...
class TeamOrganizationMembers(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2178c1196883b295a6a1f11ea9427d2c965756d709137e944c7a4cd71ecaef30)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id_", value=id_, expected_type=type_hints["id_"])
        config = TeamOrganizationMembersConfig(
            organization_membership_ids=organization_membership_ids,
            team_id=team_id,
            id=id,
    ...
    @builtins.property
    @jsii.member(jsii_name="organizationMembershipIdsInput")
    def organization_membership_ids_input(
        self,
    ) -> typing.Optional[typing.List[builtins.str]]:
        return typing.cast(typing.Optional[typing.List[builtins.str]], jsii.get(self, "organizationMembershipIdsInput"))
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ea6c93264a5d5e6e3a1ee0132c2f31014d013148324422c7b73a3ba0ab10cd85)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "id", value)

    @builtins.property
    @jsii.member(jsii_name="organizationMembershipIds")
    def organization_membership_ids(self) -> typing.List[builtins.str]:
        return typing.cast(typing.List[builtins.str], jsii.get(self, "organizationMembershipIds"))

    @organization_membership_ids.setter
    def organization_membership_ids(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e906ad25731b5a11659a526d537a2e8dc7d369f37dd553694c61a5680d588242)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "organizationMembershipIds", value)
    ...
    def team_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__51f9aa6109d469111a3a778c87deebea003bf8674f1327c5eacfc77f91ea60b6)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "teamId", value)


@jsii.data_type(
    jsii_type="@cdktf/provider-tfe.teamOrganizationMembers.TeamOrganizationMembersConfig",
    ...
    name_mapping={
        ...
        "provider": "provider",
        "provisioners": "provisioners",
        "organization_membership_ids": "organizationMembershipIds",
        "team_id": "teamId",
        "id": "id",
    },
)
class TeamOrganizationMembersConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[_cdktf_9a9027ec.SSHProvisionerConnection, typing.Dict[builtins.str, typing.Any]], typing.Union[_cdktf_9a9027ec.WinrmProvisionerConnection, typing.Dict[builtins.str, typing.Any]]]] = None,
        ...
        if __debug__:
            ...
            check_type(argname="argument organization_membership_ids", value=organization_membership_ids, expected_type=type_hints["organization_membership_ids"])
    ...
    def __repr__(self) -> str:
        return "TeamOrganizationMembersConfig(%s)" % ", ".join(
...
__all__ = [
    ...
    "TeamOrganizationMembersConfig",
]

publication.publish()

def _typecheckingstub__2178c1196883b295a6a1f11ea9427d2c965756d709137e944c7a4cd71ecaef30(
    scope: _constructs_77d1e7e8.Construct,
    id_: builtins.str,
    *,
    organization_membership_ids: typing.Sequence[builtins.str],
...
def _typecheckingstub__ea6c93264a5d5e6e3a1ee0132c2f31014d013148324422c7b73a3ba0ab10cd85(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__e906ad25731b5a11659a526d537a2e8dc7d369f37dd553694c61a5680d588242(
    value: typing.List[builtins.str],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__51f9aa6109d469111a3a778c87deebea003bf8674f1327c5eacfc77f91ea60b6(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__264066d3cb77a35e06a6d200c0833c1e3e1ce5c03da589b0de6abf5c619f37a7(
    *,
    connection: typing.Optional[typing.Union[typing.Union[_cdktf_9a9027ec.SSHProvisionerConnection, typing.Dict[builtins.str, typing.Any]], typing.Union[_cdktf_9a9027ec.WinrmProvisionerConnection, typing.Dict[builtins.str, typing.Any]]]] = None,
    count: typing.Optional[typing.Union[jsii.Number, _cdktf_9a9027ec.TerraformCount]] = None,
    depends_on: typing.Optional[typing.Sequence[_cdktf_9a9027ec.ITerraformDependable]] = None,
