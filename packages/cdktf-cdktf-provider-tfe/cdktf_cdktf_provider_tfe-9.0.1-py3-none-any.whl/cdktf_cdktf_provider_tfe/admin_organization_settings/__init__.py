...
class AdminOrganizationSettings(
    ...
    def access_beta_tools(
        ...
        jsii.set(self, "accessBetaTools", value)
    ...
    def global_module_sharing(
        ...
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "globalModuleSharing", value)
    ...
    def module_sharing_consumer_organizations(
        ...
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "moduleSharingConsumerOrganizations", value)
    ...
    def workspace_limit(self, value: jsii.Number) -> None:
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "workspaceLimit", value)
