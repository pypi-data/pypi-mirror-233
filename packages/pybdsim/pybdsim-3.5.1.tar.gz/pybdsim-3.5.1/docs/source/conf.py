# -*- coding: utf-8 -*-
#
# pybdsim documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'pybdsim', u'pybdsim Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pybdsim', u'pybdsim Documentation',
     author, 'pybdsim', 'One line description of project.',
     'Miscellaneous'),
]
