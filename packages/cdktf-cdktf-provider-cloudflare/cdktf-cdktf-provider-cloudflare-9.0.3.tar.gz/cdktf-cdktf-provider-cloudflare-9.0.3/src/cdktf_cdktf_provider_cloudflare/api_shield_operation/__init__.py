...
class ApiShieldOperation(
    ...
    def __init__(
        ...
        *,
        ...
        :param endpoint: The endpoint which can contain path parameter templates in curly braces, each will be replaced from left to right with ``{varN}``, starting with ``{var1}``. This will then be `Cloudflare-normalized <https://developers.cloudflare.com/rules/normalization/how-it-works/>`_. **Modifying this attribute will force creation of a new resource.** Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/api_shield_operation#endpoint ApiShieldOperation#endpoint}
        :param host: RFC3986-compliant host. **Modifying this attribute will force creation of a new resource.**. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/api_shield_operation#host ApiShieldOperation#host}
        :param method: The HTTP method used to access the endpoint. **Modifying this attribute will force creation of a new resource.**. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/api_shield_operation#method ApiShieldOperation#method}
        :param zone_id: The zone identifier to target for the resource. **Modifying this attribute will force creation of a new resource.**. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/api_shield_operation#zone_id ApiShieldOperation#zone_id}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/api_shield_operation#id ApiShieldOperation#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a2e2e88813bca6d82bdfe264763cf4b6c7771de78c0e79d9256a09599b2e374d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class ApiShieldOperationConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def endpoint(self) -> builtins.str:
        ...
        This will then be `Cloudflare-normalized <https://developers.cloudflare.com/rules/normalization/how-it-works/>`_. **Modifying this attribute will force creation of a new resource.**
...
def _typecheckingstub__a2e2e88813bca6d82bdfe264763cf4b6c7771de78c0e79d9256a09599b2e374d(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
