...
Refer to the Terraform Registory for docs: [`cloudflare_account`](https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/account).
'''
import abc
import builtins
import datetime
...
class Account(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: The name of the account that is displayed in the Cloudflare dashboard. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/account#name Account#name}
        :param enforce_twofactor: Whether 2FA is enforced on the account. Defaults to ``false``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/account#enforce_twofactor Account#enforce_twofactor}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/account#id Account#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param type: Account type. Available values: ``enterprise``, ``standard``. Defaults to ``standard``. **Modifying this attribute will force creation of a new resource.**. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/account#type Account#type}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def enforce_twofactor(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c8df3610656c9ee996e2ce1ac578d498ff2dfc002821a3372f4b15b37400b46e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "enforceTwofactor", value)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__44c6ad3e4544be65dbc0c4bb68896b1688d5372b936b146ec78158e12330c40f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
def _typecheckingstub__c8df3610656c9ee996e2ce1ac578d498ff2dfc002821a3372f4b15b37400b46e(
    value: typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__44c6ad3e4544be65dbc0c4bb68896b1688d5372b936b146ec78158e12330c40f(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
