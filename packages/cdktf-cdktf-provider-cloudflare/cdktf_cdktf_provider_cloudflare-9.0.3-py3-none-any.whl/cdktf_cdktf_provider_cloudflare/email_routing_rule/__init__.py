...
Refer to the Terraform Registory for docs: [`cloudflare_email_routing_rule`](https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule).
'''
import abc
import builtins
import datetime
...
class EmailRoutingRule(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule cloudflare_email_routing_rule}.'''
    ...
    def __init__(
        ...
        id_: builtins.str,
        *,
        action: typing.Union[_cdktf_9a9027ec.IResolvable, typing.Sequence[typing.Union["EmailRoutingRuleAction", typing.Dict[builtins.str, typing.Any]]]],
        matcher: typing.Union[_cdktf_9a9027ec.IResolvable, typing.Sequence[typing.Union["EmailRoutingRuleMatcher", typing.Dict[builtins.str, typing.Any]]]],
        name: builtins.str,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule cloudflare_email_routing_rule} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param action: action block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#action EmailRoutingRule#action}
        :param matcher: matcher block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#matcher EmailRoutingRule#matcher}
        :param name: Routing rule name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#name EmailRoutingRule#name}
        :param zone_id: The zone identifier to target for the resource. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#zone_id EmailRoutingRule#zone_id}
        :param enabled: Routing rule status. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#enabled EmailRoutingRule#enabled}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#id EmailRoutingRule#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param priority: Priority of the routing rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#priority EmailRoutingRule#priority}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__03568eb4eef0e5fdc5bf181f7e277b987a18d0070420dcb06570227529707e00)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class EmailRoutingRuleAction:
    def __init__(
        ...
        *,
        ...
        '''
        :param type: Type of supported action. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#type EmailRoutingRule#type}
        :param value: An array with items in the following form. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#value EmailRoutingRule#value}
        '''
        if __debug__:
    ...
    def type(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#type EmailRoutingRule#type}
        '''
    ...
    def value(self) -> typing.List[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#value EmailRoutingRule#value}
        '''
...
class EmailRoutingRuleConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def action(
        self,
    ) -> typing.Union[_cdktf_9a9027ec.IResolvable, typing.List[EmailRoutingRuleAction]]:
        '''action block.

        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#action EmailRoutingRule#action}
        '''
        result = self._values.get("action")
        assert result is not None, "Required property 'action' is missing"
        return typing.cast(typing.Union[_cdktf_9a9027ec.IResolvable, typing.List[EmailRoutingRuleAction]], result)

    @builtins.property
    def matcher(
        self,
    ) -> typing.Union[_cdktf_9a9027ec.IResolvable, typing.List["EmailRoutingRuleMatcher"]]:
        '''matcher block.

        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#matcher EmailRoutingRule#matcher}
        '''
        result = self._values.get("matcher")
        assert result is not None, "Required property 'matcher' is missing"
        return typing.cast(typing.Union[_cdktf_9a9027ec.IResolvable, typing.List["EmailRoutingRuleMatcher"]], result)

    @builtins.property
    def name(self) -> builtins.str:
        '''Routing rule name.

        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#name EmailRoutingRule#name}
        '''
    ...
    def zone_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#zone_id EmailRoutingRule#zone_id}
        '''
    ...
    def enabled(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#enabled EmailRoutingRule#enabled}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#id EmailRoutingRule#id}.
    ...
    def priority(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#priority EmailRoutingRule#priority}
        '''
...
class EmailRoutingRuleMatcher:
    def __init__(
        ...
        *,
        ...
        '''
        :param type: Type of matcher. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#type EmailRoutingRule#type}
        :param field: Field for type matcher. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#field EmailRoutingRule#field}
        :param value: Value for matcher. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#value EmailRoutingRule#value}
        '''
        if __debug__:
    ...
    def field(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.16.0/docs/resources/email_routing_rule#field EmailRoutingRule#field}
        '''
...
def _typecheckingstub__03568eb4eef0e5fdc5bf181f7e277b987a18d0070420dcb06570227529707e00(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
