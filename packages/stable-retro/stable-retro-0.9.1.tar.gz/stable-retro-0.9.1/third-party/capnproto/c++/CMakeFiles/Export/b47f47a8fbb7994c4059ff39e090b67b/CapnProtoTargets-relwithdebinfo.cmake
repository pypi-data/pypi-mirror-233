...
set_target_properties(CapnProto::kj PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libkj.a"
  )

list(APPEND _cmake_import_check_targets CapnProto::kj )
list(APPEND _cmake_import_check_files_for_CapnProto::kj "${_IMPORT_PREFIX}/lib/libkj.a" )
...
set_target_properties(CapnProto::kj-test PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libkj-test.a"
  )

list(APPEND _cmake_import_check_targets CapnProto::kj-test )
list(APPEND _cmake_import_check_files_for_CapnProto::kj-test "${_IMPORT_PREFIX}/lib/libkj-test.a" )
...
set_target_properties(CapnProto::kj-async PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libkj-async.a"
  )

list(APPEND _cmake_import_check_targets CapnProto::kj-async )
list(APPEND _cmake_import_check_files_for_CapnProto::kj-async "${_IMPORT_PREFIX}/lib/libkj-async.a" )
...
set_target_properties(CapnProto::kj-http PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libkj-http.a"
  )

list(APPEND _cmake_import_check_targets CapnProto::kj-http )
list(APPEND _cmake_import_check_files_for_CapnProto::kj-http "${_IMPORT_PREFIX}/lib/libkj-http.a" )
...
set_target_properties(CapnProto::capnp PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libcapnp.a"
  )

list(APPEND _cmake_import_check_targets CapnProto::capnp )
list(APPEND _cmake_import_check_files_for_CapnProto::capnp "${_IMPORT_PREFIX}/lib/libcapnp.a" )
...
set_target_properties(CapnProto::capnp-rpc PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libcapnp-rpc.a"
  )

list(APPEND _cmake_import_check_targets CapnProto::capnp-rpc )
list(APPEND _cmake_import_check_files_for_CapnProto::capnp-rpc "${_IMPORT_PREFIX}/lib/libcapnp-rpc.a" )
...
set_target_properties(CapnProto::capnp-json PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libcapnp-json.a"
  )

list(APPEND _cmake_import_check_targets CapnProto::capnp-json )
list(APPEND _cmake_import_check_files_for_CapnProto::capnp-json "${_IMPORT_PREFIX}/lib/libcapnp-json.a" )
...
set_target_properties(CapnProto::capnpc PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELWITHDEBINFO "CXX"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libcapnpc.a"
  )

list(APPEND _cmake_import_check_targets CapnProto::capnpc )
list(APPEND _cmake_import_check_files_for_CapnProto::capnpc "${_IMPORT_PREFIX}/lib/libcapnpc.a" )
...
set_target_properties(CapnProto::capnp_tool PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/capnp"
  )
...
set_target_properties(CapnProto::capnpc_cpp PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/capnpc-c++"
  )
...
set_target_properties(CapnProto::capnpc_capnp PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/capnpc-capnp"
  )
