...
class Settings:
    ...
    def __init__(self, root, dirpath, mirrored=False, external_cam_frame=None,
        ...
        self.brutto_too_little_win = ('brutto_too_little_win', w / 1.948, h / 2,
                                      PhotoImage(
        ...
        self.mainLogoBtn = (
            'mainL.png', w / 19.0609, h / 2.5282,
            'operator.mainPage.openWin()',
            PhotoImage(file=self.imgsysdir + 'mainL.png'), 25, 25,
            'toolbarBtn.TButton',
        ...
        self.statBtns = [
            ...
            ('Выгрузить', w / 1.144, h / 1.05, 'self.excel_creator()',
