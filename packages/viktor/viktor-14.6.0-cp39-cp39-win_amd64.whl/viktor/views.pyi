...
class MapPoint(MapFeature):
    def __init__(self, lat: float, lon: float, alt: float = ..., *, icon: str = ..., size: Literal['small', 'medium', 'large'] = ..., **kwargs: Any) -> None: ...
    @classmethod
    def from_geo_point(cls, point: GeoPoint, *, icon: str = ..., size: Literal['small', 'medium', 'large'] = ..., **kwargs: Any) -> MapPoint: ...
    @property
    def lat(self) -> float: ...
    @property
    def lon(self) -> float: ...
...
class _IFCSubResult(_SubResult):
    ifc: Incomplete
    def __init__(self, ifc: File) -> None: ...
...
class IFCAndDataResult(_ViewResult):
    ifc: Incomplete
    data: Incomplete
    def __init__(self, ifc: File, data: DataGroup) -> None: ...
...
class GeometryView(View):
    def __init__(self, label: str, duration_guess: int, *, description: str = ..., update_label: str = ..., view_mode: Literal['2D', '3D'] = ..., default_shadow: bool = ..., up_axis: Literal['Y', 'Z'] = ...) -> None: ...
