                    ...
                    <xsl:choose>
                        <xsl:when test="local-name()='p'">
                            <p>
                                ...
                                <WARNING><xsl:text>Unknown style "</xsl:text><xsl:value-of select="@text:style-name"/><xsl:text>" converted to p element. [#</xsl:text><xsl:number count="*[local-name()='p']" from="*:body" level="any"/><xsl:text>]</xsl:text></WARNING>
                                <xsl:apply-templates/>
                            </p>
                        </xsl:when>
                        <xsl:when test="local-name()='span'">
                    ...
                    <xsl:element name="{$currentElementName}">
                        ...
                        <xsl:attribute name="xml:id">
                            <xsl:choose>
                                ...
                                <xsl:otherwise>
                                    <xsl:value-of select="$currentElementName"/><xsl:number count="*[local-name()=$currentElementName]" from="*:body[not(parent::*:floatingText)]" level="any"/>
                                    <!-- [not(parent::*:note)] -->
                                </xsl:otherwise>
                            </xsl:choose>
                        </xsl:attribute>
