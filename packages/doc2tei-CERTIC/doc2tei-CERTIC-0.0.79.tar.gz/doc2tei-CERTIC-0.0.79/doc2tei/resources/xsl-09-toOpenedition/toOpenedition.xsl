...
<xsl:template match="tei:orgName">
    ...
    <xsl:choose>
        <xsl:when test="$aff = following::tei:p[@rend='authority_affiliation' and @rendition='#rtl']/text() ">
...
<!--    <availability>
    ...
    <sourceDesc>
        <xsl:choose>
            <xsl:when test="//tei:ab[@type='book']//tei:dim[@type='pagination'] != ''">
                <biblStruct>
                    <monogr>
                        <imprint>
                            <biblScope unit="page">
                                <xsl:value-of select="//tei:ab[@type='book']//tei:dim[@type='pagination']/@extent"/>
                            </biblScope>
                        </imprint>
                    </monogr>
                </biblStruct>
...
<xsl:template match="tei:cit[descendant::tei:lg]">
    <xsl:copy-of select="descendant::tei:lg"/>
</xsl:template>
    
<xsl:template match="tei:cit[(descendant::tei:sp) or (child::tei:quote[child::tei:stage])]">
    <xsl:copy-of select="descendant::tei:sp|tei:quote/tei:stage"/>
</xsl:template>
