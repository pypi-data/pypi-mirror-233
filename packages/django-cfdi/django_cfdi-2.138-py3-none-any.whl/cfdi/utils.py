...
def get_xml_object(xml_text, incluir_texto_direccion=False, venta_global_es_combustible=False):
    """
    ...
    cond3 = xml_text.encode("utf-8").startswith(b"\xef\xbb\xbf\r\n<")
    ...
    if carta_porte.exists:
        ...
        for mercancia in  carta_porte.find("mercancias").find_list("mercancia"):
            ...
            peso_total += to_decimal(mercancia_dic.get("PesoEnKg", 0) ) *  to_decimal(mercancia_dic.get("Cantidad", 0))
