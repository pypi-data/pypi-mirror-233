...
class _App:
    ...
    def __init__(self, client: modal.client._Client, app_id: str, app_page_url: str, output_mgr: typing.Union[modal._output.OutputManager, None], tag_to_object_id: typing.Union[typing.Dict[str, str], None] = None, stub_name: typing.Union[str, None] = None, environment_name: typing.Union[str, None] = None):
        ...
    ...
    async def spawn_sandbox(self, *args, **kwargs) -> modal.sandbox._Sandbox:
        ...
...
class App:
    ...
    def __init__(self, client: modal.client.Client, app_id: str, app_page_url: str, output_mgr: typing.Union[modal._output.OutputManager, None], tag_to_object_id: typing.Union[typing.Dict[str, str], None] = None, stub_name: typing.Union[str, None] = None, environment_name: typing.Union[str, None] = None):
        ...
    ...
    class __spawn_sandbox_spec(typing_extensions.Protocol):
        def __call__(self, *args, **kwargs) -> modal.sandbox.Sandbox:
            ...
