...
"""
    ...
    The version of the OpenAPI document: 1.13.618
...
class ConvertToViewData(object):
    ...
    def __init__(self, query=None, name=None, description=None, documentation_link=None, view_parameters=None, local_vars_configuration=None):  # noqa: E501
