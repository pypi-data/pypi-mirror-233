...
setup_info = dict(
    ...
    download_url='http://pypi.python.org/pypi/kaya-runner-sdk',
    project_urls={
        'Documentation': 'https://kaya.wanolabs.com.readthedocs.io/en/latest',
        'Source': 'https://github.com/WanoLabs/KayaRunnerSDK',
        'Tracker': 'https://github.com/WanoLabs/KayaRunnerSDK/issues',
    },
    ...
    package_data={'kaya_runner': ['conf/kaya_runner.conf.json']},
    ...
    install_requires=[
        'Flask', 'gunicorn', 'flake8', 'mypy', 'pylint'
    ],
    setup_requires=['flake8'],
    entry_points={
        'console_scripts': [
            'kaya_runner=kaya_runner.app:init',
        ]
    },
)
