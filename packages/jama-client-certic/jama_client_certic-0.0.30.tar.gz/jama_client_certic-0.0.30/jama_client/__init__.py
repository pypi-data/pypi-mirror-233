...
class Client:
    ...
    def add_collection_from_path(self, path: str, project_id: int) -> List[Dict]:
        ...
        ```
        """
        return self.__call("add_collection_from_path", [path, project_id])
    ...
    def add_metadataset(self, title: str, project_id: int) -> int:
        ...
        """
        return self.__call("add_metadataset", [title, project_id])
    ...
    def auto_find_rotate_angle(self, resource_id: int) -> float:
        ...
        """
        return self.__call("auto_find_rotate_angle", [resource_id])
    ...
    def collection_stats(self, collection_id: int) -> dict:
        ...
        """
        return self.__call("collection_stats", [collection_id])
    ...
    def create_project(self, project_label: str, project_description: str) -> dict:
        ...
        Requires superuser.
        """
        return self.__call("create_project", [project_label, project_description])
    ...
    def delete_metadata(self, metadata_id: int) -> bool:
        ...
        """
        return self.__call("delete_metadata", [metadata_id])
    ...
    def delete_metadataset(self, metadataset_id: int, recursive: bool = False) -> Dict:
        ...
        call.
        """
        return self.__call("delete_metadataset", [metadataset_id, recursive])
    ...
    def delete_project_property(self, project_id: int, property_key: str) -> bool:
        ...
        """
        return self.__call("delete_project_property", [project_id, property_key])
    ...
    def delete_role(self, project_id: int, role_label: str) -> bool:
        ...
        Requires superuser
        """
        return self.__call("delete_role", [project_id, role_label])
    ...
    def metadatasets(self, project_id: int) -> List[Dict]:
        ...
        ```
        """
        return self.__call("metadatasets", [project_id])
    ...
    def project_properties(self, project_id: int) -> List[dict]:
        ...
        """
        return self.__call("project_properties", [project_id])
    ...
    def project_property(self, project_id: int, property_key: str) -> dict:
        ...
        """
        return self.__call("project_property", [project_id, property_key])
    ...
    def project_stats(self, project_id: int) -> dict:
        ...
        - number of children collections
        """
        return self.__call("project_stats", [project_id])
    ...
    def projects_user_permissions(self) -> List[Dict]:
        ...
        ```
        """
        return self.__call("projects_user_permissions", [])

    def public_collections(self, project_id: int) -> List[dict]:
        """
        Get public collections
        """
        return self.__call("public_collections", [project_id])
    ...
    def recycle_bin(self, project_id: int) -> List[Dict]:
        ...
        - deleted_at
        """
        return self.__call("recycle_bin", [project_id])
    ...
    def remove_selection(self, parent_collection_id: int, selection: dict) -> bool:
        ...
        """
        return self.__call("remove_selection", [parent_collection_id, selection])
    ...
    def replace_file(self, from_resource_id: int, to_resource_id: int) -> bool:
        ...
        """
        return self.__call("replace_file", [from_resource_id, to_resource_id])
    ...
    def restore_resource(
        ...
        """
        return self.__call("restore_resource", [resource_id, destination_collection_id])

    def set_is_oai_record(self, collection_id: int, is_oai_record: bool = True) -> bool:
        """
        Set/unset the collection as a OAI-PMH record. The creation date
        will be used in OAI-PMH requests.
        """
        return self.__call("set_is_oai_record", [collection_id, is_oai_record])

    def set_metas_to_collection(
        self, collection_id: int, metas: List[dict], recursive: bool = False
    ) -> bool:
        """
        ...
        collections and resources alike.
        """
        return self.__call("set_metas_to_collection", [collection_id, metas, recursive])
    ...
    def set_metas_to_resource(self, resource_id: int, metas: List[dict]) -> bool:
        ...
        All metas must share the same metadata set.
        """
        return self.__call("set_metas_to_resource", [resource_id, metas])
    ...
    def set_representative_resource(
        ...
        """
        return self.__call("set_representative_resource", [collection_id, resource_id])
    ...
    def set_role(
        ...
        Requires superuser.
        """
        return self.__call("set_role", [project_id, role_label, permissions])
    ...
    def set_tag(
        ...
        ```
        """
        return self.__call("set_tag", [uid, project_id, label, ark])
    ...
    def tags(self, project_id: int) -> List[dict]:
        ...
        ```
        """
        return self.__call("tags", [project_id])
    ...
    def upload_infos(self, sha256_hash: str, project_id: int) -> Dict:
        ...
        """
        return self.__call("upload_infos", [sha256_hash, project_id])
...
class AsyncClient:
    ...
    async def __call(self, method: str, params: List = None) -> Any:
        self.requests_count = self.requests_count + 1
        payload = {"method": method, "params": params or [], "id": self.requests_count}
        async with aiohttp.ClientSession(headers={"X-Api-Key": self._api_key}) as sess:
            async with sess.post(self._endpoint, json=payload) as response:
                if response.status == 200:
                    ...
                    raise ServiceError(
                        "Response ended with status code {}".format(response.status)
                    )

    async def activate_rpc_access(self, user_name: str, api_key: str) -> bool:
        """
        Add access to the RPC API for the given user name with the given API key.
        A new user will be created if none is available with given user name.
        ...
        Requires superuser.
        """
        return await self.__call("activate_rpc_access", [user_name, api_key])

    async def add_collection(self, title: str, parent_id: int) -> Dict:
        """
        Create a new collection based on 'title' and parent_id
        ...
        ```
        """
        return await self.__call("add_collection", [title, parent_id])

    async def add_collection_from_path(self, path: str, project_id: int) -> List[Dict]:
        """
        Will take a path such as '/photos/arts/paintings/'
        and build the corresponding hierarchy of collections. The hierarchy
        is returned as a list of serialized collections.
        ...
        ```
        """
        return await self.__call("add_collection_from_path", [path, project_id])

    async def add_meta_to_collection(
        self, collection_id: int, meta_id: int, meta_value: str, recursive: bool = False
    ) -> int:
        """
        Add a meta value to a collection given their ids.
    ...
    async def add_meta_to_resource(
        self, resource_id: int, meta_id: int, meta_value: str
    ) -> int:
        """
        Add a meta value to a resource given their ids.
        """
        return await self.__call(
            "add_meta_to_resource", [resource_id, meta_id, meta_value]
        )

    async def add_meta_to_selection(
        self, from_collection_id: int, selection: dict, meta_id: int, meta_value: str
    ) -> bool:
        """
        Use such a dict for selection:
    ...
    async def add_metadata(
        ...
        Set optional 'metadata_type_id'. async defaults to string type.
        """
        return await self.__call(
            "add_metadata", [title, metas_set_id, metadata_type_id]
        )

    async def add_metadataset(self, title: str, project_id: int) -> int:
        """
        Create new metadata set from title.
        """
        return await self.__call("add_metadataset", [title, project_id])
    ...
    async def add_tag_to_collection(self, tag_uid: str, collection_id: int) -> bool:
        """
        Add tag to a collection based on tag uid and collection id.
        """
        return await self.__call("add_tag_to_collection", [tag_uid, collection_id])

    async def add_tag_to_resource(self, tag_uid: str, resource_id: int) -> bool:
        """
        Add tag to a resource based on tag uid and resource id.
        """
        return await self.__call("add_tag_to_resource", [tag_uid, resource_id])
    ...
    async def advanced_search_terms(self) -> List[str]:
        """
        Return terms conditions to be used in advanced search.
        ...
        ```
        """
        return await self.__call("advanced_search_terms", [])

    async def ancestors_from_collection(
        self, collection_id: int, include_self: bool = False
    ) -> List[dict]:
        """
        Get ancestors from collection id as a list of serialized collections.
        ...
        """
        return await self.__call(
            "ancestors_from_collection", [collection_id, include_self]
        )

    async def ancestors_from_resource(self, resource_id: int) -> List[List[dict]]:
        """
        Get ancestors from resource id as a list of serialized collections.
        ...
        ```
        """
        return await self.__call("ancestors_from_resource", [resource_id])

    async def auto_find_rotate_angle(self, resource_id: int) -> float:
        """
        Tries to determine skew angle of image with text.
        """
        return await self.__call("auto_find_rotate_angle", [resource_id])

    async def change_collection_meta_value(
        self, meta_value_id: int, meta_value: str
    ) -> bool:
        """
        Change the value of a meta for a collection.
        """
        return await self.__call(
            "change_collection_meta_value", [meta_value_id, meta_value]
        )

    async def change_resource_meta_value(
        self, meta_value_id: int, meta_value: str
    ) -> bool:
        """
        Change the value of a meta for a resource
        """
        return await self.__call(
            "change_resource_meta_value", [meta_value_id, meta_value]
        )

    async def collection(self, collection_id: int) -> Dict:
        """
        Get a particular collection given its id.
        ...
        ```
        """
        return await self.__call("collection", [collection_id])

    async def collection_stats(self, collection_id: int) -> dict:
        """
        Get infos from given collection:
        ...
        - number of children collections
        """
        return await self.__call("collection_stats", [collection_id])
    ...
    async def create_project(
        self, project_label: str, project_description: str
    ) -> dict:
        """
        Create a new project.
        ...
        Requires superuser.
        """
        return await self.__call("create_project", [project_label, project_description])

    async def deactivate_rpc_access(self, user_name: str, api_key: str) -> bool:
        """
        Deactivate access to the RPC API for the given user name and API key.
        Only the access (API key) is removed, not the user.
        ...
        Requires superuser.
        """
        return await self.__call("deactivate_rpc_access", [user_name, api_key])

    async def delete_collection(
        self, collection_id: int, recursive: bool = False
    ) -> Dict:
        """
        Delete collection given its id.
        ...
        deleted.
        """
        return await self.__call("delete_collection", [collection_id, recursive])

    async def delete_metadata(self, metadata_id: int) -> bool:
        """
        Delete metadata based on its id.
        """
        return await self.__call("delete_metadata", [metadata_id])

    async def delete_metadataset(
        self, metadataset_id: int, recursive: bool = False
    ) -> Dict:
        """
        Delete metadata set based on its id. Optional recursive
        call.
        """
        return await self.__call("delete_metadataset", [metadataset_id, recursive])

    async def delete_project_property(self, project_id: int, property_key: str) -> bool:
        """
        Delete a property from the project.

        property_key is NOT case sensitive, ie. "ProPertY" is the same as "pRoperTy" or "property".
        """
        return await self.__call("delete_project_property", [project_id, property_key])

    async def delete_resource(self, resource_id: int) -> bool:
        """
        Permanently (soft) delete a resource given its id.
        """
        return await self.__call("delete_resource", [resource_id])

    async def delete_role(self, project_id: int, role_label: str) -> bool:
        """
        Delete role within given project.

        Requires superuser
        """
        return await self.__call("delete_role", [project_id, role_label])

    async def delete_tag(self, uid: str) -> bool:
        """
        Remove (delete) a tag based on its uid.

        Beware: This will remove ALL associations with the tag.
        """
        return await self.__call("delete_tag", [uid])

    async def has_permission(self, project_id: int, permission: str) -> bool:
        """
        Test current user for given permission.
        """
        return await self.__call("has_permission", [project_id, permission])
    ...
    async def list_permissions(self) -> List[Dict]:
        ...
        ```
        """
        return await self.__call("list_permissions", [])

    async def list_roles(self, project_id: int) -> List[Dict]:
        """
        Fetch all roles async defined in the project, no matter the user.
        """
        return await self.__call("list_roles", [project_id])

    async def meta_count(self, metadata_id: int, collection_id: int) -> dict:
        """
        Count metadata usage.
        """
        return await self.__call("meta_count", [metadata_id, collection_id])

    async def metadata(self, metadata_id: int) -> Dict:
        """
        Get one particular metadata given its id.
        ...
        ```
        """
        return await self.__call("metadata", [metadata_id])

    async def metadatas(self, metadata_set_id: int) -> List[Dict]:
        """
        Get all metadatas given a metadata set id.
        ...
        ```
        """
        return await self.__call("metadatas", [metadata_set_id])

    async def metadatasets(self, project_id: int) -> List[Dict]:
        """
        Get the list of all the project's metadata sets.
        For each metadatas set, the number of metadatas is given in metas_count.
        ...
        ```
        """
        return await self.__call("metadatasets", [project_id])

    async def metadatatypes(self) -> List[dict]:
        """
        Get a list of available data types
        ...
        ```
        """
        return await self.__call("metadatatypes", [])
    ...
    async def project_properties(self, project_id: int) -> List[dict]:
        """
        Get ALL properties from a project.
        """
        return await self.__call("project_properties", [project_id])

    async def project_property(self, project_id: int, property_key: str) -> dict:
        """
        Get a property value from the project.
        ...
        Will raise an exception if property does not exist.
        """
        return await self.__call("project_property", [project_id, property_key])

    async def project_stats(self, project_id: int) -> dict:
        """
        Get infos from given project:
        ...
        - number of children collections
        """
        return await self.__call("project_stats", [project_id])

    async def projects_user_permissions(self) -> List[Dict]:
        """
        Get all rights for the current user.
        ...
        ```
        """
        return await self.__call("projects_user_permissions", [])

    async def public_collections(self, project_id: int) -> List[dict]:
        """
        Get public collections
        """
        return await self.__call("public_collections", [project_id])

    async def publish_collection(self, collection_id: int) -> bool:
        """
        Mark a collection as public
        """
        return await self.__call("publish_collection", [collection_id])

    async def recycle_bin(self, project_id: int) -> List[Dict]:
        """
        Gets deleted elements:
        ...
        - deleted_at
        """
        return await self.__call("recycle_bin", [project_id])

    async def remove_meta_value_from_collection(
        self, collection_id: int, meta_value_id: int, recursive: bool = False
    ) -> bool:
        """
        Remove a meta value from a collection given their ids.
    ...
    async def remove_meta_value_from_resource(
        self, resource_id: int, meta_value_id: int
    ) -> bool:
        """
        Remove a meta_value from a resource given their ids.
    ...
    async def remove_meta_value_from_selection(
        self, from_collection_id: int, selection: dict, meta_value_id: int
    ) -> bool:
        """
        Use such a dict for selection:
    ...
    async def remove_selection(
        self, parent_collection_id: int, selection: dict
    ) -> bool:
        """
        Will mass remove items (resources AND collections) based on parent collection
        ...
        The parent collection is left as-is.
        """
        return await self.__call("remove_selection", [parent_collection_id, selection])

    async def remove_tag_from_collection(
        self, tag_uid: str, collection_id: int
    ) -> bool:
        """
        Remove tag from a collection based on tag uid and collection id.
        """
        return await self.__call("remove_tag_from_collection", [tag_uid, collection_id])

    async def remove_tag_from_resource(self, tag_uid: str, resource_id: int) -> bool:
        """
        Remove tag from a resource based on tag uid and resource id.
        """
        return await self.__call("remove_tag_from_resource", [tag_uid, resource_id])

    async def rename_collection(self, collection_id: int, title: str) -> bool:
        """
        Rename a collection (ie. change its title).
        """
        return await self.__call("rename_collection", [collection_id, title])

    async def rename_meta(self, meta_id: int, title: str) -> bool:
        """
        Rename a metadata (ie. change its title).
        """
        return await self.__call("rename_meta", [meta_id, title])

    async def rename_resource(self, resource_id: int, title: str) -> bool:
        """
        Rename a resource (ie. change its title).
        """
        return await self.__call("rename_resource", [resource_id, title])

    async def replace_file(self, from_resource_id: int, to_resource_id: int) -> bool:
        """
        Replace a file by another using two existing resources.
        ...
        excluding exif metas that are transfered from the source.
        """
        return await self.__call("replace_file", [from_resource_id, to_resource_id])

    async def resource(self, resource_id: int) -> Dict:
        """
        Get a resource given its id.
        ...
        ```
        """
        return await self.__call("resource", [resource_id])
    ...
    async def restore_resource(
        ...
        """
        return await self.__call(
            "restore_resource", [resource_id, destination_collection_id]
        )

    async def set_is_oai_record(
        self, collection_id: int, is_oai_record: bool = True
    ) -> bool:
        """
        Set/unset the collection as a OAI-PMH record. The creation date
        will be used in OAI-PMH requests.
        """
        return await self.__call("set_is_oai_record", [collection_id, is_oai_record])

    async def set_metas_to_collection(
        self, collection_id: int, metas: List[dict], recursive: bool = False
    ) -> bool:
        """
        Sets all metas for a unique metadata set.
        ...
        """
        return await self.__call(
            "set_metas_to_collection", [collection_id, metas, recursive]
        )

    async def set_metas_to_resource(self, resource_id: int, metas: List[dict]) -> bool:
        """
        Sets all metas for a unique metadata set.
        ...
        All metas must share the same metadata set.
        """
        return await self.__call("set_metas_to_resource", [resource_id, metas])
    ...
    async def set_representative_resource(
        self, collection_id: int, resource_id: int = None
    ) -> bool:
        """
        Choose a Resource that is the best representation of a collection.
        ...
        """
        return await self.__call(
            "set_representative_resource", [collection_id, resource_id]
        )
    ...
    async def set_role(
        ...
        Requires superuser.
        """
        return await self.__call("set_role", [project_id, role_label, permissions])
    ...
    async def set_tag(
        ...
        ```
        """
        return await self.__call("set_tag", [uid, project_id, label, ark])
    ...
    async def supported_file_types(self) -> List[Dict]:
        """
        Get a list of all supported file type, complete with their mimes.
        ...
        ```
        """
        return await self.__call("supported_file_types", [])

    async def tags(self, project_id: int) -> List[dict]:
        """
        Returns all tags available in the project.
        ...
        ```
        """
        return await self.__call("tags", [project_id])

    async def unpublish_collection(self, collection_id: int) -> bool:
        """
        Mark a collection as private
        """
        return await self.__call("unpublish_collection", [collection_id])

    async def upload_infos(self, sha256_hash: str, project_id: int) -> Dict:
        """
        Get information for an upload based on the file hash.
        ...
        "status" being one of "not available", "available" or "incomplete"
        """
        return await self.__call("upload_infos", [sha256_hash, project_id])
