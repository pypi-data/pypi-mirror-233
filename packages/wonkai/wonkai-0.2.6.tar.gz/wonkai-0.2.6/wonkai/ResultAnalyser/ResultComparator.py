...
class ResultComparator():
    ...
    def get_rapport(self) :
        ...
        rapport = pd.DataFrame(columns=["key", "good", "wrong", "under_threshold", "not_found", "number", "accuracy", "metadatas"])
        for key in keys :
            wrong_values = []
            ...
            rapport = pd.concat([rapport, pd.DataFrame([[key, good, wrong, under_threshold, not_found, number, accuracy, wrong_values]],
