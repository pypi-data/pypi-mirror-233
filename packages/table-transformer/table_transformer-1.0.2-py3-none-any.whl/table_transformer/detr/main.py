...
def get_args_parser():
    ...
    parser.add_argument('--dilation', action='store_true',
                        help="If true, we replace stride\
                            with dilation in the last convolutional block (DC5)")
    parser.add_argument('--position_embedding', default='sine',
                        type=str, choices=('sine', 'learned'),
                        help="Type of positional embedding \
                            to use on top of the image features")
    ...
    parser.add_argument('--dim_feedforward', default=2048, type=int,
                        help="Intermediate size of the \
                            feedforward layers in the transformer blocks")
    ...
    parser.add_argument('--nheads', default=8, type=int,
                        help="Number of attention heads \
                            inside the transformer's attentions")
