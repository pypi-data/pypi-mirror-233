...
class AbstractMsf(object, ghidra.app.util.bin.format.pdb2.pdbreader.msf.Msf):




    def __init__(self, __a0: java.io.RandomAccessFile, __a1: unicode, __a2: ghidra.util.task.TaskMonitor, __a3: ghidra.app.util.bin.format.pdb2.pdbreader.PdbReaderOptions): ...
