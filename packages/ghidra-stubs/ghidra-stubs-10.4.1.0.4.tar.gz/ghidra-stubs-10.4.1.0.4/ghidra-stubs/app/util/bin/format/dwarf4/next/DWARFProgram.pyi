...
class DWARFProgram(object, java.io.Closeable):
    ...
    DWARF_ROOT_CATPATH: ghidra.program.model.data.CategoryPath = /DWARF
    DWARF_ROOT_NAME: unicode = u'DWARF'
    MAX_NAME_LENGTH_CUTOFF: int = 2000
    MIN_NAME_LENGTH_CUTOFF: int = 20
    UNCAT_CATPATH: ghidra.program.model.data.CategoryPath = /DWARF/_UNCATEGORIZED_
    ...
    def getCodeAddress(self, offset: java.lang.Number) -> ghidra.program.model.address.Address: ...
    ...
    def getDataAddress(self, offset: java.lang.Number) -> ghidra.program.model.address.Address: ...
    ...
    def getDwarfDTM(self) -> ghidra.app.util.bin.format.dwarf4.next.DWARFDataTypeManager: ...
    ...
    def getImportSummary(self) -> ghidra.app.util.bin.format.dwarf4.next.DWARFImportSummary: ...
    ...
    def getOpaqueProperty(self, key: object, defaultValue: object, valueClass: java.lang.Class) -> object: ...
    ...
    def setOpaqueProperty(self, key: object, value: object) -> None: ...
    ...
    @property
    def dwarfDTM(self) -> ghidra.app.util.bin.format.dwarf4.next.DWARFDataTypeManager: ...
    ...
    @property
    def importSummary(self) -> ghidra.app.util.bin.format.dwarf4.next.DWARFImportSummary: ...
