...
class EolCommentFieldFactory(ghidra.app.util.viewer.field.FieldFactory):
    ...
    DEFAULT_COLOR: java.awt.Color = #0000ff
    ...
    SHOW_FUNCTION_AUTOMITIC_COMMENT_MSG: unicode = u'EOL Comments Field.Show Function Reference Automatic Comments'
    ...
    def newInstance(self, fieldFormatModel: ghidra.app.util.viewer.format.FieldFormatModel, highlightProvider: ghidra.app.util.ListingHighlightProvider, newDisplayOptions: ghidra.framework.options.ToolOptions, newFieldOptions: ghidra.framework.options.ToolOptions) -> ghidra.app.util.viewer.field.FieldFactory: ...
