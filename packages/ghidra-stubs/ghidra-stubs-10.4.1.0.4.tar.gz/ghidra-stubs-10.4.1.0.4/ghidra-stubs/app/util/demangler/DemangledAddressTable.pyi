...
class DemangledAddressTable(ghidra.app.util.demangler.DemangledObject):




    def __init__(self, mangled: unicode, originalDemangled: unicode, name: unicode, calculateLength: bool):
        """
        Constructor
