...
class ProgramMergeManagerPlugin(ghidra.app.merge.MergeManagerPlugin, ghidra.app.services.ProgramManager):
    """
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, mergeManager: ghidra.app.merge.ProgramMultiUserMergeManager, program: ghidra.program.model.listing.Program):
        """
