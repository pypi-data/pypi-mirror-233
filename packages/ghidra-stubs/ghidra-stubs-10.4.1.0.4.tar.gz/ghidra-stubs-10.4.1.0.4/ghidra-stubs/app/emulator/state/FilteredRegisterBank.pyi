...
class FilteredRegisterBank(ghidra.pcode.memstate.MemoryPageBank):
    ...
    def __init__(self, __a0: ghidra.program.model.address.AddressSpace, __a1: int, __a2: ghidra.app.emulator.state.RegisterState, __a3: ghidra.program.model.lang.Language, __a4: bool, __a5: ghidra.pcode.memstate.MemoryFaultHandler): ...
