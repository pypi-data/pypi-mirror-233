...
class DebuggerTraceManagerService(object):
    ...
    class ActivationCause(java.lang.Enum):
        ACTIVATE_DEFAULT: ghidra.app.services.DebuggerTraceManagerService.ActivationCause = ACTIVATE_DEFAULT
        EMU_STATE_EDIT: ghidra.app.services.DebuggerTraceManagerService.ActivationCause = EMU_STATE_EDIT
        FOLLOW_PRESENT: ghidra.app.services.DebuggerTraceManagerService.ActivationCause = FOLLOW_PRESENT
        MAPPER_CHANGED: ghidra.app.services.DebuggerTraceManagerService.ActivationCause = MAPPER_CHANGED
        RESTORE_STATE: ghidra.app.services.DebuggerTraceManagerService.ActivationCause = RESTORE_STATE
        START_RECORDING: ghidra.app.services.DebuggerTraceManagerService.ActivationCause = START_RECORDING
        SYNC_MODEL: ghidra.app.services.DebuggerTraceManagerService.ActivationCause = SYNC_MODEL
        USER: ghidra.app.services.DebuggerTraceManagerService.ActivationCause = USER
    ...
    @overload
    def activate(self, __a0: ghidra.app.plugin.core.debug.DebuggerCoordinates) -> None: ...

    @overload
    def activate(self, __a0: ghidra.app.plugin.core.debug.DebuggerCoordinates, __a1: ghidra.app.services.DebuggerTraceManagerService.ActivationCause) -> None: ...

    def activateAndNotify(self, __a0: ghidra.app.plugin.core.debug.DebuggerCoordinates, __a1: ghidra.app.services.DebuggerTraceManagerService.ActivationCause, __a2: bool) -> java.util.concurrent.CompletableFuture: ...
    ...
    def addSynchronizeActiveChangeListener(self, __a0: ghidra.app.services.DebuggerTraceManagerService.BooleanChangeAdapter) -> None: ...
    ...
    def findSnapshot(self, __a0: ghidra.app.plugin.core.debug.DebuggerCoordinates) -> long: ...

    def getClass(self) -> java.lang.Class: ...

    def getCurrent(self) -> ghidra.app.plugin.core.debug.DebuggerCoordinates: ...

    def getCurrentFor(self, __a0: ghidra.trace.model.Trace) -> ghidra.app.plugin.core.debug.DebuggerCoordinates: ...
    ...
    def isSynchronizeActive(self) -> bool: ...

    def materialize(self, __a0: ghidra.app.plugin.core.debug.DebuggerCoordinates) -> java.util.concurrent.CompletableFuture: ...
    ...
    def removeSynchronizeActiveChangeListener(self, __a0: ghidra.app.services.DebuggerTraceManagerService.BooleanChangeAdapter) -> None: ...

    def resolveFrame(self, __a0: int) -> ghidra.app.plugin.core.debug.DebuggerCoordinates: ...

    def resolveObject(self, __a0: ghidra.trace.model.target.TraceObject) -> ghidra.app.plugin.core.debug.DebuggerCoordinates: ...

    def resolvePlatform(self, __a0: ghidra.trace.model.guest.TracePlatform) -> ghidra.app.plugin.core.debug.DebuggerCoordinates: ...

    def resolveSnap(self, __a0: long) -> ghidra.app.plugin.core.debug.DebuggerCoordinates: ...

    def resolveThread(self, __a0: ghidra.trace.model.thread.TraceThread) -> ghidra.app.plugin.core.debug.DebuggerCoordinates: ...

    def resolveTime(self, __a0: ghidra.trace.model.time.schedule.TraceSchedule) -> ghidra.app.plugin.core.debug.DebuggerCoordinates: ...

    def resolveTrace(self, __a0: ghidra.trace.model.Trace) -> ghidra.app.plugin.core.debug.DebuggerCoordinates: ...

    def resolveView(self, __a0: ghidra.trace.model.program.TraceProgramView) -> ghidra.app.plugin.core.debug.DebuggerCoordinates: ...
    ...
    def setSynchronizeActive(self, __a0: bool) -> None: ...
    ...
    @property
    def synchronizeActive(self) -> bool: ...

    @synchronizeActive.setter
    def synchronizeActive(self, value: bool) -> None: ...