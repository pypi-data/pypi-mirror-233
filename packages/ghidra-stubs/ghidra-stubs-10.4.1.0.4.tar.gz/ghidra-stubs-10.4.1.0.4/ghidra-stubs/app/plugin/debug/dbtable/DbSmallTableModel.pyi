...
class DbSmallTableModel(docking.widgets.table.AbstractSortedTableModel):
    ...
    @overload
    def getColumnValueForRow(self, rec: db.DBRecord, columnIndex: int) -> object: ...
    ...
    def getModelData(self) -> List[db.DBRecord]: ...
