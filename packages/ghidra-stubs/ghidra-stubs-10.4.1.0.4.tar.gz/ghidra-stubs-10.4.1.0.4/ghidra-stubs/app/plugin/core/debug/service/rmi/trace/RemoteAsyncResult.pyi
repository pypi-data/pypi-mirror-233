...
class RemoteAsyncResult(java.util.concurrent.CompletableFuture):
    ...
    @overload
    def __init__(self, __a0: ghidra.app.plugin.core.debug.service.rmi.trace.OpenTrace): ...
    ...
    def thenAccept(self, __a0: java.util.function.Consumer) -> java.util.concurrent.CompletableFuture: ...
