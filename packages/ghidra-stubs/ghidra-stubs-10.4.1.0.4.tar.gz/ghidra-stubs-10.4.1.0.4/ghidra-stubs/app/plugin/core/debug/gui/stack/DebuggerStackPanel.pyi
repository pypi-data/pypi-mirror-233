...
class DebuggerStackPanel(ghidra.app.plugin.core.debug.gui.model.AbstractObjectsTableBasedPanel):




    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.stack.DebuggerStackProvider): ...
