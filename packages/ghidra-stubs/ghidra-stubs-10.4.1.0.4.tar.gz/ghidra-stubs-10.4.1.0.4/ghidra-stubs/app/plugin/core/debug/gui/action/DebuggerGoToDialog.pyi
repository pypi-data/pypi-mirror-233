...
class DebuggerGoToDialog(ghidra.app.plugin.core.debug.gui.breakpoint.AbstractDebuggerSleighInputDialog):
    ...
    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.action.DebuggerGoToTrait): ...



    def addAction(self, __a0: docking.action.DockingActionIf) -> None: ...

    def cancelCallback(self) -> None: ...
    ...
    def prompt(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: unicode) -> unicode: ...
    ...
    def setOffset(self, __a0: unicode) -> None: ...
    ...
    def show(self, __a0: ghidra.app.plugin.processors.sleigh.SleighLanguage, __a1: ghidra.app.plugin.core.debug.gui.action.GoToInput) -> None: ...
    ...
    @offset.setter
    def offset(self, value: unicode) -> None: ...