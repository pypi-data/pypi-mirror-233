...
class DebuggerInterpreterPlugin(ghidra.app.plugin.core.debug.AbstractDebuggerPlugin, ghidra.app.services.DebuggerInterpreterService):
    ...
    def destroyConsole(self, __a0: ghidra.dbg.target.TargetObject, __a1: ghidra.app.plugin.core.interpreter.InterpreterConsole) -> None: ...
