...
class NoneLocationTrackingSpec(java.lang.Enum, ghidra.app.plugin.core.debug.gui.action.LocationTrackingSpec, ghidra.app.plugin.core.debug.gui.action.LocationTracker):
    CONFIG_NAME: unicode = u'TRACK_NONE'
    INSTANCE: ghidra.app.plugin.core.debug.gui.action.NoneLocationTrackingSpec = INSTANCE
    ...
    @overload
    @staticmethod
    def valueOf(__a0: unicode) -> ghidra.app.plugin.core.debug.gui.action.NoneLocationTrackingSpec: ...
    ...
    @staticmethod
    def values() -> List[ghidra.app.plugin.core.debug.gui.action.NoneLocationTrackingSpec]: ...
