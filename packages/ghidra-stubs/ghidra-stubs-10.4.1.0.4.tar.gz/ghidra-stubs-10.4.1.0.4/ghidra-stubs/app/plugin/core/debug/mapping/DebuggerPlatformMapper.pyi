...
class DebuggerPlatformMapper(object):
    ...
    def disassemble(self, __a0: ghidra.trace.model.thread.TraceThread, __a1: ghidra.trace.model.target.TraceObject, __a2: ghidra.program.model.address.Address, __a3: ghidra.program.model.address.AddressSetView, __a4: long, __a5: ghidra.util.task.TaskMonitor) -> ghidra.app.plugin.core.debug.mapping.DisassemblyResult: ...
