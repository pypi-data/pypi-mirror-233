...
class BreakpointActionSet(java.util.LinkedHashSet):
    ...
    def planDeleteTarget(self, __a0: ghidra.dbg.target.TargetBreakpointLocation) -> ghidra.app.plugin.core.debug.service.breakpoint.DeleteTargetBreakpointActionItem: ...
    ...
    def planDisableTarget(self, __a0: ghidra.dbg.target.TargetBreakpointLocation) -> ghidra.app.plugin.core.debug.service.breakpoint.DisableTargetBreakpointActionItem: ...
    ...
    def planEnableTarget(self, __a0: ghidra.dbg.target.TargetBreakpointLocation) -> ghidra.app.plugin.core.debug.service.breakpoint.EnableTargetBreakpointActionItem: ...
