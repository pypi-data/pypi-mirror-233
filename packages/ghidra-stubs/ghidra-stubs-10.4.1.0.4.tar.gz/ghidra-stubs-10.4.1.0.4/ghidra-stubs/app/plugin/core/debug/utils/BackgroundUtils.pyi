...
class BackgroundUtils(java.lang.Enum):
    ...
    class PluginToolExecutorService(java.util.concurrent.AbstractExecutorService):
        ...
        def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: unicode, __a2: ghidra.framework.model.UndoableDomainObject, __a3: int, __a4: List[ghidra.app.plugin.core.debug.utils.BackgroundUtils.PluginToolExecutorService.TaskOpt]): ...
    ...
    @staticmethod
    def async(__a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.framework.model.UndoableDomainObject, __a2: unicode, __a3: bool, __a4: bool, __a5: bool, __a6: java.util.function.BiFunction) -> ghidra.app.plugin.core.debug.utils.BackgroundUtils.AsyncBackgroundCommand: ...
