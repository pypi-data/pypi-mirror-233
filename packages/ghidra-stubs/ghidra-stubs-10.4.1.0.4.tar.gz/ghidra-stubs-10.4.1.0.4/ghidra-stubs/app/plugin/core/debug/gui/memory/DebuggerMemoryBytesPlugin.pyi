...
class DebuggerMemoryBytesPlugin(ghidra.app.plugin.core.byteviewer.AbstractByteViewerPlugin):
    ...
    def closeProvider(self, __a0: ghidra.app.plugin.core.byteviewer.ByteViewerComponentProvider) -> None: ...

    def createNewDisconnectedProvider(self) -> ghidra.app.plugin.core.byteviewer.ProgramByteViewerComponentProvider: ...

    def createViewerIfMissing(self, __a0: ghidra.app.plugin.core.debug.gui.action.LocationTrackingSpec, __a1: bool) -> ghidra.app.plugin.core.debug.gui.memory.DebuggerMemoryBytesProvider: ...
    ...
    def highlightChanged(self, __a0: ghidra.app.plugin.core.byteviewer.ByteViewerComponentProvider, __a1: ghidra.program.util.ProgramSelection) -> None: ...
    ...
    def updateSelection(self, __a0: ghidra.app.plugin.core.byteviewer.ByteViewerComponentProvider, __a1: ghidra.app.events.ProgramSelectionPluginEvent, __a2: ghidra.program.model.listing.Program) -> None: ...
