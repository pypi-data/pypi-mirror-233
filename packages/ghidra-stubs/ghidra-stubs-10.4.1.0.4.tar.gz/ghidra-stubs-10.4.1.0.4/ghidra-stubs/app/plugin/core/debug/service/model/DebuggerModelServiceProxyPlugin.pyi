...
class DebuggerModelServiceProxyPlugin(ghidra.framework.plugintool.Plugin, ghidra.app.plugin.core.debug.service.model.DebuggerModelServiceInternal):
    ...
    def fireSnapEvent(self, __a0: ghidra.app.services.TraceRecorder, __a1: long) -> None: ...
    ...
    @overload
    def getRecorder(self, __a0: ghidra.dbg.target.TargetObject) -> ghidra.app.services.TraceRecorder: ...

    @overload
    def getRecorder(self, __a0: ghidra.trace.model.Trace) -> ghidra.app.services.TraceRecorder: ...

    def getRecorderForSuccessor(self, __a0: ghidra.dbg.target.TargetObject) -> ghidra.app.services.TraceRecorder: ...
    ...
    def recordTarget(self, __a0: ghidra.dbg.target.TargetObject, __a1: ghidra.app.plugin.core.debug.mapping.DebuggerTargetTraceMapper, __a2: ghidra.app.services.ActionSource) -> ghidra.app.services.TraceRecorder: ...

    @overload
    def recordTargetAndActivateTrace(self, __a0: ghidra.dbg.target.TargetObject, __a1: ghidra.app.plugin.core.debug.mapping.DebuggerTargetTraceMapper) -> ghidra.app.services.TraceRecorder: ...

    @overload
    def recordTargetAndActivateTrace(self, __a0: ghidra.dbg.target.TargetObject, __a1: ghidra.app.plugin.core.debug.mapping.DebuggerTargetTraceMapper, __a2: ghidra.app.services.DebuggerTraceManagerService) -> ghidra.app.services.TraceRecorder: ...

    def recordTargetBestOffer(self, __a0: ghidra.dbg.target.TargetObject) -> ghidra.app.services.TraceRecorder: ...

    def recordTargetPromptOffers(self, __a0: ghidra.dbg.target.TargetObject) -> ghidra.app.services.TraceRecorder: ...
