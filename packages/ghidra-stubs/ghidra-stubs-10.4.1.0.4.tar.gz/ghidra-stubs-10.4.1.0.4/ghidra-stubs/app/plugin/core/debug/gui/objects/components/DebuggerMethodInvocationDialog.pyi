...
class DebuggerMethodInvocationDialog(docking.DialogComponentProvider, java.beans.PropertyChangeListener):




    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: unicode, __a2: unicode, __a3: javax.swing.Icon): ...
    ...
    def getArguments(self) -> java.util.Map: ...
    ...
    def getMemorizedArgument(self, __a0: unicode, __a1: java.lang.Class) -> object: ...
    ...
    def promptArguments(self, __a0: java.util.Map) -> java.util.Map: ...
    ...
    def setMemorizedArgument(self, __a0: unicode, __a1: java.lang.Class, __a2: object) -> None: ...
    ...
    def setParameters(self, __a0: java.util.Map) -> None: ...
    ...
    @property
    def arguments(self) -> java.util.Map: ...

    @property
    def parameters(self) -> None: ...  # No getter available.

    @parameters.setter
    def parameters(self, value: java.util.Map) -> None: ...

    @property
    def resetRequested(self) -> bool: ...