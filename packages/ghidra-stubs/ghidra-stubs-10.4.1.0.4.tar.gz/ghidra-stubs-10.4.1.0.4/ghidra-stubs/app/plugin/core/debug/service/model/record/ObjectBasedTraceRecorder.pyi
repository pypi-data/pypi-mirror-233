...
class ObjectBasedTraceRecorder(object, ghidra.app.services.TraceRecorder):




    def __init__(self, __a0: ghidra.app.plugin.core.debug.service.model.DebuggerModelServicePlugin, __a1: ghidra.trace.model.Trace, __a2: ghidra.dbg.target.TargetObject, __a3: ghidra.app.plugin.core.debug.mapping.ObjectBasedDebuggerTargetTraceMapper): ...



    def addListener(self, __a0: ghidra.app.services.TraceRecorderListener) -> None: ...
    ...
    def getMemoryMapper(self) -> ghidra.app.plugin.core.debug.mapping.DebuggerMemoryMapper: ...

    def getRegisterMapper(self, __a0: ghidra.trace.model.thread.TraceThread) -> ghidra.app.plugin.core.debug.mapping.DebuggerRegisterMapper: ...
    ...
    def removeListener(self, __a0: ghidra.app.services.TraceRecorderListener) -> None: ...
    ...
    @property
    def memoryMapper(self) -> ghidra.app.plugin.core.debug.mapping.DebuggerMemoryMapper: ...
