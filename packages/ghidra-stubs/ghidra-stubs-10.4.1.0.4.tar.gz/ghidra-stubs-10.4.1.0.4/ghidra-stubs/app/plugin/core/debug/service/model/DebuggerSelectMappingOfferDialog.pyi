...
class DebuggerSelectMappingOfferDialog(docking.ReusableDialogComponentProvider):
    ...
    class OfferPanel(javax.swing.JPanel):
        ...
        def getSelectedOffer(self) -> ghidra.app.plugin.core.debug.mapping.DebuggerMappingOffer: ...
        ...
        def setSelectedOffer(self, __a0: ghidra.app.plugin.core.debug.mapping.DebuggerMappingOffer) -> None: ...
        ...
        @property
        def selectedOffer(self) -> ghidra.app.plugin.core.debug.mapping.DebuggerMappingOffer: ...

        @selectedOffer.setter
        def selectedOffer(self, value: ghidra.app.plugin.core.debug.mapping.DebuggerMappingOffer) -> None: ...
