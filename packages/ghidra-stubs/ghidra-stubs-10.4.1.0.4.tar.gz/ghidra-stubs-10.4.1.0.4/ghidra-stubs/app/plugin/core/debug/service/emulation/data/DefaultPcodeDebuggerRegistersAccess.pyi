...
class DefaultPcodeDebuggerRegistersAccess(ghidra.pcode.exec.trace.data.DefaultPcodeTraceRegistersAccess, ghidra.app.plugin.core.debug.service.emulation.data.PcodeDebuggerRegistersAccess, ghidra.app.plugin.core.debug.service.emulation.data.InternalPcodeDebuggerDataAccess):
    ...
    def getPropertyOps(self, __a0: unicode, __a1: java.lang.Class, __a2: bool) -> ghidra.trace.model.property.TracePropertyMapSpace: ...
