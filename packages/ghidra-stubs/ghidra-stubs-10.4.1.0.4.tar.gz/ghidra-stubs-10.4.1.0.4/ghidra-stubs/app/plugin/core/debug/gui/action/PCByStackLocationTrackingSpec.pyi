...
class PCByStackLocationTrackingSpec(java.lang.Enum, ghidra.app.plugin.core.debug.gui.action.LocationTrackingSpec, ghidra.app.plugin.core.debug.gui.action.LocationTracker):
    CONFIG_NAME: unicode = u'TRACK_PC_BY_STACK'
    INSTANCE: ghidra.app.plugin.core.debug.gui.action.PCByStackLocationTrackingSpec = INSTANCE
