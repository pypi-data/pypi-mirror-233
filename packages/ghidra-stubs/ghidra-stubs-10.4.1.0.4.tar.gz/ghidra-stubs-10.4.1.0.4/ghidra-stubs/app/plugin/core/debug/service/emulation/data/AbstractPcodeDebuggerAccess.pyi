...
class AbstractPcodeDebuggerAccess(ghidra.pcode.exec.trace.data.AbstractPcodeTraceAccess, ghidra.app.plugin.core.debug.service.emulation.data.PcodeDebuggerAccess):




    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.app.services.TraceRecorder, __a2: ghidra.trace.model.guest.TracePlatform, __a3: long): ...
