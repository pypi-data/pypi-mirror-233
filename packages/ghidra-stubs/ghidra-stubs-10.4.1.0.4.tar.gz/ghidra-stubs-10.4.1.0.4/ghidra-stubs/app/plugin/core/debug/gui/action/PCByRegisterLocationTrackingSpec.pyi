...
class PCByRegisterLocationTrackingSpec(java.lang.Enum, ghidra.app.plugin.core.debug.gui.action.RegisterLocationTrackingSpec):
    CONFIG_NAME: unicode = u'TRACK_PC_BY_REGISTER'
    INSTANCE: ghidra.app.plugin.core.debug.gui.action.PCByRegisterLocationTrackingSpec = INSTANCE
    ...
    def computeDefaultAddressSpace(self, __a0: ghidra.app.plugin.core.debug.DebuggerCoordinates) -> ghidra.program.model.address.AddressSpace: ...

    def computeRegister(self, __a0: ghidra.app.plugin.core.debug.DebuggerCoordinates) -> ghidra.program.model.lang.Register: ...
    ...
    def doComputeTraceAddress(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.app.plugin.core.debug.DebuggerCoordinates) -> ghidra.program.model.address.Address: ...
    ...
    @overload
    @staticmethod
    def valueOf(__a0: unicode) -> ghidra.app.plugin.core.debug.gui.action.PCByRegisterLocationTrackingSpec: ...
    ...
    @staticmethod
    def values() -> List[ghidra.app.plugin.core.debug.gui.action.PCByRegisterLocationTrackingSpec]: ...
