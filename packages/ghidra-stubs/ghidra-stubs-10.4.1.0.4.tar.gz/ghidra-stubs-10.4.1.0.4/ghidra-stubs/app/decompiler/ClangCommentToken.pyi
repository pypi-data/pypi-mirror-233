...
class ClangCommentToken(ghidra.app.decompiler.ClangToken):
    """
    ...
    @staticmethod
    def derive(source: ghidra.app.decompiler.ClangCommentToken, text: unicode) -> ghidra.app.decompiler.ClangCommentToken: ...
