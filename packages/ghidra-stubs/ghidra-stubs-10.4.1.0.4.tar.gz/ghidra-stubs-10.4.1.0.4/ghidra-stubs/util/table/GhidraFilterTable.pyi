...
class GhidraFilterTable(docking.widgets.table.GFilterTable):




    def __init__(self, model: docking.widgets.table.RowObjectTableModel): ...
    ...
    def addSelectionListener(self, l: docking.widgets.table.ObjectSelectedListener) -> None: ...
    ...
    def getCellValue(self, point: java.awt.Point) -> object: ...
    ...
    def getFilterPanel(self) -> docking.widgets.table.GTableFilterPanel: ...
    ...
    def getModel(self) -> docking.widgets.table.RowObjectTableModel: ...
    ...
    def getSelectedRowObjects(self) -> List[ROW_OBJECT]:
        """
    ...
    def removeSelectionListener(self, l: docking.widgets.table.ObjectSelectedListener) -> None: ...
    ...
    def setFiterText(self, text: unicode) -> None: ...
    ...
    def setSelectedRowObject(self, __a0: object) -> None: ...
