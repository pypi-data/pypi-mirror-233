...
class AbstractGhidraColumnRenderer(ghidra.util.table.GhidraTableCellRenderer, ghidra.util.table.column.GColumnRenderer):
    """
    A convenience base class that combines the GhidraTableCellRenderer with the 
