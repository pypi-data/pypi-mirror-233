...
class DBCachedObjectStoreKeySet(object, java.util.NavigableSet):




    def __init__(self, __a0: ghidra.util.database.DBCachedObjectStore, __a1: db.util.ErrorHandler, __a2: java.util.concurrent.locks.ReadWriteLock, __a3: ghidra.util.database.DirectedIterator.Direction): ...

    def __iter__(self): ...

    @overload
    def add(self, __a0: long) -> bool: ...
    ...
    @overload
    def ceiling(self, __a0: long) -> long: ...
    ...
    @overload
    def headSet(self, __a0: long) -> ghidra.util.database.DBCachedObjectStoreKeySubSet: ...

    @overload
    def headSet(self, __a0: object) -> java.util.SortedSet: ...

    @overload
    def headSet(self, __a0: long, __a1: bool) -> ghidra.util.database.DBCachedObjectStoreKeySubSet: ...

    @overload
    def headSet(self, __a0: object, __a1: bool) -> java.util.NavigableSet: ...

    @overload
    def higher(self, __a0: long) -> long: ...
    ...
    @overload
    def subSet(self, __a0: long, __a1: long) -> ghidra.util.database.DBCachedObjectStoreKeySubSet: ...

    @overload
    def subSet(self, __a0: object, __a1: object) -> java.util.SortedSet: ...

    @overload
    def subSet(self, __a0: long, __a1: bool, __a2: long, __a3: bool) -> ghidra.util.database.DBCachedObjectStoreKeySubSet: ...

    @overload
    def subSet(self, __a0: object, __a1: bool, __a2: object, __a3: bool) -> java.util.NavigableSet: ...

    @overload
    def tailSet(self, __a0: long) -> ghidra.util.database.DBCachedObjectStoreKeySubSet: ...

    @overload
    def tailSet(self, __a0: object) -> java.util.SortedSet: ...

    @overload
    def tailSet(self, __a0: long, __a1: bool) -> ghidra.util.database.DBCachedObjectStoreKeySubSet: ...
