...
class FunctionSignatureSourceFieldLocation(ghidra.program.util.FunctionLocation):
    """
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, locationAddr: ghidra.program.model.address.Address, functionAddr: ghidra.program.model.address.Address, source: unicode, charOffset: int):
        """
    ...
    def getSignatureSource(self) -> unicode:
        """
    ...
    @property
    def signatureSource(self) -> unicode: ...