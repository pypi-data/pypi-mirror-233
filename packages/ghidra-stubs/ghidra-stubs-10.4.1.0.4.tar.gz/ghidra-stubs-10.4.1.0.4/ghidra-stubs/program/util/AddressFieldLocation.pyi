...
class AddressFieldLocation(ghidra.program.util.CodeUnitLocation):
    """
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, componentPath: List[int], addrRepresentation: unicode, charOffset: int):
        """
    ...
    def getAddressRepresentation(self) -> unicode:
        """
    ...
    @property
    def addressRepresentation(self) -> unicode: ...