...
class FunctionNameFieldLocation(ghidra.program.util.FunctionSignatureFieldLocation):
    """
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, functionName: unicode): ...

    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, functionAddr: ghidra.program.model.address.Address, col: int, signature: unicode, functionName: unicode):
        """
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, locationAddr: ghidra.program.model.address.Address, functionAddr: ghidra.program.model.address.Address, charOffset: int, signature: unicode, functionName: unicode):
        """
        Construct a new FunctionNameFieldLocation object.
        @param program the program of the location
