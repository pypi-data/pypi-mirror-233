...
class FunctionSignatureFieldLocation(ghidra.program.util.FunctionLocation):
    """
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, functionAddr: ghidra.program.model.address.Address, col: int, signature: unicode):
        """
    ...
    @property
    def fieldBasedPositioning(self) -> bool: ...
