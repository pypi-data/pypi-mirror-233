...
class RegisterTransitionFieldLocation(ghidra.program.util.ProgramLocation):
    """
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, registerNames: List[unicode], row: int, column: int): ...
