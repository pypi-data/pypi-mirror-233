...
class DividerLocation(ghidra.program.util.ProgramLocation):
    """
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, groupPath: ghidra.program.util.GroupPath, charOffset: int):
        """
