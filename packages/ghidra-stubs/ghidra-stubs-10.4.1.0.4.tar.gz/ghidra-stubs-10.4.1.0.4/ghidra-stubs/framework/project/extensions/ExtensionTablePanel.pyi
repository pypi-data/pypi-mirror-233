...
class ExtensionTablePanel(javax.swing.JPanel):
    ...
    def getSelectedItem(self) -> ghidra.framework.project.extensions.ExtensionDetails: ...
    ...
    def getTableModel(self) -> ghidra.framework.project.extensions.ExtensionTableModel: ...
    ...
    def setExtensions(self, extensions: java.util.Set) -> None:
        """
    ...
    @property
    def extensions(self) -> None: ...  # No getter available.

    @extensions.setter
    def extensions(self, value: java.util.Set) -> None: ...

    @property
    def filterPanel(self) -> docking.widgets.table.GTableFilterPanel: ...

    @property
    def selectedItem(self) -> ghidra.framework.project.extensions.ExtensionDetails: ...

    @property
    def table(self) -> docking.widgets.table.GTable: ...

    @property
    def tableModel(self) -> ghidra.framework.project.extensions.ExtensionTableModel: ...