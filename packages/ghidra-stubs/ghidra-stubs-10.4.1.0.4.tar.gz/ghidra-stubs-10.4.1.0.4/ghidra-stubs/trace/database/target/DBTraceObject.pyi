...
class DBTraceObject(ghidra.util.database.DBAnnotatedObject, ghidra.trace.model.target.TraceObject):
    ...
    @overload
    def setValue(self, __a0: ghidra.trace.model.Lifespan, __a1: unicode, __a2: object, __a3: ghidra.trace.model.target.TraceObject.ConflictResolution) -> ghidra.trace.database.target.InternalTraceObjectValue: ...
