...
class DBTraceCodeManager(ghidra.trace.database.space.AbstractDBTraceSpaceBasedManager, ghidra.trace.model.listing.TraceCodeManager, ghidra.trace.database.space.DBTraceDelegatingManager):
    ...
    def clearData(self, __a0: java.util.LinkedList, __a1: ghidra.util.task.TaskMonitor) -> None: ...
    ...
    @overload
    def getCodeSpace(self, __a0: ghidra.program.model.address.AddressSpace, __a1: bool) -> ghidra.trace.database.listing.DBTraceCodeSpace: ...
