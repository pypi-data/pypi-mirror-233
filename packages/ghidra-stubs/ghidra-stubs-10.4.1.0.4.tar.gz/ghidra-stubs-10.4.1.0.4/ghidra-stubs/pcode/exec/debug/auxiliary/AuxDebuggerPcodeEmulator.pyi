...
class AuxDebuggerPcodeEmulator(ghidra.pcode.exec.trace.auxiliary.AuxTracePcodeEmulator, ghidra.app.plugin.core.debug.service.emulation.DebuggerPcodeMachine):




    def __init__(self, __a0: ghidra.app.plugin.core.debug.service.emulation.data.PcodeDebuggerAccess): ...
    ...
    def createLocalState(self, __a0: ghidra.pcode.emu.PcodeThread) -> ghidra.pcode.exec.PcodeExecutorState: ...
