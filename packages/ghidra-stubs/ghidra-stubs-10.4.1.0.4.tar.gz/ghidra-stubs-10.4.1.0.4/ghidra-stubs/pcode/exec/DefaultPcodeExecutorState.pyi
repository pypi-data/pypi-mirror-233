...
class DefaultPcodeExecutorState(object, ghidra.pcode.exec.PcodeExecutorState):
    ...
    @overload
    def __init__(self, __a0: ghidra.pcode.exec.PcodeExecutorStatePiece): ...

    @overload
    def __init__(self, __a0: ghidra.pcode.exec.PcodeExecutorStatePiece, __a1: ghidra.pcode.exec.PcodeArithmetic): ...
