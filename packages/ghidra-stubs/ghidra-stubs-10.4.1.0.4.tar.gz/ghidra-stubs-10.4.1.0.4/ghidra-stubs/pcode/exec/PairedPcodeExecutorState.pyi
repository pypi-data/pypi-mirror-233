...
class PairedPcodeExecutorState(object, ghidra.pcode.exec.PcodeExecutorState):
    ...
    @overload
    def __init__(self, __a0: ghidra.pcode.exec.PairedPcodeExecutorStatePiece): ...

    @overload
    def __init__(self, __a0: ghidra.pcode.exec.PcodeExecutorState, __a1: ghidra.pcode.exec.PcodeExecutorStatePiece): ...

    @overload
    def __init__(self, __a0: ghidra.pcode.exec.PcodeExecutorState, __a1: ghidra.pcode.exec.PcodeExecutorStatePiece, __a2: ghidra.pcode.exec.PcodeArithmetic): ...
