...
class MemoryPageOverlay(ghidra.pcode.memstate.MemoryPageBank):




    def __init__(self, __a0: ghidra.program.model.address.AddressSpace, __a1: ghidra.pcode.memstate.MemoryBank, __a2: ghidra.pcode.memstate.MemoryFaultHandler): ...
