...
class CombinedFunctionAndDataReferenceProgramCorrelator(ghidra.feature.vt.api.correlator.program.VTAbstractReferenceProgramCorrelator):




    def __init__(self, __a0: ghidra.framework.plugintool.ServiceProvider, __a1: ghidra.program.model.listing.Program, __a2: ghidra.program.model.address.AddressSetView, __a3: ghidra.program.model.listing.Program, __a4: ghidra.program.model.address.AddressSetView, __a5: unicode, __a6: ghidra.framework.options.ToolOptions): ...
