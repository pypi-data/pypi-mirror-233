...
class GhidraVersionTrackingScript(ghidra.app.script.GhidraScript):
    ...
    @overload
    def askAddress(self, __a0: unicode, __a1: unicode, __a2: unicode) -> ghidra.program.model.address.Address: ...
    ...
    def askPassword(self, __a0: unicode, __a1: unicode) -> ghidra.framework.generic.auth.Password: ...
    ...
    def createClass(self, __a0: ghidra.program.model.symbol.Namespace, __a1: unicode) -> ghidra.program.model.listing.GhidraClass: ...
    ...
    def createNamespace(self, __a0: ghidra.program.model.symbol.Namespace, __a1: unicode) -> ghidra.program.model.symbol.Namespace: ...
    ...
    def setReusePreviousChoices(self, __a0: bool) -> None: ...
