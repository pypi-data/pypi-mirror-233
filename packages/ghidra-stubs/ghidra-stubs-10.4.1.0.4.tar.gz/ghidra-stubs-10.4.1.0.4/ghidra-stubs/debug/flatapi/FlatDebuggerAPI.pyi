...
class FlatDebuggerAPI(object):





    class ExpectingBreakpointChanges(object, java.lang.AutoCloseable):




        def __init__(self, __a0: ghidra.debug.flatapi.FlatDebuggerAPI, __a1: ghidra.app.services.DebuggerLogicalBreakpointService): ...
    ...
    @overload
    def execute(self, __a0: ghidra.dbg.target.TargetInterpreter, __a1: unicode) -> bool: ...
    ...
    @overload
    def executeCapture(self, __a0: ghidra.dbg.target.TargetInterpreter, __a1: unicode) -> unicode: ...
    ...
    @overload
    def findInterface(self, __a0: java.lang.Class) -> ghidra.dbg.target.TargetObject: ...

    @overload
    def findInterface(self, __a0: ghidra.dbg.target.TargetObject, __a1: java.lang.Class) -> ghidra.dbg.target.TargetObject: ...

    @overload
    def findInterface(self, __a0: ghidra.trace.model.Trace, __a1: java.lang.Class) -> ghidra.dbg.target.TargetObject: ...

    @overload
    def findInterface(self, __a0: ghidra.trace.model.thread.TraceThread, __a1: java.lang.Class) -> ghidra.dbg.target.TargetObject: ...
    ...
    def getCurrentDebuggerCoordinates(self) -> ghidra.app.plugin.core.debug.DebuggerCoordinates: ...
    ...
    def getCurrentRecorder(self) -> ghidra.app.services.TraceRecorder: ...
    ...
    @overload
    def getExecutionState(self, __a0: ghidra.dbg.target.TargetObject) -> ghidra.dbg.target.TargetExecutionStateful.TargetExecutionState: ...
    ...
    @overload
    def getLaunchOffers(self) -> List[object]: ...

    @overload
    def getLaunchOffers(self, __a0: ghidra.program.model.listing.Program) -> List[object]: ...
    ...
    @overload
    def getModelValue(self, __a0: unicode) -> object: ...

    @overload
    def getModelValue(self, __a0: ghidra.dbg.DebuggerObjectModel, __a1: unicode) -> object: ...

    @overload
    def getProgramCounter(self) -> ghidra.program.model.address.Address: ...

    @overload
    def getProgramCounter(self, __a0: ghidra.app.plugin.core.debug.DebuggerCoordinates) -> ghidra.program.model.address.Address: ...

    @overload
    def getStackPointer(self) -> ghidra.program.model.address.Address: ...

    @overload
    def getStackPointer(self, __a0: ghidra.app.plugin.core.debug.DebuggerCoordinates) -> ghidra.program.model.address.Address: ...
    ...
    def getTargetFocus(self, __a0: ghidra.trace.model.Trace) -> ghidra.dbg.target.TargetObject: ...
    ...
    @overload
    def interrupt(self, __a0: ghidra.dbg.target.TargetInterruptible) -> bool: ...
    ...
    @overload
    def kill(self, __a0: ghidra.dbg.target.TargetKillable) -> bool: ...
    ...
    @overload
    def launch(self, __a0: ghidra.util.task.TaskMonitor) -> ghidra.app.plugin.core.debug.service.model.launch.DebuggerProgramLaunchOffer.LaunchResult: ...

    @overload
    def launch(self, __a0: unicode, __a1: ghidra.util.task.TaskMonitor) -> ghidra.app.plugin.core.debug.service.model.launch.DebuggerProgramLaunchOffer.LaunchResult: ...

    @overload
    def launch(self, __a0: ghidra.app.plugin.core.debug.service.model.launch.DebuggerProgramLaunchOffer, __a1: ghidra.util.task.TaskMonitor) -> ghidra.app.plugin.core.debug.service.model.launch.DebuggerProgramLaunchOffer.LaunchResult: ...

    @overload
    def launch(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.util.task.TaskMonitor) -> ghidra.app.plugin.core.debug.service.model.launch.DebuggerProgramLaunchOffer.LaunchResult: ...

    @overload
    def launch(self, __a0: ghidra.app.plugin.core.debug.service.model.launch.DebuggerProgramLaunchOffer, __a1: unicode, __a2: ghidra.util.task.TaskMonitor) -> ghidra.app.plugin.core.debug.service.model.launch.DebuggerProgramLaunchOffer.LaunchResult: ...

    @overload
    def launch(self, __a0: ghidra.program.model.listing.Program, __a1: unicode, __a2: ghidra.util.task.TaskMonitor) -> ghidra.app.plugin.core.debug.service.model.launch.DebuggerProgramLaunchOffer.LaunchResult: ...
    ...
    def refreshObjectChildren(self, __a0: ghidra.dbg.target.TargetObject) -> java.util.Set: ...
    ...
    def refreshSubtree(self, __a0: ghidra.dbg.target.TargetObject) -> bool: ...
    ...
    def requireLaunchOffer(self, __a0: ghidra.program.model.listing.Program) -> ghidra.app.plugin.core.debug.service.model.launch.DebuggerProgramLaunchOffer: ...
    ...
    @overload
    def resume(self, __a0: ghidra.dbg.target.TargetResumable) -> bool: ...
    ...
    @overload
    def setControlMode(self, __a0: ghidra.app.services.ControlMode) -> None: ...

    @overload
    def setControlMode(self, __a0: ghidra.trace.model.Trace, __a1: ghidra.app.services.ControlMode) -> None: ...
    ...
    @overload
    def step(self, __a0: ghidra.dbg.target.TargetSteppable, __a1: ghidra.dbg.target.TargetSteppable.TargetStepKind) -> bool: ...

    @overload
    def step(self, __a0: ghidra.trace.model.thread.TraceThread, __a1: ghidra.dbg.target.TargetSteppable.TargetStepKind) -> bool: ...
    ...
    @overload
    def waitForBreak(self, __a0: ghidra.dbg.target.TargetObject, __a1: long, __a2: java.util.concurrent.TimeUnit) -> None: ...
    ...
    @controlMode.setter
    def controlMode(self, value: ghidra.app.services.ControlMode) -> None: ...
    ...
    @property
    def currentDebuggerCoordinates(self) -> ghidra.app.plugin.core.debug.DebuggerCoordinates: ...
    ...
    @property
    def currentRecorder(self) -> ghidra.app.services.TraceRecorder: ...
    ...
    @property
    def launchOffers(self) -> List[object]: ...

    @property
    def mappingService(self) -> ghidra.app.services.DebuggerStaticMappingService: ...

    @property
    def modelService(self) -> ghidra.app.services.DebuggerModelService: ...
