...
class FunctionBitPatternsGTree(docking.widgets.tree.GTree):




    def __init__(self, __a0: ghidra.bitpatterns.info.FunctionBitPatternsGTreeRootNode, __a1: ghidra.bitpatterns.info.PatternType): ...
    ...
    @staticmethod
    def createTree(__a0: List[object], __a1: ghidra.bitpatterns.info.PatternType, __a2: ghidra.bitpatterns.info.PercentageFilter) -> ghidra.bitpatterns.info.FunctionBitPatternsGTree: ...
    ...
    def forceNewNodeIntoView(self, __a0: docking.widgets.tree.GTreeNode, __a1: unicode, __a2: java.util.function.Consumer) -> None: ...
    ...
    def getModelNode(self, __a0: docking.widgets.tree.GTreeNode) -> docking.widgets.tree.GTreeNode: ...
    ...
    def getViewNode(self, __a0: docking.widgets.tree.GTreeNode) -> docking.widgets.tree.GTreeNode: ...
    ...
    def setTotalNum(self, __a0: int) -> None: ...
    ...
    @overload
    def startEditing(self, __a0: docking.widgets.tree.GTreeNode) -> None: ...
    ...
    @totalNum.setter
    def totalNum(self, value: int) -> None: ...
