...
class ConcretionError(ghidra.pcode.exec.PcodeExecutionException):




    def __init__(self, __a0: unicode, __a1: ghidra.pcode.exec.PcodeArithmetic.Purpose): ...
    ...
    def getPurpose(self) -> ghidra.pcode.exec.PcodeArithmetic.Purpose: ...
    ...
    @property
    def purpose(self) -> ghidra.pcode.exec.PcodeArithmetic.Purpose: ...