...
class AccessPcodeExecutionException(ghidra.pcode.exec.PcodeExecutionException):
    ...
    @overload
    def __init__(self, __a0: unicode, __a1: java.lang.Exception): ...

    @overload
    def __init__(self, __a0: unicode, __a1: ghidra.pcode.exec.PcodeFrame, __a2: java.lang.Throwable): ...
