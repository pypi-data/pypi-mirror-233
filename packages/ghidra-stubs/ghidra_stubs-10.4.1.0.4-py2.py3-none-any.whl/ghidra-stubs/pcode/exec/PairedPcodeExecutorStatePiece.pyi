...
class PairedPcodeExecutorStatePiece(object, ghidra.pcode.exec.PcodeExecutorStatePiece):
    ...
    @overload
    def __init__(self, __a0: ghidra.pcode.exec.PcodeExecutorStatePiece, __a1: ghidra.pcode.exec.PcodeExecutorStatePiece): ...

    @overload
    def __init__(self, __a0: ghidra.pcode.exec.PcodeExecutorStatePiece, __a1: ghidra.pcode.exec.PcodeExecutorStatePiece, __a2: ghidra.pcode.exec.PcodeArithmetic, __a3: ghidra.pcode.exec.PcodeArithmetic): ...
