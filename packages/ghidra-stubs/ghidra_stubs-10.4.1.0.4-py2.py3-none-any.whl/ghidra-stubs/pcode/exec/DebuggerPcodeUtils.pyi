...
class DebuggerPcodeUtils(java.lang.Enum):
    ...
    @staticmethod
    def compileExpression(__a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.app.plugin.core.debug.DebuggerCoordinates, __a2: unicode) -> ghidra.pcode.exec.PcodeExpression: ...

    @staticmethod
    def compileProgram(__a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.app.plugin.core.debug.DebuggerCoordinates, __a2: unicode, __a3: unicode, __a4: ghidra.pcode.exec.PcodeUseropLibrary) -> ghidra.pcode.exec.PcodeProgram: ...
