...
class PcodeExecutor(object):
    ...
    def __init__(self, __a0: ghidra.app.plugin.processors.sleigh.SleighLanguage, __a1: ghidra.pcode.exec.PcodeArithmetic, __a2: ghidra.pcode.exec.PcodeExecutorState, __a3: ghidra.pcode.exec.PcodeExecutorStatePiece.Reason): ...
