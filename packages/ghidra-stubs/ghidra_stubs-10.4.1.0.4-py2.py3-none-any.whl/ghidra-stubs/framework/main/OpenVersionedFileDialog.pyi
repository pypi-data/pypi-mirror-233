...
class OpenVersionedFileDialog(ghidra.framework.main.DataTreeDialog):
    ...
    def __init__(self, tool: ghidra.framework.plugintool.PluginTool, title: unicode, domainObjectClass: java.lang.Class):
        """
        Constructor
    ...
    def getDomainObject(self, consumer: object, immutable: bool) -> object:
        """
    ...
    def setOpenObjectChoices(self, openDomainObjects: List[object]) -> None:
        """
    ...
    @property
    def openObjectChoices(self) -> None: ...  # No getter available.

    @openObjectChoices.setter
    def openObjectChoices(self, value: List[object]) -> None: ...
