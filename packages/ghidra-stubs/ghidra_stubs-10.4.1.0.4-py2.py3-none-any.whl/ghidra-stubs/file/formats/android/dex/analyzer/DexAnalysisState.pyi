...
class DexAnalysisState(object, ghidra.app.plugin.core.analysis.AnalysisState):
    ...
    @overload
    @staticmethod
    def getState(__a0: ghidra.program.model.listing.Program, __a1: ghidra.program.model.address.Address) -> ghidra.file.formats.android.dex.analyzer.DexAnalysisState: ...
