...
class TargetObjectSchema(object):
    DEFAULT_ATTRIBUTE_RESYNC: ghidra.dbg.target.schema.TargetObjectSchema.ResyncMode = NEVER
    DEFAULT_ELEMENT_RESYNC: ghidra.dbg.target.schema.TargetObjectSchema.ResyncMode = NEVER
    ...
    class AttributeSchema(object):
        DEFAULT_ANY: ghidra.dbg.target.schema.TargetObjectSchema.AttributeSchema = <attr name= schema=ANY required=false fixed=false hidden=true>
        DEFAULT_OBJECT: ghidra.dbg.target.schema.TargetObjectSchema.AttributeSchema = <attr name= schema=OBJECT required=false fixed=false hidden=true>
        DEFAULT_VOID: ghidra.dbg.target.schema.TargetObjectSchema.AttributeSchema = <attr name= schema=VOID required=false fixed=true hidden=true>
    ...
    class ResyncMode(java.lang.Enum):
        ALWAYS: ghidra.dbg.target.schema.TargetObjectSchema.ResyncMode = ALWAYS
        NEVER: ghidra.dbg.target.schema.TargetObjectSchema.ResyncMode = NEVER
        ONCE: ghidra.dbg.target.schema.TargetObjectSchema.ResyncMode = ONCE
        ...
        def shouldResync(self, __a0: java.util.concurrent.CompletableFuture) -> bool: ...

        def toString(self) -> unicode: ...

        @overload
        @staticmethod
        def valueOf(__a0: unicode) -> ghidra.dbg.target.schema.TargetObjectSchema.ResyncMode: ...
        ...
        @staticmethod
        def values() -> List[ghidra.dbg.target.schema.TargetObjectSchema.ResyncMode]: ...
    ...
    class SchemaName(object, java.lang.Comparable):
        ...
        @overload
        def compareTo(self, __a0: ghidra.dbg.target.schema.TargetObjectSchema.SchemaName) -> int: ...
