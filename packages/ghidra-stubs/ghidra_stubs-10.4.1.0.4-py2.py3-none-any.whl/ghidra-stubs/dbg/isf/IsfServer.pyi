...
class IsfServer(java.lang.Thread):




    def __init__(self, __a0: ghidra.base.project.GhidraProject, __a1: int): ...
    ...
    def getDataTypeManager(self, __a0: unicode) -> ghidra.program.model.data.DataTypeManager: ...
