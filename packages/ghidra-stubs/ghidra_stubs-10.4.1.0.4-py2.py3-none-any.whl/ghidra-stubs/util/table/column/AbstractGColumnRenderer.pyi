...
class AbstractGColumnRenderer(docking.widgets.table.GTableCellRenderer, ghidra.util.table.column.GColumnRenderer):
    """
    A convenience base class that combines the GTableCellRenderer with the 
