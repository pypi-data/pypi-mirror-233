...
class DefaultTimestampRenderer(ghidra.util.table.column.AbstractGColumnRenderer):
    """
    A renderer for clients that wish to display a Date as a timestamp with the
     date and time.
    """
    ...
    @overload
    def getFilterString(self, t: java.util.Date, settings: ghidra.docking.settings.Settings) -> unicode: ...
