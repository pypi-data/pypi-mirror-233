...
class CodeUnitTableCellRenderer(ghidra.util.table.column.AbstractGColumnRenderer):
    """
    ...
    @overload
    def getFilterString(self, t: ghidra.util.table.field.CodeUnitTableCellData, settings: ghidra.docking.settings.Settings) -> unicode: ...
