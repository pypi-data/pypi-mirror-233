...
class PreviewDataTableCellRenderer(ghidra.util.table.column.AbstractGColumnRenderer):
    """
    A custom renderer used to display what is at the ProgramLocation similarly to
     ...
     used directly with PreviewTableCellData column data.
    """
    ...
    @overload
    def firePropertyChange(self, propertyName: unicode, oldValue: bool, newValue: bool) -> None:
        """
    ...
    def getDisplayedMnemonic(self) -> int: ...
    ...
    @overload
    def getFilterString(self, t: ghidra.util.table.PreviewTableCellData, settings: ghidra.docking.settings.Settings) -> unicode: ...
    ...
    def getLabelFor(self) -> java.awt.Component: ...
    ...
    @overload
    def getTableCellRendererComponent(self, table: javax.swing.JTable, value: object, isSelected: bool, hasFocus: bool, row: int, column: int) -> java.awt.Component:
        """
    ...
    @overload
    def repaint(self, r: java.awt.Rectangle) -> None:
        """
        See {@link DefaultTableCellRenderer} class header javadoc for more info.
        """
        ...
    ...
    @overload
    def repaint(self, tm: long, x: int, y: int, width: int, height: int) -> None:
        """
        See {@link DefaultTableCellRenderer} class header javadoc for more info.
        """
        ...
    ...
    @overload
    def setDisplayedMnemonic(self, __a0: int) -> None: ...
    ...
    def setDropRow(self, dropRow: int) -> None:
        """
    ...
    def setFont(self, f: java.awt.Font) -> None: ...

    def setForeground(self, fg: java.awt.Color) -> None:
        """
    ...
    @staticmethod
    def setHTMLRenderingFlag(__a0: javax.swing.JComponent, __a1: bool) -> None: ...

    def setHorizontalAlignment(self, __a0: int) -> None: ...

    def setHorizontalTextPosition(self, __a0: int) -> None: ...

    def setIcon(self, __a0: javax.swing.Icon) -> None: ...
    ...
    def setLabelFor(self, __a0: java.awt.Component) -> None: ...
    ...
    def setShouldAlternateRowBackgroundColors(self, alternate: bool) -> None: ...
    ...
    def setUI(self, __a0: javax.swing.plaf.LabelUI) -> None: ...
    ...
    @staticmethod
    def warnAboutHtmlText(__a0: unicode) -> None: ...
