...
class ElfHeader(object, ghidra.app.util.bin.StructConverter):
    """
    ...
    def __init__(self, provider: ghidra.app.util.bin.ByteProvider, errorConsumer: java.util.function.Consumer):
        """
    ...
    @property
    def programHeaderCount(self) -> int: ...
    ...
    @property
    def sectionHeaderCount(self) -> int: ...
