...
class DIEAggregate(object):
    ...
    def findAttributeInChildren(self, attribute: int, childTag: int, clazz: java.lang.Class) -> object:
        """
    ...
    def getAbstractInstance(self) -> ghidra.app.util.bin.format.dwarf4.DIEAggregate:
        """
    ...
    def getAsLocation(self, attribute: int, range: ghidra.app.util.bin.format.dwarf4.DWARFRange) -> List[ghidra.app.util.bin.format.dwarf4.DWARFLocation]:
        """
    ...
    def getFunctionParamList(self) -> List[ghidra.app.util.bin.format.dwarf4.DIEAggregate]:
        """
    ...
    def isLowPCEqualHighPC(self) -> bool:
        """
    ...
    @property
    def abstractInstance(self) -> ghidra.app.util.bin.format.dwarf4.DIEAggregate: ...
    ...
    @property
    def lowPCEqualHighPC(self) -> bool: ...
