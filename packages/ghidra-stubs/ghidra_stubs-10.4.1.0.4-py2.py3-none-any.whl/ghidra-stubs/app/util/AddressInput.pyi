...
class AddressInput(javax.swing.JPanel, docking.widgets.table.FocusableEditor):
    ...
    def selectDefaultAddressSpace(self) -> None:
        """
    ...
    @overload
    def setAddressFactory(self, factory: ghidra.program.model.address.AddressFactory) -> None:
        """
    ...
    @overload
    def setAddressFactory(self, factory: ghidra.program.model.address.AddressFactory, filterOverlaySpaces: bool, allowOtherSpace: bool) -> None:
        """
    ...
    def setAddressSpaceEditable(self, state: bool) -> None:
        """
    ...
    def setValue(self, value: unicode) -> None:
        """
    ...
    def showAddressSpaceCombo(self, showCombo: bool) -> None: ...
    ...
    @property
    def addressSpaceEditable(self) -> None: ...  # No getter available.

    @addressSpaceEditable.setter
    def addressSpaceEditable(self, value: bool) -> None: ...
    ...
    @value.setter
    def value(self, value: unicode) -> None: ...