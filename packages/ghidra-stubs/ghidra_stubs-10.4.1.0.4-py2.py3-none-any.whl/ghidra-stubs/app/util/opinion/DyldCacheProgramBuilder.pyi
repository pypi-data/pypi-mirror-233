...
class DyldCacheProgramBuilder(ghidra.app.util.opinion.MachoProgramBuilder):
    ...
    @overload
    @staticmethod
    def buildProgram(program: ghidra.program.model.listing.Program, provider: ghidra.app.util.bin.ByteProvider, fileBytes: ghidra.program.database.mem.FileBytes, options: ghidra.app.util.opinion.DyldCacheOptions, log: ghidra.app.util.importer.MessageLog, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
