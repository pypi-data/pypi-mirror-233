...
class MemoryImage(ghidra.pcode.memstate.MemoryBank):
    ...
    def __init__(self, __a0: ghidra.program.model.address.AddressSpace, __a1: bool, __a2: int, __a3: ghidra.app.emulator.memory.MemoryLoadImage, __a4: ghidra.pcode.memstate.MemoryFaultHandler): ...
    ...
    def getPage(self, __a0: long) -> ghidra.pcode.memstate.MemoryPage: ...
