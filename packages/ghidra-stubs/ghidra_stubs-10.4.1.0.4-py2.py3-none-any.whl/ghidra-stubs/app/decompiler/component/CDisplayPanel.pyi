...
class CDisplayPanel(javax.swing.JPanel, ghidra.app.decompiler.component.DecompilerCallbackHandler):




    @overload
    def __init__(self, listener: ghidra.app.decompiler.component.DecompileResultsListener): ...

    @overload
    def __init__(self, decompileOptions: ghidra.app.decompiler.DecompileOptions, listener: ghidra.app.decompiler.component.DecompileResultsListener): ...
    ...
    def clearAndShowMessage(self, message: unicode) -> None: ...
    ...
    def setProgramLocationListener(self, locationListener: ghidra.app.util.viewer.listingpanel.ProgramLocationListener) -> None: ...
    ...
    @overload
    def showFunction(self, function: ghidra.program.model.listing.Function) -> None: ...

    @overload
    def showFunction(self, program: ghidra.program.model.listing.Program, address: ghidra.program.model.address.Address) -> None: ...
