...
class DebuggerBreakpointStateTableCellRenderer(ghidra.util.table.column.AbstractGColumnRenderer):
    ...
    @overload
    def getFilterString(self, __a0: ghidra.app.services.LogicalBreakpoint.State, __a1: ghidra.docking.settings.Settings) -> unicode: ...
    ...
    @overload
    def getTableCellRendererComponent(self, __a0: docking.widgets.table.GTableCellRenderingData) -> java.awt.Component: ...
    ...
    def setDropRow(self, __a0: int) -> None: ...
    ...
    def setShouldAlternateRowBackgroundColors(self, __a0: bool) -> None: ...
