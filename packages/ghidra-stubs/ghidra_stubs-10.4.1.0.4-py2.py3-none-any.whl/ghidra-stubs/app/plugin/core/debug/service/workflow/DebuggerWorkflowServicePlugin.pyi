...
class DebuggerWorkflowServicePlugin(ghidra.framework.plugintool.Plugin, ghidra.app.services.DebuggerWorkflowService, ghidra.framework.main.ApplicationLevelOnlyPlugin, ghidra.framework.options.OptionsChangeListener):
    ...
    def getProxyingPluginTools(self) -> java.util.Collection: ...
    ...
    def pluginToolAdded(self, __a0: ghidra.framework.plugintool.PluginTool) -> None: ...

    def pluginToolRemoved(self, __a0: ghidra.framework.plugintool.PluginTool) -> None: ...
    ...
    @property
    def proxyingPluginTools(self) -> java.util.Collection: ...