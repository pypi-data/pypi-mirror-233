...
class ObjectsTreePanel(javax.swing.JPanel):
    ...
    def addTreeSelectionListener(self, __a0: docking.widgets.tree.support.GTreeSelectionListener) -> None: ...
    ...
    def getSelectedItem(self) -> ghidra.app.plugin.core.debug.gui.model.ObjectTreeModel.AbstractNode: ...
    ...
    def removeTreeSelectionListener(self, __a0: docking.widgets.tree.support.GTreeSelectionListener) -> None: ...
    ...
    @overload
    def setSelectedKeyPaths(self, __a0: java.util.Collection) -> None: ...

    @overload
    def setSelectedKeyPaths(self, __a0: java.util.Collection, __a1: docking.widgets.tree.support.GTreeSelectionEvent.EventOrigin) -> None: ...

    def setSelectedObject(self, __a0: ghidra.trace.model.target.TraceObject) -> None: ...
    ...
    @property
    def limitToSnap(self) -> bool: ...

    @limitToSnap.setter
    def limitToSnap(self, value: bool) -> None: ...

    @property
    def selectedItem(self) -> ghidra.app.plugin.core.debug.gui.model.ObjectTreeModel.AbstractNode: ...

    @property
    def selectedItems(self) -> List[object]: ...

    @property
    def selectedKeyPaths(self) -> None: ...  # No getter available.

    @selectedKeyPaths.setter
    def selectedKeyPaths(self, value: java.util.Collection) -> None: ...

    @property
    def selectedObject(self) -> None: ...  # No getter available.

    @selectedObject.setter
    def selectedObject(self, value: ghidra.trace.model.target.TraceObject) -> None: ...
