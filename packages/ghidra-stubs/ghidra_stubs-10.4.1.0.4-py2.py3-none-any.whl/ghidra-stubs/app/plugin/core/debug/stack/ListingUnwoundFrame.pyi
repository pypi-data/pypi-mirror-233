...
class ListingUnwoundFrame(ghidra.app.plugin.core.debug.stack.AbstractUnwoundFrame):




    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.app.plugin.core.debug.DebuggerCoordinates, __a2: ghidra.trace.model.listing.TraceData): ...
    ...
    def getComponentContaining(self, __a0: ghidra.program.model.address.Address) -> ghidra.trace.model.listing.TraceData: ...
    ...
    @staticmethod
    def isFrame(__a0: ghidra.trace.model.listing.TraceData) -> bool: ...
