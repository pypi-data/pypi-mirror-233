...
class DefaultRegionMapProposal(ghidra.app.plugin.core.debug.service.modules.AbstractMapProposal, ghidra.app.services.RegionMapProposal):





    class DefaultRegionMapEntry(ghidra.app.plugin.core.debug.service.modules.AbstractMapEntry, ghidra.app.services.RegionMapProposal.RegionMapEntry):




        def __init__(self, __a0: ghidra.trace.model.memory.TraceMemoryRegion, __a1: ghidra.program.model.listing.Program, __a2: ghidra.program.model.mem.MemoryBlock): ...
    ...
    @overload
    def getToObject(self, __a0: ghidra.trace.model.memory.TraceMemoryRegion) -> ghidra.program.model.mem.MemoryBlock: ...
