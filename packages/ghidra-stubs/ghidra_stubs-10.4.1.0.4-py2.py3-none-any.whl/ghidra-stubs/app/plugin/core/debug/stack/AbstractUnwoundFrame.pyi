...
class AbstractUnwoundFrame(object, ghidra.app.plugin.core.debug.stack.UnwoundFrame):




    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.app.plugin.core.debug.DebuggerCoordinates, __a2: ghidra.pcode.exec.PcodeExecutorState): ...
