...
class DebuggerSectionsPanel(ghidra.app.plugin.core.debug.gui.model.AbstractObjectsTableBasedPanel):




    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.modules.DebuggerModulesProvider): ...
    ...
    def setFilteredBySelectedModules(self, __a0: bool) -> None: ...
    ...
    @property
    def filteredBySelectedModules(self) -> None: ...  # No getter available.

    @filteredBySelectedModules.setter
    def filteredBySelectedModules(self, value: bool) -> None: ...
