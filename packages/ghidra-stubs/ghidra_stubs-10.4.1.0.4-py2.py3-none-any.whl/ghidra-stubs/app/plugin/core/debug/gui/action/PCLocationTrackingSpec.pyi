...
class PCLocationTrackingSpec(java.lang.Enum, ghidra.app.plugin.core.debug.gui.action.LocationTrackingSpec, ghidra.app.plugin.core.debug.gui.action.LocationTracker):
    CONFIG_NAME: unicode = u'TRACK_PC'
    INSTANCE: ghidra.app.plugin.core.debug.gui.action.PCLocationTrackingSpec = INSTANCE
    ...
    @overload
    @staticmethod
    def valueOf(__a0: unicode) -> ghidra.app.plugin.core.debug.gui.action.PCLocationTrackingSpec: ...
    ...
    @staticmethod
    def values() -> List[ghidra.app.plugin.core.debug.gui.action.PCLocationTrackingSpec]: ...
