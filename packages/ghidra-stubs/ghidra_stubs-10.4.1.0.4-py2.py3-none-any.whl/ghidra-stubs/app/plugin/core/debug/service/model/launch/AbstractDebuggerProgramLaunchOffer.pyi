...
class AbstractDebuggerProgramLaunchOffer(object, ghidra.app.plugin.core.debug.service.model.launch.DebuggerProgramLaunchOffer):




    def __init__(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.framework.plugintool.PluginTool, __a2: ghidra.dbg.DebuggerModelFactory): ...
    ...
    @overload
    def getLauncherArgs(self, __a0: ghidra.dbg.target.TargetLauncher, __a1: bool, __a2: ghidra.app.plugin.core.debug.service.model.launch.DebuggerProgramLaunchOffer.LaunchConfigurator) -> java.util.Map: ...
