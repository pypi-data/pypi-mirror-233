...
import ghidra.app.plugin.core.debug.gui.memory
...
class DebuggerRegionsPanel(ghidra.app.plugin.core.debug.gui.model.AbstractObjectsTableBasedPanel):





    class RegionExecuteColumn(ghidra.app.plugin.core.debug.gui.memory.DebuggerRegionsPanel.RegionFlagColumn):
        ...
        @staticmethod
        def computeAttributeType(__a0: ghidra.dbg.target.schema.SchemaContext, __a1: ghidra.dbg.target.schema.TargetObjectSchema.AttributeSchema) -> java.lang.Class: ...
    ...
    class RegionFlagColumn(ghidra.app.plugin.core.debug.gui.model.columns.TraceValueObjectAttributeColumn):
    ...
    class RegionReadColumn(ghidra.app.plugin.core.debug.gui.memory.DebuggerRegionsPanel.RegionFlagColumn):
    ...
    class RegionWriteColumn(ghidra.app.plugin.core.debug.gui.memory.DebuggerRegionsPanel.RegionFlagColumn):
    ...
    def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.memory.DebuggerRegionsProvider): ...
    ...
    def addCellActivationListener(self, __a0: ghidra.app.plugin.core.debug.gui.model.AbstractQueryTablePanel.CellActivationListener) -> None: ...
    ...
    def addSelectionListener(self, __a0: javax.swing.event.ListSelectionListener) -> None: ...
    ...
    def cellActivated(self, __a0: javax.swing.JTable) -> None: ...
    ...
    def getActionContext(self) -> ghidra.app.plugin.core.debug.gui.model.DebuggerObjectActionContext: ...
    ...
    def getAllItems(self) -> List[object]: ...
    ...
    def getColumnByNameAndType(self, __a0: unicode, __a1: java.lang.Class) -> java.util.Map.Entry: ...
    ...
    @staticmethod
    def getSelected(__a0: ghidra.app.plugin.core.debug.gui.model.DebuggerObjectActionContext, __a1: java.lang.Class) -> java.util.stream.Stream: ...

    def getSelectedItem(self) -> object: ...

    def getSelectedItems(self) -> List[object]: ...
    ...
    @staticmethod
    def isContextNonEmpty(__a0: ghidra.app.plugin.core.debug.gui.model.DebuggerObjectActionContext) -> bool: ...
    ...
    def removeCellActivationListener(self, __a0: ghidra.app.plugin.core.debug.gui.model.AbstractQueryTablePanel.CellActivationListener) -> None: ...
    ...
    def removeSelectionListener(self, __a0: javax.swing.event.ListSelectionListener) -> None: ...
    ...
    def setLimitToSnap(self, __a0: bool) -> None: ...
    ...
    def setSelectedItems(self, __a0: java.util.Collection) -> None: ...
    ...
    @overload
    def trySelect(self, __a0: ghidra.trace.model.target.TraceObject) -> bool: ...

    @overload
    def trySelect(self, __a0: java.util.Collection) -> None: ...

    def trySelectAncestor(self, __a0: ghidra.trace.model.target.TraceObject) -> bool: ...
