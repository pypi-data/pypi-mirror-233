...
class DebuggerLogicalBreakpointServicePlugin(ghidra.framework.plugintool.Plugin, ghidra.app.services.DebuggerLogicalBreakpointService):
    ...
    def addChangeListener(self, __a0: ghidra.app.services.LogicalBreakpointsChangeListener) -> None: ...
    ...
    @overload
    def computeState(self, __a0: ghidra.program.util.ProgramLocation) -> ghidra.app.services.LogicalBreakpoint.State: ...

    @overload
    def computeState(self, __a0: java.util.Collection) -> ghidra.app.services.LogicalBreakpoint.State: ...

    @overload
    def computeState(self, __a0: java.util.Collection, __a1: ghidra.program.model.listing.Program) -> ghidra.app.services.LogicalBreakpoint.State: ...

    @overload
    def computeState(self, __a0: java.util.Collection, __a1: ghidra.program.util.ProgramLocation) -> ghidra.app.services.LogicalBreakpoint.State: ...

    @overload
    def computeState(self, __a0: java.util.Collection, __a1: ghidra.trace.model.Trace) -> ghidra.app.services.LogicalBreakpoint.State: ...
    ...
    def getBreakpoint(self, __a0: ghidra.trace.model.breakpoint.TraceBreakpoint) -> ghidra.app.services.LogicalBreakpoint: ...
    ...
    def removeChangeListener(self, __a0: ghidra.app.services.LogicalBreakpointsChangeListener) -> None: ...
