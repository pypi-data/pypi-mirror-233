...
class DebuggerLegacyRegionsPanel(javax.swing.JPanel):
    ...
    def getActionContext(self) -> ghidra.app.plugin.core.debug.gui.memory.DebuggerRegionActionContext: ...
    ...
    def getSelectedRows(self) -> java.util.Collection: ...
    ...
    @property
    def actionContext(self) -> ghidra.app.plugin.core.debug.gui.memory.DebuggerRegionActionContext: ...
    ...
    @property
    def selectedRows(self) -> java.util.Collection: ...
