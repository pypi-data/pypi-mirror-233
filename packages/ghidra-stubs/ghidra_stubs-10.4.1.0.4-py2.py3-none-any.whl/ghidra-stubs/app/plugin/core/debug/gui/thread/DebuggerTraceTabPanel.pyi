...
class DebuggerTraceTabPanel(docking.widgets.HorizontalTabPanel, ghidra.framework.plugintool.util.PluginEventListener):
    ...
    @staticmethod
    def copyColor(__a0: java.awt.Color) -> java.awt.Color: ...
    ...
    def getActionContext(self) -> ghidra.app.plugin.core.debug.gui.thread.DebuggerTraceFileActionContext: ...
    ...
    def removeItem(self, __a0: object) -> None: ...
    ...
    def setModelService(self, __a0: ghidra.app.services.DebuggerModelService) -> None: ...
    ...
    @property
    def modelService(self) -> None: ...  # No getter available.

    @modelService.setter
    def modelService(self, value: ghidra.app.services.DebuggerModelService) -> None: ...