...
class DebuggerTrackLocationTrait(object):
    ...
    def getDefaultGoToInput(self, __a0: ghidra.program.util.ProgramLocation) -> ghidra.app.plugin.core.debug.gui.action.GoToInput: ...

    def getSelectionGenerator(self) -> ghidra.app.plugin.core.debug.gui.colors.SelectionGenerator: ...

    def getSpec(self) -> ghidra.app.plugin.core.debug.gui.action.LocationTrackingSpec: ...
    ...
    def setSpec(self, __a0: ghidra.app.plugin.core.debug.gui.action.LocationTrackingSpec) -> None: ...
    ...
    @property
    def spec(self) -> ghidra.app.plugin.core.debug.gui.action.LocationTrackingSpec: ...

    @spec.setter
    def spec(self, value: ghidra.app.plugin.core.debug.gui.action.LocationTrackingSpec) -> None: ...
