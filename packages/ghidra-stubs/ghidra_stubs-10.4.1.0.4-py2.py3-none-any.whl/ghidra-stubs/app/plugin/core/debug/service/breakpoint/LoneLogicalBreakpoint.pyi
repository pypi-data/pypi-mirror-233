...
class LoneLogicalBreakpoint(object, ghidra.app.plugin.core.debug.service.breakpoint.LogicalBreakpointInternal):
    ...
    def __init__(self, __a0: ghidra.framework.plugintool.PluginTool, __a1: ghidra.trace.model.Trace, __a2: ghidra.program.model.address.Address, __a3: long, __a4: java.util.Collection): ...
    ...
    def setRecorder(self, __a0: ghidra.trace.model.Trace, __a1: ghidra.app.services.TraceRecorder) -> None: ...
