...
class ConstantPropagationContextEvaluator(ghidra.program.util.ContextEvaluatorAdapter):
    ...
    def setMinpeculativeOffset(self, __a0: long) -> ghidra.app.plugin.core.analysis.ConstantPropagationContextEvaluator: ...
    ...
    @property
    def minpeculativeOffset(self) -> None: ...  # No getter available.

    @minpeculativeOffset.setter
    def minpeculativeOffset(self, value: long) -> None: ...
