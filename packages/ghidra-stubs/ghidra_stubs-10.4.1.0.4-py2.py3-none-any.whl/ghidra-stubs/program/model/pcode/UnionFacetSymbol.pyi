...
class UnionFacetSymbol(ghidra.program.model.pcode.HighSymbol):
    """
    ...
    def __init__(self, uniqueId: long, nm: unicode, dt: ghidra.program.model.data.DataType, fldNum: int, func: ghidra.program.model.pcode.HighFunction): ...



    @staticmethod
    def buildSymbolName(fldNum: int, addr: ghidra.program.model.address.Address) -> unicode:
        """
    ...
    @staticmethod
    def extractFieldNumber(nm: unicode) -> int:
        """
