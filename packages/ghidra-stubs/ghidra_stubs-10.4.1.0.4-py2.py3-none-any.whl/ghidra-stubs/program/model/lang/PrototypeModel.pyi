...
class PrototypeModel(object):
    ...
    @overload
    def __init__(self, name: unicode, model: ghidra.program.model.lang.PrototypeModel):
        """
    ...
    @property
    def aliasParent(self) -> ghidra.program.model.lang.PrototypeModel: ...
    ...
    @property
    def inputListType(self) -> ghidra.program.model.lang.InputListType: ...

    @property
    def killedByCallList(self) -> List[ghidra.program.model.pcode.Varnode]: ...

    @property
    def likelyTrash(self) -> List[ghidra.program.model.pcode.Varnode]: ...
    ...
    @property
    def programExtension(self) -> bool: ...

    @property
    def returnAddress(self) -> List[ghidra.program.model.pcode.Varnode]: ...
    ...
    @property
    def stackshift(self) -> int: ...

    @property
    def unaffectedList(self) -> List[ghidra.program.model.pcode.Varnode]: ...