...
class IndentFieldLocation(ghidra.program.util.CodeUnitLocation):
    """
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, componentPath: List[int]):
        """
