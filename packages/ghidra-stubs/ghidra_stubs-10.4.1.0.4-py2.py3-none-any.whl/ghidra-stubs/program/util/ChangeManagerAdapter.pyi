...
class ChangeManagerAdapter(object, ghidra.program.util.ChangeManager):
    ...
    DOCR_ADDRESS_SET_PROPERTY_MAP_ADDED: int = 167
    DOCR_ADDRESS_SET_PROPERTY_MAP_CHANGED: int = 169
    DOCR_ADDRESS_SET_PROPERTY_MAP_REMOVED: int = 168
    ...
    DOCR_CUSTOM_FORMAT_ADDED: int = 165
    DOCR_CUSTOM_FORMAT_REMOVED: int = 166
    ...
    DOCR_LENGTH_OVERRIDE_CHANGED: int = 164
