...
class PostCommentFieldLocation(ghidra.program.util.CommentFieldLocation):
    """
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, componentPath: List[int], comment: List[unicode], displayableCommentRow: int, charOffset: int):
        """
