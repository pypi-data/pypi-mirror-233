...
class VariableLocation(ghidra.program.util.FunctionLocation):
    """
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, var: ghidra.program.model.listing.Variable, index: int, charOffset: int):
        """
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, locationAddr: ghidra.program.model.address.Address, var: ghidra.program.model.listing.Variable, index: int, charOffset: int):
        """
        Create a new VariableLocation.
        @param program the program of the location
