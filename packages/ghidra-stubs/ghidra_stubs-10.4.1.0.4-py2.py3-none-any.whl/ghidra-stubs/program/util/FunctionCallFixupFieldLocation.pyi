...
class FunctionCallFixupFieldLocation(ghidra.program.util.FunctionLocation):
    """
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, locationAddr: ghidra.program.model.address.Address, functionAddr: ghidra.program.model.address.Address, callFixupName: unicode, charOffset: int):
        """
