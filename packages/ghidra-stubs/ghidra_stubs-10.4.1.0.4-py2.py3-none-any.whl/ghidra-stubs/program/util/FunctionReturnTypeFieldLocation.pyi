...
class FunctionReturnTypeFieldLocation(ghidra.program.util.FunctionSignatureFieldLocation):
    """
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, functionAddr: ghidra.program.model.address.Address, returnType: unicode):
        """
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, functionAddr: ghidra.program.model.address.Address, col: int, signature: unicode, returnType: unicode):
        """
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, locationAddr: ghidra.program.model.address.Address, functionAddr: ghidra.program.model.address.Address, charOffset: int, signature: unicode, returnType: unicode):
        """
        Construct a new FunctionReturnTypeFieldLocation object.
        @param program the program of the location
    ...
    def getReturnType(self) -> unicode:
        """
    ...
    def restoreState(self, restoreProgram: ghidra.program.model.listing.Program, obj: ghidra.framework.options.SaveState) -> None: ...
