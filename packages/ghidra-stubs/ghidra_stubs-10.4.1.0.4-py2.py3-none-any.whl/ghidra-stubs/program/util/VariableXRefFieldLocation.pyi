...
class VariableXRefFieldLocation(ghidra.program.util.VariableLocation):
    """
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, var: ghidra.program.model.listing.Variable, refAddr: ghidra.program.model.address.Address, index: int, charOffset: int):
        """
