...
class PcodeFieldLocation(ghidra.program.util.ProgramLocation):
    ...
    @overload
    def __init__(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.program.model.address.Address, __a2: List[object], __a3: int, __a4: int): ...
    ...
    def getPcodeStrings(self) -> List[unicode]: ...
    ...
    @property
    def pcodeStrings(self) -> List[object]: ...