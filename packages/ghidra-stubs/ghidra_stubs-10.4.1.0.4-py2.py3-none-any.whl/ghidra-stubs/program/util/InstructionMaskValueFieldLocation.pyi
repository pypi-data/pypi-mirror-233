...
class InstructionMaskValueFieldLocation(ghidra.program.util.ProgramLocation):
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, row: int, charOffset: int): ...
