...
class SubDataFieldLocation(ghidra.program.util.CodeUnitLocation):
    """
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address, path: ghidra.program.util.GroupPath, componentPath: List[int], refAddr: ghidra.program.model.address.Address, rep: unicode, charOffset: int, fieldName: unicode):
        """
    ...
    def getDataRepresentation(self) -> unicode:
        """
    ...
    @property
    def dataRepresentation(self) -> unicode: ...
