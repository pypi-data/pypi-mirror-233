...
class ThunkedFunctionFieldLocation(ghidra.program.util.FunctionLocation):
    """
    ...
    @overload
    def __init__(self, program: ghidra.program.model.listing.Program, locationAddr: ghidra.program.model.address.Address, functionAddr: ghidra.program.model.address.Address, thunkedFunctionAddr: ghidra.program.model.address.Address, charOffset: int):
        """
