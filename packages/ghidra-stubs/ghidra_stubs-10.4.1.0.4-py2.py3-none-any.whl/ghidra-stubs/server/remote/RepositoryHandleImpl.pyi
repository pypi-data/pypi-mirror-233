...
class RepositoryHandleImpl(java.rmi.server.UnicastRemoteObject, ghidra.framework.remote.RemoteRepositoryHandle, java.rmi.server.Unreferenced):
    ...
    def createDatabase(self, __a0: unicode, __a1: unicode, __a2: unicode, __a3: int, __a4: unicode, __a5: unicode) -> db.buffers.ManagedBufferFileHandle: ...
    ...
    @overload
    def openDatabase(self, __a0: unicode, __a1: unicode, __a2: long) -> db.buffers.RemoteManagedBufferFileImpl: ...

    @overload
    def openDatabase(self, __a0: unicode, __a1: unicode, __a2: int, __a3: int) -> db.buffers.RemoteManagedBufferFileImpl: ...
