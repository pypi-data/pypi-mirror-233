...
class LSAA():
    ...
    def update_lsaa(self,
        ...
        for node in nodes_in_sample:
            previous_optimizer = optimizer_template.set_weights(previous_delta=copy.deepcopy(optimizer[0]),
            ...
            # Baseline version
            baseline_gradients = copy.deepcopy(gradients)
            del baseline_gradients[node_id]
            baseline_optim = copy.deepcopy(optimizer)
            baseline_model = copy.deepcopy(previous_model)
            
            # Creating copies for the appended version
            appended_gradients = copy.deepcopy(baseline_gradients)
            ...
            print(f"Evaluated LSAA of client {node_id}") #TODO
