...
class SolORM:
    ...
    get_last_k_paths = {
        ...
        OutputPVForecastedTIC.__name__: "OutputPVForecastedTICs/getLastK",
        NuTIC.__name__: "NuTICs/getLastK",
        ProgramOptUpTIC.__name__: "ProgramOptUpTICs/getLastK",
        ProgramOptMidTIC.__name__: "ProgramOptMidTICs/getLastK",
    }

    get_last_kn_paths = {
        TAC.__name__: "TACs/getLastKN",
        WeatherEstimateTAC.__name__: "WeatherEstimateTACs/getLastKN",
        StorageStatusTAC.__name__: "StorageStatusTACs/getLastKN",
        OutputPVMeasuredTAC.__name__: "OutputPVMeasuredTACs/getLastKN",
        OutputPVForecastedTAC.__name__: "OutputPVForecastedTACs/getLastKN",
    }
