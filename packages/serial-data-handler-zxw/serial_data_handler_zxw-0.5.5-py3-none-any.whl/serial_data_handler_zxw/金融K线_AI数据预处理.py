...
def 准确率_one_hot(outputs_one_hot: torch.Tensor, labels_one_hot: torch.Tensor):
    """
    :param outputs_one_hot: [[1,0,0,0,0],... ]
    :param labels_one_hot: [[类别],... ]
    :return:
    """
    ...
    # 使用 argmax 获取最可能的类别
    true_labels = torch.argmax(labels_one_hot, dim=-1)
