...
def 准确率_one_hot(outputs: torch.Tensor, labels: torch.Tensor):
    """
    :param outputs: [[1,0,0,0,0],... ]
    :param labels: [[类别],... ]
    :return:
    """
    # outputs = torch.randn(32, 100, 7)  # 仅作为示例，你应该使用你的模型输出替换它 [32batchs数据, 100个时间步, 7个类别]
    # labels = torch.randint(0, 7, (32, 100))  # 仅作为示例，你应该使用你的真实标签替换它 [32batchs数据, 100个时间步]
