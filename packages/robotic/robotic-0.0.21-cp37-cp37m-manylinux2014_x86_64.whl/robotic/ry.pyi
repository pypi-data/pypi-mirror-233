...
class Config():
    ...
    def eval(self, featureSymbol: FS, frames: StringA = [], scale: arr = array(0.), target: arr = array(0.0078125), order: int = -1) -> tuple: 
        """
        evaluate a feature
        """
...
class Simulation():
    ...
    def setMoveto(self, path: arr, t: float, append: bool = True) -> None: 
        ...
        """
    def setState(self, frameState: arr, frameVelocities: arr = [], jointState: arr = [], jointVelocities: arr = []) -> None: ...
