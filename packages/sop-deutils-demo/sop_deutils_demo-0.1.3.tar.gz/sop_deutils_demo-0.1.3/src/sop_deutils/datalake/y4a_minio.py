...
class MinioUtils:
    ...
    :param access_key: the client access key to minio storage
    :param secret_key: the client secret key to minio storage
    """
    def __init__(
        self,
        access_key: str,
    ...
    def get_data(
        ...
        """
        Get data from a single directory of storage
    ...
    def get_data_wildcard(
        ...
        """
        Get data from multiple directories of storage
