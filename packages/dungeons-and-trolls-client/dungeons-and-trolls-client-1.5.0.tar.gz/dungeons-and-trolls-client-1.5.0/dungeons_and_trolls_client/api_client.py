...
import dungeons_and_trolls_client.models
from dungeons_and_trolls_client import rest
from dungeons_and_trolls_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(dungeons_and_trolls_client.models, klass)
