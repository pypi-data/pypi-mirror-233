...
class DungeonsandtrollsSkillEffect(BaseModel):
    ...
    flags: Optional[DungeonsandtrollsSkillSpecificFlags] = None
    ...
    def from_dict(cls, obj: dict) -> DungeonsandtrollsSkillEffect:
        ...
        _obj = DungeonsandtrollsSkillEffect.parse_obj({
            ...
            "flags": DungeonsandtrollsSkillSpecificFlags.from_dict(obj.get("flags")) if obj.get("flags") is not None else None,
