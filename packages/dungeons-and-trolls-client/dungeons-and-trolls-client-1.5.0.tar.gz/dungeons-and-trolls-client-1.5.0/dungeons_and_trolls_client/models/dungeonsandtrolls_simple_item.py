...
class DungeonsandtrollsSimpleItem(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DungeonsandtrollsSimpleItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DungeonsandtrollsSimpleItem:
        """Create an instance of DungeonsandtrollsSimpleItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DungeonsandtrollsSimpleItem.parse_obj(obj)

        _obj = DungeonsandtrollsSimpleItem.parse_obj({
            "name": obj.get("name"),
            "slot": obj.get("slot"),
            "icon": obj.get("icon")
        })
