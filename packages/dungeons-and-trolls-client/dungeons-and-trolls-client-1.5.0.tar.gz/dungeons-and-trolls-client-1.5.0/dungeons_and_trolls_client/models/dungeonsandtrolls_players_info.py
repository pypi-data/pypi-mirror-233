...
class DungeonsandtrollsPlayersInfo(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DungeonsandtrollsPlayersInfo:
        """Create an instance of DungeonsandtrollsPlayersInfo from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DungeonsandtrollsPlayersInfo:
        """Create an instance of DungeonsandtrollsPlayersInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DungeonsandtrollsPlayersInfo.parse_obj(obj)

        _obj = DungeonsandtrollsPlayersInfo.parse_obj({
