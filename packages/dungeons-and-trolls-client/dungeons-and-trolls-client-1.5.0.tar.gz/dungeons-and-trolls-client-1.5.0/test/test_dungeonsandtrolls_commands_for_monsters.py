...
from dungeons_and_trolls_client.models.dungeonsandtrolls_commands_for_monsters import DungeonsandtrollsCommandsForMonsters  # noqa: E501

class TestDungeonsandtrollsCommandsForMonsters(unittest.TestCase):
    """DungeonsandtrollsCommandsForMonsters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DungeonsandtrollsCommandsForMonsters:
        """Test DungeonsandtrollsCommandsForMonsters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DungeonsandtrollsCommandsForMonsters`
        """
        model = DungeonsandtrollsCommandsForMonsters()  # noqa: E501
        if include_optional:
            return DungeonsandtrollsCommandsForMonsters(
                commands = {
                    'key' : dungeons_and_trolls_client.models.dungeonsandtrolls_commands_batch.dungeonsandtrollsCommandsBatch(
    ...
    def testDungeonsandtrollsCommandsForMonsters(self):
        """Test DungeonsandtrollsCommandsForMonsters"""
