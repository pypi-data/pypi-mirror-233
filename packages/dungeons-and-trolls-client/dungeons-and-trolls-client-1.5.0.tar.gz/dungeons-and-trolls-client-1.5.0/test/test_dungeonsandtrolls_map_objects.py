...
from dungeons_and_trolls_client.models.dungeonsandtrolls_map_objects import DungeonsandtrollsMapObjects  # noqa: E501

class TestDungeonsandtrollsMapObjects(unittest.TestCase):
    """DungeonsandtrollsMapObjects unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DungeonsandtrollsMapObjects:
        """Test DungeonsandtrollsMapObjects
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DungeonsandtrollsMapObjects`
        """
        model = DungeonsandtrollsMapObjects()  # noqa: E501
        if include_optional:
            return DungeonsandtrollsMapObjects(
                ...
                is_stairs = True,
                portal = dungeons_and_trolls_client.models.dungeonsandtrolls_waypoint.dungeonsandtrollsWaypoint(
                    destination_floor = 56, ),
                decorations = [
                    dungeons_and_trolls_client.models.dungeonsandtrolls_decoration.dungeonsandtrollsDecoration(
                        name = '', 
                        type = '', 
                        icon = '', )
                    ],
    ...
    def testDungeonsandtrollsMapObjects(self):
        """Test DungeonsandtrollsMapObjects"""
