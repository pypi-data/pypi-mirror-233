...
class ExperimentTracking(metaclass=Singleton):
    ...
    def log_tag(self, tag_name: str, value: str or int or float):
        self._experiment_tracking.log_tag(experiment_id=self._current_experiment, key=tag_name, value=value)
    ...
    def stage_model(self, experiment_id: str) -> str:
        return self._experiment_tracking.stage_model(experiment_id=experiment_id)
