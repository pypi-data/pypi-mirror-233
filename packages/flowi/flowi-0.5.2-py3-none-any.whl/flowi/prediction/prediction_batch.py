...
from flowi.prediction.experiment_tracking import download_artifacts, load_model_by_version
from flowi.utilities.logger import Logger
from flowi.utilities.airflow_xcom import write_xcom
from flowi.settings import MODEL_NAME, MODEL_VERSION
...
def predict(source: dict, destiny: dict, result_only: bool = True):
    download_artifacts(model_name=MODEL_NAME, version=MODEL_VERSION)
    ...
    model = load_model_by_version(model_name=MODEL_NAME, version=MODEL_VERSION)
