...
WORKSPACE = _get_env(variable_name="WORKSPACE", default="unknown")
...
MODEL_NAME = f"{WORKSPACE}_{FLOW_NAME}"
MODEL_VERSION = _get_env(variable_name="MODEL_VERSION", default="1")
