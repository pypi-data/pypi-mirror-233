...
class TimeUtils:
    ...
    @staticmethod
    def before_morning_start(timestamp: datetime = datetime.now()) -> bool:
        return timestamp < TimeUtils.get_morning_start(timestamp)

    @staticmethod
    def after_afternoon_end(timestamp: datetime = datetime.now()) -> bool:
        return timestamp > TimeUtils.get_afternoon_end(timestamp)
