...
def main():
    ...
    # Add arguments
    parser.add_argument("--yolo-annotation-dir", required=True, help="Path to the YOLO annotation directory.")
    parser.add_argument("--labelme-output-dir", required=False, default= 'results', help="Path to the LabelMe output directory.")
    parser.add_argument("--image-width", type=int, required=False, default= 1024, help="Width of the images")
    parser.add_argument("--image-height", type=int, required=False, default= 1024, help="Height of the images")
    parser.add_argument("--class-mapping-file", required=True, help="Path to the class mapping file (TXT format).")
