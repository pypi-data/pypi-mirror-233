...
class Graph():
    ...
    class Chain():
        def __init__(self, nsize, **kwargs):
            ...
            self.wtype = kwargs.get("wtype", Int)
            self.weight = kwargs.get("weight", [Const.INT_MIN, Const.INT_MAX])
            self.value = Graph.Tree(self.nsize, 1, 0, directed = self.directed, wtype = self.wtype, weight = self.weight).value
    ...
    class Flower():
        def __init__(self, nsize, **kwargs):
            ...
            self.wtype = kwargs.get("wtype", Int)
            self.weight = kwargs.get("weight", [Const.INT_MIN, Const.INT_MAX])
            self.value = Graph.Tree(self.nsize, 0, 1, directed = self.directed, wtype = self.wtype, weight = self.weight).value
