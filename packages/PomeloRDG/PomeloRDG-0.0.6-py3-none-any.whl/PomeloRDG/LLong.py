...
class LLong():
    def __init__(self, value = Const.INF, limit = [Const.LLONG_MIN, Const.LLONG_MAX]):
        self.limit = limit
        self.value = self.__rand__() if value == Const.INF or not self.__check__(value) else value
        
    def __check__(self, x):
        """
        Check if a long integer is legal.
        """
    ...
    def set(self, x):
        """
        Set the value to a legal long integer.
        """
