...
class ApiCode:
    def __init__(
        ...
        *,
        ...
        '''
        :param entry: (experimental) Path to the source of the function or the location for dependencies, for the api lambda.
        :param handler: (experimental) The name of the exported handler in the ``api_lambda_index`` file.
        :param index: (experimental) Path to the index file containing the exported handler, relative to ``api_lambda_entry``.

        :stability: experimental
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ApiCode.__init__)
    ...
    def entry(self) -> builtins.str:
        '''(experimental) Path to the source of the function or the location for dependencies, for the api lambda.
    ...
    def handler(self) -> typing.Optional[builtins.str]:
        '''(experimental) The name of the exported handler in the ``api_lambda_index`` file.
    ...
    def index(self) -> typing.Optional[builtins.str]:
        '''(experimental) Path to the index file containing the exported handler, relative to ``api_lambda_entry``.
...
@jsii.data_type(
    jsii_type="eoapi-cdk.IngestorCode",
    jsii_struct_bases=[],
    name_mapping={"entry": "entry", "handler": "handler", "index": "index"},
)
class IngestorCode:
    def __init__(
        ...
        *,
        ...
        '''
        :param entry: (experimental) Path to the source of the function or the location for dependencies, for the ingestor lambda.
        :param handler: (experimental) The name of the exported handler in the ``ingestor_lambda_index`` file.
        :param index: (experimental) Path to the index file containing the exported handler, relative to ``ingestor_lambda_entry``.

        :stability: experimental
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IngestorCode.__init__)
            check_type(argname="argument entry", value=entry, expected_type=type_hints["entry"])
            check_type(argname="argument handler", value=handler, expected_type=type_hints["handler"])
            check_type(argname="argument index", value=index, expected_type=type_hints["index"])
        self._values: typing.Dict[str, typing.Any] = {
    ...
    @builtins.property
    def entry(self) -> builtins.str:
        '''(experimental) Path to the source of the function or the location for dependencies, for the ingestor lambda.
    ...
    @builtins.property
    def handler(self) -> typing.Optional[builtins.str]:
        '''(experimental) The name of the exported handler in the ``ingestor_lambda_index`` file.
    ...
    @builtins.property
    def index(self) -> typing.Optional[builtins.str]:
        '''(experimental) Path to the index file containing the exported handler, relative to ``ingestor_lambda_entry``.
...
class StacIngestor(
    ...
    def __init__(
        ...
        *,
        ...
        subnet_selection: typing.Union[aws_cdk.aws_ec2.SubnetSelection, typing.Dict[str, typing.Any]],
        vpc: aws_cdk.aws_ec2.IVpc,
        api_code: typing.Optional[typing.Union[ApiCode, typing.Dict[str, typing.Any]]] = None,
        ...
        ingestor_code: typing.Optional[typing.Union[IngestorCode, typing.Dict[str, typing.Any]]] = None,
        ...
        :param api_code: (experimental) Custom code for the ingestor api. Default: - default in the runtime folder.
        ...
        :param ingestor_code: (experimental) Custom code for the ingestor. Default: - default in the runtime folder.
...
class StacIngestorProps:
    def __init__(
        ...
        *,
        ...
        if isinstance(ingestor_code, dict):
            ingestor_code = IngestorCode(**ingestor_code)
        ...
        if __debug__:
            ...
            check_type(argname="argument ingestor_code", value=ingestor_code, expected_type=type_hints["ingestor_code"])
        ...
        if ingestor_code is not None:
            self._values["ingestor_code"] = ingestor_code
    ...
    @builtins.property
    def api_code(self) -> typing.Optional[ApiCode]:
        '''(experimental) Custom code for the ingestor api.
        ...
        '''
        result = self._values.get("api_code")
        return typing.cast(typing.Optional[ApiCode], result)
    ...
    @builtins.property
    def ingestor_code(self) -> typing.Optional[IngestorCode]:
        '''(experimental) Custom code for the ingestor.

        :default: - default in the runtime folder.

        :stability: experimental
        '''
        result = self._values.get("ingestor_code")
        return typing.cast(typing.Optional[IngestorCode], result)
...
class TiPgApiLambda(
    ...
    def __init__(
        ...
        *,
        ...
        :param subnet_selection: (experimental) Subnet into which the lambda should be deployed.
        :param vpc: (experimental) VPC into which the lambda should be deployed.
        :param api_code: (experimental) Custom code to run for the application. Default: - simplified version of tipg.
...
class TiPgApiLambdaProps:
    ...
    def api_code(self) -> typing.Optional[TiPgApiEntrypoint]:
        '''(experimental) Custom code to run for the application.
...
@jsii.data_type(
    ...
    name_mapping={
        ...
        "api_env": "apiEnv",
        "buckets": "buckets",
        "python_lambda_options": "pythonLambdaOptions",
...
class TitilerPgStacApiLambdaProps:
    def __init__(
        ...
        *,
        ...
        python_lambda_options: typing.Optional[typing.Union["TitilerPgstacPythonLambdaOptions", typing.Dict[str, typing.Any]]] = None,
        ...
        :param python_lambda_options: (experimental) Optional settings for the titiler-pgstac python lambda function. Default: - defined in the construct.
        ...
        if isinstance(subnet_selection, dict):
            subnet_selection = aws_cdk.aws_ec2.SubnetSelection(**subnet_selection)
        if isinstance(python_lambda_options, dict):
            python_lambda_options = TitilerPgstacPythonLambdaOptions(**python_lambda_options)
        if __debug__:
            ...
            check_type(argname="argument python_lambda_options", value=python_lambda_options, expected_type=type_hints["python_lambda_options"])
        ...
        if python_lambda_options is not None:
            self._values["python_lambda_options"] = python_lambda_options
    ...
    @builtins.property
    def python_lambda_options(
        self,
    ) -> typing.Optional["TitilerPgstacPythonLambdaOptions"]:
        '''(experimental) Optional settings for the titiler-pgstac python lambda function.

        :default: - defined in the construct.

        :stability: experimental
        '''
        result = self._values.get("python_lambda_options")
        return typing.cast(typing.Optional["TitilerPgstacPythonLambdaOptions"], result)
    ...
    def __init__(
        ...
        *,
        ...
        props = TitilerPgStacApiLambdaProps(
            ...
            api_env=api_env,
            buckets=buckets,
            python_lambda_options=python_lambda_options,
...
@jsii.data_type(
    jsii_type="eoapi-cdk.TitilerPgstacPythonLambdaOptions",
    jsii_struct_bases=[],
    name_mapping={
...
class TitilerPgstacPythonLambdaOptions:
    def __init__(
        self,
        *,
        architecture: aws_cdk.aws_lambda.Architecture,
        entry: builtins.str,
        ...
        '''
        :param architecture: (experimental) The system architectures compatible with this lambda function.
        :param entry: (experimental) Path to the source of the function or the location for dependencies.
        :param handler: (experimental) The name of the exported handler in the index file.
        :param index: (experimental) The path (relative to entry) to the index file containing the exported handler.
        :param memory_size: (experimental) The amount of memory, in MB, that is allocated to your Lambda function.
        :param runtime: (experimental) The runtime environment. Only runtimes of the Python family are supported.
        :param bundling: (experimental) Bundling options to use for this function. Use this to specify custom bundling options like the bundling Docker image, asset hash type, custom hash, architecture, etc.

        :stability: experimental
        '''
        if isinstance(bundling, dict):
            bundling = aws_cdk.BundlingOptions(**bundling)
        if __debug__:
            type_hints = typing.get_type_hints(TitilerPgstacPythonLambdaOptions.__init__)
    ...
    @builtins.property
    def architecture(self) -> aws_cdk.aws_lambda.Architecture:
        ...
        return typing.cast(aws_cdk.aws_lambda.Architecture, result)
    ...
    @builtins.property
    def bundling(self) -> typing.Optional[aws_cdk.BundlingOptions]:
        ...
        return typing.cast(typing.Optional[aws_cdk.BundlingOptions], result)
    ...
    def __repr__(self) -> str:
        return "TitilerPgstacPythonLambdaOptions(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
__all__ = [
    ...
    "TitilerPgstacPythonLambdaOptions",
]
