...
def binsreg(y, x, w=None, data=None, at=None, deriv=0,
    ...
    for i in range(ngroup):
        ...
        if dotsON:
            ...
            model_dots = binsreg_fit(y=y_sub, x=design, weights=weights_sub, cov_type=vce, cluster=cluster_sub)
        ...
        if lineON:
            ...
            if line_reg_ON:
                ...
                model_line = binsreg_fit(y=y_sub, x=design, weights=weights_sub, cov_type=vce, cluster=cluster_sub)
        ...
        if polyON:
            ...
            model_poly = binsreg_fit(y=y_sub, x=design, weights=weights_sub, cov_type=vce, cluster=cluster_sub)
        ...
        if ciON:
            ...
            if ci_reg_ON:
                ...
                model_ci = binsreg_fit(y=y_sub, x=design, weights=weights_sub, cov_type=vce,
                                    cluster=cluster_sub)
        ...
        if cbON:
            ...
            if cb_reg_ON:
                ...
                model_cb = binsreg_fit(y=y_sub, x=design, weights=weights_sub,
                                        cov_type = vce, cluster = cluster_sub)
    ...
    opt = options(dots=dots_by, line=line_by, ci=ci_by, cb=cb_by,
    ...
    out = binsreg_output(bins_plot=binsplot, data_plot=data_plot, cval_by=cval_by,
