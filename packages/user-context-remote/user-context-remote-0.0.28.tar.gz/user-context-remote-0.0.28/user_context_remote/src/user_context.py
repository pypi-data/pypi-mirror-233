...
class UserContext:
    ...
    def __new__(cls, email: str = None, password: str = None, userJWT: str = None):
        if cls._instance is None:
            ...
            if email is not None and password is not None:
                cls._instance._initialize(user_identifier=email, password=password)
            else:
                cls._instance._initialize(userJWT=userJWT)
        return cls._instance

    def _initialize(self, user_identifier: str = None, password: str = None, userJWT: str = None):
    ...
    def login(user_identifier: str = None, password: str = None, userJWT: str = None):
        ...
        if UserContext._instance is None:
            if userJWT is not None:
                ...
                if user_identifier is None:
                    user_identifier = os.getenv("PRODUCT_USERNAME")
                if password is None:
