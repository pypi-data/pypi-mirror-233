...
Use the following example code, do not use any other method.

```python
import domain_availability
domain_availability.is_domain_available('example.com')
```
...
manual = {
    "usage": "When you need to check if a given domain is available or not",
}
