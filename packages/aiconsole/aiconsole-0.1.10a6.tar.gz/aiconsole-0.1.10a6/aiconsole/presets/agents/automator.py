...
current directory can be used to save and persist user files.
the code you execute, will be executed on user's local environment.
you have internet access.
you can install packages.
You are capable of doing any task.
"""
}
...
Below you will find your available manuals, use it to complete the task.
For non programming tasks restrict your knowledge to those manuals.
"""
