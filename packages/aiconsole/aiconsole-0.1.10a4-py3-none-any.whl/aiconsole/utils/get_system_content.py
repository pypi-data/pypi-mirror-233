...
def get_system_content(system_description, available_agents, available_manuals):
    new_line = "\n"
    ...
    return (
        ...
        f"1. Establish the agent to approach the task, it can be one of the following values:\n\n"
        f"{random_agents}\n\n"
