...
from takamol_einvoicer_test_app.zatca.integrations.zatca import ZatcaService
from takamol_einvoicer_test_app.zatca.models import ZatcaKey
...
class OnboardingService:
    ...
    def compliance_check(cls, username, password):
        # Generate 3 temp invoices (Tax, Debit, Credit)
