...
from nurphy.ner.bert_ner_train import Trainer
from nurphy.ner.ner_utils import init_logger, load_tokenizer, set_seed, MODEL_CLASSES, MODEL_PATH_MAP
from nurphy.ner.data_loader import load_and_cache_examples
...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_file", default="ner_train.tsv", type=str, help="Train file")
    parser.add_argument("--test_file", default="ner_test.tsv", type=str, help="Test file")
    parser.add_argument("--label_file", default="ner_label.txt", type=str, help="Slot Label file")
    parser.add_argument("--write_pred", action="store_false", help="Write prediction during evaluation")
