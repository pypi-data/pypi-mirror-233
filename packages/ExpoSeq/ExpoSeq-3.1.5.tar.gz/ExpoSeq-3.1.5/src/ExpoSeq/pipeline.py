...
class PlotManager:
    ...
    def quality_analysis(self):
        ...
        print("Cluster NGS sequences in dendrograms and network plots using levenshtein distance of 2 and batch size of 1000.")
        for single_experiment in self.experiments_list:
            self.levenshtein_dendrogram(sample = single_experiment)
            self.save_in_plots(single_experiment + "ls_dendrogram")
            ...
            self.save_in_plots(single_experiment + "ls_cluster")
        ...
        if best_binder == None:
            ...
            for experiment in experiment_keys:
                ...
                self.save_in_plots(os.path.join("clustering_antigens", "dendro_binding", experiment + "_dendro_bind"))
    ...
    def basic_cluster(self, samples, batch_size = 1000, max_ld = 1, min_ld = 0, second_figure = False, label_type = "numbers", save_report_path = None):
        """
    ...
    def cluster_one_AG(self, antigen=None, max_ld=1, min_ld=0, batch_size=1000, specific_experiments=False, preferred_cmap = "Blues", label_type = "numbers", save_report_path = Non):
        """
    ...
    def validate_mixcr_path(self):
        ...
        settings_dir = os.path.join(self.module_dir, "settings")
