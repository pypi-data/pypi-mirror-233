...
class SequencingReport:
    ...
    def trim_data(self, region_string, divisible_by = 3,length_threshold = 9, min_read_count = 0, new_fraction = "cloneFraction"):
        ...
        sequencing_report = self.origin_seq_report.drop_duplicates(subset=["nSeq" + region_string], keep="first")
        ...
        self.sequencing_report = sequencing_report[(sequencing_report["readCount"] > min_read_count)]
