...
class PlotManager:
    ...
    def quality_analysis(self):
        ...
        """
        mh_save_path = os.path.join(self.plot_path, "morosita_horn_identity" + ".xlsx")
        ...
        for single_experiment in self.experiments_list:
            ...
            self.basic_cluster(sample = single_experiment, max_ld = 2)
        ...
        while True:
            ...
            if mean_length > 2.5 and threshold_identity > 0.05:
                break
            else:
