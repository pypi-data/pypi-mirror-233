...
def setup():
    ...
    try:
        ...
        settings_dict["gcp_project_id"] = typer.prompt("GCP project ID")
        settings_dict["mlflow_url"] = typer.prompt("MLFlow URL")
        settings_dict["mlflow_username"] = typer.prompt("MLFlow username")
        settings_dict["mlflow_password"] = typer.prompt(
