...
class Finding(dojo.DAPI):
    ...
    def push_to_jira(self):
        ...
        push_jira_endpoint = "api/v2/findings/{}/jira/push".format(self.id)

        push_jira_response = self.api_call(endpoint=existing_tag_endpoint,
                                        method="POST",
                                        token=True,
                                        return_json=False,
                                        json={})
    ...
    def add_note(self, entry="", private=False, note_type=0):
        ...
        notes_json = {"entry": entry, "private": private, "note_type": note-type}
