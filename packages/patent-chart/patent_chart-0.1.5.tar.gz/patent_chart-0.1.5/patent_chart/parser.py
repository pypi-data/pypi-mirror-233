...
def extract_claim_text_from_pages(pages):
    claim_signals = ['What is claimed is:', 'We claim:', 'I claim:', 'The invention claimed is:', 'The invention claimed is as follows:', 'The invention claimed is:', 'claim:', 'Claims:']
    end_signals = ['k k k k k']
    print('CLAIM SIGNALS: ', claim_signals)
    claim_chunks = []
...
class PDFParser:
    ...
    def parse_full_text(self):
        return ''.join(self.pages_text)

class PatentParser(PDFParser):
