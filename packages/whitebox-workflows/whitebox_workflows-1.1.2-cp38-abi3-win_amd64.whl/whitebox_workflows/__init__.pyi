...
def license_info(user_id: str = "") -> None: ...
...
class Lidar():
	...
	def get_point_record(self, index: int) -> Tuple[LidarPointData, Union[float, None], Union[ColourData, None], Union[WaveformPacket, None]]: ...
...
class Vector():
	...
	def get_attribute_field_num(self, name: str) -> Union[int, None]: ...
...
class WbEnvironment():
	...
	def read_lidar(self, file_name: str) -> Lidar: ...
	...
	def image_slider(self, left_raster: Raster, right_raster: Raster, output_file: str, left_palette: WbPalette = WbPalette.Grey, left_reverse_palette: bool = False, left_label: str = "",  right_palette: WbPalette = WbPalette.Grey, right_reverse_palette: bool = False, right_label: str = "", image_height: int = 600) -> None: ...
	...
	def random_forest_regression(self, input_rasters: List[Raster], training_data: Vector, field_name: str, n_trees: int = 500, min_samples_leaf: int = 1, min_samples_split: int = 2, test_proportion: float = 0.2, create_output: bool = False) -> Optional[Raster]: ...
