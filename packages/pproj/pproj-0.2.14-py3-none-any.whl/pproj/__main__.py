...
def build(
    ...
    """Build a project from path or name, run: write, clean and venv (requirements)."""
    Project(data).build()
...
def publish(
    ...
    """Publish: docs, tests (build (clean, venv (requirements)), pytest, ruff, tox), commit, tag, push, twine, clean."""
