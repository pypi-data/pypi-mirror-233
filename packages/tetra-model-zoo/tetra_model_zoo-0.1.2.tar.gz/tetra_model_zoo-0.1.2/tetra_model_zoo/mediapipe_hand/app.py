...
from tetra_model_zoo.mediapipe_hand.model import (
    DETECT_DSCALE,
    DETECT_DXY,
...
from tetra_model_zoo.utils.draw import draw_connections, draw_points
...
class MediaPipeHandApp(MediaPipeApp):
    ...
    def __init__(
        ...
        super().__init__(
            model.hand_detector,
            model.hand_detector_anchors,
            model.hand_landmark_detector,
            MediaPipeHand.get_palm_detector_input_spec()["image"][0][-2:],
            MediaPipeHand.get_hand_landmark_detector_input_spec(0)["image"][0][-2:],
            WRIST_CENTER_KEYPOINT_INDEX,
            MIDDLE_FINDER_KEYPOINT_INDEX,
            ROTATION_VECTOR_OFFSET_RADS,
            DETECT_DXY,
