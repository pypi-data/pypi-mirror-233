...
class MediaPipeFace:
    def __init__(
        ...
        face_detector_anchors: torch.Tensor,
        ...
        Inputs:
            ...
            face_detector_anchors: torch.Tensor
                Anchor boxes used to decode the output boxes & keypoints from the face detector model.
        ...
        self.face_detector_anchors = face_detector_anchors
    ...
    def from_pretrained(
        ...
        return MediaPipeFace(
            *MediaPipeFace._load_mediapipe_face_models(
                detector_weights, detector_anchors, landmark_detector_weights
            )
        )

    @staticmethod
    def get_face_detector_input_spec(batch_size: int = BATCH_SIZE) -> InputSpec:
        """
    ...
    @staticmethod
    def get_face_landmark_detector_input_spec(batch_size: int) -> InputSpec:
        """
    ...
    def _load_mediapipe_face_models(
        ...
        Returns tuple[<source repository>.blazeface.BlazeFace, BlazeFace Anchors, <source repository>.blazeface_landmark.BlazeFaceLandmark]
        """
        with MediaPipePyTorchAsRoot():
            ...
            return (face_detector, face_detector.anchors, face_regressor)
