...
from tetra_model_zoo.openai_clip.app import ClipApp
from tetra_model_zoo.openai_clip.model import MODEL_ASSET_VERSION, MODEL_ID, Clip
from tetra_model_zoo.utils.asset_loaders import get_model_asset_url, load_image

DEFAULT_DEMO_IMAGE_FOLDER = get_model_asset_url(MODEL_ID, MODEL_ASSET_VERSION, "")
