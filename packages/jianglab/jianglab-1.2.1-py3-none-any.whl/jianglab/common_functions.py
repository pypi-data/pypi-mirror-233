...
def get_data_of_a_cell_type(filename):
    mean_dict = {}
...
def add_globalID_to_data(folder_list, ref_template = "step_up", data_to_label_template = "dense_noise_long",
    ...
    for folder in tqdm(folder_list):
        file_list = jl.search_file_in_location(folder, ["pkl"])
        try:
            ...
            new_aligned_data = jl.assign_gID_between_two_files(ref_data, data_to_label, search_range=2)
