...
class QTL2347 (PowerModule):
    ...
    has_noise_test = True
    channel_dict_max_limits = {"current +3.3V Max": "400uA", "current +12V Max": "400uA", "current +3.3Vaux Max": "400uA"}
    ...
    class QTL2347_LeakageCalibration (QTL2347Calibration):
        ...
        def setRef(self,value):
            ...
            self.powerModule.calInstrument.setReferenceVoltage(value/1000,currentLimit=1e-3,currentRange="1mA")
