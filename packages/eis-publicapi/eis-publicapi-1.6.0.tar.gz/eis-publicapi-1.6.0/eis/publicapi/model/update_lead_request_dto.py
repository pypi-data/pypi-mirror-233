...
class UpdateLeadRequestDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, code, product_code, policy_objects, status, account, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, code, product_code, policy_objects, status, account, *args, **kwargs):  # noqa: E501
        """UpdateLeadRequestDto - a model defined in OpenAPI
