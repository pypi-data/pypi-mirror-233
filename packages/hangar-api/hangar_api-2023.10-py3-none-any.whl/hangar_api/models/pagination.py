...
class Pagination(BaseModel):
    ...
    Pagination
    """
    limit: Optional[Annotated[int, Field(le=25, strict=True, ge=1)]] = Field(default=None, description="The maximum amount of items to return")
    offset: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Where to start searching")
    count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["limit", "offset", "count"]
