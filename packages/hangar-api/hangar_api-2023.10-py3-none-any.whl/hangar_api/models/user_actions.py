...
class UserActions(BaseModel):
    """
    Information about your interactions with the project  # noqa: E501
    """
    starred: Optional[StrictBool] = None
    watching: Optional[StrictBool] = None
    flagged: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["starred", "watching", "flagged"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UserActions from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of UserActions from a dict"""
        if obj is None:
            return None
