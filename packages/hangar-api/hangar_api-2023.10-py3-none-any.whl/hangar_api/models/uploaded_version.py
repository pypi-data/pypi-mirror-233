...
class UploadedVersion(BaseModel):
    """
    A version that has been uploaded  # noqa: E501
    """
    url: Optional[StrictStr] = Field(default=None, description="URL of the uploaded version")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UploadedVersion from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of UploadedVersion from a dict"""
        if obj is None:
            return None
