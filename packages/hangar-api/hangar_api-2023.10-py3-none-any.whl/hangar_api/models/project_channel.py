...
class ProjectChannel(BaseModel):
    ...
    flags: Optional[List[ChannelFlag]] = None
    __properties: ClassVar[List[str]] = ["createdAt", "name", "description", "color", "flags"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ProjectChannel from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of ProjectChannel from a dict"""
        if obj is None:
            return None
