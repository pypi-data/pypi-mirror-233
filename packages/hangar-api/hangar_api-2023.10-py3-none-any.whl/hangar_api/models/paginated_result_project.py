...
class PaginatedResultProject(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaginatedResultProject from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of PaginatedResultProject from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "result": [Project.from_dict(_item) for _item in obj.get("result")] if obj.get("result") is not None else None
        })
        return _obj
