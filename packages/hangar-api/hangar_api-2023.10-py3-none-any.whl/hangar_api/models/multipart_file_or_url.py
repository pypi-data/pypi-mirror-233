...
class MultipartFileOrUrl(BaseModel):
    """
    List of different jars/external links that are part of the version  # noqa: E501
    """
    platforms: Optional[List[Platform]] = Field(default=None, description="List of platforms this jar runs on")
    external_url: Optional[StrictStr] = Field(default=None, description="External url to download the jar from if not provided via an attached jar, else null", alias="externalUrl")
    __properties: ClassVar[List[str]] = ["platforms", "externalUrl"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of MultipartFileOrUrl from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of MultipartFileOrUrl from a dict"""
        if obj is None:
            return None
