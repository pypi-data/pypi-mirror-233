...
class StringContent(BaseModel):
    """
    The path and new contents of the page  # noqa: E501
    """
    content: StrictStr = Field(description="A non-null, non-empty string")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of StringContent from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of StringContent from a dict"""
        if obj is None:
            return None
