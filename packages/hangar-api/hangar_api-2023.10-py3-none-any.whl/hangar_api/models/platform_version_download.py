...
class PlatformVersionDownload(BaseModel):
    """
    PlatformVersionDownload
    """
    file_info: Optional[FileInfo] = Field(default=None, alias="fileInfo")
    external_url: Optional[StrictStr] = Field(default=None, description="External download url if not directly uploaded to Hangar", alias="externalUrl")
    download_url: Optional[StrictStr] = Field(default=None, description="Hangar download url if not an external download", alias="downloadUrl")
    __properties: ClassVar[List[str]] = ["fileInfo", "externalUrl", "downloadUrl"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PlatformVersionDownload from a JSON string"""
    ...
    def to_dict(self):
        ...
        if self.file_info:
            _dict['fileInfo'] = self.file_info.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of PlatformVersionDownload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "fileInfo": FileInfo.from_dict(obj.get("fileInfo")) if obj.get("fileInfo") is not None else None,
