...
class CompactRole(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["title", "color", "rank", "category"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CompactRole from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of CompactRole from a dict"""
        if obj is None:
            return None
