...
class UserNameChange(BaseModel):
    ...
    UserNameChange
    """
    old_name: Optional[StrictStr] = Field(default=None, alias="oldName")
    new_name: Optional[StrictStr] = Field(default=None, alias="newName")
    var_date: Optional[datetime] = Field(default=None, alias="date")
    __properties: ClassVar[List[str]] = ["oldName", "newName", "date"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UserNameChange from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of UserNameChange from a dict"""
        if obj is None:
            return None
