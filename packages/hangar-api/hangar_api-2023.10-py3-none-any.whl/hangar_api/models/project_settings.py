...
class ProjectSettings(BaseModel):
    """
    The settings of the project  # noqa: E501
    """
    links: List[LinkSection]
    tags: List[StrictStr]
    license: Optional[ProjectLicense] = None
    keywords: List[StrictStr]
    sponsors: Optional[StrictStr] = None
    donation: Optional[ProjectDonationSettings] = None
    __properties: ClassVar[List[str]] = ["links", "tags", "license", "keywords", "sponsors", "donation"]
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of donation
        if self.donation:
            _dict['donation'] = self.donation.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            "links": [LinkSection.from_dict(_item) for _item in obj.get("links")] if obj.get("links") is not None else None,
            "tags": obj.get("tags"),
            "license": ProjectLicense.from_dict(obj.get("license")) if obj.get("license") is not None else None,
            "keywords": obj.get("keywords"),
            "sponsors": obj.get("sponsors"),
            "donation": ProjectDonationSettings.from_dict(obj.get("donation")) if obj.get("donation") is not None else None
        })
        return _obj
