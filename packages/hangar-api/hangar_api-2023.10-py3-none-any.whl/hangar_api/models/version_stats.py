...
class VersionStats(BaseModel):
    ...
    platform_downloads: Optional[Dict[str, StrictInt]] = Field(default=None, alias="platformDownloads")
    __properties: ClassVar[List[str]] = ["totalDownloads", "platformDownloads"]
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "platformDownloads": obj.get("platformDownloads")
        })
        return _obj
