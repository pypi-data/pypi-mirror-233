...
class ApiSession(BaseModel):
    ...
    ApiSession
    """
    token: Optional[StrictStr] = Field(default=None, description="JWT used for authentication")
    expires_in: Optional[StrictInt] = Field(default=None, description="Milliseconds this JWT expires in", alias="expiresIn")
    __properties: ClassVar[List[str]] = ["token", "expiresIn"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApiSession from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of ApiSession from a dict"""
        if obj is None:
            return None
