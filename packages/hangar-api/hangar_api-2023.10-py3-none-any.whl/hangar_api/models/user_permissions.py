...
class UserPermissions(BaseModel):
    ...
    permission_bin_string: Optional[StrictStr] = Field(default=None, alias="permissionBinString")
    permissions: Optional[List[NamedPermission]] = None
    __properties: ClassVar[List[str]] = ["type", "permissionBinString", "permissions"]
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "permissionBinString": obj.get("permissionBinString"),
