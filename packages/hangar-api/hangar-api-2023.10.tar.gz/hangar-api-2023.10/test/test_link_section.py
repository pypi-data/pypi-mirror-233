...
from hangar_api.models.link_section import LinkSection  # noqa: E501

class TestLinkSection(unittest.TestCase):
    """LinkSection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinkSection:
        """Test LinkSection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinkSection`
        """
        model = LinkSection()  # noqa: E501
        if include_optional:
            return LinkSection(
                id = 56,
                type = 'TOP',
