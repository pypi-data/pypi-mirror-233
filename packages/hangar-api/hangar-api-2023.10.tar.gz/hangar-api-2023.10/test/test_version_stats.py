...
from hangar_api.models.version_stats import VersionStats  # noqa: E501

class TestVersionStats(unittest.TestCase):
    """VersionStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VersionStats:
        """Test VersionStats
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VersionStats`
        """
        model = VersionStats()  # noqa: E501
        if include_optional:
            return VersionStats(
                total_downloads = 56,
                platform_downloads = {
