...
from hangar_api.models.day_project_stats import DayProjectStats  # noqa: E501

class TestDayProjectStats(unittest.TestCase):
    """DayProjectStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DayProjectStats:
        """Test DayProjectStats
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DayProjectStats`
        """
        model = DayProjectStats()  # noqa: E501
        if include_optional:
