...
from hangar_api.models.project_license import ProjectLicense  # noqa: E501

class TestProjectLicense(unittest.TestCase):
    """ProjectLicense unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectLicense:
        """Test ProjectLicense
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectLicense`
        """
        model = ProjectLicense()  # noqa: E501
        if include_optional:
