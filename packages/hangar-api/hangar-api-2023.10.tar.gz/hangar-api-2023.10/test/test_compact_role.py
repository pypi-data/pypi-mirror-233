...
from hangar_api.models.compact_role import CompactRole  # noqa: E501

class TestCompactRole(unittest.TestCase):
    """CompactRole unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompactRole:
        """Test CompactRole
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompactRole`
        """
        model = CompactRole()  # noqa: E501
        if include_optional:
            return CompactRole(
                title = '',
                color = '#B400FF',
