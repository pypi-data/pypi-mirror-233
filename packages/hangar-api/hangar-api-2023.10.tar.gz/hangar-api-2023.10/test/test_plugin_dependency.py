...
from hangar_api.models.plugin_dependency import PluginDependency  # noqa: E501
...
class TestPluginDependency(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PluginDependency:
        """Test PluginDependency
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PluginDependency`
        """
        model = PluginDependency()  # noqa: E501
        if include_optional:
