...
from hangar_api.models.paginated_result_project import PaginatedResultProject  # noqa: E501

class TestPaginatedResultProject(unittest.TestCase):
    """PaginatedResultProject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedResultProject:
        """Test PaginatedResultProject
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedResultProject`
        """
        model = PaginatedResultProject()  # noqa: E501
        if include_optional:
            return PaginatedResultProject(
                pagination = hangar_api.models.pagination.Pagination(
                    ...
                    count = 56, ),
                result = [
                    hangar_api.models.project.Project(
    ...
    def testPaginatedResultProject(self):
        """Test PaginatedResultProject"""
