...
from hangar_api.models.api_session import ApiSession  # noqa: E501

class TestApiSession(unittest.TestCase):
    """ApiSession unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiSession:
        """Test ApiSession
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiSession`
        """
        model = ApiSession()  # noqa: E501
        if include_optional:
            return ApiSession(
                token = '',
                expires_in = 56
