...
from hangar_api.models.platform_version_download import PlatformVersionDownload  # noqa: E501

class TestPlatformVersionDownload(unittest.TestCase):
    """PlatformVersionDownload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlatformVersionDownload:
        """Test PlatformVersionDownload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlatformVersionDownload`
        """
        model = PlatformVersionDownload()  # noqa: E501
        if include_optional:
    ...
    def testPlatformVersionDownload(self):
        """Test PlatformVersionDownload"""
