...
from hangar_api.models.paginated_result_project_member import PaginatedResultProjectMember  # noqa: E501

class TestPaginatedResultProjectMember(unittest.TestCase):
    """PaginatedResultProjectMember unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedResultProjectMember:
        """Test PaginatedResultProjectMember
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedResultProjectMember`
        """
        model = PaginatedResultProjectMember()  # noqa: E501
        if include_optional:
            return PaginatedResultProjectMember(
                pagination = hangar_api.models.pagination.Pagination(
                    ...
                    count = 56, ),
                result = [
                    hangar_api.models.project_member.ProjectMember(
                        user = '', 
                        roles = [
                            hangar_api.models.compact_role.CompactRole(
                                title = '', 
                                color = '#B400FF', 
                                rank = 56, 
                                category = '', )
    ...
    def testPaginatedResultProjectMember(self):
        """Test PaginatedResultProjectMember"""
