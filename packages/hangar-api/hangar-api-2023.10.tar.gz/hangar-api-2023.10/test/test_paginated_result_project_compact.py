...
from hangar_api.models.paginated_result_project_compact import PaginatedResultProjectCompact  # noqa: E501

class TestPaginatedResultProjectCompact(unittest.TestCase):
    """PaginatedResultProjectCompact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedResultProjectCompact:
        """Test PaginatedResultProjectCompact
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedResultProjectCompact`
        """
        model = PaginatedResultProjectCompact()  # noqa: E501
        if include_optional:
            return PaginatedResultProjectCompact(
                pagination = hangar_api.models.pagination.Pagination(
                    ...
                    count = 56, ),
                result = [
                    hangar_api.models.project_compact.ProjectCompact(
    ...
    def testPaginatedResultProjectCompact(self):
        """Test PaginatedResultProjectCompact"""
