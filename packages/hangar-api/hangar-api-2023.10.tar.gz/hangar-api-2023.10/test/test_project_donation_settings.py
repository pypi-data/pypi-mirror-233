...
from hangar_api.models.project_donation_settings import ProjectDonationSettings  # noqa: E501

class TestProjectDonationSettings(unittest.TestCase):
    """ProjectDonationSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectDonationSettings:
        """Test ProjectDonationSettings
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectDonationSettings`
        """
        model = ProjectDonationSettings()  # noqa: E501
        if include_optional:
            return ProjectDonationSettings(
                enable = True,
                subject = ''
            )
        else:
    ...
    def testProjectDonationSettings(self):
        """Test ProjectDonationSettings"""
