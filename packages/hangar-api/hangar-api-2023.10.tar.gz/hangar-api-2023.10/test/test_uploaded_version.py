...
from hangar_api.models.uploaded_version import UploadedVersion  # noqa: E501

class TestUploadedVersion(unittest.TestCase):
    """UploadedVersion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadedVersion:
        """Test UploadedVersion
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UploadedVersion`
        """
        model = UploadedVersion()  # noqa: E501
        if include_optional:
            return UploadedVersion(
                url = 'https://hangar.papermc.io/PaperMC/Debuggery/versions/1.0.0'
            )
        else:
            return UploadedVersion(
        )
