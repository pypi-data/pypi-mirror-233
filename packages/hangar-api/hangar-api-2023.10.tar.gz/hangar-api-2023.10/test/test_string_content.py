...
from hangar_api.models.string_content import StringContent  # noqa: E501

class TestStringContent(unittest.TestCase):
    """StringContent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StringContent:
        """Test StringContent
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StringContent`
        """
        model = StringContent()  # noqa: E501
        if include_optional:
