...
from hangar_api.models.project_namespace import ProjectNamespace  # noqa: E501

class TestProjectNamespace(unittest.TestCase):
    """ProjectNamespace unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectNamespace:
        """Test ProjectNamespace
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectNamespace`
        """
        model = ProjectNamespace()  # noqa: E501
        if include_optional:
