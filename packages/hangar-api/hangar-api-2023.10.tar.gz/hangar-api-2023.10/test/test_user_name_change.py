...
from hangar_api.models.user_name_change import UserNameChange  # noqa: E501

class TestUserNameChange(unittest.TestCase):
    """UserNameChange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserNameChange:
        """Test UserNameChange
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserNameChange`
        """
        model = UserNameChange()  # noqa: E501
        if include_optional:
