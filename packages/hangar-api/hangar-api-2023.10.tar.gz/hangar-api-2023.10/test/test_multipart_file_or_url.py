...
from hangar_api.models.multipart_file_or_url import MultipartFileOrUrl  # noqa: E501

class TestMultipartFileOrUrl(unittest.TestCase):
    """MultipartFileOrUrl unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultipartFileOrUrl:
        """Test MultipartFileOrUrl
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultipartFileOrUrl`
        """
        model = MultipartFileOrUrl()  # noqa: E501
        if include_optional:
            return MultipartFileOrUrl(
    ...
    def testMultipartFileOrUrl(self):
        """Test MultipartFileOrUrl"""
