...
from hangar_api.models.paginated_result_version import PaginatedResultVersion  # noqa: E501

class TestPaginatedResultVersion(unittest.TestCase):
    """PaginatedResultVersion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedResultVersion:
        """Test PaginatedResultVersion
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedResultVersion`
        """
        model = PaginatedResultVersion()  # noqa: E501
        if include_optional:
            return PaginatedResultVersion(
                pagination = hangar_api.models.pagination.Pagination(
                    ...
                    count = 56, ),
                result = [
                    hangar_api.models.version.Version(
    ...
    def testPaginatedResultVersion(self):
        """Test PaginatedResultVersion"""
