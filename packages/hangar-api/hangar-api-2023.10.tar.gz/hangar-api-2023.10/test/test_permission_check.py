...
from hangar_api.models.permission_check import PermissionCheck  # noqa: E501

class TestPermissionCheck(unittest.TestCase):
    """PermissionCheck unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PermissionCheck:
        """Test PermissionCheck
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PermissionCheck`
        """
        model = PermissionCheck()  # noqa: E501
        if include_optional:
