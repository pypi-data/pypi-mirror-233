...
from hangar_api.models.create_api_key_form import CreateAPIKeyForm  # noqa: E501

class TestCreateAPIKeyForm(unittest.TestCase):
    """CreateAPIKeyForm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAPIKeyForm:
        """Test CreateAPIKeyForm
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAPIKeyForm`
        """
        model = CreateAPIKeyForm()  # noqa: E501
        if include_optional:
