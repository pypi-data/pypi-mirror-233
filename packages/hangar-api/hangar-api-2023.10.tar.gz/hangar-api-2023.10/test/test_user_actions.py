...
from hangar_api.models.user_actions import UserActions  # noqa: E501

class TestUserActions(unittest.TestCase):
    """UserActions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserActions:
        """Test UserActions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserActions`
        """
        model = UserActions()  # noqa: E501
        if include_optional:
            return UserActions(
                starred = True,
                watching = True,
