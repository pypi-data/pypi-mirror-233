...
from hangar_api.models.page_edit_form import PageEditForm  # noqa: E501

class TestPageEditForm(unittest.TestCase):
    """PageEditForm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageEditForm:
        """Test PageEditForm
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageEditForm`
        """
        model = PageEditForm()  # noqa: E501
        if include_optional:
            return PageEditForm(
                path = '',
                content = ''
