...
from hangar_api.api.users_api import UsersApi  # noqa: E501
...
class TestUsersApi(unittest.TestCase):
    ...
    def test_get_user_pinned_projects(self) -> None:
        """Test case for get_user_pinned_projects

        Returns the pinned projects for a specific user  # noqa: E501
        """
        pass

    def test_get_user_watching(self) -> None:
    ...
    def test_show_starred(self) -> None:
        """Test case for show_starred

        Returns the starred projects for a specific user  # noqa: E501
        """
        pass

    def test_show_users(self) -> None:
