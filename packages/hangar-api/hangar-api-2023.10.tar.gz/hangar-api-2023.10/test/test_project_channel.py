...
from hangar_api.models.project_channel import ProjectChannel  # noqa: E501

class TestProjectChannel(unittest.TestCase):
    """ProjectChannel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectChannel:
        """Test ProjectChannel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectChannel`
        """
        model = ProjectChannel()  # noqa: E501
        if include_optional:
