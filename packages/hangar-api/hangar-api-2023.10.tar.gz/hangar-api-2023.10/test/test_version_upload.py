...
from hangar_api.models.version_upload import VersionUpload  # noqa: E501

class TestVersionUpload(unittest.TestCase):
    """VersionUpload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VersionUpload:
        """Test VersionUpload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VersionUpload`
        """
        model = VersionUpload()  # noqa: E501
        if include_optional:
            return VersionUpload(
                ...
                platform_dependencies = {PAPER: ["1.12", "1.16-1.18.2", "1.20.x"]},
                description = '',
                files = [
                    hangar_api.models.multipart_file_or_url.MultipartFileOrUrl(
