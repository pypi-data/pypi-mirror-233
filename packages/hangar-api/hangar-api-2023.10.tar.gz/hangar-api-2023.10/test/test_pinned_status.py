...
from hangar_api.models.pinned_status import PinnedStatus  # noqa: E501

class TestPinnedStatus(unittest.TestCase):
    """PinnedStatus unit test stubs"""
