...
from hangar_api.models.project_compact import ProjectCompact  # noqa: E501
...
class TestProjectCompact(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProjectCompact:
        """Test ProjectCompact
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectCompact`
        """
