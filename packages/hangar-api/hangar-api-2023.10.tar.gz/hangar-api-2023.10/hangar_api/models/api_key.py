...
class ApiKey(BaseModel):
    ...
    token_identifier: Optional[StrictStr] = Field(default=None, alias="tokenIdentifier")
    permissions: Optional[List[NamedPermission]] = None
    last_used: Optional[datetime] = Field(default=None, alias="lastUsed")
    __properties: ClassVar[List[str]] = ["createdAt", "name", "tokenIdentifier", "permissions", "lastUsed"]
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "tokenIdentifier": obj.get("tokenIdentifier"),
