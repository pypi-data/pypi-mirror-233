...
class ProjectNamespace(BaseModel):
    """
    The namespace of the project  # noqa: E501
    """
    owner: Optional[StrictStr] = None
    slug: Optional[StrictStr] = Field(default=None, description="The unique name of a project")
    __properties: ClassVar[List[str]] = ["owner", "slug"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ProjectNamespace from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of ProjectNamespace from a dict"""
        if obj is None:
            return None
