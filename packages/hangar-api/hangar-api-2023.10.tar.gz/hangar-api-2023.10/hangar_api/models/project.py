...
class Project(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The unique name of the project")
    namespace: Optional[ProjectNamespace] = None
    stats: Optional[ProjectStats] = None
    category: Optional[Category] = None
    last_updated: Optional[datetime] = Field(default=None, description="The last time the project was updated", alias="lastUpdated")
    visibility: Optional[Visibility] = None
    avatar_url: Optional[StrictStr] = Field(default=None, description="The url to the project's icon", alias="avatarUrl")
    description: Optional[StrictStr] = Field(default=None, description="The short description of the project")
    user_actions: Optional[UserActions] = Field(default=None, alias="userActions")
    settings: Optional[ProjectSettings] = None
    __properties: ClassVar[List[str]] = ["createdAt", "name", "namespace", "stats", "category", "lastUpdated", "visibility", "avatarUrl", "description", "userActions", "settings"]
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of user_actions
        if self.user_actions:
            _dict['userActions'] = self.user_actions.to_dict()
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "namespace": ProjectNamespace.from_dict(obj.get("namespace")) if obj.get("namespace") is not None else None,
            "stats": ProjectStats.from_dict(obj.get("stats")) if obj.get("stats") is not None else None,
            "category": obj.get("category"),
            "lastUpdated": obj.get("lastUpdated"),
            "visibility": obj.get("visibility"),
            "avatarUrl": obj.get("avatarUrl"),
            "description": obj.get("description"),
            "userActions": UserActions.from_dict(obj.get("userActions")) if obj.get("userActions") is not None else None,
