...
class CreateAPIKeyForm(BaseModel):
    """
    Data about the key to create  # noqa: E501
    """
    name: Annotated[str, Field(min_length=5, strict=True, max_length=36)]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CreateAPIKeyForm from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of CreateAPIKeyForm from a dict"""
        if obj is None:
            return None
