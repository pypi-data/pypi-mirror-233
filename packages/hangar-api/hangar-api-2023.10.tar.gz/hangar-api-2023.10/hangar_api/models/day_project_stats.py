...
class DayProjectStats(BaseModel):
    """
    DayProjectStats
    """
    views: Optional[StrictInt] = None
    downloads: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["views", "downloads"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DayProjectStats from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of DayProjectStats from a dict"""
        if obj is None:
            return None
