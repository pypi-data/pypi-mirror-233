...
class PluginDependency(BaseModel):
    """
    Map of each platform's plugin dependencies  # noqa: E501
    """
    name: Optional[StrictStr] = Field(default=None, description="Name of the plugin dependency. For non-external dependencies, this should be the Hangar project name")
    required: Optional[StrictBool] = Field(default=None, description="Whether the dependency is required for the plugin to function")
    external_url: Optional[StrictStr] = Field(default=None, description="External url to download the dependency from if not a Hangar project, else null", alias="externalUrl")
    platform: Optional[Platform] = None
    __properties: ClassVar[List[str]] = ["name", "required", "externalUrl", "platform"]
