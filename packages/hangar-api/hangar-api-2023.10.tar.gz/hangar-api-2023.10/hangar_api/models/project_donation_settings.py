...
class ProjectDonationSettings(BaseModel):
    """
    ProjectDonationSettings
    """
    enable: Optional[StrictBool] = None
    subject: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["enable", "subject"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ProjectDonationSettings from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of ProjectDonationSettings from a dict"""
        if obj is None:
            return None
