...
class ProjectStats(BaseModel):
    """
    Stats of the project  # noqa: E501
    """
    views: Optional[StrictInt] = None
    downloads: Optional[StrictInt] = None
    recent_views: Optional[StrictInt] = Field(default=None, alias="recentViews")
    recent_downloads: Optional[StrictInt] = Field(default=None, alias="recentDownloads")
    stars: Optional[StrictInt] = None
    watchers: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["views", "downloads", "recentViews", "recentDownloads", "stars", "watchers"]
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "recentViews": obj.get("recentViews"),
            "recentDownloads": obj.get("recentDownloads"),
            "stars": obj.get("stars"),
