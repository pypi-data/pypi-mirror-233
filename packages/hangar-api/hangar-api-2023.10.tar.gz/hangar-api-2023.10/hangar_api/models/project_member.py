...
class ProjectMember(BaseModel):
    ...
    roles: Optional[List[CompactRole]] = None
    __properties: ClassVar[List[str]] = ["user", "roles"]
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            "user": obj.get("user"),
            "roles": [CompactRole.from_dict(_item) for _item in obj.get("roles")] if obj.get("roles") is not None else None
        })
        return _obj
