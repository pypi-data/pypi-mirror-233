...
class PaginatedResultProjectMember(BaseModel):
    """
    PaginatedResultProjectMember
    """
    pagination: Optional[Pagination] = None
    result: Optional[List[ProjectMember]] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaginatedResultProjectMember from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of PaginatedResultProjectMember from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "result": [ProjectMember.from_dict(_item) for _item in obj.get("result")] if obj.get("result") is not None else None
        })
        return _obj
