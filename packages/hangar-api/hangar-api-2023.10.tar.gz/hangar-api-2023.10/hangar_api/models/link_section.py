...
class LinkSection(BaseModel):
    ...
    type: StrictStr = Field(description="Type of the link. Either SIDEBAR or TOP")
    title: Optional[StrictStr] = None
    links: List[Link]
    __properties: ClassVar[List[str]] = ["id", "type", "title", "links"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of LinkSection from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of LinkSection from a dict"""
        if obj is None:
            return None
