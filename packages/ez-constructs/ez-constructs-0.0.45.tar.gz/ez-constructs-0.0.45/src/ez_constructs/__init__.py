...
class SimpleStepFunction(
    ...
    def assemble(
        ...
        *,
        ...
        :param definition_substitutions: substitutions for the definition body aas a key-value map.
    ...
    def create_state_machine_cloud_watch_log_group(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__84a9295c88626f8d3711c4b72703d01f61dfd6670328e60a8ba6d1aea3747c83)
            check_type(argname="argument state_machine_name", value=state_machine_name, expected_type=type_hints["state_machine_name"])
        return typing.cast(_aws_cdk_aws_logs_ceddda9d.LogGroup, jsii.invoke(self, "createStateMachineCloudWatchLogGroup", [state_machine_name]))
    ...
    def state_definition(
        ...
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "stateDefinition", value)
...
def _typecheckingstub__84a9295c88626f8d3711c4b72703d01f61dfd6670328e60a8ba6d1aea3747c83(
    state_machine_name: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
