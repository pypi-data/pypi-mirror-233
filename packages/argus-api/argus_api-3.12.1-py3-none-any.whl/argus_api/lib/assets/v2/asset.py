...
def get_vulnerability_by_asset(
    ...
    """Get Vulnerabilities belong to the Asset. (PUBLIC)
...
def get_vulnerability_by_asset_and_vulnerability_id(
    ...
    """Get Vulnerabilities belong to the Asset and have same identifier of vulnerability. (PUBLIC)
