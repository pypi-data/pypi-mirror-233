...
get_webauthn_create_options_1 = deprecated_alias("get_webauthn_create_options_1")(get_webauthn_create_options)
...
list_2 = deprecated_alias("list_2")(list_public_keys)