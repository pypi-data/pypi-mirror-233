...
delete_user_1 = deprecated_alias("delete_user_1")(delete_user)
...
get_user_image_1 = deprecated_alias("get_user_image_1")(admin_get_user_image)
...
list_users_1 = deprecated_alias("list_users_1")(list_users)