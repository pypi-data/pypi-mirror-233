...
def add_address_overrides(
    ...
    :param bool clear: Whether to remove all current override entries in the override list. \(default false\)
...
def add_override_list(
    ...
    :param str name: Unique Override list name \=\> \[a\-zA\-Z0\-9\_\:\\\-\\.\]\*
...
def update_override_list(
    ...
    :param str name: If set\, update the name of this list \=\> \[a\-zA\-Z0\-9\_\:\\\-\\.\]\*
...
#: **DEPRECATED** : ``get_override_for_i_p`` is an alias for ``get_override_for_ip``. Exists
#: only for backward compatibility - **do not use** - use ``get_override_for_ip`` instead.
get_override_for_i_p = register_command(
    extending=("reputation", "v1", "override", "domain"),
    module=argus_cli_module,
    alias="get_override_for_i_p"
)(deprecated_alias("get_override_for_i_p")(get_override_for_ip))
#: **DEPRECATED** : ``get_overrides_for_i_p`` is an alias for ``get_overrides_for_ip``. Exists
#: only for backward compatibility - **do not use** - use ``get_overrides_for_ip`` instead.
get_overrides_for_i_p = register_command(
    extending=("reputation", "v1", "override", "domain"),
    module=argus_cli_module,
    alias="get_overrides_for_i_p"
)(deprecated_alias("get_overrides_for_i_p")(get_overrides_for_ip))