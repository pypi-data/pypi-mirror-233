...
def add_attachment(
    ...
    :param bool encryptedZip: DEPRECATED\: This option is deprecated\, use encryptedZipMode instead
    :param str encryptedZipMode: If set to \'server\'\, the server will zip\-encrypt the file using encryptedZipPassword\, and set the outer mimetype to application\/zip.If set to \'client\'\, the server will mark this attachment as already encrypted zip \(document the password using property encryptedZipPassword\).  \(default none\)
    :param str encryptedZipPassword: If encryptedZipMode is set\, use this property to encrypt\/document the password set on the zipfile. \(default argus\)
    ...
    :param bool internal: If set\, the attachment will be marked as internal. This is only allowed by tech users. Internal attachements are only readable by tech users.
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
    :param verify: path to a certificate bundle or boolean indicating whether SSL
      verification should be performed.
...
def add_comment(
    ...
    :param str textFormat: Specify the text format of this comment. Setting plainText gives other consumers a hint that contents does not require a HTML renderer. \(default html\)
...
def advanced_case_search(
    ...
    :param list service: DEPRECATED\: This option is deprecated\, use serviceCriteria instead.
...
def create_case(
    ...
    testData: bool = None,
    descriptionTextFormat: str = None,
    publish: bool = True,
    ...
    :param str descriptionTextFormat: Set the text format of the description. Setting plainText gives other consumers a hint that contents does not require a HTML renderer. \(default html\)
...
def download_attachment(
    ...
    route = "/cases/v2/case/{caseID}/attachments/{attachmentID}/download".format(inline=inline,
        caseID=caseID,
        attachmentID=attachmentID)
    headers = {}
    headers['content'] = None
...
def grant_access(
    ...
    :param bool addWatcher: If true\, also add the granted subject as watcher for this case. \(default true\)
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
    :param verify: path to a certificate bundle or boolean indicating whether SSL
      verification should be performed.
...
def list_case_seen(
    ...
    route = "/cases/v2/case/{caseID}/seen".format(limit=limit,
        caseID=caseID,
        offset=offset)
    headers = {}
...
def upload_streaming_attachment(
    ...
    route = "/cases/v2/case/{caseID}/attachments/upload/{filename}".format(encryptedZipMode=encryptedZipMode,
        encryptedZipPassword=encryptedZipPassword,
        caseID=caseID,
        filename=filename,
...
#: **DEPRECATED** : ``list_case_a_c_l`` is an alias for ``list_case_acl``. Exists
#: only for backward compatibility - **do not use** - use ``list_case_acl`` instead.
list_case_a_c_l = register_command(
    extending=("cases", "v2", "case"),
    module=argus_cli_module,
    alias="list_case_a_c_l"
)(deprecated_alias("list_case_a_c_l")(list_case_acl))
#: **DEPRECATED** : ``list_case_seen_status`` is an alias for ``list_case_seen``. Exists
#: only for backward compatibility - **do not use** - use ``list_case_seen`` instead.
list_case_seen_status = register_command(
    extending=("cases", "v2", "case"),
    module=argus_cli_module,
    alias="list_case_seen_status"
)(deprecated_alias("list_case_seen_status")(list_case_seen))
#: **DEPRECATED** : ``register_case_seen_status`` is an alias for ``register_case_seen``. Exists
#: only for backward compatibility - **do not use** - use ``register_case_seen`` instead.
register_case_seen_status = register_command(
    extending=("cases", "v2", "case"),
    module=argus_cli_module,
    alias="register_case_seen_status"
)(deprecated_alias("register_case_seen_status")(register_case_seen))