...
def create_location(
    ...
    :param str shortName: Short name of some physical Location \=\> \[a\-zA\-Z0\-9\_\:\\\-\\.\]\*
...
def find_locations(
    ...
    :param str searchString: DEPRECATED\: Deprecated. Use keywords.
...
def update_location(
    ...
    :param str name: New name for the Location \=\> \[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\*
    :param str shortName: New short name for the Location \=\> \[a\-zA\-Z0\-9\_\:\\\-\\.\]\*
