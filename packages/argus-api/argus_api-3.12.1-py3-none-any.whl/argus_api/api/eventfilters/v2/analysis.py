...
@register_command(
    extending=("eventfilters", "v2", "analysis"),
    module=argus_cli_module
)
def add_analysis_filter(
    preStatementCode1: str = None,
    preStatementCode2: str = None,
    statementCode: str = None,
    triggerCode: str = None,
    actionName: str = None,
    defaultAggregate: bool = None,
    skipNewEvent: bool = None,
    name: str = None,
    ...
    """Adds an analysis filter (DEV)
    
    :param str preStatementCode1: 
    :param str preStatementCode2: 
    :param str statementCode: 
    :param str triggerCode: 
    :param str actionName: 
    :param bool defaultAggregate: 
    :param bool skipNewEvent: 
    ...
    body = body or {}
    # Only send preStatementCode1 if the argument was provided, don't send null values
    if preStatementCode1 is not None:
        body.update({"preStatementCode1": preStatementCode1})
    # Only send preStatementCode2 if the argument was provided, don't send null values
    if preStatementCode2 is not None:
        body.update({"preStatementCode2": preStatementCode2})
    # Only send statementCode if the argument was provided, don't send null values
    if statementCode is not None:
        body.update({"statementCode": statementCode})
    # Only send triggerCode if the argument was provided, don't send null values
    if triggerCode is not None:
        body.update({"triggerCode": triggerCode})
    # Only send actionName if the argument was provided, don't send null values
    if actionName is not None:
        body.update({"actionName": actionName})
    # Only send defaultAggregate if the argument was provided, don't send null values
    if defaultAggregate is not None:
        body.update({"defaultAggregate": defaultAggregate})
    # Only send skipNewEvent if the argument was provided, don't send null values
    if skipNewEvent is not None:
        body.update({"skipNewEvent": skipNewEvent})
...
def delete_analysis_filter(
    ...
    """Deletes an analysis filter (DEV)
    ...
    route = "/eventfilters/v2/analysis/{id}".format(id=id)
    headers = {}
...
def disable_analysis_filter(
    ...
    """Disables an analysis filter (DEV)
...
def disable_analysis_filter_on_instance(
    ...
    """Disables an analysis filter on instance (DEV)
...
def duplicate_analysis_filter(
    ...
    """Duplicates an analysis filter (DEV)
...
def enable_analysis_filter(
    ...
    """Enables an analysis filter (DEV)
...
def enable_analysis_filter_on_instance(
    ...
    """Enables an analysis filter on instance (DEV)
...
def get_analysis_filter_revisions(
    ...
    """Gets a analysis filters earlier revisions (DEV)
...
def get_analysis_filter_status(
    ...
    """Gets the status of a analysis filters instance statuses (DEV)
...
def list_analysis_filter(
    ...
    """Simple search for analysis filters (DEV)
...
def revert_analysis_filter(
    ...
    """Reverts an analysis filter to a previous revision (DEV)
...
def revive_analysis_filter(
    ...
    """Revives a deleted a analysis filter (DEV)
...
def search_analysis_filter(
    ...
    """Searches for analysis filters (DEV)
...
def set_analysis_filter_log_level(
    ...
    """Sets the log level of a analysis filter (DEV)
...
def update_analysis_filter(
    ...
    """Updates an analysis filter (DEV)
