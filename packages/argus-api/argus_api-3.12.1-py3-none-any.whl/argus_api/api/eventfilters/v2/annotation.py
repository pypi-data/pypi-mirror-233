...
@register_command(
    extending=("eventfilters", "v2", "annotation"),
...
def add_annotation_filter(
    ...
    body = body or {}
    # Only send stage if the argument was provided, don't send null values
    if stage is not None:
        body.update({"stage": stage})
...
def delete_annotation_filter(
    ...
    """Deletes an annotation filter (DEV)
    ...
    route = "/eventfilters/v2/annotation/{id}".format(id=id)
    headers = {}
...
def disable_annotation_filter(
    ...
    """Disables an annotation filter (DEV)
...
def disable_annotation_filter_on_instance(
    ...
    """Disables an annotation filter on instance (DEV)
    ...
    route = "/eventfilters/v2/annotation/{filterID}/{instanceID}/disable".format(filterID=filterID,
...
def duplicate_annotation_filter(
    ...
    """Duplicates a annotation filter (DEV)
    
    :param int id: ID of filter
    :param str customerIDOrShortname: DEPRECATED\: The customer the duplicate should belong to \(id or shortname\). The default is using the same customer as the original filter.
...
def enable_annotation_filter(
    ...
    """Enables an annotation filter (DEV)
...
def enable_annotation_filter_on_instance(
    ...
    """Enables an annotation filter on instance (DEV)
    ...
    route = "/eventfilters/v2/annotation/{filterID}/{instanceID}/enable".format(filterID=filterID,
        instanceID=instanceID)
    headers = {}
...
def get_annotation_filter_status(
    ...
    """Gets the status of a annotation filters instances (DEV)
    ...
    route = "/eventfilters/v2/annotation/{id}/status".format(limit=limit,
        id=id,
        offset=offset)
    headers = {}
...
def list_annotation_filter(
    ...
    """Simple search for annotation filters (DEV)
    ...
    route = "/eventfilters/v2/annotation".format(keywordMatchStrategy=keywordMatchStrategy,
...
def list_annotation_filter_revisions(
    ...
    """Gets a annotation filters earlier revisions (DEV)
    ...
    route = "/eventfilters/v2/annotation/{id}/revisions".format(limit=limit,
        id=id,
        offset=offset)
    headers = {}
...
def revert_annotation_filter(
    ...
    """Reverts an annotation filter to a previous revision (DEV)
...
def revive_annotation_filter(
    ...
    """Revives a deleted a annotation filter (DEV)
...
def search_annotation_filter(
    ...
    """Searches for annotation filters (DEV)
...
def set_annotation_filter_log_level(
    ...
    """Sets the log level of a annotation filter (DEV)
...
def update_annotation_filter(
    ...
    """Updates an annotation filter (DEV)
