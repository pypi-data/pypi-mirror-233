...
def add_match_filter(
    ...
    uriPattern: str = None,
    sourceIPAddresses: str = None,
    sourcePorts: int = None,
    destinationIPAddresses: str = None,
    destinationPorts: int = None,
    sourceOrDestinationIPAddresses: str = None,
    sourceOrDestinationPorts: int = None,
    attackIdentifier: str = None,
    attackCategory: str = None,
    transformCode: str = None,
    newAggregationKey: str = None,
    newSeverity: str = None,
    newSourceAggregationBits: int = None,
    newDestinationAggregationBits: int = None,
    drop: bool = None,
    noTransform: bool = None,
    continueAfterTransform: bool = None,
    stopAfterNoMatch: bool = None,
    changeAggregationKey: bool = None,
    invertIp: bool = None,
    alarmID: int = None,
    sensorID: int = None,
    name: str = None,
    ...
    """Adds a match filter (DEV)
    
    :param list location: 
    :param dict properties: 
    :param str protocol: 
    :param str domainPattern: 
    :param int associatedCaseID: 
    :param str matchCode: 
    :param str minSeverity: 
    :param str maxSeverity: 
    :param list includeEventFlags: 
    :param list excludeEventFlags: 
    :param str uriPattern: 
    :param list sourceIPAddresses: 
    :param list sourcePorts: 
    :param list destinationIPAddresses: 
    :param list destinationPorts: 
    :param list sourceOrDestinationIPAddresses: 
    :param list sourceOrDestinationPorts: 
    :param list attackIdentifier: 
    :param list attackCategory: 
    :param str transformCode: 
    :param str newAggregationKey: 
    :param str newSeverity: 
    :param int newSourceAggregationBits: 
    :param int newDestinationAggregationBits: 
    :param bool drop: 
    :param bool noTransform: 
    :param bool continueAfterTransform: 
    :param bool stopAfterNoMatch: 
    :param bool changeAggregationKey: 
    :param bool invertIp: 
    :param list alarmID: 
    :param list sensorID: 
    ...
    # Only send domainPattern if the argument was provided, don't send null values
    if domainPattern is not None:
        body.update({"domainPattern": domainPattern})
    ...
    # Only send matchCode if the argument was provided, don't send null values
    if matchCode is not None:
        body.update({"matchCode": matchCode})
    ...
    # Only send uriPattern if the argument was provided, don't send null values
    if uriPattern is not None:
        body.update({"uriPattern": uriPattern})
    # Only send sourceIPAddresses if the argument was provided, don't send null values
    if sourceIPAddresses is not None:
        body.update({"sourceIPAddresses": sourceIPAddresses})
    # Only send sourcePorts if the argument was provided, don't send null values
    if sourcePorts is not None:
        body.update({"sourcePorts": sourcePorts})
    # Only send destinationIPAddresses if the argument was provided, don't send null values
    if destinationIPAddresses is not None:
        body.update({"destinationIPAddresses": destinationIPAddresses})
    # Only send destinationPorts if the argument was provided, don't send null values
    if destinationPorts is not None:
        body.update({"destinationPorts": destinationPorts})
    # Only send sourceOrDestinationIPAddresses if the argument was provided, don't send null values
    if sourceOrDestinationIPAddresses is not None:
        body.update({"sourceOrDestinationIPAddresses": sourceOrDestinationIPAddresses})
    # Only send sourceOrDestinationPorts if the argument was provided, don't send null values
    if sourceOrDestinationPorts is not None:
        body.update({"sourceOrDestinationPorts": sourceOrDestinationPorts})
    ...
    # Only send transformCode if the argument was provided, don't send null values
    if transformCode is not None:
        body.update({"transformCode": transformCode})
    # Only send newAggregationKey if the argument was provided, don't send null values
    if newAggregationKey is not None:
        body.update({"newAggregationKey": newAggregationKey})
    ...
    # Only send newSourceAggregationBits if the argument was provided, don't send null values
    if newSourceAggregationBits is not None:
        body.update({"newSourceAggregationBits": newSourceAggregationBits})
    # Only send newDestinationAggregationBits if the argument was provided, don't send null values
    if newDestinationAggregationBits is not None:
        body.update({"newDestinationAggregationBits": newDestinationAggregationBits})
    # Only send drop if the argument was provided, don't send null values
    if drop is not None:
        body.update({"drop": drop})
    # Only send noTransform if the argument was provided, don't send null values
    if noTransform is not None:
        body.update({"noTransform": noTransform})
    # Only send continueAfterTransform if the argument was provided, don't send null values
    if continueAfterTransform is not None:
        body.update({"continueAfterTransform": continueAfterTransform})
    # Only send stopAfterNoMatch if the argument was provided, don't send null values
    if stopAfterNoMatch is not None:
        body.update({"stopAfterNoMatch": stopAfterNoMatch})
    # Only send changeAggregationKey if the argument was provided, don't send null values
    if changeAggregationKey is not None:
        body.update({"changeAggregationKey": changeAggregationKey})
    # Only send invertIp if the argument was provided, don't send null values
    if invertIp is not None:
        body.update({"invertIp": invertIp})
...
def debug_match_filter(
    ...
    """Shows the result of running a match filter against a set of events (DEV)
...
def disable_match_filter_on_instance(
    ...
    """Disables a match filter on instance (DEV)
...
def duplicate_match_filter(
    id: int,
    customerIDOrShortname: str = None,
    customer: str = None,
    json: bool = True,
    verify: Optional[bool] = None,
    proxies: Optional[dict] = None,
    ...
    """Duplicates a match filter (DEV)
    
    :param int id: ID of filter
    :param str customerIDOrShortname: DEPRECATED\: The customer the duplicate should belong to \(id or shortname\). Use \'0\' to create a global filter\, If this field is not set the default is using the same customer as the original filter.
    ...
    body = body or {}
    # Only send customerIDOrShortname if the argument was provided, don't send null values
    if customerIDOrShortname is not None:
        body.update({"customerIDOrShortname": customerIDOrShortname})
    # Only send customer if the argument was provided, don't send null values
    if customer is not None:
        body.update({"customer": customer})
...
def enable_match_filter_on_instance(
    ...
    """Enables a match filter on instance (DEV)
...
def get_match_filter_status(
    ...
    """Gets the statuses of a match filters instances (DEV)
...
def list_match_filter(
    ...
    """Simple search for match filters (DEV)
...
def list_match_filter_revisions(
    ...
    """Gets a match filters earlier revisions (DEV)
...
def revert_match_filter(
    ...
    """Reverts a match filter to a previous revision (DEV)
...
def revive_match_filter(
    ...
    """Revives a deleted a Match filter (DEV)
...
def search_match_filter(
    ...
    """Searches for match filters (DEV)
    ...
    :param list sensorID: Limit to filters which target the following sensors
...
def set_match_filter_log_level(
    ...
    """Sets the log level of a Match filter (DEV)
