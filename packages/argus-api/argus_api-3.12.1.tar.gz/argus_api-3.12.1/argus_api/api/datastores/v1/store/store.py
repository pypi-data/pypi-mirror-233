...
def get_entries_from_store(
    ...
    :param str startTimestamp: Restrict search to entries which were last updated after this timestamp \(including\). Allows unix timestamp \(milliseconds\)\, ISO timestamp\, or relative time notation. See https\:\/\/docs.mnemonic.no\/x\/AQDXAQ
    :param str endTimestamp: Restrict search to entries which were last updated before this timestamp \(including\). Allows unix timestamp \(milliseconds\)\, ISO timestamp\, or relative time notation. See https\:\/\/docs.mnemonic.no\/x\/AQDXAQ
...
#: **DEPRECATED** : ``put_single_data_store_entry`` is an alias for ``put_single_data_store_list_entry``. Exists
#: only for backward compatibility - **do not use** - use ``put_single_data_store_list_entry`` instead.
put_single_data_store_entry = register_command(
    extending=("datastores", "v1", "store"),
    module=argus_cli_module,
    alias="put_single_data_store_entry"
)(deprecated_alias("put_single_data_store_entry")(put_single_data_store_list_entry))
#: **DEPRECATED** : ``put_single_data_store_entry_1`` is an alias for ``put_single_data_store_map_entry``. Exists
#: only for backward compatibility - **do not use** - use ``put_single_data_store_map_entry`` instead.
put_single_data_store_entry_1 = register_command(
    extending=("datastores", "v1", "store"),
    module=argus_cli_module,
    alias="put_single_data_store_entry_1"
)(deprecated_alias("put_single_data_store_entry_1")(put_single_data_store_map_entry))