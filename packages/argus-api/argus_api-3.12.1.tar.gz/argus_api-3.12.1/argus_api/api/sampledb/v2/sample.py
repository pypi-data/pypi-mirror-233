...
def add_analysis(
    ...
    :param str jobID: The ID of the job that initiated the analysis
    ...
    :param str analyzerName: Name of the analyzer that produced this result \=\> \[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\*
    ...
    :param dict categories: The categories to scores mapping for this analysis. Possible values for the key\: hackTool\, adware\, spyware\, trojan\, ransomware\, other. The value is a score from \-1 to 100 and is an indication of how certain the analyzer is that the category is correct. A value of \-1 indicates no findings. The verdict engine will only consider the \`other\` category when creating a verdict
    :param list tags: The tags for the analysis
    :param list flags: The flags for the analysis
    ...
    if acl is not None:
        body.update({"acl": acl})
    # Only send jobID if the argument was provided, don't send null values
    if jobID is not None:
        body.update({"jobID": jobID})
    ...
    # Only send analyzerName if the argument was provided, don't send null values
...
def add_evidence(
    ...
    :param list flags: Flags for the evidence
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
    :param verify: path to a certificate bundle or boolean indicating whether SSL
      verification should be performed.
...
def add_submission(
    ...
    :param str tlp: TLP color of the submission. Defaults to amber \(default amber\)
...
def add_verdict(
    ...
    :param str sha256: 
    :param list analysisID: A list of analysisIDs that serves as the basis for the verdict status
    :param str comment: A comment providing information or context to the verdict \=\> \[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\*
    :param dict scores: Scores for the different verdict statuses. Possible values for the key\: unknown\, malicious\, benign\, noFindings\, unwanted\, suspicious. The value is a score from 0\-100 and is an indication of how certain it is that the status is correct
    :param dict categories: The categories to scores mapping for this verdict. Possible values for the key\: hackTool\, adware\, spyware\, trojan\, ransomware\, other. The value is a score from 0\-100 and is an indication of how certain it is that the category is correct
    :param list tags: Tags for the verdict
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
    :param verify: path to a certificate bundle or boolean indicating whether SSL
      verification should be performed.
    ...
    body = body or {}
    # Only send analysisID if the argument was provided, don't send null values
    if analysisID is not None:
        body.update({"analysisID": analysisID})
    # Only send comment if the argument was provided, don't send null values
    if comment is not None:
        body.update({"comment": comment})
    # Only send scores if the argument was provided, don't send null values
    if scores is not None:
        body.update({"scores": scores})
    # Only send categories if the argument was provided, don't send null values
    if categories is not None:
        body.update({"categories": categories})
    # Only send tags if the argument was provided, don't send null values
...
def advanced_search(
    ...
    :param list sortBy: Specify sort ordering for returned samples \(default \-sampleCreationTimestamp\)
    ...
    :param int indexStartTimestamp: Restrict search to data after this time. Timestamps can be milliseconds since epoch\, ISO8601 timestamp\, or a string with a relative timestamp. See the general integration guide for more details \(default now \- 1 month\)
    :param int indexEndTimestamp: Restrict search to data before this time. Timestamps can be milliseconds since epoch\, ISO8601 timestamp\, or a string with a relative timestamp. See the general integration guide for more details \(default now\)
...
def list_analysis(
    ...
    :param str sha256: Sha256 of sample to fetch the analysis from
    :param list analyserName: Only return analyses with any of these analyser names. Filtering is done on the user agent name if it exists. If it doesn\'t the analyserName field is used
    ...
    # Only send analyserName if the argument was provided, don't send null values
    if analyserName is not None:
        query_parameters.update({"analyserName": analyserName})
...
def list_analysis_categories(
    ...
    """Lists valid analysis categories (DEV)
    ...
    route = "/sampledb/v2/sample/analysis/category".format(limit=limit,
        offset=offset)
    headers = {}
...
def list_classifications(
    ...
    :param str sha256: Sha256 of the sample
    :param list sortBy: The field on which to sort the classifications
...
def upload_evidence(
    ...
    :param list flags: The flags to set on the evidence
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
    :param verify: path to a certificate bundle or boolean indicating whether SSL
      verification should be performed.
    ...
    # Only send flags if the argument was provided, don't send null values
    if flags is not None:
        query_parameters.update({"flags": flags})
