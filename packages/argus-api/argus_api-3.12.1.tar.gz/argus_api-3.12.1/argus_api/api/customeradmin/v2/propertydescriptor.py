...
def add_property_descriptor(
    ...
    """Create a new property descriptor (DEV)
    ...
    :param str defaultValue: Default value of the property. If left empty\, the default for the given type will be set.
...
def add_property_descriptor_enum_entry(
    ...
    """Create a new property descriptor enum entry (DEV)
...
def delete_property_descriptor(
    ...
    """Delete a property descriptor (DEV)
...
def delete_property_descriptor_enum_entry(
    ...
    """Delete a property descriptor enum entry (DEV)
...
def get_property_descriptor(
    ...
    """Returns a property descriptor identified by its UUID or key (DEV)
...
def get_property_descriptor_json_schema(
    ...
    """Returns JSON Schema for a property descriptor identified by its UUID or key. (DEV)
...
def list_property_descriptor_enum_entries(
    ...
    """Returns property descriptor enum entries defined by query parameters (DEV)
...
def list_property_descriptors(
    ...
    """Returns property descriptors defined by query parameters (DEV)
...
def search_property_descriptor(
    ...
    """Returns property descriptors defined by SearchPropertyDescriptorRequest (DEV)
...
def search_property_descriptor_enum_entries(
    ...
    """Returns property descriptors defined by SearchPropertyDescriptorEnumEntryRequest (DEV)
...
def update_property_descriptor(
    ...
    """Update a property descriptor object. (DEV)
    
    :param str idOrKey: Property descriptor UUID or key
    :param dict localizedDescriptions: Descriptions. Mapped by language.
    :param str section: Section of the property.
    :param str defaultValue: Default value of the property.
    :param str type: Type of the property.
    :param dict schema: 
    :param bool deprecated: Set\/unset the deprecated flag. \(default null\)
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
    :param verify: path to a certificate bundle or boolean indicating whether SSL
      verification should be performed.
...
def update_property_descriptor_enum_entry(
    ...
    """Update a property descriptor enum entry object. (DEV)
