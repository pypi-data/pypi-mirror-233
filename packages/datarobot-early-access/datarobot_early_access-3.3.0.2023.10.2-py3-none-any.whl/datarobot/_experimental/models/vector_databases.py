...
text_chunking_parameter_fields_trafaret = t.Dict(
    {
        ...
        t.Key("default"): t.Or(t.Int, t.List(t.String)),
...
vector_database_trafaret = t.Dict(
    {
        ...
        t.Key("dataset_version_id", optional=True, default=None): t.Or(t.Null, t.String),
...
custom_model_vector_database_validation = t.Dict(
    {
        t.Key("id"): t.String,
...
class CustomModelVectorDatabaseValidation(APIObject):
    """
    ...
    _converter = custom_model_vector_database_validation
    ...
    @classmethod
    def get(cls, validation_id: str) -> CustomModelVectorDatabaseValidation:
        """
        ...
        ----------
        validation_id : str
            The ID of the CustomModelVectorDatabaseValidation for the deployment.
    ...
    def create(
        ...
        """
        Start the validation of deployment to serve as a vector database.
        ...
        deployment_id : str
            ID of the deployment.
            Underlying model id will be derived from deployment info automatically.
        wait_for_completion : bool
            ...
            CustomModelVectorDatabaseValidation.get with returned ID.
        ...
        if wait_for_completion:
            wait_for_async_resolution(cls._client, response.headers["Location"])
        return cls.from_server_data(response.json())

    @classmethod
    def revalidate(cls, validation_id: str) -> CustomModelVectorDatabaseValidation:
        """
        Revalidate an unlinked custom model vector database.
        This method is useful when a deployment used as vector database is accidentally replaced
        with another model that stopped complying with the vector database requirements.
        Replace the model and call this method as a shortcut to creating a new vector database
        from scratch.

        Parameters
        ----------
        validation_id : str
            The ID of the CustomModelVectorDatabaseValidation for revalidation.
    ...
    def __str__(self) -> str:
        return f"CustomModelVectorDatabaseValidation({self.id})"
