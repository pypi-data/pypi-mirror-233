...
class Block(rx.Base):
    ...
    @classmethod
    def from_line(cls, line: str) -> Block | None:
    ...
    def _apply_transforms(self, line: str, env: dict[str, Any]) -> str:
    ...
    def get_content(self, env: dict[str, Any]) -> str:
    ...
    def render(self, env: dict[str, Any] | None = None) -> rx.Component:
        """Render a block to a Reflex component.

        Args:
            env: The environment variables to use when rendering the block.
