...
def easy_load(app=None, plugin_list=None, plugin_folders=None, **kwargs):
    '''
    ...
    sp = Senpy(app, plugin_folders=plugin_folders, plugin_list=plugin_list **kwargs)
    return sp, app
