...
def main_function(argv):
    ...
    params = api.parse_params(argv_to_dict(argv),
                              ...
                              api.API_PARAMS,
                              api.NIF_PARAMS)
    plugin_folders = params['plugin-folder'].split(":")
    include_default = not params.get('no-default-plugins', False)
    sp = Senpy(include_default=include_default, plugin_folders=plugin_folders)
