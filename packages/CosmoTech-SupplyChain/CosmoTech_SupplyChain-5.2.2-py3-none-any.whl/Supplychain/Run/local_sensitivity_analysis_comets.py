...
def run_one_sa(
    ...
    with Timer("[Run one sensitivity analysis]") as t:
        ...
        list_of_datapaths, max_time_step = get_simulator_data(
...
def get_simulator_data(simulator_path, entity_type, attribute):
    ...
    Returns:
        (list, integer): list of datapaths on which the S.A will be used and number of time steps of the simulation
    """
    ...
    return list_of_datapaths, max_time_step
