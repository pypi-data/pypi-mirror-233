...
from abstract_utilities.time_utils import get_time_stamp,get_sleep
...
class RateLimiter:
    ...
    def request(self):
        ...
        new_tokens = time_since_last_request * self.refill_rate
        ...
        if self.tokens >= 1:
            ...
            time_to_wait = (1 - self.tokens) / self.refill_rate
            get_sleep(time_to_wait)
            return self.request()

    def retry_after(self, seconds):
