...
class SafeRequest:
    ...
    def __init__(self,
        ...
        self.headers = self.user_agent_manager.get_user_agent(user_agent=headers)
        self.max_retries=max_retries
        self.request_wait_limit = request_wait_limit
        self.session = self.initialize_session()
        self.last_request_time = last_request_time
        self.headers = headers
        self.response = None if url == None else self.make_request()
    ...
    def update_url(self,url):
        self.url_manager =URLManagerSingleton().get_instance(url=url)
        self.url=self.url_manager.correct_url
