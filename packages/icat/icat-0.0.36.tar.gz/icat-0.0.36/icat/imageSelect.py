...
class boxDraw:
    def __init__(self, bgColor=24, \
                chars="",\
                frameColors=[],\
                title="", statusBar='', mode='auto', charset='utf8'):
        ...
        if len(chars)!=9:
            ...
            if charset.lower() in ['utf8', 'utf-8']:
                ...
                cd=grchr['ascii']
            self.chars=f'{cd["TL"]}{cd["TC"]}{cd["TR"]}'\
                        f'{cd["ML"]}{cd["MC"]}{cd["MR"]}'\
                        f'{cd["BL"]}{cd["BC"]}{cd["BR"]}'
        else:
            self.chars=chars
...
class imageSelect:
    ...
    def interface(self, target, images, describe, mode='auto', charset='utf8'):
        ...
        if charset.lower() in [ 'utf8', 'utf-8' ]:
            ...
            cd=grchr['ascii']
        chars=f'{cd["B100"]}{cd["TH"]}{cd["B100"]}'\
                    f'{cd["B100"]}{cd["B0"]}{cd["B100"]}'\
                    f'{cd["B100"]}{cd["BH"]}{cd["B100"]}'
        ...
        y0=2
        ysep=0
        backBox=boxDraw(chars=chars, title=describe, statusBar='',mode=mode, charset=charset)
