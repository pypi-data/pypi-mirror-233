...
#error "This file is deprecated. Use the header file from /opt/rocm-5.7.0/include/hiprand/hiprand_mtgp32_host.h by using #include <hiprand/hiprand_mtgp32_host.h>"
#else  /* ROCM_HEADER_WRAPPER_WERROR 0 */
/* give warning */
#if defined(_MSC_VER)
#pragma message(": warning:This file is deprecated. Use the header file from /opt/rocm-5.7.0/include/hiprand/hiprand_mtgp32_host.h by using #include <hiprand/hiprand_mtgp32_host.h>")
#elif defined(__GNUC__)
#warning "This file is deprecated. Use the header file from /opt/rocm-5.7.0/include/hiprand/hiprand_mtgp32_host.h by using #include <hiprand/hiprand_mtgp32_host.h>"
#endif
