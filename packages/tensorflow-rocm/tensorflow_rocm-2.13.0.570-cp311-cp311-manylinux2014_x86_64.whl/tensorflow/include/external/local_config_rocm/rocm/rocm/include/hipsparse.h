...
#error "This file is deprecated. Use the header file from /opt/rocm-5.7.0/include/hipsparse/hipsparse.h by using #include <hipsparse/hipsparse.h>"
#else  /* ROCM_HEADER_WRAPPER_WERROR 0 */
/* give warning */
#if defined(_MSC_VER)
#pragma message(": warning:This file is deprecated. Use the header file from /opt/rocm-5.7.0/include/hipsparse/hipsparse.h by using #include <hipsparse/hipsparse.h>")
#elif defined(__GNUC__)
#warning "This file is deprecated. Use the header file from /opt/rocm-5.7.0/include/hipsparse/hipsparse.h by using #include <hipsparse/hipsparse.h>"
#endif
