...
#error "This file is deprecated. Use the header file from /opt/rocm-5.7.0/include/rocrand/rocrand_mrg32k3a_precomputed.h by using #include <rocrand/rocrand_mrg32k3a_precomputed.h>"
#else  /* ROCM_HEADER_WRAPPER_WERROR 0 */
/* give warning */
#if defined(_MSC_VER)
#pragma message(": warning:This file is deprecated. Use the header file from /opt/rocm-5.7.0/include/rocrand/rocrand_mrg32k3a_precomputed.h by using #include <rocrand/rocrand_mrg32k3a_precomputed.h>")
#elif defined(__GNUC__)
#warning "This file is deprecated. Use the header file from /opt/rocm-5.7.0/include/rocrand/rocrand_mrg32k3a_precomputed.h by using #include <rocrand/rocrand_mrg32k3a_precomputed.h>"
#endif
