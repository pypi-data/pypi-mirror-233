...
#error "This file is deprecated. Use the header file from /opt/rocm-5.7.0/include/rocrand/rocrand_uniform.h by using #include <rocrand/rocrand_uniform.h>"
#else  /* ROCM_HEADER_WRAPPER_WERROR 0 */
/* give warning */
#if defined(_MSC_VER)
#pragma message(": warning:This file is deprecated. Use the header file from /opt/rocm-5.7.0/include/rocrand/rocrand_uniform.h by using #include <rocrand/rocrand_uniform.h>")
#elif defined(__GNUC__)
#warning "This file is deprecated. Use the header file from /opt/rocm-5.7.0/include/rocrand/rocrand_uniform.h by using #include <rocrand/rocrand_uniform.h>"
#endif
