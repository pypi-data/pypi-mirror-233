...
#ifndef ROCM_SYMLINK_ROCSOLVER_VERSION_H
#define ROCM_SYMLINK_ROCSOLVER_VERSION_H
...
#error "This file is deprecated. Use the header file from /opt/rocm-5.7.0/include/rocsolver/rocsolver-version.h by using #include <rocsolver/rocsolver-version.h>"
#else  /* ROCM_HEADER_WRAPPER_WERROR 0 */
/* give warning */
#if defined(_MSC_VER)
#pragma message(": warning:This file is deprecated. Use the header file from /opt/rocm-5.7.0/include/rocsolver/rocsolver-version.h by using #include <rocsolver/rocsolver-version.h>")
#elif defined(__GNUC__)
#warning "This file is deprecated. Use the header file from /opt/rocm-5.7.0/include/rocsolver/rocsolver-version.h by using #include <rocsolver/rocsolver-version.h>"
#endif
...
#endif /* ROCM_SYMLINK_ROCSOLVER_VERSION_H */
