...
def test_heat_source():
    ...
    # ===================================================================================================================
    # Set Heat Pump
    my_heat_source = generic_heat_source.HeatSource(
    ...
    my_heat_source.l1_heatsource_taget_percentage.source_output = (
        my_heat_source_controller_l1.heat_pump_target_percentage_channel
    )
