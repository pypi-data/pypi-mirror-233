...
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/tests/test_examples_household_3_advanced_hp_diesel_car_pv_battery.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/tests/test_generic_gas_heater.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/tests/test_examples_basic_household.py
if %errorlevel% neq 0 exit /b
...
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/tests/test_examples_household_1_advanced_hp_diesel_car.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/tests/test_examples_household_with_heatpump_and_pv.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/tests/test_example_transformer.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/tests/test_examples_household_4_advanced_hp_ev_pv.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/tests/test_examples_household_with_gas_heater_with_new_controller.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/tests/test_gas_heater.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/tests/test_examples_household_reference_gas_heater_diesel_car.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/tests/test_examples_household_2_advanced_hp_diesel_car_pv.py
if %errorlevel% neq 0 exit /b
...
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/tests/test_examples_basic_household_network_chart.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/tests/test_examples_basic_household_with_all_resultfiles.py
if %errorlevel% neq 0 exit /b
...
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/tests/test_examples_household_5_advanced_hp_ev_pv_battery.py
if %errorlevel% neq 0 exit /b
...
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/examples/household_with_gas_heater_with_controller.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/examples/household_reference_gas_heater_diesel_car.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/examples/default_connections.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/examples/household_5_advanced_hp_ev_pv_battery.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/examples/household_2_advanced_hp_diesel_car_pv.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/examples/household_with_gas_heater.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/examples/dynamic_components.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/examples/household_with_advanced_hp_hws_hds_pv.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/examples/electrolyzer_with_renewables.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/examples/household_cluster_advanced_hp_pv_battery_ems.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/examples/household_3_advanced_hp_diesel_car_pv_battery.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/examples/basic_household.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/examples/basic_household_only_heating.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/examples/household_cluster_reference_advanced_hp.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/examples/household_1_advanced_hp_diesel_car.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/examples/household_4_advanced_hp_ev_pv.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/examples/household_with_advanced_hp_hws_hds_pv_battery_ems.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/examples/simple_examples.py
if %errorlevel% neq 0 exit /b
pylint /fast/home/k-rieck/repositories/HiSim/examples/household_with_heatpump_and_pv.py
if %errorlevel% neq 0 exit /b
