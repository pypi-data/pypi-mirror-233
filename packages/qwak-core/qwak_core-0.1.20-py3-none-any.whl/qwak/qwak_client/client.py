...
class QwakClient:
    ...
    def get_latest_build(
        ...
        builds = self._get_build_management().list_builds(model_uuid=model_uuid).builds
        if not builds:
            return None
    ...
    def list_feature_sets(self) -> List[BatchFeatureSetV1]:
        """
