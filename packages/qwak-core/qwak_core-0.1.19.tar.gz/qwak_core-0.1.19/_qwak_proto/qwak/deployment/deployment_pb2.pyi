...
class DeploymentPhase(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "deployment_phase_status", b"deployment_phase_status", "deployment_phase_type", b"deployment_phase_type", "last_modified_at", b"last_modified_at", "phase_duration_in_seconds", b"phase_duration_in_seconds"]) -> None: ...
