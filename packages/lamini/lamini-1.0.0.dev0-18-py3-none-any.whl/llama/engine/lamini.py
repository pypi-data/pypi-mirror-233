...
class Lamini:
    ...
    def train_async(
        ...
        req_data = {"id": self.id, "model_name": self.model_name, "data": data}
        ...
        job = self.make_web_request(url, "post", req_data)
    ...
    def delete_data(self):
        ...
        return self.make_web_request(url, "post", {"id": self.id})

    def make_web_request(self, url, http_method, json):
        # print("make_web_request" + str(json))
        headers = {
