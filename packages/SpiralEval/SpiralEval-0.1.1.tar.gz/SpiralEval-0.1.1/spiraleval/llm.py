...
class EvalLLM:
    ...
    def run(self, instruction):
        ...
        for item in self.target_data:
            ...
            all_result_df.to_csv('large_language_model_result_df.csv', index=False)

        # Open the file in write mode
        with open('large_language_model_score.txt', 'w') as file:
            file.write(f"{all_result_df['result_decision'].sum()}/{len(self.target_data)} were determined to be statements made by the person.\n")
