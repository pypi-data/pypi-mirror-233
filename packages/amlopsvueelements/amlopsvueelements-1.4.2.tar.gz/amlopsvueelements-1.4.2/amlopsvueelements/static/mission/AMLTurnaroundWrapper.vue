                  ...
                  <div class="flex items-center justify-between w-full">
                    ...
                    <div
                      ...
                      :class="[
                        ...
                        $style['free-input'],
                        ...(errors?.servicing?.[0]?.$response?.extraParams?.services?.[index]
                          ?.error && isValidationDirty
                    ...
                    >
                      ...
                      <template #popper>
                        <div class="mt-2 px-4">
                          <UInputWrapper v-model="service.note" label-text="Comments:" />
                        </div>
                      </template>
                    </VMenu>
                    <div class="flex justify-between gap-x-[0.5rem] items-center pr-1">
                      <UCheckboxWrapper
                        ...
                        :disabled="
                          isDisabledField ||
                          !findServiceById(service.service, serviceOptions).arrival
                        "
                        class="!mb-0 d-flex"
                        size="24px"
                      />
                      <UCheckboxWrapper
                        ...
                        :disabled="
                          isDisabledField ||
                          !findServiceById(service.service, serviceOptions).departure
                        "
                        class="gap-0 !mb-0"
                        size="24px"
                      />
...
import UTooltipWrapper from '@/components/ui/wrappers/UTooltipWrapper.vue'
