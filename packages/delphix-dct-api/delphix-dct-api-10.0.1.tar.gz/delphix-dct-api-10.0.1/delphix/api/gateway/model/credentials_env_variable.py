...
class CredentialsEnvVariable(ModelNormal):
    ...
    attribute_map = {
        'base_var_name': 'base_var_name',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, base_var_name, *args, **kwargs):  # noqa: E501
        """CredentialsEnvVariable - a model defined in OpenAPI

        Args:
            base_var_name (str): Base name of the environment variables. Variables are named by appending '_USER', '_PASSWORD', '_PUBKEY' and '_PRIVKEY' to this base name, respectively. Variables whose values are not entered or are not present in the type of credential or vault selected, will not be set.
        ...
        Keyword Args:
            ...
            password (str): Password to assign to the environment variables.. [optional]  # noqa: E501
            vault (str): The name or reference of the vault to assign to the environment variables.. [optional]  # noqa: E501
            ...
            hashicorp_vault_username_key (str): Hashicorp vault key for the username in the key-value store.. [optional]  # noqa: E501
            hashicorp_vault_secret_key (str): Hashicorp vault key for the password in the key-value store.. [optional]  # noqa: E501
            azure_vault_name (str): Azure key vault name.. [optional]  # noqa: E501
            azure_vault_username_key (str): Azure vault key in the key-value store.. [optional]  # noqa: E501
            azure_vault_secret_key (str): Azure vault key in the key-value store.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, base_var_name, *args, **kwargs):  # noqa: E501
        """CredentialsEnvVariable - a model defined in OpenAPI
