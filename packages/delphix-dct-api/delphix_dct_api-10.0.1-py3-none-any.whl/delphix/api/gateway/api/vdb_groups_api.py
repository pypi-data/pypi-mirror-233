    ...
    def __init__(self, api_client=None):
        ...
        def __create_vdb_groups_tags(
            ...
            **kwargs
            ...
            >>> thread = api.create_vdb_groups_tags(vdb_group_id, tags_request, async_req=True)
            >>> result = thread.get()

            Args:
                vdb_group_id (str): The ID or name of the VDBGroup.
                tags_request (TagsRequest): Tags information for VDB Group.
        ...
        self.create_vdb_groups_tags = _Endpoint(
            settings={
                'response_type': (TagsResponse,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/vdb-groups/{vdbGroupId}/tags',
                'operation_id': 'create_vdb_groups_tags',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__create_vdb_groups_tags
        )
        ...
        def __delete_vdb_group_tags(
            ...
            **kwargs
            ...
            >>> thread = api.delete_vdb_group_tags(vdb_group_id, async_req=True)
            >>> result = thread.get()
        ...
        self.delete_vdb_group_tags = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/vdb-groups/{vdbGroupId}/tags/delete',
                'operation_id': 'delete_vdb_group_tags',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__delete_vdb_group_tags
        )
        ...
        def __get_vdb_group_tags(
            ...
            **kwargs
            ...
            >>> thread = api.get_vdb_group_tags(vdb_group_id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_vdb_group_tags = _Endpoint(
            settings={
                'response_type': (TagsResponse,),
                'auth': [
                    'ApiKeyAuth'
                ...
                'endpoint_path': '/vdb-groups/{vdbGroupId}/tags',
                'operation_id': 'get_vdb_group_tags',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        def __lock_vdb_group(
            self,
            vdb_group_id,
            lock_vdb_group_parameters,
            **kwargs
        ):
            ...
            >>> thread = api.lock_vdb_group(vdb_group_id, lock_vdb_group_parameters, async_req=True)
            >>> result = thread.get()

            Args:
                vdb_group_id (str): The ID or name of the VDBGroup.
                lock_vdb_group_parameters (LockVDBGroupParameters):
            ...
            kwargs['vdb_group_id'] = \
                vdb_group_id
            kwargs['lock_vdb_group_parameters'] = \
                lock_vdb_group_parameters
            return self.call_with_http_info(**kwargs)

        self.lock_vdb_group = _Endpoint(
            settings={
                'response_type': (VDBGroup,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/vdb-groups/{vdbGroupId}/lock',
                'operation_id': 'lock_vdb_group',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'vdb_group_id': 'path',
                    'lock_vdb_group_parameters': 'body',
                },
                'collection_format_map': {
                }
            },
            ...
            api_client=api_client,
            callable=__lock_vdb_group
        )

        def __provision_vdb_group_from_bookmark(
            self,
            **kwargs
        ):
            ...
            >>> thread = api.provision_vdb_group_from_bookmark(async_req=True)
            >>> result = thread.get()


            Keyword Args:
                provision_vdb_group_from_bookmark_parameters (ProvisionVDBGroupFromBookmarkParameters): The parameters to provision a VDB group from a Bookmark.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        self.provision_vdb_group_from_bookmark = _Endpoint(
            settings={
                'response_type': (ProvisionVDBGroupFromBookmarkResponse,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/vdb-groups/provision_from_bookmark',
                'operation_id': 'provision_vdb_group_from_bookmark',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'provision_vdb_group_from_bookmark_parameters',
                ],
                'required': [],
                'nullable': [
                ],
            ...
            root_map={
                ...
                'location_map': {
                    'provision_vdb_group_from_bookmark_parameters': 'body',
                },
                'collection_format_map': {
                }
            },
            ...
            api_client=api_client,
            callable=__provision_vdb_group_from_bookmark
        )
        ...
        def __refresh_vdb_group(
            ...
            **kwargs
            ...
            Keyword Args:
                refresh_vdb_group_parameters (RefreshVDBGroupParameters): The parameters to refresh a VDBGroup.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        def __rollback_vdb_group(
            ...
            **kwargs
            ...
            Keyword Args:
                rollback_vdb_group_parameters (RollbackVDBGroupParameters): The parameters to rollback a VDBGroup.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        def __search_bookmarks_by_vdb_group(
            self,
            vdb_group_id,
            **kwargs
        ):
            ...
            >>> thread = api.search_bookmarks_by_vdb_group(vdb_group_id, async_req=True)
            >>> result = thread.get()
        ...
        self.search_bookmarks_by_vdb_group = _Endpoint(
            settings={
                'response_type': (SearchBookmarksByVDBGroupsResponse,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/vdb-groups/{vdbGroupId}/bookmarks/search',
                'operation_id': 'search_bookmarks_by_vdb_group',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__search_bookmarks_by_vdb_group
        )

        def __search_vdb_groups(
            self,
            **kwargs
        ):
            ...
            >>> thread = api.search_vdb_groups(async_req=True)
            >>> result = thread.get()
        ...
        self.search_vdb_groups = _Endpoint(
            settings={
                'response_type': (SearchVDBGroupResponse,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/vdb-groups/search',
                'operation_id': 'search_vdb_groups',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__search_vdb_groups
        )

        def __unlock_vdb_group(
            self,
            vdb_group_id,
            **kwargs
        ):
            ...
            >>> thread = api.unlock_vdb_group(vdb_group_id, async_req=True)
            >>> result = thread.get()
        ...
        self.unlock_vdb_group = _Endpoint(
            settings={
                'response_type': (VDBGroup,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/vdb-groups/{vdbGroupId}/unlock',
                'operation_id': 'unlock_vdb_group',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__unlock_vdb_group
        )

        def __update_vdb_group_by_id(
            self,
            vdb_group_id,
            **kwargs
        ):
            ...
            >>> thread = api.update_vdb_group_by_id(vdb_group_id, async_req=True)
            >>> result = thread.get()
            ...
            Keyword Args:
                update_vdb_group_parameters (UpdateVDBGroupParameters): The new data to update a VDB group.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        self.update_vdb_group_by_id = _Endpoint(
            settings={
                'response_type': (VDBGroup,),
                'auth': [
                    'ApiKeyAuth'
                ...
                'endpoint_path': '/vdb-groups/{vdbGroupId}',
                'operation_id': 'update_vdb_group_by_id',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'vdb_group_id': 'path',
                    'update_vdb_group_parameters': 'body',
                },
                'collection_format_map': {
                }
            },
            ...
            api_client=api_client,
            callable=__update_vdb_group_by_id
        )
