...
class DatabaseConnectivityCheckParameters(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'credentials_type': (str,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, credentials_type, source_id, *args, **kwargs):  # noqa: E501
        """DatabaseConnectivityCheckParameters - a model defined in OpenAPI

        Args:
            credentials_type (str): The type of credentials.
        ...
        Keyword Args:
            ...
            username (str): Database username (Not applicable for MSSQL_ENVIRONMENT_USER).. [optional]  # noqa: E501
            password (str): Database password (Not applicable for MSSQL_ENVIRONMENT_USER and mutually exclusive with vault attributes).. [optional]  # noqa: E501
            vault (str): The name or reference of the vault from which to read the database credentials (ORACLE, ASE and MSSQL_DOMAIN_USER only).. [optional]  # noqa: E501
            hashicorp_vault_engine (str): Vault engine name where the credential is stored (ORACLE, ASE and MSSQL_DOMAIN_USER only).. [optional]  # noqa: E501
            hashicorp_vault_secret_path (str): Path in the vault engine where the credential is stored (ORACLE, ASE and MSSQL_DOMAIN_USER only).. [optional]  # noqa: E501
            hashicorp_vault_username_key (str): Hashicorp vault key for the username in the key-value store (ORACLE, ASE and MSSQL_DOMAIN_USER only).. [optional]  # noqa: E501
            hashicorp_vault_secret_key (str): Hashicorp vault key for the password in the key-value store (ORACLE, ASE and MSSQL_DOMAIN_USER only).. [optional]  # noqa: E501
            ...
            cyberark_vault_query_string (str): Query to find a credential in the CyberArk vault (ORACLE, ASE and MSSQL_DOMAIN_USER only).. [optional]  # noqa: E501
            environment_id (str): Id of the environment to which environment user belongs (MSSQL_ENVIRONMENT_USER only).. [optional]  # noqa: E501
            environment_user (str): Reference to the environment user (MSSQL_ENVIRONMENT_USER only).. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, credentials_type, source_id, *args, **kwargs):  # noqa: E501
        """DatabaseConnectivityCheckParameters - a model defined in OpenAPI
