...
class LoginToken(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, access_token, token_type, expires_in, *args, **kwargs):  # noqa: E501
        """LoginToken - a model defined in OpenAPI
