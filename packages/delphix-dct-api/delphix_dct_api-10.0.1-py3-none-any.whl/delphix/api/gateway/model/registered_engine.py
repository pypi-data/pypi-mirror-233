...
class RegisteredEngine(ModelNormal):
    ...
    def _from_openapi_data(cls, name, hostname, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            insecure_ssl (bool): Allow connections to the engine over HTTPs without validating the TLS certificate. Even though the connection to the engine might be performed over HTTPs, setting this property eliminates the protection against a man-in-the-middle attach for connections to this engine. Instead, consider creating a truststore with a Certificate Authority to validate the engine's certificate, and set the truststore_filename property. . [optional] if omitted the server will use the default value of False  # noqa: E501
