...
class AppDataDSourceLinkSourceParametersAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AppDataDSourceLinkSourceParametersAllOf - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            environment_user (str): The OS user to use for linking.. [optional]  # noqa: E501
            ...
            parameters ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The JSON payload conforming to the DraftV4 schema based on the type of application data being manipulated.. [optional]  # noqa: E501
            sync_parameters ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The JSON payload conforming to the snapshot parameters definition in a LUA toolkit or platform plugin.. [optional]  # noqa: E501
        """
