...
class ScopeTagsRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, tags, *args, **kwargs):  # noqa: E501
        """ScopeTagsRequest - a model defined in OpenAPI

        Args:
            tags ([ScopeTag]): Array of tags with key value pairs along with optional object_type and permissions
