...
class LockVDBGroupParameters(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LockVDBGroupParameters - a model defined in OpenAPI
