...
version = axisvm.__version__
# The full version, including alpha/beta/rc tags.
release = axisvm.__version__ + "-git"
...
latex_documents = [
    ("index", "pyaxisvm.tex", "PyAxisVM Documentation", "Inter-CAD Kft.", "manual"),
]
...
man_pages = [("index", "pyaxisvm", "PyAxisVM Documentation", ["Inter-CAD Kft."], 1)]
...
sphinx_gallery_conf = {
    ...
    "junit": os.path.join("pyaxisvm", "junit-results.xml"),
