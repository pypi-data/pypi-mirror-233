# Generated by Django 4.2.1 on 2023-10-04 01:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('endpoint', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='models.endpoint')),
            ],
            options={
                'verbose_name': 'Param',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.CharField(max_length=400)),
                ('description', models.TextField()),
                ('endpoint', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='headers', to='models.endpoint')),
            ],
            options={
                'verbose_name': 'Header',
