...
def read_data_prep(zip_dir="", image_dir="image_dir", ext_image_file="BGRN_SR_clip.tif", udm_mask_dir="udm_mask_dir", ext_udm_mask_file="udm2_clip.tif" ):
    """
    ...
    for n in range (0, len(zip_list)):
        with ZipFile(join(zipdir,zip_list[n]), 'r') as zipObject:
            ...
            for fileName in listOfFileNames:
                ...
                elif fileName.endswith(ext_udm_mask_file):
                    # Extract a single file from zip
