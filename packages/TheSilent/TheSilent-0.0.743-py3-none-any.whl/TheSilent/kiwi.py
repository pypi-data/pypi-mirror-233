...
def kiwi(host,delay=0):
    ...
    subdomains = ["adfs","analytics","autodiscover","barracuda","ckm","ckm01","ckr01","covid","covidash","destiny","eduphoria","exchange","expe","filter","forms","ftp","gp","hr","mail","mileage","ns1","ns2","old","portal","register","skyward","timeclock","transfinder","vpn","webmail","www"]
