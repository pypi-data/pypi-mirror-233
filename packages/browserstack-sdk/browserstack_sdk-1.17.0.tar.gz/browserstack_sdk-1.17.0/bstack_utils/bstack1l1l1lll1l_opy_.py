...
import threading
bstack1l1l1ll1l1_opy_ = 10
bstack1l1l1ll1ll_opy_ = 5
bstack1l1l1l11l1_opy_ = 30
bstack1l1l1ll111_opy_ = 2
class bstack1l1l1l1l11_opy_:
    def __init__(self, handler, bstack1l1l1l11ll_opy_=bstack1l1l1ll1l1_opy_, bstack1l1l1lll11_opy_=bstack1l1l1ll1ll_opy_):
        self.queue = []
    ...
    def bstack1l1l1l1l1l_opy_(self):
        self.timer = threading.Timer(self.bstack1l1l1lll11_opy_, self.bstack1l1l1l1ll1_opy_)
        self.timer.start()
    ...
    def add(self, event):
        with self.lock:
            ...
            if len(self.queue) >= self.bstack1l1l1l11ll_opy_:
                t = threading.Thread(target=self.bstack1l1l1l1ll1_opy_)
                t.start()
                self.bstack1l1l1ll11l_opy_()
    def bstack1l1l1l1ll1_opy_(self):
        if len(self.queue) <= 0:
            return
        data = self.queue[:self.bstack1l1l1l11ll_opy_]
        del self.queue[:self.bstack1l1l1l11ll_opy_]
        self.handler(data)
    def shutdown(self):
        self.bstack1l1l1l1lll_opy_()
        while len(self.queue) > 0:
            self.bstack1l1l1l1ll1_opy_()