...
from chalk.features import Feature, Features, FeatureSetBase, FeatureWrapper, unwrap_feature
...
def run_stubgen(args: argparse.Namespace, file_filter: Optional[str]):
    root = args.root
    if root is None:
