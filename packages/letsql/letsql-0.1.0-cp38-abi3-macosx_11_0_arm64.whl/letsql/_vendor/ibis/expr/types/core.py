...
from letsql._vendor.ibis.common.exceptions import IbisError, TranslationError
...
from letsql._vendor.ibis.config import _default_backend, options as opts
...
class Expr(Immutable, Coercible):
    ...
    def __repr__(self) -> str:
        ...
        from letsql._vendor.ibis.expr.types.pretty import simple_console
    ...
    def _repr(self) -> str:
        from letsql._vendor.ibis.expr.format import pretty
    ...
    def _repr_png_(self) -> bytes | None:
        if opts.interactive or not opts.graphviz_repr:
            return None
        try:
            import letsql._vendor.ibis.expr.visualize as viz
        except ImportError:
            return None
        else:
    ...
    def unbind(self) -> ir.Table:
        ...
        from letsql._vendor.ibis.expr.analysis import substitute_unbound
