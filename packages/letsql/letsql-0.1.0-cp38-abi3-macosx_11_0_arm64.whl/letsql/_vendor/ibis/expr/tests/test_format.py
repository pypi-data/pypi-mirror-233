...
import letsql._vendor.ibis.expr.format
import letsql._vendor.ibis.expr.datatypes as dt
import letsql._vendor.ibis.expr.operations as ops
import letsql._vendor.ibis.legacy.udf.vectorized as udf
from letsql._vendor.ibis import util
from letsql._vendor.ibis.expr.operations.relations import Projection
...
def test_tables_have_format_rules(cls):
    assert cls in letsql._vendor.ibis.expr.format.fmt.registry
