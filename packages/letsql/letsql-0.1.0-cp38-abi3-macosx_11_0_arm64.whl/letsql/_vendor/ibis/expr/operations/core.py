...
from letsql._vendor.ibis.common.graph import Node as Traversable
...
from letsql._vendor.ibis.common.typing import DefaultTypeVars, VarTuple
...
class Value(Node, Named, Coercible, DefaultTypeVars, Generic[T, S]):
    ...
    def __coerce__(
        ...
        from letsql._vendor.ibis.expr.operations import Literal
        from letsql._vendor.ibis.expr.types import Expr
