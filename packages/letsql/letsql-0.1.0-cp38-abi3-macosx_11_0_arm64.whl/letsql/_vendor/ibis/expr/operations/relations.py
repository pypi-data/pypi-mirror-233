...
import letsql._vendor.ibis.expr.datashape as ds
...
from letsql._vendor.ibis.common.annotations import annotated, attribute
from letsql._vendor.ibis.common.collections import FrozenDict  # noqa: TCH001
from letsql._vendor.ibis.common.grounds import Immutable
from letsql._vendor.ibis.common.patterns import Coercible
from letsql._vendor.ibis.common.typing import VarTuple  # noqa: TCH001
from letsql._vendor.ibis.expr.deferred import Deferred
from letsql._vendor.ibis.expr.operations.core import Column, Named, Node, Scalar, Value
from letsql._vendor.ibis.expr.operations.sortkeys import SortKey  # noqa: TCH001
...
class PandasDataFrameProxy(TableProxy):
    ...
    def to_pyarrow(self, schema: Schema) -> pa.Table:
        ...
        from letsql._vendor.ibis.formats.pyarrow import PyArrowSchema
...
def _clean_join_predicates(left, right, predicates):
    ...
    import letsql._vendor.ibis.expr.types as ir
    from letsql._vendor.ibis.expr.analysis import shares_all_roots
...
class Selection(Projection):
    ...
    def __init__(self, table, selections, predicates, sort_keys, **kwargs):
        from letsql._vendor.ibis.expr.analysis import (
            shares_all_roots,
            shares_some_roots,
        )
...
def _dedup_join_columns(expr, lname: str, rname: str):
    from letsql._vendor.ibis.expr.operations.generic import TableColumn
    from letsql._vendor.ibis.expr.operations.logical import Equals
