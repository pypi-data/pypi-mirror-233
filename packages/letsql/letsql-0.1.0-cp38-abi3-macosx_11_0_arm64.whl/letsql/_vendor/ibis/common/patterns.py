...
from letsql._vendor.ibis.common.bases import FrozenSlotted as Slotted
from letsql._vendor.ibis.common.bases import Singleton
from letsql._vendor.ibis.common.collections import (
    FrozenDict,
    RewindableIterator,
    frozendict,
)
from letsql._vendor.ibis.common.dispatch import lazy_singledispatch
from letsql._vendor.ibis.common.typing import (
    ModuleType,
    Sentinel,
    UnionType,
    _ClassInfo,
...
from letsql._vendor.ibis.util import is_iterable, promote_tuple
...
class CallableWith(Slotted, Pattern):
    ...
    def match(self, value, context):
        from letsql._vendor.ibis.common.annotations import EMPTY, annotated
