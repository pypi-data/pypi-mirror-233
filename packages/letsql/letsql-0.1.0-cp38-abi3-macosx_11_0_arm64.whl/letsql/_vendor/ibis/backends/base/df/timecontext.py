...
from letsql._vendor.ibis import config

TimeContext = tuple[pd.Timestamp, pd.Timestamp]


if TYPE_CHECKING:
    from letsql._vendor.ibis.backends.base.df.scope import Scope
...
def adjust_context_asof_join(
    ...
    if op.tolerance is not None:
        from letsql._vendor.ibis.backends.pandas.execution import execute
