...
from letsql._vendor.ibis.common.exceptions import OperationNotDefinedError
...
@pytest.mark.parametrize(
    ...
    [
        ...
        param(
            ...
            id="negative-index",
            marks=[
                pytest.mark.broken(raises=AssertionError),
            ],
        ),
        param(
...
def test_string(alltypes, df, result_func, expected_func):
    ...
    expected = default_series_rename(expected_func(df))
