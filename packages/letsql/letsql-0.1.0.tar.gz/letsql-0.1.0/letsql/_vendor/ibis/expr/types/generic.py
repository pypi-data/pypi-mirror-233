...
from letsql._vendor.ibis.common.grounds import Singleton
from letsql._vendor.ibis.expr.types.core import Expr, _binop, _FixedTextJupyterMixin
...
class Value(Expr):
    ...
    def isin(self, values: Value | Sequence[Value]) -> ir.BooleanValue:
        ...
        """
        from letsql._vendor.ibis.expr.types import ArrayValue
    ...
    def over(
        ...
        *,
        ...
        import letsql._vendor.ibis.expr.builders as bl
        import letsql._vendor.ibis.expr.deferred as de
    ...
    def as_table(self) -> ir.Table:
        ...
        True
        """
        from letsql._vendor.ibis.expr.analysis import find_immediate_parent_tables
...
class Scalar(Value):
    ...
    def as_table(self) -> ir.Table:
        ...
        True
        """
        from letsql._vendor.ibis.expr.analysis import find_first_base_table
