...
from letsql._vendor.ibis.common.exceptions import InputTypeError, IntegrityError
from letsql._vendor.ibis.common.grounds import Concrete
from letsql._vendor.ibis.common.patterns import Coercible
from letsql._vendor.ibis.util import deprecated, indent
...
class Schema(Concrete, Coercible, MapSet):
    ...
    def from_numpy(cls, numpy_schema):
        ...
        from letsql._vendor.ibis.formats.numpy import NumpySchema
    ...
    def from_pandas(cls, pandas_schema):
        """Return the equivalent ibis schema."""
        from letsql._vendor.ibis.formats.pandas import PandasSchema
