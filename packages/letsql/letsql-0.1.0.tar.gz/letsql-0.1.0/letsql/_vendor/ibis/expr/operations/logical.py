...
from letsql._vendor.ibis.common.exceptions import IbisTypeError
from letsql._vendor.ibis.common.typing import VarTuple  # noqa: TCH001
from letsql._vendor.ibis.expr.operations.core import Binary, Column, Unary, Value
from letsql._vendor.ibis.expr.operations.generic import _Negatable
...
class UnresolvedExistsSubquery(_UnresolvedSubquery):
    ...
    def _resolve(self, table) -> ExistsSubquery:
        from letsql._vendor.ibis.expr.operations.relations import TableNode
