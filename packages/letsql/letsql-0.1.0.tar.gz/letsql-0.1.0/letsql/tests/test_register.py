...
@pytest.mark.parametrize(
    ...
    [
        ...
        param(
            ...
            "fancy_stones2",
            id="multi_csv",
            marks=pytest.mark.notimpl(raises=ValueError),
        ),
    ],
)
...
@pytest.mark.notimpl(raises=ValueError)
...
@pytest.mark.notimpl(raises=TypeError)
...
@pytest.mark.notimpl(raises=AttributeError)
