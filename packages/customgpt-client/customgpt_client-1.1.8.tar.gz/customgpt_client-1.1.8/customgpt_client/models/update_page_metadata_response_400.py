...
from ..models.update_page_metadata_response_400_status import UpdatePageMetadataResponse400Status
...
class UpdatePageMetadataResponse400:
    ...
    status: Union[Unset, UpdatePageMetadataResponse400Status] = UNSET
