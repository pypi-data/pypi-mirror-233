...
from ..models.update_conversation_response_401_status import UpdateConversationResponse401Status
...
class UpdateConversationResponse401:
    ...
    status: Union[Unset, UpdateConversationResponse401Status] = UNSET
