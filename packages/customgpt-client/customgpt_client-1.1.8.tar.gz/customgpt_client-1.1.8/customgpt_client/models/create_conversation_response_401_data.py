...
from ..models.create_conversation_response_401_data_code import CreateConversationResponse401DataCode
...
class CreateConversationResponse401Data:
    ...
    code: Union[Unset, CreateConversationResponse401DataCode] = UNSET
