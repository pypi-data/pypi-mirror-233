...
from ..models.delete_conversation_response_401_status import DeleteConversationResponse401Status
...
class DeleteConversationResponse401:
    ...
    status: Union[Unset, DeleteConversationResponse401Status] = UNSET
