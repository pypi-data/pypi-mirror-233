...
from ..models.update_conversation_response_200_status import UpdateConversationResponse200Status
...
class UpdateConversationResponse200:
    ...
    status: Union[Unset, UpdateConversationResponse200Status] = UNSET
