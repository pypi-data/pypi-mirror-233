...
from ..models.create_conversation_response_404_status import CreateConversationResponse404Status
...
class CreateConversationResponse404:
    ...
    status: Union[Unset, CreateConversationResponse404Status] = UNSET
