...
from ..models.update_page_metadata_response_404_status import UpdatePageMetadataResponse404Status
...
class UpdatePageMetadataResponse404:
    ...
    status: Union[Unset, UpdatePageMetadataResponse404Status] = UNSET
