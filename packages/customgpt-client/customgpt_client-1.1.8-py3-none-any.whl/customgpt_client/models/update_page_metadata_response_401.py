...
from ..models.update_page_metadata_response_401_status import UpdatePageMetadataResponse401Status
...
class UpdatePageMetadataResponse401:
    ...
    status: Union[Unset, UpdatePageMetadataResponse401Status] = UNSET
