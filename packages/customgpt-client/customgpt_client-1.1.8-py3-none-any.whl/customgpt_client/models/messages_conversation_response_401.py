...
from ..models.messages_conversation_response_401_status import MessagesConversationResponse401Status
...
class MessagesConversationResponse401:
    ...
    status: Union[Unset, MessagesConversationResponse401Status] = UNSET
