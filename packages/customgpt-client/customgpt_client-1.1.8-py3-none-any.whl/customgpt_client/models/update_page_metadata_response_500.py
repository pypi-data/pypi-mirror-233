...
from ..models.update_page_metadata_response_500_status import UpdatePageMetadataResponse500Status
...
class UpdatePageMetadataResponse500:
    ...
    status: Union[Unset, UpdatePageMetadataResponse500Status] = UNSET
