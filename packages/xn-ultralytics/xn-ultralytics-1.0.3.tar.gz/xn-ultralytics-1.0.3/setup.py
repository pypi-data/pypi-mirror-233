...
setup(
    name="xn-ultralytics",  # name of pypi package
    version=get_version(),  # version of pypi package
    python_requires=">=3.7",
    license="AGPL-3.0",
    description=(
        "This is a public fork of Ultralytics YOLOv8 for SOTA object detection, multi-object tracking, instance segmentation, "
        "pose estimation and image classification. Free for anyone to use, for non-commercial purposes."
    ),
