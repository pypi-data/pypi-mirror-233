...
class ArchAVR_ExtIntConfig(yasimavr.lib._sip.wrapper):
    ...
    extint_pins = ... # type: yasimavr.lib._sip.Buffer
    extint_vector = ... # type: yasimavr.lib._sip.Buffer
    pcint_pins = ... # type: yasimavr.lib._sip.Buffer
    pcint_vector = ... # type: yasimavr.lib._sip.Buffer
    ...
    reg_pcint_mask = ... # type: yasimavr.lib._sip.Buffer
...
class ArchAVR_ExtInt(core.Peripheral, core.InterruptHandler, core.SignalHook):
...
class ArchAVR_MiscRegCtrl(core.Peripheral):
    ...
    def init(self, device: core.Device) -> bool: ...
...
class ArchAVR_SPI(core.Peripheral, core.SignalHook):
...
class ArchAVR_TWI(core.Peripheral, core.SignalHook):
...
class ArchAVR_USART(core.Peripheral, core.SignalHook):
...
class ArchAVR_WDT(core.WatchdogTimer, core.InterruptHandler):
