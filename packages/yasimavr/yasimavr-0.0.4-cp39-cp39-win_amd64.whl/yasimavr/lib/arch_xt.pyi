...
class ArchXT_NVM(core.Peripheral):
...
class ArchXT_Port(core.Port):
    ...
    def pin_state_changed(self, a0: int, a1: core.Pin.State) -> None: ...
    def ioreg_write_handler(self, a0: core.reg_addr_t, a1: core.ioreg_write_t) -> None: ...
    def ioreg_read_handler(self, a0: core.reg_addr_t, a1: int) -> int: ...
    def reset(self) -> None: ...
    def init(self, a0: core.Device) -> bool: ...
...
class ArchXT_SPI(core.Peripheral, core.SignalHook):
...
class ArchXT_TWI(core.Peripheral, core.SignalHook):
...
class ArchXT_USART(core.Peripheral, core.SignalHook):
...
TCA_CMP_CHANNEL_COUNT = ... # type: int
