...
class Firmware(yasimavr.lib._sip.wrapper):
    ...
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, other: 'Firmware') -> None: ...

    def bsssize(self) -> int: ...
    def datasize(self) -> int: ...
    def load_memory(self, a0: str, a1: 'NonVolatileMemory') -> bool: ...
    def blocks(self, a0: str) -> typing.List['Firmware.Block']: ...
    def memory_size(self, a0: str) -> int: ...
    def has_memory(self, a0: str) -> bool: ...
    def add_block(self, a0: str, a1: typing.Any, a2: int = ...) -> None: ...
    @staticmethod
...
class NonVolatileMemory(yasimavr.lib._sip.wrapper):
    ...
    @typing.overload
    def __init__(self, a0: int, a1: str = ...) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def dbg_write(self, a0: int, a1: int) -> None: ...
    @typing.overload
    def dbg_write(self, a0: yasimavr.lib._sip.Buffer, a1: int) -> None: ...
    @typing.overload
    def dbg_read(self, a0: int) -> int: ...
    @typing.overload
    def dbg_read(self, a0: int, a1: int) -> yasimavr.lib._sip.Buffer: ...
    @typing.overload
    def erase(self) -> None: ...
    @typing.overload
    ...
    def program(self, a0: typing.Any, a1: int = ...) -> bool: ...
    @typing.overload
    def block(self) -> typing.Any: ...
    @typing.overload
    def block(self, a0: int, a1: int) -> typing.Any: ...
...
class Pin(SignalHook):
    ...
    class SignalId(enum.IntEnum):
        DigitalStateChange = ... # type: Pin.SignalId
        AnalogValueChange = ... # type: Pin.SignalId
    ...
    def digital_state(self) -> 'Pin.State': ...
    def state(self) -> 'Pin.State': ...
    def id(self) -> int: ...
    def set_external_analog_value(self, a0: float) -> None: ...
    def set_external_state(self, a0: 'Pin.State') -> None: ...
    @staticmethod
...
class Port(Peripheral, SignalHook):
    ...
    def pin_state_changed(self, a0: int, a1: Pin.State) -> None: ...
    def set_pin_internal_state(self, a0: int, a1: Pin.State) -> None: ...
    def pin_mask(self) -> int: ...
    def raised(self, a0: signal_data_t, a1: int) -> None: ...
    def ctlreq(self, a0: int, a1: typing.Optional[ctlreq_data_t]) -> bool: ...
    def reset(self) -> None: ...
    def init(self, a0: Device) -> bool: ...
...
class TimerCounter(yasimavr.lib._sip.wrapper):
    ...
    def __init__(self, a0: PrescaledTimer, a1: int, a2: int) -> None: ...

    def set_logger(self, logger: typing.Optional[Logger]) -> None: ...
