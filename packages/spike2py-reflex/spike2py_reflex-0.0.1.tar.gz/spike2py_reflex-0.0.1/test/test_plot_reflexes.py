...
@pytest.mark.plot
def test_plot_ramp_singles(info_data_ramp):
...
@pytest.mark.plot
def test_plot_ramp_singles_two_muscles(info_data_ramp):
    info, data = info_data_ramp
    section = s2pr.reflexes.extract(info, data)
    section = s2pr.outcomes.calculate(section)
...
@pytest.mark.plot
def test_plot_mmax_singles(info_data_mmax):
...
@pytest.mark.plot
def test_plot_mmax_singles_two_muscles(info_data_mmax):
    info, data = info_data_mmax
    section = s2pr.reflexes.extract(info, data)
    section = s2pr.outcomes.calculate(section)
    section.reflexes['Adm'] = section.reflexes['Fdi']
...
@pytest.mark.plot
def test_plot_mmax_singles_two_muscles_three_intensities(info_data_mmax):
    info, data = info_data_mmax
    section = s2pr.reflexes.extract(info, data)
    section = s2pr.outcomes.calculate(section)
...
@pytest.mark.plot
def test_plot_hreflex_doubles(info_data_hreflex):
...
@pytest.mark.plot
def test_plot_hreflex_doubles_two_muscles(info_data_hreflex):
    info, data = info_data_hreflex
    section = s2pr.reflexes.extract(info, data)
    section = s2pr.outcomes.calculate(section)
    section.reflexes['Adm'] = section.reflexes['Fdi']
...
@pytest.mark.plot
def test_plot_hreflex_doubles_two_muscles_three_intensities(info_data_hreflex):
    info, data = info_data_hreflex
    section = s2pr.reflexes.extract(info, data)
    section = s2pr.outcomes.calculate(section)
    section.reflexes['Fdi'].avg_waveform[32] = section.reflexes['Fdi'].avg_waveform[19]
    section.reflexes['Fdi'].avg_waveform[35] = section.reflexes['Fdi'].avg_waveform[19]
    section.reflexes['Fdi'].reflexes[3].stim_intensity = 32
    section.reflexes['Fdi'].reflexes[2].stim_intensity = 32
    section.reflexes['Fdi'].reflexes[4].stim_intensity = 35
    section.reflexes['Fdi'].reflexes[5].stim_intensity = 35
    section.reflexes['Fdi'].avg_reflex1[32] = section.reflexes['Fdi'].avg_reflex1[19]
    section.reflexes['Fdi'].avg_reflex1[35] = section.reflexes['Fdi'].avg_reflex1[19]
    section.reflexes['Fdi'].avg_reflex2[32] = section.reflexes['Fdi'].avg_reflex2[19]
