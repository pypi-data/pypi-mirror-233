...
def test_grouped_windows_compute_idx(demo_study_reflex):
    ...
    assert win.idx.reflexes['Fdi']['mmax'] == {'double': [[512, 526], [611, 625]],
                                               'single': [512, 526],
                                               'train': [46, 60]}
...
def test_windows_add_subject_short(demo_study_reflex, demo_subject_windows_short):
    ...
    assert win._study.ms.reflexes['Fdi']['mmax'] == [8, 15]
    assert win._subject.ms.reflexes['Fdi']['mmax'] == [12, 22]
...
def test_windows_add_subject_section(demo_study_reflex, demo_subject_windows_short, demo_section_windows_short):
    ...
    assert win._study.ms.reflexes['Fdi']['mmax'] == [8, 15]
    assert win._subject.ms.reflexes['Fdi']['mmax'] == [12, 22]
    assert win._section.ms.reflexes['Fdi']['mmax'] == [3, 28]
...
def test_windows_add_subject_section_get_idx(demo_study_reflex, demo_subject_windows_short, demo_section_windows_short):
    ...
    assert win._study.idx.reflexes['Fdi']['mmax'] == {'double': [[512, 526], [611, 625]],
                                                      'single': [512, 526],
                                                      'train': [46, 60]}
    assert win._subject.idx.reflexes['Fdi']['mmax'] == {'double': [[520, 540], [619, 639]],
                                                        'single': [520, 540],
                                                        'train': [54, 74]}
    assert win._section.idx.reflexes['Fdi']['mmax'] == {'double': [[502, 552], [601, 651]],
                                                        'single': [502, 552],
                                                        'train': [36, 86]}
...
def test_windows_get_attributes(demo_study_reflex, demo_subject_windows_short, demo_section_windows_short):
    ...
    assert win.idx_reflexes['Fdi']['mmax'] == {'double': [[502, 552], [601, 651]],
                                               'single': [502, 552],
                                               'train': [36, 86]}
