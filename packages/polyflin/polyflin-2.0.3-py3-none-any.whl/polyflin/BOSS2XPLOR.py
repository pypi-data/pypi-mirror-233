...
def Boss2CharmmRTF(num2typ2symb, Qs, resid, bnd_df, angs,props,imps):
    ...
    rtf.write('Remarks generated XPLOR-TOP file for Bonvin group (by Abd. Kakhar Umar <abdulkaharumar@gmail.com>)\n')
    rtf.write('\nset echo=false end\n')
...
def Boss2CharmmPRM(resid, num2typ2symb, Qs, bnd_df, ang_df, tor_df):
    ...
    prm.write('Remarks generated XPLOR-TOP file for Bonvin group (by Abd. Kakhar Umar <abdulkaharumar@gmail.com>)\n')
    prm.write('\nset echo=false end \n')
