...
class DataHcpConsulAgentKubernetesSecret(
    ...
    def __init__(
        ...
        *,
        ...
        :param cluster_id: The ID of the HCP Consul cluster. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.72.1/docs/data-sources/consul_agent_kubernetes_secret#cluster_id DataHcpConsulAgentKubernetesSecret#cluster_id}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.72.1/docs/data-sources/consul_agent_kubernetes_secret#id DataHcpConsulAgentKubernetesSecret#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param project_id: The ID of the HCP project where the HCP Consul cluster is located. If not specified, the project specified in the HCP Provider config block will be used, if configured. If a project is not configured in the HCP Provider config block, the oldest project in the organization will be used. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.72.1/docs/data-sources/consul_agent_kubernetes_secret#project_id DataHcpConsulAgentKubernetesSecret#project_id}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.72.1/docs/data-sources/consul_agent_kubernetes_secret#timeouts DataHcpConsulAgentKubernetesSecret#timeouts}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1bd61ae1127a6bed7ff8bbafe32cd585a361d147ca91f4dfcf6734a05ec457d5)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id_", value=id_, expected_type=type_hints["id_"])
        config = DataHcpConsulAgentKubernetesSecretConfig(
    ...
    def put_timeouts(self, *, default: typing.Optional[builtins.str] = None) -> None:
        '''
        :param default: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.72.1/docs/data-sources/consul_agent_kubernetes_secret#default DataHcpConsulAgentKubernetesSecret#default}.
        '''
    ...
    def timeouts(self) -> "DataHcpConsulAgentKubernetesSecretTimeoutsOutputReference":
        return typing.cast("DataHcpConsulAgentKubernetesSecretTimeoutsOutputReference", jsii.get(self, "timeouts"))
    ...
    def cluster_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__68fab04213b82d36d7bbae93b375275ab68ad5a5a41386599ced5ebe998732ba)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5ce09c07e7b995d389c8a1c7a6e8f3d2dd680894245020d7fc628d4a66b36416)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def project_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1a4f26c50fa30845abb26288024a9b5657e36efb41b579b8e35b2fb2d3b7ead5)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "projectId", value)


@jsii.data_type(
    jsii_type="@cdktf/provider-hcp.dataHcpConsulAgentKubernetesSecret.DataHcpConsulAgentKubernetesSecretConfig",
...
class DataHcpConsulAgentKubernetesSecretConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def __repr__(self) -> str:
        return "DataHcpConsulAgentKubernetesSecretConfig(%s)" % ", ".join(
...
class DataHcpConsulAgentKubernetesSecretTimeouts:
    ...
    def __repr__(self) -> str:
        return "DataHcpConsulAgentKubernetesSecretTimeouts(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class DataHcpConsulAgentKubernetesSecretTimeoutsOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-hcp.dataHcpConsulAgentKubernetesSecret.DataHcpConsulAgentKubernetesSecretTimeoutsOutputReference",
):
    def __init__(
        self,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__35ad726dca58835193b8e5336e08e273e62cfa2e958ea57c36c0308c18b684ad)
    ...
    def default(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7f83eb8dac66c9e596ddfa44be6c7261f7bd3543e647eb5c9210c4aaa21f5450)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
def _typecheckingstub__1bd61ae1127a6bed7ff8bbafe32cd585a361d147ca91f4dfcf6734a05ec457d5(
    scope: _constructs_77d1e7e8.Construct,
    id_: builtins.str,
    *,
    cluster_id: builtins.str,
...
def _typecheckingstub__68fab04213b82d36d7bbae93b375275ab68ad5a5a41386599ced5ebe998732ba(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__5ce09c07e7b995d389c8a1c7a6e8f3d2dd680894245020d7fc628d4a66b36416(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__1a4f26c50fa30845abb26288024a9b5657e36efb41b579b8e35b2fb2d3b7ead5(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__3df70bd5a73802b3268610283263f56fafc818d7a8202339d48801ee49e63fa4(
    *,
...
def _typecheckingstub__35ad726dca58835193b8e5336e08e273e62cfa2e958ea57c36c0308c18b684ad(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
