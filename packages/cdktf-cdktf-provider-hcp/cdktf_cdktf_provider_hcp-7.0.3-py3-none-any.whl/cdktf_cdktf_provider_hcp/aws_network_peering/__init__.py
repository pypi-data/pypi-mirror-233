...
class AwsNetworkPeering(
    ...
    def __init__(
        ...
        *,
        ...
        :param hvn_id: The ID of the HashiCorp Virtual Network (HVN). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.72.1/docs/resources/aws_network_peering#hvn_id AwsNetworkPeering#hvn_id}
        :param peer_account_id: The account ID of the peer VPC in AWS. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.72.1/docs/resources/aws_network_peering#peer_account_id AwsNetworkPeering#peer_account_id}
        :param peering_id: The ID of the network peering. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.72.1/docs/resources/aws_network_peering#peering_id AwsNetworkPeering#peering_id}
        :param peer_vpc_id: The ID of the peer VPC in AWS. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.72.1/docs/resources/aws_network_peering#peer_vpc_id AwsNetworkPeering#peer_vpc_id}
        :param peer_vpc_region: The region of the peer VPC in AWS. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.72.1/docs/resources/aws_network_peering#peer_vpc_region AwsNetworkPeering#peer_vpc_region}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.72.1/docs/resources/aws_network_peering#id AwsNetworkPeering#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param project_id: The ID of the HCP project where the network peering is located. Always matches the HVN's project. If not specified, the project specified in the HCP Provider config block will be used, if configured. If a project is not configured in the HCP Provider config block, the oldest project in the organization will be used. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.72.1/docs/resources/aws_network_peering#project_id AwsNetworkPeering#project_id}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.72.1/docs/resources/aws_network_peering#timeouts AwsNetworkPeering#timeouts}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0fedad6c9ec944e4353d6236392934a3f4c1bd09df192bec7bcadd4cadef8cd0)
    ...
    def put_timeouts(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.72.1/docs/resources/aws_network_peering#create AwsNetworkPeering#create}.
        :param default: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.72.1/docs/resources/aws_network_peering#default AwsNetworkPeering#default}.
        :param delete: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.72.1/docs/resources/aws_network_peering#delete AwsNetworkPeering#delete}.
        '''
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["AwsNetworkPeeringTimeouts", _cdktf_9a9027ec.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["AwsNetworkPeeringTimeouts", _cdktf_9a9027ec.IResolvable]], jsii.get(self, "timeoutsInput"))
    ...
    def hvn_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__158fee31342bb2c08d28a13bf8836f96bdb39cdc33ac48901324bb6f7cccfc0d)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__683bab11fc77ea9838045a5e191bc253d5b0a6fc55ad3e695cfdbd6aae9320f8)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def peer_account_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f7be25f9c2dc8cbafa8c4f13cbb19c6852a9d797e420f0b4e62c34c1a4b7d1b5)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def peering_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ac8dc1b2faceb6a380f93c7fe3a3682262f43d370d771cc2cb94fe53a21764c1)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def peer_vpc_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__469e56de922c1284d319541c0932949e08afe940031c440235dc18a9acd77dbf)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def peer_vpc_region(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__482afb72e86b1ae5d5bb1614802ca329894da7fba4ea7bc4d9ec3d48f43d4f88)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def project_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__bc3c88777f28162fa16e79b040487704f7fe6500316cdf3a88edd71c95282b3f)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class AwsNetworkPeeringTimeoutsOutputReference(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4eed555b586dec1530ec142fc2acfa39b3a8a7b597ee902e8322aa840351a589)
    ...
    def create(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__60546a56a8bf7b9f5e11491e673747d73abe7055a27d06002b125568a235a872)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def default(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1b6e12cbf52fa390b96847fdc16967aded167404a933bd0aafe73642778c6551)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def delete(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__033a8900d106bb94d9e00a4946a6415988b817d88c66f80a25abd3084d03abc4)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[AwsNetworkPeeringTimeouts, _cdktf_9a9027ec.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[AwsNetworkPeeringTimeouts, _cdktf_9a9027ec.IResolvable]],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1f1b8505808e27b9cb316f7c523b92f348457d01e56e6e709111a8e9ea796c1d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
def _typecheckingstub__0fedad6c9ec944e4353d6236392934a3f4c1bd09df192bec7bcadd4cadef8cd0(
    scope: _constructs_77d1e7e8.Construct,
    id_: builtins.str,
    *,
    hvn_id: builtins.str,
...
def _typecheckingstub__158fee31342bb2c08d28a13bf8836f96bdb39cdc33ac48901324bb6f7cccfc0d(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__683bab11fc77ea9838045a5e191bc253d5b0a6fc55ad3e695cfdbd6aae9320f8(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__f7be25f9c2dc8cbafa8c4f13cbb19c6852a9d797e420f0b4e62c34c1a4b7d1b5(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__ac8dc1b2faceb6a380f93c7fe3a3682262f43d370d771cc2cb94fe53a21764c1(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__469e56de922c1284d319541c0932949e08afe940031c440235dc18a9acd77dbf(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__482afb72e86b1ae5d5bb1614802ca329894da7fba4ea7bc4d9ec3d48f43d4f88(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__bc3c88777f28162fa16e79b040487704f7fe6500316cdf3a88edd71c95282b3f(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__b0806ef2cb0a231646e95e4e369115a214ea50b4cb68f673ea8486daac15fe09(
    *,
    create: typing.Optional[builtins.str] = None,
    default: typing.Optional[builtins.str] = None,
    delete: typing.Optional[builtins.str] = None,
...
def _typecheckingstub__4eed555b586dec1530ec142fc2acfa39b3a8a7b597ee902e8322aa840351a589(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__60546a56a8bf7b9f5e11491e673747d73abe7055a27d06002b125568a235a872(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__1b6e12cbf52fa390b96847fdc16967aded167404a933bd0aafe73642778c6551(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__033a8900d106bb94d9e00a4946a6415988b817d88c66f80a25abd3084d03abc4(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__1f1b8505808e27b9cb316f7c523b92f348457d01e56e6e709111a8e9ea796c1d(
    value: typing.Optional[typing.Union[AwsNetworkPeeringTimeouts, _cdktf_9a9027ec.IResolvable]],
) -> None:
    """Type checking stubs"""
    pass
