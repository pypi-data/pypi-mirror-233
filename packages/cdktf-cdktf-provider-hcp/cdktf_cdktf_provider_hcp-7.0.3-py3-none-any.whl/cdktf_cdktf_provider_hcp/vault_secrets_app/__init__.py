...
class VaultSecretsApp(
    ...
    def __init__(
        ...
        *,
        ...
        :param app_name: The Vault Secrets App name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.72.1/docs/resources/vault_secrets_app#app_name VaultSecretsApp#app_name}
        :param description: The Vault Secrets app description. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.72.1/docs/resources/vault_secrets_app#description VaultSecretsApp#description}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
