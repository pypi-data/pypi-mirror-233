...
from cubicweb_web.views import actions, editforms, ibreadcrumbs
...
def linkto_clone_url_params(entity):
    ...
    linkto = f"{iclone.rtype}:{entity.eid}:{neg_role(iclone.role)}"
...
class CloneController(Controller):
    ...
    def publish(self, rset=None):
        ...
        rtype = iclone.rtype if iclone.role == "object" else "reverse_" + iclone.rtype
        kwargs = {rtype: eid}
