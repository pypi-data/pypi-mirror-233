...
class JsonList(list):
    ...
    def find_ordered(self, value, key=None, search_type=SearchType.Exact):
        return self[self.find_ordered_index(value, key=key, search_type=search_type)]

    def find_ordered_index(self, value, key=None, search_type=SearchType.Exact):
        i = bin_search(self, value, key=key, search_type=search_type)
        return i
