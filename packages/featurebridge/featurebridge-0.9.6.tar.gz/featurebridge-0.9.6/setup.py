...
setup(
    ...
    description="FeatureBridge: Revolutionizing ML adaptive modelling for handling missing features and data. The model can predict and fill data gaps in real-world scenarios.",
