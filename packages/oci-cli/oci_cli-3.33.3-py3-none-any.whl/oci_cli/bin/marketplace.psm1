...
function GetOciSubcommands_marketplace() {
    $ociSubcommands = @{
        'marketplace' = 'accepted-agreement account agreement category listing listing-summary package publication publication-package publication-summary publisher report-collection report-type-collection tax-summary'
