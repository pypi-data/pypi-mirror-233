...
setup(
    name='invoicing-pdf-ln',  # * Your package will have this name
    ...
    description='This package is designed for the conversion of Excel invoices into PDF invoices.',
    # Short description of your library
    author='Paul Lennard Polito',  # Your name
    author_email='lennardpolito@gmail.com',  # Your email
