...
from dydxprotocol.sending import tx_pb2 as dydxprotocol_dot_sending_dot_tx__pb2
...
class Msg(object):
    ...
    def CreateTransfer(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/dydxprotocol.sending.Msg/CreateTransfer',
    ...
    def DepositToSubaccount(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/dydxprotocol.sending.Msg/DepositToSubaccount',
    ...
    def WithdrawFromSubaccount(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/dydxprotocol.sending.Msg/WithdrawFromSubaccount',
