...
address = open(BASE_DIR + "dicts/address.txt", "r").read().splitlines()
date = open(BASE_DIR + "dicts/date.txt", "r").read().splitlines()
email = open(BASE_DIR + "dicts/email.txt", "r").read().splitlines()
user_id = open(BASE_DIR + "dicts/id.txt", "r").read().splitlines()
name = open(BASE_DIR + "dicts/name.txt", "r").read().splitlines()
