...
address = open("dicts/address.txt", "r").read().splitlines()
date = open("dicts/date.txt", "r").read().splitlines()
email = open("dicts/email.txt", "r").read().splitlines()
user_id = open("dicts/id.txt", "r").read().splitlines()
name = open("dicts/name.txt", "r").read().splitlines()
