...
class ImagePipeline(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        components: typing.Sequence[typing.Union[ComponentProps, typing.Dict[builtins.str, typing.Any]]],
...
class ImagePipelineProps:
    def __init__(
        ...
        *,
        ...
        :param vuln_scans_repo_tags: Store vulnerability scans through AWS Inpsector in ECR using these image tags (if option is enabled).
        '''
        if isinstance(ebs_volume_configuration, dict):
            ebs_volume_configuration = _aws_cdk_aws_imagebuilder_ceddda9d.CfnImageRecipe.EbsInstanceBlockDeviceSpecificationProperty(**ebs_volume_configuration)
        if __debug__:
    ...
    @builtins.property
    def components(self) -> typing.List[ComponentProps]:
        '''List of component props.'''
        result = self._values.get("components")
        assert result is not None, "Required property 'components' is missing"
        return typing.cast(typing.List[ComponentProps], result)
    ...
    @builtins.property
    def ebs_volume_name(self) -> typing.Optional[builtins.str]:
        '''Name of the AMI's EBS volume.'''
        result = self._values.get("ebs_volume_name")
        return typing.cast(typing.Optional[builtins.str], result)
