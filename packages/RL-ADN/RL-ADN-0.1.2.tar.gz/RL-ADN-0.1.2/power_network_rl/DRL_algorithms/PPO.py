...
from utility import Config, ReplayBuffer, SumTree, clip_grad_norm_, build_mlp, get_episode_return, get_optim_param
from Agent import AgentBase
import time

config_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../power_network_rl', 'environments', 'env_config.py'))
...
class AgentPPO(AgentBase):
    ...
    def update_net(self, buffer) -> [float]:
        with torch.no_grad():
            ...
            bs =4096 # set a smaller 'batch_size' when out of GPU memory.
