...
env_config={
  ...
  "network_info": "None",
  "time_series_data_path": "../power_network_rl/data_sources/time_series_data/34_node_time_series.csv"
}
    ...
    def __init__(self, env_config: dict = env_config) -> None:
        ...
        if self.network_info == 'None':
            ...
            self.network_info={'vm_pu':1.0,'s_base':1000,
                'bus_info_file': '../power_network_rl/data_sources/network_data/node_34/Nodes_34.csv',
                'branch_info_file': '../power_network_rl/data_sources/network_data/node_34/Lines_34.csv'}
            self.s_base=1000
            self.node_num=34
        else:
