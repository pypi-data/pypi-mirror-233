...
class DDS(Card):
    ...
    * SPCM_DDS_TRG_SRC_CARD  = 2
    ...
    def set_card_mode(self) -> None:
        ...
        super().set_card_mode(SPC_REP_STD_DDS)
    ...
    def dds_reset(self) -> None:
        ...
        self.set(SPC_DDS_CMD, SPCM_DDS_CMD_RESET)
    ...
    def connections(self, value : int) -> None:
        ...
        self.set(SPC_DDS_CONNECTIONS, value)
    ...
    def trg_timer(self, period : float) -> None:
        ...
        self.set(SPC_DDS_TRG_TIMER, float(period))
    ...
    def dds_x_mode(self, xio : int, mode : int) -> None:
        ...
        self.set(SPC_DDS_X0_MODE + xio * (SPC_DDS_X1_MODE - SPC_DDS_X0_MODE), mode)
    ...
    def freq_ramp_stepsize(self, divider : int) -> None:
        ...
        self.set(SPC_DDS_FREQ_RAMP_STEPSIZE, int(divider))

    def amp_ramp_stepsize(self, divider : int):
        """
        ...
        self.set(SPC_DDS_AMP_RAMP_STEPSIZE, int(divider))
    ...
    def amp(self, core_index : int, amplitude : float) -> None:
        ...
        self.set(SPC_DDS_CORE0_AMP + core_index * (SPC_DDS_CORE1_AMP - SPC_DDS_CORE0_AMP), float(amplitude))
    # aliases
    amplitude = amp
    ...
    def freq(self, core_index : int, frequency : float) -> None:
        ...
        self.set(SPC_DDS_CORE0_FREQ + core_index * (SPC_DDS_CORE1_FREQ - SPC_DDS_CORE0_FREQ), float(frequency))
    # aliases
    frequency = freq
    ...
    def phase(self, core_index : int, phase : float) -> None:
        ...
        self.set(SPC_DDS_CORE0_PHASE + core_index * (SPC_DDS_CORE1_PHASE - SPC_DDS_CORE0_PHASE), float(phase))
    ...
    def x_manual_output(self, state_mask : int) -> None:
        ...
        self.set(SPC_DDS_X_MANUAL_OUTPUT, state_mask)
    ...
    def freq_slope(self, core_index : int, slope : float) -> None:
        ...
        self.set(SPC_DDS_CORE0_FREQ_SLOPE + core_index * (SPC_DDS_CORE1_FREQ_SLOPE - SPC_DDS_CORE0_FREQ_SLOPE), float(slope))
    # aliases
    ...
    def amp_slope(self, core_index : int, slope : float) -> None:
        ...
        self.set(SPC_DDS_CORE0_AMP_SLOPE + core_index * (SPC_DDS_CORE1_AMP_SLOPE - SPC_DDS_CORE0_AMP_SLOPE), float(slope))
    # aliases
    ...
    def kwargs2mask(self, kwargs : list, prefix : str = ""):
        """
