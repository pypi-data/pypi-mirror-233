...
{'': ['*'],
 'tabella': ['static/*',
             'static/out/clients/typescript/*',
             'static/out/clients/typescript/tabella-integration-test-http-client/*',
             'static/out/clients/typescript/tabella-integration-test-http-client/src/*',
             'static/out/typescript/*',
             'static/out/typescript/tabella-demo-http-client/*',
             'static/out/typescript/tabella-demo-http-client/src/*',
             'templates/*',
             'templates/modals/*',
...
['Jinja2>=3.1.2,<4.0.0',
 ...
 'openrpc>=8.4.1,<9.0.0',
 'openrpcclientgenerator>=0.43.4,<0.44.0',
