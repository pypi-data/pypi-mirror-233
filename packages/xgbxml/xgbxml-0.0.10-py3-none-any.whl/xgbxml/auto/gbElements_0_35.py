...
class Building_auto():
	...
	def BuildingStory(self):
		return self.get_child('BuildingStory')


	@property
	def BuildingStorys(self):
		return self.get_children('BuildingStory')


	def add_BuildingStory(self,
		):
		return self.add_child('BuildingStory',
			)



class BuildingStory_auto():
	"""Captures Building Story Structure"""
...
class Level_auto():
	"""Building story Local Placement Z coordinate."""
...
class CADModelAzimuth_auto():
	"""The number of degrees (0 to 360) of the angle of positive Y axis from north.
				(Value of the of Azimuth of Model's North relative to Cardinal North)"""
...
class SpaceBoundary_auto():
	"""This element establishes the logical relation of a given part of the space geomery to the building constructions through its surfaceIdRef attribute. One Surface may be referenced by more space boundaries of one space."""
	...
	def isSecondLevelBoundary(self):
		"""If this attribute is set to true, the boundary is important in heatflow calculation."""
