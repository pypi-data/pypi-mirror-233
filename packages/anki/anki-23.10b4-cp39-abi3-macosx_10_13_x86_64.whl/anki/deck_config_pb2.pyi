...
class DeckConfig(google.protobuf.message.Message):
    ...
    class Config(google.protobuf.message.Message):
        ...
        RESCHEDULE_FSRS_CARDS_FIELD_NUMBER: builtins.int
        ...
        """for fsrs"""
        reschedule_fsrs_cards: builtins.bool
...
class DeckConfigsForUpdate(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["all_config", b"all_config", "card_state_customizer", b"card_state_customizer", "current_deck", b"current_deck", "defaults", b"defaults", "fsrs", b"fsrs", "new_cards_ignore_review_limit", b"new_cards_ignore_review_limit", "schema_modified", b"schema_modified", "v3_scheduler", b"v3_scheduler"]) -> None: ...
...
class UpdateDeckConfigsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["limits", b"limits"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["apply_to_children", b"apply_to_children", "card_state_customizer", b"card_state_customizer", "configs", b"configs", "fsrs", b"fsrs", "limits", b"limits", "new_cards_ignore_review_limit", b"new_cards_ignore_review_limit", "removed_config_ids", b"removed_config_ids", "target_deck_id", b"target_deck_id"]) -> None: ...
