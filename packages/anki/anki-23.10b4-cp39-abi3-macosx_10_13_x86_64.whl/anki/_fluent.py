...
class GeneratedTranslations:
    ...
    def actions_flag_number(self, number: FluentVariable) -> str:
        r''' Flag {$number} '''
        return self._translate(1, 22, {"number": number})
    ...
    def actions_options_for(self, val: FluentVariable) -> str:
        r''' Options for {$val} '''
        return self._translate(1, 40, {"val": val})
    ...
    def actions_shortcut_key(self, val: FluentVariable) -> str:
        r''' Shortcut key: {$val} '''
        return self._translate(1, 57, {"val": val})
    ...
    def actions_with_ellipsis(self, action: str) -> str:
        r''' {$action}... '''
        return self._translate(1, 66, {"action": action})
...
{$traceback} '''
    ...
    def addons_possibly_involved(self, addons: str) -> str:
        ...
        return self._translate(3, 44, {"addons": addons})


    def addons_requires(self, val: FluentVariable) -> str:
        r''' (requires {$val}) '''
        return self._translate(3, 45, {"val": val})


    def addons_restored_defaults(self, ) -> str:
        r''' Restored defaults '''
        return self._translate(3, 46, {})
    ...
    def addons_the_following_addons_are_incompatible_with(self, name: str, found: FluentVariable) -> str:
        ...
        return self._translate(3, 47, {"name": name, "found": found})
    ...
    def addons_unable_to_update_or_delete_addon(self, val: FluentVariable) -> str:
        ...
        return self._translate(3, 53, {"val": val})
    ...
    def browsing_window_title(self, selected: int, total: int) -> str:
        ...
        return self._translate(4, 132, {"selected": selected, "total": total})
...
used while looking at the answer side of a card. '''
    ...
    def deck_config_analyze_button(self, ) -> str:
        r''' Analyze '''
...
learning cards are cards with a current learning step of one or more days. '''
    ...
    def deck_config_complete(self, num: FluentVariable) -> str:
        r''' {$num}% complete. '''
        return self._translate(11, 20, {"num": num})
    ...
    def deck_config_daily_limit_will_be_capped(self, cards: int) -> str:
        ...
        return self._translate(11, 27, {"cards": cards})
...
the manual before changing this option. '''
    ...
    def deck_config_invalid_weights(self, ) -> str:
        r''' Weights must be either left blank to use the defaults, or must be 17 comma-separated numbers. '''
...
The shorter you set this, the greater your workload will be. '''
    ...
    def deck_config_must_have_1000_reviews(self, count: int) -> str:
        r''' Only {$count} reviews were found. You must have at least 1000 reviews to generate custom weights. '''
        return self._translate(11, 62, {"count": count})
...
sort orders preferable. '''
    ...
    def deck_config_reviews_too_low(self, cards: int, expected: FluentVariable) -> str:
        ...
        return self._translate(11, 101, {"cards": cards, "expected": expected})
    ...
    def deck_config_set_optimal_retention(self, num: FluentVariable) -> str:
        r''' Set desired retention to {$num} '''
        return self._translate(11, 104, {"num": num})
...
newly-learned card will delay the next review by 2.5x the previous delay. '''
    ...
    def deck_config_steps_too_large_for_fsrs(self, ) -> str:
        r''' When FSRS is enabled, learning steps over 1 day are not recommended. '''
...
- `Today only`: Make a temporary change to this deck's limit. '''
    ...
    def deck_config_updating_cards(self, current_cards_count: int, total_cards_count: int) -> str:
        ...
        return self._translate(11, 132, {"current_cards_count": current_cards_count, "total_cards_count": total_cards_count})


    def deck_config_used_by_decks(self, decks: int) -> str:
        r''' used by {$decks} decks '''
        return self._translate(11, 133, {"decks": decks})
...
you proceed. '''
    ...
    def editing_mathjax_placeholder(self, accept: str, newline: str) -> str:
        ...
        return self._translate(13, 44, {"accept": accept, "newline": newline})
...
Debug info: '''
    ...
    def errors_invalid_input_details(self, details: str) -> str:
        ...
        return self._translate(15, 9, {"details": details})
    ...
    def errors_option_not_set(self, option: str) -> str:
        r''' '{$option}' not set '''
        return self._translate(15, 12, {"option": option})
...
You can help us complete this help page on {$link}. '''
    ...
    def help_open_manual_chapter(self, name: str) -> str:
        ...
        return self._translate(19, 2, {"name": name})
...
option disabled, the literal characters '&lt;br&gt;' will be rendered. '''
    ...
    def importing_appeared_twice_in_file(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 8, {"val": val})
    ...
    def importing_cards_added(self, count: int) -> str:
        r''' {$count} cards added. '''
        return self._translate(20, 10, {"count": count})
    ...
    def importing_conflicting_notes_skipped(self, count: int) -> str:
        ...
        return self._translate(20, 14, {"count": count})
    ...
    def importing_conflicting_notes_skipped2(self, count: int) -> str:
        ...
        return self._translate(20, 15, {"count": count})
    ...
    def importing_empty_first_field(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 20, {"val": val})
...
- ``: Create a new note. '''
    ...
    def importing_existing_notes_skipped(self, count: int) -> str:
        ...
        return self._translate(20, 24, {"count": count})
    ...
    def importing_failed_to_import_media_file(self, debug_info: str) -> str:
        ...
        return self._translate(20, 27, {"debugInfo": debug_info})
    ...
    def importing_field_of_file_is(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 29, {"val": val})
...
do this automatically. '''
    ...
    def importing_first_field_matched(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 37, {"val": val})
...
Otherwise, all cards will be imported as new cards. '''
    ...
    def importing_map_to(self, val: FluentVariable) -> str:
        r''' Map to {$val} '''
        return self._translate(20, 52, {"val": val})
...
Warning: This will require a one-way sync, and may mark existing notes as modified. '''
    ...
    def importing_note_added(self, count: int) -> str:
        r''' {$count} notes added '''
        return self._translate(20, 63, {"count": count})


    def importing_note_imported(self, count: int) -> str:
        r''' {$count} notes imported. '''
        return self._translate(20, 64, {"count": count})
    ...
    def importing_note_updated(self, count: int) -> str:
        r''' {$count} notes updated '''
        return self._translate(20, 70, {"count": count})
    ...
    def importing_notes_updated(self, count: int) -> str:
        ...
        return self._translate(20, 79, {"count": count})
...
mapping tool. '''
    ...
    def importing_rows_had_num1d_fields_expected_num2d(self, row: str, found: FluentVariable, expected: FluentVariable) -> str:
        ...
        return self._translate(20, 90, {"row": row, "found": found, "expected": expected})
    ...
    def importing_unable_to_import_filename(self, filename: str) -> str:
        ...
        return self._translate(20, 108, {"filename": filename})
...
{$link} '''
    ...
    def qt_misc_anki_updatedanki_has_been_released(self, val: FluentVariable) -> str:
        ...
        return self._translate(29, 4, {"val": val})
    ...
    def qt_misc_error_during_startup(self, val: FluentVariable) -> str:
        ...
        return self._translate(29, 21, {"val": val})
    ...
    def qt_misc_error_loading_graphics_driver(self, mode: str, context: str) -> str:
        ...
        return self._translate(29, 22, {"mode": mode, "context": context})
    ...
    def qt_misc_in_order_to_ensure_your_collection(self, val: FluentVariable) -> str:
        ...
        return self._translate(29, 25, {"val": val})
    ...
    def qt_misc_second(self, count: int) -> str:
        r''' {$count} seconds '''
        return self._translate(29, 45, {"count": count})
    ...
    def qt_misc_the_following_character_can_not_be(self, val: FluentVariable) -> str:
        ...
        return self._translate(29, 54, {"val": val})
...
Please select  before proceeding. '''
    ...
    def statistics_card_difficulty_subtitle(self, ) -> str:
        r''' The higher the difficulty, the harder it is to remember. '''
    ...
    def statistics_card_difficulty_tooltip(self, cards: int, percent: FluentVariable) -> str:
        ...
        return self._translate(32, 20, {"cards": cards, "percent": percent})
    ...
    def statistics_card_ease_tooltip(self, cards: int, percent: FluentVariable) -> str:
        ...
        return self._translate(32, 23, {"cards": cards, "percent": percent})
    ...
    def statistics_card_stability_subtitle(self, ) -> str:
        r''' Predicted delay that you have a 90% chance of remembering. '''
    ...
    def statistics_cards(self, cards: int) -> str:
        r''' {$cards} cards '''
        return self._translate(32, 27, {"cards": cards})
    ...
    def statistics_cards_per_min(self, cards_per_minute: float) -> str:
        ...
        return self._translate(32, 30, {"cards-per-minute": cards_per_minute})
    ...
    def statistics_days_ago_range(self, days_start: int, days_end: int) -> str:
        ...
        return self._translate(32, 42, {"daysStart": days_start, "daysEnd": days_end})


    def statistics_days_ago_single(self, days: int) -> str:
        r''' {$days} days ago '''
        return self._translate(32, 43, {"days": days})
    ...
    def statistics_due_for_new_card(self, number: FluentVariable) -> str:
        r''' New #{$number} '''
        return self._translate(32, 47, {"number": number})
    ...
    def statistics_elapsed_time_days(self, amount: int) -> str:
        r''' {$amount}d '''
        return self._translate(32, 49, {"amount": amount})
    ...
    def statistics_in_days_range(self, days_start: int, days_end: int) -> str:
        ...
        return self._translate(32, 63, {"daysStart": days_start, "daysEnd": days_end})


    def statistics_in_days_single(self, days: int) -> str:
        r''' In {$days} days '''
        return self._translate(32, 64, {"days": days})


    def statistics_in_time_span_days(self, amount: int) -> str:
        r''' in {$amount} days '''
        return self._translate(32, 65, {"amount": amount})
    ...
    def statistics_minutes_per_day(self, count: int) -> str:
        r''' {$count} minutes/day '''
        return self._translate(32, 75, {"count": count})


    def statistics_no_data(self, ) -> str:
        r''' NO DATA '''
        return self._translate(32, 76, {})
    ...
    def statistics_retrievability_subtitle(self, ) -> str:
        r''' How likely you are to remember. '''
...
({$secs-per-card}s/card) '''
        return self._translate(32, 95, {"unit": unit, "secs-per-card": secs_per_card, "amount": amount, "cards": cards})
    ...
    def statistics_today_correct_mature(self, correct: int, total: int, percent: FluentVariable) -> str:
        ...
        return self._translate(32, 98, {"correct": correct, "total": total, "percent": percent})
    ...
    def statistics_today_type_counts(self, learn_count: int, review_count: int, relearn_count: int, filtered_count: int) -> str:
        ...
        return self._translate(32, 102, {"learnCount": learn_count, "reviewCount": review_count, "relearnCount": relearn_count, "filteredCount": filtered_count})
    ...
    def studying_card_studied_in(self, count: int) -> str:
        ...
        return self._translate(33, 8, {"count": count})
    ...
    def studying_cards_buried(self, count: int) -> str:
        ...
        return self._translate(33, 11, {"count": count})
    ...
    def studying_minute(self, count: int) -> str:
        r''' {$count} minutes. '''
        return self._translate(33, 27, {"count": count})
    ...
    def studying_type_answer_unknown_field(self, val: FluentVariable) -> str:
        ...
        return self._translate(33, 42, {"val": val})
...
After all devices are in sync, future reviews and added cards can be merged automatically. '''
    ...
    def sync_media_added_count(self, up: FluentVariable, down: FluentVariable) -> str:
        r''' Added: {$up}↑ {$down}↓ '''
        return self._translate(34, 18, {"up": up, "down": down})


    def sync_media_checked_count(self, count: int) -> str:
        r''' Checked: {$count} '''
        return self._translate(34, 19, {"count": count})
...
then using Check Database to shrink the file size down. ({$details}) '''
        return self._translate(34, 34, {"details": details})
...
class LegacyTranslationEnum:
    ...
    ACTIONS_CLOSE = (1, 11)
    ACTIONS_COPY = (1, 12)
    ACTIONS_CREATE_COPY = (1, 13)
    ACTIONS_CUSTOM_STUDY = (1, 14)
    ACTIONS_DECKS = (1, 15)
    ACTIONS_DECREMENT_VALUE = (1, 16)
    ACTIONS_DELETE = (1, 17)
    ACTIONS_EXPORT = (1, 18)
    ACTIONS_FILTER = (1, 19)
    ACTIONS_FLAG_BLUE = (1, 20)
    ACTIONS_FLAG_GREEN = (1, 21)
    ACTIONS_FLAG_NUMBER = (1, 22)
    ACTIONS_FLAG_ORANGE = (1, 23)
    ACTIONS_FLAG_PINK = (1, 24)
    ACTIONS_FLAG_PURPLE = (1, 25)
    ACTIONS_FLAG_RED = (1, 26)
    ACTIONS_FLAG_TURQUOISE = (1, 27)
    ACTIONS_FORGET_CARD = (1, 28)
    ACTIONS_FULLSCREEN_UNSUPPORTED = (1, 29)
    ACTIONS_HELP = (1, 30)
    ACTIONS_IMPORT = (1, 31)
    ACTIONS_INCREMENT_VALUE = (1, 32)
    ACTIONS_MANAGE = (1, 33)
    ACTIONS_NAME = (1, 34)
    ACTIONS_NEW = (1, 35)
    ACTIONS_NEW_NAME = (1, 36)
    ACTIONS_NOTHING_TO_REDO = (1, 37)
    ACTIONS_NOTHING_TO_UNDO = (1, 38)
    ACTIONS_OPTIONS = (1, 39)
    ACTIONS_OPTIONS_FOR = (1, 40)
    ACTIONS_PREVIEW = (1, 41)
    ACTIONS_PREVIOUS_CARD_INFO = (1, 42)
    ACTIONS_REBUILD = (1, 43)
    ACTIONS_REMOVE_NOTETYPE = (1, 44)
    ACTIONS_REMOVE_TAG = (1, 45)
    ACTIONS_RENAME = (1, 46)
    ACTIONS_RENAME_DECK = (1, 47)
    ACTIONS_RENAME_TAG = (1, 48)
    ACTIONS_RENAME_WITH_PARENTS = (1, 49)
    ACTIONS_REPLAY_AUDIO = (1, 50)
    ACTIONS_REPOSITION = (1, 51)
    ACTIONS_SAVE = (1, 52)
    ACTIONS_SEARCH = (1, 53)
    ACTIONS_SELECT = (1, 54)
    ACTIONS_SET_DUE_DATE = (1, 55)
    ACTIONS_SET_FLAG = (1, 56)
    ACTIONS_SHORTCUT_KEY = (1, 57)
    ACTIONS_SUSPEND_CARD = (1, 58)
    ACTIONS_UNBURY_UNSUSPEND = (1, 59)
    ACTIONS_UPDATE_CARD = (1, 60)
    ACTIONS_UPDATE_CONFIG = (1, 61)
    ACTIONS_UPDATE_DECK = (1, 62)
    ACTIONS_UPDATE_NOTE = (1, 63)
    ACTIONS_UPDATE_NOTETYPE = (1, 64)
    ACTIONS_UPDATE_TAG = (1, 65)
    ACTIONS_WITH_ELLIPSIS = (1, 66)
    ...
    ADDONS_GET_ADDONS = (3, 23)
    ADDONS_IMPORTANT_AS_ADDONS_ARE_PROGRAMS_DOWNLOADED = (3, 24)
    ADDONS_INSTALL_ADDON = (3, 25)
    ADDONS_INSTALL_ADDONS = (3, 26)
    ADDONS_INSTALL_ANKI_ADDON = (3, 27)
    ADDONS_INSTALL_FROM_FILE = (3, 28)
    ADDONS_INSTALLATION_COMPLETE = (3, 29)
    ADDONS_INSTALLED_NAMES = (3, 30)
    ADDONS_INSTALLED_SUCCESSFULLY = (3, 31)
    ADDONS_INVALID_ADDON_MANIFEST = (3, 32)
    ADDONS_INVALID_CODE = (3, 33)
    ADDONS_INVALID_CODE_OR_ADDON_NOT_AVAILABLE = (3, 34)
    ADDONS_INVALID_CONFIGURATION = (3, 35)
    ADDONS_INVALID_CONFIGURATION_TOP_LEVEL_OBJECT_MUST = (3, 36)
    ADDONS_NO_UPDATES_AVAILABLE = (3, 37)
    ADDONS_ONE_OR_MORE_ERRORS_OCCURRED = (3, 38)
    ADDONS_PACKAGED_ANKI_ADDON = (3, 39)
    ADDONS_PLEASE_CHECK_YOUR_INTERNET_CONNECTION = (3, 40)
    ADDONS_PLEASE_REPORT_THIS_TO_THE_RESPECTIVE = (3, 41)
    ADDONS_PLEASE_RESTART_ANKI_TO_COMPLETE_THE = (3, 42)
    ADDONS_PLEASE_SELECT_A_SINGLE_ADDON_FIRST = (3, 43)
    ADDONS_POSSIBLY_INVOLVED = (3, 44)
    ADDONS_REQUIRES = (3, 45)
    ADDONS_RESTORED_DEFAULTS = (3, 46)
    ADDONS_THE_FOLLOWING_ADDONS_ARE_INCOMPATIBLE_WITH = (3, 47)
    ADDONS_THE_FOLLOWING_ADDONS_HAVE_UPDATES_AVAILABLE = (3, 48)
    ADDONS_THE_FOLLOWING_CONFLICTING_ADDONS_WERE_DISABLED = (3, 49)
    ADDONS_THIS_ADDON_IS_NOT_COMPATIBLE_WITH = (3, 50)
    ADDONS_TO_BROWSE_ADDONS_PLEASE_CLICK_THE = (3, 51)
    ADDONS_TOGGLE_ENABLED = (3, 52)
    ADDONS_UNABLE_TO_UPDATE_OR_DELETE_ADDON = (3, 53)
    ADDONS_UNKNOWN_ERROR = (3, 54)
    ADDONS_VIEW_ADDON_PAGE = (3, 55)
    ADDONS_VIEW_FILES = (3, 56)
    ADDONS_WINDOW_TITLE = (3, 57)
    ...
    BROWSING_SIDEBAR_COLLAPSE = (4, 92)
    BROWSING_SIDEBAR_COLLAPSE_CHILDREN = (4, 93)
    BROWSING_SIDEBAR_DECKS = (4, 94)
    BROWSING_SIDEBAR_DUE_TODAY = (4, 95)
    BROWSING_SIDEBAR_EXPAND = (4, 96)
    BROWSING_SIDEBAR_EXPAND_CHILDREN = (4, 97)
    BROWSING_SIDEBAR_FILTER = (4, 98)
    BROWSING_SIDEBAR_FIRST_REVIEW = (4, 99)
    BROWSING_SIDEBAR_FLAGS = (4, 100)
    BROWSING_SIDEBAR_NOTETYPES = (4, 101)
    BROWSING_SIDEBAR_OVERDUE = (4, 102)
    BROWSING_SIDEBAR_RESCHEDULED = (4, 103)
    BROWSING_SIDEBAR_SAVE_CURRENT_SEARCH = (4, 104)
    BROWSING_SIDEBAR_SAVED_SEARCHES = (4, 105)
    BROWSING_SIDEBAR_TAGS = (4, 106)
    BROWSING_SIDEBAR_UNTAGGED = (4, 107)
    BROWSING_SORT_FIELD = (4, 108)
    BROWSING_SORTING_ON_THIS_COLUMN_IS_NOT = (4, 109)
    BROWSING_START_POSITION = (4, 110)
    BROWSING_STEP = (4, 111)
    BROWSING_STUDIED_TODAY = (4, 112)
    BROWSING_SUSPENDED = (4, 113)
    BROWSING_TAG_DUPLICATES = (4, 114)
    BROWSING_TAG_RENAME_WARNING_EMPTY = (4, 115)
    BROWSING_TARGET_FIELD = (4, 116)
    BROWSING_TODAY = (4, 117)
    BROWSING_TOGGLE_BURY = (4, 118)
    BROWSING_TOGGLE_MARK = (4, 119)
    BROWSING_TOGGLE_SHOWING_CARDS_NOTES = (4, 120)
    BROWSING_TOGGLE_SUSPEND = (4, 121)
    BROWSING_TOOLTIP_ANSWER = (4, 122)
    BROWSING_TOOLTIP_CARD = (4, 123)
    BROWSING_TOOLTIP_CARD_MODIFIED = (4, 124)
    BROWSING_TOOLTIP_CARDS = (4, 125)
    BROWSING_TOOLTIP_NOTE_MODIFIED = (4, 126)
    BROWSING_TOOLTIP_NOTETYPE = (4, 127)
    BROWSING_TOOLTIP_QUESTION = (4, 128)
    BROWSING_TREAT_INPUT_AS_REGULAR_EXPRESSION = (4, 129)
    BROWSING_UPDATE_SAVED_SEARCH = (4, 130)
    BROWSING_WHOLE_COLLECTION = (4, 131)
    BROWSING_WINDOW_TITLE = (4, 132)
    BROWSING_WINDOW_TITLE_NOTES = (4, 133)
    BROWSING_YOU_MUST_HAVE_AT_LEAST_ONE = (4, 134)
    ...
    DECK_CONFIG_AFFECTS_ENTIRE_COLLECTION = (11, 2)
    DECK_CONFIG_ALWAYS_INCLUDE_QUESTION_AUDIO_TOOLTIP = (11, 3)
    DECK_CONFIG_ANALYZE_BUTTON = (11, 4)
    DECK_CONFIG_AUDIO_TITLE = (11, 5)
    DECK_CONFIG_BURY_IF_NEW = (11, 6)
    DECK_CONFIG_BURY_IF_NEW_OR_REVIEW = (11, 7)
    DECK_CONFIG_BURY_IF_NEW_REVIEW_OR_INTERDAY = (11, 8)
    DECK_CONFIG_BURY_INTERDAY_LEARNING_SIBLINGS = (11, 9)
    DECK_CONFIG_BURY_INTERDAY_LEARNING_TOOLTIP = (11, 10)
    DECK_CONFIG_BURY_NEW_SIBLINGS = (11, 11)
    DECK_CONFIG_BURY_NEW_TOOLTIP = (11, 12)
    DECK_CONFIG_BURY_PRIORITY_TOOLTIP = (11, 13)
    DECK_CONFIG_BURY_REVIEW_SIBLINGS = (11, 14)
    DECK_CONFIG_BURY_REVIEW_TOOLTIP = (11, 15)
    DECK_CONFIG_BURY_SIBLINGS = (11, 16)
    DECK_CONFIG_BURY_TITLE = (11, 17)
    DECK_CONFIG_BURY_TOOLTIP = (11, 18)
    DECK_CONFIG_CLONE_GROUP = (11, 19)
    DECK_CONFIG_COMPLETE = (11, 20)
    DECK_CONFIG_COMPUTE_BUTTON = (11, 21)
    DECK_CONFIG_COMPUTE_OPTIMAL_RETENTION = (11, 22)
    DECK_CONFIG_COMPUTE_OPTIMAL_WEIGHTS = (11, 23)
    DECK_CONFIG_CONFIRM_REMOVE_NAME = (11, 24)
    DECK_CONFIG_CUSTOM_SCHEDULING = (11, 25)
    DECK_CONFIG_CUSTOM_SCHEDULING_TOOLTIP = (11, 26)
    DECK_CONFIG_DAILY_LIMIT_WILL_BE_CAPPED = (11, 27)
    DECK_CONFIG_DAILY_LIMITS = (11, 28)
    DECK_CONFIG_DECK_ONLY = (11, 29)
    DECK_CONFIG_DEFAULT_NAME = (11, 30)
    DECK_CONFIG_DESCRIPTION_NEW_HANDLING = (11, 31)
    DECK_CONFIG_DESCRIPTION_NEW_HANDLING_HINT = (11, 32)
    DECK_CONFIG_DESIRED_RETENTION = (11, 33)
    DECK_CONFIG_DISABLE_AUTOPLAY = (11, 34)
    DECK_CONFIG_DISABLE_AUTOPLAY_TOOLTIP = (11, 35)
    DECK_CONFIG_DISPLAY_ORDER_WILL_USE_CURRENT_DECK = (11, 36)
    DECK_CONFIG_DO_NOT_BURY = (11, 37)
    DECK_CONFIG_EASY_BONUS_TOOLTIP = (11, 38)
    DECK_CONFIG_EASY_INTERVAL_TOOLTIP = (11, 39)
    DECK_CONFIG_FSRS_ON_ALL_CLIENTS = (11, 40)
    DECK_CONFIG_GET_PARAMS = (11, 41)
    DECK_CONFIG_GOOD_ABOVE_EASY = (11, 42)
    DECK_CONFIG_GRADUATING_INTERVAL_TOOLTIP = (11, 43)
    DECK_CONFIG_HARD_INTERVAL_TOOLTIP = (11, 44)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY = (11, 45)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY_TOOLTIP = (11, 46)
    DECK_CONFIG_INTERVAL_MODIFIER_TOOLTIP = (11, 47)
    DECK_CONFIG_INVALID_WEIGHTS = (11, 48)
    DECK_CONFIG_LEARNING_STEP_ABOVE_GRADUATING_INTERVAL = (11, 49)
    DECK_CONFIG_LEARNING_STEPS = (11, 50)
    DECK_CONFIG_LEARNING_STEPS_TOOLTIP = (11, 51)
    DECK_CONFIG_LEECH_ACTION_TOOLTIP = (11, 52)
    DECK_CONFIG_LEECH_THRESHOLD_TOOLTIP = (11, 53)
    DECK_CONFIG_LIMIT_DECK_V3 = (11, 54)
    DECK_CONFIG_LIMIT_INTERDAY_BOUND_BY_REVIEWS = (11, 55)
    DECK_CONFIG_LIMIT_NEW_BOUND_BY_REVIEWS = (11, 56)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS = (11, 57)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_ABOVE_RECOMMENDED = (11, 58)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_TOOLTIP = (11, 59)
    DECK_CONFIG_MAXIMUM_INTERVAL_TOOLTIP = (11, 60)
    DECK_CONFIG_MINIMUM_INTERVAL_TOOLTIP = (11, 61)
    DECK_CONFIG_MUST_HAVE_1000_REVIEWS = (11, 62)
    DECK_CONFIG_NAME_PROMPT = (11, 63)
    DECK_CONFIG_NEW_CARD_SORT_ORDER = (11, 64)
    DECK_CONFIG_NEW_CARD_SORT_ORDER_TOOLTIP_2 = (11, 65)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT = (11, 66)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT_TOOLTIP = (11, 67)
    DECK_CONFIG_NEW_GATHER_PRIORITY = (11, 68)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK = (11, 69)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK_THEN_RANDOM_NOTES = (11, 70)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_HIGHEST_FIRST = (11, 71)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_LOWEST_FIRST = (11, 72)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_CARDS = (11, 73)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_NOTES = (11, 74)
    DECK_CONFIG_NEW_GATHER_PRIORITY_TOOLTIP_2 = (11, 75)
    DECK_CONFIG_NEW_INSERTION_ORDER = (11, 76)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM = (11, 77)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM_WITH_V3 = (11, 78)
    DECK_CONFIG_NEW_INSERTION_ORDER_SEQUENTIAL = (11, 79)
    DECK_CONFIG_NEW_INSERTION_ORDER_TOOLTIP = (11, 80)
    DECK_CONFIG_NEW_INTERVAL_TOOLTIP = (11, 81)
    DECK_CONFIG_NEW_LIMIT_TOOLTIP = (11, 82)
    DECK_CONFIG_NEW_REVIEW_PRIORITY = (11, 83)
    DECK_CONFIG_NEW_REVIEW_PRIORITY_TOOLTIP = (11, 84)
    DECK_CONFIG_NOT_ENOUGH_HISTORY = (11, 85)
    DECK_CONFIG_OPTIMIZE_BUTTON = (11, 86)
    DECK_CONFIG_ORDERING_TITLE = (11, 87)
    DECK_CONFIG_RELEARNING_STEPS = (11, 88)
    DECK_CONFIG_RELEARNING_STEPS_ABOVE_MINIMUM_INTERVAL = (11, 89)
    DECK_CONFIG_RELEARNING_STEPS_TOOLTIP = (11, 90)
    DECK_CONFIG_REMOVE_GROUP = (11, 91)
    DECK_CONFIG_RENAME_GROUP = (11, 92)
    DECK_CONFIG_RESCHEDULE_CARDS_ON_CHANGE = (11, 93)
    DECK_CONFIG_REVERT_BUTTON_TOOLTIP = (11, 94)
    DECK_CONFIG_REVIEW_LIMIT_TOOLTIP = (11, 95)
    DECK_CONFIG_REVIEW_MIX_MIX_WITH_REVIEWS = (11, 96)
    DECK_CONFIG_REVIEW_MIX_SHOW_AFTER_REVIEWS = (11, 97)
    DECK_CONFIG_REVIEW_MIX_SHOW_BEFORE_REVIEWS = (11, 98)
    DECK_CONFIG_REVIEW_SORT_ORDER = (11, 99)
    DECK_CONFIG_REVIEW_SORT_ORDER_TOOLTIP = (11, 100)
    DECK_CONFIG_REVIEWS_TOO_LOW = (11, 101)
    DECK_CONFIG_SAVE_BUTTON = (11, 102)
    DECK_CONFIG_SAVE_TO_ALL_SUBDECKS = (11, 103)
    DECK_CONFIG_SET_OPTIMAL_RETENTION = (11, 104)
    DECK_CONFIG_SHARED_PRESET = (11, 105)
    DECK_CONFIG_SHOW_ANSWER_TIMER_TOOLTIP = (11, 106)
    DECK_CONFIG_SKIP_QUESTION_WHEN_REPLAYING = (11, 107)
    DECK_CONFIG_SMALLER_IS_BETTER = (11, 108)
    DECK_CONFIG_SORT_ORDER_ASCENDING_DIFFICULTY = (11, 109)
    DECK_CONFIG_SORT_ORDER_ASCENDING_EASE = (11, 110)
    DECK_CONFIG_SORT_ORDER_ASCENDING_INTERVALS = (11, 111)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_RANDOM = (11, 112)
    DECK_CONFIG_SORT_ORDER_DECK_THEN_DUE_DATE = (11, 113)
    DECK_CONFIG_SORT_ORDER_DESCENDING_DIFFICULTY = (11, 114)
    DECK_CONFIG_SORT_ORDER_DESCENDING_EASE = (11, 115)
    DECK_CONFIG_SORT_ORDER_DESCENDING_INTERVALS = (11, 116)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_DECK = (11, 117)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_RANDOM = (11, 118)
    DECK_CONFIG_SORT_ORDER_GATHER = (11, 119)
    DECK_CONFIG_SORT_ORDER_RANDOM = (11, 120)
    DECK_CONFIG_SORT_ORDER_RANDOM_NOTE_THEN_TEMPLATE = (11, 121)
    DECK_CONFIG_SORT_ORDER_RELATIVE_OVERDUENESS = (11, 122)
    DECK_CONFIG_SORT_ORDER_TEMPLATE_THEN_GATHER = (11, 123)
    DECK_CONFIG_STARTING_EASE_TOOLTIP = (11, 124)
    DECK_CONFIG_STEPS_TOO_LARGE_FOR_FSRS = (11, 125)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER = (11, 126)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER_TOOLTIP = (11, 127)
    DECK_CONFIG_TAB_DESCRIPTION = (11, 128)
    DECK_CONFIG_TIMER_TITLE = (11, 129)
    DECK_CONFIG_TITLE = (11, 130)
    DECK_CONFIG_TODAY_ONLY = (11, 131)
    DECK_CONFIG_UPDATING_CARDS = (11, 132)
    DECK_CONFIG_USED_BY_DECKS = (11, 133)
    DECK_CONFIG_WEIGHTS = (11, 134)
    DECK_CONFIG_WHICH_DECK = (11, 135)
    DECK_CONFIG_WILL_REQUIRE_FULL_SYNC = (11, 136)
    ...
    DECKS_NEW_DECK_NAME = (12, 19)
    DECKS_NO_DECK = (12, 20)
    DECKS_OLDEST_SEEN_FIRST = (12, 21)
    DECKS_ORDER_ADDED = (12, 22)
    DECKS_ORDER_DUE = (12, 23)
    DECKS_PLEASE_SELECT_SOMETHING = (12, 24)
    DECKS_RANDOM = (12, 25)
    DECKS_RELATIVE_OVERDUENESS = (12, 26)
    DECKS_REPEAT_FAILED_CARDS_AFTER = (12, 27)
    DECKS_RESCHEDULE_CARDS_BASED_ON_MY_ANSWERS = (12, 28)
    DECKS_STUDY = (12, 29)
    DECKS_STUDY_DECK = (12, 30)
    DECKS_UNMOVABLE_CARDS = (12, 31)
    ...
    EDITING_INDENT = (13, 34)
    EDITING_ITALIC_TEXT = (13, 35)
    EDITING_JUMP_TO_TAGS_WITH_CTRLANDSHIFTANDT = (13, 36)
    EDITING_JUSTIFY = (13, 37)
    EDITING_LATEX = (13, 38)
    EDITING_LATEX_EQUATION = (13, 39)
    EDITING_LATEX_MATH_ENV = (13, 40)
    EDITING_MATHJAX_BLOCK = (13, 41)
    EDITING_MATHJAX_CHEMISTRY = (13, 42)
    EDITING_MATHJAX_INLINE = (13, 43)
    EDITING_MATHJAX_PLACEHOLDER = (13, 44)
    EDITING_MATHJAX_PREVIEW = (13, 45)
    EDITING_MEDIA = (13, 46)
    EDITING_NO_IMAGE_FOUND_ON_CLIPBOARD = (13, 47)
    EDITING_ORDERED_LIST = (13, 48)
    EDITING_OUTDENT = (13, 49)
    EDITING_PASTE = (13, 50)
    EDITING_RECORD_AUDIO = (13, 51)
    EDITING_REMOVE_FORMATTING = (13, 52)
    EDITING_RESTORE_ORIGINAL_SIZE = (13, 53)
    EDITING_SELECT_REMOVE_FORMATTING = (13, 54)
    EDITING_SHOW_DUPLICATES = (13, 55)
    EDITING_SHRINK_IMAGES = (13, 56)
    EDITING_SUBSCRIPT = (13, 57)
    EDITING_SUPERSCRIPT = (13, 58)
    EDITING_TAGS = (13, 59)
    EDITING_TAGS_ADD = (13, 60)
    EDITING_TAGS_COPY = (13, 61)
    EDITING_TAGS_REMOVE = (13, 62)
    EDITING_TAGS_SELECT_ALL = (13, 63)
    EDITING_TEXT_COLOR = (13, 64)
    EDITING_TEXT_HIGHLIGHT_COLOR = (13, 65)
    EDITING_TO_MAKE_A_CLOZE_DELETION_ON = (13, 66)
    EDITING_TOGGLE_HTML_EDITOR = (13, 67)
    EDITING_TOGGLE_STICKY = (13, 68)
    EDITING_TOGGLE_VISUAL_EDITOR = (13, 69)
    EDITING_UNDERLINE_TEXT = (13, 70)
    EDITING_UNORDERED_LIST = (13, 71)
    EDITING_WARNING_CLOZE_DELETIONS_WILL_NOT_WORK = (13, 72)
    ...
    ERRORS_FILTERED_DECK_REQUIRED = (15, 5)
    ERRORS_FILTERED_PARENT_DECK = (15, 6)
    ERRORS_INCONSISTENT_DB_STATE = (15, 7)
    ERRORS_INVALID_IDS = (15, 8)
    ERRORS_INVALID_INPUT_DETAILS = (15, 9)
    ERRORS_INVALID_INPUT_EMPTY = (15, 10)
    ERRORS_MULTIPLE_NOTETYPES_SELECTED = (15, 11)
    ERRORS_OPTION_NOT_SET = (15, 12)
    ERRORS_PARSE_NUMBER_FAIL = (15, 13)
    ERRORS_PLEASE_CHECK_DATABASE = (15, 14)
    ERRORS_PLEASE_CHECK_MEDIA = (15, 15)
    ERRORS_STANDARD_POPUP = (15, 16)
    ERRORS_UNABLE_OPEN_COLLECTION = (15, 17)
    ERRORS_WINDOWS_TTS_RUNTIME_ERROR = (15, 18)
    ...
    EXPORTING_INCLUDE_GUID = (16, 16)
    EXPORTING_INCLUDE_HTML_AND_MEDIA_REFERENCES = (16, 17)
    EXPORTING_INCLUDE_MEDIA = (16, 18)
    EXPORTING_INCLUDE_NOTETYPE = (16, 19)
    EXPORTING_INCLUDE_SCHEDULING_INFORMATION = (16, 20)
    EXPORTING_INCLUDE_TAGS = (16, 21)
    EXPORTING_NOTE_EXPORTED = (16, 22)
    EXPORTING_NOTES_IN_PLAIN_TEXT = (16, 23)
    EXPORTING_PROCESSED_MEDIA_FILES = (16, 24)
    EXPORTING_SELECTED_NOTES = (16, 25)
    EXPORTING_SUPPORT_OLDER_ANKI_VERSIONS = (16, 26)
    ...
    IMPORTING_ANKI_FILES_ARE_FROM_A_VERY = (20, 6)
    IMPORTING_ANKI2_FILES_ARE_NOT_DIRECTLY_IMPORTABLE = (20, 7)
    IMPORTING_APPEARED_TWICE_IN_FILE = (20, 8)
    IMPORTING_BY_DEFAULT_ANKI_WILL_DETECT_THE = (20, 9)
    IMPORTING_CARDS_ADDED = (20, 10)
    IMPORTING_CHANGE = (20, 11)
    IMPORTING_COLON = (20, 12)
    IMPORTING_COMMA = (20, 13)
    IMPORTING_CONFLICTING_NOTES_SKIPPED = (20, 14)
    IMPORTING_CONFLICTING_NOTES_SKIPPED2 = (20, 15)
    IMPORTING_DECK_HELP = (20, 16)
    IMPORTING_DETAILS = (20, 17)
    IMPORTING_DUPLICATE = (20, 18)
    IMPORTING_DUPLICATE_NOTE_ADDED = (20, 19)
    IMPORTING_EMPTY_FIRST_FIELD = (20, 20)
    IMPORTING_EXISTING_NOTE_SKIPPED = (20, 21)
    IMPORTING_EXISTING_NOTES = (20, 22)
    IMPORTING_EXISTING_NOTES_HELP = (20, 23)
    IMPORTING_EXISTING_NOTES_SKIPPED = (20, 24)
    IMPORTING_EXTRACTING = (20, 25)
    IMPORTING_FAILED_DEBUG_INFO = (20, 26)
    IMPORTING_FAILED_TO_IMPORT_MEDIA_FILE = (20, 27)
    IMPORTING_FIELD_MAPPING = (20, 28)
    IMPORTING_FIELD_OF_FILE_IS = (20, 29)
    IMPORTING_FIELD_SEPARATOR = (20, 30)
    IMPORTING_FIELD_SEPARATOR_HELP = (20, 31)
    IMPORTING_FIELDS_SEPARATED_BY = (20, 32)
    IMPORTING_FILE = (20, 33)
    IMPORTING_FILE_EMPTY = (20, 34)
    IMPORTING_FILE_MUST_CONTAIN_FIELD_COLUMN = (20, 35)
    IMPORTING_FILE_VERSION_UNKNOWN_TRYING_IMPORT_ANYWAY = (20, 36)
    IMPORTING_FIRST_FIELD_MATCHED = (20, 37)
    IMPORTING_GATHERING = (20, 38)
    IMPORTING_IDENTICAL = (20, 39)
    IMPORTING_IGNORE_FIELD = (20, 40)
    IMPORTING_IGNORE_LINES_WHERE_FIRST_FIELD_MATCHES = (20, 41)
    IMPORTING_IGNORED = (20, 42)
    IMPORTING_IMPORT_EVEN_IF_EXISTING_NOTE_HAS = (20, 43)
    IMPORTING_IMPORT_LOG = (20, 44)
    IMPORTING_IMPORT_OPTIONS = (20, 45)
    IMPORTING_IMPORTING_COLLECTION = (20, 46)
    IMPORTING_IMPORTING_COMPLETE = (20, 47)
    IMPORTING_IMPORTING_FILE = (20, 48)
    IMPORTING_INCLUDE_REVIEWS = (20, 49)
    IMPORTING_INCLUDE_REVIEWS_HELP = (20, 50)
    IMPORTING_INVALID_FILE_PLEASE_RESTORE_FROM_BACKUP = (20, 51)
    IMPORTING_MAP_TO = (20, 52)
    IMPORTING_MAP_TO_TAGS = (20, 53)
    IMPORTING_MAPPED_TO = (20, 54)
    IMPORTING_MAPPED_TO_TAGS = (20, 55)
    IMPORTING_MATCH_SCOPE = (20, 56)
    IMPORTING_MATCH_SCOPE_HELP = (20, 57)
    IMPORTING_MERGE_NOTETYPES = (20, 58)
    IMPORTING_MERGE_NOTETYPES_HELP = (20, 59)
    IMPORTING_MNEMOSYNE_20_DECK_DB = (20, 60)
    IMPORTING_MULTICHARACTER_SEPARATORS_ARE_NOT_SUPPORTED_PLEASE = (20, 61)
    IMPORTING_NO_NOTES_IN_FILE = (20, 62)
    IMPORTING_NOTE_ADDED = (20, 63)
    IMPORTING_NOTE_IMPORTED = (20, 64)
    IMPORTING_NOTE_SKIPPED_DUE_TO_EMPTY_FIRST_FIELD = (20, 65)
    IMPORTING_NOTE_SKIPPED_DUE_TO_MISSING_DECK = (20, 66)
    IMPORTING_NOTE_SKIPPED_DUE_TO_MISSING_NOTETYPE = (20, 67)
    IMPORTING_NOTE_SKIPPED_UPDATE_DUE_TO_NOTETYPE = (20, 68)
    IMPORTING_NOTE_UNCHANGED = (20, 69)
    IMPORTING_NOTE_UPDATED = (20, 70)
    IMPORTING_NOTE_UPDATED_AS_FILE_HAD_NEWER = (20, 71)
    IMPORTING_NOTES_ADDED = (20, 72)
    IMPORTING_NOTES_ADDED_FROM_FILE = (20, 73)
    IMPORTING_NOTES_FOUND_IN_FILE = (20, 74)
    IMPORTING_NOTES_FOUND_IN_FILE2 = (20, 75)
    IMPORTING_NOTES_SKIPPED_AS_THEYRE_ALREADY_IN = (20, 76)
    IMPORTING_NOTES_SKIPPED_UPDATE_DUE_TO_NOTETYPE = (20, 77)
    IMPORTING_NOTES_THAT_COULD_NOT_BE_IMPORTED = (20, 78)
    IMPORTING_NOTES_UPDATED = (20, 79)
    IMPORTING_NOTES_UPDATED_AS_FILE_HAD_NEWER = (20, 80)
    IMPORTING_NOTETYPE_AND_DECK = (20, 81)
    IMPORTING_NOTETYPE_HELP = (20, 82)
    IMPORTING_PACKAGED_ANKI_DECKCOLLECTION_APKG_COLPKG_ZIP = (20, 83)
    IMPORTING_PAUKER_18_LESSON_PAUGZ = (20, 84)
    IMPORTING_PIPE = (20, 85)
    IMPORTING_PRESERVE = (20, 86)
    IMPORTING_PROCESSED_CARDS = (20, 87)
    IMPORTING_PROCESSED_MEDIA_FILE = (20, 88)
    IMPORTING_PROCESSED_NOTES = (20, 89)
    IMPORTING_ROWS_HAD_NUM1D_FIELDS_EXPECTED_NUM2D = (20, 90)
    IMPORTING_SELECTED_FILE_WAS_NOT_IN_UTF8 = (20, 91)
    IMPORTING_SEMICOLON = (20, 92)
    IMPORTING_SHOW = (20, 93)
    IMPORTING_SKIPPED = (20, 94)
    IMPORTING_STATUS = (20, 95)
    IMPORTING_SUPERMEMO_XML_EXPORT_XML = (20, 96)
    IMPORTING_TAB = (20, 97)
    IMPORTING_TAG_ALL_NOTES = (20, 98)
    IMPORTING_TAG_ALL_NOTES_HELP = (20, 99)
    IMPORTING_TAG_MODIFIED_NOTES = (20, 100)
    IMPORTING_TAG_UPDATED_NOTES = (20, 101)
    IMPORTING_TAG_UPDATED_NOTES_HELP = (20, 102)
    IMPORTING_TEXT_SEPARATED_BY_TABS_OR_SEMICOLONS = (20, 103)
    IMPORTING_THE_FIRST_FIELD_OF_THE_NOTE = (20, 104)
    IMPORTING_THE_PROVIDED_FILE_IS_NOT_A = (20, 105)
    IMPORTING_THIS_FILE_DOES_NOT_APPEAR_TO = (20, 106)
    IMPORTING_THIS_WILL_DELETE_YOUR_EXISTING_COLLECTION = (20, 107)
    IMPORTING_UNABLE_TO_IMPORT_FILENAME = (20, 108)
    IMPORTING_UNABLE_TO_IMPORT_FROM_A_READONLY = (20, 109)
    IMPORTING_UNKNOWN_FILE_FORMAT = (20, 110)
    IMPORTING_UPDATE = (20, 111)
    IMPORTING_UPDATE_ALWAYS = (20, 112)
    IMPORTING_UPDATE_EXISTING_NOTES_WHEN_FIRST_FIELD = (20, 113)
    IMPORTING_UPDATE_IF_NEWER = (20, 114)
    IMPORTING_UPDATE_NEVER = (20, 115)
    IMPORTING_UPDATE_NOTES = (20, 116)
    IMPORTING_UPDATE_NOTES_HELP = (20, 117)
    IMPORTING_UPDATE_NOTETYPES = (20, 118)
    IMPORTING_UPDATE_NOTETYPES_HELP = (20, 119)
    IMPORTING_UPDATED = (20, 120)
    KEYBOARD_CTRL = (21, 0)
    KEYBOARD_SHIFT = (21, 1)
    ...
    QT_MISC_ANKI_IS_RUNNING = (29, 3)
    QT_MISC_ANKI_UPDATEDANKI_HAS_BEEN_RELEASED = (29, 4)
    QT_MISC_AUTOMATIC_SYNCING_AND_BACKUPS_HAVE_BEEN = (29, 5)
    QT_MISC_BACK_SIDE_ONLY = (29, 6)
    QT_MISC_BACKING_UP = (29, 7)
    QT_MISC_BROWSE = (29, 8)
    QT_MISC_CHANGE_NOTE_TYPE_CTRLANDN = (29, 9)
    QT_MISC_CHECK_THE_FILES_IN_THE_MEDIA = (29, 10)
    QT_MISC_CHOOSE_DECK = (29, 11)
    QT_MISC_CHOOSE_NOTE_TYPE = (29, 12)
    QT_MISC_CLOSING = (29, 13)
    QT_MISC_CONFIGURE_INTERFACE_LANGUAGE_AND_OPTIONS = (29, 14)
    QT_MISC_COPY_TO_CLIPBOARD = (29, 15)
    QT_MISC_CREATE_FILTERED_DECK = (29, 16)
    QT_MISC_DEBUG_CONSOLE = (29, 17)
    QT_MISC_DECK_WILL_BE_IMPORTED_WHEN_A = (29, 18)
    QT_MISC_EMPTY_CARDS = (29, 19)
    QT_MISC_ERROR = (29, 20)
    QT_MISC_ERROR_DURING_STARTUP = (29, 21)
    QT_MISC_ERROR_LOADING_GRAPHICS_DRIVER = (29, 22)
    QT_MISC_IF_INSTANCE_IS_NOT_RESPONDING = (29, 23)
    QT_MISC_IGNORE_THIS_UPDATE = (29, 24)
    QT_MISC_IN_ORDER_TO_ENSURE_YOUR_COLLECTION = (29, 25)
    QT_MISC_INCOMPATIBLE_VIDEO_DRIVER = (29, 26)
    QT_MISC_INVALID_PROPERTY_FOUND_ON_CARD_PLEASE = (29, 27)
    QT_MISC_LAYOUT_AUTO_ENABLED = (29, 28)
    QT_MISC_LAYOUT_HORIZONTAL_ENABLED = (29, 29)
    QT_MISC_LAYOUT_VERTICAL_ENABLED = (29, 30)
    QT_MISC_LOADING = (29, 31)
    QT_MISC_MANAGE = (29, 32)
    QT_MISC_MANAGE_NOTE_TYPES = (29, 33)
    QT_MISC_NAME_EXISTS = (29, 34)
    QT_MISC_NO_TEMP_FOLDER = (29, 35)
    QT_MISC_NON_UNICODE_TEXT = (29, 36)
    QT_MISC_OPTIMIZING = (29, 37)
    QT_MISC_PLEASE_ENSURE_A_PROFILE_IS_OPEN = (29, 38)
    QT_MISC_PLEASE_SELECT_1_CARD = (29, 39)
    QT_MISC_PLEASE_SELECT_A_DECK = (29, 40)
    QT_MISC_PLEASE_USE_FILEIMPORT_TO_IMPORT_THIS = (29, 41)
    QT_MISC_PROCESSING = (29, 42)
    QT_MISC_REPLACE_YOUR_COLLECTION_WITH_AN_EARLIER = (29, 43)
    QT_MISC_REVERT_TO_BACKUP = (29, 44)
    QT_MISC_SECOND = (29, 45)
    QT_MISC_SEGOE_UI = (29, 46)
    QT_MISC_SHIFT_KEY_WAS_HELD_DOWN_SKIPPING = (29, 47)
    QT_MISC_SHORTCUT_KEY_LEFT_ARROW = (29, 48)
    QT_MISC_SHORTCUT_KEY_RIGHT_ARROW_OR_ENTER = (29, 49)
    QT_MISC_STATS = (29, 50)
    QT_MISC_STUDY_DECK = (29, 51)
    QT_MISC_SYNC = (29, 52)
    QT_MISC_TARGET_DECK_CTRLANDD = (29, 53)
    QT_MISC_THE_FOLLOWING_CHARACTER_CAN_NOT_BE = (29, 54)
    QT_MISC_THE_REQUESTED_CHANGE_WILL_REQUIRE_A = (29, 55)
    QT_MISC_THERE_MUST_BE_AT_LEAST_ONE = (29, 56)
    QT_MISC_THIS_FILE_EXISTS_ARE_YOU_SURE = (29, 57)
    QT_MISC_UNABLE_TO_ACCESS_ANKI_MEDIA_FOLDER = (29, 58)
    QT_MISC_UNABLE_TO_RECORD = (29, 59)
    QT_MISC_UNEXPECTED_RESPONSE_CODE = (29, 60)
    QT_MISC_WOULD_YOU_LIKE_TO_DOWNLOAD_IT = (29, 61)
    QT_MISC_YOUR_COLLECTION_FILE_APPEARS_TO_BE = (29, 62)
    QT_MISC_YOUR_COMPUTERS_STORAGE_MAY_BE_FULL = (29, 63)
    QT_MISC_YOUR_FIREWALL_OR_ANTIVIRUS_PROGRAM_IS = (29, 64)
    ...
    STATISTICS_BACKLOG_CHECKBOX = (32, 16)
    STATISTICS_CALENDAR_TITLE = (32, 17)
    STATISTICS_CARD_DIFFICULTY_SUBTITLE = (32, 18)
    STATISTICS_CARD_DIFFICULTY_TITLE = (32, 19)
    STATISTICS_CARD_DIFFICULTY_TOOLTIP = (32, 20)
    STATISTICS_CARD_EASE_SUBTITLE = (32, 21)
    STATISTICS_CARD_EASE_TITLE = (32, 22)
    STATISTICS_CARD_EASE_TOOLTIP = (32, 23)
    STATISTICS_CARD_RETRIEVABILITY_TITLE = (32, 24)
    STATISTICS_CARD_STABILITY_SUBTITLE = (32, 25)
    STATISTICS_CARD_STABILITY_TITLE = (32, 26)
    STATISTICS_CARDS = (32, 27)
    STATISTICS_CARDS_DUE = (32, 28)
    STATISTICS_CARDS_PER_DAY = (32, 29)
    STATISTICS_CARDS_PER_MIN = (32, 30)
    STATISTICS_COUNTS_BURIED_CARDS = (32, 31)
    STATISTICS_COUNTS_FILTERED_CARDS = (32, 32)
    STATISTICS_COUNTS_LEARNING_CARDS = (32, 33)
    STATISTICS_COUNTS_MATURE_CARDS = (32, 34)
    STATISTICS_COUNTS_NEW_CARDS = (32, 35)
    STATISTICS_COUNTS_RELEARNING_CARDS = (32, 36)
    STATISTICS_COUNTS_SEPARATE_SUSPENDED_BURIED_CARDS = (32, 37)
    STATISTICS_COUNTS_SUSPENDED_CARDS = (32, 38)
    STATISTICS_COUNTS_TITLE = (32, 39)
    STATISTICS_COUNTS_TOTAL_CARDS = (32, 40)
    STATISTICS_COUNTS_YOUNG_CARDS = (32, 41)
    STATISTICS_DAYS_AGO_RANGE = (32, 42)
    STATISTICS_DAYS_AGO_SINGLE = (32, 43)
    STATISTICS_DAYS_STUDIED = (32, 44)
    STATISTICS_DUE_COUNT = (32, 45)
    STATISTICS_DUE_DATE = (32, 46)
    STATISTICS_DUE_FOR_NEW_CARD = (32, 47)
    STATISTICS_DUE_TOMORROW = (32, 48)
    STATISTICS_ELAPSED_TIME_DAYS = (32, 49)
    STATISTICS_ELAPSED_TIME_HOURS = (32, 50)
    STATISTICS_ELAPSED_TIME_MINUTES = (32, 51)
    STATISTICS_ELAPSED_TIME_MONTHS = (32, 52)
    STATISTICS_ELAPSED_TIME_SECONDS = (32, 53)
    STATISTICS_ELAPSED_TIME_YEARS = (32, 54)
    STATISTICS_FUTURE_DUE_SUBTITLE = (32, 55)
    STATISTICS_FUTURE_DUE_TITLE = (32, 56)
    STATISTICS_HOURS_CORRECT = (32, 57)
    STATISTICS_HOURS_CORRECT_REVIEWS = (32, 58)
    STATISTICS_HOURS_RANGE = (32, 59)
    STATISTICS_HOURS_REVIEWS = (32, 60)
    STATISTICS_HOURS_SUBTITLE = (32, 61)
    STATISTICS_HOURS_TITLE = (32, 62)
    STATISTICS_IN_DAYS_RANGE = (32, 63)
    STATISTICS_IN_DAYS_SINGLE = (32, 64)
    STATISTICS_IN_TIME_SPAN_DAYS = (32, 65)
    STATISTICS_IN_TIME_SPAN_HOURS = (32, 66)
    STATISTICS_IN_TIME_SPAN_MINUTES = (32, 67)
    STATISTICS_IN_TIME_SPAN_MONTHS = (32, 68)
    STATISTICS_IN_TIME_SPAN_SECONDS = (32, 69)
    STATISTICS_IN_TIME_SPAN_YEARS = (32, 70)
    STATISTICS_INTERVALS_DAY_RANGE = (32, 71)
    STATISTICS_INTERVALS_DAY_SINGLE = (32, 72)
    STATISTICS_INTERVALS_SUBTITLE = (32, 73)
    STATISTICS_INTERVALS_TITLE = (32, 74)
    STATISTICS_MINUTES_PER_DAY = (32, 75)
    STATISTICS_NO_DATA = (32, 76)
    STATISTICS_RANGE_1_YEAR_HISTORY = (32, 77)
    STATISTICS_RANGE_ALL_HISTORY = (32, 78)
    STATISTICS_RANGE_ALL_TIME = (32, 79)
    STATISTICS_RANGE_COLLECTION = (32, 80)
    STATISTICS_RANGE_DECK = (32, 81)
    STATISTICS_RANGE_SEARCH = (32, 82)
    STATISTICS_RETRIEVABILITY_SUBTITLE = (32, 83)
    STATISTICS_RETRIEVABILITY_TOOLTIP = (32, 84)
    STATISTICS_REVIEWS = (32, 85)
    STATISTICS_REVIEWS_COUNT_SUBTITLE = (32, 86)
    STATISTICS_REVIEWS_PER_DAY = (32, 87)
    STATISTICS_REVIEWS_TIME_CHECKBOX = (32, 88)
    STATISTICS_REVIEWS_TIME_SUBTITLE = (32, 89)
    STATISTICS_REVIEWS_TITLE = (32, 90)
    STATISTICS_RUNNING_TOTAL = (32, 91)
    STATISTICS_SAVE_PDF = (32, 92)
    STATISTICS_SAVED = (32, 93)
    STATISTICS_STATS = (32, 94)
    STATISTICS_STUDIED_TODAY = (32, 95)
    STATISTICS_TITLE = (32, 96)
    STATISTICS_TODAY_AGAIN_COUNT = (32, 97)
    STATISTICS_TODAY_CORRECT_MATURE = (32, 98)
    STATISTICS_TODAY_NO_CARDS = (32, 99)
    STATISTICS_TODAY_NO_MATURE_CARDS = (32, 100)
    STATISTICS_TODAY_TITLE = (32, 101)
    STATISTICS_TODAY_TYPE_COUNTS = (32, 102)
    STATISTICS_TOTAL = (32, 103)
    STUDYING_AGAIN = (33, 0)
    STUDYING_ALL_BURIED_CARDS = (33, 1)
    STUDYING_AUDIO_5S = (33, 2)
    STUDYING_AUDIO_AND5S = (33, 3)
    STUDYING_BURIED_SIBLINGS = (33, 4)
    STUDYING_BURY = (33, 5)
    STUDYING_BURY_CARD = (33, 6)
    STUDYING_BURY_NOTE = (33, 7)
    STUDYING_CARD_STUDIED_IN = (33, 8)
    STUDYING_CARD_SUSPENDED = (33, 9)
    STUDYING_CARD_WAS_A_LEECH = (33, 10)
    STUDYING_CARDS_BURIED = (33, 11)
    STUDYING_CARDS_WILL_BE_AUTOMATICALLY_RETURNED_TO = (33, 12)
    STUDYING_CONTINUE = (33, 13)
    STUDYING_COUNTS_DIFFER = (33, 14)
    STUDYING_DELETE_NOTE = (33, 15)
    STUDYING_DELETING_THIS_DECK_FROM_THE_DECK = (33, 16)
    STUDYING_EASY = (33, 17)
    STUDYING_EDIT = (33, 18)
    STUDYING_EMPTY = (33, 19)
    STUDYING_FINISH = (33, 20)
    STUDYING_FLAG_CARD = (33, 21)
    STUDYING_GOOD = (33, 22)
    STUDYING_HARD = (33, 23)
    STUDYING_IT_HAS_BEEN_SUSPENDED = (33, 24)
    STUDYING_MANUALLY_BURIED_CARDS = (33, 25)
    STUDYING_MARK_NOTE = (33, 26)
    STUDYING_MINUTE = (33, 27)
    STUDYING_MORE = (33, 28)
    STUDYING_NO_CARDS_ARE_DUE_YET = (33, 29)
    STUDYING_NOTE_SUSPENDED = (33, 30)
    STUDYING_PAUSE_AUDIO = (33, 31)
    STUDYING_PLEASE_RUN_TOOLSEMPTY_CARDS = (33, 32)
    STUDYING_RECORD_OWN_VOICE = (33, 33)
    STUDYING_REPLAY_OWN_VOICE = (33, 34)
    STUDYING_SHOW_ANSWER = (33, 35)
    STUDYING_SPACE = (33, 36)
    STUDYING_STUDY_NOW = (33, 37)
    STUDYING_SUSPEND = (33, 38)
    STUDYING_SUSPEND_NOTE = (33, 39)
    STUDYING_THIS_IS_A_SPECIAL_DECK_FOR = (33, 40)
    STUDYING_TO_REVIEW = (33, 41)
    STUDYING_TYPE_ANSWER_UNKNOWN_FIELD = (33, 42)
    STUDYING_UNBURY = (33, 43)
    STUDYING_WHAT_WOULD_YOU_LIKE_TO_UNBURY = (33, 44)
    STUDYING_YOU_HAVENT_RECORDED_YOUR_VOICE_YET = (33, 45)
    ...
    SYNC_CONFLICT = (34, 10)
    SYNC_CONFLICT_EXPLANATION = (34, 11)
    SYNC_CONNECTING = (34, 12)
    SYNC_DOWNLOAD_FROM_ANKIWEB = (34, 13)
    SYNC_DOWNLOADING_FROM_ANKIWEB = (34, 14)
    SYNC_LOG_OUT_BUTTON = (34, 15)
    SYNC_MEDIA_ABORTED = (34, 16)
    SYNC_MEDIA_ABORTING = (34, 17)
    SYNC_MEDIA_ADDED_COUNT = (34, 18)
    SYNC_MEDIA_CHECKED_COUNT = (34, 19)
    SYNC_MEDIA_COMPLETE = (34, 20)
    SYNC_MEDIA_DISABLED = (34, 21)
    SYNC_MEDIA_FAILED = (34, 22)
    SYNC_MEDIA_LOG_BUTTON = (34, 23)
    SYNC_MEDIA_LOG_TITLE = (34, 24)
    SYNC_MEDIA_REMOVED_COUNT = (34, 25)
    SYNC_MEDIA_STARTING = (34, 26)
    SYNC_MUST_WAIT_FOR_END = (34, 27)
    SYNC_PASSWORD_LABEL = (34, 28)
    SYNC_RESYNC_REQUIRED = (34, 29)
    SYNC_SANITY_CHECK_FAILED = (34, 30)
    SYNC_SERVER_ERROR = (34, 31)
    SYNC_SYNCING = (34, 32)
    SYNC_UPLOAD_TO_ANKIWEB = (34, 33)
    SYNC_UPLOAD_TOO_LARGE = (34, 34)
    SYNC_UPLOADING_TO_ANKIWEB = (34, 35)
    SYNC_WRONG_PASS = (34, 36)
