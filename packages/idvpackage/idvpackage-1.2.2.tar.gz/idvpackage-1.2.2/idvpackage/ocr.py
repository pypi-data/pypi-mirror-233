...
class IdentityVerification:
    ...
    def check_document_quality(self, data, brightness_threshold=230, blur_threshold=3500, video_duration_threshold=5):
        ...
        if input_type == 'base_64':
            ...
            try:
                ...
                if video_capture.isOpened():
                    ...
                    if duration < video_duration_threshold:  # Assuming a threshold of 5 seconds
            ...
            if is_colored2:
                try:
                    ...
                    if identify_back_id(text):
                        ...
                        try:
                            mrz = re.findall(mrz_pattern, original_text, re.MULTILINE)
                        ...
                        mrz3_keys = ['name', 'first_name', 'last_name']
