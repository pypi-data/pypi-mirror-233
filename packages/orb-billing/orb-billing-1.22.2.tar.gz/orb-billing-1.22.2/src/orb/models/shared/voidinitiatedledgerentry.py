...
class VoidInitiatedLedgerEntryAmount:
    pass



@dataclasses.dataclass
class VoidInitiatedLedgerEntryEndingBalance:
    pass

class VoidInitiatedLedgerEntryEntryStatus(str, Enum):
    COMMITTED = 'committed'
    PENDING = 'pending'
...
@dataclasses.dataclass
class VoidInitiatedLedgerEntryStartingBalance:
    pass



@dataclasses.dataclass
class VoidInitiatedLedgerEntryVoidAmount:
    pass
...
class VoidInitiatedLedgerEntry:
    ...
    entry_status: VoidInitiatedLedgerEntryEntryStatus = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('entry_status') }})
    ...
    new_block_expiry_date: datetime = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('new_block_expiry_date'), 'encoder': utils.datetimeisoformat(False), 'decoder': dateutil.parser.isoparse }})
    ...
    ENTRY_TYPE: Final[str] = dataclasses.field(default='void_initiated', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('entry_type') }})
