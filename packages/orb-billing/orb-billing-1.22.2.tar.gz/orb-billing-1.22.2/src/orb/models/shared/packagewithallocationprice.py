...
class PackageWithAllocationPriceCadence(str, Enum):
    ONE_TIME = 'one_time'
    MONTHLY = 'monthly'
    QUARTERLY = 'quarterly'
    ANNUAL = 'annual'
...
class PackageWithAllocationPriceDiscount:
    pass

class PackageWithAllocationPricePriceType(str, Enum):
...
class PackageWithAllocationPrice:
    ...
    cadence: PackageWithAllocationPriceCadence = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cadence') }})
    ...
    price_type: PackageWithAllocationPricePriceType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('price_type') }})
    MODEL_TYPE: Final[str] = dataclasses.field(default='package_with_allocation', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
