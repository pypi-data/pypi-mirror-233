...
class NewPackageWithAllocationPriceCadence(str, Enum):
...
class NewPackageWithAllocationPriceFixedPriceQuantity:
    pass
...
@dataclasses.dataclass
class NewPackageWithAllocationPrice:
    cadence: NewPackageWithAllocationPriceCadence = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cadence') }})
    r"""The cadence to bill for this price on."""
