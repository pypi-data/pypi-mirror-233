...
class DecrementLedgerEntryAmount:
    pass



@dataclasses.dataclass
class DecrementLedgerEntryEndingBalance:
    pass

class DecrementLedgerEntryEntryStatus(str, Enum):
    COMMITTED = 'committed'
    PENDING = 'pending'
...
@dataclasses.dataclass
class DecrementLedgerEntryStartingBalance:
    pass
...
class DecrementLedgerEntry:
    ...
    entry_status: DecrementLedgerEntryEntryStatus = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('entry_status') }})
    ...
    event_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('event_id') }})
    invoice_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('invoice_id') }})
