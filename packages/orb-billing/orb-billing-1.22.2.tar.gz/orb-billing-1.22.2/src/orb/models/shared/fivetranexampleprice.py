...
class FivetranExamplePriceCadence(str, Enum):
    ONE_TIME = 'one_time'
    MONTHLY = 'monthly'
    QUARTERLY = 'quarterly'
    ANNUAL = 'annual'
...
class FivetranExamplePriceDiscount:
    pass

class FivetranExamplePricePriceType(str, Enum):
...
class FivetranExamplePrice:
    ...
    cadence: FivetranExamplePriceCadence = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cadence') }})
    ...
    fivetran_example_config: dict[str, Any] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fivetran_example_config') }})
    ...
    price_type: FivetranExamplePricePriceType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('price_type') }})
    MODEL_TYPE: Final[str] = dataclasses.field(default='fivetran_example', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
