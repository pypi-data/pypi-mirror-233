...
class TieredPackagePriceCadence(str, Enum):
    ONE_TIME = 'one_time'
    MONTHLY = 'monthly'
    QUARTERLY = 'quarterly'
    ANNUAL = 'annual'
...
class TieredPackagePriceDiscount:
    pass

class TieredPackagePricePriceType(str, Enum):
...
class TieredPackagePrice:
    ...
    cadence: TieredPackagePriceCadence = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cadence') }})
    ...
    price_type: TieredPackagePricePriceType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('price_type') }})
    tiered_package_config: dict[str, Any] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tiered_package_config') }})
    MODEL_TYPE: Final[str] = dataclasses.field(default='tiered_package', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
