...
class MatrixPriceCadence(str, Enum):
    ONE_TIME = 'one_time'
    MONTHLY = 'monthly'
    QUARTERLY = 'quarterly'
    ANNUAL = 'annual'
...
class MatrixPriceDiscount:
    pass

class MatrixPricePriceType(str, Enum):
...
class MatrixPrice:
    ...
    cadence: MatrixPriceCadence = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cadence') }})
    ...
    price_type: MatrixPricePriceType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('price_type') }})
    MODEL_TYPE: Final[str] = dataclasses.field(default='matrix', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
