...
class NewMatrixPriceCadence(str, Enum):
...
class NewMatrixPriceFixedPriceQuantity:
    pass
...
@dataclasses.dataclass
class NewMatrixPrice:
    cadence: NewMatrixPriceCadence = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cadence') }})
    r"""The cadence to bill for this price on."""
