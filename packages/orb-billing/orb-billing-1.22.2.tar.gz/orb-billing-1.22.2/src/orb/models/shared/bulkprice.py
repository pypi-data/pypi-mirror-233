...
class BulkPriceCadence(str, Enum):
    ONE_TIME = 'one_time'
    MONTHLY = 'monthly'
    QUARTERLY = 'quarterly'
    ANNUAL = 'annual'
...
class BulkPricePriceType(str, Enum):
...
class BulkPrice:
    ...
    cadence: BulkPriceCadence = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cadence') }})
    ...
    price_type: BulkPricePriceType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('price_type') }})
    MODEL_TYPE: Final[str] = dataclasses.field(default='bulk', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
