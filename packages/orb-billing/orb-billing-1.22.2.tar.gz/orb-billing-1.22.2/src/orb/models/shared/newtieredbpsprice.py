...
class NewTieredBpsPriceCadence(str, Enum):
...
class NewTieredBpsPriceFixedPriceQuantity:
    pass
...
class NewTieredBpsPrice:
    cadence: NewTieredBpsPriceCadence = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cadence') }})
    r"""The cadence to bill for this price on."""
