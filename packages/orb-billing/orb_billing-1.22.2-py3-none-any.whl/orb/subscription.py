...
class Subscription:
    ...
    def cancel(self, subscription_id: str, cancel_subscription_params: Optional[shared.CancelSubscriptionParams] = None) -> operations.CancelSubscriptionResponse:
        ...
        request = operations.CancelSubscriptionRequest(
            ...
            cancel_subscription_params=cancel_subscription_params,
        )
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "cancel_subscription_params", False, True, 'json')
    ...
    def fetch_schedule(self, request: operations.FetchSubscriptionScheduleRequest) -> operations.FetchSubscriptionScheduleResponse:
        r"""Fetch subscription schedule
        ...
        headers = {}
        query_params = utils.get_query_params(operations.FetchSubscriptionScheduleRequest, request)
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.SubscriptionScheduleItems])
                res.subscription_schedule_items = out
            else:
                raise errors.SDKError(f'unknown content-type received: {content_type}', http_res.status_code, http_res.text, http_res)
        elif http_res.status_code == 400:
            if utils.match_content_type(content_type, 'application/json'):
    ...
    def fetch_usage(self, request: operations.FetchSubscriptionUsageRequest) -> operations.FetchSubscriptionUsageResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Union[shared.UngroupedSubscriptionUsage, shared.GroupedSubscriptionUsage]])
    ...
    def schedule_plan_change(self, subscription_id: str, subscription_plan_change: Optional[shared.SubscriptionPlanChange] = None) -> operations.SchedulePlanChangeResponse:
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "subscription_plan_change", False, True, 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
    ...
    def trigger_phase(self, subscription_id: str, trigger_subscription_phase_params: Optional[shared.TriggerSubscriptionPhaseParams] = None) -> operations.TriggerPhaseResponse:
        r"""Trigger phase
        Manually trigger a phase, effective the given date (or the current time, if not specified).
        """
        request = operations.TriggerPhaseRequest(
            subscription_id=subscription_id,
            trigger_subscription_phase_params=trigger_subscription_phase_params,
        )
        
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        
        url = utils.generate_url(operations.TriggerPhaseRequest, base_url, '/subscriptions/{subscription_id}/trigger_phase', request)
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "trigger_subscription_phase_params", False, True, 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        ...
        res = operations.TriggerPhaseResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def unschedule_cancellation(self, subscription_id: str) -> operations.UnscheduleCancellationResponse:
        r"""Unschedule subscription cancellation
    ...
    def unschedule_fixed_fee_quantity(self, subscription_id: str, unschedule_fixed_fee_quantity_change_params: Optional[shared.UnscheduleFixedFeeQuantityChangeParams] = None) -> operations.UnscheduleFixedFeeQuantityResponse:
        r"""Unschedule fixed fee quantity updates
        ...
        """
        request = operations.UnscheduleFixedFeeQuantityRequest(
            subscription_id=subscription_id,
            unschedule_fixed_fee_quantity_change_params=unschedule_fixed_fee_quantity_change_params,
        )
        
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        
        url = utils.generate_url(operations.UnscheduleFixedFeeQuantityRequest, base_url, '/subscriptions/{subscription_id}/unschedule_fixed_fee_quantity_updates', request)
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "unschedule_fixed_fee_quantity_change_params", False, True, 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        ...
        res = operations.UnscheduleFixedFeeQuantityResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_fixed_fee_quantity(self, subscription_id: str, fixed_fee_quantity_change: Optional[shared.FixedFeeQuantityChange] = None) -> operations.UpdateFixedFeeQuantityResponse:
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "fixed_fee_quantity_change", False, True, 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
