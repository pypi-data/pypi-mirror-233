...
class Event:
    ...
    def amend(self, event_id: str, amended_event: Optional[shared.AmendedEvent] = None) -> operations.AmendEventResponse:
        ...
        * The event's `timestamp` must fall within the customer's current subscription's billing period, or within the
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "amended_event", False, True, 'json')
    ...
    def fetch(self, backfill_id: str) -> operations.FetchBackfillResponse:
        r"""Fetch backfill
        This endpoint is used to fetch a backfill given an identifier.
        """
        request = operations.FetchBackfillRequest(
            backfill_id=backfill_id,
        )
        
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        
        url = utils.generate_url(operations.FetchBackfillRequest, base_url, '/events/backfills/{backfill_id}', request)
        headers = {}
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        ...
        res = operations.FetchBackfillResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def ingest(self, ingest_request_body: Optional[shared.IngestRequestBody] = None, backfill_id: Optional[str] = None, debug: Optional[bool] = None) -> operations.IngestResponse:
        r"""Ingest events
        ...
        request = operations.IngestRequest(
            ingest_request_body=ingest_request_body,
            backfill_id=backfill_id,
            debug=debug,
        )
        ...
        url = base_url + '/ingest'
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "ingest_request_body", False, True, 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
    ...
    def list_backfills(self, cursor: Optional[str] = None, limit: Optional[int] = None) -> operations.ListBackfillsResponse:
        r"""List backfills
        ...
        """
        request = operations.ListBackfillsRequest(
            cursor=cursor,
            limit=limit,
        )
        ...
        url = base_url + '/events/backfills'
        headers = {}
        query_params = utils.get_query_params(operations.ListBackfillsRequest, request)
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
    ...
    def search(self, request: operations.SearchEventsRequest) -> operations.SearchEventsResponse:
        r"""Search events
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "event_search_criteria", False, True, 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.SearchEventsRequest, request)
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
