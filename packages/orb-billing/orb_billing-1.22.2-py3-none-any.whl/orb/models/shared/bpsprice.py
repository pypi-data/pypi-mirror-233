...
class BpsPriceCadence(str, Enum):
    ONE_TIME = 'one_time'
    MONTHLY = 'monthly'
    QUARTERLY = 'quarterly'
    ANNUAL = 'annual'
...
class BpsPriceDiscount:
    pass

class BpsPricePriceType(str, Enum):
...
class BpsPrice:
    ...
    cadence: BpsPriceCadence = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cadence') }})
    ...
    price_type: BpsPricePriceType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('price_type') }})
    MODEL_TYPE: Final[str] = dataclasses.field(default='bps', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
