...
class NewTieredPackagePriceCadence(str, Enum):
...
class NewTieredPackagePriceFixedPriceQuantity:
    pass
...
@dataclasses.dataclass
class NewTieredPackagePrice:
    cadence: NewTieredPackagePriceCadence = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cadence') }})
    r"""The cadence to bill for this price on."""
