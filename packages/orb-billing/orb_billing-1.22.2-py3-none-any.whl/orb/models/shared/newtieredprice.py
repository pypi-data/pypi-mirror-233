...
class NewTieredPriceCadence(str, Enum):
...
class NewTieredPriceFixedPriceQuantity:
    pass
...
@dataclasses.dataclass
class NewTieredPrice:
    cadence: NewTieredPriceCadence = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cadence') }})
    r"""The cadence to bill for this price on."""
