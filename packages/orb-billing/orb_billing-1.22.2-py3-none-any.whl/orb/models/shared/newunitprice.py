...
class NewUnitPriceCadence(str, Enum):
...
class NewUnitPriceFixedPriceQuantity:
    pass
...
@dataclasses.dataclass
class NewUnitPrice:
    cadence: NewUnitPriceCadence = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cadence') }})
    r"""The cadence to bill for this price on."""
