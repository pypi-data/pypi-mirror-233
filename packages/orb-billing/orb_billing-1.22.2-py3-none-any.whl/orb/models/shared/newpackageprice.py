...
class NewPackagePriceCadence(str, Enum):
...
class NewPackagePriceFixedPriceQuantity:
    pass
...
@dataclasses.dataclass
class NewPackagePrice:
    cadence: NewPackagePriceCadence = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cadence') }})
    r"""The cadence to bill for this price on."""
