...
class TieredWithMinimumPriceCadence(str, Enum):
    ONE_TIME = 'one_time'
    MONTHLY = 'monthly'
    QUARTERLY = 'quarterly'
    ANNUAL = 'annual'
...
class TieredWithMinimumPriceDiscount:
    pass

class TieredWithMinimumPricePriceType(str, Enum):
...
class TieredWithMinimumPrice:
    ...
    cadence: TieredWithMinimumPriceCadence = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cadence') }})
    ...
    price_type: TieredWithMinimumPricePriceType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('price_type') }})
    ...
    MODEL_TYPE: Final[str] = dataclasses.field(default='tiered_with_minimum', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
