...
class TieredBpsPriceCadence(str, Enum):
    ONE_TIME = 'one_time'
    MONTHLY = 'monthly'
    QUARTERLY = 'quarterly'
    ANNUAL = 'annual'
...
class TieredBpsPriceDiscount:
    pass

class TieredBpsPricePriceType(str, Enum):
...
class TieredBpsPrice:
    ...
    cadence: TieredBpsPriceCadence = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cadence') }})
    ...
    price_type: TieredBpsPricePriceType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('price_type') }})
