...
class ThresholdTotalAmountPriceCadence(str, Enum):
    ONE_TIME = 'one_time'
    MONTHLY = 'monthly'
    QUARTERLY = 'quarterly'
    ANNUAL = 'annual'
...
class ThresholdTotalAmountPriceDiscount:
    pass

class ThresholdTotalAmountPricePriceType(str, Enum):
...
class ThresholdTotalAmountPrice:
    ...
    cadence: ThresholdTotalAmountPriceCadence = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cadence') }})
    ...
    price_type: ThresholdTotalAmountPricePriceType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('price_type') }})
    ...
    MODEL_TYPE: Final[str] = dataclasses.field(default='threshold_total_amount', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
