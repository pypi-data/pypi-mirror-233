...
class NewBulkBpsPriceCadence(str, Enum):
...
class NewBulkBpsPriceFixedPriceQuantity:
    pass
...
class NewBulkBpsPrice:
    ...
    cadence: NewBulkBpsPriceCadence = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cadence') }})
    r"""The cadence to bill for this price on."""
