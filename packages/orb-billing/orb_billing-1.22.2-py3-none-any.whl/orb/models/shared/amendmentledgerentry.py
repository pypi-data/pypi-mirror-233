...
class AmendmentLedgerEntryAmount:
    pass



@dataclasses.dataclass
class AmendmentLedgerEntryEndingBalance:
    pass

class AmendmentLedgerEntryEntryStatus(str, Enum):
    COMMITTED = 'committed'
    PENDING = 'pending'
...
@dataclasses.dataclass
class AmendmentLedgerEntryStartingBalance:
    pass
...
class AmendmentLedgerEntry:
    ...
    entry_status: AmendmentLedgerEntryEntryStatus = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('entry_status') }})
    ...
    ENTRY_TYPE: Final[str] = dataclasses.field(default='amendment', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('entry_type') }})
