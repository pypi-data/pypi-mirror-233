...
class ExpirationChangeLedgerEntryAmount:
    pass



@dataclasses.dataclass
class ExpirationChangeLedgerEntryEndingBalance:
    pass

class ExpirationChangeLedgerEntryEntryStatus(str, Enum):
    COMMITTED = 'committed'
    PENDING = 'pending'
...
@dataclasses.dataclass
class ExpirationChangeLedgerEntryStartingBalance:
    pass
...
class ExpirationChangeLedgerEntry:
    ...
    entry_status: ExpirationChangeLedgerEntryEntryStatus = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('entry_status') }})
    ...
    ENTRY_TYPE: Final[str] = dataclasses.field(default='expiration_change', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('entry_type') }})
