...
class NewBpsPriceCadence(str, Enum):
...
class NewBpsPriceFixedPriceQuantity:
    pass
...
class NewBpsPrice:
    ...
    cadence: NewBpsPriceCadence = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cadence') }})
    r"""The cadence to bill for this price on."""
