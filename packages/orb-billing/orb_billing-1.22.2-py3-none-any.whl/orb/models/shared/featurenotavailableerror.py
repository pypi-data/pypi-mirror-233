...
class FeatureNotAvailableError:
    ...
    TYPE: Final[str] = dataclasses.field(default='https://docs.withorb.com/reference/error-responses#404-feature-not-available', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
