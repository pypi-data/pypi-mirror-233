...
from ..shared import triggersubscriptionphaseparams as shared_triggersubscriptionphaseparams
...
class TriggerPhaseRequest:
    subscription_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'subscription_id', 'style': 'simple', 'explode': False }})
    trigger_subscription_phase_params: Optional[shared_triggersubscriptionphaseparams.TriggerSubscriptionPhaseParams] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
@dataclasses.dataclass
class TriggerPhaseResponse:
    content_type: str = dataclasses.field()
    r"""HTTP response content type for this operation"""
    status_code: int = dataclasses.field()
    r"""HTTP response status code for this operation"""
    four_hundred_error: Optional[Union[shared_requestvalidationerror.RequestValidationError, shared_duplicateresourcecreationerror.DuplicateResourceCreationError, shared_duplicateconstraintviolationerror.DuplicateConstraintViolationError]] = dataclasses.field(default=None)
    r"""Bad Request"""
    ...
    r"""Unauthorized"""
    four_hundred_and_four_error: Optional[Union[shared_resourcenotfounderror.ResourceNotFoundError, shared_featurenotavailableerror.FeatureNotAvailableError, shared_urlnotfound.URLNotFound]] = dataclasses.field(default=None)
    r"""Not Found"""
    four_hundred_and_nine_error: Optional[Union[shared_idempotencyconflict.IdempotencyConflict, shared_idempotencyrequestmismatch.IdempotencyRequestMismatch, shared_idempotencykeyvalidationerror.IdempotencyKeyValidationError]] = dataclasses.field(default=None)
    r"""Conflict"""
