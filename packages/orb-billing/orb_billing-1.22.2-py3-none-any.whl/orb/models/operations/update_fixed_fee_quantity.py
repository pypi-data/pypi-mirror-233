...
from ..shared import fixedfeequantitychange as shared_fixedfeequantitychange
...
class UpdateFixedFeeQuantityRequest:
    ...
    fixed_fee_quantity_change: Optional[shared_fixedfeequantitychange.FixedFeeQuantityChange] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
