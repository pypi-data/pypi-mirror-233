...
class BusinessContext:
    def __init__(self,spark,api_type,api_key,api_base,api_version,deployment_model,model_name):
    ...
    def business_contextFN(self,df):
        ...
        business_context = self.spark.createDataFrame([Row(result=business_context)])
