...
class Standarization:
    def __init__(self,spark,columns,df,api_type,api_key,api_base,api_version,deployment_model,model_name):
        self.spark=spark
    ...
    def initiate_langchainFN(self):
            ...
            os.environ["OPENAI_API_KEY"] = self.api_type
    ...
    def format_issue_detection(self):
        ...
        result_df = self.spark.createDataFrame(final_df)
