...
class DataQuality:
    ...
    def main(self):
        ...
        if self.choice['Standardization']==1:
            result=Standardization(spark,self.standarization_columns,df_pandas,self.api_key,self.api_base,self.api_version,self.deployment_model,self.model_name).format_issue_detection()
