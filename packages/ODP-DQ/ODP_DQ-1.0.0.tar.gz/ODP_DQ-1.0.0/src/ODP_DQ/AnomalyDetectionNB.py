...
class AnomalyDetection:
    def __init__(self,inputfile, outputfile, column_types, columns_and_contamination,
                 columns_and_null_handling, columns_and_dbscan_params):
    ...
    def run_anomaly_detection(self,df):
        ...
        output_df.write.csv(outputfile, header=True, mode="overwrite")

        # output_data.to_csv(self.outputfile, index=False)
        return output_data