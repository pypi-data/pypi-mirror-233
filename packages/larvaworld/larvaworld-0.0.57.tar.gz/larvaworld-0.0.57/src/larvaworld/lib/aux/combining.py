...
def combine_images(files=None, file_dir='.', save_as='combined_image.pdf', save_to=None, size=(1000, 1000),
                   figsize=None):
    """
...
def combine_videos_4to1(files=None, file_dir='.', save_to=None, save_as='combined_videos.mp4'):
    """
...
def combine_pdfs(files=None, file_dir='.', pref='', save_to=None, save_as="final.pdf", include_subdirs=True):
    """
    ...
    if files is None:
        files = files_in_dir(file_dir, include_subdirs=include_subdirs, pref=pref, suf='.pdf')
    import pypdf
