...
class ConfigurationFileProvider(CredentialProvider):
    ...
    Methods:
        get_credentials(db_type): Retrieves credentials for the specified database type from the loaded data.
    ...
    def get_credentials(self, db_type: str, db: str) -> dict:
        """
        ...
        """
        return self.credentials[db_type][db]