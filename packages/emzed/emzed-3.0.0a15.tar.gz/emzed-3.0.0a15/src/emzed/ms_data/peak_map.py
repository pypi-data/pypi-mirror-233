...
from emzed.utils.sqlite import Connection, copy_table, table_exists
...
Chromatogram = namedtuple("Chromatogram", ["rts", "intensities"])
...
class ImmutablePeakMap(DbBackedModel):
    ...
    def extract(
        ...
        *,
        ...
        # an DISTINCT in the previous SQL statement is to slow.
