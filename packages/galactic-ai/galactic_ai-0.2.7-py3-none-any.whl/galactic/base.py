...
from typing import TypeVar, Optional, Union, Dict, List, Callable, Literal, Sequence, Any
import pandas as pd
import numpy as np
import datasets
from .utils import (
...
class GalacticDatasetBase(ABC):
    ...
    @abstractclassmethod
    def from_hugging_face(cls: T, path: str, split: str, config_name: Optional[str] = None, **kwargs) -> T:
        pass
    
    @abstractclassmethod
    def from_hugging_face_stream(cls: T, path: str, split: str, config_name: Optional[str] = None, **kwargs) -> T:
        pass
