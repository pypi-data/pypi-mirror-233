...
HELP_CONTENT_PATH = os.path.realpath(os.path.join(os.getcwd(), os.path.dirname(__file__), 'help_content'))
VERSION_FILE_PATH = os.path.realpath(os.path.join(os.getcwd(), os.path.dirname(__file__), '.version'))
