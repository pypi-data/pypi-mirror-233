...
def run() -> None:
    ...
    trialCount: int | None = Options.trial_count
    ...
    for elem in buttons:
        ...
        buttonSize: int = (
            10 + (elemWidth >= 10)
            if Options.button_size is None
            else Options.button_size
        )
        ...
        lastElem.append(
            sg.Submit(
                **commonButtonArgs,
                ...
                pad=(
                    (Options.button_margin, Options.button_margin),
                    (0, Options.button_margin * 2),
                ),
            )
        )
        ...
        [
            sg.Submit(
                **commonButtonArgs,
                ...
                pad=(
                    (Options.button_margin, Options.button_margin),
                    (Options.button_margin, Options.button_margin * 2),
                ),
            )
    ...
    layout: list[list] = [
        [
            sg.Text(
                text=Options.title, font=(Options.font_family, Options.title_font_size)
            ),
            sg.Frame(
                **commonFrameArgs,
        ...
        [
            sg.Frame(
                **commonFrameArgs,
                ...
                layout=[
                    [
                        sg.Text(text=Options.text_top, pad=(0, 5)),
                    ]
                ],
                expand_x=True,
            ),
        ...
        [
            sg.Text(text=Options.text_left),
            sg.Frame(
                **commonFrameArgs,
            ...
            sg.Text(text=Options.text_right),
        ],
        [
            sg.Frame(
                **commonFrameArgs,
                ...
                layout=[
                    [
                        sg.Text(text=Options.text_bottom, pad=(0, 5)),
                    ]
                ],
                expand_x=True,
            ),
    ...
    while True:
        ...
        # when the stop button is pressed
            ...
            if Options.trial_count_increment:
                if trialCount is None:
                    trialCount = 0

                record["meta"] |= {"COUNT": [trialCount]}
                trialCount += 1

            elif Options.trial_count is not None:
    ...
    layout: list[list] = [
        ...
        [
            sg.Slider(
                ...
                pad=(Options.button_margin, Options.button_margin),
                key=" score_slider ",
            )
        ],
        [sg.Text()],
