...
@click.option('--git', is_flag=True, default=False, help="Init workspace with git releases. Generates CI/CD files for yout git provider")
@click.option('--override-commit', default=None, help="Pass commit in case want to override git commit reference")
@click.pass_context
@coro
async def init(
    ctx: Context,
