...
class TestCase:
    ...
    def __init__(self, name: str, sql: str, max_time: Optional[float] = None, max_bytes_read: Optional[int] = None, pipe: Optional[Dict[str, Any]] = None):
        self.name = name
        self.sql = sql
    ...
    def __iter__(self):
        yield (self.name, {'sql': self.sql, 'max_time': self.max_time, 'max_bytes_read': self.max_bytes_read, 'pipe': self.pipe})
