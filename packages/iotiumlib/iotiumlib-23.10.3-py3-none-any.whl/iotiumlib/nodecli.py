...
class nodecli(object):
    def __init__(self, action, payload=None, filters=None, node_id=None, command=None, cliId=None):
        ...
        self.uri = {
            set_nodecli: 'api/v1/node/{nodeId}/{Command}',
            unset_nodecli: 'api/v1/node/{nodeId}/{Command}',
            get_nodecli: 'api/v1/node/{nodeId}/{Command}',
            history_nodecli: 'api/v1/node/{nodeId}/{Command}/history/{cliId}'
        }
