...
def arrott_plotting(g_name, n, one_M_plot_final, one_H_by_M_con):
    ...
    if (g_name== 'arrott_plots' or g_name== 'all_plots'):
        ...
        plt.xlabel("(H/M)^(1/γ)", fontname="monospace")
        plt.ylabel("M^(1/β)", fontname="monospace")
        plt.title("Arrott plot 01 (β:0.5; γ:1)", fontname="monospace")
        ...
        plt.xlabel("(H/M)^(1/γ)", fontname="monospace")
        plt.ylabel("M^(1/β)", fontname="monospace")
        plt.title("Arrott plot 02 (β:0.25; γ:1)", fontname="monospace")
        ...
        plt.xlabel("(H/M)^(1/γ)", fontname="monospace")
        plt.ylabel("M^(1/β)", fontname="monospace")
        plt.title("Arrott plot 03 (β:0.365; γ:1.336)", fontname="monospace")
        ...
        plt.xlabel("(H/M)^(1/γ)", fontname="monospace")
        plt.ylabel("M^(1/β)", fontname="monospace")
        plt.title("Arrott plot 04 (β:0.325; γ:1.24)", fontname="monospace")
