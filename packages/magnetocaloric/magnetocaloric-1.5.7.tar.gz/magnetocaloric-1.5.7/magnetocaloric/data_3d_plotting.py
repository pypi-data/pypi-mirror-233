...
def mce_3d(path, sheet_index, T_row, H_col, g_name, M_unit, H_unit, T_unit, dpi, save_data):
    ...
    if (g_name == 'MH_show'):        
        ...
        ax5.set_xlabel(f'T {T_unit}', fontname="monospace")
        ax5.set_ylabel(f'H {H_unit}', fontname="monospace")
        ax5.set_zlabel(f'dM/dT ({M_unit})/{T_unit}', fontname="monospace")
        ax5.set_title('dM/dT distribution', fontname="monospace")
        ...
        ax6.set_xlabel(f'T {T_unit}', fontname="monospace")
        ax6.set_ylabel(f'H {H_unit}', fontname="monospace")
        ax6.set_zlabel(f"$\\frac{{d^2M}}{{dT \\cdot dH}} ({M_unit}/{T_unit}.{H_unit})$", fontname="monospace")
        ax6.set_title('d2M/(dT.dH) distribution', fontname="monospace")
