...
class RFOutput:
    ...
    def _set_gain(self, crb, gain: float, frequency: float, use_iq_attenuators: bool):
        ...
        if total_attn < 20:
            ...
            crb.up[self._index].mixer_output_attn = 20
            crb.up[self._index].power_amp_attn = total_attn - 20
...
class Octave:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._host = host
        self._port = port
        self._client = octave_client or OctaveClient(host, port, octave_name)
    ...
    def set_clock(
        ...
        if clock_type == ClockType.Buffered or (
            ...
            if frequency is None:
                ...
                raise ValueError(
                    "Error, buffered clock frequency must be 1000 MHz, please use External for",
            ...
            if frequency is not None:
                print(
                    "Warning, ignoring",
                    frequency.name,
                    "clock setting and using internal 10MHz clock",
                )
