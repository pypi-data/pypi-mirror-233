...
class Module:
    ...
    def add_command(self, method) -> None:
        prefix = method.__command__['prefix'] 
        alliases = method.__command__['alliases']
        
        @self.bot.listener.on_command(prefix=prefix, alliases=alliases)
