...
if __name__ == '__main__':
    ...
    ssosession = tsgauth.oidcauth.KerbAuthSession()
    ...
    try:
        data = ssosession.session.get(base_view_url+args.twiki)
    ...
    with io.open(args.input,mode="r",encoding="utf-8") as f:
        ...
        r = ssosession.session.post(base_save_url+args.twiki,data={"text" : text.encode('iso-8859-1','replace')})
