...
if __name__ == "__main__":
    ...
    parser.add_argument("--redirect-url",dest="redirect_url",default="http://localhost:8080")    
    ...
    auth = oidcauth.KerbAuth(args.client_id,args.redirect_url,args.target_client_id)
