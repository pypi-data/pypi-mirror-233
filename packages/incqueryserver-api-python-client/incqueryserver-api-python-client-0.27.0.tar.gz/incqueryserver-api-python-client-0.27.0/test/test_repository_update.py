...
import iqs_client
from iqs_client.models.repository_update import RepositoryUpdate  # noqa: E501
...
class TestRepositoryUpdate(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = iqs_client.models.repository_update.RepositoryUpdate()  # noqa: E501
        if include_optional :
            return RepositoryUpdate(
                return_list_of_new_compartments = True
            )
        else :
            return RepositoryUpdate(
        )
