...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of model_analyzer_client.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = model_analyzer_client.Configuration(
    ...
    Note you can use the constants defined in the model_analyzer_client.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = model_analyzer_client.Configuration(
        signing_info = model_analyzer_client.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="http://localhost/api",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("model_analyzer_client")
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: placeHolderApiVersion\n"\
