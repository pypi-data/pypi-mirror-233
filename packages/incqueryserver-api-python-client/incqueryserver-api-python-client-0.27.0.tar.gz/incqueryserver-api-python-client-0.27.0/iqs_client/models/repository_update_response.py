...
class RepositoryUpdateResponse(object):
    ...
    openapi_types = {
        ...
        'repository_update_errors': 'dict(str, list[str])'
    }
    ...
    attribute_map = {
        ...
        'repository_update_errors': 'repositoryUpdateErrors'
    }

    def __init__(self, repository_changed=None, number_of_new_compartments=None, new_model_compartments=None, repository_update_errors=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._repository_update_errors = None
        ...
        if repository_update_errors is not None:
            self.repository_update_errors = repository_update_errors
    ...
    def repository_changed(self, repository_changed):
        ...
        :type: bool
        """
        if self.local_vars_configuration.client_side_validation and repository_changed is None:  # noqa: E501
    ...
    @property
    def repository_update_errors(self):
        """Gets the repository_update_errors of this RepositoryUpdateResponse.  # noqa: E501


        :return: The repository_update_errors of this RepositoryUpdateResponse.  # noqa: E501
        :rtype: dict(str, list[str])
        """
        return self._repository_update_errors

    @repository_update_errors.setter
    def repository_update_errors(self, repository_update_errors):
        """Sets the repository_update_errors of this RepositoryUpdateResponse.


        :param repository_update_errors: The repository_update_errors of this RepositoryUpdateResponse.  # noqa: E501
        :type: dict(str, list[str])
        """

        self._repository_update_errors = repository_update_errors
