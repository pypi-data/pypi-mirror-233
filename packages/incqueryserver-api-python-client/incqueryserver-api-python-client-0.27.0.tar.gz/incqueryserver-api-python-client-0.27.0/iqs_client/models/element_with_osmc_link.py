...
class ElementWithOSMCLink(object):
    ...
    @property
    def name(self):
        """Gets the name of this ElementWithOSMCLink.  # noqa: E501


        :return: The name of this ElementWithOSMCLink.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ElementWithOSMCLink.


        :param name: The name of this ElementWithOSMCLink.  # noqa: E501
        :type: str
        """
