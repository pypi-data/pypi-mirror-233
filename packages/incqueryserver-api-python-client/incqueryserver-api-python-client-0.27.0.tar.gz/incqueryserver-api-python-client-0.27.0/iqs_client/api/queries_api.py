...
class QueriesApi(object):
    ...
    def get_query_details_with_http_info(self, query_fqn, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(QuerySpecificationResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('query_fqn' not in local_var_params or  # noqa: E501
                                                        local_var_params['query_fqn'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `query_fqn` when calling `get_query_details`")  # noqa: E501
        ...
        query_params = []
        if 'query_fqn' in local_var_params and local_var_params['query_fqn'] is not None:  # noqa: E501
    ...
    def register_queries_with_http_info(self, query_definition_request, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(QueryFQNList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('query_definition_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['query_definition_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `query_definition_request` when calling `register_queries`")  # noqa: E501
    ...
    def register_queries_from_model_compartment_with_http_info(self, model_compartment, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('model_compartment' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `model_compartment` when calling `register_queries_from_model_compartment`")  # noqa: E501
    ...
    def register_queries_plain_text(self, body, **kwargs):  # noqa: E501
        ...
        :param str query_package: Optional query package for organizing queries and controlling visibility.  The value must be a legal Java package name: * start with lowercase letter * contain only lowercase letters, digits ,dots ('.') and underscore (_) * cannot end with dot ('.') 
        ...
        :param str query_name: Optional query name parameter * contain only letters, digits 
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def register_queries_plain_text_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'query_package', 'query_language', 'query_name']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('body' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `body` when calling `register_queries_plain_text`")  # noqa: E501
        ...
        query_params = []
        if 'query_package' in local_var_params and local_var_params['query_package'] is not None:  # noqa: E501
            query_params.append(('queryPackage', local_var_params['query_package']))  # noqa: E501
        if 'query_language' in local_var_params and local_var_params['query_language'] is not None:  # noqa: E501
