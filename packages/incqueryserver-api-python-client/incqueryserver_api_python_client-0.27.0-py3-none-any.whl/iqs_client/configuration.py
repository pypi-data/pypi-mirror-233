...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of iqs_client.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the iqs_client.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = iqs_client.Configuration(
        signing_info = iqs_client.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="http://localhost/api",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("iqs_client")
