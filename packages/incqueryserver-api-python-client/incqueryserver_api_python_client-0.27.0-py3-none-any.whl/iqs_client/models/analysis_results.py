...
class AnalysisResults(object):
    ...
    def __init__(self, configuration=None, analysis_results=None, kpi_values=None, local_vars_configuration=None):  # noqa: E501
    ...
    def analysis_results(self, analysis_results):
        ...
        """
        if self.local_vars_configuration.client_side_validation and analysis_results is None:  # noqa: E501
    ...
    def kpi_values(self, kpi_values):
        ...
        :type: list[KPI]
        """
        if self.local_vars_configuration.client_side_validation and kpi_values is None:  # noqa: E501
            raise ValueError("Invalid value for `kpi_values`, must not be `None`")  # noqa: E501
