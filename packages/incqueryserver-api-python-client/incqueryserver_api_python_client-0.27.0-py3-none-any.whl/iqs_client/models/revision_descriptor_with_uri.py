...
class RevisionDescriptorWithURI(object):
    ...
    def __init__(self, revision_number=None, branch_id=None, resource_id=None, workspace_id=None, compartment_uri=None, author=None, local_vars_configuration=None):  # noqa: E501
