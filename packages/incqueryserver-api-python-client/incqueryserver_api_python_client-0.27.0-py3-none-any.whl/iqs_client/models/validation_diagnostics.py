...
class ValidationDiagnostics(object):
    ...
    def __init__(self, info=None, debug=None, warning=None, error=None, fatal=None, local_vars_configuration=None):  # noqa: E501
    ...
    def debug(self, debug):
        ...
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and debug is None:  # noqa: E501
    ...
    def fatal(self, fatal):
        ...
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and fatal is None:  # noqa: E501
