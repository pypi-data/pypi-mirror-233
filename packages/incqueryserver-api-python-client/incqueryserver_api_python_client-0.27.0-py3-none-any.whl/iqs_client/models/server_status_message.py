...
class ServerStatusMessage(object):
    ...
    openapi_types = {
        ...
        'concurrent_acquisition_tasks': 'int',
    ...
    attribute_map = {
        ...
        'concurrent_acquisition_tasks': 'concurrentAcquisitionTasks',
        'server_exceptions': 'serverExceptions'
    }

    def __init__(self, concurrent_client_connections=None, concurrent_indexing_tasks=None, concurrent_persisting_tasks=None, concurrent_load_back_tasks=None, concurrent_query_executions=None, concurrent_validation_tasks=None, concurrent_impact_analysis_tasks=None, concurrent_acquisition_tasks=None, server_exceptions=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._concurrent_acquisition_tasks = None
        ...
        self.concurrent_acquisition_tasks = concurrent_acquisition_tasks
    ...
    def concurrent_client_connections(self, concurrent_client_connections):
        ...
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and concurrent_client_connections is None:  # noqa: E501
    ...
    def concurrent_indexing_tasks(self, concurrent_indexing_tasks):
        ...
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and concurrent_indexing_tasks is None:  # noqa: E501
    ...
    def concurrent_persisting_tasks(self, concurrent_persisting_tasks):
        ...
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and concurrent_persisting_tasks is None:  # noqa: E501
    ...
    def concurrent_load_back_tasks(self, concurrent_load_back_tasks):
        ...
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and concurrent_load_back_tasks is None:  # noqa: E501
    ...
    def concurrent_query_executions(self, concurrent_query_executions):
        ...
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and concurrent_query_executions is None:  # noqa: E501
    ...
    def concurrent_validation_tasks(self, concurrent_validation_tasks):
        ...
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and concurrent_validation_tasks is None:  # noqa: E501
    ...
    def concurrent_impact_analysis_tasks(self, concurrent_impact_analysis_tasks):
        ...
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and concurrent_impact_analysis_tasks is None:  # noqa: E501
    ...
    @property
    def concurrent_acquisition_tasks(self):
        """Gets the concurrent_acquisition_tasks of this ServerStatusMessage.  # noqa: E501


        :return: The concurrent_acquisition_tasks of this ServerStatusMessage.  # noqa: E501
        :rtype: int
        """
        return self._concurrent_acquisition_tasks

    @concurrent_acquisition_tasks.setter
    def concurrent_acquisition_tasks(self, concurrent_acquisition_tasks):
        """Sets the concurrent_acquisition_tasks of this ServerStatusMessage.


        :param concurrent_acquisition_tasks: The concurrent_acquisition_tasks of this ServerStatusMessage.  # noqa: E501
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and concurrent_acquisition_tasks is None:  # noqa: E501
            raise ValueError("Invalid value for `concurrent_acquisition_tasks`, must not be `None`")  # noqa: E501

        self._concurrent_acquisition_tasks = concurrent_acquisition_tasks
