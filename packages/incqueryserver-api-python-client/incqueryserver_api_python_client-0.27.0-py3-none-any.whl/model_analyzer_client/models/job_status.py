...
class JobStatus(object):
    ...
    def status(self):
        ...
        - WAITING: Waiting in queue for execution - RUNNING: IncQuery Server scheduled the job for execution and it is probably already running. - DONE: Model Analyzer job had been finished. - ERROR: There were some problems with the Model Analyzer job.  # noqa: E501
    ...
    def status(self, status):
        ...
        allowed_values = ["WAITING", "RUNNING", "DONE", "ERROR"]  # noqa: E501
