    ...
    """
{
    ...
    "package_data": {
        "cdk_monitoring_constructs._jsii": [
            "cdk-monitoring-constructs@6.0.2.jsii.tgz"
        ],
        "cdk_monitoring_constructs": [
            "py.typed"
        ]
    ...
    "python_requires": "~=3.7",
    "install_requires": [
        "aws-cdk-lib>=2.99.0, <3.0.0",
        "aws-cdk.aws-apigatewayv2-alpha>=2.99.0.a0, <3.0.0",
        "aws-cdk.aws-redshift-alpha>=2.99.0.a0, <3.0.0",
