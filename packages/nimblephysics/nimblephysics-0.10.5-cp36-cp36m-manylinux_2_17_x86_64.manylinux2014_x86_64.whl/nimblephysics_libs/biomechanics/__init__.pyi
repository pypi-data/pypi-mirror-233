...
class Anthropometrics():
    ...
    def measure(self, skel: nimblephysics_libs._nimblephysics.dynamics.Skeleton) -> dict[str, float]: ...
...
class BatchGaitInverseDynamics():
    ...
    def getContactBodiesAtTimestep(self, timestep: int) -> list[nimblephysics_libs._nimblephysics.dynamics.BodyNode]: ...
    def getContactWrenchesAtTimestep(self, timestep: int) -> list[numpy.ndarray[numpy.float64, _Shape[6, 1]]]: ...
...
class BilevelFitResult():
    ...
    def groupScales(self, arg0: numpy.ndarray[numpy.float64, _Shape[m, 1]]) -> None:
        pass
    @property
    def markerOffsets(self) -> dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]:
        """
        :type: dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]
        """
    @markerOffsets.setter
    def markerOffsets(self, arg0: dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]) -> None:
        pass
    @property
    def poses(self) -> list[numpy.ndarray[numpy.float64, _Shape[m, 1]]]:
        """
        :type: list[numpy.ndarray[numpy.float64, _Shape[m, 1]]]
        """
    @poses.setter
    def poses(self, arg0: list[numpy.ndarray[numpy.float64, _Shape[m, 1]]]) -> None:
        pass
    @property
...
class C3D():
    ...
    def forcePlates(self) -> list[ForcePlate]:
        """
        :type: list[ForcePlate]
        """
    @forcePlates.setter
    def forcePlates(self, arg0: list[ForcePlate]) -> None:
        pass
    @property
    ...
    def framesPerSecond(self, arg0: int) -> None:
        pass
    @property
    def markerTimesteps(self) -> list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]:
        """
        :type: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]
        """
    @markerTimesteps.setter
    def markerTimesteps(self, arg0: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None:
        pass
    @property
    def markers(self) -> list[str]:
        ...
        """
    @markers.setter
    def markers(self, arg0: list[str]) -> None:
        pass
    @property
    ...
    def timestamps(self) -> list[float]:
        ...
        """
    @timestamps.setter
    def timestamps(self, arg0: list[float]) -> None:
        pass
    pass
class C3DLoader():
    @staticmethod
...
class ContactRegimeSection():
    ...
    def endTime(self, arg0: int) -> None:
        pass
    @property
    def groundContactBodies(self) -> list[nimblephysics_libs._nimblephysics.dynamics.BodyNode]:
        """
        :type: list[nimblephysics_libs._nimblephysics.dynamics.BodyNode]
        """
    @groundContactBodies.setter
    def groundContactBodies(self, arg0: list[nimblephysics_libs._nimblephysics.dynamics.BodyNode]) -> None:
        pass
    @property
    ...
    def startTime(self, arg0: int) -> None:
        pass
    @property
    def wrenches(self) -> list[list[numpy.ndarray[numpy.float64, _Shape[6, 1]]]]:
        """
        :type: list[list[numpy.ndarray[numpy.float64, _Shape[6, 1]]]]
        """
    @wrenches.setter
    def wrenches(self, arg0: list[list[numpy.ndarray[numpy.float64, _Shape[6, 1]]]]) -> None:
        pass
    pass
...
class DynamicsFitter():
    def __init__(self, skeleton: nimblephysics_libs._nimblephysics.dynamics.Skeleton, footNodes: list[nimblephysics_libs._nimblephysics.dynamics.BodyNode], trackingMarkers: list[str]) -> None: ...
    ...
    def comAccelerations(self, init: DynamicsInitialization, trial: int) -> list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]: ...
    def comPositions(self, init: DynamicsInitialization, trial: int) -> list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]: ...
    ...
    @staticmethod
    @typing.overload
    def createInitialization(skel: nimblephysics_libs._nimblephysics.dynamics.Skeleton, markerMap: dict[str, tuple[nimblephysics_libs._nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], trackingMarkers: list[str], grfNodes: list[nimblephysics_libs._nimblephysics.dynamics.BodyNode], forcePlateTrials: list[list[ForcePlate]], poseTrials: list[numpy.ndarray[numpy.float64, _Shape[m, n]]], framesPerSecond: list[int], markerObservationTrials: list[list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]], overrideForcePlateToGRFNodeAssignment: list[list[int]] = []) -> DynamicsInitialization: ...
    @staticmethod
    @typing.overload
    def createInitialization(skel: nimblephysics_libs._nimblephysics.dynamics.Skeleton, kinematicInits: list[MarkerInitialization], trackingMarkers: list[str], grfNodes: list[nimblephysics_libs._nimblephysics.dynamics.BodyNode], forcePlateTrials: list[list[ForcePlate]], framesPerSecond: list[int], markerObservationTrials: list[list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]], overrideForcePlateToGRFNodeAssignment: list[list[int]] = []) -> DynamicsInitialization: ...
    ...
    def impliedCOMForces(self, init: DynamicsInitialization, trial: int, includeGravity: numpy.ndarray[numpy.float64, _Shape[3, 1]] = True) -> list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]: ...
    def measuredGRFForces(self, init: DynamicsInitialization, trial: int) -> list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]: ...
    ...
    def writeCSVData(self, path: str, init: DynamicsInitialization, trialIndex: int, useAdjustedGRFs: bool = False, timestamps: list[float] = []) -> None: ...
...
class DynamicsInitialization():
    @property
    def axisWeights(self) -> list[numpy.ndarray[numpy.float64, _Shape[m, 1]]]:
        """
        :type: list[numpy.ndarray[numpy.float64, _Shape[m, 1]]]
        """
    @axisWeights.setter
    def axisWeights(self, arg0: list[numpy.ndarray[numpy.float64, _Shape[m, 1]]]) -> None:
        pass
    @property
    ...
    def bodyMasses(self, arg0: numpy.ndarray[numpy.float64, _Shape[m, 1]]) -> None:
        pass
    @property
    def contactBodies(self) -> list[list[nimblephysics_libs._nimblephysics.dynamics.BodyNode]]:
        """
        :type: list[list[nimblephysics_libs._nimblephysics.dynamics.BodyNode]]
        """
    @contactBodies.setter
    def contactBodies(self, arg0: list[list[nimblephysics_libs._nimblephysics.dynamics.BodyNode]]) -> None:
        pass
    @property
    def defaultForcePlateCorners(self) -> list[list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]]:
        """
        :type: list[list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]]
        """
    @defaultForcePlateCorners.setter
    def defaultForcePlateCorners(self, arg0: list[list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None:
        pass
    @property
    def flatGround(self) -> list[bool]:
        """
        :type: list[bool]
        """
    @flatGround.setter
    def flatGround(self, arg0: list[bool]) -> None:
        pass
    @property
    def forcePlateTrials(self) -> list[list[ForcePlate]]:
        """
        :type: list[list[ForcePlate]]
        """
    @forcePlateTrials.setter
    def forcePlateTrials(self, arg0: list[list[ForcePlate]]) -> None:
        pass
    @property
    ...
    def grfBodyContactSphereRadius(self, arg0: list[list[list[float]]]) -> None:
        pass
    @property
    ...
    def grfBodyForceActive(self, arg0: list[list[list[bool]]]) -> None:
        pass
    @property
    ...
    def grfBodyIndices(self, arg0: list[int]) -> None:
        pass
    @property
    def grfBodyNodes(self) -> list[nimblephysics_libs._nimblephysics.dynamics.BodyNode]:
        """
        :type: list[nimblephysics_libs._nimblephysics.dynamics.BodyNode]
        """
    @grfBodyNodes.setter
    def grfBodyNodes(self, arg0: list[nimblephysics_libs._nimblephysics.dynamics.BodyNode]) -> None:
        pass
    @property
    ...
    def grfBodyOffForcePlate(self, arg0: list[list[list[bool]]]) -> None:
        pass
    @property
    ...
    def grfBodySphereInContact(self, arg0: list[list[list[bool]]]) -> None:
        pass
    @property
    def grfTrials(self) -> list[numpy.ndarray[numpy.float64, _Shape[m, n]]]:
        """
        :type: list[numpy.ndarray[numpy.float64, _Shape[m, n]]]
        """
    @grfTrials.setter
    def grfTrials(self, arg0: list[numpy.ndarray[numpy.float64, _Shape[m, n]]]) -> None:
        pass
    @property
    def groundHeight(self) -> list[float]:
        """
        :type: list[float]
        """
    @groundHeight.setter
    def groundHeight(self, arg0: list[float]) -> None:
        pass
    @property
    ...
    def includeTrialsInDynamicsFit(self, arg0: list[bool]) -> None:
        pass
    @property
    ...
    def initialGroupScales(self, arg0: numpy.ndarray[numpy.float64, _Shape[m, 1]]) -> None:
        pass
    @property
    def initialMarkerOffsets(self) -> dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]:
        """
        :type: dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]
        """
    @initialMarkerOffsets.setter
    def initialMarkerOffsets(self, arg0: dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]) -> None:
        pass
    @property
    def jointAxis(self) -> list[numpy.ndarray[numpy.float64, _Shape[m, n]]]:
        """
        :type: list[numpy.ndarray[numpy.float64, _Shape[m, n]]]
        """
    @jointAxis.setter
    def jointAxis(self, arg0: list[numpy.ndarray[numpy.float64, _Shape[m, n]]]) -> None:
        pass
    @property
    def jointCenters(self) -> list[numpy.ndarray[numpy.float64, _Shape[m, n]]]:
        """
        :type: list[numpy.ndarray[numpy.float64, _Shape[m, n]]]
        """
    @jointCenters.setter
    def jointCenters(self, arg0: list[numpy.ndarray[numpy.float64, _Shape[m, n]]]) -> None:
        pass
    @property
    def jointWeights(self) -> list[numpy.ndarray[numpy.float64, _Shape[m, 1]]]:
        """
        :type: list[numpy.ndarray[numpy.float64, _Shape[m, 1]]]
        """
    @jointWeights.setter
    def jointWeights(self, arg0: list[numpy.ndarray[numpy.float64, _Shape[m, 1]]]) -> None:
        pass
    @property
    def joints(self) -> list[list[nimblephysics_libs._nimblephysics.dynamics.Joint]]:
        """
        :type: list[list[nimblephysics_libs._nimblephysics.dynamics.Joint]]
        """
    @joints.setter
    def joints(self, arg0: list[list[nimblephysics_libs._nimblephysics.dynamics.Joint]]) -> None:
        pass
    @property
    ...
    def jointsAdjacentMarkers(self, arg0: list[list[list[str]]]) -> None:
        pass
    @property
    def markerObservationTrials(self) -> list[list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]]:
        """
        :type: list[list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]]
        """
    @markerObservationTrials.setter
    def markerObservationTrials(self, arg0: list[list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]]) -> None:
        pass
    @property
    def markerOffsets(self) -> dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]:
        """
    ...
    def missingGRFReason(self) -> list[list[MissingGRFReason]]:
        """
        :type: list[list[MissingGRFReason]]
        """
    @missingGRFReason.setter
    def missingGRFReason(self, arg0: list[list[MissingGRFReason]]) -> None:
        pass
    @property
    def originalPoses(self) -> list[numpy.ndarray[numpy.float64, _Shape[m, n]]]:
        """
        :type: list[numpy.ndarray[numpy.float64, _Shape[m, n]]]
        """
    @originalPoses.setter
    def originalPoses(self, arg0: list[numpy.ndarray[numpy.float64, _Shape[m, n]]]) -> None:
        pass
    @property
    def poseTrials(self) -> list[numpy.ndarray[numpy.float64, _Shape[m, n]]]:
        """
        :type: list[numpy.ndarray[numpy.float64, _Shape[m, n]]]
        """
    @poseTrials.setter
    def poseTrials(self, arg0: list[numpy.ndarray[numpy.float64, _Shape[m, n]]]) -> None:
        pass
    @property
    def probablyMissingGRF(self) -> list[list[bool]]:
        """
        :type: list[list[bool]]
        """
    @probablyMissingGRF.setter
    def probablyMissingGRF(self, arg0: list[list[bool]]) -> None:
        pass
    @property
    ...
    def regularizeGroupScalesTo(self, arg0: numpy.ndarray[numpy.float64, _Shape[m, 1]]) -> None:
        pass
    @property
    def regularizeMarkerOffsetsTo(self) -> dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]:
        """
        :type: dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]
        """
    @regularizeMarkerOffsetsTo.setter
    def regularizeMarkerOffsetsTo(self, arg0: dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]) -> None:
        pass
    @property
    ...
    def trackingMarkers(self, arg0: list[str]) -> None:
        pass
    @property
    ...
    def trialTimesteps(self, arg0: list[float]) -> None:
        pass
    @property
    def updatedMarkerMap(self) -> dict[str, tuple[nimblephysics_libs._nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]:
        """
        :type: dict[str, tuple[nimblephysics_libs._nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]
        """
    @updatedMarkerMap.setter
    def updatedMarkerMap(self, arg0: dict[str, tuple[nimblephysics_libs._nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None:
        pass
    pass
class ForcePlate():
    ...
    @property
    def centersOfPressure(self) -> list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]:
        """
        :type: list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]
        """
    @centersOfPressure.setter
    def centersOfPressure(self, arg0: list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]) -> None:
        pass
    @property
    def corners(self) -> list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]:
        """
        :type: list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]
        """
    @corners.setter
    def corners(self, arg0: list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]) -> None:
        pass
    @property
    def forces(self) -> list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]:
        """
        :type: list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]
        """
    @forces.setter
    def forces(self, arg0: list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]) -> None:
        pass
    @property
    def moments(self) -> list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]:
        """
        :type: list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]
        """
    @moments.setter
    def moments(self, arg0: list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]) -> None:
        pass
    @property
    def timestamps(self) -> list[float]:
        """
...
class Frame():
    ...
    """
    @property
    def accObservations(self) -> list[tuple[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]:
        """
        ...
        :type: list[tuple[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]
        """
    @accObservations.setter
    def accObservations(self, arg0: list[tuple[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None:
        """
        This is list of :code:`Pair[str, np.ndarray]` of the accelerometers observations at this frame. Accelerometers that were not observed (perhaps due to time offsets in uploaded data) will not be present in this list. For the full specification of the accelerometer set, load the model from the :code:`SubjectOnDisk`
        """
    @property
    def customValues(self) -> list[tuple[str, numpy.ndarray[numpy.float64, _Shape[m, 1]]]]:
        """
        ...
        :type: list[tuple[str, numpy.ndarray[numpy.float64, _Shape[m, 1]]]]
        """
    @customValues.setter
    def customValues(self, arg0: list[tuple[str, numpy.ndarray[numpy.float64, _Shape[m, 1]]]]) -> None:
        """
        This is list of :code:`Pair[str, np.ndarray]` of unspecified values. The idea here is to allow the format to be easily extensible with unusual data (for example, exoskeleton torques) without bloating ordinary training files.
        """
    @property
    def emgSignals(self) -> list[tuple[str, numpy.ndarray[numpy.float64, _Shape[m, 1]]]]:
        """
        ...
        """
    @emgSignals.setter
    def emgSignals(self, arg0: list[tuple[str, numpy.ndarray[numpy.float64, _Shape[m, 1]]]]) -> None:
        """
        This is list of :code:`Pair[str, np.ndarray]` of the EMG signals at this frame. EMG signals are generally preserved at a higher sampling frequency than the motion capture, so the `np.ndarray` vector will be a number of samples that were captured during this single motion capture frame. For example, if EMG is at 1000Hz and mocap is at 100Hz, the `np.ndarray` vector will be of length 10.
        """
    @property
    def exoTorques(self) -> list[tuple[int, float]]:
        ...
        """
    @exoTorques.setter
    def exoTorques(self, arg0: list[tuple[int, float]]) -> None:
        """
        This is list of :code:`Pair[int, np.ndarray]` of the DOF indices that are actuated by exoskeletons, and the torques on those DOFs.
        """
    @property
    def gyroObservations(self) -> list[tuple[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]:
        """
    ...
    def gyroObservations(self, arg0: list[tuple[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None:
        """
        This is list of :code:`Pair[str, np.ndarray]` of the gyroscope observations at this frame. Gyroscopes that were not observed (perhaps due to time offsets in uploaded data) will not be present in this list. For the full specification of the gyroscope set, load the model from the :code:`SubjectOnDisk`
        """
    @property
    def markerObservations(self) -> list[tuple[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]:
        """
    ...
    def markerObservations(self, arg0: list[tuple[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None:
        """
        This is list of :code:`Pair[str, np.ndarray]` of the marker observations at this frame. Markers that were not observed will not be present in this list. For the full specification of the markerset, load the model from the :code:`SubjectOnDisk`
        """
    @property
    ...
    def missingGRFReason(self, arg0: MissingGRFReason) -> None:
        ...
        """
    @property
    def processingPasses(self) -> list[FramePass]:
        """
    ...
    def processingPasses(self, arg0: list[FramePass]) -> None:
        """
        The processing passes that were done on this Frame. For example, if we solved for kinematics, then dynamics, 
        then low pass filtered, this will have 3 entries.
        ...
        """
    @property
    def rawForcePlateCenterOfPressures(self) -> list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]:
        """
    ...
    def rawForcePlateCenterOfPressures(self, arg0: list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]) -> None:
        """
        This is list of :code:`np.ndarray` of the original center of pressure readings on each force plate, without any processing by AddBiomechanics. These are the original inputs that were used to create this SubjectOnDisk.
        """
    @property
    def rawForcePlateForces(self) -> list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]:
        """
    ...
    def rawForcePlateForces(self, arg0: list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]) -> None:
        """
        This is list of :code:`np.ndarray` of the original force readings on each force plate, without any processing by AddBiomechanics. These are the original inputs that were used to create this SubjectOnDisk.
        """
    @property
    def rawForcePlateTorques(self) -> list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]:
        """
    ...
    def rawForcePlateTorques(self, arg0: list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]) -> None:
        """
        This is list of :code:`np.ndarray` of the original torque readings on each force plate, without any processing by AddBiomechanics. These are the original inputs that were used to create this SubjectOnDisk.
        """
    @property
...
class FramePass():
    ...
    pass
class IKErrorReport():
    def __init__(self, skeleton: nimblephysics_libs._nimblephysics.dynamics.Skeleton, markers: dict[str, tuple[nimblephysics_libs._nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], poses: numpy.ndarray[numpy.float64, _Shape[m, n]], observations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None: ...
    ...
    def maxError(self) -> list[float]:
        ...
        """
    @maxError.setter
    def maxError(self, arg0: list[float]) -> None:
        pass
    @property
    ...
    def rootMeanSquaredError(self, arg0: list[float]) -> None:
        pass
    @property
    ...
    def sumSquaredError(self, arg0: list[float]) -> None:
        pass
    pass
...
class InitialMarkerFitParams():
    ...
    def setJointCenters(self, joints: list[nimblephysics_libs._nimblephysics.dynamics.Joint], jointCenters: numpy.ndarray[numpy.float64, _Shape[m, n]], jointAdjacentMarkers: list[list[str]]) -> InitialMarkerFitParams: ...
    def setJointCentersAndWeights(self, joints: list[nimblephysics_libs._nimblephysics.dynamics.Joint], jointCenters: numpy.ndarray[numpy.float64, _Shape[m, n]], jointAdjacentMarkers: list[list[str]], jointWeights: numpy.ndarray[numpy.float64, _Shape[m, 1]]) -> InitialMarkerFitParams: ...
    def setMarkerOffsets(self, markerOffsets: dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]) -> InitialMarkerFitParams: ...
    ...
    def jointWeights(self, arg0: numpy.ndarray[numpy.float64, _Shape[m, 1]]) -> None:
        pass
    @property
    def joints(self) -> list[nimblephysics_libs._nimblephysics.dynamics.Joint]:
        """
        :type: list[nimblephysics_libs._nimblephysics.dynamics.Joint]
        """
    @joints.setter
    def joints(self, arg0: list[nimblephysics_libs._nimblephysics.dynamics.Joint]) -> None:
        pass
    @property
    def markerOffsets(self) -> dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]:
        """
    ...
    def markerWeights(self, arg0: dict[str, float]) -> None:
        pass
    @property
...
class LabelledMarkers():
    @property
    def jointCenterGuesses(self) -> list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]:
        """
        :type: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]
        """
    @jointCenterGuesses.setter
    def jointCenterGuesses(self, arg0: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None:
        pass
    @property
    def markerObservations(self) -> list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]:
        """
        :type: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]
        """
    @markerObservations.setter
    def markerObservations(self, arg0: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None:
        pass
    @property
    def markerOffsets(self) -> dict[str, tuple[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]:
        """
        :type: dict[str, tuple[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]
        """
    @markerOffsets.setter
    def markerOffsets(self, arg0: dict[str, tuple[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None:
        pass
    @property
    def traces(self) -> list[MarkerTrace]:
        """
        :type: list[MarkerTrace]
        """
    @traces.setter
    def traces(self, arg0: list[MarkerTrace]) -> None:
        pass
    pass
class LilypadSolver():
    def __init__(self, skeleton: nimblephysics_libs._nimblephysics.dynamics.Skeleton, groundContactBodies: list[nimblephysics_libs._nimblephysics.dynamics.BodyNode], groundNormal: numpy.ndarray[numpy.float64, _Shape[3, 1]], tileSize: float) -> None: ...
    def clear(self) -> None: ...
    def debugToGUI(self, gui: nimblephysics_libs._nimblephysics.server.GUIWebsocketServer) -> None: ...
    def getContactBodies(self) -> list[nimblephysics_libs._nimblephysics.dynamics.BodyNode]: ...
    ...
    pass
class MarkerFitter():
    def __init__(self, skeleton: nimblephysics_libs._nimblephysics.dynamics.Skeleton, markers: dict[str, tuple[nimblephysics_libs._nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], ignoreVirtualJointCenterMarkers: bool = False) -> None: ...
    def addZeroConstraint(self, name: str, loss: typing.Callable[[MarkerFitterState], float]) -> None: ...
    def autorotateC3D(self, c3d: C3D) -> None: ...
    def checkForEnoughMarkers(self, markerObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> bool: ...
    def checkForFlippedMarkers(self, markerObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], init: MarkerInitialization, report: MarkersErrorReport) -> bool: ...
    def debugTrajectoryAndMarkersToGUI(self, server: nimblephysics_libs._nimblephysics.server.GUIWebsocketServer, init: MarkerInitialization, markerObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], forcePlates: list[ForcePlate] = None, goldOsim: OpenSimFile = None, goldPoses: numpy.ndarray[numpy.float64, _Shape[m, n]] = array([], shape=(0, 0), dtype=float64)) -> None: ...
    def findJointCenters(self, initializations: MarkerInitialization, newClip: list[bool], markerObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None: ...
    def fineTuneWithIMU(self, accObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], gyroObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], markerObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], newClip: list[bool], init: MarkerInitialization, dt: float, weightAccs: float = 1.0, weightGyros: float = 1.0, weightMarkers: float = 100.0, regularizePoses: float = 1.0, useIPOPT: bool = True, iterations: int = 300, lbfgsMemory: int = 100) -> MarkerInitialization: ...
    def generateDataErrorsReport(self, markerObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], dt: float, rippleReduce: bool = True, rippleReduceUseSparse: bool = True, rippleReduceUseIterativeSolver: bool = True, rippleReduceSolverIterations: int = 100000.0) -> MarkersErrorReport: ...
    def getIMUFineTuneProblem(self, accObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], gyroObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], markerObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], init: MarkerInitialization, dt: float, start: int, end: int) -> IMUFineTuneProblem: ...
    def getImuList(self) -> list[tuple[nimblephysics_libs._nimblephysics.dynamics.BodyNode, nimblephysics_libs._nimblephysics.math.Isometry3]]: ...
    def getImuMap(self) -> dict[str, tuple[nimblephysics_libs._nimblephysics.dynamics.BodyNode, nimblephysics_libs._nimblephysics.math.Isometry3]]: ...
    def getImuNames(self) -> list[str]: ...
    def getInitialization(self, markerObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], newClip: list[bool], params: InitialMarkerFitParams = InitialMarkerFitParams(numBlocks=12)) -> MarkerInitialization: ...
    def getMarkerIsTracking(self, marker: str) -> bool: ...
    def getNumMarkers(self) -> int: ...
    def measureAccelerometerRMS(self, accObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], newClip: list[bool], init: MarkerInitialization, dt: float) -> float: ...
    def measureGyroRMS(self, gyroObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], newClip: list[bool], init: MarkerInitialization, dt: float) -> float: ...
    def optimizeBilevel(self, markerObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], initialization: MarkerInitialization, numSamples: int, applyInnerProblemGradientConstraints: bool = True) -> BilevelFitResult: ...
    @staticmethod
    def pickSubset(markerObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], subsetSize: int) -> list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]: ...
    def removeZeroConstraint(self, name: str) -> None: ...
    def rotateIMUs(self, accObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], gyroObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], newClip: list[bool], init: MarkerInitialization, dt: float) -> None: ...
    def runKinematicsPipeline(self, markerObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], newClip: list[bool], params: InitialMarkerFitParams, numSamples: int = 20, skipFinalIK: bool = False) -> MarkerInitialization: ...
    def runMultiTrialKinematicsPipeline(self, markerTrials: list[list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]], params: InitialMarkerFitParams, numSamples: int = 50) -> list[MarkerInitialization]: ...
    def runPrescaledPipeline(self, markerObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], params: InitialMarkerFitParams) -> MarkerInitialization: ...
    def saveTrajectoryAndMarkersToGUI(self, path: str, init: MarkerInitialization, markerObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], accObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], gyroObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], frameRate: int, forcePlates: list[ForcePlate] = None, goldOsim: OpenSimFile = None, goldPoses: numpy.ndarray[numpy.float64, _Shape[m, n]] = array([], shape=(0, 0), dtype=float64)) -> None: ...
    ...
    def setImuMap(self, imuMap: dict[str, tuple[nimblephysics_libs._nimblephysics.dynamics.BodyNode, nimblephysics_libs._nimblephysics.math.Isometry3]]) -> None: ...
    ...
    def setStaticTrial(self, markerObservationsMapAtStaticPose: dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]], staticPose: numpy.ndarray[numpy.float64, _Shape[m, 1]]) -> None: ...
...
class MarkerFitterState():
    ...
    def bodyNames(self) -> list[str]:
        ...
        """
    @bodyNames.setter
    def bodyNames(self, arg0: list[str]) -> None:
        pass
    @property
    ...
    def jointOrder(self) -> list[str]:
        ...
        """
    @jointOrder.setter
    def jointOrder(self, arg0: list[str]) -> None:
        pass
    @property
    ...
    def markerOrder(self) -> list[str]:
        ...
        """
    @markerOrder.setter
    def markerOrder(self, arg0: list[str]) -> None:
        pass
    @property
...
class MarkerFixer():
    @staticmethod
    def generateDataErrorsReport(immutableMarkerObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], dt: float, dropProlongedStillness: bool = False, rippleReduce: bool = True, rippleReduceUseSparse: bool = True, rippleReduceUseIterativeSolver: bool = True, rippleReduceSolverIterations: int = 100000.0) -> MarkersErrorReport: ...
    pass
class MarkerInitialization():
    ...
    def jointsAdjacentMarkers(self) -> list[list[str]]:
        ...
        """
    @jointsAdjacentMarkers.setter
    def jointsAdjacentMarkers(self, arg0: list[list[str]]) -> None:
        pass
    @property
    def markerOffsets(self) -> dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]:
        """
...
class MarkerLabeller():
    def evaluate(self, markerOffsets: dict[str, tuple[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], labeledPointClouds: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None: ...
    def guessJointLocations(self, pointClouds: list[list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]: ...
    def labelPointClouds(self, pointClouds: list[list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]], mergeMarkersThreshold: float = 0.01) -> LabelledMarkers: ...
...
class MarkerLabellerMock(MarkerLabeller):
    def __init__(self) -> None: ...
    def setMockJointLocations(self, jointsOverTime: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None: ...
    pass
class MarkerTrace():
    @property
    ...
    def bodyMarkerOffsetVariance(self) -> dict[str, float]:
        ...
        """
    @property
    def bodyMarkerOffsets(self) -> dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]:
        """
        :type: dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]
        """
    @property
    ...
    def minTime(self) -> int:
        ...
        """
    @property
    def points(self) -> list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]:
        """
        :type: list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]
        """
    @property
...
class MarkersErrorReport():
    def getMarkerMapOnTimestep(self, t: int) -> dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]: ...
    def getMarkerNamesOnTimestep(self, t: int) -> list[str]: ...
    def getMarkerPositionOnTimestep(self, t: int, marker: str) -> numpy.ndarray[numpy.float64, _Shape[3, 1]]: ...
    def getNumTimesteps(self) -> int: ...
    @property
    def droppedMarkerWarnings(self) -> list[list[tuple[str, numpy.ndarray[numpy.float64, _Shape[3, 1]], str]]]:
        """
        :type: list[list[tuple[str, numpy.ndarray[numpy.float64, _Shape[3, 1]], str]]]
        """
    @droppedMarkerWarnings.setter
    def droppedMarkerWarnings(self, arg0: list[list[tuple[str, numpy.ndarray[numpy.float64, _Shape[3, 1]], str]]]) -> None:
        pass
    @property
    def info(self) -> list[str]:
        ...
        """
    @info.setter
    def info(self, arg0: list[str]) -> None:
        pass
    @property
    def markerObservationsAttemptedFixed(self) -> list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]:
        """
        :type: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]
        """
    @markerObservationsAttemptedFixed.setter
    def markerObservationsAttemptedFixed(self, arg0: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None:
        pass
    @property
    ...
    def markersRenamedFromTo(self, arg0: list[list[tuple[str, str]]]) -> None:
        pass
    @property
    def warnings(self) -> list[str]:
        ...
        """
    @warnings.setter
    def warnings(self, arg0: list[str]) -> None:
        pass
    pass
...
class NeuralMarkerLabeller(MarkerLabeller):
    def __init__(self, jointCenterPredictor: typing.Callable[[list[list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]]], list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]]) -> None: ...
    pass
class OpenSimFile():
    def __init__(self, skeleton: nimblephysics_libs._nimblephysics.dynamics.Skeleton, markers: dict[str, tuple[nimblephysics_libs._nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None: ...
    @property
    ...
    def anatomicalMarkers(self, arg0: list[str]) -> None:
        pass
    @property
    ...
    def ignoredBodies(self, arg0: list[str]) -> None:
        pass
    @property
    ...
    def jointsDrivenBy(self, arg0: list[tuple[str, str]]) -> None:
        pass
    @property
    def markersMap(self) -> dict[str, tuple[nimblephysics_libs._nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]:
        """
        :type: dict[str, tuple[nimblephysics_libs._nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]
        """
    @markersMap.setter
    def markersMap(self, arg0: dict[str, tuple[nimblephysics_libs._nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None:
        pass
    @property
...
class OpenSimMocoTrajectory():
    ...
    def activationNames(self, arg0: list[str]) -> None:
        pass
    @property
    ...
    def excitationNames(self, arg0: list[str]) -> None:
        pass
    @property
...
class OpenSimScaleAndMarkerOffsets():
    ...
    def markerOffsets(self, arg0: dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]) -> None:
        pass
    @property
    def markers(self) -> dict[str, tuple[nimblephysics_libs._nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]:
        """
        :type: dict[str, tuple[nimblephysics_libs._nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]
        """
    @markers.setter
    def markers(self, arg0: dict[str, tuple[nimblephysics_libs._nimblephysics.dynamics.BodyNode, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None:
        pass
    @property
    def success(self) -> bool:
        """
...
class OpenSimTRC():
    ...
    def framesPerSecond(self, arg0: int) -> None:
        pass
    @property
    def markerLines(self) -> dict[str, list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]]:
        """
        :type: dict[str, list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]]
        """
    @markerLines.setter
    def markerLines(self, arg0: dict[str, list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None:
        pass
    @property
    def markerTimesteps(self) -> list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]:
        """
...
class ResidualForceHelper():
    def __init__(self, skeleton: nimblephysics_libs._nimblephysics.dynamics.Skeleton, forceBodies: list[int]) -> None: ...
...
class SkeletonConverter():
    ...
    def getSourceJoints(self) -> list[nimblephysics_libs._nimblephysics.dynamics.Joint]: ...
    def getTargetJointWorldPositions(self) -> numpy.ndarray[numpy.float64, _Shape[m, 1]]: ...
    def getTargetJoints(self) -> list[nimblephysics_libs._nimblephysics.dynamics.Joint]: ...
...
class SubjectOnDisk():
    ...
    def getCustomValues(self) -> list[str]: 
        ...
        """
    def getDofAccelerationsFiniteDifferenced(self, trial: int, processingPass: int) -> list[bool]: 
        """
        ...
        """
    def getDofPositionsObserved(self, trial: int, processingPass: int) -> list[bool]: 
        """
        This returns the vector of booleans indicating which DOFs have their positions observed during this trial
        """
    def getDofVelocitiesFiniteDifferenced(self, trial: int, processingPass: int) -> list[bool]: 
        """
        ...
        """
    def getForcePlateCorners(self, trial: int, forcePlate: int) -> list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]: 
        """
    ...
    def getMassKg(self) -> float: 
        ...
        """
    def getMissingGRF(self, trial: int) -> list[MissingGRFReason]: 
        """
    ...
    def getSubjectTags(self) -> list[str]: 
        ...
        """
    def getTrialAngularResidualNorms(self, trial: int, processingPass: int) -> list[float]: 
        """
    ...
    def getTrialTimestep(self, trial: int) -> float: 
        ...
        """
    def readFrames(self, trial: int, startFrame: int, numFramesToRead: int = 1, includeSensorData: bool = True, includeProcessingPasses: bool = True, stride: int = 1, contactThreshold: float = 1.0) -> list[Frame]: 
        """
...
class SubjectOnDiskHeader():
    ...
    def setCustomValueNames(self, customValueNames: list[str]) -> SubjectOnDiskHeader: ...
    def setGroundForceBodies(self, groundForceBodies: list[str]) -> SubjectOnDiskHeader: ...
    ...
    def setSubjectTags(self, subjectTags: list[str]) -> SubjectOnDiskHeader: ...
    pass
...
class SubjectOnDiskTrial():
    ...
    def addPass(self) -> SubjectOnDiskTrialPass: 
        ...
        """
    def setAccObservations(self, accObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None: ...
    def setCustomValues(self, customValues: list[numpy.ndarray[numpy.float64, _Shape[m, n]]]) -> None: ...
    def setEmgObservations(self, emgObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[m, 1]]]]) -> None: ...
    def setExoTorques(self, exoTorques: dict[int, numpy.ndarray[numpy.float64, _Shape[m, 1]]]) -> None: ...
    def setForcePlates(self, forcePlates: list[ForcePlate]) -> None: ...
    def setGyroObservations(self, gyroObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None: ...
    def setMarkerNamesGuessed(self, markersGuessed: bool) -> None: ...
    def setMarkerObservations(self, markerObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> None: ...
    def setMissingGRFReason(self, missingGRFReason: list[MissingGRFReason]) -> None: ...
    ...
    def setTrialTags(self, trialTags: list[str]) -> None: ...
    pass
class SubjectOnDiskTrialPass():
    def __init__(self) -> None: ...
    def computeValues(self, skel: nimblephysics_libs._nimblephysics.dynamics.Skeleton, timestep: float, poses: numpy.ndarray[numpy.float64, _Shape[m, n]], footBodyNames: list[str], forces: numpy.ndarray[numpy.float64, _Shape[m, n]], moments: numpy.ndarray[numpy.float64, _Shape[m, n]], cops: numpy.ndarray[numpy.float64, _Shape[m, n]]) -> None: ...
    def computeValuesFromForcePlates(self, skel: nimblephysics_libs._nimblephysics.dynamics.Skeleton, timestep: float, poses: numpy.ndarray[numpy.float64, _Shape[m, n]], footBodyNames: list[str], forcePlates: list[ForcePlate]) -> None: ...
    def setAccs(self, accs: numpy.ndarray[numpy.float64, _Shape[m, n]]) -> None: ...
    def setAngularResidual(self, angularResidual: list[float]) -> None: ...
    ...
    def setDofAccelerationFiniteDifferenced(self, dofAccelerationFiniteDifference: list[bool]) -> None: ...
    def setDofPositionsObserved(self, dofPositionsObserved: list[bool]) -> None: ...
    def setDofVelocitiesFiniteDifferenced(self, dofVelocitiesFiniteDifferenced: list[bool]) -> None: ...
    ...
    def setLinearResidual(self, linearResidual: list[float]) -> None: ...
    def setMarkerMax(self, markerMax: list[float]) -> None: ...
    def setMarkerRMS(self, markerRMS: list[float]) -> None: ...
