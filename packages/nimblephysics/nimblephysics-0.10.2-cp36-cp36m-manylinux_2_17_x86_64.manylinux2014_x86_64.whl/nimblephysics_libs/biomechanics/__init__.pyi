...
class MarkerFitter():
    ...
    def generateDataErrorsReport(self, markerObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], dt: float) -> MarkersErrorReport: ...
...
class MarkerFixer():
    @staticmethod
    def generateDataErrorsReport(immutableMarkerObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]], dt: float, dropProlongedStillness: bool = False) -> MarkersErrorReport: ...
    pass
