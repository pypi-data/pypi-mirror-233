...
def labelling_quality_test(test_session:TestSession, 
    ...
    dataset_id = labelling_quality_test_validation(test_session, dataset_name, test_name, type, output_type, rules, mistake_score_col_name, embedding_col_name)
    return {
            "datasetId": dataset_id,
            "experimentId": test_session.experiment_id,
            "name": test_name,
...
def labelling_quality_test_validation(test_session:TestSession, dataset_name:str, test_name:str, type:str, output_type:str,  rules:LQRules, mistake_score_col_name:str, embedding_col_name:str):
    from raga.constants import INVALID_RESPONSE, INVALID_RESPONSE_DATA, REQUIRED_ARG_V2
    ...
    assert isinstance(embedding_col_name, str) and embedding_col_name, f"{REQUIRED_ARG_V2.format('embedding_col_name', 'str')}"
