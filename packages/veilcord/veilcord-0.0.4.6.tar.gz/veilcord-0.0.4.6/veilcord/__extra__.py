...
class Solver:
    ...
    def solveCaptcha(self) -> str:
        if self.service in self.valid_services:
            ...
            return self.solveCapSecondary("http://api.captcha.guru")
        elif self.service == "24CAP":
            return self.solveCapSecondary("https://24captcha.online")
        else:
    ...
    def solveSecondary(self, domain: str) -> str:
    ...
    def solveCapSecondary(self, domain: str):
        payload = {
            "key": self.capKey,
            "method": "hcaptcha",
            "sitekey": self.siteKey,
