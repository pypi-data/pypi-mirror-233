from typing import Literal, TypedDict, Union, Dict, Any, Tuple, List
...
_EventType = Union[Literal["error"], Literal["csp"], Literal["hpkp"], Literal["expectct"], Literal["expectstaple"], Literal["transaction"], Literal["nel"], Literal["default"]]
"""
