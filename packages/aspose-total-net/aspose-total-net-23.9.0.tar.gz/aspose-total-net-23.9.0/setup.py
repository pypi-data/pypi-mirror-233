...
REQUIRES = ["aspose-3d==23.9.0",
            "aspose-barcode-for-python-via-net==23.9",
            "aspose-cad==23.6",
            "aspose-cells-python==23.9.0",
            "aspose-diagram-python==23.9.0",
            "Aspose.Email-for-Python-via-NET==23.8",
            "aspose-finance==23.9",
            "aspose-imaging-python-net==23.9.0",
            "aspose-ocr-python-net==23.9.1",
            "aspose-pdf==23.9.0",
