...
class SieveProject():
    ...
    def edit(self):
        ...
        """
        res = sieve_post(
            f'{API_URL}/{API_BASE}/projects/{self.name}',
            data={
                PROJECT_CREATE_CONFIG: self.dict,
            }
        )
    ...
    def push(self, source_name: str, source_url: str, local_upload=False, last_layer=None):
        """
...
class SieveClient():
    ...
    def push(
        ...
        Returns:
            a SieveJob object
        """
        return SieveProject.from_name(project_name, load_project_info=False).push(source_name, source_url, local_upload=local_upload, last_layer=last_layer)
