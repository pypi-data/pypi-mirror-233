...
def test_response_validation_return_true_for_correct_curves_and_structure():
    required_output = ["DEN", "NEU"]
...
def test_response_validation_return_false_for_correct_curves_wrong_structure():
    required_output = ["DEN", "NEU"]
...
def test_response_validation_return_false_for_correct_structure_wrong_curves():
    required_output = ["DEN", "NEU"]
    response_with_incorrect_curves_and_correct_structure = [
        {
            "DEPTH": [1, 2, 3],
            "WELL": "test",
            "DEN": [0.5, 0.6, 0.7],
    ...
    assert not response_validation(
        response=response_with_incorrect_curves_and_correct_structure,
        required_output=required_output,
    )
