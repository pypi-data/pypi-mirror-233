from atoti_core import DataType as DataType, get_env_flag
...
from ._typecheck import (
    DISABLE_TYPECHECKING_ENV_VAR_NAME as _DISABLE_TYPECHECKING_ENV_VAR_NAME,
...
if __debug__ and not get_env_flag(_DISABLE_TYPECHECKING_ENV_VAR_NAME):
    _api_decorators.append(_typecheck)
