...
from .directquery._clustering_columns_parameter import (
...
class Session(LocalSession[Cubes]):
    ...
    def __init__(
        ...
        *,
        ...
        app_extensions: Mapping[str, Union[str, Path]] = _EMPTY_MAPPING,
    ...
    def create_table(
        ...
        *,
        ...
        default_values: Mapping[str, Optional[ConstantValue]] = _EMPTY_MAPPING,
        **kwargs: Any,
    ) -> Table:
        ...
        *,
        ...
        if options is not None:
            ...
            clustering_columns = cast(
                ...
                options._options.get(_CLUSTERING_COLUMNS_PARAMETER),
            )
            keys = options._keys
    ...
    def read_pandas(
        ...
        *,
        ...
        keys: Iterable[str] = (),
        partitioning: Optional[str] = None,
        types: Mapping[str, DataType] = _EMPTY_MAPPING,
        default_values: Mapping[str, Optional[ConstantValue]] = _EMPTY_MAPPING,
        **kwargs: Any,
    ) -> Table:
    ...
    @doc(**{**_TABLE_CREATION_KWARGS, **_CSV_KWARGS, **_CLIENT_SIDE_ENCRYPTION_DOC})
    def read_csv(
        self,
        path: PathLike,
        /,
    ...
    @doc(**{**_TABLE_CREATION_KWARGS, **_SQL_KWARGS})
    def read_sql(
        self,
        sql: str,
        /,
