...
class ScamInsight:
    ...
    def run(self, search_type):
        ...
        if search_type == "-w":
            ...
            chrome_services = Service("driver_path")
            chrome_services.creation_flags = CREATE_NO_WINDOW
            ...
            try:
                ...
                driver = webdriver.Chrome(driver_path, service=chrome_services, options=chrome_options)
