...
class QueryResultResponse(pydantic.BaseModel):
    """
    ...
    dataset: BasicDescription = pydantic.Field(description="Basic information about the dataset for the query")
    embedding: BasicDescription = pydantic.Field(description="Basic information about the embedding for the query")
    status: QueryStatus = pydantic.Field(description="The current status of the query")
    ...
    error: typing.Optional[str] = pydantic.Field(description="The query error stacktrace")
    results: typing.Optional[QueryResult] = pydantic.Field(description="The query error stacktrace")
