...
class DatasetResponse(pydantic.BaseModel):
    ...
    storage_type: StorageTypeEnum = pydantic.Field(
        alias="storageType", description="The primary data source for the dataset"
    )
    ...
    ocr: typing.Optional[bool] = pydantic.Field(
        description="True if OCR (optical character recognition) is enabled for all assets in this dataset"
    )
