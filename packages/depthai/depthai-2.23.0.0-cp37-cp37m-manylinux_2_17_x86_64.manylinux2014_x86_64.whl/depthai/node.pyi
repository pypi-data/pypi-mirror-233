...
class Camera(depthai.Node):
    class Properties:
        ...
        previewWidth: int
        rawPacked: Optional[bool]
        resolutionHeight: int
        resolutionWidth: int
        sensorCropX: float
        sensorCropY: float
        sensorType: depthai.CameraSensorType
        stillHeight: int
        stillWidth: int
        videoHeight: int
        videoWidth: int
    ...
    def getCalibrationAlpha(self) -> Optional[float]: ...
...
class ColorCamera(depthai.Node):
    class Properties:
        ...
        class SensorResolution:
            ...
            THE_1352X1012: ClassVar[depthai.ColorCameraProperties.SensorResolution] = ...
            ...
            THE_2024X1520: ClassVar[depthai.ColorCameraProperties.SensorResolution] = ...
...
class Warp(depthai.Node):
    class Properties:
        class Interpolation:
            __members__: ClassVar[dict] = ...  # read-only
            BICUBIC: ClassVar[depthai.Interpolation] = ...
            BILINEAR: ClassVar[depthai.Interpolation] = ...
            BYPASS: ClassVar[depthai.Interpolation] = ...
            DEFAULT: ClassVar[depthai.Interpolation] = ...
            DEFAULT_DISPARITY_DEPTH: ClassVar[depthai.Interpolation] = ...
            NEAREST_NEIGHBOR: ClassVar[depthai.Interpolation] = ...
            __entries: ClassVar[dict] = ...
            def __init__(self, value: int) -> None: ...
            def __eq__(self, other: object) -> bool: ...
            def __getstate__(self) -> int: ...
