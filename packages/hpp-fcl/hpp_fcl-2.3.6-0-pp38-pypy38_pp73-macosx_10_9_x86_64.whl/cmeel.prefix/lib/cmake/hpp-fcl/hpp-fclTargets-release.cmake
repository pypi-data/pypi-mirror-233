...
set_target_properties(hpp-fcl::hpp-fcl PROPERTIES
  IMPORTED_LOCATION_RELEASE "${PACKAGE_PREFIX_DIR}/lib/libhpp-fcl.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libhpp-fcl.dylib"
  )

list(APPEND _cmake_import_check_targets hpp-fcl::hpp-fcl )
list(APPEND _cmake_import_check_files_for_hpp-fcl::hpp-fcl "${PACKAGE_PREFIX_DIR}/lib/libhpp-fcl.dylib" )
