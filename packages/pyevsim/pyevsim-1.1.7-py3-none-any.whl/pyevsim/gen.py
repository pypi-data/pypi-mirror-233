relay_example = """from pyevsim import SystemSimulator, BehaviorModelExecutor, SysMessage
...
periodic_example = """from pyevsim import BehaviorModelExecutor, SystemSimulator, Infinite
import datetime
...
usage = """
Usage: python -m pyevsim.gen [example]
