...
The GitHub Actions CI/CD Bot is enables teams to automate their SQLMesh projects using GitHub Actions. It can be configured to perform the following things:
...
There are two fundamental ways the bot can be configured: synchronized or desychronized production code and data. 

### Syncronized vs. Desynchronized Production Code and Data
...
SQLMesh's virtual data environments offer a different approach where the code and data in production can be **synchronized**.
