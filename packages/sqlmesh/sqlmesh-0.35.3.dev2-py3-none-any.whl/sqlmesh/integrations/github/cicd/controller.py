        ...
        def conclusion_handler(
            ...
            if conclusion.is_success:
                ...
                skip_reason = (
                    ...
                    if exception
                    else "A prior stage failed resulting in skipping PR creation."
                )
                conclusion_to_summary = {
                    ...
                    GithubCheckConclusion.FAILURE: f":x: Failed to create or update PR Environment `{self.pr_environment_name}`. This is an unexpected error. Exception: {exception}",
