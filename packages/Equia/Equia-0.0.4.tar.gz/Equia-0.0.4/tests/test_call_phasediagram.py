...
async def test_call_phasediagram():
    client = EquiaClient(sharedsettings.url, sharedsettings.user_id, sharedsettings.access_secret)
    ...
    result: ProblemDetails = await client.call_phasediagram_standard_async(input)
