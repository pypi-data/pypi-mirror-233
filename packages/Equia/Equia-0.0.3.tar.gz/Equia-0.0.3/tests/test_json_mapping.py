from equia.models import CalculationComposition, FlashCalculationInput
...
def test_flash_input_mapped():
    body = {
        ...
        "flashType": "Fixed Temperature/Pressure",
    ...
    assert input.flash_type == "Fixed Temperature/Pressure"
