...
T = TypeVar("T", bound="FlashedPropertyCalculationResult")


@attr.s(auto_attribs=True)
class FlashedPropertyCalculationResult:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flashed_property_calculation_result = cls(
            success=success,
        ...
        return flashed_property_calculation_result
