...
class CreateJobSuccess(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["jid", "status", "message", "detail", "status_code", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["jid"]) -> MetaOapg.properties.jid: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["jid", "status", "message", "detail", "status_code", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        jid: typing.Union[MetaOapg.properties.jid, str, uuid.UUID, ],
