...
class GetJobSuccess(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["job", "status", "message", "detail", "status_code", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["job", "status", "message", "detail", "status_code", ], str]):
