...
class Gpu(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "vendor", "memory", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "vendor", "memory", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        vendor: typing.Union[MetaOapg.properties.vendor, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
