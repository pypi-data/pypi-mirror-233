...
class GetFlavorsSuccess(
        ...
        class properties:
            ...
            class flavors(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Flavor']:
                        return Flavor
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Flavor'], typing.List['Flavor']],
                ...
                def __getitem__(self, i: int) -> 'Flavor':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["flavors"]) -> MetaOapg.properties.flavors: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["status", "message", "detail", "status_code", "limit", "no", "flavors", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["flavors"]) -> typing.Union[MetaOapg.properties.flavors, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["status", "message", "detail", "status_code", "limit", "no", "flavors", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        flavors: typing.Union[MetaOapg.properties.flavors, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
