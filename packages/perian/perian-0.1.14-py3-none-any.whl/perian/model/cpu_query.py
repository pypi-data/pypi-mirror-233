...
class CpuQuery(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["no", "cores", "threads", "speed", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["no", "cores", "threads", "speed", ], str]):
