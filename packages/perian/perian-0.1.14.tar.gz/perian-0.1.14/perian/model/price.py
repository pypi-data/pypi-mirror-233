...
class Price(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["per_hour", "unit", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["per_hour", "unit", ], str]):
