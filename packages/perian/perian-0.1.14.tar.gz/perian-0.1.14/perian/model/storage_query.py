...
class StorageQuery(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["no", "size", "type", "speed", "included", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["no", "size", "type", "speed", "included", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        included: typing.Union[MetaOapg.properties.included, str, schemas.Unset] = schemas.unset,
