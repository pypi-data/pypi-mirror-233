...
class GpuData(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class gpus(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Gpu'], typing.List['Gpu']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'gpus':
                    return super().__new__(
                        cls,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["no", "memory", "gpus", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["no", "memory", "gpus", ], str]):
