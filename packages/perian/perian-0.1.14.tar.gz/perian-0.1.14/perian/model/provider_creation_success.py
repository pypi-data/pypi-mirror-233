...
class ProviderCreationSuccess(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["status", "message", "detail", "status_code", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["status", "message", "detail", "status_code", ], str]):
