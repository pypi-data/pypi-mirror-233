...
class ModelsCommonBandwidth(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["sla"]) -> MetaOapg.properties.sla: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["speed", "maximum", "minimum", "unit", "sla", "limit", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["sla"]) -> typing.Union[MetaOapg.properties.sla, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["speed", "maximum", "minimum", "unit", "sla", "limit", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        sla: typing.Union[MetaOapg.properties.sla, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
