...
class Storage(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "size", "speed", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "size", "speed", ], str]):
