...
from perian import rest
from perian.configuration import Configuration
from perian.exceptions import ApiTypeError, ApiValueError
from perian.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/0.1.16/python'
