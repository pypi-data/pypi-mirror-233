...
class GetJobError(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["detail", "status", "message", "status_code", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["detail", "status", "message", "status_code", ], str]):
