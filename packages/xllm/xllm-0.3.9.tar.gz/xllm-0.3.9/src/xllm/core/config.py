...
class HuggingFaceConfig:
    ...
    stabilize: bool = field(
        default=True,
        metadata={
            "help": "Stabilize the model. Convert some weights to fp32",
        },
    )
    ...
    lora_hub_model_id: Optional[str] = field(
        default=None,
        metadata={
            "help": "Fusing LoRA. The name of the LoRA model at the hub for fusing. Example: KompleteAI/Shurale",
        },
    )
    ...
    quantized_hub_model_id: Optional[str] = field(
        default=None,
        metadata={
            "help": "The name of the model at the hub for GPTQ quantization. Example: KompleteAI/Shurale-GPTQ",
        },
    )
    ...
    hub_model_id: Optional[str] = field(
        default=None,
        metadata={
            "help": "The name of the model at the hub. Example: KompleteAI/Shurale",
        },
    )
    ...
    def dtype(self) -> torch.dtype:
        if not torch.cuda.is_available() or not self.apply_lora:
