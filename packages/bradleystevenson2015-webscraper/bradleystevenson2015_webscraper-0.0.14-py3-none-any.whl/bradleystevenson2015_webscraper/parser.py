    ...
    def parse(self, html_object, data_dict, webscraperObject):
        ...
        for object_url in self.object_urls_create_if_not_exist:
            try:
                ...
                return_dict[object_url['field_name']] = webscraperObject.get_webscraper_object_with_name(object_url['object_name']).create_from_page("https://www.basketbball-reference.com" + get_url_of_element_with_attributes(object_url['attributes']), webscraperObject)
        return return_dict
