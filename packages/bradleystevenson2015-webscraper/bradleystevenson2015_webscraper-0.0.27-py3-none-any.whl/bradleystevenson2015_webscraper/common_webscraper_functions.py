...
def get_value_of_field_from_element(field_dict):
    print("in get_value_of_field_from_element w/ field_dict " + str(field_dict))
    if field_dict['html_field_value'] == 'url':
        def return_function(html_object):
            print("in get_value_of_field_from_element.return_function1")
            return get_element(field_dict)(html_object).find('a')['href']
        return return_function
    elif field_dict['html_field_value'] == 'text':
        def return_function(html_object):
            print("in get_value_of_field_from_element.return_function2")
...
def get_value_from_element(field_dict):
    def return_function(html_object):
        print("in get_value_from_element.return_function")
        return_value = get_value_of_field_from_element(field_dict)(html_object)
