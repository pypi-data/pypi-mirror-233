...
# sources: Constants.proto, Core.proto, Datawatch.proto, Demo.proto, FeatureProviders.proto, Forecast.proto, ModelService.proto, Temporal.proto, Tests.proto
...
@dataclass
class MetricHistory(betterproto.Message):
    metric_configuration_id: int = betterproto.int32_field(1)
    metric_timeseries: List["MetricHistoryDataPoint"] = betterproto.message_field(2)


@dataclass
class MetricData(betterproto.Message):
    history: "MetricHistory" = betterproto.message_field(1)
    profile: "ColumnMetricProfile" = betterproto.message_field(2)
    prediction_epoch_seconds: List[int] = betterproto.int32_field(3)
...
class RowCreationTimeResponse(betterproto.Message):
    columns_set_as_row_creation_time: List[
        "IdAndDisplayName"
    ] = betterproto.message_field(1)
    row_creation_time_upsert_failures: List[
        "RowCreationTimeFailure"
    ] = betterproto.message_field(2)
    tables_with_row_creation_time_set: List[
        "IdAndDisplayName"
...
class MetricSuiteResponse(betterproto.Message):
    ...
    metric_application_errors: List[
...
@dataclass
class GenerateSuggestionsJob(betterproto.Message):
...
@dataclass
class RunComparisonTableJob(betterproto.Message):
...
class JobDefinition(betterproto.Message):
    ...
    run_comparison_table_job: "RunComparisonTableJob" = betterproto.message_field(
        9, group="job"
    )
    lineage_job: "LineageJob" = betterproto.message_field(10, group="job")
    workflow_cleanup_job: "WorkflowCleanupJob" = betterproto.message_field(
        11, group="job"
    )
...
@dataclass
class SuggestionFields(betterproto.Message):
    arg1: str = betterproto.string_field(1)


@dataclass
class Suggestion(betterproto.Message):
    id: int = betterproto.int32_field(1)
    state: str = betterproto.string_field(2)
    statistic_full_name: str = betterproto.string_field(3)
    fields: "SuggestionFields" = betterproto.message_field(4)


@dataclass
class SuggestionList(betterproto.Message):
    suggestions: List["Suggestion"] = betterproto.message_field(1)


@dataclass
class GenerateAutometricsRequest(betterproto.Message):
    dataset_id: int = betterproto.int32_field(1)
    workflow_info: "WorkflowInfo" = betterproto.message_field(2)
    always_profile: bool = betterproto.bool_field(3)
...
@dataclass
class LineageJob(betterproto.Message):
    entity_id: int = betterproto.int32_field(1)
    lineage_type: "LineageType" = betterproto.enum_field(2)
...
@dataclass
class AutometricAcceptRequest(betterproto.Message):
    metric_ids: List[int] = betterproto.int32_field(1)
    lookback_days: int = betterproto.int32_field(2)
    schedule_frequency: "TimeInterval" = betterproto.message_field(3)
    run_backfill: bool = betterproto.bool_field(4)
    metric_schedule: "MetricSchedule" = betterproto.message_field(5)


@dataclass
class FailedAutometricOperation(betterproto.Message):
    metric_id: int = betterproto.int32_field(1)
    reason: str = betterproto.string_field(2)


@dataclass
class AutometricAcceptResponse(betterproto.Message):
    metric_ids: List[int] = betterproto.int32_field(1)
    failed_autometric_accepts: List[
        "FailedAutometricOperation"
    ] = betterproto.message_field(2)


@dataclass
class AutometricRejectRequest(betterproto.Message):
    metric_ids: List[int] = betterproto.int32_field(1)


@dataclass
class AutometricRejectResponse(betterproto.Message):
    metric_ids: List[int] = betterproto.int32_field(1)
    failed_autometric_rejects: List[
        "FailedAutometricOperation"
    ] = betterproto.message_field(2)
...
class ComparisonTableInfo(betterproto.Message):
    ...
    metric_count: int = betterproto.int32_field(5)
...
class TableApplicableMetricTypes(betterproto.Message):
    id: int = betterproto.int32_field(1)
    applicable_metric_types: List[
        "ColumnApplicableMetricTypes"
    ] = betterproto.message_field(2)
...
@dataclass
class BulkAutometricUpdate(betterproto.Message):
    where: "WhereClause" = betterproto.message_field(1)
    state_update: "AutometricStateUpdate" = betterproto.message_field(2)


@dataclass
class AutometricStateUpdate(betterproto.Message):
    state: "MetricCreationState" = betterproto.enum_field(1)
    lookback_days: int = betterproto.int32_field(2)
    schedule_frequency: "TimeInterval" = betterproto.message_field(3)
    run_backfill: bool = betterproto.bool_field(4)
    metric_schedule: "MetricSchedule" = betterproto.message_field(5)
...
@dataclass
class ProvideFeedbackRequest(betterproto.Message):
    name: str = betterproto.string_field(1)
    email: str = betterproto.string_field(2)
    company_name: str = betterproto.string_field(3)
    feedback: str = betterproto.string_field(4)
    referer: str = betterproto.string_field(5)


@dataclass
class ProvideFeedbackResponse(betterproto.Message):
    ticket_url: str = betterproto.string_field(1)
...
class Delta(betterproto.Message):
    ...
    alerting_metric_count: int = betterproto.int32_field(7)
    total_metric_count: int = betterproto.int32_field(8)
    failed_metric_count: int = betterproto.int32_field(9)
...
class DeltaTargetInfo(betterproto.Message):
    ...
    comparison_metric_infos: List["ComparisonMetricInfo"] = betterproto.message_field(2)
    schema_match: bool = betterproto.bool_field(3)
    metric_count: int = betterproto.int32_field(4)
    failed_metric_count: int = betterproto.int32_field(5)
...
class DimensionRun(betterproto.Message):
    ...
    dim_observed_value: str = betterproto.string_field(2)


@dataclass
class InjectMetricRunRequest(betterproto.Message):
    stat_id: int = betterproto.int32_field(1)
    observed_value: float = betterproto.double_field(2)
    dimension_values: List["DimensionRun"] = betterproto.message_field(3)
    run_millis: int = betterproto.int64_field(4)
...
@dataclass
class FetchMetricRequest(betterproto.Message):
    id: int = betterproto.int32_field(1)


@dataclass
class AutoThresholdRequest(betterproto.Message):
    metric_data: "MetricData" = betterproto.message_field(1)
    metric_configuration: "MetricConfiguration" = betterproto.message_field(2)
...
@dataclass
class CalculateAutoThresholdPreamble(betterproto.Message):
    request: "AutoThresholdRequest" = betterproto.message_field(1)
    training_preamble: "TrainingPreamble" = betterproto.message_field(2)
    version_info: "VersionInfo" = betterproto.message_field(3)
...
class MetricServiceStub(betterproto.ServiceStub):
    ...
    async def accept_autometrics(
        ...
        *,
        ...
        if schedule_frequency is not None:
            request.schedule_frequency = schedule_frequency
        request.run_backfill = run_backfill
        if metric_schedule is not None:
            request.metric_schedule = metric_schedule

        return await self._unary_unary(
            "/com.bigeye.models.generated.MetricService/AcceptAutometrics",
            request,
            AutometricAcceptResponse,
        )

    async def reject_autometrics(
        self, *, metric_ids: List[int] = []
    ) -> AutometricRejectResponse:
        """Batch reject autometrics"""

        request = AutometricRejectRequest()
        request.metric_ids = metric_ids

        return await self._unary_unary(
            "/com.bigeye.models.generated.MetricService/RejectAutometrics",
            request,
            AutometricRejectResponse,
        )
    ...
    async def bulk_update_autometrics(
        self,
        *,
        where: Optional["WhereClause"] = None,
        state_update: Optional["AutometricStateUpdate"] = None,
    ) -> BulkResponse:
        """Performs bulk autometric updates"""

        request = BulkAutometricUpdate()
        if where is not None:
            request.where = where
        if state_update is not None:
            request.state_update = state_update

        return await self._unary_unary(
            "/com.bigeye.models.generated.MetricService/BulkUpdateAutometrics",
            request,
            BulkResponse,
        )
...
class AgentServiceStub(betterproto.ServiceStub):
    async def get_bigeye_public_key(self) -> PublicKeyMessage:
        """
        Gets the public key the user's company Agent should use when sending
        messages to Bigeye
        """
    ...
    async def get_company_public_key(self) -> PublicKeyMessage:
        """
        Gets the public key Bigeye currently has for the user's company Agent
        """
    ...
    async def set_company_public_key(self, *, public_key: str = "") -> PublicKeyMessage:
        """
        Sets the public key Bigeye will use to encrypt messages to the user's
        company Agent
        """
...
class GroupServiceStub(betterproto.ServiceStub):
    ...
    async def bulk_change_group_roles(
        self,
        *,
        role_ids: List[int] = [],
        group_id: int = 0,
        operation: "RoleOperation" = 0,
    ) -> BulkResponse:
        """Grant or revoke roles to a group"""

        request = BulkChangeGroupRolesRequest()
        request.role_ids = role_ids
        request.group_id = group_id
        request.operation = operation

        return await self._unary_unary(
            "/com.bigeye.models.generated.GroupService/BulkChangeGroupRoles",
            request,
            BulkResponse,
        )
