...
from bigeye_sdk.generated.com.bigeye.models.generated import Threshold, NotificationChannel, MetricRunFailureReason, \
    ForecastModelType, MetricInfo, MetricConfiguration, MetricParameter, MetricType, Table, LookbackType, \
    ConstantThreshold, SimpleBound, SimpleBoundType, SlackChannelInfo
from bigeye_sdk.log import get_logger
from bigeye_sdk.model.protobuf_enum_facade import SimpleMetricCategory, SimplePredefinedMetricName
from bigeye_sdk.model.protobuf_message_facade import SimplePredefinedMetric, SimpleMetricType

log = get_logger(__file__)


def _is_table_level_metric(metric_type: SimpleMetricType, table_level_metrics: List[SimplePredefinedMetricName]) -> bool:
