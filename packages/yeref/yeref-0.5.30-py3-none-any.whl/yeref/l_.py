...
l_cword_wrd = {
    'ru': "🚀 1/2 <b>Введи</b> отслеживаемые слова (более <u>3</u> символов) через <i>пробельные или разделительные</i> символы (без 🌬️Подписки: <u>5</u> слов): укажи символ * (в конце слова) чтобы учитывать вхождение\n\n👩🏽‍💻 <b>Отслеживаемые</b>  слова: <code>{0}</code>\n👩🏽‍💻 <b>Отслеживаемые</b> группы/каналы: <code>{1}</code>",
    'en': "👩🏽‍💻 <b>Enter</b> recipient Ids separated by spaces or separator characters",
    'es': "👩🏽‍💻 <b>Ingrese</b> las identificaciones de los destinatarios separadas por espacios o caracteres separadores",
    'fr': "👩🏽‍💻 <b>Entrez</b> les identifiants des destinataires séparés par des espaces ou des caractères de séparation",
    'zh': "👩🏽‍💻<b>输入</b>以空格或分隔符分隔的收件人 ID",
...
l_cword_src = {
    'ru': "🚀 2/2 <b>Вставь</b> @username/id групп/каналов (через <i>пробельные или разделительные</i> символы), в которых {0}-аккаунт участник, например: {0} (без 🌬️Подписки: <u>10</u> группа/канал)\n\n👩🏽‍💻 <b>Отслеживаемые</b>  слова: <code>{0}</code>\n👩🏽‍💻 <b>Отслеживаемые</b> группы/каналы: <code>{1}</code>",
    'en': "👩🏽‍💻 <b>Enter</b> recipient Ids separated by spaces or separator characters",
    'es': "👩🏽‍💻 <b>Ingrese</b> las identificaciones de los destinatarios separadas por espacios o caracteres separadores",
    'fr': "👩🏽‍💻 <b>Entrez</b> les identifiants des destinataires séparés par des espaces ou des caractères de séparation",
    'zh': "👩🏽‍💻<b>输入</b>以空格或分隔符分隔的收件人 ID",
...
l_find_alert_sources = {
    'ru': "👩🏽‍💻 2/2 <b>Вставь</b> публичные ссылки на группы/каналы (для отслеживаемых слов) через <i>пробельные или разделительные</i> символы (без 🌬️Подписки: <u>1</u> группа/канал)\n\n🔔 <b>Отслеживаемые</b>  слова: <code>{0}</code>\n🔔 <b>Отслеживаемые</b> группы/каналы: <code>{1}</code>",
    'en': "👩🏽‍💻 <b>Enter</b> recipient Ids separated by spaces or separator characters",
    'es': "👩🏽‍💻 <b>Ingrese</b> las identificaciones de los destinatarios separadas por espacios o caracteres separadores",
    'fr': "👩🏽‍💻 <b>Entrez</b> les identifiants des destinataires séparés par des espaces ou des caractères de séparation",
    'zh': "👩🏽‍💻<b>输入</b>以空格或分隔符分隔的收件人 ID",
