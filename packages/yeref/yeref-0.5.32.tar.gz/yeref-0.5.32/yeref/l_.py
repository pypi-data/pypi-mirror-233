...
l_creact_correct = {
    'ru': "🫶🏽 <b>Введи</b> корректное <b>число</b> креативных авто-эмоджи на последний пост канала\n\n👩🏽‍💻 Используй команду <code>/react {0}</code>, чтобы задать количество авто-эмоджи (без 🌬️Подписки: <u>{1}</u>)",
...
l_creact_on = {
    'ru': "🫶🏽 <b>Готово!</b> Текущее количество <b>авто-эмоджи</b> на пост канала установлено в значение <u>{0}</u> (без 🌬️Подписки: <u>{1}</u>)",
...
l_cview_on = {
    'ru': "👁️‍🗨️ <b>Готово!</b> Текущее количество <b>авто-просмотров</b> на последний пост канала установлено в значение <u>{0}</u> (без 🌬️Подписки: <u>{1}</u>)",
...
l_current_participants = {
    'ru': "🚶🏽 Для {0}<b>текущее количество</b> реальных подписчиков: <u>{1}</u>\n\n▪️ <b>Введи</b> <i>число</i> подписчиков, которое необходимо подписывать <b>ежедневно</b> от 1 до 3 (без 🌬️Подписки +{2}):",
...
l_cinvite_choose_cnt = {
    'ru': "🚶🏽 <b>Введи</b> <b>количество</b> пользователей для авто-инвайта, которые будут приглашаться ежедневно (без 🌬️Подписки: 1 польз)",
...
l_cword_wrd = {
    'ru': "🚀 1/2. <b>Введи</b> отслеживаемые слова (более <u>3</u> символов) через <i>пробелы/раздели</i> (без 🌬️Подписки: <u>5</u> слов): укажи символ * (в конце слова) чтобы учитывать вхождение\n\n👩🏽‍💻 <b>Отслеживаемые</b>  слова: <code>{0}</code>\n👩🏽‍💻 <b>Отслеживаемые</b> группы/каналы: <code>{1}</code>",
    'en': "👩🏽‍💻 <b>Enter</b> recipient Ids separated by spaces or separator characters",
    'es': "👩🏽‍💻 <b>Ingrese</b> las identificaciones de los destinatarios separadas por espacios o caracteres separadores",
    'fr': "👩🏽‍💻 <b>Entrez</b> les identifiants des destinataires séparés par des espaces ou des caractères de séparation",
    'zh': "👩🏽‍💻<b>输入</b>以空格或分隔符分隔的收件人 ID",
...
l_cword_src = {
    'ru': "🚀 2/2. <b>Введи</b> @username/id групп/каналов (через <i>пробелы/разделители</i>), в которых {0}-аккаунт участник, например: {0} (без 🌬️Подписки: <u>10</u> групп/каналов)\n\n👩🏽‍💻 <b>Отслеживаемые</b>  слова: <code>{1}</code>\n👩🏽‍💻 <b>Отслеживаемые</b> группы/каналы: <code>{2}</code>",
    'en': "👩🏽‍💻 <b>Enter</b> recipient Ids separated by spaces or separator characters",
    'es': "👩🏽‍💻 <b>Ingrese</b> las identificaciones de los destinatarios separadas por espacios o caracteres separadores",
    'fr': "👩🏽‍💻 <b>Entrez</b> les identifiants des destinataires séparés par des espaces ou des caractères de séparation",
    'zh': "👩🏽‍💻<b>输入</b>以空格或分隔符分隔的收件人 ID",
...
l_csend_choose_cnt = {
    'ru': "📨️ Введи <b>количество</b> сообщений для авто-рассылки, которое будет отправляться ежедневно (без 🌬️Подписки: 1 сообщ)",
