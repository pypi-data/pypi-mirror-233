...
class elastixParameterObject(itk.ITKCommonBasePython.itkDataObject):
    ...
    SetParameterMaps = _swig_new_instance_method(_elxParameterObjectPython.elastixParameterObject_SetParameterMaps)
    ...
    GetParameterMaps = _swig_new_instance_method(_elxParameterObjectPython.elastixParameterObject_GetParameterMaps)
    ...
    ReadParameterFiles = _swig_new_instance_method(_elxParameterObjectPython.elastixParameterObject_ReadParameterFiles)
    AddParameterFile = _swig_new_instance_method(_elxParameterObjectPython.elastixParameterObject_AddParameterFile)
    WriteParameterFile = _swig_new_static_method(_elxParameterObjectPython.elastixParameterObject_WriteParameterFile)
    WriteParameterFiles = _swig_new_static_method(_elxParameterObjectPython.elastixParameterObject_WriteParameterFiles)
...
elastixParameterObject_WriteParameterFile = _elxParameterObjectPython.elastixParameterObject_WriteParameterFile
elastixParameterObject_WriteParameterFiles = _elxParameterObjectPython.elastixParameterObject_WriteParameterFiles
