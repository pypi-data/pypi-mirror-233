...
if __name__ == '__main__':
    ...
    obj1 = Initials(
        AP_filepath=r'V:\Findep\Incoming\test\DevOps\ARAP Project\Project\Accounting Input Data\YTD07_2023\AP07YTD2023_02Aug2023.txt',
        report_date='07/31/2023',
        master_data=master_data,
        vendors=vendors, customers=customers, translated=translated

    )
    print(obj1.make_ap_df().to_clipboard())
