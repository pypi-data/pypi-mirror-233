...
class AffiliationScheme(BaseModel):
    """
    An enumeration.
    """
    __properties = []
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AffiliationScheme:
        """Create an instance of AffiliationScheme from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AffiliationScheme:
        """Create an instance of AffiliationScheme from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AffiliationScheme.parse_obj(obj)

        _obj = AffiliationScheme.parse_obj({
        })
        return _obj
