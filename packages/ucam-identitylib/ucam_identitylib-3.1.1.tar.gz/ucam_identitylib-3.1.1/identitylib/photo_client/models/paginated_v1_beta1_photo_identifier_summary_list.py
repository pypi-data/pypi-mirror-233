...
class PaginatedV1Beta1PhotoIdentifierSummaryList(BaseModel):
    ...
    results: Optional[conlist(V1Beta1PhotoIdentifierSummary)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedV1Beta1PhotoIdentifierSummaryList:
        """Create an instance of PaginatedV1Beta1PhotoIdentifierSummaryList from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedV1Beta1PhotoIdentifierSummaryList:
        """Create an instance of PaginatedV1Beta1PhotoIdentifierSummaryList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedV1Beta1PhotoIdentifierSummaryList.parse_obj(obj)

        _obj = PaginatedV1Beta1PhotoIdentifierSummaryList.parse_obj({
            "next": obj.get("next"),
            "previous": obj.get("previous"),
            "results": [V1Beta1PhotoIdentifierSummary.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
