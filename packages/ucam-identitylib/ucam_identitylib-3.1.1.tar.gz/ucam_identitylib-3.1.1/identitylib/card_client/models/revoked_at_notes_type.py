...
class RevokedAtNotesType(BaseModel):
    ...
    RevokedAtNotesType
    """
    change_of_role: StrictInt = Field(..., alias="changeOfRole")
    var_date: date = Field(..., alias="date")
    lost_by_cardholder: StrictInt = Field(..., alias="lostByCardholder")
    stolen: StrictInt = Field(...)
    __properties = ["changeOfRole", "date", "lostByCardholder", "stolen"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RevokedAtNotesType:
        """Create an instance of RevokedAtNotesType from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RevokedAtNotesType:
        """Create an instance of RevokedAtNotesType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RevokedAtNotesType.parse_obj(obj)

        _obj = RevokedAtNotesType.parse_obj({
            "change_of_role": obj.get("changeOfRole"),
            "var_date": obj.get("date"),
            "lost_by_cardholder": obj.get("lostByCardholder"),
            "stolen": obj.get("stolen")
        })
        return _obj
