...
class CardIdentifierSummaryRequest(BaseModel):
    ...
    value: constr(strict=True, min_length=1) = Field(..., description="The identifier's value")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardIdentifierSummaryRequest:
        """Create an instance of CardIdentifierSummaryRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardIdentifierSummaryRequest:
        """Create an instance of CardIdentifierSummaryRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CardIdentifierSummaryRequest.parse_obj(obj)

        _obj = CardIdentifierSummaryRequest.parse_obj({
