...
class CardNoteDestroyResponseType(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardNoteDestroyResponseType:
        """Create an instance of CardNoteDestroyResponseType from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardNoteDestroyResponseType:
        """Create an instance of CardNoteDestroyResponseType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CardNoteDestroyResponseType.parse_obj(obj)

        _obj = CardNoteDestroyResponseType.parse_obj({
