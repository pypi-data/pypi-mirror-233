...
class CardIdentifierAllowedActions(BaseModel):
    ...
    __properties = ["canCreateCardRequest", "canCreateCardRequestDetails"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardIdentifierAllowedActions:
        """Create an instance of CardIdentifierAllowedActions from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardIdentifierAllowedActions:
        """Create an instance of CardIdentifierAllowedActions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CardIdentifierAllowedActions.parse_obj(obj)

        _obj = CardIdentifierAllowedActions.parse_obj({
            "can_create_card_request": obj.get("canCreateCardRequest"),
            "can_create_card_request_details": obj.get("canCreateCardRequestDetails")
        })
        return _obj
