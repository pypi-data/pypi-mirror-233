...
class RevokedAtType(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RevokedAtType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RevokedAtType:
        """Create an instance of RevokedAtType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RevokedAtType.parse_obj(obj)

        _obj = RevokedAtType.parse_obj({
            "count": obj.get("count"),
