...
class CardRequestUpdateResponseType(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardRequestUpdateResponseType:
        """Create an instance of CardRequestUpdateResponseType from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardRequestUpdateResponseType:
        """Create an instance of CardRequestUpdateResponseType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CardRequestUpdateResponseType.parse_obj(obj)

        _obj = CardRequestUpdateResponseType.parse_obj({
