...
class PaginatedCardRequestSummaryList(BaseModel):
    ...
    results: Optional[conlist(CardRequestSummary)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedCardRequestSummaryList:
        """Create an instance of PaginatedCardRequestSummaryList from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedCardRequestSummaryList:
        """Create an instance of PaginatedCardRequestSummaryList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedCardRequestSummaryList.parse_obj(obj)

        _obj = PaginatedCardRequestSummaryList.parse_obj({
            "count": obj.get("count"),
            "next": obj.get("next"),
            "previous": obj.get("previous"),
            "results": [CardRequestSummary.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
