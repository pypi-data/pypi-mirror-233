...
class CardIdentifierDestroyResponseType(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardIdentifierDestroyResponseType:
        """Create an instance of CardIdentifierDestroyResponseType from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardIdentifierDestroyResponseType:
        """Create an instance of CardIdentifierDestroyResponseType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CardIdentifierDestroyResponseType.parse_obj(obj)

        _obj = CardIdentifierDestroyResponseType.parse_obj({
