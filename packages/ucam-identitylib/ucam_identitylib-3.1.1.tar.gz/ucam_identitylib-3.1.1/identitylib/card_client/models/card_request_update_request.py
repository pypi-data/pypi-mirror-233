...
class CardRequestUpdateRequest(BaseModel):
    ...
    __properties = ["action", "fields", "identifiers"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardRequestUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardRequestUpdateRequest:
        """Create an instance of CardRequestUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CardRequestUpdateRequest.parse_obj(obj)

        _obj = CardRequestUpdateRequest.parse_obj({
