...
class PermissionsApi(object):
    ...
    @validate_arguments
    def permissions_retrieve(self, **kwargs) -> Permissions:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the permissions_retrieve_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.permissions_retrieve_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def permissions_retrieve_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """List permissions  # noqa: E501
        ...
        >>> thread = api.permissions_retrieve_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Permissions, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method permissions_retrieve" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
