...
class PaginatedCardIdentifierSummaryList(BaseModel):
    ...
    results: Optional[conlist(CardIdentifierSummary)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedCardIdentifierSummaryList:
        """Create an instance of PaginatedCardIdentifierSummaryList from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedCardIdentifierSummaryList:
        """Create an instance of PaginatedCardIdentifierSummaryList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedCardIdentifierSummaryList.parse_obj(obj)

        _obj = PaginatedCardIdentifierSummaryList.parse_obj({
            "count": obj.get("count"),
            "next": obj.get("next"),
            "previous": obj.get("previous"),
            "results": [CardIdentifierSummary.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
