...
class InternalServerError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InternalServerError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InternalServerError:
        """Create an instance of InternalServerError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InternalServerError.parse_obj(obj)

        _obj = InternalServerError.parse_obj({
