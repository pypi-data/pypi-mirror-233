...
class PaginatedCardSummaryList(BaseModel):
    ...
    results: Optional[conlist(CardSummary)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedCardSummaryList:
        """Create an instance of PaginatedCardSummaryList from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedCardSummaryList:
        """Create an instance of PaginatedCardSummaryList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedCardSummaryList.parse_obj(obj)

        _obj = PaginatedCardSummaryList.parse_obj({
            "count": obj.get("count"),
            "next": obj.get("next"),
            "previous": obj.get("previous"),
            "results": [CardSummary.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
