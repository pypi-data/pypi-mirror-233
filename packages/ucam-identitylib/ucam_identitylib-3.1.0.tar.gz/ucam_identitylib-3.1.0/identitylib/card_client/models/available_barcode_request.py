...
class AvailableBarcodeRequest(BaseModel):
    ...
    """
    barcode: constr(strict=True, max_length=5, min_length=1) = Field(...)
    __properties = ["barcode"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AvailableBarcodeRequest:
        """Create an instance of AvailableBarcodeRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AvailableBarcodeRequest:
        """Create an instance of AvailableBarcodeRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AvailableBarcodeRequest.parse_obj(obj)

        _obj = AvailableBarcodeRequest.parse_obj({
