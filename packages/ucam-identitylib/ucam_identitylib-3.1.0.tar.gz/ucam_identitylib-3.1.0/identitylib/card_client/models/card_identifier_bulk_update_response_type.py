...
class CardIdentifierBulkUpdateResponseType(BaseModel):
    ...
    """
    details: conlist(CardIdentifierBulkUpdateDetails) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardIdentifierBulkUpdateResponseType:
        """Create an instance of CardIdentifierBulkUpdateResponseType from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardIdentifierBulkUpdateResponseType:
        """Create an instance of CardIdentifierBulkUpdateResponseType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CardIdentifierBulkUpdateResponseType.parse_obj(obj)

        _obj = CardIdentifierBulkUpdateResponseType.parse_obj({
            "details": [CardIdentifierBulkUpdateDetails.from_dict(_item) for _item in obj.get("details")] if obj.get("details") is not None else None
        })
        return _obj
