...
class AvailableBarcodeBatchInvalid(BaseModel):
    ...
    """
    barcode: StrictStr = Field(...)
    errors: conlist(Dict[str, Any]) = Field(...)
    __properties = ["barcode", "errors"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AvailableBarcodeBatchInvalid:
        """Create an instance of AvailableBarcodeBatchInvalid from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AvailableBarcodeBatchInvalid:
        """Create an instance of AvailableBarcodeBatchInvalid from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AvailableBarcodeBatchInvalid.parse_obj(obj)

        _obj = AvailableBarcodeBatchInvalid.parse_obj({
