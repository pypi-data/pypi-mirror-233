...
class CardRequestDistinctValues(BaseModel):
    ...
    """
    results: conlist(StrictStr) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardRequestDistinctValues:
        """Create an instance of CardRequestDistinctValues from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardRequestDistinctValues:
        """Create an instance of CardRequestDistinctValues from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CardRequestDistinctValues.parse_obj(obj)

        _obj = CardRequestDistinctValues.parse_obj({
