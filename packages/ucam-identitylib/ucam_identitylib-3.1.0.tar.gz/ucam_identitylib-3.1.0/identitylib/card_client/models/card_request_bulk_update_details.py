...
class CardRequestBulkUpdateDetails(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardRequestBulkUpdateDetails:
        """Create an instance of CardRequestBulkUpdateDetails from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardRequestBulkUpdateDetails:
        """Create an instance of CardRequestBulkUpdateDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CardRequestBulkUpdateDetails.parse_obj(obj)

        _obj = CardRequestBulkUpdateDetails.parse_obj({
