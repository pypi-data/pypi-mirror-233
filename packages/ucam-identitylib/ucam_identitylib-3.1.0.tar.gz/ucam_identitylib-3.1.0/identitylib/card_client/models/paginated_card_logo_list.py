...
class PaginatedCardLogoList(BaseModel):
    ...
    results: Optional[conlist(CardLogo)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedCardLogoList:
        """Create an instance of PaginatedCardLogoList from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedCardLogoList:
        """Create an instance of PaginatedCardLogoList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedCardLogoList.parse_obj(obj)

        _obj = PaginatedCardLogoList.parse_obj({
            "next": obj.get("next"),
            "previous": obj.get("previous"),
            "results": [CardLogo.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
