...
class PaginatedV1Beta1PhotoList(BaseModel):
    ...
    results: Optional[conlist(V1Beta1Photo)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedV1Beta1PhotoList:
        """Create an instance of PaginatedV1Beta1PhotoList from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedV1Beta1PhotoList:
        """Create an instance of PaginatedV1Beta1PhotoList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedV1Beta1PhotoList.parse_obj(obj)

        _obj = PaginatedV1Beta1PhotoList.parse_obj({
            "next": obj.get("next"),
            "previous": obj.get("previous"),
            "results": [V1Beta1Photo.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
