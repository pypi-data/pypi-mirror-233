...
class HTTPException(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HTTPException:
        """Create an instance of HTTPException from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HTTPException:
        """Create an instance of HTTPException from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HTTPException.parse_obj(obj)

        _obj = HTTPException.parse_obj({
