...
class CardIdentifierBulkUpdateDetails(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardIdentifierBulkUpdateDetails:
        """Create an instance of CardIdentifierBulkUpdateDetails from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardIdentifierBulkUpdateDetails:
        """Create an instance of CardIdentifierBulkUpdateDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CardIdentifierBulkUpdateDetails.parse_obj(obj)

        _obj = CardIdentifierBulkUpdateDetails.parse_obj({
