...
class CardBulkUpdateResponseType(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardBulkUpdateResponseType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardBulkUpdateResponseType:
        """Create an instance of CardBulkUpdateResponseType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CardBulkUpdateResponseType.parse_obj(obj)

        _obj = CardBulkUpdateResponseType.parse_obj({
