...
class CardRequestBulkUpdateRequest(BaseModel):
    ...
    """
    updates: conlist(CardRequestBulkUpdateElementRequest) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardRequestBulkUpdateRequest:
        """Create an instance of CardRequestBulkUpdateRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardRequestBulkUpdateRequest:
        """Create an instance of CardRequestBulkUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CardRequestBulkUpdateRequest.parse_obj(obj)

        _obj = CardRequestBulkUpdateRequest.parse_obj({
            "updates": [CardRequestBulkUpdateElementRequest.from_dict(_item) for _item in obj.get("updates")] if obj.get("updates") is not None else None
        })
        return _obj
