...
class CardRequestCreateTypeRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardRequestCreateTypeRequest:
        """Create an instance of CardRequestCreateTypeRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardRequestCreateTypeRequest:
        """Create an instance of CardRequestCreateTypeRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CardRequestCreateTypeRequest.parse_obj(obj)

        _obj = CardRequestCreateTypeRequest.parse_obj({
