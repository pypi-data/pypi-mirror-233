...
class AvailableBarcode(BaseModel):
    ...
    AvailableBarcode
    """
    barcode: constr(strict=True, max_length=5) = Field(...)
    ...
    __properties = ["barcode", "createdAt", "selfLink"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AvailableBarcode:
        """Create an instance of AvailableBarcode from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AvailableBarcode:
        """Create an instance of AvailableBarcode from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AvailableBarcode.parse_obj(obj)

        _obj = AvailableBarcode.parse_obj({
