...
class CardIdentifierBulkUpdateRequest(BaseModel):
    ...
    """
    updates: conlist(CardIdentifierBulkUpdateElementRequest) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardIdentifierBulkUpdateRequest:
        """Create an instance of CardIdentifierBulkUpdateRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardIdentifierBulkUpdateRequest:
        """Create an instance of CardIdentifierBulkUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CardIdentifierBulkUpdateRequest.parse_obj(obj)

        _obj = CardIdentifierBulkUpdateRequest.parse_obj({
            "updates": [CardIdentifierBulkUpdateElementRequest.from_dict(_item) for _item in obj.get("updates")] if obj.get("updates") is not None else None
        })
        return _obj
