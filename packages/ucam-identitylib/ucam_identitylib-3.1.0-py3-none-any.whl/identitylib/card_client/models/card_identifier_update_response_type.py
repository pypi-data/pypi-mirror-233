...
class CardIdentifierUpdateResponseType(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardIdentifierUpdateResponseType:
        """Create an instance of CardIdentifierUpdateResponseType from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardIdentifierUpdateResponseType:
        """Create an instance of CardIdentifierUpdateResponseType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CardIdentifierUpdateResponseType.parse_obj(obj)

        _obj = CardIdentifierUpdateResponseType.parse_obj({
