...
class AvailableBarcodeBatchRequest(BaseModel):
    ...
    """
    barcodes: conlist(constr(strict=True, min_length=1), max_items=1000, min_items=1) = Field(...)
    __properties = ["barcodes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AvailableBarcodeBatchRequest:
        """Create an instance of AvailableBarcodeBatchRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AvailableBarcodeBatchRequest:
        """Create an instance of AvailableBarcodeBatchRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AvailableBarcodeBatchRequest.parse_obj(obj)

        _obj = AvailableBarcodeBatchRequest.parse_obj({
