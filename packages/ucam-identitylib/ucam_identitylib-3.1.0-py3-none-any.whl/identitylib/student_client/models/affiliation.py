...
class Affiliation(BaseModel):
    ...
    """
    end: Optional[Any] = Field(None, description="The end date of this affiliation. May not be populated if not known.")
    scheme: AffiliationScheme = Field(...)
    start: Optional[Any] = Field(None, description="The start date of this affiliation. May not be populated if not known.")
    status: Optional[Any] = Field(..., description="A student's status within an affiliated entity. Currently this will be any of the Academic Careers documented within the [CamSIS Coding Manual](https://www.camsis.cam.ac.uk/technical/camsis-coding-manual).")
    value: Optional[Any] = Field(..., description="The value of this affiliation. This will be specific to the student management system, indicating an entity that this student is affiliated with.")
