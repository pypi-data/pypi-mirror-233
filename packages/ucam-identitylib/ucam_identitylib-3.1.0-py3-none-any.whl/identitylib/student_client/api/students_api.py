...
class StudentsApi(object):
    ...
    @validate_arguments
    def get_v1alpha2_student_students_identifier_get(self, identifier : Any, **kwargs) -> Student:  # noqa: E501
    ...
    @validate_arguments
    def get_v1alpha2_student_students_identifier_get_with_http_info(self, identifier : Any, **kwargs) -> ApiResponse:  # noqa: E501
        """Get a single student  # noqa: E501
    ...
    @validate_arguments
    def list_v1alpha2_recent_graduates_recent_graduates_get(self, affiliation : Annotated[Optional[Any], Field(description="An affiliation to filter by, in the format `<value>@<scheme>`. When included only graduates with a matching affiliation are returned.")] = None, cursor : Annotated[Optional[Any], Field(description="The cursor indicating a unique page of results - this should be auto generated on the `next` and `previous` fields and does not need to be manually added / updated.")] = None, **kwargs) -> PaginatedResultsStudent:  # noqa: E501
