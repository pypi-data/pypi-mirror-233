...
class Affiliation(BaseModel):
    ...
    """
    end: Optional[Any] = Field(None, description="The end date of this affiliation. May not be populated if the affiliation is open-ended.")
    ...
    status: Optional[Any] = Field(..., description="A staff member's status in relation to an affiliated entity. Currently this will be their job title or `report`, indicating that this person reports to the affiliated entity.")
    value: Optional[Any] = Field(..., description="The value of this affiliation. This will be specific to the human resources system, indicating an entity that this staff member is affiliated with.")
