...
class StaffMembersApi(object):
    ...
    @validate_arguments
    def get_v1alpha2_staff_member_staff_identifier_get(self, identifier : Any, **kwargs) -> StaffMember:  # noqa: E501
    ...
    @validate_arguments
    def get_v1alpha2_staff_member_staff_identifier_get_with_http_info(self, identifier : Any, **kwargs) -> ApiResponse:  # noqa: E501
        """Get a single staff member  # noqa: E501
    ...
    @validate_arguments
    def list_v1alpha2_staff_staff_get(self, affiliation : Annotated[Optional[Any], Field(description="An affiliation to filter by, in the format `<value>@<scheme>`. When included only the staff members with a matching affiliation are returned.")] = None, cursor : Annotated[Optional[Any], Field(description="The cursor indicating a unique page of results - this should be auto generated on the `next` and `previous` fields and does not need to be manually added / updated.")] = None, page_size : Annotated[Optional[Any], Field(description="The number of results to return per page. This is limited to 999 results, if a number over 999 is provided the results will be capped at 999. Defaults to 200.")] = None, **kwargs) -> PaginatedResultsStaffMember:  # noqa: E501
    ...
    @validate_arguments
    def list_v1alpha2_staff_staff_get_with_http_info(self, affiliation : Annotated[Optional[Any], Field(description="An affiliation to filter by, in the format `<value>@<scheme>`. When included only the staff members with a matching affiliation are returned.")] = None, cursor : Annotated[Optional[Any], Field(description="The cursor indicating a unique page of results - this should be auto generated on the `next` and `previous` fields and does not need to be manually added / updated.")] = None, page_size : Annotated[Optional[Any], Field(description="The number of results to return per page. This is limited to 999 results, if a number over 999 is provided the results will be capped at 999. Defaults to 200.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List staff members  # noqa: E501
