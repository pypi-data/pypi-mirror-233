...
class IdentifierScheme(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IdentifierScheme:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IdentifierScheme:
        """Create an instance of IdentifierScheme from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IdentifierScheme.parse_obj(obj)

        _obj = IdentifierScheme.parse_obj({
        })
        return _obj
