...
class CardUpdateResponseType(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardUpdateResponseType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardUpdateResponseType:
        """Create an instance of CardUpdateResponseType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CardUpdateResponseType.parse_obj(obj)

        _obj = CardUpdateResponseType.parse_obj({
