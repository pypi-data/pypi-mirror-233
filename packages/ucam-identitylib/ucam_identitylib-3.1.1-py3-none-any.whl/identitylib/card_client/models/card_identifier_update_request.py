...
class CardIdentifierUpdateRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardIdentifierUpdateRequest:
        """Create an instance of CardIdentifierUpdateRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardIdentifierUpdateRequest:
        """Create an instance of CardIdentifierUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CardIdentifierUpdateRequest.parse_obj(obj)

        _obj = CardIdentifierUpdateRequest.parse_obj({
