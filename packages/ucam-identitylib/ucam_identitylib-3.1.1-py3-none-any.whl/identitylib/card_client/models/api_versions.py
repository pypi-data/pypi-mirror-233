...
class APIVersions(BaseModel):
    ...
    APIVersions
    """
    v1alpha1: StrictStr = Field(...)
    v1beta1: StrictStr = Field(...)
    __properties = ["v1alpha1", "v1beta1"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> APIVersions:
        """Create an instance of APIVersions from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> APIVersions:
        """Create an instance of APIVersions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return APIVersions.parse_obj(obj)

        _obj = APIVersions.parse_obj({
            "v1alpha1": obj.get("v1alpha1"),
            "v1beta1": obj.get("v1beta1")
        })
        return _obj
