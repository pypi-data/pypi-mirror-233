...
class CardRFIDConfigListResponseType(BaseModel):
    ...
    """
    results: conlist(RFIDConfiguration) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardRFIDConfigListResponseType:
        """Create an instance of CardRFIDConfigListResponseType from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardRFIDConfigListResponseType:
        """Create an instance of CardRFIDConfigListResponseType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CardRFIDConfigListResponseType.parse_obj(obj)

        _obj = CardRFIDConfigListResponseType.parse_obj({
            "results": [RFIDConfiguration.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
