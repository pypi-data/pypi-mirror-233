...
class PaginatedCardNoteList(BaseModel):
    ...
    results: Optional[conlist(CardNote)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedCardNoteList:
        """Create an instance of PaginatedCardNoteList from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedCardNoteList:
        """Create an instance of PaginatedCardNoteList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedCardNoteList.parse_obj(obj)

        _obj = PaginatedCardNoteList.parse_obj({
            "next": obj.get("next"),
            "previous": obj.get("previous"),
            "results": [CardNote.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
