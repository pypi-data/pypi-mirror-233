...
class PaginatedAvailableBarcodeList(BaseModel):
    ...
    results: Optional[conlist(AvailableBarcode)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedAvailableBarcodeList:
        """Create an instance of PaginatedAvailableBarcodeList from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedAvailableBarcodeList:
        """Create an instance of PaginatedAvailableBarcodeList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedAvailableBarcodeList.parse_obj(obj)

        _obj = PaginatedAvailableBarcodeList.parse_obj({
            "count": obj.get("count"),
            "next": obj.get("next"),
            "previous": obj.get("previous"),
            "results": [AvailableBarcode.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
