...
class CardRequestBulkUpdateResponseType(BaseModel):
    ...
    """
    details: conlist(CardRequestBulkUpdateDetails) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardRequestBulkUpdateResponseType:
        """Create an instance of CardRequestBulkUpdateResponseType from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardRequestBulkUpdateResponseType:
        """Create an instance of CardRequestBulkUpdateResponseType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CardRequestBulkUpdateResponseType.parse_obj(obj)

        _obj = CardRequestBulkUpdateResponseType.parse_obj({
            "details": [CardRequestBulkUpdateDetails.from_dict(_item) for _item in obj.get("details")] if obj.get("details") is not None else None
        })
        return _obj
