...
class CollegeInstituionsIdsListResponseType(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CollegeInstituionsIdsListResponseType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CollegeInstituionsIdsListResponseType:
        """Create an instance of CollegeInstituionsIdsListResponseType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CollegeInstituionsIdsListResponseType.parse_obj(obj)

        _obj = CollegeInstituionsIdsListResponseType.parse_obj({
