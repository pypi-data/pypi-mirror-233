...
from eis.billing import rest
from eis.billing.configuration import Configuration
from eis.billing.exceptions import ApiTypeError, ApiValueError, ApiException, UnauthorizedException
from eis.billing.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CorrectionInvoicesApi()
        api_instance.create_correction_invoice  # this is an instance of the class Endpoint
        api_instance.create_correction_invoice()  # this invokes api_instance.create_correction_invoice.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_correction_invoice.callable or self.callable in this class
