...
class ToolbarController():
     ...
     def show_dosemap(self, engine):
         print(self.model.floorplan.geometry.pixel_size_cm)
         print(min(self.model.dosemap.grid.X.flatten()), max(self.model.dosemap.grid.X.flatten()))
         self.model.dosemap.engine = engine
         
         
         dosemap = self.parent.dosemapper.get_dosemap(self.model)
         print(min(dosemap.flatten()), max(dosemap.flatten()))
