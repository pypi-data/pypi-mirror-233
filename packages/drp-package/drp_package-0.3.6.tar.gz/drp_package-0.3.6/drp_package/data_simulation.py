...
def process_data_plan(data_json_plan):
    ...
    data_plan["loc_f"], data_plan['loc_h'], data_plan['loc_c'] = get_location(locations,
                                                                              data_plan['dict_factory_index'],
                                                                              data_plan['dict_depot_index'],
                                                                              data_plan['dict_customer_index'])
