...
# demand_customer_forcasting = create_database_demand( demand_matrix, data_encode_demand , data_json_plan, days_plan )
...
def write_file(data_json_plan, past_data ):
    ...
    supply_max_factory_forcasting, supply_min_factory_forcasting = create_database_supply( supply_matrix, data_encode_supply , data_json_plan, days_plan )
