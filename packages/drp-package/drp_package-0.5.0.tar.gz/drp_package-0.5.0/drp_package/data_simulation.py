...
# past_data = {}
# past_data['data_NM_TCO'] = pd.read_csv("NM_TCO_rawdata_298.csv")
# past_data['data_TCO_NPP'] = pd.read_csv("TCO_NPP_rawdata_298.csv")
# """# data plan"""
#
...
# simulation_plan(data_json_plan, past_data,days_plan =1 )
