...
from src.mb_cruise_migration.models.cruise.cruise_parameter import CruiseProjectParameter, CruiseSurveyParameter, CruiseDatasetParameter, CruiseFileParameter
...
class ShapeService(object):
    ...
    def delete_shape(self, shape_entity: Shape):
        self.cruise.db.delete(shape_entity)
