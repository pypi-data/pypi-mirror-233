...
class BaselineEngine(Model):
    ...
    def __init__(self, *, run: bool=None, permission_id: int=None, permission_code: str=None, permission_name: str=None, description: str=None, permission_category_name: str=None, is_licensed: bool=None, products=None, **kwargs) -> None:
        super(BaselineEngine, self).__init__(**kwargs)
        self.run = run
