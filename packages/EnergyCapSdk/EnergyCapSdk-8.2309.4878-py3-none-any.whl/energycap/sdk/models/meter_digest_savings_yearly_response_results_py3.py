...
class MeterDigestSavingsYearlyResponseResults(Model):
    ...
    def __init__(self, *, year: str=None, batcc_total_cost: float=None, total_cost: float=None, savings_total_cost: float=None, batcc_native_use: float=None, native_use: float=None, savings_native_use: float=None, batcc_common_use: float=None, common_use: float=None, savings_common_use: float=None, **kwargs) -> None:
