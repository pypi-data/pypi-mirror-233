...
class OtherSavingsResponse(Model):
    ...
    def __init__(self, *, other_savings_id: int=None, frequency: str=None, other_savings_category=None, description: str=None, start_period: int=None, end_period: int=None, annnual_cycle_start_month: int=None, annual_cycle_end_month: int=None, value: float=None, created_by=None, created_date=None, modified_by=None, modified_date=None, cost_unit=None, **kwargs) -> None:
        super(OtherSavingsResponse, self).__init__(**kwargs)
