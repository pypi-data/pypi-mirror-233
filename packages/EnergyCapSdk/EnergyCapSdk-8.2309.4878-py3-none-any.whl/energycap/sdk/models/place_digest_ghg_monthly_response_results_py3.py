...
class PlaceDigestGHGMonthlyResponseResults(Model):
    ...
    def __init__(self, *, period_name: str=None, calendar_period: int=None, calendar_year: int=None, fiscal_period: int=None, fiscal_year: int=None, equivalent_co2_emissions: float=None, **kwargs) -> None:
