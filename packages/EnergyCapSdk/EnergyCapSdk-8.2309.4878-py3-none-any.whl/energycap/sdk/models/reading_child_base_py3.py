...
class ReadingChildBase(Model):
    ...
    def __init__(self, *, observation_id: int=None, time=None, value: float=None, estimated: bool=None, note: str=None, **kwargs) -> None:
        super(ReadingChildBase, self).__init__(**kwargs)
