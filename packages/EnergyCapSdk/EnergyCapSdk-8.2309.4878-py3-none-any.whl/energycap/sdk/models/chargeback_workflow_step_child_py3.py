...
class ChargebackWorkflowStepChild(Model):
    ...
    def __init__(self, *, chargeback_workflow_step_id: int=None, chargeback_workflow_step_info: str=None, chargeback_workflow_step_description: str=None, chargeback_workflow_step_type: str=None, chargeback_workflow_step_order: int=None, chargeback_workflow=None, **kwargs) -> None:
        super(ChargebackWorkflowStepChild, self).__init__(**kwargs)
