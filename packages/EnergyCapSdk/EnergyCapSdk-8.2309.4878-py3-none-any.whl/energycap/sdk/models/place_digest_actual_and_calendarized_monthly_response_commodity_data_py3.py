...
class PlaceDigestActualAndCalendarizedMonthlyResponseCommodityData(Model):
    ...
    def __init__(self, *, commodity_code: str=None, commodity_info: str=None, commodity_id: int=None, common_use_unit=None, common_demand_unit=None, cost_unit=None, results=None, target_comparison=None, **kwargs) -> None:
