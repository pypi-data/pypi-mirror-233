...
class PlaceGroupDigestWeatherRankingResponse(Model):
    ...
    def __init__(self, *, high_weather_load: float=None, low_weather_load: float=None, average_weather_load: float=None, median_weather_load: float=None, high_non_weather_load: float=None, low_non_weather_load: float=None, average_non_weather_load: float=None, median_non_weather_load: float=None, results=None, place_group_id: int=None, place_group_code: str=None, place_group_info: str=None, place_group_display: str=None, benchmark_unit: str=None, benchmark_factor_unit: str=None, benchmark_value_unit: str=None, use_unit=None, cost_unit=None, updated=None, **kwargs) -> None:
