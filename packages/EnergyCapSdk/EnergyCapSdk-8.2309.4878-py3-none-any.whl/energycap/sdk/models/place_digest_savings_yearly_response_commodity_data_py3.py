...
class PlaceDigestSavingsYearlyResponseCommodityData(Model):
    ...
    def __init__(self, *, commodity_code: str=None, commodity_info: str=None, commodity_id: int=None, all_time_batcc_common_use: float=None, all_time_common_use: float=None, all_time_savings_common_use: float=None, all_time_batcc_global_use: float=None, all_time_global_use: float=None, all_time_savings_global_use: float=None, all_time_batcc_total_cost: float=None, all_time_total_cost: float=None, all_time_savings_total_cost: float=None, cost_unit=None, common_use_unit=None, results=None, **kwargs) -> None:
