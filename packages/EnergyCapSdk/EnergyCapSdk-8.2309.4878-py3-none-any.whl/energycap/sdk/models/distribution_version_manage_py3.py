...
class DistributionVersionManage(Model):
    ...
    :param name: Required. Name given to the version
    ...
    def __init__(self, *, name: str, begin_period: int, version_id: int=None, copy_version_id: int=None, workflow_step_id: int=None, end_period: int=None, **kwargs) -> None:
        super(DistributionVersionManage, self).__init__(**kwargs)
