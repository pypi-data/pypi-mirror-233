...
class BaselineLog(Model):
    ...
    :param warning_count: Number of meters processed with warning
    ...
    def __init__(self, *, status: str=None, success_count: int=None, warning_count: int=None, error_count: int=None, number_of_meters: int=None, **kwargs) -> None:
        super(BaselineLog, self).__init__(**kwargs)
        self.status = status
