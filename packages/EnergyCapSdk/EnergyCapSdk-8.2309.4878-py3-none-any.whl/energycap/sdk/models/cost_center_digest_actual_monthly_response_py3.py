...
class CostCenterDigestActualMonthlyResponse(Model):
    ...
    def __init__(self, *, cost_center_code: str=None, cost_center_info: str=None, cost_center_id: int=None, updated=None, global_use_unit=None, cost_unit=None, commodities=None, results=None, **kwargs) -> None:
