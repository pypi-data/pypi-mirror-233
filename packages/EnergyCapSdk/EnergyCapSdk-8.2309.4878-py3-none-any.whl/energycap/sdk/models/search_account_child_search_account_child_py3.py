...
class SearchAccountChildSearchAccountChild(Model):
    ...
    def __init__(self, *, account_code: str, account_info: str, account_id: int=None, active: bool=None, account_type=None, vendor=None, address=None, parent_path=None, has_calculated_meter: bool=None, has_split_parent_meter: bool=None, has_split_child_meter: bool=None, previous_account_code: str=None, **kwargs) -> None:
