...
class BillActionMove(Model):
    ...
    def __init__(self, *, ids=None, account_id: int=None, account_meter_ids=None, update_account_gls: bool=None, update_meter_gls: bool=None, update_record_scope_and_factor: bool=None, **kwargs) -> None:
