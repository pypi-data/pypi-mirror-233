...
class AccountResponse(Model):
    ...
    def __init__(self, *, account_id: int=None, account_meter_id: int=None, account_code: str=None, account_info: str=None, account_type=None, cost_center=None, vendor=None, contact=None, customer=None, active: bool=None, accrual_enabled: bool=None, address=None, deposit_paid=None, deposit_return=None, deposit_note: str=None, deposit_amount: float=None, memo: str=None, service_start=None, service_end=None, account_general_ledger=None, meters=None, created_by=None, created_date=None, modified_by=None, modified_date=None, cost_unit=None, has_calculated_meter: bool=None, has_split_parent_meter: bool=None, has_split_child_meter: bool=None, account_code_history=None, account_description: str=None, audit_enabled: bool=None, data_access_release_id: int=None, data_access_release_approved: bool=None, **kwargs) -> None:
        ...
        self.data_access_release_approved = data_access_release_approved
