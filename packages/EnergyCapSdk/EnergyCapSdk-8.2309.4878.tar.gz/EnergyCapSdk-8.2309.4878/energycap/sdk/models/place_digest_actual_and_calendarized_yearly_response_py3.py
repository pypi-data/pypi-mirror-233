...
class PlaceDigestActualAndCalendarizedYearlyResponse(Model):
    ...
    def __init__(self, *, place_code: str=None, place_info: str=None, place_id: int=None, target_comparison=None, results=None, updated=None, global_use_unit=None, cost_unit=None, commodities=None, **kwargs) -> None:
