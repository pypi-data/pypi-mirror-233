...
class AccountDigestActualYearlyResponse(Model):
    ...
    def __init__(self, *, account_code: str=None, account_info: str=None, account_id: int=None, global_use_unit=None, cost_unit=None, updated=None, results=None, commodities=None, **kwargs) -> None:
