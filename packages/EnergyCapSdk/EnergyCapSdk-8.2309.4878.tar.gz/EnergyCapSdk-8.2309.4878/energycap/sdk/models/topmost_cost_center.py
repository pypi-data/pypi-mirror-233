...
class TopmostCostCenter(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.is_multi_topmost_cost_center = kwargs.get('is_multi_topmost_cost_center', None)
        self.multi_topmost_cost_centers = kwargs.get('multi_topmost_cost_centers', None)
