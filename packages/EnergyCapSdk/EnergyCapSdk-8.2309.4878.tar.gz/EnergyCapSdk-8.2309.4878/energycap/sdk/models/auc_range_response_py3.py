...
class AucRangeResponse(Model):
    ...
    def __init__(self, *, commodity_cap_id: int=None, commodity=None, lower_limit_multiplier: float=None, upper_limit_multiplier: float=None, is_used: bool=None, **kwargs) -> None:
