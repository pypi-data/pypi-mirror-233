...
class ChannelEdit(Model):
    ...
    def __init__(self, *, interval_minutes: int, observation_type_code: str, channel_description: str=None, channel_import_id: str=None, channel_version=None, **kwargs) -> None:
