...
class BillCreate(Model):
    ...
    def __init__(self, *, account_id: int, begin_date, end_date, billing_period: int, manual_entry: bool, account_period: int=None, estimated: bool=None, statement_date=None, due_date=None, next_reading=None, control_code: str=None, invoice_number: str=None, note: str=None, meters=None, account_body_lines=None, **kwargs) -> None:
