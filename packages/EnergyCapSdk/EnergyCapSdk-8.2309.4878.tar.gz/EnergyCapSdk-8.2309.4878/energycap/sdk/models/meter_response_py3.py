...
class MeterResponse(Model):
    ...
    def __init__(self, *, meter_id: int=None, meter_code: str=None, meter_info: str=None, meter_type=None, channels=None, accounts=None, commodity=None, place=None, address=None, bill_entry_note: str=None, include_in_energy_star: bool=None, primary_use=None, created_by=None, created_date=None, modified_by=None, modified_date=None, properties=None, include_in_cost_avoidance: bool=None, route=None, meter_time_zone=None, active: bool=None, is_calculated_meter: bool=None, is_split_parent_meter: bool=None, is_split_child_meter: bool=None, use_unit=None, demand_unit=None, serial_number: str=None, serial_number_history=None, meter_description: str=None, wattics_data_point=None, emission_source=None, **kwargs) -> None:
        ...
        self.wattics_data_point = wattics_data_point
