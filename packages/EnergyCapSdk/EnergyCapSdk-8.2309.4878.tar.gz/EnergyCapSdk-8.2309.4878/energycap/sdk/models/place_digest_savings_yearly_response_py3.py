...
class PlaceDigestSavingsYearlyResponse(Model):
    ...
    def __init__(self, *, place_code: str=None, place_info: str=None, place_id: int=None, all_time_batcc_global_use: float=None, all_time_global_use: float=None, all_time_savings_global_use: float=None, all_time_batcc_total_cost: float=None, all_time_total_cost: float=None, all_time_savings_total_cost: float=None, results=None, updated=None, global_use_unit=None, cost_unit=None, commodities=None, **kwargs) -> None:
        super(PlaceDigestSavingsYearlyResponse, self).__init__(**kwargs)
