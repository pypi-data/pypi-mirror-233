...
class BillImportRequest(Model):
    ...
    :param file_name: Required. FileName for the import file. Should include
     extension.
     Example: fileABC.csv
    ...
    :param data: Required. The base64 encoded file. <span
    ...
    def __init__(self, *, file_name: str, data: str, profile_code: str=None, batch_settings=None, import_note: str=None, save_as_resolved: bool=None, comment: str=None, **kwargs) -> None:
        super(BillImportRequest, self).__init__(**kwargs)
