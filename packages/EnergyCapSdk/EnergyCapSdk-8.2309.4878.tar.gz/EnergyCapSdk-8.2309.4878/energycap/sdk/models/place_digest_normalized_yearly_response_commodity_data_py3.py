...
class PlaceDigestNormalizedYearlyResponseCommodityData(Model):
    ...
    def __init__(self, *, commodity_code: str=None, commodity_info: str=None, commodity_id: int=None, target_comparison=None, common_use_unit=None, results=None, **kwargs) -> None:
