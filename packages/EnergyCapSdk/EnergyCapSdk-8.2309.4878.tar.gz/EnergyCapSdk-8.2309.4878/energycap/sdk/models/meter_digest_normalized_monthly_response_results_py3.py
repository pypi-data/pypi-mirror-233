...
class MeterDigestNormalizedMonthlyResponseResults(Model):
    ...
    def __init__(self, *, period_name: str=None, calendar_period: int=None, calendar_year: int=None, fiscal_period: int=None, fiscal_year: int=None, days: int=None, cumulative_native_use: float=None, native_use: float=None, common_use: float=None, native_actual_demand: float=None, native_billed_demand: float=None, load_factor: float=None, **kwargs) -> None:
