...
class AccrualSettings(Model):
    ...
    def __init__(self, *, view: bool=None, run: bool=None, manage: bool=None, permission_id: int=None, permission_code: str=None, permission_name: str=None, description: str=None, permission_category_name: str=None, is_licensed: bool=None, products=None, **kwargs) -> None:
        super(AccrualSettings, self).__init__(**kwargs)
        self.view = view
        self.run = run
        self.manage = manage
