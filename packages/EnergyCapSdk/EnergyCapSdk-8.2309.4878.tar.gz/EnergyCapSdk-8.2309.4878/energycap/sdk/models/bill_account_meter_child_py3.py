...
class BillAccountMeterChild(Model):
    ...
    def __init__(self, *, account_id: int=None, meter_id: int=None, native_use: float=None, native_use_unit=None, direct_cost: float=None, direct_cost_unit=None, native_use_unit_cost: float=None, native_use_per_day: float=None, direct_cost_per_day: float=None, native_billed_demand: float=None, native_billed_demand_unit=None, native_actual_demand: float=None, native_actual_demand_unit=None, **kwargs) -> None:
