...
class PlaceDigestActualAndCalendarizedYearlyResponseCommodityResults(Model):
    ...
    def __init__(self, *, year: str=None, total_cost: float=None, common_use: float=None, common_use_unit_cost: float=None, global_use: float=None, global_use_unit_cost: float=None, common_demand: float=None, common_demand_unit_cost: float=None, **kwargs) -> None:
        super(PlaceDigestActualAndCalendarizedYearlyResponseCommodityResults, self).__init__(**kwargs)
        self.year = year
