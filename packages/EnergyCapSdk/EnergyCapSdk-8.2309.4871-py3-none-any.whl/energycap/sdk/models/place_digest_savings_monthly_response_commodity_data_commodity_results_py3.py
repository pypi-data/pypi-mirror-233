...
class PlaceDigestSavingsMonthlyResponseCommodityDataCommodityResults(Model):
    ...
    :param savings_common_use: Savings Global Use
    ...
    def __init__(self, *, period_name: str=None, calendar_period: int=None, calendar_year: int=None, fiscal_period: int=None, fiscal_year: int=None, savings_total_cost: float=None, savings_common_use: float=None, savings_global_use: float=None, **kwargs) -> None:
        super(PlaceDigestSavingsMonthlyResponseCommodityDataCommodityResults, self).__init__(**kwargs)
