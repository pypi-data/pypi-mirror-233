...
class ReportDistributionEditRequest(Model):
    """ReportDistributionEditRequest.

    All required parameters must be populated in order to send to Azure.

    :param enabled: Required. Indicates if the report distribution is
     currently enabled <span class='property-internal'>Required</span>
    :type enabled: bool
    ...
    def __init__(self, *, enabled: bool, report_distribution_name: str, report_filters, recipient_user_group_ids, email_subject: str, email_message: str, report_subscription_schedule_type_id: int, day_indicator_value: int, only_send_if_data: bool, report_format: str, reply_to_email: str=None, **kwargs) -> None:
        super(ReportDistributionEditRequest, self).__init__(**kwargs)
        self.enabled = enabled
        self.report_distribution_name = report_distribution_name
        self.report_filters = report_filters
        self.reply_to_email = reply_to_email
        self.recipient_user_group_ids = recipient_user_group_ids
