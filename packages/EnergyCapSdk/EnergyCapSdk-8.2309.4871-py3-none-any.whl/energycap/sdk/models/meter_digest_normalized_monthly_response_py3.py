...
class MeterDigestNormalizedMonthlyResponse(Model):
    ...
    def __init__(self, *, meter_code: str=None, meter_info: str=None, meter_id: int=None, updated=None, native_use_unit=None, native_demand_unit=None, common_use_unit=None, results=None, **kwargs) -> None:
        super(MeterDigestNormalizedMonthlyResponse, self).__init__(**kwargs)
