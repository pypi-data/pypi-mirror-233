...
class BillAccountMeterResponse(Model):
    ...
    def __init__(self, *, global_use: float=None, global_use_per_day: float=None, global_use_unit=None, native_use: float=None, native_use_per_day: float=None, native_use_unit=None, native_demand: float=None, native_demand_unit=None, native_billed_demand: float=None, native_billed_demand_unit=None, native_actual_demand: float=None, native_actual_demand_unit=None, common_use: float=None, common_use_per_day: float=None, common_use_unit=None, common_demand: float=None, common_demand_unit=None, common_billed_demand: float=None, common_billed_demand_unit=None, common_actual_demand: float=None, common_actual_demand_unit=None, direct_cost: float=None, direct_cost_per_day: float=None, proportional_cost: float=None, proportional_cost_per_day: float=None, cost_unit=None, bill_id: int=None, billing_period: int=None, begin_date=None, end_date=None, days: int=None, account=None, meter=None, **kwargs) -> None:
