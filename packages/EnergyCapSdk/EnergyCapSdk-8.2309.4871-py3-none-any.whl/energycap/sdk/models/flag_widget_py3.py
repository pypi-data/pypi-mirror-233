...
class FlagWidget(Model):
    ...
    def __init__(self, *, view_by: str=None, flag_status: str=None, total_cost: float=None, total_cost_recovery: float=None, flag_count: int=None, results=None, total_number_of_results: int=None, **kwargs) -> None:
