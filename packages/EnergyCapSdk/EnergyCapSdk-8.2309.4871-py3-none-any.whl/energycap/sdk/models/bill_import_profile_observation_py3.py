...
class BillImportProfileObservation(Model):
    ...
    :param column_index: Required.  <span
     class='property-internal'>Required</span> <span
     class='property-internal'>Must be between 1 and 2147483647</span>
    :type column_index: int
    :param observation_type_code: Required.  <span
    ...
    def __init__(self, *, column_index: int, observation_type_code: str, caption: str, unit_code: str, **kwargs) -> None:
        super(BillImportProfileObservation, self).__init__(**kwargs)
