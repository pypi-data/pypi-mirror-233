...
class FlagWidgetChild(Model):
    ...
    def __init__(self, *, item_id: int=None, item_display: str=None, item_type: str=None, parent_id: int=None, parent_display: str=None, parent_item_type: str=None, split_parent: bool=None, split_child: bool=None, calculated: bool=None, active: bool=None, cost: float=None, cost_recovery: float=None, flag_count: int=None, **kwargs) -> None:
