...
class BillAccountBodyLineEdit(Model):
    ...
    def __init__(self, *, observation_type_id: int, caption: str, body_line_id: int=None, special_charge_id: int=None, cost_unit_id: int=None, cost: float=None, **kwargs) -> None:
