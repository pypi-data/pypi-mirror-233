...
class MeterBillResponse(Model):
    ...
    def __init__(self, *, bill_id: int=None, batch=None, account=None, begin_date=None, end_date=None, billing_period: int=None, account_period: int=None, cost: float=None, cost_per_day: float=None, cost_per_unit: float=None, estimated: bool=None, approved: bool=None, approve_date=None, approved_by=None, exported: bool=None, export_date=None, exported_by=None, observation_method=None, statement_date=None, due_date=None, next_reading=None, control_code: str=None, invoice_number: str=None, invoice_pages: int=None, check_number: str=None, check_date=None, pay_status: str=None, cleared_date=None, created_by=None, created_date=None, modified_by=None, modified_date=None, void: bool=None, dirty: bool=None, import_verified: bool=None, accrual: bool=None, accrual_reversed: bool=None, accrual_reversed_date=None, export_hold: bool=None, gl_exported: bool=None, gl_exported_by=None, gl_export_date=None, from_vendor: bool=None, has_been_split: bool=None, was_split_date=None, trans_ref_num: str=None, payment_type: str=None, actual_amount_paid: float=None, assigned_to=None, assigned_date=None, pay_source: str=None, pay_to: str=None, previous_balance: float=None, balance_forward: float=None, current_charges: float=None, usage: float=None, use_per_day: float=None, use_unit=None, actual_demand: float=None, actual_demand_unit=None, billed_demand: float=None, billed_demand_unit=None, **kwargs) -> None:
