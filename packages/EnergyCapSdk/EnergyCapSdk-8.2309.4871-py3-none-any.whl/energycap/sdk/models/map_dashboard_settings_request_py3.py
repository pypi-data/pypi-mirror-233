...
class MapDashboardSettingsRequest(Model):
    ...
    def __init__(self, *, title: str, description: str=None, show_cost: bool=None, show_use: bool=None, show_ghg: bool=None, map_dashboard_filter=None, global_commodity_display: str=None, fixed_commodity_ids=None, **kwargs) -> None:
        ...
        self.map_dashboard_filter = map_dashboard_filter
        self.global_commodity_display = global_commodity_display
        self.fixed_commodity_ids = fixed_commodity_ids
