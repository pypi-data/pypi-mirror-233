...
class BillHistoryResponse(Model):
    ...
    def __init__(self, *, bill_id: int=None, billing_period: int=None, begin_date=None, end_date=None, created_date=None, total_cost: float=None, total_cost_unit=None, void: bool=None, accrual: bool=None, invoice_number: str=None, estimated: bool=None, due_date=None, statement_date=None, bill_account_meters=None, **kwargs) -> None:
