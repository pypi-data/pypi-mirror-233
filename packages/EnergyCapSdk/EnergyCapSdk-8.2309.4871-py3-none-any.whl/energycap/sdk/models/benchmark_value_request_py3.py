...
class BenchmarkValueRequest(Model):
    ...
    :param effective_date: Required. The effective date for the benchmark
     <span class='property-internal'>Required</span> <span
     class='property-internal'>Required</span>
    :type effective_date: datetime
    :param value: Required. The benchmark value <span
    ...
    def __init__(self, *, effective_date, value: float, **kwargs) -> None:
        super(BenchmarkValueRequest, self).__init__(**kwargs)
