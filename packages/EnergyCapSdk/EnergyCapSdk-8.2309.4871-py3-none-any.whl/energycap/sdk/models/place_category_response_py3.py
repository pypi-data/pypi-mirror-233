...
class PlaceCategoryResponse(Model):
    ...
    def __init__(self, *, place_group_category_id: int=None, place_group_category_code: str=None, place_group_category_info: str=None, auto_group: bool=None, number_of_groups: int=None, number_of_groups_with_visible_members: int=None, **kwargs) -> None:
