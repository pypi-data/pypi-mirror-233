...
class MeterGroupMemberChild(Model):
    ...
    def __init__(self, *, meter_id: int=None, meter_code: str=None, meter_info: str=None, meter_type=None, commodity=None, place=None, include_in_charts: bool=None, active: bool=None, is_calculated_meter: bool=None, is_split_parent_meter: bool=None, is_split_child_meter: bool=None, **kwargs) -> None:
