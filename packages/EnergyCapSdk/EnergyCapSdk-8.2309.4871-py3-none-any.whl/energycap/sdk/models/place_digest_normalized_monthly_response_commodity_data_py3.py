...
class PlaceDigestNormalizedMonthlyResponseCommodityData(Model):
    ...
    :type results:
     list[~energycap.sdk.models.PlaceDigestNormalizedMonthlyResponseCommodityResults]
    :param target_comparison:
    :type target_comparison:
     ~energycap.sdk.models.PlaceDigestNormalizedCommodityTargetComparisonMonthly
    """
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[PlaceDigestNormalizedMonthlyResponseCommodityResults]'},
        'target_comparison': {'key': 'targetComparison', 'type': 'PlaceDigestNormalizedCommodityTargetComparisonMonthly'},
    }

    def __init__(self, *, commodity_code: str=None, commodity_info: str=None, commodity_id: int=None, common_use_unit=None, common_demand_unit=None, results=None, target_comparison=None, **kwargs) -> None:
        super(PlaceDigestNormalizedMonthlyResponseCommodityData, self).__init__(**kwargs)
