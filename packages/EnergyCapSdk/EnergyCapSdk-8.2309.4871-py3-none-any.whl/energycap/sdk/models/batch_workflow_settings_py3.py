...
class BatchWorkflowSettings(Model):
    ...
    def __init__(self, *, batch_mode_enabled: bool=None, due_date=None, statement_date=None, invoice_number=None, control_code=None, next_reading=None, account_period_name=None, account_period_year=None, **kwargs) -> None:
