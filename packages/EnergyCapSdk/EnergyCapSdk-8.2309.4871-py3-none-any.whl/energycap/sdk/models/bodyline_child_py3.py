...
class BodylineChild(Model):
    ...
    def __init__(self, *, body_line_id: int=None, account_id: int=None, meter_id: int=None, display_order: int=None, caption: str=None, value: float=None, value_is_info_only: bool=None, cost: float=None, cost_is_info_only: bool=None, value_unit=None, cost_unit=None, observation_type=None, general_ledger=None, **kwargs) -> None:
