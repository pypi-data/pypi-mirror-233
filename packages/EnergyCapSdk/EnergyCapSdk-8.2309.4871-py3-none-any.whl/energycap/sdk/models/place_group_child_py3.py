...
class PlaceGroupChild(Model):
    ...
    def __init__(self, *, place_group_id: int=None, place_group_code: str=None, place_group_info: str=None, auto_group: bool=None, user_defined_auto_group: bool=None, **kwargs) -> None:
        super(PlaceGroupChild, self).__init__(**kwargs)
