...
class HierarchicalEmissionSource(Model):
    """HierarchicalEmissionSource.

    :param has_eum_meter: Indicates if the emission source has a EUM Meter
     link
    :type has_eum_meter: bool
    ...
    _attribute_map = {
        'has_eum_meter': {'key': 'hasEUMMeter', 'type': 'bool'},
    ...
    def __init__(self, *, has_eum_meter: bool=None, emission_source_id: int=None, emission_source_code: str=None, emission_source_info: str=None, active: bool=None, commodity=None, **kwargs) -> None:
        super(HierarchicalEmissionSource, self).__init__(**kwargs)
        self.has_eum_meter = has_eum_meter
