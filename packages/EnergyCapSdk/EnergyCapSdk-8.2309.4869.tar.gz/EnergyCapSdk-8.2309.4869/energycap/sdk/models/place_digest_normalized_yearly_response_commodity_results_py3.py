...
class PlaceDigestNormalizedYearlyResponseCommodityResults(Model):
    ...
    def __init__(self, *, year: str=None, common_use: float=None, global_use: float=None, **kwargs) -> None:
        super(PlaceDigestNormalizedYearlyResponseCommodityResults, self).__init__(**kwargs)
        self.year = year
