...
class DistributedReportsConfiguration(Model):
    ...
    def __init__(self, *, format: str=None, use_copy: bool=None, filters=None, clear_filters: bool=None, save_filters: bool=None, only_send_if_data: bool=None, file_name: str=None, distribution=None, **kwargs) -> None:
        super(DistributedReportsConfiguration, self).__init__(**kwargs)
        self.format = format
