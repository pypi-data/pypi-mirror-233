...
class AccountDigestActualMonthlyResponse(Model):
    ...
    def __init__(self, *, account_code: str=None, account_info: str=None, account_id: int=None, updated=None, global_use_unit=None, cost_unit=None, commodities=None, results=None, **kwargs) -> None:
