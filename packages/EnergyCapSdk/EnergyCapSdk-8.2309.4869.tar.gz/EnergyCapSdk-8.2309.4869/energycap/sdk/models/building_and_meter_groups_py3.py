...
class BuildingAndMeterGroups(Model):
    ...
    def __init__(self, *, create: bool=None, edit: bool=None, delete: bool=None, permission_id: int=None, permission_code: str=None, permission_name: str=None, description: str=None, permission_category_name: str=None, is_licensed: bool=None, products=None, **kwargs) -> None:
        super(BuildingAndMeterGroups, self).__init__(**kwargs)
        self.create = create
        self.edit = edit
        self.delete = delete
