...
class BillContainsLineItemDescriptionsSettingResponse(Model):
    ...
    def __init__(self, *, line_item_descriptions=None, setting_status: str=None, setting_code: str=None, setting_description: str=None, minimum_cost: int=None, assignees=None, **kwargs) -> None:
        super(BillContainsLineItemDescriptionsSettingResponse, self).__init__(**kwargs)
