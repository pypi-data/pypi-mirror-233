...
class OtherSavingsRequest(Model):
    ...
    def __init__(self, *, frequency: str, other_savings_category_id: int, description: str, start_period: int, value: float, end_period: int=None, annual_cycle_start_month: int=None, annual_cycle_end_month: int=None, **kwargs) -> None:
