...
class SubtractRequest(Model):
    ...
    def __init__(self, **kwargs):
        super(SubtractRequest, self).__init__(**kwargs)
        self.subtract_meter_ids = kwargs.get('subtract_meter_ids', None)
        self.subtract_meter_group_ids = kwargs.get('subtract_meter_group_ids', None)
