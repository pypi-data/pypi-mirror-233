...
class PlaceDigestActualAndCalendarizedMonthlyResponseResults(Model):
    ...
    :param cumulative_global_use: Cumulative Use
    ...
    def __init__(self, *, period_name: str=None, calendar_period: int=None, calendar_year: int=None, fiscal_period: int=None, fiscal_year: int=None, total_cost: float=None, cumulative_total_cost: float=None, global_use: float=None, cumulative_global_use: float=None, global_use_unit_cost: float=None, **kwargs) -> None:
        super(PlaceDigestActualAndCalendarizedMonthlyResponseResults, self).__init__(**kwargs)
