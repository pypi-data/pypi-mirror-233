...
class MeterDigestActualAndCalendarizedMonthlyResponse(Model):
    ...
    :type results:
     list[~energycap.sdk.models.MeterDigestActualAndCalendarizedMonthlyResponseResults]
    """
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[MeterDigestActualAndCalendarizedMonthlyResponseResults]'},
    }

    def __init__(self, *, meter_code: str=None, meter_info: str=None, meter_id: int=None, updated=None, native_use_unit=None, native_demand_unit=None, common_use_unit=None, cost_unit=None, results=None, **kwargs) -> None:
        super(MeterDigestActualAndCalendarizedMonthlyResponse, self).__init__(**kwargs)
