...
class PlaceGroupResponse(Model):
    ...
    def __init__(self, *, place_group_id: int=None, place_group_code: str=None, place_group_info: str=None, auto_group: bool=None, place_group_category=None, user_defined_auto_group: bool=None, last_updated=None, **kwargs) -> None:
        super(PlaceGroupResponse, self).__init__(**kwargs)
