...
class MeterAccountChild(Model):
    ...
    def __init__(self, *, account_meter_id: int=None, account_id: int=None, account_code: str=None, account_info: str=None, active: bool=None, has_calculated_meter: bool=None, has_split_parent_meter: bool=None, has_split_child_meter: bool=None, vendor=None, meter_general_ledger=None, account_general_ledger=None, vendor_type=None, start_date=None, end_date=None, data_access_release_id: int=None, **kwargs) -> None:
