...
class UpdateApprovedBills(Model):
    """UpdateApprovedBills.
    ...
    def __init__(self, *, edit: bool=None, delete: bool=None, permission_id: int=None, permission_code: str=None, permission_name: str=None, description: str=None, permission_category_name: str=None, is_licensed: bool=None, products=None, **kwargs) -> None:
        super(UpdateApprovedBills, self).__init__(**kwargs)
        self.edit = edit
        self.delete = delete
