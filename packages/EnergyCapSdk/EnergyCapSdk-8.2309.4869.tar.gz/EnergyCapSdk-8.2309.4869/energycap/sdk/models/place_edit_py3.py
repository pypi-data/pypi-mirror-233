...
class PlaceEdit(Model):
    ...
    def __init__(self, *, place_code: str, place_info: str, parent_place_id: int, place_type_id: int, primary_use_id: int=None, build_date=None, address=None, weather_station_code: str=None, place_description: str="Æ", **kwargs) -> None:
