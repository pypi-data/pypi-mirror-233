...
class FilterResponse(Model):
    ...
    def __init__(self, *, available_operator=None, caption: str=None, query_parameter_name: str=None, field_id: int=None, data_field_id: int=None, data_type=None, operator: str=None, value: str=None, required: bool=None, recommended: bool=None, hidden: bool=None, **kwargs) -> None:
