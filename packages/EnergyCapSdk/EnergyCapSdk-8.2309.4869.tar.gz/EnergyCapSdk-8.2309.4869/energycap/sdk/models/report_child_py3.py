...
class ReportChild(Model):
    ...
    def __init__(self, *, version: str=None, report_id: int=None, report_code: str=None, report_info: str=None, report_type=None, description: str=None, is_landscape: bool=None, last_updated=None, tags=None, export_formats=None, report_source: str=None, **kwargs) -> None:
