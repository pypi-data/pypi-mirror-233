...
class BillAccountBodyLineCreate(Model):
    ...
    def __init__(self, *, observation_type_id: int, caption: str, special_charge_id: int=None, cost_unit_id: int=None, cost: float=None, **kwargs) -> None:
        super(BillAccountBodyLineCreate, self).__init__(**kwargs)
