...
class PlaceDigestGHGMonthlyResponse(Model):
    ...
    def __init__(self, *, place_code: str=None, place_info: str=None, place_id: int=None, updated=None, equivalent_co2_emissions_unit=None, ghg_types=None, ghg_scopes=None, commodities=None, **kwargs) -> None:
