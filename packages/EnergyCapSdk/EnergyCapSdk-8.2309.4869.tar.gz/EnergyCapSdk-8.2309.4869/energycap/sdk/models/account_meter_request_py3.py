...
class AccountMeterRequest(Model):
    ...
    def __init__(self, *, account_id: int, meter_id: int, rate_id: int, begin_date=None, end_date=None, general_ledger_id: int=None, vendor_type_id: int=None, deregulated: bool=None, template_id: int=None, **kwargs) -> None:
