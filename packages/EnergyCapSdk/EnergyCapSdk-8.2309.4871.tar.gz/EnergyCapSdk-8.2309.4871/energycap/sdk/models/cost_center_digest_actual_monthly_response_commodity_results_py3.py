...
class CostCenterDigestActualMonthlyResponseCommodityResults(Model):
    ...
    def __init__(self, *, period_name: str=None, calendar_period: int=None, calendar_year: int=None, fiscal_period: int=None, fiscal_year: int=None, total_cost: float=None, common_use: float=None, common_use_unit_cost: float=None, global_use: float=None, global_use_unit_cost: float=None, **kwargs) -> None:
