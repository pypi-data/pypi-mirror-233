...
class AddressChildBase(Model):
    ...
    def __init__(self, *, line1: str=None, line2: str=None, line3: str="Æ", city: str=None, state: str=None, country: str=None, postal_code: str=None, latitude: float=None, longitude: float=None, **kwargs) -> None:
        super(AddressChildBase, self).__init__(**kwargs)
        self.line1 = line1
        self.line2 = line2
        self.line3 = line3
        self.city = city
