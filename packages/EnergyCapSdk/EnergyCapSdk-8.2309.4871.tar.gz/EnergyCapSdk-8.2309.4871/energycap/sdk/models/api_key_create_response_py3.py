...
class ApiKeyCreateResponse(Model):
    """ApiKeyCreateResponse.

    :param api_key: The API key. This value cannot be retrieved again after it
     is created.
    :type api_key: str
    ...
    def __init__(self, *, api_key: str=None, api_key_id: int=None, api_key_name: str=None, api_key_description: str=None, created_by=None, created_date=None, **kwargs) -> None:
        super(ApiKeyCreateResponse, self).__init__(**kwargs)
