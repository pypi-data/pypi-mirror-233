...
class ListResponseListField(Model):
    ...
    def __init__(self, *, field_id: int=None, width: int=None, display_order: int=None, sortable: bool=None, caption: str=None, sort_direction: str=None, sort_order: int=None, data_type_code: str=None, required_output: bool=None, visible: bool=None, **kwargs) -> None:
