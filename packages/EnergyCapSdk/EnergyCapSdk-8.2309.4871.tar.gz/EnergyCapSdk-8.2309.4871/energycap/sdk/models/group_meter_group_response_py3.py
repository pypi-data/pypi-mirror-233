...
class GroupMeterGroupResponse(Model):
    ...
    def __init__(self, *, meter_group_id: int=None, meter_group_code: str=None, meter_group_info: str=None, auto_group: bool=None, member_count: int=None, member_count_with_topmost: int=None, meter_group_category=None, limit_members_by_topmost: bool=None, user_defined_auto_group: bool=None, user_defined_auto_group_filters=None, last_updated=None, member_commodity_code: str=None, **kwargs) -> None:
