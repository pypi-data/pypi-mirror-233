...
class PlaceDigestSavingsMonthlyResponseCommodityData(Model):
    ...
    :type results:
     list[~energycap.sdk.models.PlaceDigestSavingsMonthlyResponseCommodityDataCommodityResults]
    """
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[PlaceDigestSavingsMonthlyResponseCommodityDataCommodityResults]'},
    }

    def __init__(self, *, commodity_code: str=None, commodity_info: str=None, commodity_id: int=None, common_use_unit=None, cost_unit=None, results=None, **kwargs) -> None:
        super(PlaceDigestSavingsMonthlyResponseCommodityData, self).__init__(**kwargs)
