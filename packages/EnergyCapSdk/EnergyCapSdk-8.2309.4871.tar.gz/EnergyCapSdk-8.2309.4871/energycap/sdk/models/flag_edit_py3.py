...
class FlagEdit(Model):
    ...
    def __init__(self, *, flag_type_id: int=None, flag_status_id: int=None, cost_recovery: float=None, comment: str=None, assignees=None, release_export_hold: bool=None, hold_from_export: bool=None, **kwargs) -> None:
