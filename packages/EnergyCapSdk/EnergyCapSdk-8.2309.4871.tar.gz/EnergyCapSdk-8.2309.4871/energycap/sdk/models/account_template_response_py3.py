...
class AccountTemplateResponse(Model):
    ...
    def __init__(self, *, form_template_id: int=None, template_info: str=None, template_code: str=None, start_date=None, end_date=None, display_order: int=None, meter=None, **kwargs) -> None:
