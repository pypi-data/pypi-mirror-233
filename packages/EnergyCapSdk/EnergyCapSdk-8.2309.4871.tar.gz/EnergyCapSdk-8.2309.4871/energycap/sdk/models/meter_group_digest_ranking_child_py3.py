...
class MeterGroupDigestRankingChild(Model):
    ...
    def __init__(self, *, cost: float=None, use: float=None, unit_cost: float=None, value: float=None, days: int=None, savings_opportunity: float=None, meter_id: int=None, meter_code: str=None, meter_info: str=None, meter_display: str=None, commodity=None, include_in_charts: bool=None, active: bool=None, is_calculated_meter: bool=None, is_split_parent_meter: bool=None, is_split_child_meter: bool=None, **kwargs) -> None:
