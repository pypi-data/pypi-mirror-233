...
class ObservationRule(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.observation_rule_id = kwargs.get('observation_rule_id', None)
        self.observation_rule_code = kwargs.get('observation_rule_code', None)
        self.observation_rule_info = kwargs.get('observation_rule_info', None)
