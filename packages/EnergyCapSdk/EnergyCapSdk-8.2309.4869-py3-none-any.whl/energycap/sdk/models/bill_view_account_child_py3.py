...
class BillViewAccountChild(Model):
    ...
    def __init__(self, *, account_id: int=None, account_code: str=None, account_info: str=None, audit_enabled: bool=None, account_type=None, address=None, vendor=None, general_ledger=None, **kwargs) -> None:
