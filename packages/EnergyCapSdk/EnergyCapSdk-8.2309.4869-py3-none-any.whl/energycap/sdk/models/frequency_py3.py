...
class Frequency(Model):
    ...
    def __init__(self, *, frequency: str=None, start_date=None, end_date=None, annual_cycle_start_mmdd: int=None, annual_cycle_end_mmdd: int=None, annual_cycle_start_info: str=None, annual_cycle_end_info: str=None, **kwargs) -> None:
