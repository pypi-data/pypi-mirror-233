...
class PlaceDigestTargetComparisonMonthlyResults(Model):
    ...
    def __init__(self, *, period_name: str=None, calendar_period: int=None, calendar_year: int=None, fiscal_period: int=None, fiscal_year: int=None, total_cost: float=None, **kwargs) -> None:
        super(PlaceDigestTargetComparisonMonthlyResults, self).__init__(**kwargs)
