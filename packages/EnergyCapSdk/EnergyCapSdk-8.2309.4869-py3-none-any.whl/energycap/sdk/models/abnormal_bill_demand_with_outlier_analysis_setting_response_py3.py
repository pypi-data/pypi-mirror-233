...
class AbnormalBillDemandWithOutlierAnalysisSettingResponse(Model):
    ...
    def __init__(self, *, sensitivity: str=None, setting_status: str=None, setting_code: str=None, setting_description: str=None, minimum_cost: int=None, assignees=None, **kwargs) -> None:
        super(AbnormalBillDemandWithOutlierAnalysisSettingResponse, self).__init__(**kwargs)
