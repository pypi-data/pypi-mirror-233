...
class BillContainsLineItemTypesSettingRequest(Model):
    ...
    def __init__(self, *, line_item_types=None, setting_status: str=None, minimum_cost: int=None, assignees=None, **kwargs) -> None:
        super(BillContainsLineItemTypesSettingRequest, self).__init__(**kwargs)
