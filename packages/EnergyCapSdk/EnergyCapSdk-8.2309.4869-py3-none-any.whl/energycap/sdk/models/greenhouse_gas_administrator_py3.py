...
class GreenhouseGasAdministrator(Model):
    ...
    def __init__(self, *, manage: bool=None, permission_id: int=None, permission_code: str=None, permission_name: str=None, description: str=None, permission_category_name: str=None, is_licensed: bool=None, products=None, **kwargs) -> None:
        super(GreenhouseGasAdministrator, self).__init__(**kwargs)
        self.manage = manage
