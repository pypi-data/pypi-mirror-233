...
class MeterEdit(Model):
    ...
    def __init__(self, *, meter_code: str, meter_info: str, place_id: int, commodity_id: int, meter_time_zone_id: int, active: bool, address=None, bill_entry_note: str=None, include_in_energy_star: bool=None, primary_use_id: int=None, properties=None, use_unit_id: int=None, demand_unit_id: int=None, meter_description: str="Æ", **kwargs) -> None:
