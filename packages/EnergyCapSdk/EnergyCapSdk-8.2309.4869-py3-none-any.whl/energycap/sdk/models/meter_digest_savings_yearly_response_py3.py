...
class MeterDigestSavingsYearlyResponse(Model):
    ...
    def __init__(self, *, meter_id: int=None, meter_code: str=None, meter_info: str=None, meter_cap=None, native_use_unit=None, common_use_unit=None, cost_unit=None, all_time_batcc_native_use: float=None, all_time_native_use: float=None, all_time_savings_native_use: float=None, all_time_batcc_common_use: float=None, all_time_common_use: float=None, all_time_savings_common_use: float=None, all_time_batcc_total_cost: float=None, all_time_total_cost: float=None, all_time_savings_total_cost: float=None, updated=None, savings_start_date=None, results=None, **kwargs) -> None:
