...
class BaselineProcessorResponseBaselineBill(Model):
    ...
    def __init__(self, *, bill_id: int=None, avg_cooling_degree_days: float=None, avg_heating_degree_days: float=None, begin_date=None, end_date=None, is_excluded: bool=None, is_outlier: bool=None, native_use: float=None, days: int=None, period_name: str=None, calendar_period: int=None, calendar_year: int=None, fiscal_period: int=None, fiscal_year: int=None, **kwargs) -> None:
