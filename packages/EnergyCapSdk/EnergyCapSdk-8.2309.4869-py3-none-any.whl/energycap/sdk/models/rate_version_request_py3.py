...
class RateVersionRequest(Model):
    ...
    def __init__(self, *, effective_date, note: str=None, use_unit_cost: float=None, use_unit_id: int=None, demand_unit_cost: float=None, demand_unit_id: int=None, account_line_items=None, meter_line_items=None, udfs=None, **kwargs) -> None:
