...
class PreferenceRequest(Model):
    ...
    def __init__(self, *, meters_show_inactive: bool=None, show_data_source: bool=None, building_tree_display_setting: str=None, accounts_show_inactive: bool=None, emission_sources_show_inactive: bool=None, cost_center_tree_display_setting: str=None, building_tree_group_to_display: int=None, vendor_tree_display_setting: str=None, view_vendors_tree_by_commodity: bool=None, group_display_setting=None, bill_list_rows_per_page: int=None, date_format: str=None, time_format: str=None, time_zone_code: str=None, trend_chart_number_of_years: int=None, language: str=None, building_and_organization_identifier: str=None, meter_identifier: str=None, account_identifier: str=None, other_identifier: str=None, collection_identifier: str=None, emission_source_identifier: str=None, help_open: bool=None, workflow_display_setting=None, **kwargs) -> None:
