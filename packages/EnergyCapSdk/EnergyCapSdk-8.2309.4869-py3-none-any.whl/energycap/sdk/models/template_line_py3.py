...
class TemplateLine(Model):
    ...
    def __init__(self, *, template_line_id: int=None, begin_day: int=None, end_day: int=None, display_order: int=None, caption: str=None, help_tag: str=None, is_required: bool=None, from_prev_template_line_id: int=None, unit=None, cost_unit=None, commodity=None, observation_type=None, **kwargs) -> None:
