...
class RateVersionResponse(Model):
    ...
    def __init__(self, *, version_id: int=None, begin_date=None, end_date=None, created_date=None, modified_date=None, note: str=None, created_by=None, modified_by=None, use_unit_cost: float=None, use_unit=None, demand_unit_cost: float=None, demand_unit=None, cost_unit=None, account_line_items=None, meter_line_items=None, udfs=None, **kwargs) -> None:
