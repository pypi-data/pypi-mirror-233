...
class WeatherStationSummary(Model):
    ...
    def __init__(self, *, begin_date=None, earliest_reading_date=None, weather_station_id: int=None, weather_station_code: str=None, weather_station_name: str=None, base_weather_station_code: str=None, number_of_readings_imported: int=None, number_of_failed_readings: int=None, channel_id: int=None, channel_code: str=None, channel_interval_in_seconds: int=None, **kwargs) -> None:
