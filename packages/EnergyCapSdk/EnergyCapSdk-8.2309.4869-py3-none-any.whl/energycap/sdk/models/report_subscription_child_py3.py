...
class ReportSubscriptionChild(Model):
    ...
    def __init__(self, *, report_subscription_id: int=None, user=None, email_recipient: str=None, email_subject: str=None, email_message: str=None, report_format: str=None, schedule_type=None, day_indicator=None, only_send_if_data: bool=None, **kwargs) -> None:
