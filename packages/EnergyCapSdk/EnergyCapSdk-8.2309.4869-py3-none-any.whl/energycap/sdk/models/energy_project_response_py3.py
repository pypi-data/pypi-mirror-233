...
class EnergyProjectResponse(Model):
    ...
    def __init__(self, *, energy_project_code: str, energy_project_info: str, energy_project_id: int=None, installation_begin_date=None, installation_end_date=None, installation_cost: float=None, utility_rebate: float=None, funding_source: str=None, project_manager: str=None, note: str=None, energy_savings=None, cost_savings=None, place=None, energy_project_type=None, **kwargs) -> None:
