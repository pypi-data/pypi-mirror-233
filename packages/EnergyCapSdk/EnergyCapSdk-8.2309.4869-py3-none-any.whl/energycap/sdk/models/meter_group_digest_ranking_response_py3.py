...
class MeterGroupDigestRankingResponse(Model):
    ...
    _attribute_map = {
        ...
        'high_unit_cost': {'key': 'highUnitCost', 'type': 'float'},
        'low_unit_cost': {'key': 'lowUnitCost', 'type': 'float'},
        'average_unit_cost': {'key': 'averageUnitCost', 'type': 'float'},
        'median_unit_cost': {'key': 'medianUnitCost', 'type': 'float'},
        ...
        'results': {'key': 'results', 'type': '[MeterGroupDigestRankingChild]'},
    ...
    def __init__(self, *, high_cost: float=None, low_cost: float=None, average_cost: float=None, median_cost: float=None, high_use: float=None, low_use: float=None, average_use: float=None, median_use: float=None, high_unit_cost: float=None, low_unit_cost: float=None, average_unit_cost: float=None, median_unit_cost: float=None, high_value: float=None, low_value: float=None, average_value: float=None, median_value: float=None, cost_unit=None, use_unit=None, benchmark_unit: str=None, benchmark_value_unit: str=None, benchmark_factor_unit: str=None, high_savings_opportunity: float=None, results=None, meter_group_id: int=None, meter_group_code: str=None, meter_group_info: str=None, meter_group_display: str=None, updated=None, **kwargs) -> None:
        ...
        self.high_unit_cost = high_unit_cost
        self.low_unit_cost = low_unit_cost
        self.average_unit_cost = average_unit_cost
        self.median_unit_cost = median_unit_cost
