...
class CalculateSavingsRequest(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.skip_special_adjustment_option = kwargs.get('skip_special_adjustment_option', None)
        self.special_adjustment_type_id_to_ignore = kwargs.get('special_adjustment_type_id_to_ignore', None)
