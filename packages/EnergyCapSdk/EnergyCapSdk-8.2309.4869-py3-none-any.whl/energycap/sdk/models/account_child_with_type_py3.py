...
class AccountChildWithType(Model):
    ...
    def __init__(self, *, account_type=None, account_id: int=None, account_code: str=None, account_info: str=None, vendor=None, active: bool=None, has_calculated_meter: bool=None, has_split_parent_meter: bool=None, has_split_child_meter: bool=None, **kwargs) -> None:
