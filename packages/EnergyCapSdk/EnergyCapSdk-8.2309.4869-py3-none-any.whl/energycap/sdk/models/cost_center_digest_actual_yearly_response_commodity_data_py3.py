...
class CostCenterDigestActualYearlyResponseCommodityData(Model):
    ...
    :type results:
     list[~energycap.sdk.models.CostCenterDigestActualYearlyResponseCommodityResults]
    """
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[CostCenterDigestActualYearlyResponseCommodityResults]'},
    }
    ...
    def __init__(self, *, commodity_code: str=None, commodity_info: str=None, commodity_id: int=None, common_use_unit=None, cost_unit=None, results=None, **kwargs) -> None:
        super(CostCenterDigestActualYearlyResponseCommodityData, self).__init__(**kwargs)
