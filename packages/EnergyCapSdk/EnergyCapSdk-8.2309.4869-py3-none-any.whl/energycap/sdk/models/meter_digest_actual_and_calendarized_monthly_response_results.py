...
class MeterDigestActualAndCalendarizedMonthlyResponseResults(Model):
    ...
    def __init__(self, **kwargs):
        super(MeterDigestActualAndCalendarizedMonthlyResponseResults, self).__init__(**kwargs)
        ...
        self.native_actual_demand_unit_cost = kwargs.get('native_actual_demand_unit_cost', None)
        self.native_billed_demand = kwargs.get('native_billed_demand', None)
        self.native_billed_demand_unit_cost = kwargs.get('native_billed_demand_unit_cost', None)
