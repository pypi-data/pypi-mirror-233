...
class UserResponse(Model):
    ...
    def __init__(self, *, user_id: int=None, user_code: str=None, full_name: str=None, user_role=None, cost_center=None, place=None, collection=None, active_directory: bool=None, active: bool=None, email: str=None, password_expiration_interval: int=None, strong_password: bool=None, force_password_change: bool=None, max_approval_amount: int=None, last_login=None, report_group=None, external_user_id: str=None, user_groups=None, **kwargs) -> None:
