...
class BaseStructureCollection():
    ...
    def _overlay_structure_on_mesh_(self, structure_list: list, mesh: numpy.ndarray, coordinate_system: Axis) -> numpy.ndarray:
        """
...
class GenericFiber(BaseStructureCollection):
    ...
    def render_raster_on_ax(self, ax: Axis, structure, coordinate_system: Axes) -> None:
    ...
    def render_mesh_on_ax(self, ax: Axis, coordinate_system: Axes):
        """
    ...
    def render_gradient_on_ax(self, ax: Axis, coordinate_system: Axes) -> None:
        """
    ...
    def shift_coordinates(self, coordinate_system: Axis, x_shift: float, y_shift: float) -> numpy.ndarray:
        """
