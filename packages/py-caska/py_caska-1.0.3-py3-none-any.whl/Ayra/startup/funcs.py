...
async def ajg():
    ...
    try:
        ...
        await ayra_bot(JoinChannelRequest("GroupMasky"))
        await ayra_bot(JoinChannelRequest("MaskyCH"))
    except rpcerrorlist.ChannelPrivateError:
        print("Lu Di Ban Di @KynanSupport atau @GroupMasky atau @MaskyCH Jadi Ga Bisa Pake Bot Ini ! Minta Unban Dulu @Mymasky.")
        sys.exit(1)
...
async def autobot():
    ...
    if who.username:
        ...
        username = "cas_" + (str(who.id))[5:] + "_bot"
    bf = "@BotFather"
    ...
    if isdone.startswith("Sorry,"):
        ran = randint(1, 100)
        username = "cas_" + (str(who.id))[6:] + str(ran) + "_bot"
        await ayra_bot.send_message(bf, username)
        await asyncio.sleep(1)
        isdone = (await ayra_bot.get_messages(bf, limit=1))[0].text
...
async def autopilot():
    ...
    if not channel:
        ...
        try:
            r = await ayra_bot(
                CreateChannelRequest(
                    title="Masky-Userbot Logs",
                    about="Ini adalah grup logs dari Masky-Userbot\nJangan keluar dari grup logs ini\nPowered By @GroupMasky",
                    megagroup=True,
                ),
            )
    ...
    if isinstance(chat.photo, ChatPhotoEmpty):
        photo = await download_file(
            "https://telegra.ph//file/0acc220f0ea06abcd5847.jpg", "logo.jpg"
        )
...
async def customize():
    ...
    try:
        ...
        file = random.choice(
            [
                "https://telegra.ph//file/0acc220f0ea06abcd5847.jpg",
        ...
        await ayra_bot.send_message(
            "botfather",
            f"✨ Powerful Masky-Userbot Assistant  ✨\n✨ Master ~ {sir} ✨\n\n✨ Powered By ~ @GroupMasky ✨",
        )
        await asyncio.sleep(2)
        ...
        try:
            async for x in ayra_bot.iter_messages(
                ...
                try:
                    ...
                    LOGS.info(f"Masky-Userbot - PLUGIN_CHANNEL - ERROR - {plugin}")
                    LOGS.exception(e)
                    os.remove(plugin)
        except Exception as er:
            LOGS.exception(er)
...
async def ready():
    ...
    if not udB.get_key("INIT_DEPLOY"):  # Detailed Message at Initial Deploy
        MSG = """ **Thanks for Deploying Masky-Userbot!**
• Here, are the Some Basic stuff from, where you can Know, about its Usage."""
        PHOTO = "https://telegra.ph//file/0acc220f0ea06abcd5847.jpg"
        BTTS = Button.inline("• Click to Start •", "initft_2")
        udB.set_key("INIT_DEPLOY", "Done")
    else:
        MSG = f"**Masky-Userbot has been deployed!**\n╼┅━━━━━━━━━━━┅╾\n**UserMode**: {inline_mention(ayra_bot.me)}\n**Assistant**: @{asst.me.username}\n╼┅━━━━━━━━━━━┅╾\n**Support**: @GroupMasky\n╼┅━━━━━━━━━━━┅╾"
