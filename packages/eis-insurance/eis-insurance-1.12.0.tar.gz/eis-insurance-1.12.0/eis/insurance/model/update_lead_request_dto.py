...
class UpdateLeadRequestDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, status, custom_data, account, policy, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            custom_data ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Custom data.
    ...
    @convert_js_args_to_python_args
    def __init__(self, status, custom_data, account, policy, *args, **kwargs):  # noqa: E501
        """UpdateLeadRequestDto - a model defined in OpenAPI
