...
class CreateProductRequestDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, insured_object_types, contract_duration_days, slug, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, insured_object_types, contract_duration_days, slug, *args, **kwargs):  # noqa: E501
        """CreateProductRequestDto - a model defined in OpenAPI
