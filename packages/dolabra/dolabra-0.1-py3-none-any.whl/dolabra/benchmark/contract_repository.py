...
from dolabra.benchmark.verification_db import VerificationDB, Contract
...
class ContractRepository:
    ...
    def save(self, address: Text, block_id: Text) -> Contract:
        """
        ...
        if entity is None:
            entity = Contract(address=address, block_id=block_id)
