...
from dolabra.benchmark import verifications_db_path
from dolabra.analysis.module.modules.loader import MODULES
from dolabra.analysis.module.modules.utils import Singleton
...
class VerificationDB(metaclass=Singleton):
    ...
    def _init_db(self) -> None:
        for strategy_name in MODULES.keys():
