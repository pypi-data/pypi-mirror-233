...
from   bankstatementextractor.Incom_expense import income_expense
...
class BankExtractor:
    ...
    def extract(self, pdf_bytes):
        ...
        # if len(data) > 0:
        #     data = data[0]
        #     purchases,income_streams=income_expense.income_detection(data)
        # else:
        #     raise Exception("No label detected")

        # return purchases,income_streams
        return True 
