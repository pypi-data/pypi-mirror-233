    ...
    for lag in lags:
        ...
        for r in range(run):
            ...
            for i, e in enumerate(epochs_num):
                ...
                history_X.append(
                    model_X.fit(
                        data_X, X, epochs=e, batch_size=batch_size_num, verbose=verbose, callbacks=callbacks, validation_data=(data_X_val, X_val)
                    )
                )
                ...
                history_XY.append(
                    model_XY.fit(
                        data_XY, X, epochs=e, batch_size=batch_size_num, verbose=verbose, callbacks=callbacks, validation_data=(data_XY_val, X_val)
                    )
                )
