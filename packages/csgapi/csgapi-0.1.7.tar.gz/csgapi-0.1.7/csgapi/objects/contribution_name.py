...
__all__ = [
    "ContributionName",
    "ContributionNameManager",
]


class ContributionName(SaveMixin, RESTObject):
    _id_attr = "uid"
    # pass
...
class ContributionNameManager(GetMixin, CreateMixin, UpdateMixin, ListMixin, RESTManager):
    _path = "contribution_name"
    _obj_cls = ContributionName
    ...
    def get(self, uid=None, params=None):
        ...
        # in each obj
        return cast(ContributionName, super(ContributionNameManager, self).get(uid=uid, params=params))
