...
class Source(SaveMixin, RESTObject):
    _id_attr = "uid"
    # pass
...
class SourceManager(ForeignKeyManager, RESTManager):
    _path = "source"
    _obj_cls = Source
    ...
    def get(self, uid=None, params=None):
        ...
        # in each obj
        return cast(Source, super(SourceManager, self).get(uid=uid, params=params))
