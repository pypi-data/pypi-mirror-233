...
class Organization(SaveMixin, RESTObject):
    _id_attr = "uid"
    # pass
...
class OrganizationManager(GetMixin, CreateMixin, UpdateMixin, ListMixin, RESTManager):
    _path = "organization"
    ...
    def get(self, uid=None, params=None):
        ...
        # in each obj
        return cast(Organization, super(OrganizationManager, self).get(uid=uid, params=params))
