...
class DegreeType(SaveMixin, RESTObject):
    _id_attr = "uid"
    # pass
...
class DegreeTypeManager(GetMixin, CreateMixin, UpdateMixin, ListMixin, RESTManager):
    _path = "degree_type"
    _obj_cls = DegreeType
    ...
    def get(self, uid=None, params=None):
        ...
        # in each obj
        return cast(DegreeType, super(DegreeTypeManager, self).get(uid=uid, params=params))
