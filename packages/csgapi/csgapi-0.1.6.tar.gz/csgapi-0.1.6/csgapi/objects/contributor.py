...
class Contributor(SaveMixin, ObjectDeleteMixin, RESTObject):
    _id_attr = "uid"
    # pass
...
class ContributorManager(GetMixin, CreateMixin, UpdateMixin, ListMixin, DeleteMixin, RESTManager):
    _path = "contributor"
    _obj_cls = Contributor
    ...
    def get(self, uid=None, params=None):
        ...
        # in each obj
        return cast(Contributor, super(ContributorManager, self).get(uid=uid, params=params))
