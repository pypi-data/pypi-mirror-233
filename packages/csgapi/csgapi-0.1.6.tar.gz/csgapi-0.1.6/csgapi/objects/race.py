...
class Race(SaveMixin, RESTObject):
    _id_attr = "uid"
    # pass
...
class RaceManager(GetMixin, CreateMixin, UpdateMixin, ListMixin, RESTManager):
    _path = "race"
    _obj_cls = Race
    ...
    def get(self, uid=None, params=None):
        ...
        # in each obj
        return cast(Race, super(RaceManager, self).get(uid=uid, params=params))
