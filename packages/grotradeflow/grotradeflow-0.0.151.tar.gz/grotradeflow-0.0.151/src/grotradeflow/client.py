...
class GroTradeFlow:
    ...
    def get_all_for_time(
        ...
        *,
        ...
        """
        get all items data for a particular country or all countries for a particular item in a single time period. Required parameters are metric, year, and country or item/hs6_code. Optional parameters are month, quarter, partner_region, and in_usd.
    ...
    def get_implied_import_prices(
        ...
        *,
        ...
        """
        get implied import prices for a particular country and item or HS code. Required parameters are country and item/hs6_code. Optional parameters are partner_region, in_usd, and freq.
