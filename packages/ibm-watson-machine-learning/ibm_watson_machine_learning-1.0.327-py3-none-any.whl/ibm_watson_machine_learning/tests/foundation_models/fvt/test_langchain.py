...
class TestLangchain:
    ...
    def test_04_simple_sequential_chain(self, setup_class, model_type):
        ...
        model_1 = Model(model_id=model_type, credentials=self.wml_credentials, project_id=self.project_id, params=params)
        llm_1 = WatsonxLLM(model=model_1)
        model_2 = Model(model_id=model_type, credentials=self.wml_credentials, project_id=self.project_id, params=params)
    ...
    def test_10_to_langchain_wrapper(self, setup_class):
        prompt_template = "What color is the {flower}?"
        model = Model(
