...
def pd_generate_data2(n_colnum=3, n_colcat=4, nrows=100, use_catstr=1, max_category=20, seed=4,
    ...
    Args:
        n_colnum (int, optional): _description_. Defaults to 3.
        n_colcat (int, optional): _description_. Defaults to 4.
        nrows (int, optional): _description_. Defaults to 100.
        use_catstr (int, optional): _description_. Defaults to 1.
        max_category (int, optional): _description_. Defaults to 20.
