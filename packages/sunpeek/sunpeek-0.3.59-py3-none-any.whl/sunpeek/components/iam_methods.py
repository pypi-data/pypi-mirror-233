...
def get_iam_ambrosetti(aoi: pd.Series, kappa: Q):
    """ Determines the incidence angle modifier using the Ambrosetti function, as defined in the EN ISO 9806.
...
def _add_boundaries(aoi_reference: list, iam_reference: list):
    """ Applies default boundary values for the IAM based on EN ISO 9806 Solar Energy Draft:
