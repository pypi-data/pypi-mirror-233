...
all_definitions = [
    ...
    CollectorQDT(name='Absolicon T160',
                 ...
                 certificate_date_issued=datetime(2019, 1, 15),
                 certificate_lab='DIN CERTCO',
                 ...
                 a5=Q(1483, "J m**-2 K**-1"),
                 a8=Q(0.000, 'W m**-2 K**-4'),
                 kd=Q(0.12, ''),
                 iam_method=iam.IAM_Interpolated(aoi_reference=Q([10, 20, 30, 40, 50, 60, 70, 80, 90], 'deg'),
                                                 iam_reference=Q([0.99, 0.99, 0.98, 0.96, 0.91, 0.77, 0.53, 0.18, 0.0]))
                 ),
    ...
    CollectorSST(name="CONA CCS+",
                     ...
                     certificate_date_issued=datetime(2015, 1, 14),
