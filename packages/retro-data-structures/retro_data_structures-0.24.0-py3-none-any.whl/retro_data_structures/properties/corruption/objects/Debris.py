...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Debris]:
    if property_count != 3:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x8a1c821d
    debris_properties = DebrisProperties.from_stream(data, property_size)

    return Debris(editor_properties, actor_information, debris_properties)
...
_decode_debris_properties = DebrisProperties.from_stream
