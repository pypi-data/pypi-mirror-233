...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[PlantScarabSwarm]:
    ...
    return PlantScarabSwarm(editor_properties, actor_information, character_animation_information, active, swarm_basics_data, unknown_0xe44c130c, unknown_0x47177c43, max_attack_angle, into_attack_speed, attack_speed, grenade_data, grenade_launch_speed)
