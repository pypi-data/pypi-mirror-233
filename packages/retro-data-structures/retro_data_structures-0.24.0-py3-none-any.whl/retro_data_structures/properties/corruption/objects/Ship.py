...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Ship]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xc854d4a6
    ship_data = ShipData.from_stream(data, property_size)

    return Ship(editor_properties, patterned, actor_information, ship_data)
...
_decode_ship_data = ShipData.from_stream
