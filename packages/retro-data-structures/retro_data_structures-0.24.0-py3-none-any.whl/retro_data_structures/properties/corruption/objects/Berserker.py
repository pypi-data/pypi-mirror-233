...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Berserker]:
    if property_count != 7:
        return None
    ...
    return Berserker(editor_properties, actor_information, patterned_info, berserker_info, berserker_info_hard, berserker_info_elite, unknown_struct21)
...
_decode_berserker_info = BerserkerData.from_stream

_decode_berserker_info_hard = BerserkerData.from_stream

_decode_berserker_info_elite = BerserkerData.from_stream
