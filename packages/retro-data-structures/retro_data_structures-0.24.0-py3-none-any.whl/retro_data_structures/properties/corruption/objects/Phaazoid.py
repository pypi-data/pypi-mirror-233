...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Phaazoid]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xa92bfe03
    phaazoid_data = PhaazoidData.from_stream(data, property_size)

    return Phaazoid(editor_properties, patterned, actor_information, phaazoid_data)
...
_decode_phaazoid_data = PhaazoidData.from_stream
