...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[PhazonTentacle]:
    if property_count != 3:
        return None
    ...
    return PhazonTentacle(editor_properties, patterned, actor_information)
