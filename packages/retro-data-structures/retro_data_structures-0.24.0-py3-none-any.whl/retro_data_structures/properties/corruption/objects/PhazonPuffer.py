...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[PhazonPuffer]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x1be8b2db
    unknown_struct51 = UnknownStruct51.from_stream(data, property_size)

    return PhazonPuffer(editor_properties, patterned, actor_information, unknown_struct51)
...
_decode_unknown_struct51 = UnknownStruct51.from_stream
