...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[GunTurretTop]:
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xa858f4e7
    gun_turret_top_data = GunTurretTopData.from_stream(data, property_size)
    ...
    return GunTurretTop(editor_properties, gun_turret_top_data, patterned, actor_information)


_decode_editor_properties = EditorProperties.from_stream

_decode_gun_turret_top_data = GunTurretTopData.from_stream
