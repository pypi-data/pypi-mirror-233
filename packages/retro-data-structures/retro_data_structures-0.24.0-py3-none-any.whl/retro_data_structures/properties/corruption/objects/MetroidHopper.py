...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[MetroidHopper]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xd9488fbd
    metroid_hopper_data = MetroidHopperData.from_stream(data, property_size)

    return MetroidHopper(editor_properties, patterned, actor_information, metroid_hopper_data)
...
_decode_metroid_hopper_data = MetroidHopperData.from_stream
