...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[TeamAI]:
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x1c3a365c
    max_special_attackers = struct.unpack('>l', data.read(4))[0]
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x69cde528
    unknown_0x69cde528 = struct.unpack('>l', data.read(4))[0]
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x9856e6f0
    unknown_0x9856e6f0 = struct.unpack('>f', data.read(4))[0]

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x46b94e2c
    max_hypermode_members = struct.unpack('>l', data.read(4))[0]

    return TeamAI(editor_properties, max_team_size, max_melee_attackers, max_ranged_attackers, max_special_attackers, unknown_0x9fa9c457, unknown_0x54cd2755, unknown_0xc36ed15c, unknown_0x69cde528, team_formation, unknown_0xd3ad55b6, unknown_0x8d00b839, unknown_0x9856e6f0, max_hypermode_members)
