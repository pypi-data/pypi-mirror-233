...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[SwarmBot]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x3fa5c15b
    swarm_bot_properties = SwarmBotData.from_stream(data, property_size)

    return SwarmBot(editor_properties, patterned, actor_information, swarm_bot_properties)
...
_decode_swarm_bot_properties = SwarmBotData.from_stream
