...
_decode_ship = AnimationParameters.from_stream

_decode_camera = AnimationParameters.from_stream

def _decode_skybox(data: typing.BinaryIO, property_size: int):
    return struct.unpack(">Q", data.read(8))[0]


_decode_char_0x05014c61 = AnimationParameters.from_stream

_decode_unknown_0xf9ef55d4 = Spline.from_stream

_decode_char_0x3c79e121 = AnimationParameters.from_stream

_decode_unknown_0x8e718724 = Spline.from_stream
...
_decode_from_ship = AnimationParameters.from_stream

_decode_from_camera = AnimationParameters.from_stream

def _decode_to_skybox(data: typing.BinaryIO, property_size: int):
    return data.read(property_size)[:-1].decode("utf-8")


_decode_to_ship = AnimationParameters.from_stream

_decode_to_camera = AnimationParameters.from_stream
