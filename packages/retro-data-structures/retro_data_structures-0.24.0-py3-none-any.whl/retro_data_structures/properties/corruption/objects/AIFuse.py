...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[AIFuse]:
    if property_count != 3:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x25e1e3b6
    unknown_struct1 = UnknownStruct1.from_stream(data, property_size)

    return AIFuse(editor_properties, actor_information, unknown_struct1)
...
_decode_unknown_struct1 = UnknownStruct1.from_stream
