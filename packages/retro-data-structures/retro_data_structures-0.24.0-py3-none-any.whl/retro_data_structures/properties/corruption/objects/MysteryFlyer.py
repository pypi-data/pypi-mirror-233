...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[MysteryFlyer]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x44080565
    mystery_flyer_properties = MysteryFlyerData.from_stream(data, property_size)

    return MysteryFlyer(editor_properties, patterned, actor_information, mystery_flyer_properties)
...
_decode_mystery_flyer_properties = MysteryFlyerData.from_stream
