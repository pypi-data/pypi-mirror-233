...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Spinner]:
    ...
    return Spinner(editor_properties, forward_speed, backward_speed, unknown_0x449dd059, unknown_0xfc849759, shot_spinner, allow_wrap, no_backward, spline_control, unknown_0x865322ca, loop_sound, start_sound, stop_sound)
