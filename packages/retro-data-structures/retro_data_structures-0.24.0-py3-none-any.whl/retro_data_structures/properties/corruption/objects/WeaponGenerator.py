...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[WeaponGenerator]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x3f003133
    weapon_generator_properties = WeaponGeneratorProperties.from_stream(data, property_size)

    return WeaponGenerator(editor_properties, weapon_generator_properties)


_decode_editor_properties = EditorProperties.from_stream

_decode_weapon_generator_properties = WeaponGeneratorProperties.from_stream
