...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[FlyingPirate]:
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xb327e803
    flying_pirate_properties = FlyingPirateData.from_stream(data, property_size)

    return FlyingPirate(editor_properties, patterned, actor_information, flying_pirate_properties)
...
_decode_flying_pirate_properties = FlyingPirateData.from_stream
