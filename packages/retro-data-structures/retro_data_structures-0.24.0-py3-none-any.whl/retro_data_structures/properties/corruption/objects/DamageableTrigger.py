...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[DamageableTrigger]:
    ...
    return DamageableTrigger(editor_properties, health, vulnerability, orbitable, enable_seeker_lock_on, invulnerable, show_on_radar, visor, damage_originator, only_take_damage_from_inhabitants, is_hostile)
