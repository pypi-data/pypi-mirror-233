...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Generator]:
    ...
    return Generator(editor_properties, min_number_objects_to_generate, max_number_objects_to_generate, unique_objects, unique_locations, keep_orientation, use_originator_transform, offset, offset_is_local_space, random_scale_min, random_scale_max)
