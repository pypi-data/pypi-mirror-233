...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[SoundModifier]:
    ...
    return SoundModifier(editor_properties, time, auto_reset, auto_start, global_, volume, pan, surround_pan, pitch, low_pass)
