...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[CoverPoint]:
    ...
    return CoverPoint(editor_properties, unknown_0x969de5ff, should_crouch, horizontal_safe_angle, vertical_safe_angle, minimum_safe_range, maximum_safe_range, lock_time, unknown_0x25717ace, unknown_0xc83e3228)
