...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[SteamLord]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x01d5823c
    steam_lord_data = SteamLordData.from_stream(data, property_size)

    return SteamLord(editor_properties, patterned, actor_information, steam_lord_data)
...
_decode_steam_lord_data = SteamLordData.from_stream
