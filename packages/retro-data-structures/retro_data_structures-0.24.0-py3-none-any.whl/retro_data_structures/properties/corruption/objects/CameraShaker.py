...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[CameraShaker]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xad547f96
    shaker_data = CameraShakerData.from_stream(data, property_size)

    return CameraShaker(editor_properties, shaker_data)


_decode_editor_properties = EditorProperties.from_stream

_decode_shaker_data = CameraShakerData.from_stream
