...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[RSPL]:
    if property_count != 6:
        return None
    ...
    return RSPL(editor_properties, splash_scale, max_splashes, generation_rate, start_height, alpha_factor)
