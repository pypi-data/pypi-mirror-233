...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[MultiModelActor]:
    ...
    return MultiModelActor(editor_properties, collision_box, collision_offset, collision_model, model, multi_model_information, actor_information, unknown, use_mod_inca, mod_inca_color, mod_inca_amount, orbit_offset, orbit_offset_local, is_solid, immovable)
...
_decode_multi_model_information = MultiModelInformation.from_stream
