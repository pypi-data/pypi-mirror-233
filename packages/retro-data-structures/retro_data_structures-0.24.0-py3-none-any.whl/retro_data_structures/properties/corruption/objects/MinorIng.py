...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[MinorIng]:
    if property_count != 4:
        return None
    ...
    patterned = PatternedAITypedef.from_stream(data, property_size, default_override={'collision_height': 4.0, 'min_attack_range': 4.5, 'max_attack_range': 30.0, 'average_attack_time': 3.0})
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xa3a2ac3f
    unknown_struct45 = UnknownStruct45.from_stream(data, property_size)

    return MinorIng(editor_properties, patterned, actor_information, unknown_struct45)
...
_decode_unknown_struct45 = UnknownStruct45.from_stream
