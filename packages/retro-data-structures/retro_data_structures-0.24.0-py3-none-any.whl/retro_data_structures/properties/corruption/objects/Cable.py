...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Cable]:
    if property_count != 3:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x93b93db9
    cable_properties = CableProperties.from_stream(data, property_size)

    return Cable(editor_properties, actor_information, cable_properties)
...
_decode_cable_properties = CableProperties.from_stream
