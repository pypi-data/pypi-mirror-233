...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[DistanceFog]:
    ...
    return DistanceFog(editor_properties, unknown_0x88e8d530, mode, color, near_far_plane, color_rate, distance_rate, force_settings, is_two_sided, unknown_0xb7246843, vector2f_0x520d1dd5, unknown_0xbc86052a, vector2f_0xfba31a97)
