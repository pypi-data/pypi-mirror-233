...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[GhorUpperBody]:
    if property_count != 5:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xfc135e9b
    unknown_struct42 = UnknownStruct42.from_stream(data, property_size)

    return GhorUpperBody(editor_properties, actor_information, patterned, ai_difficulty_settings, unknown_struct42)
...
_decode_unknown_struct42 = UnknownStruct42.from_stream
