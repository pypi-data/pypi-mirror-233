...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[StreamedAudioModifier]:
    if property_count != 4:
        return None
    ...
    return StreamedAudioModifier(editor_properties, fade_up_time, fade_down_time, fade_volume_multiplier)
