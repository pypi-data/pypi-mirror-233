...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[GunTurretBase]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x34a8fc8e
    gun_turret_base_data = GunTurretBaseData.from_stream(data, property_size)
    ...
    return GunTurretBase(editor_properties, gun_turret_base_data, patterned, actor_information)


_decode_editor_properties = EditorProperties.from_stream

_decode_gun_turret_base_data = GunTurretBaseData.from_stream
