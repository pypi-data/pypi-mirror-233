...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[SeedBoss2GiantForm]:
    if property_count != 3:
        return None
    ...
    return SeedBoss2GiantForm(editor_properties, patterned, actor_information)
