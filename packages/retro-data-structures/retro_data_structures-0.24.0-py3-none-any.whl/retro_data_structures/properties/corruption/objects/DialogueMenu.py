...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[DialogueMenu]:
    ...
    default_selection = enums.DefaultSelection.from_stream(data)
    ...
    return DialogueMenu(editor_properties, text_properties, japan_text_properties, text_position_y, japan_text_position_y, selected_font_color, unknown_0x69fdb265, selection_model, unknown_0x3c5e109a, default_selection, highlight_sound, select_sound)


_decode_editor_properties = EditorProperties.from_stream

_decode_text_properties = TextProperties.from_stream

_decode_japan_text_properties = TextProperties.from_stream
