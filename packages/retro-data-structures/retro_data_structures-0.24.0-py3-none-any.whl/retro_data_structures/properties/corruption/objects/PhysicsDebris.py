...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[PhysicsDebris]:
    if property_count != 3:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xd94d4ca3
    physics_debris_properties = PhysicsDebrisProperties.from_stream(data, property_size)

    return PhysicsDebris(editor_properties, actor_information, physics_debris_properties)
...
_decode_physics_debris_properties = PhysicsDebrisProperties.from_stream
