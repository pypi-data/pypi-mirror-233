...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[SteamBot]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x11375ec0
    steam_bot_data = SteamBotData.from_stream(data, property_size)
    ...
    return SteamBot(editor_properties, steam_bot_data, patterned, actor_information)


_decode_editor_properties = EditorProperties.from_stream

_decode_steam_bot_data = SteamBotData.from_stream
