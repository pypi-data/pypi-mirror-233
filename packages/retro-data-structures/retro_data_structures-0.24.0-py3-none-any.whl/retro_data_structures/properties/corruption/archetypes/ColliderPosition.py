...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ColliderPosition]:
    if property_count != 7:
        return None

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xe2ae470c
    collider_position_type = enums.ColliderPositionType.from_stream(data)
    ...
    return ColliderPosition(collider_position_type, distance, backwards_distance, z_offset, distance_convergence, centroid_convergence, camera_convergence)
...
_decode_distance_convergence = Convergence.from_stream

_decode_centroid_convergence = Convergence.from_stream

_decode_camera_convergence = Convergence.from_stream
