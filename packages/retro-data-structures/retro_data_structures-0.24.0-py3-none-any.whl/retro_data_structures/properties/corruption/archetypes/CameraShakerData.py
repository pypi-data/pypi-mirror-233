...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[CameraShakerData]:
    ...
    return CameraShakerData(flags_camera_shaker, attenuation_distance, duration, audio_effect, horizontal_motion, vertical_motion, forward_motion)
...
_decode_horizontal_motion = CameraShakerEnvelope.from_stream

_decode_vertical_motion = CameraShakerEnvelope.from_stream

_decode_forward_motion = CameraShakerEnvelope.from_stream
