...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[FlyingPirateHelixMissileData]:
    ...
    return FlyingPirateHelixMissileData(projectile_static_geometry_test, projectile_left, projectile_right, damage, visor_effect, visor_impact_sound, stop_homing_range, min_attack_range, max_attack_range, min_attack_time, attack_time_variance)
