...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[DefenseMechanoidData]:
...
_decode_jammer_antenna_vulnerability = DamageVulnerability.from_stream

_decode_command_core_vulnerability = DamageVulnerability.from_stream
...
_decode_huge_missile_damage = DamageInfo.from_stream

_decode_pulse_shockwave = ShockWaveInfo.from_stream

_decode_seeker_bomb_damage = DamageInfo.from_stream
