...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[LaunchProjectileData]:
    ...
    return LaunchProjectileData(projectile, damage, scale, delay, delay_variance, visor_effect, sound_visor_effect, stop_homing_range, burn_damage, burn_duration, targetable, collision_box, hit_points, generate_pickup_chance)
