...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[SpacePirateStruct]:
    ...
    return SpacePirateStruct(enable_hyper_mode, initial_hyper_mode_time, hyper_mode_check_time, hyper_mode_check_chance, hyper_mode_duration, skip_taunt, unknown_0xdb922374, shot_projectile, sound_projectile, shot_damage, unknown_0x71587b45, unknown_0x7903312e, hyper_mode_attack_time, unknown_0xca686731, hyper_mode_vulnerability)
...
_decode_shot_damage = DamageInfo.from_stream
