...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Chakram]:
    ...
    return Chakram(chakram_model, energy_effect, trail_effect, static_geometry_collision_effect, in_flight_sound, player_impact_sound, caud, damage, hyper_damage, speed, unknown_0x508c48d7, spin_rate, fade_out_time, visor_effect, stun_time, unknown_0x2f79b3d0, unknown_0x11cc7b58)
