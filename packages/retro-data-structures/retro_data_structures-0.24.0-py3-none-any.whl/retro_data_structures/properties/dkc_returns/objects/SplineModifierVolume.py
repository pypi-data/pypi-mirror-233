...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[SplineModifierVolume]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x7af6f162
    unknown = Spline.from_stream(data, property_size)

    return SplineModifierVolume(editor_properties, unknown)
