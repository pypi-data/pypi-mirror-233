...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[MemoryRelay]:
    if property_count != 4:
        return None
    ...
    return MemoryRelay(editor_properties, object_id, one_shot, delayed_action)
