...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[BloomVolume]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x3801a56b
    unknown = Spline.from_stream(data, property_size)

    return BloomVolume(editor_properties, unknown)
