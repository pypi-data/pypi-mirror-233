...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[AIKeyframe]:
    ...
    return AIKeyframe(editor_properties, unknown_0xc215a24f, mirrored, force_secondary, loop, loop_duration, unknown_0x6d62ef74, playback_rate, playback_blend_mode)
