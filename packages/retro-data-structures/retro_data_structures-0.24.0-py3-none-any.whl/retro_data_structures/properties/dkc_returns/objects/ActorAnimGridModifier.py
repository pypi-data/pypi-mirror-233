...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ActorAnimGridModifier]:
    if property_count != 2:
        return None
    ...
    return ActorAnimGridModifier(editor_properties, anim_grid)
