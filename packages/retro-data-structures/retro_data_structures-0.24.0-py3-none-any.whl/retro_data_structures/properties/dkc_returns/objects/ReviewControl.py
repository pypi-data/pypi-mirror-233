...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ReviewControl]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xb96c0abe
    review_stage = enums.ReviewStage.from_stream(data)

    return ReviewControl(editor_properties, review_stage)
