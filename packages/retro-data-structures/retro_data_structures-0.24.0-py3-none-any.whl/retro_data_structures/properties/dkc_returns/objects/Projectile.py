...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Projectile]:
    ...
    return Projectile(editor_properties, actor_information, projectile_data, projectile_render_data, projectile_collision_data, projectile_motion_data, can_bounce, projectile_bounce_data)
