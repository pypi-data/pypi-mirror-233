...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[MusicTrack]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x3c18666c
    unknown_struct242 = UnknownStruct242.from_stream(data, property_size)

    return MusicTrack(editor_properties, unknown_struct242)


_decode_editor_properties = EditorProperties.from_stream

_decode_unknown_struct242 = UnknownStruct242.from_stream
