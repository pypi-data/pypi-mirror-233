...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[CinematicCamera]:
    ...
    interpolation_behavior = CameraInterpolation.from_stream(data, property_size, default_override={'on_flags': 0, 'off_flags': 0})
    ...
    return CinematicCamera(editor_properties, object_id, camera_mode, use_script_object_transform, animation, cinematic_ends_type, end_time, unknown, motion_control_spline, target_control_spline, orientation_behavior, fov_spline, roll_spline, slowmo_control_spline, interpolation_behavior, near_plane_distance_spline, far_plane_distance_spline)
