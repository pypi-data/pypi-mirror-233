...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[RocketBarrel]:
    ...
    patterned = PatternedAITypedef.from_stream(data, property_size, default_override={'collision_radius': 0.5, 'collision_offset': Vector(x=0.0, y=0.0, z=-0.699999988079071)})
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x15f240a8
    unknown_struct250 = UnknownStruct250.from_stream(data, property_size)

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x4a862510
    unknown_struct252 = UnknownStruct252.from_stream(data, property_size)

    return RocketBarrel(editor_properties, patterned, shadow_data, actor_information, unknown_struct, common, mount_data, rider_list_data, unknown_struct250, unknown_struct252)
...
_decode_unknown_struct250 = UnknownStruct250.from_stream

_decode_unknown_struct252 = UnknownStruct252.from_stream
