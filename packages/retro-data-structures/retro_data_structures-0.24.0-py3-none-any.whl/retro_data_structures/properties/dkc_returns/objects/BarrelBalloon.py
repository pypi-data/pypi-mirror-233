...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[BarrelBalloon]:
    if property_count != 3:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x94f9c48d
    balloon_barrel_data = BalloonBarrelData.from_stream(data, property_size)

    return BarrelBalloon(editor_properties, actor_information, balloon_barrel_data)
...
_decode_balloon_barrel_data = BalloonBarrelData.from_stream
