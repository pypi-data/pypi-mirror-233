...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[MultiModelActor]:
    ...
    return MultiModelActor(editor_properties, collision_box, collision_offset, collision_model, health, vulnerability, model, multi_model_information, actor_information, use_mod_inca, mod_inca_color, mod_inca_amount, is_solid, immovable)
