...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[PirateCrab]:
    if property_count != 5:
        return None
    ...
    return PirateCrab(editor_properties, shadow_data, actor_information, patterned, unknown_struct89)
...
_decode_unknown_struct89 = UnknownStruct89.from_stream
