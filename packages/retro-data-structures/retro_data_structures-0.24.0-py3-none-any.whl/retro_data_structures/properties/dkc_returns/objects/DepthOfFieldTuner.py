...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[DepthOfFieldTuner]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x72767c80
    unknown_struct93 = UnknownStruct93.from_stream(data, property_size)

    return DepthOfFieldTuner(editor_properties, unknown_struct93)


_decode_editor_properties = EditorProperties.from_stream

_decode_unknown_struct93 = UnknownStruct93.from_stream
