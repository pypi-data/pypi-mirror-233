...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[RelayRandom]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x3836c403
    unknown_struct264 = UnknownStruct264.from_stream(data, property_size)

    return RelayRandom(editor_properties, unknown_struct264)


_decode_editor_properties = EditorProperties.from_stream

_decode_unknown_struct264 = UnknownStruct264.from_stream
