...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[MotionPlatform]:
    ...
    return MotionPlatform(editor_properties, motion_properties, max_velocity, elevation_velocity, radius, elevation, max_elevation, min_elevation, direction, convergence)
