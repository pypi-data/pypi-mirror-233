...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[PoiObject]:
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x98574eb1
    unknown_struct247 = UnknownStruct247.from_stream(data, property_size)

    return PoiObject(editor_properties, unknown_struct247)


_decode_editor_properties = EditorProperties.from_stream

_decode_unknown_struct247 = UnknownStruct247.from_stream
