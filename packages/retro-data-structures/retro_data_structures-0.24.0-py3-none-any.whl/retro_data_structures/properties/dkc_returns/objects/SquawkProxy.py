...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[SquawkProxy]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x6ceaa8da
    squawk_proxy_data = SquawkProxyData.from_stream(data, property_size)

    return SquawkProxy(editor_properties, squawk_proxy_data)


_decode_editor_properties = EditorProperties.from_stream

_decode_squawk_proxy_data = SquawkProxyData.from_stream
