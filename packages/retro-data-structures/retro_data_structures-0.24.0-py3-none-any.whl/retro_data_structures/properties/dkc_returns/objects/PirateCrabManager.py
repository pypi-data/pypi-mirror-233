...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[PirateCrabManager]:
    if property_count != 2:
        return None
    ...
    return PirateCrabManager(editor_properties, unknown_struct83)


_decode_editor_properties = EditorProperties.from_stream

_decode_unknown_struct83 = UnknownStruct83.from_stream
