...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Kong]:
    if property_count != 8:
        return None
    ...
    return Kong(editor_properties, shadow_data, actor_information, unknown_struct, patterned_info, alternate_skins, kong_data, unknown_struct227)
...
_decode_unknown_struct227 = UnknownStruct227.from_stream
