...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[OceanBridge]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xb33f8ce5
    ocean_bridge_data = OceanBridgeData.from_stream(data, property_size)

    return OceanBridge(editor_properties, model, actor_information, ocean_bridge_data)
...
_decode_ocean_bridge_data = OceanBridgeData.from_stream
