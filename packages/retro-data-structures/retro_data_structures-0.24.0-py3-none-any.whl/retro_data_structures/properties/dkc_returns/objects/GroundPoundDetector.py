...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[GroundPoundDetector]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xe809b3a0
    ground_pound_detector_data = GroundPoundDetectorData.from_stream(data, property_size)

    return GroundPoundDetector(editor_properties, ground_pound_detector_data)


_decode_editor_properties = EditorProperties.from_stream

_decode_ground_pound_detector_data = GroundPoundDetectorData.from_stream
