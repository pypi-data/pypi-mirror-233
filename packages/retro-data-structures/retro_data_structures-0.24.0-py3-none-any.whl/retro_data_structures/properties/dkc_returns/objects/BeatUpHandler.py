...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[BeatUpHandler]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x50228364
    data = Data.from_stream(data, property_size)

    return BeatUpHandler(editor_properties, data)


_decode_editor_properties = EditorProperties.from_stream

_decode_data = Data.from_stream
