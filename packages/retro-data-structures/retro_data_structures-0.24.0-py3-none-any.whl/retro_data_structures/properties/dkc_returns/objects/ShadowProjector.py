...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ShadowProjector]:
    ...
    unknown_struct510 = UnknownStruct510.from_stream(data, property_size)

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x8ce1176e
    unknown_0x8ce1176e = struct.unpack('>f', data.read(4))[0]

    return ShadowProjector(editor_properties, shadow_scale, shadow_offset, shadow_height, shadow_alpha, shadow_fade_time, unknown_0xbca8b742, render_in_foreground, unknown_0x606e341c, unknown_struct510, unknown_0x8ce1176e)
...
_decode_unknown_struct510 = UnknownStruct510.from_stream
