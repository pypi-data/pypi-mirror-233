...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[KongProxy]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x660d8c9c
    kong_proxy_data = KongProxyData.from_stream(data, property_size)

    return KongProxy(editor_properties, kong_proxy_data)


_decode_editor_properties = EditorProperties.from_stream

_decode_kong_proxy_data = KongProxyData.from_stream
