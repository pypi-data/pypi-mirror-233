...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ProbabilityRelay]:
    if property_count != 5:
        return None
    ...
    return ProbabilityRelay(editor_properties, prob1_p, prob2_p, prob_time_attack, prob_mirror_mode)


_decode_editor_properties = EditorProperties.from_stream

_decode_prob1_p = PickupRelayStruct.from_stream

_decode_prob2_p = PickupRelayStruct.from_stream

_decode_prob_time_attack = PickupRelayStruct.from_stream

_decode_prob_mirror_mode = PickupRelayStruct.from_stream
