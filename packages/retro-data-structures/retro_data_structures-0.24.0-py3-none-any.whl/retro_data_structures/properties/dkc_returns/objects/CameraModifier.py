...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[CameraModifier]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x106ab581
    unknown_struct84 = UnknownStruct84.from_stream(data, property_size)

    return CameraModifier(editor_properties, unknown_struct84)


_decode_editor_properties = EditorProperties.from_stream

_decode_unknown_struct84 = UnknownStruct84.from_stream
