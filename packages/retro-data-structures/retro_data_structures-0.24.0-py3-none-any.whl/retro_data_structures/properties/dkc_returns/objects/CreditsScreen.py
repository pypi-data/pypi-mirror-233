...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[CreditsScreen]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x6b9f6b7c
    credits_data = CreditsData.from_stream(data, property_size)

    return CreditsScreen(editor_properties, credits_data)


_decode_editor_properties = EditorProperties.from_stream

_decode_credits_data = CreditsData.from_stream
