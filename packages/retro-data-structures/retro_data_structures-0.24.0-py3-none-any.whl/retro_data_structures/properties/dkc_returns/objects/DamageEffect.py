...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[DamageEffect]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xeaf272dd
    damage_effect_data = DamageEffectData.from_stream(data, property_size)

    return DamageEffect(editor_properties, damage_effect_data)
