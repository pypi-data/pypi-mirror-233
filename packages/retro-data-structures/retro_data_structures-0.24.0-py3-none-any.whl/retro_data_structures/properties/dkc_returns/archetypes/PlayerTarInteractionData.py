...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[PlayerTarInteractionData]:
    ...
    return PlayerTarInteractionData(uses_tar_in_this_level, inhibit_player_on_tar_pit_exit, num_tar_inhibitors_for_tar_mode, num_ground_pounds_to_break_tar_mode, ground_pound_cool_down, tar_ground_pound_effect, tar_ground_pound_effect_locator, tar_jump_land_effect, tar_jump_land_effect_locator, tar_liberation_effect, tar_liberation_sound, tar_liberation_effect_locator)
