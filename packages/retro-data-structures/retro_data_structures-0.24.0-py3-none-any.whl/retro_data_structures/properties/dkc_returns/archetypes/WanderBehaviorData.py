...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[WanderBehaviorData]:
...
_decode_seeking_tarred_player_locomotion_context = LocomotionContextEnum.from_stream

def _decode_enable_random_turn(data: typing.BinaryIO, property_size: int):
    return struct.unpack('>?', data.read(1))[0]


_decode_random_turn = WanderRandomTurnData.from_stream
