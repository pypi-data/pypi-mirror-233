...
class GenericCreatureData(BaseProperty):
    ...
    single_bop_particle_effect: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=default_asset_id)
...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[GenericCreatureData]:
...
_decode_modify_contact_rules = ModifyContactRuleData.from_stream

_decode_despawn_rules = DespawnRules.from_stream

_decode_fixed_delay_rules = FixedDelayRules.from_stream

_decode_hurl_height_rules = HurlHeightRules.from_stream

_decode_unknown_struct132 = UnknownStruct132.from_stream

_decode_collision_actors = CollisionActorModifierData.from_stream

_decode_unknown_struct133 = UnknownStruct133.from_stream

_decode_anim_grid = AnimGridModifierData.from_stream

_decode_unknown_struct134 = UnknownStruct134.from_stream

_decode_unknown_struct135 = UnknownStruct135.from_stream

def _decode_use_dash_modifier(data: typing.BinaryIO, property_size: int):
    return struct.unpack('>?', data.read(1))[0]


_decode_dash_modifier = DashModifierData.from_stream
...
_decode_skin_swap_modifier = SkinSwapModifierData.from_stream
