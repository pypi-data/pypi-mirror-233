...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[GrabPlayerBehaviorData]:
    ...
    return GrabPlayerBehaviorData(grab_player_type, chew_damage, chew_damage_time, chew_damage_on_spit_out, chew_damage_on_spit_out_delay_time, ground_pound_let_go_time, ground_pound_relapse_multiplier, ground_pound_window, attract_target_speed, grab_distance_threshold, post_release_ignore_time, spit_distance, spit_height, spit_speed, vine_ignore_time, vine_swing_dampen_time, vine_swing_undampen_time)
...
_decode_chew_damage = DamageInfo.from_stream
