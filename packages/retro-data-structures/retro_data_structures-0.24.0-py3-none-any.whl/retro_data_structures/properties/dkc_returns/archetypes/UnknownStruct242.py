...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[UnknownStruct242]:
    ...
    return UnknownStruct242(song_file, dvd_file, start_faded_out, fade_in_time, fade_out_time, volume, pan, positional, min_audible_distance, max_audible_distance, fall_off, use_room_acoustics, start_sample, is_default_retronome_music, sound_group_names)
