...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[UnknownStruct63]:
    ...
    return UnknownStruct63(unknown_0x348c9d90, flight_sound_deceleration_k, flight_sound, flight_sound_low_pass_filter, flight_sound_pitch, flight_sound_volume, caud, unknown_0xbd894993, flight_sound2_pitch, flight_sound2_volume, hit_player_sound, swoop_interrupted_sound)
