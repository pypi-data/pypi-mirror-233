...
_FAST_FORMAT = None
_FAST_IDS = (0x29c77d27, 0x37c7d09d)


def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[UnknownStruct299]:
    if property_count != 2:
        return None

    global _FAST_FORMAT
    if _FAST_FORMAT is None:
        _FAST_FORMAT = struct.Struct('>LH?LHffff')

    dec = _FAST_FORMAT.unpack(data.read(29))
    assert (dec[0], dec[3]) == _FAST_IDS
    return UnknownStruct299(
        dec[2],
        Color(*dec[5:9]),
    )
