...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[UnknownStruct182]:
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xbab90759
    unknown_struct165 = UnknownStruct165.from_stream(data, property_size)

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xf9674517
    unknown_struct166 = UnknownStruct166.from_stream(data, property_size)

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x2c7916ec
    unknown_struct168 = UnknownStruct168.from_stream(data, property_size)

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x4cea53f4
    unknown_struct169 = UnknownStruct169.from_stream(data, property_size)

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x90a6ae10
    unknown_struct174 = UnknownStruct174.from_stream(data, property_size)

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x6362f910
    unknown_struct175 = UnknownStruct175.from_stream(data, property_size)

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x372866d4
    unknown_struct176 = UnknownStruct176.from_stream(data, property_size)

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xea2f750a
    unknown_struct177 = UnknownStruct177.from_stream(data, property_size)

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x51adb968
    unknown_struct34 = UnknownStruct34.from_stream(data, property_size)

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xd8ba1e9a
    unknown_struct178 = UnknownStruct178.from_stream(data, property_size)

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x2aa48723
    unknown_struct179 = UnknownStruct179.from_stream(data, property_size)

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xc6476c7d
    unknown_struct180 = UnknownStruct180.from_stream(data, property_size)

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xbc2379a9
    unknown_struct181 = UnknownStruct181.from_stream(data, property_size)

    return UnknownStruct182(unknown_struct35, unknown_struct165, unknown_struct166, unknown_struct168, unknown_struct169, unknown_struct174, unknown_struct175, unknown_struct176, unknown_struct177, unknown_struct34, unknown_struct178, unknown_struct179, unknown_struct180, unknown_struct181)


_decode_unknown_struct35 = UnknownStruct35.from_stream

_decode_unknown_struct165 = UnknownStruct165.from_stream

_decode_unknown_struct166 = UnknownStruct166.from_stream

_decode_unknown_struct168 = UnknownStruct168.from_stream

_decode_unknown_struct169 = UnknownStruct169.from_stream

_decode_unknown_struct174 = UnknownStruct174.from_stream

_decode_unknown_struct175 = UnknownStruct175.from_stream

_decode_unknown_struct176 = UnknownStruct176.from_stream

_decode_unknown_struct177 = UnknownStruct177.from_stream

_decode_unknown_struct34 = UnknownStruct34.from_stream

_decode_unknown_struct178 = UnknownStruct178.from_stream

_decode_unknown_struct179 = UnknownStruct179.from_stream

_decode_unknown_struct180 = UnknownStruct180.from_stream

_decode_unknown_struct181 = UnknownStruct181.from_stream
