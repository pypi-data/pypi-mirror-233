...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[KongStalledDescentData]:
    ...
    return KongStalledDescentData(rate_of_descent, thrust_ramp_in_time, descent_control_scalar, thrust_duration, rocket_pack_effect, rocket_pack_smoke_effect, rocket_pack_smoke_trail_effect, rocket_pack_effect_locator, rocket_pack_sound, unknown_0xbdaaa9b1, unknown_0x7e50a6d2, unknown_0x075f730c)
...
_decode_unknown_0xbdaaa9b1 = Spline.from_stream

_decode_unknown_0x7e50a6d2 = Spline.from_stream

_decode_unknown_0x075f730c = Spline.from_stream
