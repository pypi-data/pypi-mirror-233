...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[UnknownStruct173]:
    if property_count != 8:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x1bd63859
    music_names = struct.unpack(">Q", data.read(8))[0]
    ...
    return UnknownStruct173(unknown_struct29, title_strings, instruction, instruction_core, music_names, back, back_core, text_background)
