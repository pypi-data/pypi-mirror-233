...
_FAST_FORMAT = None
_FAST_IDS = (0x9e235c61, 0x6ab0341a, 0x43c02224, 0x446a33f5, 0x8b331ce, 0x91936b5e, 0x81d40910, 0x16407ed9, 0x3e7b2b4, 0xe190f77d, 0xce5d16c3, 0xa99a0e33, 0xe7b88d51, 0x7de2e6ba, 0xe1107c4a, 0xb674ea3d, 0x96bb302a, 0x4414d99c)


def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[RagDollData]:
    if property_count != 18:
        return None

    global _FAST_FORMAT
    if _FAST_FORMAT is None:
        _FAST_FORMAT = struct.Struct('>LHfffLHfLHfLHfLHfLHfLHfLHfLHfLHQLH?LH?LH?LH?LH?LHLLHfffLHf')

    dec = _FAST_FORMAT.unpack(data.read(185))
    assert (dec[0], dec[5], dec[8], dec[11], dec[14], dec[17], dec[20], dec[23], dec[26], dec[29], dec[32], dec[35], dec[38], dec[41], dec[44], dec[47], dec[50], dec[55]) == _FAST_IDS
    return RagDollData(
        Vector(*dec[2:5]),
        dec[7],
        dec[10],
