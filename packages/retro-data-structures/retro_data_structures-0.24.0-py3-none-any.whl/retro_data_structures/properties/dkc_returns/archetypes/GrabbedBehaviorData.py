...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[GrabbedBehaviorData]:
...
_decode_flash_sound_pitch = Spline.from_stream

_decode_flash_sound_volume = Spline.from_stream
