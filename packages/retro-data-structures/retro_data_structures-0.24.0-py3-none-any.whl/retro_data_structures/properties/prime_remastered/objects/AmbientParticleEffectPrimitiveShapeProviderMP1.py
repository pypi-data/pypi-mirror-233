...
class AmbientParticleEffectPrimitiveShapeProviderMP1(BaseProperty):
...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[AmbientParticleEffectPrimitiveShapeProviderMP1]:
    if property_count != 0:
        return None
