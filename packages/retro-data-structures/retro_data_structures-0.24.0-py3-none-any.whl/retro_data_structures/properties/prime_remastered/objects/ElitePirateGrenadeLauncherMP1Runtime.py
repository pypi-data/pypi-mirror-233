...
class ElitePirateGrenadeLauncherMP1Runtime(BaseProperty):
...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ElitePirateGrenadeLauncherMP1Runtime]:
    if property_count != 0:
        return None
