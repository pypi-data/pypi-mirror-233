...
class CreatureScriptedAnimationBehavior(BaseProperty):
...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[CreatureScriptedAnimationBehavior]:
    if property_count != 0:
        return None
