...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[TBeamInfo]:
    if property_count != 2:
        return None
    ...
    return TBeamInfo(cooldown, damage_info)
...
_decode_damage_info = TWeaponDamage.from_stream
