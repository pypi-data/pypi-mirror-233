...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Subtitle]:
    ...
    return Subtitle(editor_properties, text_properties, text_position_x, text_position_y, japan_text_properties, japan_text_position_x, japan_text_position_y, string_table, initial_string_index, fade_in_time, fade_out_time)
