...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[SplitterCommandModule]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x560cf813
    unknown_struct43 = UnknownStruct43.from_stream(data, property_size)

    return SplitterCommandModule(editor_properties, patterned, actor_information, unknown_struct43)
...
_decode_unknown_struct43 = UnknownStruct43.from_stream
