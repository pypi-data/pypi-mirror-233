...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Crystallite]:
    ...
    return Crystallite(editor_properties, patterned, actor_information, waypoint_approach_distance, wall_turn_speed, floor_turn_speed, down_turn_speed, visible_distance, forward_moving_priority, stun_time)
