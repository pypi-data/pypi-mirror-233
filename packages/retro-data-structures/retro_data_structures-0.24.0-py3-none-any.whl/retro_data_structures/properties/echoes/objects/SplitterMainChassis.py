...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[SplitterMainChassis]:
    if property_count != 4:
        return None
    ...
    patterned = PatternedAITypedef.from_stream(data, property_size, default_override={'turn_speed': 60.0, 'min_attack_range': 12.0, 'max_attack_range': 37.0, 'creature_size': 2})
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x15e03a2f
    splitter_main_chassis_data = SplitterMainChassisData.from_stream(data, property_size)

    return SplitterMainChassis(editor_properties, patterned, actor_information, splitter_main_chassis_data)
...
_decode_splitter_main_chassis_data = SplitterMainChassisData.from_stream
