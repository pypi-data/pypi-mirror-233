...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[SwampBossStage2]:
    if property_count != 5:
        return None
    ...
    patterned = PatternedAITypedef.from_stream(data, property_size, default_override={'mass': 25.0, 'turn_speed': 720.0, 'detection_range': 5.0, 'detection_height_range': 5.0, 'detection_angle': 90.0, 'min_attack_range': 4.0, 'max_attack_range': 20.0, 'damage_wait_time': 1.0, 'collision_radius': 0.5, 'collision_height': 1.5, 'creature_size': 2})
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xb31b771d
    swamp_boss_stage2_data = SwampBossStage2Data.from_stream(data, property_size)

    return SwampBossStage2(editor_properties, patterned, actor_information, ing_possession_data, swamp_boss_stage2_data)
...
_decode_swamp_boss_stage2_data = SwampBossStage2Data.from_stream
