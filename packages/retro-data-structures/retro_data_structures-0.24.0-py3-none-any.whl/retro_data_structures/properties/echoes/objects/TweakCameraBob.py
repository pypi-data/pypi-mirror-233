...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[TweakCameraBob]:
    ...
    return TweakCameraBob(instance_name, camera_bob_extent_x, camera_bob_extent_y, camera_bob_period, unknown_0xa27bb5a7, unknown_0xe3580b2b, slow_speed_period_scale, target_magnitude_tracking_rate, landing_bob_spring_constant, view_wander_radius, view_wander_speed_min, view_wander_speed_max, view_wander_roll_variation, gun_bob_magnitude, helmet_bob_magnitude)
