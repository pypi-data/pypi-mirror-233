...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[SwampBossStage1]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xb01a28d5
    unknown_struct37 = UnknownStruct37.from_stream(data, property_size)

    return SwampBossStage1(editor_properties, patterned, actor_information, unknown_struct37)
