...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[AtomicAlpha]:
    ...
    return AtomicAlpha(editor_properties, patterned, actor_information, bomb_weapon, bomb_model, bomb_damage, bomb_drop_delay, bomb_reappear_delay, bomb_reappear_time, invisible, home_while_charging)
