...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[PillBug]:
    ...
    return PillBug(editor_properties, patterned, actor_information, unknown_0xde7e9f94, floor_turn_speed, stick_radius, waypoint_approach_distance, visible_distance, damage_vulnerability, wander_vulnerability, crawl_radius, roll_radius, unknown_0x519c7197, unknown_0xa265383c, forward_priority, unknown_0x558c0692, unknown_0x0f991bf1, unknown_0x385a1bed, unknown_0xcf4ea141)
