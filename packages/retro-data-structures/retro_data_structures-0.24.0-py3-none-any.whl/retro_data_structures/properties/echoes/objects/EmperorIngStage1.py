...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[EmperorIngStage1]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x4a1e493b
    data = EmperorIngStage1Data.from_stream(data, property_size)

    return EmperorIngStage1(editor_properties, patterned, actor_information, data)
...
_decode_data = EmperorIngStage1Data.from_stream
