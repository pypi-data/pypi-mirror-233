...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[RubiksPuzzle]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x9fcd4e38
    unknown_struct35 = UnknownStruct35.from_stream(data, property_size)

    return RubiksPuzzle(editor_properties, unknown_struct35)
