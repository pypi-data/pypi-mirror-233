...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[AtomicBeta]:
    ...
    return AtomicBeta(editor_properties, patterned, actor_information, beam_effect, beam, beam_damage, contact_fx, beam_fade_time, beam_radius, hover_speed, frozen_vulnerability, normal_rotate_speed, charging_rotate_speed, speed_change_rate, sound_0x14038b71, sound_0x16a435cb, sound_0x67edefc2, damage_delay)
