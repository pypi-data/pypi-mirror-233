...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[HUDHint]:
    if property_count != 8:
        return None
    ...
    hud_texture = struct.unpack(">L", data.read(4))[0]
    ...
    return HUDHint(editor_properties, hud_texture, unknown_0x6078a651, unknown_0xf00bb6bb, icon_scale, animation_time, animation_frames, unknown_0xd993f97b)
