...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[FogVolume]:
    if property_count != 4:
        return None
    ...
    return FogVolume(editor_properties, fog_bob_height, fog_bob_freq, fog_color)
