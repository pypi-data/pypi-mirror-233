...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ScanTreeSlider]:
    if property_count != 4:
        return None
    ...
    return ScanTreeSlider(editor_properties, name_string_table, name_string_name, unknown)
