...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Shredder]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xab24a926
    data = UnknownStruct39.from_stream(data, property_size)

    return Shredder(editor_properties, patterned, actor_information, data)
...
_decode_data = UnknownStruct39.from_stream
