...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[EmperorIngStage2Tentacle]:
    if property_count != 4:
        return None
    ...
    patterned = PatternedAITypedef.from_stream(data, property_size, default_override={'creature_size': 2})
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x5105fa2d
    data = EmperorIngStage2TentacleData.from_stream(data, property_size)

    return EmperorIngStage2Tentacle(editor_properties, patterned, actor_information, data)
...
_decode_data = EmperorIngStage2TentacleData.from_stream
