...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Silhouette]:
    if property_count != 5:
        return None
    ...
    return Silhouette(editor_properties, unknown, silhouette_color, fade_in_time, fade_out_time)
