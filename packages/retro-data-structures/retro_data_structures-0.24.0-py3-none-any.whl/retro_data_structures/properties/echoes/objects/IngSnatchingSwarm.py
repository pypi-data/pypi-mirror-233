...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[IngSnatchingSwarm]:
    ...
    return IngSnatchingSwarm(editor_properties, state_machine, swarm_particle_system, unknown_0x7cae2ed5, part_0x35a88fa1, unknown_0xf65e7ec5, lifetime, max_linear_speed, max_linear_acceleration, max_turn_speed, unknown_0xdffdf5a2, ignore_player, unknown_0xe6b57a25, exit_portal_distance, unknown_0x2de5a19a, unknown_0x4e79f717, unknown_0xe8e0b5a6, begin_snatching_range, part_0x2d2afc26, impact_damage, sound_impact, sound_idle, sound_move, health, swarm_vulnerability)
...
_decode_swarm_vulnerability = DamageVulnerability.from_stream
