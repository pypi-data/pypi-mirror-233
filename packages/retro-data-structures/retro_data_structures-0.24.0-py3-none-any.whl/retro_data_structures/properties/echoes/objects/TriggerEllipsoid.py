...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[TriggerEllipsoid]:
    if property_count != 4:
        return None
    ...
    return TriggerEllipsoid(editor_properties, trigger, deactivate_on_enter, deactivate_on_exit)
