...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[TweakParticle]:
    if property_count != 4:
        return None
    ...
    return TweakParticle(instance_name, pak_file, primary_weapon, secondary_weapon)
