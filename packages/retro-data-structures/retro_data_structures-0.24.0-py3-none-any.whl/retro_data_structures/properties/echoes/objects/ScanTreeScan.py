...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ScanTreeScan]:
    if property_count != 4:
        return None
    ...
    return ScanTreeScan(editor_properties, name_string_table, name_string_name, scannable_parameters)
