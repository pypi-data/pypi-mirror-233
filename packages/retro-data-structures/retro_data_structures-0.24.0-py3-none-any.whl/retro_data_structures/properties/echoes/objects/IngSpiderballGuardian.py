...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[IngSpiderballGuardian]:
    if property_count != 4:
        return None
    ...
    return IngSpiderballGuardian(editor_properties, patterned, actor_information, unknown_struct31)
