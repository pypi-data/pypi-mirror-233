...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Krocuss]:
...
_decode_shell_closed_vulnerability = DamageVulnerability.from_stream
