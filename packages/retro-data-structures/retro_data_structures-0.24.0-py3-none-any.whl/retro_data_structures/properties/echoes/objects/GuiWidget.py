...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[GuiWidget]:
    if property_count != 3:
        return None
    ...
    return GuiWidget(editor_properties, gui_widget_properties, controller_number)
