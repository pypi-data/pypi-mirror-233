...
class Sandworm(BaseObjectType):
    ...
    walk_vocal_sound: int = dataclasses.field(default=0, metadata={'sound': True})
    melee_attack_sound: int = dataclasses.field(default=0, metadata={'sound': True})
    eye_killed_sound: int = dataclasses.field(default=0, metadata={'sound': True})
    pincer_l: AssetId = dataclasses.field(metadata={'asset_types': ['CMDL']}, default=default_asset_id)
    pincer_r: AssetId = dataclasses.field(metadata={'asset_types': ['CMDL']}, default=default_asset_id)
    unknown_0x63dcbbb6: float = dataclasses.field(default=9.0)
    unknown_0x2393c3c0: float = dataclasses.field(default=25.0)
    spit_attack_visor_effect: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=default_asset_id)
    ...
    eye_glow: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=default_asset_id)
    part_0x3221407e: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=default_asset_id)
    part_0x8b2a15ee: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=default_asset_id)
    part_0x526c6956: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=default_asset_id)
    part_0xd24a1751: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=default_asset_id)
    ...
    bomb_bounce_sound: int = dataclasses.field(default=0, metadata={'sound': True})
    bomb_explode_sound: int = dataclasses.field(default=0, metadata={'sound': True})
    ...
    def _dependencies_for_morphball_toss_damage(self, asset_manager):
        yield from self.morphball_toss_damage.dependencies_for(asset_manager)

    def _dependencies_for_pincer_swipe_damage(self, asset_manager):
        yield from self.pincer_swipe_damage.dependencies_for(asset_manager)

    def _dependencies_for_eye_glow(self, asset_manager):
        yield from asset_manager.get_dependencies_for_asset(self.eye_glow)

    def _dependencies_for_part_0x3221407e(self, asset_manager):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x3221407e)

    def _dependencies_for_part_0x8b2a15ee(self, asset_manager):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x8b2a15ee)

    def _dependencies_for_part_0x526c6956(self, asset_manager):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x526c6956)

    def _dependencies_for_part_0xd24a1751(self, asset_manager):
        yield from asset_manager.get_dependencies_for_asset(self.part_0xd24a1751)

    def _dependencies_for_ing_boss_bomb_damage(self, asset_manager):
        yield from self.ing_boss_bomb_damage.dependencies_for(asset_manager)

    def _dependencies_for_bomb_bounce_sound(self, asset_manager):
        yield from asset_manager.get_audio_group_dependency(self.bomb_bounce_sound)

    def _dependencies_for_bomb_explode_sound(self, asset_manager):
        yield from asset_manager.get_audio_group_dependency(self.bomb_explode_sound)

    def _dependencies_for_sandworm_struct_0xb8c15f15(self, asset_manager):
        yield from self.sandworm_struct_0xb8c15f15.dependencies_for(asset_manager)

    def _dependencies_for_sandworm_struct_0xce246628(self, asset_manager):
        yield from self.sandworm_struct_0xce246628.dependencies_for(asset_manager)

    def _dependencies_for_sandworm_struct_0x55578cfc(self, asset_manager):
        yield from self.sandworm_struct_0x55578cfc.dependencies_for(asset_manager)

    def _dependencies_for_sandworm_struct_0x23ee1452(self, asset_manager):
        yield from self.sandworm_struct_0x23ee1452.dependencies_for(asset_manager)

    def _dependencies_for_sandworm_struct_0xb89dfe86(self, asset_manager):
        yield from self.sandworm_struct_0xb89dfe86.dependencies_for(asset_manager)
    ...
    def dependencies_for(self, asset_manager):
        for method, field_name, field_type in [
            ...
            (self._dependencies_for_morphball_toss_damage, "morphball_toss_damage", "DamageInfo"),
            (self._dependencies_for_pincer_swipe_damage, "pincer_swipe_damage", "DamageInfo"),
            ...
            (self._dependencies_for_ing_boss_bomb_damage, "ing_boss_bomb_damage", "DamageInfo"),
            ...
            (self._dependencies_for_sandworm_struct_0xb8c15f15, "sandworm_struct_0xb8c15f15", "SandwormStruct"),
            (self._dependencies_for_sandworm_struct_0xce246628, "sandworm_struct_0xce246628", "SandwormStruct"),
            (self._dependencies_for_sandworm_struct_0x55578cfc, "sandworm_struct_0x55578cfc", "SandwormStruct"),
            (self._dependencies_for_sandworm_struct_0x23ee1452, "sandworm_struct_0x23ee1452", "SandwormStruct"),
            (self._dependencies_for_sandworm_struct_0xb89dfe86, "sandworm_struct_0xb89dfe86", "SandwormStruct"),
...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Sandworm]:
...
_decode_sandworm_struct_0xb8c15f15 = SandwormStruct.from_stream

_decode_sandworm_struct_0xce246628 = SandwormStruct.from_stream

_decode_sandworm_struct_0x55578cfc = SandwormStruct.from_stream

_decode_sandworm_struct_0x23ee1452 = SandwormStruct.from_stream

_decode_sandworm_struct_0xb89dfe86 = SandwormStruct.from_stream
