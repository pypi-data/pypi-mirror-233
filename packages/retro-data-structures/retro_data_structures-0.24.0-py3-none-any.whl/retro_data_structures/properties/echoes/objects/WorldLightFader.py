...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[WorldLightFader]:
    if property_count != 3:
        return None
    ...
    return WorldLightFader(editor_properties, target_light, target_light_rate)
