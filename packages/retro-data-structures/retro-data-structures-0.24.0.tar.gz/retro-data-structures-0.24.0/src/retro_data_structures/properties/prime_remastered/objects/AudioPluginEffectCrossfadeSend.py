...
class AudioPluginEffectCrossfadeSend(BaseProperty):
...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[AudioPluginEffectCrossfadeSend]:
    if property_count != 0:
        return None
