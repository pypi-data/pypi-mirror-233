...
class PlayerSpawnPoint_InputMacroRelay(BaseProperty):
...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[PlayerSpawnPoint_InputMacroRelay]:
    if property_count != 0:
        return None
