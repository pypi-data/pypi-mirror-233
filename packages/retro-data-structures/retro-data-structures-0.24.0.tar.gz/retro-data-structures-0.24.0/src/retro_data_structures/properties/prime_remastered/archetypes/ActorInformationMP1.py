...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ActorInformationMP1]:
    ...
    return ActorInformationMP1(unk_guid_1, unk_guid_2, unk_guid_3, unk_guid_4, unk_guid_5, unk_float_1, unk_bool_4, lighting, scannable, visor, unk_float_2, unk_float_3, unk_float_4, unk_int, water_sort_type, unk_bool_1, unk_bool_2, unk_bool_3, unk_bool_5, unk_bool_6, unk_bool_7, unk_bool_8, unk_bool_9, unk_bool_10)
...
_decode_lighting = LightingMP1.from_stream

_decode_scannable = ScannableMP1.from_stream

_decode_visor = VisorMP1.from_stream
