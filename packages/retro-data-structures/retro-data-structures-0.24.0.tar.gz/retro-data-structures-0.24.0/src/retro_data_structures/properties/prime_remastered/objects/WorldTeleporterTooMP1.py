...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[WorldTeleporterTooMP1]:
    ...
    return WorldTeleporterTooMP1(world, area, animation_information, player_scale, platform, platform_scale, shaft_scale, unk_str, unk_bool1, sound, volume, upward_elevator, text, pan, unk_bool2, char_fade_in_time, chars_per_second, delay_before_show, show_text_instead_of_cutscene, unk_float1, unk_float2, unk_float3)
...
_decode_animation_information = AnimSetMP1.from_stream

_decode_player_scale = VectorMP1.from_stream

def _decode_platform(data: typing.BinaryIO, property_size: int):
    return uuid.UUID(bytes_le=data.read(16))


_decode_platform_scale = VectorMP1.from_stream

_decode_shaft_scale = VectorMP1.from_stream

_decode_unk_str = PooledString.from_stream
