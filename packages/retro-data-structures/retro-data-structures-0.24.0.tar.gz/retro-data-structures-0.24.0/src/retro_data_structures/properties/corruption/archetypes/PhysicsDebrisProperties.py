...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[PhysicsDebrisProperties]:
    ...
    physics_debris_properties_orientation_enum_0x49286613 = PhysicsDebrisPropertiesOrientationEnum.from_stream(data, property_size)
    ...
    physics_debris_properties_orientation_enum_0x1e0a4a41 = PhysicsDebrisPropertiesOrientationEnum.from_stream(data, property_size)
    ...
    return PhysicsDebrisProperties(cone_spread_yaw, cone_spread_pitch, initial_direction, position_offset, transform_position_offset, minimum_speed, maximum_speed, minimum_spin_speed, maximum_spin_speed, minimum_lifetime, maximum_lifetime, disable_collision_time, fade_in_end_percentage, fade_out_start_percentage, start_color, middle_color, end_color, scale_start_percentage, final_scale, unknown_0x417f4a91, friction, gravity, disable_physics_threshold, model, bounce_sound, max_bounce_sounds, unknown_0x76c79503, unknown_0x310dfac8, unknown_0x5e9f5215, unknown_0x39743618, unknown_0x33e0fbb4, unknown_0xe82e7ed7, unknown_0x855ee21b, particle_system1, particle_system1_scale, particle_system1_uses_global_translation, particle_system1_uses_global_orientation, particle_system1_wait_for_particles_to_die, physics_debris_properties_orientation_enum_0x49286613, particle_system2, particle_system2_scale, particle_system2_uses_global_translation, particle_system2_uses_global_orientation, particle_system2_wait_for_particles_to_die, physics_debris_properties_orientation_enum_0x1e0a4a41, is_collider, is_shootable, die_on_collision, unknown_0xbfd82a19, unknown_0x723d42d6, unknown_0x4edb1d0e, unknown_0xbf496273)
...
_decode_physics_debris_properties_orientation_enum_0x49286613 = PhysicsDebrisPropertiesOrientationEnum.from_stream
...
_decode_physics_debris_properties_orientation_enum_0x1e0a4a41 = PhysicsDebrisPropertiesOrientationEnum.from_stream
