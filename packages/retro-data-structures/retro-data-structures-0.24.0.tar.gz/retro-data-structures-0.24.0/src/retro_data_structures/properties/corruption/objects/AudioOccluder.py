...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[AudioOccluder]:
    if property_count != 3:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xfa7b5650
    unknown = struct.unpack('>l', data.read(4))[0]

    return AudioOccluder(editor_properties, volume_attenuation, unknown)
