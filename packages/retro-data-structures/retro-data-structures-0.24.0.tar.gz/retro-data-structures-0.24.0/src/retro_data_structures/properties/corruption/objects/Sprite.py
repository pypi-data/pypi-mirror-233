...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Sprite]:
    if property_count != 4:
        return None
    ...
    return Sprite(editor_properties, unknown_struct64, patterned, actor_information)
