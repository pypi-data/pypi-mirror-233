...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[CableProperties]:
    ...
    cable_bloom = enums.CableBloom.from_stream(data)
