...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Metaree]:
    ...
    patterned = PatternedAITypedef.from_stream(data, property_size, default_override={'detection_range': 30.0})
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xe99c264a
    unknown_struct47 = UnknownStruct47.from_stream(data, property_size)

    return Metaree(editor_properties, patterned, actor_information, unknown_struct47)
...
_decode_unknown_struct47 = UnknownStruct47.from_stream
