...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Platform]:
    ...
    return Platform(editor_properties, collision_box, collision_offset, model, animation, actor_information, collision_model, health, vulnerability, x_ray_transparency, maximum_splashes, splash_generation_rate, render_rain_splashes, unknown_0xf203bc81, motion_properties, unknown_0x24fdeea1, random_animation_offset, orbit_offset_local, orbit_offset, unknown_0x6b5e87a7, look_at_velocity)
