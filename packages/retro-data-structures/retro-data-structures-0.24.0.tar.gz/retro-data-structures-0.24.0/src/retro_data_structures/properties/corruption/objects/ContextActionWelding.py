...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ContextActionWelding]:
    if property_count != 3:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x2f74dc89
    unknown_struct24 = UnknownStruct24.from_stream(data, property_size)

    return ContextActionWelding(editor_properties, actor_information, unknown_struct24)
