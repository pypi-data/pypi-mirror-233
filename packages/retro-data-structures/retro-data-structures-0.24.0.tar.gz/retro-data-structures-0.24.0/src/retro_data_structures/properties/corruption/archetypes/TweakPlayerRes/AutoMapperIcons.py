...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[AutoMapperIcons]:
    ...
    return AutoMapperIcons(landing_site, unknown_0xdd1b0445, warp_portal, save_station, map_station, unknown_0xdfac0db1, unknown_0xb838c9c0, unknown_0x5096bfa5, unknown_0x5291eb5f, unknown_0xf4e6e0eb, unknown_0x65700ccc, unknown_0xa0d73242)
