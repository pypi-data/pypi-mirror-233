...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[BlinkWolfData]:
...
_decode_spit_starting = LaunchProjectileData.from_stream

_decode_spit_full_speed = LaunchProjectileData.from_stream

_decode_launch_projectile_data_0x76b1b8e0 = LaunchProjectileData.from_stream

_decode_launch_projectile_data_0xfe3b5965 = LaunchProjectileData.from_stream
...
_decode_shockwave_damage = DamageInfo.from_stream
