...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[CameraBlurKeyframe]:
    if property_count != 6:
        return None
    ...
    return CameraBlurKeyframe(editor_properties, blur_type, blur_radius, which_filter_group, interpolate_in_time, interpolate_out_time)
