...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[FargullHatcher]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xf55b70e6
    fargull_hatcher_data = FargullHatcherData.from_stream(data, property_size)
    ...
    return FargullHatcher(editor_properties, fargull_hatcher_data, patterned, actor_information)


_decode_editor_properties = EditorProperties.from_stream

_decode_fargull_hatcher_data = FargullHatcherData.from_stream
