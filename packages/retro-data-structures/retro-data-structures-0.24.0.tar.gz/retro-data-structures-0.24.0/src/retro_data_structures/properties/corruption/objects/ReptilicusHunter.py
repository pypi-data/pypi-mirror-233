...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ReptilicusHunter]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x3b7085ad
    reptilicus_hunter_data = ReptilicusHunterData.from_stream(data, property_size)

    return ReptilicusHunter(editor_properties, patterned, actor_information, reptilicus_hunter_data)
...
_decode_reptilicus_hunter_data = ReptilicusHunterData.from_stream
