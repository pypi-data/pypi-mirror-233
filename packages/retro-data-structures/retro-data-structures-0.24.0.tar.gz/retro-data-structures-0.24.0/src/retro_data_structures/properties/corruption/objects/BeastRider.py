...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[BeastRider]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x56c48141
    beast_rider_properties = BeastRiderData.from_stream(data, property_size)
    ...
    return BeastRider(editor_properties, beast_rider_properties, patterned, actor_information)


_decode_editor_properties = EditorProperties.from_stream

_decode_beast_rider_properties = BeastRiderData.from_stream
