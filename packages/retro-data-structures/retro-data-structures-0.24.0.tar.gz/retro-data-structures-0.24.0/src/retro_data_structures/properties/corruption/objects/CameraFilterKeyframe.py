...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[CameraFilterKeyframe]:
    ...
    return CameraFilterKeyframe(editor_properties, filter_type, filter_shape, filter_stage, which_filter_group, color, interpolate_in_time, interpolate_out_time, texture, model)
