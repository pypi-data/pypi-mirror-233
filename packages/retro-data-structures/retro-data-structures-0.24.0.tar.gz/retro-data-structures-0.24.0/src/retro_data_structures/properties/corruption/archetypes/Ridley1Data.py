...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Ridley1Data]:
...
_decode_damage_info_0xe82166db = DamageInfo.from_stream

_decode_below_beam_damage = DamageInfo.from_stream

def _decode_unknown_0xf616d87b(data: typing.BinaryIO, property_size: int):
    return struct.unpack('>f', data.read(4))[0]


_decode_below_bite_damage = DamageInfo.from_stream

_decode_damage_info_0x54031e21 = DamageInfo.from_stream

def _decode_unknown_0xb5194095(data: typing.BinaryIO, property_size: int):
    return struct.unpack('>f', data.read(4))[0]


_decode_in_hand_bite_damage = DamageInfo.from_stream

def _decode_unknown_0xddd0212a(data: typing.BinaryIO, property_size: int):
    return struct.unpack('>f', data.read(4))[0]


_decode_damage_info_0x6bb8e35c = DamageInfo.from_stream

def _decode_unknown_0xf4c13980(data: typing.BinaryIO, property_size: int):
    return struct.unpack('>f', data.read(4))[0]


_decode_in_hand_slap_damage = DamageInfo.from_stream

def _decode_unknown_0xa4cb7b3c(data: typing.BinaryIO, property_size: int):
    return struct.unpack('>f', data.read(4))[0]


_decode_damage_info_0x742287f5 = DamageInfo.from_stream

def _decode_unknown_0xbe3b8e93(data: typing.BinaryIO, property_size: int):
    return struct.unpack('>f', data.read(4))[0]


_decode_damage_info_0x78f4a916 = DamageInfo.from_stream

_decode_damage_info_0x76f0f23b = DamageInfo.from_stream

_decode_damage_info_0x77edd892 = DamageInfo.from_stream

_decode_above_missile_damage = DamageInfo.from_stream

_decode_above_fireball_damage = DamageInfo.from_stream
