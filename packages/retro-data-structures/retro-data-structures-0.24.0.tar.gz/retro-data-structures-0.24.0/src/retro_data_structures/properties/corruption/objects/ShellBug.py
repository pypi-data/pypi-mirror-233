...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ShellBug]:
    if property_count != 5:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xb9ffa928
    shell_bug_data = ShellBugData.from_stream(data, property_size)
    ...
    return ShellBug(editor_properties, shell_bug_data, wall_crawler_properties, patterned, actor_information)


_decode_editor_properties = EditorProperties.from_stream

_decode_shell_bug_data = ShellBugData.from_stream
