...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[CrossAreaRelay]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xd2eb009d
    relay_name = data.read(property_size)[:-1].decode("utf-8")

    return CrossAreaRelay(editor_properties, relay_name)
