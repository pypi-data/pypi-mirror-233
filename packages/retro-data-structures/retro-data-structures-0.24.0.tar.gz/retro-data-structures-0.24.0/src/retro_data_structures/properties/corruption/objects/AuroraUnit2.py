...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[AuroraUnit2]:
    if property_count != 6:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x26594deb
    aurora_unit2_data_0x26594deb = AuroraUnit2Data.from_stream(data, property_size)

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x857bee96
    aurora_unit2_data_0x857bee96 = AuroraUnit2Data.from_stream(data, property_size)

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xe74db2b8
    aurora_unit2_data_0xe74db2b8 = AuroraUnit2Data.from_stream(data, property_size)

    return AuroraUnit2(editor_properties, patterned, actor_information, aurora_unit2_data_0x26594deb, aurora_unit2_data_0x857bee96, aurora_unit2_data_0xe74db2b8)
...
_decode_aurora_unit2_data_0x26594deb = AuroraUnit2Data.from_stream

_decode_aurora_unit2_data_0x857bee96 = AuroraUnit2Data.from_stream

_decode_aurora_unit2_data_0xe74db2b8 = AuroraUnit2Data.from_stream
