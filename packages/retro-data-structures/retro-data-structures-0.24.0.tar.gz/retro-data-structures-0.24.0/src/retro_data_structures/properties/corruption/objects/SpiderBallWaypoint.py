...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[SpiderBallWaypoint]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x5d817483
    flags = struct.unpack('>l', data.read(4))[0]

    return SpiderBallWaypoint(editor_properties, flags)
