...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[DarkSamusEcho]:
    if property_count != 6:
        return None
    ...
    patterned = PatternedAITypedef.from_stream(data, property_size, default_override={'turn_speed': 360.0})
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x6d8a6608
    dark_samus_echo_data_0x6d8a6608 = DarkSamusEchoData.from_stream(data, property_size)

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x35c49ddd
    dark_samus_echo_data_0x35c49ddd = DarkSamusEchoData.from_stream(data, property_size)

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xa1178bcf
    dark_samus_echo_data_0xa1178bcf = DarkSamusEchoData.from_stream(data, property_size)

    return DarkSamusEcho(editor_properties, patterned, actor_information, dark_samus_echo_data_0x6d8a6608, dark_samus_echo_data_0x35c49ddd, dark_samus_echo_data_0xa1178bcf)
...
_decode_dark_samus_echo_data_0x6d8a6608 = DarkSamusEchoData.from_stream

_decode_dark_samus_echo_data_0x35c49ddd = DarkSamusEchoData.from_stream

_decode_dark_samus_echo_data_0xa1178bcf = DarkSamusEchoData.from_stream
