...
class UnknownStruct27(BaseProperty):
    ...
    wpsc_0xf5056d9d: AssetId = dataclasses.field(metadata={'asset_types': ['WPSC']}, default=default_asset_id)
    wpsc_0x58dbcc52: AssetId = dataclasses.field(metadata={'asset_types': ['WPSC']}, default=default_asset_id)
    part_0x3a6d3a64: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=default_asset_id)
    pillar_base: AssetId = dataclasses.field(metadata={'asset_types': []}, default=default_asset_id)
    pillar_explosion_effect: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=default_asset_id)
    part_0xe8706e6e: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=default_asset_id)
    plasma_beam_info_0x6cc7412a: PlasmaBeamInfo = dataclasses.field(default_factory=PlasmaBeamInfo)
    homing_missile_projectile: AssetId = dataclasses.field(metadata={'asset_types': ['WPSC']}, default=default_asset_id)
    ...
    echo_explosion: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=default_asset_id)
    echo_scan: AssetId = dataclasses.field(metadata={'asset_types': ['SCAN']}, default=default_asset_id)
    ...
    super_loop_projectile: AssetId = dataclasses.field(metadata={'asset_types': ['WPSC']}, default=default_asset_id)
    part_0x8e96e5e4: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=default_asset_id)
    ...
    unknown_0xe8f323f9: AssetId = dataclasses.field(metadata={'asset_types': []}, default=default_asset_id)
    caud: AssetId = dataclasses.field(metadata={'asset_types': ['CAUD']}, default=default_asset_id)
    unknown_0x8b8b33d9: AssetId = dataclasses.field(metadata={'asset_types': []}, default=default_asset_id)
    unknown_0x09133ecd: AssetId = dataclasses.field(metadata={'asset_types': []}, default=default_asset_id)
    is_dash_automatically: AssetId = dataclasses.field(metadata={'asset_types': []}, default=default_asset_id)
    sound_invulnerable_loop: AssetId = dataclasses.field(metadata={'asset_types': []}, default=default_asset_id)
    sound_shockwave: AssetId = dataclasses.field(metadata={'asset_types': []}, default=default_asset_id)
...
_decode_plasma_beam_info_0x6cc7412a = PlasmaBeamInfo.from_stream
...
_decode_echo_animation_information = AnimationParameters.from_stream
...
_decode_plasma_beam_info_0xec493f59 = PlasmaBeamInfo.from_stream
