...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[SeedBoss2BotSwarm]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xd6cc62cb
    unknown_struct59 = UnknownStruct59.from_stream(data, property_size)

    return SeedBoss2BotSwarm(editor_properties, patterned, actor_information, unknown_struct59)
