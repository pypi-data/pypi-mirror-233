...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[SeedBoss1Orb]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xee53ebe7
    seed_boss1_orb_data = SeedBoss1OrbData.from_stream(data, property_size)

    return SeedBoss1Orb(editor_properties, patterned, actor_information, seed_boss1_orb_data)
...
_decode_seed_boss1_orb_data = SeedBoss1OrbData.from_stream
