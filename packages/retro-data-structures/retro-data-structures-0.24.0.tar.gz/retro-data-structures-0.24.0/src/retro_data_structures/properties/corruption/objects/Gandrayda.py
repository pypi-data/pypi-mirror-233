...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Gandrayda]:
    if property_count != 6:
        return None
    ...
    return Gandrayda(editor_properties, patterned, actor_information, gandrayda_data_0xfee49b25, gandrayda_data_0x49b975e6, gandrayda_data_0x82439cba)
...
_decode_gandrayda_data_0xfee49b25 = GandraydaData.from_stream

_decode_gandrayda_data_0x49b975e6 = GandraydaData.from_stream

_decode_gandrayda_data_0x82439cba = GandraydaData.from_stream
