...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ControlHint]:
    ...
    return ControlHint(editor_properties, priority, timer, cancel_method, cancel_press_count, cancel_press_time, cancel_timer, cancel_velocity, unknown, command1, command2, command3, command4, command5, command6, command7, command8)
...
_decode_command1 = CommandData.from_stream

_decode_command2 = CommandData.from_stream

_decode_command3 = CommandData.from_stream

_decode_command4 = CommandData.from_stream

_decode_command5 = CommandData.from_stream

_decode_command6 = CommandData.from_stream

_decode_command7 = CommandData.from_stream

_decode_command8 = CommandData.from_stream
