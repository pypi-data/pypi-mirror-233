...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[PhazonPuddle]:
    if property_count != 3:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x6f3bb625
    phazon_puddle_properties = PhazonPuddleData.from_stream(data, property_size)

    return PhazonPuddle(editor_properties, actor_information, phazon_puddle_properties)
...
_decode_phazon_puddle_properties = PhazonPuddleData.from_stream
