...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[AlarmController]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xde8088c9
    stage1_timer = struct.unpack('>f', data.read(4))[0]

    return AlarmController(editor_properties, stage1_timer)
