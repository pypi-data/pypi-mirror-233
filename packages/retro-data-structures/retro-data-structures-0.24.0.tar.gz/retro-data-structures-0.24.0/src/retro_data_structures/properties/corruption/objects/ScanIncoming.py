...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ScanIncoming]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x607bc79e
    scan_asset = struct.unpack(">Q", data.read(8))[0]

    return ScanIncoming(editor_properties, scan_asset)
