...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[PlatformMotionProperties]:
    ...
    return PlatformMotionProperties(motion_spline_type, motion_control_spline, motion_spline_duration, initial_time, unknown, roll_control_spline, yaw_control_spline, pitch_control_spline, target_object_offset)
