...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Parasite]:
    ...
    patterned = PatternedAITypedef.from_stream(data, property_size, default_override={'mass': 25.0, 'damage_wait_time': 3.0, 'collision_radius': 0.20000000298023224, 'speed': 3.0, 'turn_speed': 720.0, 'detection_range': 5.0, 'detection_angle': 90.0, 'min_attack_range': 4.0, 'max_attack_range': 20.0})
    ...
    wall_crawler_properties = WallCrawlerData.from_stream(data, property_size)

    return Parasite(editor_properties, flavor, patterned, actor_information, telegraph_distance, waypoint_approach_distance, wall_turn_speed, floor_turn_speed, down_turn_speed, stuck_time, unknown_0xd5c25506, behavior_influence_radius, separation_distance, separation_priority, alignment_priority, unknown_0x61959f0d, path_following_priority, forward_moving_priority, player_avoidance_distance, player_avoidance_priority, parasite_visible_distance, initially_paused, wall_crawler_properties)
...
_decode_wall_crawler_properties = WallCrawlerData.from_stream
