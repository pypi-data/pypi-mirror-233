...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[DarkSamus]:
    ...
    return DarkSamus(editor_properties, unknown_struct27, dark_samus_properties, patterned, dark_samus_data, patterned_ai_0x1464ae05, dark_samus_properties_elite_difficulty, patterned_ai_0x24d00673, actor_information)
...
_decode_dark_samus_properties = DarkSamusData.from_stream

_decode_patterned = PatternedAITypedef.from_stream

_decode_dark_samus_data = DarkSamusData.from_stream

_decode_patterned_ai_0x1464ae05 = PatternedAITypedef.from_stream

_decode_dark_samus_properties_elite_difficulty = DarkSamusData.from_stream
