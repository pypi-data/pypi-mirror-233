...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[CircleLineMode]:
    if property_count != 7:
        return None
    ...
    return CircleLineMode(ghor_struct_a_0x17386c2c, ghor_struct_a_0xd171838c, ghor_struct_a_0x017549cb, ghor_struct_a_0x08f6bdc5, ghor_struct_a_0x7b589dd6, collision_set, vulnerability)


_decode_ghor_struct_a_0x17386c2c = GhorStructA.from_stream

_decode_ghor_struct_a_0xd171838c = GhorStructA.from_stream

_decode_ghor_struct_a_0x017549cb = GhorStructA.from_stream

_decode_ghor_struct_a_0x08f6bdc5 = GhorStructA.from_stream

_decode_ghor_struct_a_0x7b589dd6 = GhorStructA.from_stream
