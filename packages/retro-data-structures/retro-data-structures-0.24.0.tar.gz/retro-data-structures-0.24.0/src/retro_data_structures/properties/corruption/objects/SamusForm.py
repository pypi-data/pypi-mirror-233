...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[SamusForm]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x7efc051a
    unknown_struct57 = UnknownStruct57.from_stream(data, property_size)

    return SamusForm(editor_properties, actor_information, patterned, unknown_struct57)
...
_decode_unknown_struct57 = UnknownStruct57.from_stream
