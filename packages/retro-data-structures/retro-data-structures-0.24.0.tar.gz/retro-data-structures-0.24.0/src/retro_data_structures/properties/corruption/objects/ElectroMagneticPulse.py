...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ElectroMagneticPulse]:
    if property_count != 9:
        return None
    ...
    return ElectroMagneticPulse(editor_properties, initial_size, final_size, duration, unknown_0x96bd6426, unknown_0xd7aa5ba0, backward_forward_sweep_chance, unknown_0xce54e50e, explosion)
