...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[UnknownStruct1]:
    ...
    return UnknownStruct1(background_blend_color, unknown_0x10f17007, ship_model_scale, ship_model_base_pitch, ship_model_base_yaw, ship_model_pitch_limit, ship_model_yaw_limit, ship_ambient_color, ship_light_color, ship_light_position, unknown_0x37e62f14, unknown_0x3287fcad)
...
_decode_unknown_0x37e62f14 = Spline.from_stream

_decode_unknown_0x3287fcad = Spline.from_stream
