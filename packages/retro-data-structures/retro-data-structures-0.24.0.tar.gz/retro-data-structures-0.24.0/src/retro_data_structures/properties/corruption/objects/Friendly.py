...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Friendly]:
    if property_count != 5:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xbcc2fddf
    federation_properties = FederationData.from_stream(data, property_size)

    return Friendly(editor_properties, actor_information, patterned, friendly_properties, federation_properties)
...
_decode_federation_properties = FederationData.from_stream
