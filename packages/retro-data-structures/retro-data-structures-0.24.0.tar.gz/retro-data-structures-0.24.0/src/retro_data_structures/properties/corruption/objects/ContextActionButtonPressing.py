...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ContextActionButtonPressing]:
    if property_count != 3:
        return None
    ...
    return ContextActionButtonPressing(editor_properties, unknown_struct22, animation_information)
