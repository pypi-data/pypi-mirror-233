...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[HyperModeData]:
    if property_count != 9:
        return None
    ...
    return HyperModeData(initial_time_max, initial_time_min, duration_max, duration_min, check_delay_max, check_delay_min, check_chance, shot, vulnerability)
...
_decode_shot = LaunchProjectileData.from_stream
