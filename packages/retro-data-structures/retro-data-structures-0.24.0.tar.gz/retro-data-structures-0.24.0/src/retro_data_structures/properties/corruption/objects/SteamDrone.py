...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[SteamDrone]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xa23f161c
    unknown_struct61 = UnknownStruct61.from_stream(data, property_size)

    return SteamDrone(editor_properties, patterned, actor_information, unknown_struct61)
