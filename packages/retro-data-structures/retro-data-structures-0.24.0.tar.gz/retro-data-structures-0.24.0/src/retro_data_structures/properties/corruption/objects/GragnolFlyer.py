...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[GragnolFlyer]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x47ed32f2
    gragnol_flyer_properties = GragnolFlyerData.from_stream(data, property_size)

    return GragnolFlyer(editor_properties, patterned, actor_information, gragnol_flyer_properties)
...
_decode_gragnol_flyer_properties = GragnolFlyerData.from_stream
