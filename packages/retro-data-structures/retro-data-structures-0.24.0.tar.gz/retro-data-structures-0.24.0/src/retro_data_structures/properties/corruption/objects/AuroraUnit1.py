...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[AuroraUnit1]:
    if property_count != 6:
        return None
    ...
    aurora_unit1_data_0x93aedac3 = AuroraUnit1Data.from_stream(data, property_size)

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x867ab15e
    aurora_unit1_data_0x867ab15e = AuroraUnit1Data.from_stream(data, property_size)

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xb3c5f11b
    aurora_unit1_data_0xb3c5f11b = AuroraUnit1Data.from_stream(data, property_size)

    return AuroraUnit1(editor_properties, patterned, actor_information, aurora_unit1_data_0x93aedac3, aurora_unit1_data_0x867ab15e, aurora_unit1_data_0xb3c5f11b)
...
_decode_aurora_unit1_data_0x93aedac3 = AuroraUnit1Data.from_stream

_decode_aurora_unit1_data_0x867ab15e = AuroraUnit1Data.from_stream

_decode_aurora_unit1_data_0xb3c5f11b = AuroraUnit1Data.from_stream
