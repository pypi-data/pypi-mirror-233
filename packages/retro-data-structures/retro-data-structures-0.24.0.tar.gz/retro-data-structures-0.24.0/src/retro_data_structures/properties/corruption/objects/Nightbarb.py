...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Nightbarb]:
    if property_count != 7:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x7971e068
    unknown_struct48 = UnknownStruct48.from_stream(data, property_size)

    return Nightbarb(editor_properties, actor_information, character_animation_information, active, swarm_basics_data, flyer_swarm_data, unknown_struct48)
...
_decode_unknown_struct48 = UnknownStruct48.from_stream
