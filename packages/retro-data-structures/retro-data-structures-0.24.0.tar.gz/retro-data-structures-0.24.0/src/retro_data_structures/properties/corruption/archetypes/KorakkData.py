...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[KorakkData]:
    ...
    return KorakkData(unknown_0x27b15c35, unknown_0x6c6b5700, mouth_vulnerability, tongue_damage, morphball_bite_damage, damage_info_0x77941011, damage_info_0x4d07f7b1, phazon_lance_damage, damage_info_0x8333b35f, stab_damage)
...
_decode_tongue_damage = DamageInfo.from_stream

_decode_morphball_bite_damage = DamageInfo.from_stream

_decode_damage_info_0x77941011 = DamageInfo.from_stream

_decode_damage_info_0x4d07f7b1 = DamageInfo.from_stream

_decode_phazon_lance_damage = DamageInfo.from_stream

_decode_damage_info_0x8333b35f = DamageInfo.from_stream
