...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[BallTrigger]:
    ...
    return BallTrigger(editor_properties, attraction_force, attraction_angle, attraction_distance, attraction_direction, no_ball_movement, bounds_size_multiplier, fix_position_on_activate, trigger_properties)
