...
class UnknownStruct26(BaseProperty):
    ...
    helmet_l_model: AssetId = dataclasses.field(metadata={'asset_types': ['CMDL']}, default=default_asset_id)
    helmet_r_model: AssetId = dataclasses.field(metadata={'asset_types': ['CMDL']}, default=default_asset_id)
    optic_array_model: AssetId = dataclasses.field(metadata={'asset_types': ['CMDL']}, default=default_asset_id)
    jammer_antenna_model: AssetId = dataclasses.field(metadata={'asset_types': ['CMDL']}, default=default_asset_id)
    part_0x537f8382: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=default_asset_id)
    jammer_antenna_explosion_effect: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=default_asset_id)
    part_0xad17a036: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=default_asset_id)
    leg_collision_effect: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=default_asset_id)
    ...
    huge_missile_projectile: AssetId = dataclasses.field(metadata={'asset_types': ['WPSC']}, default=default_asset_id)
    seeker_bomb_effect: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=default_asset_id)
    part_0xdbf176dd: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=default_asset_id)
    death_gibs: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=default_asset_id)
    part_0xdd6be17f: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=default_asset_id)
    ...
    sound_jump_loop: AssetId = dataclasses.field(metadata={'asset_types': ['CAUD']}, default=default_asset_id)
    sound_bomb_loop: AssetId = dataclasses.field(metadata={'asset_types': ['CAUD']}, default=default_asset_id)
    caud_0xb4a84d85: AssetId = dataclasses.field(metadata={'asset_types': ['CAUD']}, default=default_asset_id)
    caud_0xfef01104: AssetId = dataclasses.field(metadata={'asset_types': ['CAUD']}, default=default_asset_id)
    caud_0xeb8805bd: AssetId = dataclasses.field(metadata={'asset_types': ['CAUD']}, default=default_asset_id)
    sound_fireball_loop: AssetId = dataclasses.field(metadata={'asset_types': []}, default=default_asset_id)
    unknown_0xa99ccb84: AssetId = dataclasses.field(metadata={'asset_types': []}, default=default_asset_id)
    unknown_0xb60df150: AssetId = dataclasses.field(metadata={'asset_types': []}, default=default_asset_id)
