...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[OptionalAreaAsset]:
    if property_count != 3:
        return None
    ...
    return OptionalAreaAsset(editor_properties, optional_area_asset_types, asset)


_decode_editor_properties = EditorProperties.from_stream

_decode_optional_area_asset_types = OptionalAreaAssetTypes.from_stream
