...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ParticleBlaster]:
    ...
    return ParticleBlaster(projectile_static_geometry_test, projectile, damage, sound, visor_effect, visor_impact_sound, max_attack_range, min_attack_time, attack_time_variance, unknown)
