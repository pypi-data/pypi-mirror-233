...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[FlyingPirateStruct]:
    if property_count != 6:
        return None
    ...
    return FlyingPirateStruct(enable_hyper_mode, initial_hyper_mode_time, hyper_mode_check_time, hyper_mode_check_chance, hyper_mode_duration, hyper_mode_vulnerability)
