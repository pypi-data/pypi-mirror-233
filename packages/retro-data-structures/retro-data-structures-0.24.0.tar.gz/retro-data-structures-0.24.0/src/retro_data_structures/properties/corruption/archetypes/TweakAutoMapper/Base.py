...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Base]:
...
_decode_unknown_0x0c939a90 = Spline.from_stream
...
_decode_unknown_0xd33eb347 = Spline.from_stream
