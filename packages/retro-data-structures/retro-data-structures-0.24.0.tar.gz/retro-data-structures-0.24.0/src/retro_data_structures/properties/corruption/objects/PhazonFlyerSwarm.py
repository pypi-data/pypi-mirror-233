...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[PhazonFlyerSwarm]:
    if property_count != 7:
        return None
    ...
    return PhazonFlyerSwarm(editor_properties, actor_information, character_animation_information, active, swarm_basics_data, flyer_swarm_data, phazon_flyer_swarm_data)
...
_decode_phazon_flyer_swarm_data = PhazonFlyerSwarmData.from_stream
