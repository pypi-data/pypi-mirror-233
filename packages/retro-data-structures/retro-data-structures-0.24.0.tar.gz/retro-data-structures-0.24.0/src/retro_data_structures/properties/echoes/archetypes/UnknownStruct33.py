...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[UnknownStruct33]:
    ...
    return UnknownStruct33(damage, bomb_stun_duration, unknown_0x46aaced3, max_speed, max_wall_speed, ball_pursuit_speed, speed_modifier, turn_speed, blob_effect, hit_normal_damage, hit_heavy_damage, death, sound_idle, sound_move, sound_0xb392943a, sound_0x24ecc1e9, sound_death, unknown_0x7569fdba, unknown_0xd55938d2, vulnerability)
