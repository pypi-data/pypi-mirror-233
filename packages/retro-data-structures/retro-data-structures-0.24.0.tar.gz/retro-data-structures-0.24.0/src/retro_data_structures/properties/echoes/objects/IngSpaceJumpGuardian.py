...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[IngSpaceJumpGuardian]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xf9837ab3
    unknown_struct32 = UnknownStruct32.from_stream(data, property_size)

    return IngSpaceJumpGuardian(editor_properties, patterned, actor_information, unknown_struct32)
