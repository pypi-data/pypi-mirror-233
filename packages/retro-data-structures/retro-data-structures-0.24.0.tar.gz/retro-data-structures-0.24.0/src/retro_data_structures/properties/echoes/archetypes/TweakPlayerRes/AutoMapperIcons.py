...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[AutoMapperIcons]:
    ...
    return AutoMapperIcons(save_station_icon, missile_station_icon, elevator_icon_icon, portal_icon, unknown_0xfbf479ec, unknown_0x5566b6e4, unknown_0x51fe3f1f, unknown_0xa4127a5a, translator_door_icon)
