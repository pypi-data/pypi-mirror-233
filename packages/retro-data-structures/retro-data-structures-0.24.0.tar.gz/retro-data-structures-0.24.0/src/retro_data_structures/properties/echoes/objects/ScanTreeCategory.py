...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ScanTreeCategory]:
    if property_count != 3:
        return None
    ...
    return ScanTreeCategory(editor_properties, name_string_table, name_string_name)
