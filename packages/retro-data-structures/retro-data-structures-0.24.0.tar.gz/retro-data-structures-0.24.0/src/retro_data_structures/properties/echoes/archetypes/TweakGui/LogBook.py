...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[LogBook]:
...
_decode_node_collapse_motion = Spline.from_stream

_decode_selected_node_collapse_motion = Spline.from_stream

_decode_node_expand_motion = Spline.from_stream
...
_decode_unknown_0x925b9d4a = Spline.from_stream
