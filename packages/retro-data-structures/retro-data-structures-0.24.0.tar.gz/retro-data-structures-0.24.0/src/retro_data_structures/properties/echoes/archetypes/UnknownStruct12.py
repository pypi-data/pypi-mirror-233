...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[UnknownStruct12]:
    ...
    return UnknownStruct12(unknown_0xb33a0cbc, min_attack_range, max_attack_range, grenade_damage, grenade_explosion, grenade_effect, grenade_trail, grenade_mass, unknown_0xed086ce0, unknown_0x00fc6646, unknown_0xa7c8e63f, unknown_0x454f16b1, unknown_0x2d4706e8, sound_grenade_bounce, sound_grenade_explode)
