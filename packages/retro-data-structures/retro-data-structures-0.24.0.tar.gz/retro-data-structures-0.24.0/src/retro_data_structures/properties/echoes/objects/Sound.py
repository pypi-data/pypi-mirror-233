...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Sound]:
    ...
    return Sound(editor_properties, sound, max_audible_distance, drop_off, delay_time, min_volume, max_volume, priority, surround_pan, loop, ambient, unknown, auto_start, can_occlude, use_room_acoustics, persistent, play_always, all_area, sound_is_music, pitch, echo_visor_max_volume)
