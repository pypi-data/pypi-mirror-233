...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Rezbit]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x8716d656
    rezbit_data = RezbitData.from_stream(data, property_size)

    return Rezbit(editor_properties, patterned, actor_information, rezbit_data)
...
_decode_rezbit_data = RezbitData.from_stream
