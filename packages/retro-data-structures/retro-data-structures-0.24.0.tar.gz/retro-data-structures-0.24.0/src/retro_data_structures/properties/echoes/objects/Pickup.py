...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Pickup]:
    ...
    pickup_effect = struct.unpack(">L", data.read(4))[0]
    ...
    return Pickup(editor_properties, collision_size, collision_offset, item_to_give, capacity_increase, item_percentage_increase, amount, respawn_time, pickup_effect_lifetime, lifetime, fadetime, model, animation_information, actor_information, echo_information, activation_delay, pickup_effect, absolute_value, calculate_visibility, unknown, auto_home_range, delay_until_home, homing_speed, auto_spin, blink_out, orbit_offset)
