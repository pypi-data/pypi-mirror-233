...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Debris]:
    ...
    return Debris(editor_properties, impulse, impulse_variance, fade_out_color, mass, unknown_0x417f4a91, life_time, scale_type, random_spin, model, actor_information, particle, particle_system_scale, is_collider, unknown_0x4edb1d0e)
