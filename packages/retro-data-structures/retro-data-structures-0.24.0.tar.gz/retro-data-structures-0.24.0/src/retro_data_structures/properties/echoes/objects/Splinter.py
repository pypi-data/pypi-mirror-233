...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Splinter]:
...
_decode_unknown_0x6d752efc = AnimationParameters.from_stream

_decode_unknown_0x0d6ab7b5 = AnimationParameters.from_stream

def _decode_part_0x630d93a1(data: typing.BinaryIO, property_size: int):
    return struct.unpack(">L", data.read(4))[0]


_decode_damage_info_0x4436a388 = DamageInfo.from_stream
