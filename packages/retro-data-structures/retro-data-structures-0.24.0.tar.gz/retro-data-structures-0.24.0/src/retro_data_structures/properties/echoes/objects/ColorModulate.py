...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ColorModulate]:
    ...
    return ColorModulate(editor_properties, color_a, color_b, blend_mode, time_a2_b, time_b2_a, do_reverse, reset_target_when_done, depth_compare, depth_update, depth_backwards, auto_start, update_time, loop_forever, external_time, copy_model_color_to_color_a, control_spline)
