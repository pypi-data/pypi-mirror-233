...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[DarkSamusBattleStage]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xd83caab6
    unknown_struct17 = UnknownStruct17.from_stream(data, property_size)

    return DarkSamusBattleStage(editor_properties, unknown_struct17)
