...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[AIKeyframe]:
    if property_count != 7:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x58810503
    unknown_0x58810503 = struct.unpack('>l', data.read(4))[0]
    ...
    return AIKeyframe(editor_properties, animation_index, loop, loop_duration, unknown_0x58810503, unknown_0x6d62ef74, playback_rate)
