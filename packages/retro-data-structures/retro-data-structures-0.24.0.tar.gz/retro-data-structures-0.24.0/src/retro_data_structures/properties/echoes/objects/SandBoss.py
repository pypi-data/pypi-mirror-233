...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[SandBoss]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x91e88d81
    sand_boss_data = SandBossData.from_stream(data, property_size)

    return SandBoss(editor_properties, patterned, actor_information, sand_boss_data)
...
_decode_sand_boss_data = SandBossData.from_stream
