...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Ripper]:
    if property_count != 5:
        return None
    ...
    grapple_info = GrappleParameters.from_stream(data, property_size)

    return Ripper(editor_properties, flavor, patterned, actor_information, grapple_info)
...
_decode_grapple_info = GrappleParameters.from_stream
