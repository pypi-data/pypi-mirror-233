...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[DarkCommando]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x89400baa
    dark_commando_properties = DarkCommandoData.from_stream(data, property_size)

    return DarkCommando(editor_properties, patterned, actor_information, dark_commando_properties)
...
_decode_dark_commando_properties = DarkCommandoData.from_stream
