...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Glowbug]:
    ...
    return Glowbug(editor_properties, patterned, actor_information, death_flash_effect, part, attack_effect, attack_telegraph_effect, attack_echo_effect, attack_duration, attack_telegraph_duration, attack_aim_offset, attack_telegraph_sound, attack_sound, scan_model, is_in_light_world)
