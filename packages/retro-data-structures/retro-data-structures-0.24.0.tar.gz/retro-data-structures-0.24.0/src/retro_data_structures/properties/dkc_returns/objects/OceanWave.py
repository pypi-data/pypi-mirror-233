...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[OceanWave]:
    if property_count != 4:
        return None
    ...
    return OceanWave(editor_properties, model, actor_information, unknown_struct298)
...
_decode_unknown_struct298 = UnknownStruct298.from_stream
