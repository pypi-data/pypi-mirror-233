...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[BalloonData]:
    ...
    return BalloonData(balloon_character, texture_set, mass, downward_velocity, extra_downward_collision, dk_riding_offset, start_offset, drop_height_above_spawn_point, dk_pop_effect, d_kand_diddy_pop_effect, dk_pop_sound, d_kand_diddy_pop_sound, balloonless_mode_drop_timer)
