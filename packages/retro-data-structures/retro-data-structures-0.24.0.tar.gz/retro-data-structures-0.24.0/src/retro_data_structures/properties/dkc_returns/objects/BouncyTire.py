...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[BouncyTire]:
    if property_count != 3:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xc4d5bfde
    bouncy_tire_data = BouncyTireData.from_stream(data, property_size)

    return BouncyTire(editor_properties, actor_information, bouncy_tire_data)
...
_decode_bouncy_tire_data = BouncyTireData.from_stream
