...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[TPND]:
    ...
    return TPND(editor_properties, collision_box, collision_offset, actor_information, model, collision_model, animation, tippy_platform_module, motion_platform_module, unknown_struct18, unknown_struct276)
...
_decode_unknown_struct276 = UnknownStruct276.from_stream
