...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[AreaNode]:
...
_decode_unknown_0xb7cd213c = AnimationParameters.from_stream

_decode_unknown_0x9f93bc3f = AnimationParameters.from_stream
