...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[AnimGridModifierData]:
    ...
    return AnimGridModifierData(unknown, enabled_by_default, mirror_when_facing_left, enable_interval_timer, minimum_interval_time, maximum_interval_time, override_locomotion_context_during_interval, unknown_struct3, looping, logic_type, unknown_struct9, track_player, unknown_struct10)
...
_decode_unknown_struct3 = LocomotionContextEnum.from_stream
...
_decode_track_player = TrackPlayer.from_stream
