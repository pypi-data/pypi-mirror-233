...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[BonusRoom]:
    if property_count != 5:
        return None
    ...
    return BonusRoom(editor_properties, use_timer, auto_start, timer_seconds, warning_seconds)
