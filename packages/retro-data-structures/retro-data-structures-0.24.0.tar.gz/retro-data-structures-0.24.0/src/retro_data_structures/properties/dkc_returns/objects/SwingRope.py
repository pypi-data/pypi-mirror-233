...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[SwingRope]:
    if property_count != 3:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x6461ccd6
    swing_rope_data = SwingRopeData.from_stream(data, property_size)

    return SwingRope(editor_properties, actor_information, swing_rope_data)
...
_decode_swing_rope_data = SwingRopeData.from_stream
