...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[MultiModelInformation]:
...
_decode_multi_model_actor_struct_0x681c4457 = MultiModelActorStruct.from_stream

_decode_multi_model_actor_struct_0xc674d5c6 = MultiModelActorStruct.from_stream

_decode_multi_model_actor_struct_0x3b8d2db3 = MultiModelActorStruct.from_stream

_decode_multi_model_actor_struct_0x95e5bc22 = MultiModelActorStruct.from_stream

_decode_multi_model_actor_struct_0xbc2d08d0 = MultiModelActorStruct.from_stream

_decode_multi_model_actor_struct_0x12459941 = MultiModelActorStruct.from_stream

_decode_multi_model_actor_struct_0x9caffe7b = MultiModelActorStruct.from_stream

_decode_multi_model_actor_struct_0x32c76fea = MultiModelActorStruct.from_stream

_decode_multi_model_actor_struct_0x681aaa77 = MultiModelActorStruct.from_stream
