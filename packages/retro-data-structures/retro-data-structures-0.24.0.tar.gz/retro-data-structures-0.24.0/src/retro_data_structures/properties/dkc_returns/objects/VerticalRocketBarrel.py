...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[VerticalRocketBarrel]:
    if property_count != 9:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x45b5b754
    unknown_struct297 = UnknownStruct297.from_stream(data, property_size)

    return VerticalRocketBarrel(editor_properties, patterned, shadow_data, actor_information, unknown_struct, common, mount_data, rider_list_data, unknown_struct297)
...
_decode_unknown_struct297 = UnknownStruct297.from_stream
