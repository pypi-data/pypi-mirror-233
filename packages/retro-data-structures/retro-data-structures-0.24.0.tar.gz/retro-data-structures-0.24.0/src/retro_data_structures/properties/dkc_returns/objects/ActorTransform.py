...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ActorTransform]:
    ...
    return ActorTransform(editor_properties, flags_actor_transform, duration, initial_time, rotation_controls, scale_controls, translation_control, path_position)
