...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[GameManager]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x4e92c60d
    unknown_struct141 = UnknownStruct141.from_stream(data, property_size)

    return GameManager(editor_properties, unknown_struct141)


_decode_editor_properties = EditorProperties.from_stream

_decode_unknown_struct141 = UnknownStruct141.from_stream
