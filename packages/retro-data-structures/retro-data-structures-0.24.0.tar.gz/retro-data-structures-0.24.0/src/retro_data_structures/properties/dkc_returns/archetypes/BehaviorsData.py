...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[BehaviorsData]:
    if property_count != 7:
        return None
    ...
    return BehaviorsData(behavior0, behavior1, behavior2, behavior3, behavior4, behavior5, behavior6)
...
_decode_behavior5 = BehaviorData.from_stream

_decode_behavior6 = BehaviorData.from_stream
