...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[JungleBoss1]:
    if property_count != 5:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x16212198
    unknown_struct208 = UnknownStruct208.from_stream(data, property_size)

    return JungleBoss1(editor_properties, shadow_data, actor_information, patterned, unknown_struct208)
...
_decode_unknown_struct208 = UnknownStruct208.from_stream
