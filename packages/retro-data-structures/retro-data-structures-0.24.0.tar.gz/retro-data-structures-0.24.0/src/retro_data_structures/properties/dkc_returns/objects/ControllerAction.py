...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ControllerAction]:
    ...
    return ControllerAction(editor_properties, character_type, command, one_shot, disable_during_cinematics, auto_press_during_cinematic_skip, decay_time)
...
_decode_command = ControlCommands.from_stream
