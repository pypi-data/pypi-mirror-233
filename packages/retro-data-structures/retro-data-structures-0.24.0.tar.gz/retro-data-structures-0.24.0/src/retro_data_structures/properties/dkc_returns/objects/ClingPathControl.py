...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ClingPathControl]:
    if property_count != 5:
        return None
    ...
    return ClingPathControl(editor_properties, path_flags, spline_type, cling_path_control_data, editor_color)
...
_decode_cling_path_control_data = ClingPathControlData.from_stream
