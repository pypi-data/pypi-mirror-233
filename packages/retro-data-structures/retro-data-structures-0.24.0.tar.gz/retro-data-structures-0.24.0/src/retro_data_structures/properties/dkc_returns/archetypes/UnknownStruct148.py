...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[UnknownStruct148]:
    if property_count != 8:
        return None
    ...
    return UnknownStruct148(unknown_struct29, title, audio, controllers, back, back_core, unknown_struct31, unknown_struct30)
