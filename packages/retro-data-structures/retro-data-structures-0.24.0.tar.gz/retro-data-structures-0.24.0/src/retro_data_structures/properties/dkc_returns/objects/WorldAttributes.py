...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[WorldAttributes]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xeae86bfb
    unknown_struct299 = UnknownStruct299.from_stream(data, property_size)

    return WorldAttributes(editor_properties, unknown_struct299)


_decode_editor_properties = EditorProperties.from_stream

_decode_unknown_struct299 = UnknownStruct299.from_stream
