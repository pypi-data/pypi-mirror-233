...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[SpawnPoint]:
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xacbf5340
    spawn_point_data = SpawnPointData.from_stream(data, property_size)

    return SpawnPoint(editor_properties, spawn_point_data)


_decode_editor_properties = EditorProperties.from_stream

_decode_spawn_point_data = SpawnPointData.from_stream
