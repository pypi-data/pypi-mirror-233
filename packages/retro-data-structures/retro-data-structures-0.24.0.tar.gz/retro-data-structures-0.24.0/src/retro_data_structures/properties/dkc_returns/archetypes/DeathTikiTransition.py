...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[DeathTikiTransition]:
    ...
    return DeathTikiTransition(background, tiki_face, time_attack_stop_watch, black_screen, swirl, start_mask, end_mask, balloon_board, text_font_name, text_gradient_start_color, text_gradient_end_color, text_outline_color, text_decrement_time, text_pos_x, text_pos_y, model_camera_pos, model_look_at_pos, balloon_start_pos, super_guide_dk_start_pos, super_guide_anim_delay, balloon_velocity, quit_button_position, game_over_text_pos, button_text_locator)
