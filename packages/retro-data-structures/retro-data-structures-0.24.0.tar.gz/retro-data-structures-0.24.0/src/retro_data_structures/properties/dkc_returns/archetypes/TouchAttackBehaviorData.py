...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[TouchAttackBehaviorData]:
    if property_count != 4:
        return None
    ...
    return TouchAttackBehaviorData(contact_top, contact_bottom, contact_front, contact_back)
