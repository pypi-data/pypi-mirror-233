...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[UnknownStruct184]:
    ...
    return UnknownStruct184(title, item_names, descriptions, confirm, entry_strings, exit_strings, island_area_struct_0x57cb6052, island_area_struct_0x4c256cd9, island_area_struct_0xfa4dc52c, island_area_struct_0x7803ae46, island_area_struct_0x2ed30bdd, island_area_struct_0xcfbdcf70, island_area_struct_0xd611406b)
