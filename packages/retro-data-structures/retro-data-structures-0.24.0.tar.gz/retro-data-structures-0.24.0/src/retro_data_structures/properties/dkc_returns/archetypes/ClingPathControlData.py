...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ClingPathControlData]:
    if property_count != 4:
        return None
    ...
    return ClingPathControlData(cling_path_control_struct, can_player_walk_off_cling, lock_distance_override, use_fixed_lateral_jump)
