...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ForestBoss]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x4acc5921
    unknown_struct95 = UnknownStruct95.from_stream(data, property_size)

    return ForestBoss(editor_properties, actor_information, patterned, unknown_struct95)
...
_decode_unknown_struct95 = UnknownStruct95.from_stream
