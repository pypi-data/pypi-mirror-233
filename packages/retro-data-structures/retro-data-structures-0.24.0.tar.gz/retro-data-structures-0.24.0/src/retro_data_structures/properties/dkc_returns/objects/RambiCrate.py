...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[RambiCrate]:
    if property_count != 3:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xdd65d9b6
    rambi_crate_data = RambiCrateData.from_stream(data, property_size)

    return RambiCrate(editor_properties, actor_information, rambi_crate_data)
...
_decode_rambi_crate_data = RambiCrateData.from_stream
