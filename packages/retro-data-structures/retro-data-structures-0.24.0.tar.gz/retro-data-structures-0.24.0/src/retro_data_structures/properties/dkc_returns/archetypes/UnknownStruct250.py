...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[UnknownStruct250]:
...
_decode_engine_sound_low_pass_filter = Spline.from_stream

_decode_engine_sound_pitch = Spline.from_stream

_decode_engine_sound_volume = Spline.from_stream

def _decode_engine_sound2(data: typing.BinaryIO, property_size: int):
    return struct.unpack(">Q", data.read(8))[0]


_decode_engine_sound2_low_pass_filter = Spline.from_stream

_decode_engine_sound2_pitch = Spline.from_stream

_decode_engine_sound2_volume = Spline.from_stream
