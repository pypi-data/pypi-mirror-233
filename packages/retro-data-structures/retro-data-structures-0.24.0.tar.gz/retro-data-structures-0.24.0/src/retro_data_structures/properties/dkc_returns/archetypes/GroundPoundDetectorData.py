...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[GroundPoundDetectorData]:
    if property_count != 9:
        return None
    ...
    return GroundPoundDetectorData(use_detection_shape_and_ignore_radius, trigger_shape, detection_vector, detection_angle_tolerance, radius, ignore_dk, ignore_diddy, ignore_rambi, use_originator_transform)
...
_decode_trigger_shape = TriggerShape.from_stream
