...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[RobotChicken]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x9e3b570e
    unknown_struct259 = UnknownStruct259.from_stream(data, property_size)

    return RobotChicken(editor_properties, actor_information, patterned, unknown_struct259)
...
_decode_unknown_struct259 = UnknownStruct259.from_stream
