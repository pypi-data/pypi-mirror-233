...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[UnknownStruct8]:
    ...
    return UnknownStruct8(num_attachments, unknown, attachment1, attachment2, attachment3)
...
_decode_attachment1 = UnknownStruct7.from_stream

_decode_attachment2 = UnknownStruct7.from_stream

_decode_attachment3 = UnknownStruct7.from_stream
