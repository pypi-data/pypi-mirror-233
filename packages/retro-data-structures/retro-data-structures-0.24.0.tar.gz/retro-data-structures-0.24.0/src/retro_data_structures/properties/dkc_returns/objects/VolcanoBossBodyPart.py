...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[VolcanoBossBodyPart]:
    if property_count != 5:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x84506963
    unknown_struct296 = UnknownStruct296.from_stream(data, property_size)

    return VolcanoBossBodyPart(editor_properties, shadow_data, actor_information, patterned, unknown_struct296)
...
_decode_unknown_struct296 = UnknownStruct296.from_stream
