...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ProjectileBehaviorData]:
...
_decode_damage_effect = DamageEffectData.from_stream

_decode_damage_effect2 = DamageEffectData.from_stream

_decode_damage_effect3 = DamageEffectData.from_stream
