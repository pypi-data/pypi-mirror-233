...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[GenericCreatureGroup]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xed1ad712
    unknown_struct96 = UnknownStruct96.from_stream(data, property_size)

    return GenericCreatureGroup(editor_properties, unknown_struct96)


_decode_editor_properties = EditorProperties.from_stream

_decode_unknown_struct96 = UnknownStruct96.from_stream
