...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[RespawnBalloon]:
    if property_count != 3:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x0aa1aae7
    balloon_data = BalloonData.from_stream(data, property_size)

    return RespawnBalloon(editor_properties, actor_information, balloon_data)
...
_decode_balloon_data = BalloonData.from_stream
