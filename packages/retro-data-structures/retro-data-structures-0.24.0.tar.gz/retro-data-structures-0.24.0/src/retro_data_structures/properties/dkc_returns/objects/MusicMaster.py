...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[MusicMaster]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x17a804e1
    unknown_struct241 = UnknownStruct241.from_stream(data, property_size)

    return MusicMaster(editor_properties, unknown_struct241)


_decode_editor_properties = EditorProperties.from_stream

_decode_unknown_struct241 = UnknownStruct241.from_stream
