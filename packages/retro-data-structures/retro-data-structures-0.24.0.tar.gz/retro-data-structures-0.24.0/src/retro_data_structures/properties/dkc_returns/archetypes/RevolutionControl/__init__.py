...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[RevolutionControl]:
    ...
    return RevolutionControl(revolution_control_type, physical_control, unknown_0x6e14bc06, unknown_0xf0bf68a4, revolution_virtual_control, unknown_0xebaabf01, unknown_0xeda6d736, unknown_0xbf80d594, unknown_0x91b8c18a)
