...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[UnknownStruct260]:
    ...
    caud_0xb0c2f5f6 = struct.unpack(">Q", data.read(8))[0]
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xc8b23273
    caud_0xc8b23273 = struct.unpack(">Q", data.read(8))[0]

    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xbe5f118d
    swoop_interrupted_sound = struct.unpack(">Q", data.read(8))[0]

    return UnknownStruct260(unknown_0x348c9d90, flight_sound_deceleration_k, flight_sound, flight_sound_low_pass_filter, flight_sound_pitch, flight_sound_volume, caud_0xb0c2f5f6, unknown_0xbd894993, flight_sound2_pitch, flight_sound2_volume, hit_player_sound, caud_0xc8b23273, swoop_interrupted_sound)
...
_decode_unknown_0xbd894993 = Spline.from_stream

_decode_flight_sound2_pitch = Spline.from_stream

_decode_flight_sound2_volume = Spline.from_stream
