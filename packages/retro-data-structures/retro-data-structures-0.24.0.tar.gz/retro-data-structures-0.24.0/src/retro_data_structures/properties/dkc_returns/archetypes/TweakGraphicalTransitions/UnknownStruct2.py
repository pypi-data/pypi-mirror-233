...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[UnknownStruct2]:
    ...
    return UnknownStruct2(resource_name, alpha_mask_name, draw_color, rendering_type, rotations_per_second, delay_time, display_time, texture_alpha, texture_scale, separate_alpha_texture_scale, alpha_rotations_per_second, alpha_texture_scale, vertical_from_center, draw_before_models, stretch_across_screen, pause_timing_for_code, pause_time)
...
_decode_texture_alpha = Spline.from_stream

_decode_texture_scale = Spline.from_stream
...
_decode_alpha_texture_scale = Spline.from_stream

_decode_vertical_from_center = Spline.from_stream
