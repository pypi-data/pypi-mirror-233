...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[PilotChicken]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x253fa4ef
    unknown_struct243 = UnknownStruct243.from_stream(data, property_size)

    return PilotChicken(editor_properties, actor_information, patterned, unknown_struct243)
...
_decode_unknown_struct243 = UnknownStruct243.from_stream
