...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[PeanutProperties]:
...
_decode_material_effects1 = PeanutMaterialEffects.from_stream

_decode_material_effects2 = PeanutMaterialEffects.from_stream

_decode_material_effects3 = PeanutMaterialEffects.from_stream

_decode_material_effects4 = PeanutMaterialEffects.from_stream

_decode_material_effects5 = PeanutMaterialEffects.from_stream

_decode_material_effects6 = PeanutMaterialEffects.from_stream

_decode_material_effects7 = PeanutMaterialEffects.from_stream

_decode_material_effects8 = PeanutMaterialEffects.from_stream
