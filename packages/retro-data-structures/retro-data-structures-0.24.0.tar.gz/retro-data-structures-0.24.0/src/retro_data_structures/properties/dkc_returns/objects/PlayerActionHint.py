...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[PlayerActionHint]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0xbbfade55
    unknown_struct143 = UnknownStruct143.from_stream(data, property_size)

    return PlayerActionHint(editor_properties, unknown_struct143)


_decode_editor_properties = EditorProperties.from_stream

_decode_unknown_struct143 = UnknownStruct143.from_stream
