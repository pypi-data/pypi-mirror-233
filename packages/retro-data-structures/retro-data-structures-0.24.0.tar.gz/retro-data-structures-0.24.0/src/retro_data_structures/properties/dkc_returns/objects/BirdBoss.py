...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[BirdBoss]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x552f7242
    bird_boss_data = BirdBossData.from_stream(data, property_size)

    return BirdBoss(editor_properties, actor_information, patterned, bird_boss_data)
...
_decode_bird_boss_data = BirdBossData.from_stream
