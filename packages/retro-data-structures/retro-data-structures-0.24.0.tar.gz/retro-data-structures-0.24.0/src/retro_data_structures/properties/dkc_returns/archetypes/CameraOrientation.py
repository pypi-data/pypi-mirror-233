...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[CameraOrientation]:
    ...
    look_at_motion = Convergence.from_stream(data, property_size, default_override={'convergence_type': enums.ConvergenceType.Unknown1})
    ...
    unknown_struct74 = UnknownStruct74.from_stream(data, property_size)

    return CameraOrientation(orientation_type, flags_orientation, look_at_type, locator_name, pitch_angle, target_path_determination, distance, distance_direction_method, look_at_motion, look_at_offset, target_control_spline, unknown_struct13, spindle_orientation, surface_orientation, unknown_struct74)
...
_decode_unknown_struct74 = UnknownStruct74.from_stream
