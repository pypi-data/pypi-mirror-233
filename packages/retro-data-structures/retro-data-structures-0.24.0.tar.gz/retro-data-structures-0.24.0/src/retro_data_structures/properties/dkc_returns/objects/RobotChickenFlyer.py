...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[RobotChickenFlyer]:
    if property_count != 4:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x3bffc0d1
    unknown_struct262 = UnknownStruct262.from_stream(data, property_size)

    return RobotChickenFlyer(editor_properties, actor_information, patterned, unknown_struct262)
...
_decode_unknown_struct262 = UnknownStruct262.from_stream
