...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[Peanut]:
    if property_count != 3:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x5f058f67
    peanut_properties = PeanutProperties.from_stream(data, property_size)

    return Peanut(editor_properties, actor_information, peanut_properties)
...
_decode_peanut_properties = PeanutProperties.from_stream
