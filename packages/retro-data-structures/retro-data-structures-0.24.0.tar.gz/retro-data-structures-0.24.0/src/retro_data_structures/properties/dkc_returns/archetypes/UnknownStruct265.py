...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[UnknownStruct265]:
    ...
    return UnknownStruct265(dominance, unknown_0x60d9b1cc, acceleration_frame, movement_acceleration, max_movement_speed, passive_acceleration, max_passive_speed, stopped_threshold, unknown_0x91b27cb3, balanced_velocity_percentage, unknown_0xc355fb9f, unknown_0x3153f656)
...
_decode_unknown_0x3153f656 = Spline.from_stream
