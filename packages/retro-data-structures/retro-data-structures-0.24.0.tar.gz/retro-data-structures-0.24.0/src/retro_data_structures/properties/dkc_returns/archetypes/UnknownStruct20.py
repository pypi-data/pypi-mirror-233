...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[UnknownStruct20]:
    ...
    return UnknownStruct20(gradient_start, gradient_end, font_outline_color, font_geometry_color, unknown_0x045c4906, unknown_0x9c403177, is_front_end, animation1, animation2, unknown_0x7024d89b, unknown_0x495c75db, unknown_0x19080ebd, unknown_0x2070a3fd)
...
_decode_animation1 = AnimationParameters.from_stream

_decode_animation2 = AnimationParameters.from_stream

_decode_unknown_0x7024d89b = AnimationParameters.from_stream

_decode_unknown_0x495c75db = AnimationParameters.from_stream

_decode_unknown_0x19080ebd = AnimationParameters.from_stream

_decode_unknown_0x2070a3fd = AnimationParameters.from_stream
