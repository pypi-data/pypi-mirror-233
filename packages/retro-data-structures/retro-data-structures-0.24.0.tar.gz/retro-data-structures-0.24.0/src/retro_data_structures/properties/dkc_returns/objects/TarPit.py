...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[TarPit]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x3d2b7eb9
    unknown_struct271 = UnknownStruct271.from_stream(data, property_size)

    return TarPit(editor_properties, unknown_struct271)


_decode_editor_properties = EditorProperties.from_stream

_decode_unknown_struct271 = UnknownStruct271.from_stream
