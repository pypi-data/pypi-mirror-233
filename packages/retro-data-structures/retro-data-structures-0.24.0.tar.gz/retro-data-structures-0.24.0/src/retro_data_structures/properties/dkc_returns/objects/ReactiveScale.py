...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[ReactiveScale]:
    if property_count != 2:
        return None
    ...
    property_id, property_size = struct.unpack(">LH", data.read(6))
    assert property_id == 0x366a5224
    unknown_struct265 = UnknownStruct265.from_stream(data, property_size)

    return ReactiveScale(editor_properties, unknown_struct265)


_decode_editor_properties = EditorProperties.from_stream

_decode_unknown_struct265 = UnknownStruct265.from_stream
