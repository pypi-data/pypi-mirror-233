...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[PlayerCling2Data]:
...
_decode_off_angle_stick_response = Spline.from_stream

_decode_acceleration_factor = Spline.from_stream

_decode_max_velocity_factor = Spline.from_stream
