...
def _fast_decode(data: typing.BinaryIO, property_count: int) -> typing.Optional[OrientationInterpolationMethod]:
    ...
    orientation_control = InterpolationMethod.from_stream(data, property_size, default_override={'interpolation_control_type': enums.InterpolationControlType.Unknown5})
