...
VERSION = "0.0.4a1696453164"
PLUGIN_VERSION = "0.0.4-alpha.1696453164+373e25d0"
    ...
    def run(self):
        ...
        try:
            ...
            if error.errno == errno.ENOENT:
                print(f"""
                There was an error installing the cockroach resource provider plugin.
                It looks like `pulumi` is not installed on your system.
                Please visit https://pulumi.com/ to install the Pulumi CLI.
                You may try manually installing the plugin by running
                `pulumi plugin install resource cockroach {PLUGIN_VERSION}`
                """)
            else:
                raise
