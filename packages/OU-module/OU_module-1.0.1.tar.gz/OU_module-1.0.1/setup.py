...
setup(
  ...
  description = 'Models the time evolution of a spin-1/2 system with Hamiltonian subjected to random Ornstein-Uhlenbeck noise.',   # Give a short description about your library
  ...
  keywords = ['Spin-1/2 Systems', 'OU process'],   # Keywords that define your package best
