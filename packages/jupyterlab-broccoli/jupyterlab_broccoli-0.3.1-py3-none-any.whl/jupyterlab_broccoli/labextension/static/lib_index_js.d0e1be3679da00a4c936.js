...
/* harmony import */ var _jupyter_widgets_jupyterlab_manager__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @jupyter-widgets/jupyterlab-manager */ "webpack/sharing/consume/default/@jupyter-widgets/jupyterlab-manager");
/* harmony import */ var _jupyter_widgets_jupyterlab_manager__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_jupyter_widgets_jupyterlab_manager__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var jupyterlab_broccoli__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! jupyterlab-broccoli */ "webpack/sharing/consume/default/jupyterlab-broccoli/jupyterlab-broccoli");
/* harmony import */ var jupyterlab_broccoli__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(jupyterlab_broccoli__WEBPACK_IMPORTED_MODULE_12__);
...
const plugin = {
    ...
    provides: jupyterlab_broccoli__WEBPACK_IMPORTED_MODULE_12__.IBlocklyRegistry,
    activate: (app, restorer, rendermime, editorServices, browserFactory, settings, translator, launcher, palette, mainMenu, widgetRegistry) => {
        ...
        const widgetFactory = new jupyterlab_broccoli__WEBPACK_IMPORTED_MODULE_12__.BlocklyEditorFactory(app, {
            name: FACTORY,
            modelName: 'text',
            fileTypes: ['blockly'],
            defaultFor: ['blockly'],
        ...
        widgetFactory.widgetCreated.connect((sender, widget) => {
            ...
            widget.title.icon = _icons__WEBPACK_IMPORTED_MODULE_13__.blockly_icon;
        ...
        commands.addCommand(CommandIDs.createNew, {
            ...
            icon: args => (args['isPalette'] ? null : _icons__WEBPACK_IMPORTED_MODULE_13__.blockly_icon),
            execute: async (args) => {
        ...
        if (mainMenu) {
            mainMenu.kernelMenu.kernelUsers.add({
                ...
                restartKernel: current => {
                    _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_2__.sessionContextDialogs.restart(current.context.sessionContext, translator);
                    return Promise.resolve(void 0);
                },
        ...
        if (widgetRegistry) {
            tracker.forEach(panel => {
                (0,_jupyter_widgets_jupyterlab_manager__WEBPACK_IMPORTED_MODULE_11__.registerWidgetManager)(panel.context, panel.content.rendermime, widgetRenderers([panel.content.cell]));
            });
...
function* widgetRenderers(cells) {
    for (const w of cells) {
        if (w instanceof _jupyter_widgets_jupyterlab_manager__WEBPACK_IMPORTED_MODULE_11__.WidgetRenderer) {
            yield w;
        }
    }
}
...
//# sourceMappingURL=lib_index_js.d0e1be3679da00a4c936.js.map