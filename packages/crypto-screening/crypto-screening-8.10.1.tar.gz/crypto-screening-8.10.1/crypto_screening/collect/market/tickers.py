...
class AssetsTickersMarketState(TickersMarketState, AssetsMarketState):
    ...
    >>> from crypto_screening.collect.market.tickers import assets_orders_market_state
    >>>
...
class SymbolsTickersMarketState(TickersMarketState, SymbolsMarketState):
    ...
    >>> from crypto_screening.collect.market.tickers import symbols_orders_market_state
    >>>
...
def merge_symbols_orders_market_states(
        *states: SymbolsTickersMarketState, sort: Optional[bool] = True
) -> SymbolsTickersMarketState:
    """
...
def merge_assets_orders_market_states(
        *states: AssetsTickersMarketState, sort: Optional[bool] = True
) -> AssetsTickersMarketState:
    """
    Concatenates the states of the market.
