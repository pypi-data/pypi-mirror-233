...
setup(
    ...
    version=VERSION,
    license='MIT',
    url = 'https://github.com/hansalemaos/jerryrigserialver',
    author="Johannes Fischer",
    author_email="aulasparticularesdealemaosp@gmail.com",
    description=DESCRIPTION,
long_description = long_description,
long_description_content_type="text/markdown",
    #packages=['cryptography', 'dill', 'pycryptodomex', 'requests'],
    keywords=['UUID', 'license system', 'expiration date', 'serial number'],
    classifiers=['Development Status :: 4 - Beta', 'Programming Language :: Python :: 3 :: Only', 'Programming Language :: Python :: 3.10', 'Topic :: Software Development :: Libraries :: Python Modules', 'Topic :: Utilities'],
    install_requires=['cryptography', 'dill', 'pycryptodomex', 'requests'],
