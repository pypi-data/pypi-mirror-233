...
def get_drupal_infos(u,user_agent=None,cookie=None,timeout=10,proxy=None,logs=True,crt_timeout=120,wayback_timeout=120,subdomain_check_timeout=10,max_wayback_urls=10,subdomains_only=True,headers={}):
    ...
    if version!='':
        ...
        wpvulns=vulners_search('drupal',version=version,proxy=proxy)
        for x in wpvulns:
