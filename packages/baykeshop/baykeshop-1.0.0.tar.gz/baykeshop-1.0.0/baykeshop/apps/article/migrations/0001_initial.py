    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='article.baykearticlecategory', verbose_name='父类')),
            ],
            options={
                'verbose_name': 'ArticleCategory',
                'verbose_name_plural': 'ArticleCategory',
                'ordering': ['sort'],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'ArticleContent',
                'ordering': ['-pub_date'],
            },
        ),
    ]
