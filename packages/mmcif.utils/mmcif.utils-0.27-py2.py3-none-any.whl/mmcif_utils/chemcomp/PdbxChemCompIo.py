...
class PdbxChemCompIo(PdbxStyleIoUtil):
    ...
    def __init__(self, styleObject=ChemCompCategoryStyle(), verbose=True, log=sys.stderr):
        super(PdbxChemCompIo, self).__init__(styleObject=styleObject, verbose=verbose, log=log)
