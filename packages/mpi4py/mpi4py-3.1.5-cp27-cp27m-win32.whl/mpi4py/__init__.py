...
def profile(name, **_3to2kwargs):
    if 'logfile' in _3to2kwargs: logfile = _3to2kwargs['logfile']; del _3to2kwargs['logfile']
    else: logfile = None
    if 'path' in _3to2kwargs: path = _3to2kwargs['path']; del _3to2kwargs['path']
    else: path = None
