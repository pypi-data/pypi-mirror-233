    ...
    class preferences(TUIMenu):
        ...
        class general(TUIMenu):
            ...
            def laplace_auto_partition_default(self, *args, **kwargs):
                ...
                .
                """
                return PyMenu(self._service, self._version, self._mode, "/preferences/general/laplace_auto_partition_default").execute(*args, **kwargs)
            def enable_parametric_study(self, *args, **kwargs):
                """
                .
                """
                return PyMenu(self._service, self._version, self._mode, "/preferences/general/enable_parametric_study").execute(*args, **kwargs)
        ...
        class turbo_workflow(TUIMenu):
            ...
            class cell_zone_settings(TUIMenu):
                ...
                def stationary(self, *args, **kwargs):
                    ...
                    .
                    """
                    return PyMenu(self._service, self._version, self._mode, "/preferences/turbo_workflow/cell_zone_settings/stationary").execute(*args, **kwargs)
                def rotating(self, *args, **kwargs):
                    """
                    .
                    """
                    return PyMenu(self._service, self._version, self._mode, "/preferences/turbo_workflow/cell_zone_settings/rotating").execute(*args, **kwargs)
                def czsearch_order(self, *args, **kwargs):
                    """
                    .
                    """
                    return PyMenu(self._service, self._version, self._mode, "/preferences/turbo_workflow/cell_zone_settings/czsearch_order").execute(*args, **kwargs)
    ...
    class file(TUIMenu):
        ...
        class import_(TUIMenu):
            ...
            def stl(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/stl").execute(*args, **kwargs)
            def reimport_last_with_cfd_surface_mesh(self, *args, **kwargs):
                """
                Reimport CAD using the size field.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/reimport_last_with_cfd_surface_mesh").execute(*args, **kwargs)
            def cgns_surf_mesh(self, *args, **kwargs):
                """
                Enables you to read a CGNS surface mesh file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/cgns_surf_mesh").execute(*args, **kwargs)
            def cad(self, *args, **kwargs):
                """
                Enables you to import CAD files based on the options set.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/cad").execute(*args, **kwargs)
            def fluent_2d_mesh(self, *args, **kwargs):
                """
                Enables you to read a 2D mesh into the 3D version.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/fluent_2d_mesh").execute(*args, **kwargs)
            def patran_vol_mesh(self, *args, **kwargs):
                """
                Enables you to read a PATRAN volume mesh file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/patran_vol_mesh").execute(*args, **kwargs)
            def hypermesh_surf_mesh(self, *args, **kwargs):
                """
                Enables you to read a HYPERMESH surface mesh file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/hypermesh_surf_mesh").execute(*args, **kwargs)
            def ideas_vol_mesh(self, *args, **kwargs):
                """
                Enables you to read an I-deas volume mesh file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/ideas_vol_mesh").execute(*args, **kwargs)
            def patran_surf_mesh(self, *args, **kwargs):
                """
                Enables you to read a PATRAN surface mesh file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/patran_surf_mesh").execute(*args, **kwargs)
            def nastran_surf_mesh(self, *args, **kwargs):
                """
                Enables you to read a NASTRAN surface mesh file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/nastran_surf_mesh").execute(*args, **kwargs)
            def nastran_vol_mesh(self, *args, **kwargs):
                """
                Enables you to read a NASTRAN volume mesh file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/nastran_vol_mesh").execute(*args, **kwargs)
            def ansys_vol_mesh(self, *args, **kwargs):
                """
                Enables you to read a Ansys volume mesh file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/ansys_vol_mesh").execute(*args, **kwargs)
            def cgns_vol_mesh(self, *args, **kwargs):
                """
                Enables you to read a CGNS volume mesh file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/cgns_vol_mesh").execute(*args, **kwargs)
            def hypermesh_vol_mesh(self, *args, **kwargs):
                """
                Enables you to read a HYPERMESH volume mesh file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/hypermesh_vol_mesh").execute(*args, **kwargs)
            def ideas_surf_mesh(self, *args, **kwargs):
                """
                Enables you to read an I-deas surface mesh file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/ideas_surf_mesh").execute(*args, **kwargs)
            def ansys_surf_mesh(self, *args, **kwargs):
                """
                Enables you to read a Ansys surface mesh file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/ansys_surf_mesh").execute(*args, **kwargs)
            def fl_uns2_mesh(self, *args, **kwargs):
                """
                Enables you to read a Fluent UNS V2 case file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/fl_uns2_mesh").execute(*args, **kwargs)
            def cad_geometry(self, *args, **kwargs):
                """
                Enables you to import CAD files based on the options set.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/cad_geometry").execute(*args, **kwargs)
            def fluent_3d_mesh(self, *args, **kwargs):
                """
                Read a 3D mesh.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/fluent_3d_mesh").execute(*args, **kwargs)
            def gambit_vol_mesh(self, *args, **kwargs):
                """
                Enables you to read a GAMBIT volume mesh file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/gambit_vol_mesh").execute(*args, **kwargs)
            def fidap_vol_mesh(self, *args, **kwargs):
                """
                Enables you to read a FIDAP volume mesh file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/fidap_vol_mesh").execute(*args, **kwargs)
            def fidap_surf_mesh(self, *args, **kwargs):
                """
                Enables you to read a FIDAP surface mesh file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/fidap_surf_mesh").execute(*args, **kwargs)
            def gambit_surf_mesh(self, *args, **kwargs):
                """
                Enables you to read a GAMBIT surface mesh file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import/gambit_surf_mesh").execute(*args, **kwargs)
            ...
            class cad_options(TUIMenu):
                ...
                def derive_zone_name_from_object_scope(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/derive_zone_name_from_object_scope").execute(*args, **kwargs)
                def double_connected_face_label(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/double_connected_face_label").execute(*args, **kwargs)
                def use_part_names(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/use_part_names").execute(*args, **kwargs)
                def import_body_names(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/import_body_names").execute(*args, **kwargs)
                def separate_features_by_type(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/separate_features_by_type").execute(*args, **kwargs)
                def single_connected_edge_label(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/single_connected_edge_label").execute(*args, **kwargs)
                def named_selections(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/named_selections").execute(*args, **kwargs)
                def one_face_zone_per(self, *args, **kwargs):
                    """
                    Enables you to create one face zone per body/face/object to be imported.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/one_face_zone_per").execute(*args, **kwargs)
                def extract_features(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/extract_features").execute(*args, **kwargs)
                def strip_file_name_extension_from_naming(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/strip_file_name_extension_from_naming").execute(*args, **kwargs)
                def reconstruct_topology(self, *args, **kwargs):
                    """
                    Reconstruct topology for STL files.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/reconstruct_topology").execute(*args, **kwargs)
                def import_part_names(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/import_part_names").execute(*args, **kwargs)
                def name_separator_character(self, *args, **kwargs):
                    """
                    :.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/name_separator_character").execute(*args, **kwargs)
                def use_body_names(self, *args, **kwargs):
                    """
                    Use body names for CAD files.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/use_body_names").execute(*args, **kwargs)
                def save_PMDB(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/save_PMDB").execute(*args, **kwargs)
                def continue_on_error(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/continue_on_error").execute(*args, **kwargs)
                def enclosure_symm_processing(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/enclosure_symm_processing").execute(*args, **kwargs)
                def replacement_character(self, *args, **kwargs):
                    """
                    Name replacement character.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/replacement_character").execute(*args, **kwargs)
                def tessellation(self, *args, **kwargs):
                    """
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/tessellation").execute(*args, **kwargs)
                def use_part_or_body_names_as_suffix_to_named_selections(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/use_part_or_body_names_as_suffix_to_named_selections").execute(*args, **kwargs)
                def create_cad_assemblies(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/create_cad_assemblies").execute(*args, **kwargs)
                def one_object_per(self, *args, **kwargs):
                    """
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/one_object_per").execute(*args, **kwargs)
                def import_label_for_body_named_selection(self, *args, **kwargs):
                    """
                    Import face zone labels for body named selections.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/import_label_for_body_named_selection").execute(*args, **kwargs)
                def use_collection_names(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/use_collection_names").execute(*args, **kwargs)
                def object_type(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/object_type").execute(*args, **kwargs)
                def import_curvature_data_from_CAD(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/import_curvature_data_from_CAD").execute(*args, **kwargs)
                def merge_nodes(self, *args, **kwargs):
                    """
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/merge_nodes").execute(*args, **kwargs)
                def create_label_per_body_during_cad_faceting(self, *args, **kwargs):
                    """
                    Create label Per Body during cad faceting.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/create_label_per_body_during_cad_faceting").execute(*args, **kwargs)
                def modify_all_duplicate_names(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/modify_all_duplicate_names").execute(*args, **kwargs)
                def strip_path_prefix_from_names(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/strip_path_prefix_from_names").execute(*args, **kwargs)
                def use_component_names(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/use_component_names").execute(*args, **kwargs)
                def read_all_cad_in_subdirectories(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/read_all_cad_in_subdirectories").execute(*args, **kwargs)
                def named_selection_tessellation_failure(self, *args, **kwargs):
                    """
                    Set named selection for CFD surface mesh failures.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/named_selection_tessellation_failure").execute(*args, **kwargs)
                def merge_objects_per_body_named_selection(self, *args, **kwargs):
                    """
                    Merge Objects per body named selection.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import/cad_options/merge_objects_per_body_named_selection").execute(*args, **kwargs)
        ...
        class project(TUIMenu):
            ...
            def new(self, *args, **kwargs):
                ...
                Create New Project.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/project[beta]/new").execute(*args, **kwargs)
            def archive(self, *args, **kwargs):
                """
                Archive Project.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/project[beta]/archive").execute(*args, **kwargs)
            def open(self, *args, **kwargs):
                """
                Open project.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/project[beta]/open").execute(*args, **kwargs)
            def save_as(self, *args, **kwargs):
                """
                Save As Project.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/project[beta]/save_as").execute(*args, **kwargs)
            def save_as_copy(self, *args, **kwargs):
                """
                Save As Copy.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/project[beta]/save_as_copy").execute(*args, **kwargs)
            def save(self, *args, **kwargs):
                """
                Save Project.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/project[beta]/save").execute(*args, **kwargs)
