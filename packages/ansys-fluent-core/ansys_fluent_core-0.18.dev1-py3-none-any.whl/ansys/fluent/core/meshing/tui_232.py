...
class main_menu(TUIMenu):
    ...
    def switch_to_solution_mode(self, *args, **kwargs):
        ...
        """
        return PyMenu(self._service, self._version, self._mode, "/switch_to_solution_mode").execute(*args, **kwargs)
    ...
    def beta_feature_access(self, *args, **kwargs):
        ...
        """
        return PyMenu(self._service, self._version, self._mode, "/beta_feature_access").execute(*args, **kwargs)
    ...
    class objects(TUIMenu):
        ...
        def create_and_activate_domain(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/create_and_activate_domain").execute(*args, **kwargs)
        def improve_feature_capture(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/improve_feature_capture").execute(*args, **kwargs)
        def delete_unreferenced_faces_and_edges(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/delete_unreferenced_faces_and_edges").execute(*args, **kwargs)
        def scale(self, *args, **kwargs):
            """
            Scales the object(s) based on the scale factors specified.
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/scale").execute(*args, **kwargs)
        def improve_object_quality(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/improve_object_quality").execute(*args, **kwargs)
        def clear_backup(self, *args, **kwargs):
            """
            Clear backup data of objects.
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/clear_backup").execute(*args, **kwargs)
        def summary(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/summary").execute(*args, **kwargs)
        def list(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/list").execute(*args, **kwargs)
        def delete_all_geom(self, *args, **kwargs):
            """
            Deletes all the defined geom objects.
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/delete_all_geom").execute(*args, **kwargs)
        def delete_all(self, *args, **kwargs):
            """
            Deletes all the defined objects.
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/delete_all").execute(*args, **kwargs)
        def merge_voids(self, *args, **kwargs):
            """
            Allows you to merge voids in the mesh object after the sewing operation.
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/merge_voids").execute(*args, **kwargs)
        def merge_nodes(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/merge_nodes").execute(*args, **kwargs)
        def change_prefix(self, *args, **kwargs):
            """
            Change the prefix for specified objects.
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/change_prefix").execute(*args, **kwargs)
        def update(self, *args, **kwargs):
            """
            Allows you to update the objects defined when the face and/or edge zone(s) comprising the object have been deleted.
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/update").execute(*args, **kwargs)
        def rename_cell_zone_boundaries_using_labels(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/rename_cell_zone_boundaries_using_labels").execute(*args, **kwargs)
        def translate(self, *args, **kwargs):
            """
            Translates the object(s) based on the translation offsets specified.
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/translate").execute(*args, **kwargs)
        def check_mesh(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/check_mesh").execute(*args, **kwargs)
        def rotate(self, *args, **kwargs):
            """
            Rotates the object(s) based on the angle of rotation, pivot point, and axis of rotation specified.
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/rotate").execute(*args, **kwargs)
        def extract_edges(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/extract_edges").execute(*args, **kwargs)
        def change_suffix(self, *args, **kwargs):
            """
            Change the suffix for specified objects.
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/change_suffix").execute(*args, **kwargs)
        def merge(self, *args, **kwargs):
            """
            Merges the specified objects into a single object.
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/merge").execute(*args, **kwargs)
        def create_groups(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/create_groups").execute(*args, **kwargs)
        def delete(self, *args, **kwargs):
            """
            Deletes the specified object(s).
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/delete").execute(*args, **kwargs)
        def merge_edges(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/merge_edges").execute(*args, **kwargs)
        def create_intersection_loops(self, *args, **kwargs):
            """
            Allows you to create intersection loops for objects.
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/create_intersection_loops").execute(*args, **kwargs)
        def sew(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/sew").execute(*args, **kwargs)
        def merge_walls(self, *args, **kwargs):
            """
            Merges all the face zones of type wall in an object into a single face zone.
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/merge_walls").execute(*args, **kwargs)
        def create(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/create").execute(*args, **kwargs)
        def separate_faces_by_angle(self, *args, **kwargs):
            """
            Separates the face zone(s) comprising the object based on the angle specified.
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/separate_faces_by_angle").execute(*args, **kwargs)
        def separate_faces_by_seed(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/separate_faces_by_seed").execute(*args, **kwargs)
        def rename_object(self, *args, **kwargs):
            """
            Allows you to rename a specified geometry or mesh object with another specified name.
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/rename_object").execute(*args, **kwargs)
        def restore_faces(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/restore_faces").execute(*args, **kwargs)
        def change_object_type(self, *args, **kwargs):
            """
            Allows you to change the object type (geom, or mesh).
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/change_object_type").execute(*args, **kwargs)
        def create_multiple(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/create_multiple").execute(*args, **kwargs)
        def rename_object_zones(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/objects/rename_object_zones").execute(*args, **kwargs)
        ...
        class cad_association(TUIMenu):
            ...
            def update_objects(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/cad_association/update_objects").execute(*args, **kwargs)
            def detach_objects(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/cad_association/detach_objects").execute(*args, **kwargs)
            def query_object_association(self, *args, **kwargs):
                """
                Returns a list of the CAD entities associated with the objects selected.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/cad_association/query_object_association").execute(*args, **kwargs)
            def unlock_cad(self, *args, **kwargs):
                """
                Unlocks the CAD objects associated with the selected geometry/mesh objects.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/cad_association/unlock_cad").execute(*args, **kwargs)
            def update_all_objects(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/cad_association/update_all_objects").execute(*args, **kwargs)
            def detach_all_objects(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/cad_association/detach_all_objects").execute(*args, **kwargs)
            def restore_cad(self, *args, **kwargs):
                """
                Restores the geometry/mesh objects from the associated CAD objects.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/cad_association/restore_cad").execute(*args, **kwargs)
            def attach_cad(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/cad_association/attach_cad").execute(*args, **kwargs)
        ...
        class join_intersect(TUIMenu):
            ...
            def join(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/join_intersect/join").execute(*args, **kwargs)
            def delete_region(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/join_intersect/delete_region").execute(*args, **kwargs)
            def rename_region(self, *args, **kwargs):
                """
                Enables you to specify a new name for a specified region.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/join_intersect/rename_region").execute(*args, **kwargs)
            def compute_regions(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/join_intersect/compute_regions").execute(*args, **kwargs)
            def change_region_type(self, *args, **kwargs):
                """
                Allows you to select a cell zone type (solid, fluid or dead) for a specific region.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/join_intersect/change_region_type").execute(*args, **kwargs)
            def list_regions(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/join_intersect/list_regions").execute(*args, **kwargs)
            def merge_regions(self, *args, **kwargs):
                """
                Specified regions are joined into a single region.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/join_intersect/merge_regions").execute(*args, **kwargs)
            def intersect(self, *args, **kwargs):
                """
                Connects two intersecting face zones within specified angle and tolerance.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/join_intersect/intersect").execute(*args, **kwargs)
            def create_mesh_object(self, *args, **kwargs):
                """
                Allows you to specify one or more mesh objects to be connected in one mesh object.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/join_intersect/create_mesh_object").execute(*args, **kwargs)
            def add_objects_to_mesh_object(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/join_intersect/add_objects_to_mesh_object").execute(*args, **kwargs)
            ...
            class controls(TUIMenu):
                ...
                def remesh_post_intersection(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/join_intersect/controls/remesh_post_intersection").execute(*args, **kwargs)
        ...
        class fix_holes(TUIMenu):
            ...
            def patch_all_holes(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/fix_holes/patch_all_holes").execute(*args, **kwargs)
            def open_all_holes(self, *args, **kwargs):
                """
                Open all wetted holes of the material point.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/fix_holes/open_all_holes").execute(*args, **kwargs)
            def open_holes(self, *args, **kwargs):
                """
                Open holes even not connected by material point.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/fix_holes/open_holes").execute(*args, **kwargs)
            def patch_holes(self, *args, **kwargs):
                """
                Patch holes even not connected by material point.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/fix_holes/patch_holes").execute(*args, **kwargs)
            def reset_material_point(self, *args, **kwargs):
                """
                Reset material point of of region of interest.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/fix_holes/reset_material_point").execute(*args, **kwargs)
            def find_holes(self, *args, **kwargs):
                """
                Find holes in objects using octree.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/fix_holes/find_holes").execute(*args, **kwargs)
            def shrink_wrap(self, *args, **kwargs):
                """
                Shrink wrap wetted region of material point.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/fix_holes/shrink_wrap").execute(*args, **kwargs)
            ...
            class advanced(TUIMenu):
                ...
                def patch_holes_not_connected_to_material_points(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/fix_holes/advanced/patch_holes_not_connected_to_material_points").execute(*args, **kwargs)
                def patch_holes_between_material_points(self, *args, **kwargs):
                    """
                    Patch holes separating the material points.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/fix_holes/advanced/patch_holes_between_material_points").execute(*args, **kwargs)
                def patch_holes_connected_to_material_points(self, *args, **kwargs):
                    """
                    Patch all holes wetted by material points.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/fix_holes/advanced/patch_holes_connected_to_material_points").execute(*args, **kwargs)
                def open_holes_connected_to_material_points(self, *args, **kwargs):
                    """
                    Open all holes wetted by material points.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/fix_holes/advanced/open_holes_connected_to_material_points").execute(*args, **kwargs)
                def open_holes_between_material_points(self, *args, **kwargs):
                    """
                    Open holes separating the material points to merge them.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/fix_holes/advanced/open_holes_between_material_points").execute(*args, **kwargs)
                def open_traced_holes_between_material_points(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/fix_holes/advanced/open_traced_holes_between_material_points").execute(*args, **kwargs)
                def open_holes_not_connected_to_material_points(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/fix_holes/advanced/open_holes_not_connected_to_material_points").execute(*args, **kwargs)
        ...
        class wrap(TUIMenu):
            ...
            def wrap(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/wrap/wrap").execute(*args, **kwargs)
            def debug(self, *args, **kwargs):
                """
                Debug from intermediate objects.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/wrap/debug").execute(*args, **kwargs)
            def object_zone_separate(self, *args, **kwargs):
                """
                Separate Object Face Zones.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/wrap/object_zone_separate").execute(*args, **kwargs)
            def check_holes(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/wrap/check_holes").execute(*args, **kwargs)
            ...
            class set(TUIMenu):
                ...
                def report_holes(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/wrap/set/report_holes").execute(*args, **kwargs)
                def minimum_topo_area(self, *args, **kwargs):
                    """
                    Specifies the minimum topological area for shrink wrapping.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/wrap/set/minimum_topo_area").execute(*args, **kwargs)
                def use_ray_tracing(self, *args, **kwargs):
                    """
                    Use ray tracing.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/wrap/set/use_ray_tracing").execute(*args, **kwargs)
                def list_zones_geometry_recovery_levels(self, *args, **kwargs):
                    """
                    Lists the zones based on geometry recovery level specified.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/wrap/set/list_zones_geometry_recovery_levels").execute(*args, **kwargs)
                def use_smooth_folded_faces(self, *args, **kwargs):
                    """
                    Use smooth folded faces.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/wrap/set/use_smooth_folded_faces").execute(*args, **kwargs)
                def include_thin_cut_edges_and_faces(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/wrap/set/include_thin_cut_edges_and_faces").execute(*args, **kwargs)
                def minimum_topo_count(self, *args, **kwargs):
                    """
                    Specifies the minimum topological count for shrink wrapping.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/wrap/set/minimum_topo_count").execute(*args, **kwargs)
                def delete_far_edges(self, *args, **kwargs):
                    """
                    Delete-far-edges-after-wrap.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/wrap/set/delete_far_edges").execute(*args, **kwargs)
                def resolution_factor(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/wrap/set/resolution_factor").execute(*args, **kwargs)
                def zone_name_prefix(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/wrap/set/zone_name_prefix").execute(*args, **kwargs)
                def minimum_relative_topo_count(self, *args, **kwargs):
                    """
                    Specifies the minimum relative topological count for shrink wrapping.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/wrap/set/minimum_relative_topo_count").execute(*args, **kwargs)
                def shrink_wrap_rezone_parameters(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/wrap/set/shrink_wrap_rezone_parameters").execute(*args, **kwargs)
                def max_free_edges_for_hole_patching(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/wrap/set/max_free_edges_for_hole_patching").execute(*args, **kwargs)
                def add_geometry_recovery_level_to_zones(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/wrap/set/add_geometry_recovery_level_to_zones").execute(*args, **kwargs)
                def minimum_relative_topo_area(self, *args, **kwargs):
                    """
                    Specifies the minimum relative topological area for shrink wrapping.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/wrap/set/minimum_relative_topo_area").execute(*args, **kwargs)
                def relative_feature_tolerance(self, *args, **kwargs):
                    """
                    Specifies the relative feature tolerance for shrink wrapping.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/wrap/set/relative_feature_tolerance").execute(*args, **kwargs)
        ...
        class labels(TUIMenu):
            ...
            def create_label_per_zone(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/labels/create_label_per_zone").execute(*args, **kwargs)
            def create(self, *args, **kwargs):
                """
                Creates a new face zone label for the specified face zones.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/labels/create").execute(*args, **kwargs)
            def label_unlabeled_zones(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/labels/label_unlabeled_zones").execute(*args, **kwargs)
            def rename(self, *args, **kwargs):
                """
                Renames the specified face zone label.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/labels/rename").execute(*args, **kwargs)
            def remove_all_labels_on_zones(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/labels/remove_all_labels_on_zones").execute(*args, **kwargs)
            def add_zones(self, *args, **kwargs):
                """
                Adds the specified face zones to the existing face zone label for an object.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/labels/add_zones").execute(*args, **kwargs)
            def remove_zones(self, *args, **kwargs):
                """
                Removes the specified face zones from the existing face zone label for an object.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/labels/remove_zones").execute(*args, **kwargs)
            def delete(self, *args, **kwargs):
                """
                Deletes the specified face zone labels.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/labels/delete").execute(*args, **kwargs)
            def merge(self, *args, **kwargs):
                """
                Merges the specified face zone labels to a single label with the name specified.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/labels/merge").execute(*args, **kwargs)
            def create_label_per_object(self, *args, **kwargs):
                """
                Creates a new face zone label for all the face zones in every object.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/labels/create_label_per_object").execute(*args, **kwargs)
            ...
            class cavity(TUIMenu):
                ...
                def add(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/labels/cavity/add").execute(*args, **kwargs)
                def remove(self, *args, **kwargs):
                    """
                    Create cavity by removing labels.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/labels/cavity/remove").execute(*args, **kwargs)
                def replace(self, *args, **kwargs):
                    """
                    Create cavity by replacing labels from another mesh object.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/labels/cavity/replace").execute(*args, **kwargs)
        ...
        class set(TUIMenu):
            ...
            def show_face_zones(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/set/show_face_zones").execute(*args, **kwargs)
            def set_edge_feature_angle(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/set/set_edge_feature_angle").execute(*args, **kwargs)
            def show_edge_zones(self, *args, **kwargs):
                """
                Displays the edge zone(s) comprising the object(s) drawn in the graphics window.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/set/show_edge_zones").execute(*args, **kwargs)
        ...
        class create_new_mesh_object(TUIMenu):
            ...
            def remesh(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/create_new_mesh_object/remesh").execute(*args, **kwargs)
            def wrap(self, *args, **kwargs):
                """
                Creates a new mesh object by wrapping the specified objects individually or collectively.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/create_new_mesh_object/wrap").execute(*args, **kwargs)
        ...
        class volumetric_regions(TUIMenu):
            ...
            def change_type(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/change_type").execute(*args, **kwargs)
            def delete_cells(self, *args, **kwargs):
                """
                Deletes the cell zones of the specified regions.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/delete_cells").execute(*args, **kwargs)
            def list(self, *args, **kwargs):
                """
                Prints region information to the console, including type, volume, material point and face zones.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/list").execute(*args, **kwargs)
            def compute(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/compute").execute(*args, **kwargs)
            def merge(self, *args, **kwargs):
                """
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/merge").execute(*args, **kwargs)
            def merge_cells(self, *args, **kwargs):
                """
                Merge all cell zones assocaited to a region.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/merge_cells").execute(*args, **kwargs)
            def auto_fill_volume(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/auto_fill_volume").execute(*args, **kwargs)
            def delete(self, *args, **kwargs):
                """
                Deletes the specified volumetric regions.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/delete").execute(*args, **kwargs)
            def update(self, *args, **kwargs):
                """
                Recomputes the selected volumetric region(s) while preserving the region name(s) and type(s).
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/update").execute(*args, **kwargs)
            def fill_empty_volume(self, *args, **kwargs):
                """
                Fill empty volume of selected regions.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/fill_empty_volume").execute(*args, **kwargs)
            def rename(self, *args, **kwargs):
                """
                Renames the region.
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/rename").execute(*args, **kwargs)
            ...
            class hexcore(TUIMenu):
                ...
                def generate(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/generate").execute(*args, **kwargs)
                ...
                class set(TUIMenu):
                    ...
                    def keep_hex_tet_separate(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/keep_hex_tet_separate").execute(*args, **kwargs)
                    def buffer_layers(self, *args, **kwargs):
                        """
                        Number of addition cells to mark for subdivision.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/buffer_layers").execute(*args, **kwargs)
                    def non_fluid_type(self, *args, **kwargs):
                        """
                        Set non fluid type for cell zones.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/non_fluid_type").execute(*args, **kwargs)
                    def octree_hexcore(self, *args, **kwargs):
                        """
                        Create hexcore using size-function driven octree.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/octree_hexcore").execute(*args, **kwargs)
                    def set_region_based_sizing(self, *args, **kwargs):
                        """
                        Set region based sizings.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/set_region_based_sizing").execute(*args, **kwargs)
                    def maximum_subdivisions(self, *args, **kwargs):
                        """
                        Maximum number of subdivision sweeps.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/maximum_subdivisions").execute(*args, **kwargs)
                    def maximum_cell_length(self, *args, **kwargs):
                        """
                        Maximum cell length.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/maximum_cell_length").execute(*args, **kwargs)
                    def only_hexcore(self, *args, **kwargs):
                        """
                        Create hexcore and activate tet domain.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/only_hexcore").execute(*args, **kwargs)
                    def compute_max_cell_length(self, *args, **kwargs):
                        """
                        Compute maximum cell length.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/compute_max_cell_length").execute(*args, **kwargs)
                    def skip_tet_refinement(self, *args, **kwargs):
                        """
                        Skip tethedral refinement in transition cell generation.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/skip_tet_refinement").execute(*args, **kwargs)
                    def smooth_relaxation(self, *args, **kwargs):
                        """
                        Smoothing under relaxation on hexcore interface.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/smooth_relaxation").execute(*args, **kwargs)
                    def island_thresholds(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/island_thresholds").execute(*args, **kwargs)
                    def print_region_based_sizing(self, *args, **kwargs):
                        """
                        Print region based sizings.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/print_region_based_sizing").execute(*args, **kwargs)
                    def smooth_interface(self, *args, **kwargs):
                        """
                        Enable smoothing of hexcore interface.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/smooth_interface").execute(*args, **kwargs)
                    def merge_tets_to_pyramids(self, *args, **kwargs):
                        """
                        Merge tets into pyramids.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/merge_tets_to_pyramids").execute(*args, **kwargs)
                    def delete_dead_zones(self, *args, **kwargs):
                        """
                        Delete dead zones after hexcore creation.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/delete_dead_zones").execute(*args, **kwargs)
                    def smooth_iterations(self, *args, **kwargs):
                        """
                        Number of smoothing iterations on hexcore interface.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/smooth_iterations").execute(*args, **kwargs)
                    def avoid_1_by_8_cell_jump_in_hexcore(self, *args, **kwargs):
                        """
                        Avoid-1:8-cell-jump-in-hexcore.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/avoid_1_by_8_cell_jump_in_hexcore").execute(*args, **kwargs)
                    def define_hexcore_extents(self, *args, **kwargs):
                        """
                        Enables sspecificaton of hexcore outer domain parameters.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/define_hexcore_extents").execute(*args, **kwargs)
                    def peel_layers(self, *args, **kwargs):
                        """
                        Number of hexcore cells to peel back from boundary.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/peel_layers").execute(*args, **kwargs)
                    def maximum_initial_cells(self, *args, **kwargs):
                        """
                        Maximum number of initial Cartesian cells.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/maximum_initial_cells").execute(*args, **kwargs)
                    ...
                    class outer_domain_params(TUIMenu):
                        ...
                        def boundaries(self, *args, **kwargs):
                            ...
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/outer_domain_params/boundaries").execute(*args, **kwargs)
                        def delete_old_face_zones(self, *args, **kwargs):
                            """
                            Delete replaced old tri face zones.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/outer_domain_params/delete_old_face_zones").execute(*args, **kwargs)
                        def list(self, *args, **kwargs):
                            """
                            List the face zones selected for hexcore up to boundaries.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/outer_domain_params/list").execute(*args, **kwargs)
                        def specify_boundaries(self, *args, **kwargs):
                            """
                            Set parameters to get hex mesh to boundary(s).
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/outer_domain_params/specify_boundaries").execute(*args, **kwargs)
                        def specify_coordinates(self, *args, **kwargs):
                            """
                            Enables specification of coordinates of hexcore outer box.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/outer_domain_params/specify_coordinates").execute(*args, **kwargs)
                        def auto_align(self, *args, **kwargs):
                            """
                            Enable auto-align?.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/outer_domain_params/auto_align").execute(*args, **kwargs)
                        def auto_align_boundaries(self, *args, **kwargs):
                            """
                            Auto-align selected boundaries.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/outer_domain_params/auto_align_boundaries").execute(*args, **kwargs)
                        def auto_align_tolerance(self, *args, **kwargs):
                            """
                            Set auto-align-tolerance.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/outer_domain_params/auto_align_tolerance").execute(*args, **kwargs)
                        def coordinates(self, *args, **kwargs):
                            """
                            Secifiy coordinates of outer box.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/hexcore/set/outer_domain_params/coordinates").execute(*args, **kwargs)
            ...
            class scoped_prism(TUIMenu):
                ...
                def generate(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/scoped_prism/generate").execute(*args, **kwargs)
                ...
                class set(TUIMenu):
                    ...
                    def poly_keep_nlayer_prism_characteristics(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/scoped_prism/set/poly_keep_nlayer_prism_characteristics").execute(*args, **kwargs)
                    def set_no_imprint_zones(self, *args, **kwargs):
                        """
                        Set zones which should not be imprinted during prism generation.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/scoped_prism/set/set_no_imprint_zones").execute(*args, **kwargs)
                    def write(self, *args, **kwargs):
                        """
                        Write scoped prisms to a file.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/scoped_prism/set/write").execute(*args, **kwargs)
                    def set_overset_prism_controls(self, *args, **kwargs):
                        """
                        Set boundary layer controls for overset mesh generation.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/scoped_prism/set/set_overset_prism_controls").execute(*args, **kwargs)
                    def read(self, *args, **kwargs):
                        """
                        Read scoped prisms from a file.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/scoped_prism/set/read").execute(*args, **kwargs)
                    def list(self, *args, **kwargs):
                        """
                        List all scoped prisms parameters.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/scoped_prism/set/list").execute(*args, **kwargs)
                    def set_advanced_controls(self, *args, **kwargs):
                        """
                        Set scoped boundary layer controls.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/scoped_prism/set/set_advanced_controls").execute(*args, **kwargs)
                    def modify(self, *args, **kwargs):
                        """
                        Modify scoped prisms.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/scoped_prism/set/modify").execute(*args, **kwargs)
                    def growth_options(self, *args, **kwargs):
                        """
                        Set scoped prisms growth options.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/scoped_prism/set/growth_options").execute(*args, **kwargs)
                    def delete(self, *args, **kwargs):
                        """
                        Delete scoped prisms.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/scoped_prism/set/delete").execute(*args, **kwargs)
                    def create(self, *args, **kwargs):
                        """
                        Create new scoped prism.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/scoped_prism/set/create").execute(*args, **kwargs)
            ...
            class tet(TUIMenu):
                ...
                def generate(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/generate").execute(*args, **kwargs)
                ...
                class set(TUIMenu):
                    ...
                    def delete_dead_zones(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/delete_dead_zones").execute(*args, **kwargs)
                    def skewness_method(self, *args, **kwargs):
                        """
                        Skewness refinement controls.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/skewness_method").execute(*args, **kwargs)
                    def max_cell_length(self, *args, **kwargs):
                        """
                        Set max-cell-length.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/max_cell_length").execute(*args, **kwargs)
                    def use_max_cell_size(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/use_max_cell_size").execute(*args, **kwargs)
                    def compute_max_cell_volume(self, *args, **kwargs):
                        """
                        Computes max cell size.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/compute_max_cell_volume").execute(*args, **kwargs)
                    def refine_method(self, *args, **kwargs):
                        """
                        Define refinement method.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/refine_method").execute(*args, **kwargs)
                    def improve_surface_mesh(self, *args, **kwargs):
                        """
                        Automatically improve surface mesh?.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/improve_surface_mesh").execute(*args, **kwargs)
                    def delete_unused_nodes(self, *args, **kwargs):
                        """
                        Automatically delete unused nodes?.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/delete_unused_nodes").execute(*args, **kwargs)
                    def merge_free_nodes(self, *args, **kwargs):
                        """
                        Automatically merge duplicate nodes?.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/merge_free_nodes").execute(*args, **kwargs)
                    def max_cell_volume(self, *args, **kwargs):
                        """
                        Set max-cell-volume.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/max_cell_volume").execute(*args, **kwargs)
                    def set_region_based_sizing(self, *args, **kwargs):
                        """
                        Set region based sizings.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/set_region_based_sizing").execute(*args, **kwargs)
                    def clear_zone_growth_rate(self, *args, **kwargs):
                        """
                        Clear zone specific geometric growth rates.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/clear_zone_growth_rate").execute(*args, **kwargs)
                    def print_region_based_sizing(self, *args, **kwargs):
                        """
                        Print region based sizings.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/print_region_based_sizing").execute(*args, **kwargs)
                    def non_fluid_type(self, *args, **kwargs):
                        """
                        Select the default non-fluid cell zone type.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/non_fluid_type").execute(*args, **kwargs)
                    def set_zone_growth_rate(self, *args, **kwargs):
                        """
                        Set zone specific geometric growth rates.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/set_zone_growth_rate").execute(*args, **kwargs)
                    def cell_sizing(self, *args, **kwargs):
                        """
                        Allow cell volume distribution to be determined based on boundary.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/cell_sizing").execute(*args, **kwargs)
                    ...
                    class remove_slivers(TUIMenu):
                        ...
                        def iterations(self, *args, **kwargs):
                            ...
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/remove_slivers/iterations").execute(*args, **kwargs)
                        def remove(self, *args, **kwargs):
                            """
                            Automatically remove slivers.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/remove_slivers/remove").execute(*args, **kwargs)
                        def skew(self, *args, **kwargs):
                            """
                            Remove sliver skew.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/remove_slivers/skew").execute(*args, **kwargs)
                        def low_skew(self, *args, **kwargs):
                            """
                            Remove sliver low skew.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/remove_slivers/low_skew").execute(*args, **kwargs)
                        def method(self, *args, **kwargs):
                            """
                            Sliver remove method.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/remove_slivers/method").execute(*args, **kwargs)
                        def attempts(self, *args, **kwargs):
                            """
                            Sliver remove attempts.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/remove_slivers/attempts").execute(*args, **kwargs)
                        def angle(self, *args, **kwargs):
                            """
                            Max dihedral angle defining a valid boundary sliver.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/remove_slivers/angle").execute(*args, **kwargs)
                    ...
                    class tet_improve(TUIMenu):
                        ...
                        def angle(self, *args, **kwargs):
                            ...
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/tet_improve/angle").execute(*args, **kwargs)
                        def skew(self, *args, **kwargs):
                            """
                            Remove skew.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/tet_improve/skew").execute(*args, **kwargs)
                        def iterations(self, *args, **kwargs):
                            """
                            Improve iterations.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/tet_improve/iterations").execute(*args, **kwargs)
                        def attempts(self, *args, **kwargs):
                            """
                            Improve attempts.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/tet_improve/attempts").execute(*args, **kwargs)
                    ...
                    class improve_mesh(TUIMenu):
                        ...
                        def laplace_smooth(self, *args, **kwargs):
                            ...
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/improve_mesh/laplace_smooth").execute(*args, **kwargs)
                        def skewness_smooth(self, *args, **kwargs):
                            """
                            Skewness smooth parametersx.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/improve_mesh/skewness_smooth").execute(*args, **kwargs)
                        def swap(self, *args, **kwargs):
                            """
                            Face swap parameters.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/improve_mesh/swap").execute(*args, **kwargs)
                        def improve(self, *args, **kwargs):
                            """
                            Automatically improve mesh.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/improve_mesh/improve").execute(*args, **kwargs)
                    ...
                    class advanced(TUIMenu):
                        ...
                        def report_max_unmeshed(self, *args, **kwargs):
                            ...
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/advanced/report_max_unmeshed").execute(*args, **kwargs)
                        def defaults(self, *args, **kwargs):
                            """
                            Calculate defaults.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/advanced/defaults").execute(*args, **kwargs)
                        def keep_virtual_entities(self, *args, **kwargs):
                            """
                            Toggle deletion of virtual entities after intialization.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/advanced/keep_virtual_entities").execute(*args, **kwargs)
                        def report_unmeshed_nodes(self, *args, **kwargs):
                            """
                            Report unmeshed nodes.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/advanced/report_unmeshed_nodes").execute(*args, **kwargs)
                        def max_nodes(self, *args, **kwargs):
                            """
                            Set maximum number of nodes in mesh.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/advanced/max_nodes").execute(*args, **kwargs)
                        def progress_reports(self, *args, **kwargs):
                            """
                            Set time between progress reports in seconds.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/advanced/progress_reports").execute(*args, **kwargs)
                        def freeze_boundary_cells(self, *args, **kwargs):
                            """
                            Freeze boundary cells .
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/advanced/freeze_boundary_cells").execute(*args, **kwargs)
                        def sliver_size(self, *args, **kwargs):
                            """
                            Set sliver-size.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/advanced/sliver_size").execute(*args, **kwargs)
                        def max_cells(self, *args, **kwargs):
                            """
                            Set maximum number of cells in mesh.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/advanced/max_cells").execute(*args, **kwargs)
                        def node_tolerance(self, *args, **kwargs):
                            """
                            Set node-tolerance.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/advanced/node_tolerance").execute(*args, **kwargs)
                        def report_unmeshed_faces(self, *args, **kwargs):
                            """
                            Report unmeshed faces.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/advanced/report_unmeshed_faces").execute(*args, **kwargs)
                    ...
                    class adv_front_method(TUIMenu):
                        ...
                        def refine_parameters(self, *args, **kwargs):
                            ...
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/adv_front_method/refine_parameters").execute(*args, **kwargs)
                        def second_improve_params(self, *args, **kwargs):
                            """
                            Define cell zone improve parameters.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/adv_front_method/second_improve_params").execute(*args, **kwargs)
                        def first_improve_params(self, *args, **kwargs):
                            """
                            Define refine front improve parameters.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/adv_front_method/first_improve_params").execute(*args, **kwargs)
                        ...
                        class skew_improve(TUIMenu):
                            ...
                            def target_low_skew(self, *args, **kwargs):
                                ...
                                """
                                return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/adv_front_method/skew_improve/target_low_skew").execute(*args, **kwargs)
                            def target(self, *args, **kwargs):
                                """
                                Activate target skew refinement.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/adv_front_method/skew_improve/target").execute(*args, **kwargs)
                            def iterations(self, *args, **kwargs):
                                """
                                Refine improve iterations.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/adv_front_method/skew_improve/iterations").execute(*args, **kwargs)
                            def boundary_sliver_skew(self, *args, **kwargs):
                                """
                                Refine improve boundary sliver skew.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/adv_front_method/skew_improve/boundary_sliver_skew").execute(*args, **kwargs)
                            def attempts(self, *args, **kwargs):
                                """
                                Refine improve attempts.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/adv_front_method/skew_improve/attempts").execute(*args, **kwargs)
                            def target_skew(self, *args, **kwargs):
                                """
                                Refine improve target skew.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/adv_front_method/skew_improve/target_skew").execute(*args, **kwargs)
                            def sliver_skew(self, *args, **kwargs):
                                """
                                Refine improve sliver skew.
                                """
                                return PyMenu(self._service, self._version, self._mode, "/objects/volumetric_regions/tet/set/adv_front_method/skew_improve/sliver_skew").execute(*args, **kwargs)
        ...
        class deprecated(TUIMenu):
            ...
            def create_mesh_object_from_wrap(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/deprecated/create_mesh_object_from_wrap").execute(*args, **kwargs)
        ...
        class remove_gaps(TUIMenu):
            ...
            def remove_gaps(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/remove_gaps/remove_gaps").execute(*args, **kwargs)
            def show_gaps(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/remove_gaps/show_gaps").execute(*args, **kwargs)
            def ignore_orientation(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/objects/remove_gaps/ignore_orientation").execute(*args, **kwargs)
    ...
    class parallel(TUIMenu):
        ...
        def auto_partition(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/parallel/auto_partition").execute(*args, **kwargs)
        def spawn_solver_processes(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/parallel/spawn_solver_processes").execute(*args, **kwargs)
        def agglomerate(self, *args, **kwargs):
            """
            Recombines distributed mesh data into a single partition on compute node 0.
            """
            return PyMenu(self._service, self._version, self._mode, "/parallel/agglomerate").execute(*args, **kwargs)
        def print_partition_info(self, *args, **kwargs):
            """
            Displays computed partition data to the console.
            """
            return PyMenu(self._service, self._version, self._mode, "/parallel/print_partition_info").execute(*args, **kwargs)
    ...
    class reference_frames(TUIMenu):
        ...
        def display(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/reference_frames/display").execute(*args, **kwargs)
        def edit(self, *args, **kwargs):
            """
            Edit an object.
            """
            return PyMenu(self._service, self._version, self._mode, "/reference_frames/edit").execute(*args, **kwargs)
        def display_edit(self, *args, **kwargs):
            """
            Display and edit reference frame from graphics.
            """
            return PyMenu(self._service, self._version, self._mode, "/reference_frames/display_edit").execute(*args, **kwargs)
        def list_properties(self, *args, **kwargs):
            """
            List properties of an object.
            """
            return PyMenu(self._service, self._version, self._mode, "/reference_frames/list_properties").execute(*args, **kwargs)
        def delete(self, *args, **kwargs):
            """
            Delete an object.
            """
            return PyMenu(self._service, self._version, self._mode, "/reference_frames/delete").execute(*args, **kwargs)
        def add(self, *args, **kwargs):
            """
            Add a new object.
            """
            return PyMenu(self._service, self._version, self._mode, "/reference_frames/add").execute(*args, **kwargs)
        def list(self, *args, **kwargs):
            """
            List objects.
            """
            return PyMenu(self._service, self._version, self._mode, "/reference_frames/list").execute(*args, **kwargs)
        def hide(self, *args, **kwargs):
            """
            Hide Reference Frame.
            """
            return PyMenu(self._service, self._version, self._mode, "/reference_frames/hide").execute(*args, **kwargs)
    ...
    class scoped_sizing(TUIMenu):
        ...
        def list(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/scoped_sizing/list").execute(*args, **kwargs)
        def delete_all(self, *args, **kwargs):
            """
            Deletes all the defined scoped size controls.
            """
            return PyMenu(self._service, self._version, self._mode, "/scoped_sizing/delete_all").execute(*args, **kwargs)
        def create(self, *args, **kwargs):
            """
            Defines the scoped size based on the specified parameters.
            """
            return PyMenu(self._service, self._version, self._mode, "/scoped_sizing/create").execute(*args, **kwargs)
        def delete_size_field(self, *args, **kwargs):
            """
            Deletes the current size field.
            """
            return PyMenu(self._service, self._version, self._mode, "/scoped_sizing/delete_size_field").execute(*args, **kwargs)
        def delete(self, *args, **kwargs):
            """
            Deletes the specified scoped size controls.
            """
            return PyMenu(self._service, self._version, self._mode, "/scoped_sizing/delete").execute(*args, **kwargs)
        def validate(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/scoped_sizing/validate").execute(*args, **kwargs)
        def list_zones_uncovered_by_controls(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/scoped_sizing/list_zones_uncovered_by_controls").execute(*args, **kwargs)
        def modify(self, *args, **kwargs):
            """
            Modifies the scoped size control definition.
            """
            return PyMenu(self._service, self._version, self._mode, "/scoped_sizing/modify").execute(*args, **kwargs)
        def read(self, *args, **kwargs):
            """
            Enables you to read in a scoped sizing file (\*.szcontrol).
            """
            return PyMenu(self._service, self._version, self._mode, "/scoped_sizing/read").execute(*args, **kwargs)
        def compute(self, *args, **kwargs):
            """
            Computes the size field based on the defined size functions and/or scoped size controls.
            """
            return PyMenu(self._service, self._version, self._mode, "/scoped_sizing/compute").execute(*args, **kwargs)
        def write(self, *args, **kwargs):
            """
            Enables you to write a scoped sizing file (\*.szcontrol).
            """
            return PyMenu(self._service, self._version, self._mode, "/scoped_sizing/write").execute(*args, **kwargs)
    ...
    class openmp_controls(TUIMenu):
        ...
        def get_max_cores(self, *args, **kwargs):
            ...
            Max Number of Cores.
            """
            return PyMenu(self._service, self._version, self._mode, "/openmp_controls/get_max_cores").execute(*args, **kwargs)
        def get_active_cores(self, *args, **kwargs):
            """
            Number of Active Cores.
            """
            return PyMenu(self._service, self._version, self._mode, "/openmp_controls/get_active_cores").execute(*args, **kwargs)
        def set_num_cores(self, *args, **kwargs):
            """
            Enter Number of Cores.
            """
            return PyMenu(self._service, self._version, self._mode, "/openmp_controls/set_num_cores").execute(*args, **kwargs)
    ...
    class diagnostics(TUIMenu):
        ...
        def perform_summary(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/diagnostics/perform_summary").execute(*args, **kwargs)
        def manage_summary(self, *args, **kwargs):
            """
            Manage diagnostics summary checks.
            """
            return PyMenu(self._service, self._version, self._mode, "/diagnostics/manage_summary").execute(*args, **kwargs)
        def modify_defaults(self, *args, **kwargs):
            """
            Modify diagnostics defaults.
            """
            return PyMenu(self._service, self._version, self._mode, "/diagnostics/modify_defaults").execute(*args, **kwargs)
        def set_scope(self, *args, **kwargs):
            """
            Set Diagnostics scope.
            """
            return PyMenu(self._service, self._version, self._mode, "/diagnostics/set_scope").execute(*args, **kwargs)
        ...
        class quality(TUIMenu):
            ...
            def smooth(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/diagnostics/quality/smooth").execute(*args, **kwargs)
            def general_improve(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/diagnostics/quality/general_improve").execute(*args, **kwargs)
            def delaunay_swap(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/diagnostics/quality/delaunay_swap").execute(*args, **kwargs)
            def collapse(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/diagnostics/quality/collapse").execute(*args, **kwargs)
        ...
        class face_connectivity(TUIMenu):
            ...
            def fix_invalid_normals(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/diagnostics/face_connectivity/fix_invalid_normals").execute(*args, **kwargs)
            def fix_spikes(self, *args, **kwargs):
                """
                Fixes spiked faces based on the spike angle specified.
                """
                return PyMenu(self._service, self._version, self._mode, "/diagnostics/face_connectivity/fix_spikes").execute(*args, **kwargs)
            def remove_label_from_small_islands(self, *args, **kwargs):
                """
                Change small disconnected island labels to their connected neighbors.
                """
                return PyMenu(self._service, self._version, self._mode, "/diagnostics/face_connectivity/remove_label_from_small_islands").execute(*args, **kwargs)
            def fix_free_faces(self, *args, **kwargs):
                """
                Removes free faces by the method selected. The methods available are:.
                """
                return PyMenu(self._service, self._version, self._mode, "/diagnostics/face_connectivity/fix_free_faces").execute(*args, **kwargs)
            def add_label_to_small_neighbors(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/diagnostics/face_connectivity/add_label_to_small_neighbors").execute(*args, **kwargs)
            def fix_deviations(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/diagnostics/face_connectivity/fix_deviations").execute(*args, **kwargs)
            def fix_steps(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/diagnostics/face_connectivity/fix_steps").execute(*args, **kwargs)
            def fix_self_intersections(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/diagnostics/face_connectivity/fix_self_intersections").execute(*args, **kwargs)
            def fix_slivers(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/diagnostics/face_connectivity/fix_slivers").execute(*args, **kwargs)
            def fix_islands(self, *args, **kwargs):
                """
                Deletes groups of island faces based on the absolute face count specified.
                """
                return PyMenu(self._service, self._version, self._mode, "/diagnostics/face_connectivity/fix_islands").execute(*args, **kwargs)
            def fix_multi_faces(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/diagnostics/face_connectivity/fix_multi_faces").execute(*args, **kwargs)
            def fix_point_contacts(self, *args, **kwargs):
                """
                Fixes non-manifold configurations by removing point contacts.
                """
                return PyMenu(self._service, self._version, self._mode, "/diagnostics/face_connectivity/fix_point_contacts").execute(*args, **kwargs)
            def fix_duplicate_faces(self, *args, **kwargs):
                """
                Removes duplicate faces.
                """
                return PyMenu(self._service, self._version, self._mode, "/diagnostics/face_connectivity/fix_duplicate_faces").execute(*args, **kwargs)
    ...
    class cad_assemblies(TUIMenu):
        ...
        def add_prefix(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/add_prefix").execute(*args, **kwargs)
        def replace_object(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/replace_object").execute(*args, **kwargs)
        def update_cad_assemblies(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/update_cad_assemblies").execute(*args, **kwargs)
        def add_to_object(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/add_to_object").execute(*args, **kwargs)
        def extract_edges_zones(self, *args, **kwargs):
            """
            Extract feature edges for CAD assemblies.
            """
            return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/extract_edges_zones").execute(*args, **kwargs)
        def draw(self, *args, **kwargs):
            """
            Displays the selected CAD entities.
            """
            return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/draw").execute(*args, **kwargs)
        def rename(self, *args, **kwargs):
            """
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/rename").execute(*args, **kwargs)
        def create_objects(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/create_objects").execute(*args, **kwargs)
        def delete_cad_assemblies(self, *args, **kwargs):
            """
            Deletes all the CAD assemblies data.
            """
            return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/delete_cad_assemblies").execute(*args, **kwargs)
        ...
        class update_options(TUIMenu):
            ...
            def import_edge_zones(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/update_options/import_edge_zones").execute(*args, **kwargs)
            def one_object_per(self, *args, **kwargs):
                """
                Enables you to change the CAD object granularity on reimport.
                """
                return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/update_options/one_object_per").execute(*args, **kwargs)
            def tessellation(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/update_options/tessellation").execute(*args, **kwargs)
            def one_zone_per(self, *args, **kwargs):
                """
                Enables you to change the CAD zone granularity on reimport.
                """
                return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/update_options/one_zone_per").execute(*args, **kwargs)
        ...
        class manage_state(TUIMenu):
            ...
            def unsuppress(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/manage_state/unsuppress").execute(*args, **kwargs)
            def suppress(self, *args, **kwargs):
                """
                Suppresses the selected CAD entities.
                """
                return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/manage_state/suppress").execute(*args, **kwargs)
            def unlock(self, *args, **kwargs):
                """
                Unlocks the selected CAD entities.
                """
                return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/manage_state/unlock").execute(*args, **kwargs)
        ...
        class draw_options(TUIMenu):
            ...
            def draw_unlabelled_zones(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/draw_options/draw_unlabelled_zones").execute(*args, **kwargs)
            def add_to_graphics(self, *args, **kwargs):
                """
                Adds the selected entities to the display in the graphics window.
                """
                return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/draw_options/add_to_graphics").execute(*args, **kwargs)
            def remove_from_graphics(self, *args, **kwargs):
                """
                Removes the selected entities from the display in the graphics window.
                """
                return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/draw_options/remove_from_graphics").execute(*args, **kwargs)
        ...
        class labels(TUIMenu):
            ...
            def remove_from_graphics(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/labels/remove_from_graphics").execute(*args, **kwargs)
            def delete(self, *args, **kwargs):
                """
                Deletes the selected labels.
                """
                return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/labels/delete").execute(*args, **kwargs)
            def add_to_graphics(self, *args, **kwargs):
                """
                Adds the selected labels to the display in the graphics window.
                """
                return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/labels/add_to_graphics").execute(*args, **kwargs)
            def draw(self, *args, **kwargs):
                """
                Displays the selected labels.
                """
                return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/labels/draw").execute(*args, **kwargs)
            def rename(self, *args, **kwargs):
                """
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/cad_assemblies/labels/rename").execute(*args, **kwargs)
    ...
    class material_point(TUIMenu):
        ...
        def list_material_points(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/material_point/list_material_points").execute(*args, **kwargs)
        def delete_all_material_points(self, *args, **kwargs):
            """
            Enables the deletion of all defined material points.
            """
            return PyMenu(self._service, self._version, self._mode, "/material_point/delete_all_material_points").execute(*args, **kwargs)
        def delete_material_point(self, *args, **kwargs):
            """
            Deletes the specified material point.
            """
            return PyMenu(self._service, self._version, self._mode, "/material_point/delete_material_point").execute(*args, **kwargs)
        def create_material_point(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/material_point/create_material_point").execute(*args, **kwargs)
    ...
    class display(TUIMenu):
        ...
        def clear(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/display/clear").execute(*args, **kwargs)
        def boundary_cells(self, *args, **kwargs):
            """
            Displays boundary cells attached to the specified face zones.
            """
            return PyMenu(self._service, self._version, self._mode, "/display/boundary_cells").execute(*args, **kwargs)
        def clear_annotation(self, *args, **kwargs):
            """
            Removes all annotations and attachment lines from the active graphics window.
            """
            return PyMenu(self._service, self._version, self._mode, "/display/clear_annotation").execute(*args, **kwargs)
        def redisplay(self, *args, **kwargs):
            """
            Redraws the grid in the graphics window.
            """
            return PyMenu(self._service, self._version, self._mode, "/display/redisplay").execute(*args, **kwargs)
        ...
        def boundary_grid(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/display/boundary_grid").execute(*args, **kwargs)
        def draw_face_zones_using_entities(self, *args, **kwargs):
            """
            Draws cells that are connected to the selected entities.
            """
            return PyMenu(self._service, self._version, self._mode, "/display/draw_face_zones_using_entities").execute(*args, **kwargs)
        def draw_zones(self, *args, **kwargs):
            """
            Draws the boundary/cell zones using the zone ID specified as input.
            """
            return PyMenu(self._service, self._version, self._mode, "/display/draw_zones").execute(*args, **kwargs)
        ...
        def draw_cells_using_faces(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/display/draw_cells_using_faces").execute(*args, **kwargs)
        def all_grid(self, *args, **kwargs):
            """
            Displays the grid according to the currently set parameters.
            """
            return PyMenu(self._service, self._version, self._mode, "/display/all_grid").execute(*args, **kwargs)
        def views(self, *args, **kwargs):
            """
            Enters the view window options menu.
            """
            return PyMenu(self._service, self._version, self._mode, "/display/views").execute(*args, **kwargs)
        ...
        def draw_cells_using_nodes(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/display/draw_cells_using_nodes").execute(*args, **kwargs)
        def center_view_on(self, *args, **kwargs):
            """
            Sets the camera target to be the center (centroid) of an entity.
            """
            return PyMenu(self._service, self._version, self._mode, "/display/center_view_on").execute(*args, **kwargs)
        def show_hide_clipping_plane_triad(self, *args, **kwargs):
            """
            S.
            """
            return PyMenu(self._service, self._version, self._mode, "/display/show_hide_clipping_plane_triad").execute(*args, **kwargs)
        ...
        class objects(TUIMenu):
            ...
            def make_transparent(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/display/objects/make_transparent").execute(*args, **kwargs)
            def toggle_color_palette(self, *args, **kwargs):
                """
                Toggles the color palette of the geometry.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/objects/toggle_color_palette").execute(*args, **kwargs)
            def isolate_objects(self, *args, **kwargs):
                """
                Displays only the selected objects.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/objects/isolate_objects").execute(*args, **kwargs)
            def explode(self, *args, **kwargs):
                """
                Explodes the objects in the geometry. (This command is valid only when the geometry is an assembled mode.).
                """
                return PyMenu(self._service, self._version, self._mode, "/display/objects/explode").execute(*args, **kwargs)
            def display_similar_area(self, *args, **kwargs):
                """
                Displays the objects with similar area to the selected object area.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/objects/display_similar_area").execute(*args, **kwargs)
            def show_all(self, *args, **kwargs):
                """
                Unhides all the objects in the geometry and displays them.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/objects/show_all").execute(*args, **kwargs)
            def toggle_color_mode(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/display/objects/toggle_color_mode").execute(*args, **kwargs)
            def implode(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/display/objects/implode").execute(*args, **kwargs)
            def display_neighborhood(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/display/objects/display_neighborhood").execute(*args, **kwargs)
            def hide_objects(self, *args, **kwargs):
                """
                Hides the selected objects in the display.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/objects/hide_objects").execute(*args, **kwargs)
            def select_all_visible(self, *args, **kwargs):
                """
                Selects all the visible objects in the graphics window.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/objects/select_all_visible").execute(*args, **kwargs)
        ...
        class xy_plot(TUIMenu):
            ...
            def set(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/display/xy_plot/set").execute(*args, **kwargs)
            def face_distribution(self, *args, **kwargs):
                """
                Plots a histogram of face quality.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/xy_plot/face_distribution").execute(*args, **kwargs)
            def file(self, *args, **kwargs):
                """
                Enables you to choose a file from which to create an xy plot.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/xy_plot/file").execute(*args, **kwargs)
            def cell_distribution(self, *args, **kwargs):
                """
                Plots a histogram of cell quality.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/xy_plot/cell_distribution").execute(*args, **kwargs)
        ...
        class set(TUIMenu):
            ...
            def title(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set/title").execute(*args, **kwargs)
            ...
            def shrink_factor(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set/shrink_factor").execute(*args, **kwargs)
            def remote_display_defaults(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set/remote_display_defaults").execute(*args, **kwargs)
            def highlight_tree_selection(self, *args, **kwargs):
                """
                Turn on/off outline display of tree selection in graphics window.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set/highlight_tree_selection").execute(*args, **kwargs)
            def windows(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set/windows").execute(*args, **kwargs)
            def re_render(self, *args, **kwargs):
                """
                Re-renders the current window after modifying the variables in the set menu.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set/re_render").execute(*args, **kwargs)
            def edges(self, *args, **kwargs):
                """
                Enables/disables the display of face/cell edges.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set/edges").execute(*args, **kwargs)
            def native_display_defaults(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set/native_display_defaults").execute(*args, **kwargs)
            def quick_moves_algorithm(self, *args, **kwargs):
                """
                Select quick moves algorithm for icons and helptext overlay.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set/quick_moves_algorithm").execute(*args, **kwargs)
            ...
            class styles(TUIMenu):
                ...
                def dummy(self, *args, **kwargs):
                    ...
                    .
                    """
                    return PyMenu(self._service, self._version, self._mode, "/display/set/styles/dummy").execute(*args, **kwargs)
        ...
        class advanced_rendering(TUIMenu):
            ...
            def simple_shadow(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/display/advanced_rendering/simple_shadow").execute(*args, **kwargs)
            def max_extent_culling(self, *args, **kwargs):
                """
                Truncates zones smaller that the maximum extent culling pixel value.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/advanced_rendering/max_extent_culling").execute(*args, **kwargs)
            def fast_silhouette_edges(self, *args, **kwargs):
                """
                Enhances viewability by adding fast silhouette edges.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/advanced_rendering/fast_silhouette_edges").execute(*args, **kwargs)
            def edge_color(self, *args, **kwargs):
                """
                Choose between black and body colored edges.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/advanced_rendering/edge_color").execute(*args, **kwargs)
            def static_model(self, *args, **kwargs):
                """
                Static model driver setting.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/advanced_rendering/static_model").execute(*args, **kwargs)
        ...
        class zones(TUIMenu):
            ...
            def toggle_color_palette(self, *args, **kwargs):
                ...
                Toggles the color palette of the geometry.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/zones/toggle_color_palette").execute(*args, **kwargs)
            def toggle_color_mode(self, *args, **kwargs):
                """
                Toggles the colors of the geometry. In one mode geometry is colored object-wise while in the other mode it is colored zone-wise.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/zones/toggle_color_mode").execute(*args, **kwargs)
            def hide_zones(self, *args, **kwargs):
                """
                Hides the selected zones in the display.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/zones/hide_zones").execute(*args, **kwargs)
            def display_neighborhood(self, *args, **kwargs):
                """
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/display/zones/display_neighborhood").execute(*args, **kwargs)
            def show_all(self, *args, **kwargs):
                """
                Unhides all the zones in the geometry and displays them.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/zones/show_all").execute(*args, **kwargs)
            def isolate_zones(self, *args, **kwargs):
                """
                Displays only the selected zones.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/zones/isolate_zones").execute(*args, **kwargs)
            def display_similar_area(self, *args, **kwargs):
                """
                Displays the zones with similar area to the selected zone area.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/zones/display_similar_area").execute(*args, **kwargs)
            def make_transparent(self, *args, **kwargs):
                """
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/display/zones/make_transparent").execute(*args, **kwargs)
            def select_all_visible(self, *args, **kwargs):
                """
                Selects all the visible zones in the graphics window.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/zones/select_all_visible").execute(*args, **kwargs)
        ...
        class set_grid(TUIMenu):
            ...
            def label_alignment(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/label_alignment").execute(*args, **kwargs)
            def tagged(self, *args, **kwargs):
                """
                Enables/disables the display of tagged nodes.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/tagged").execute(*args, **kwargs)
            def label_scale(self, *args, **kwargs):
                """
                Scales the size of the label.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/label_scale").execute(*args, **kwargs)
            def node_symbol(self, *args, **kwargs):
                """
                Specifies the node symbol.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/node_symbol").execute(*args, **kwargs)
            def cell_quality(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/cell_quality").execute(*args, **kwargs)
            def normals(self, *args, **kwargs):
                """
                Enables/disables the display of face normals.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/normals").execute(*args, **kwargs)
            def all_cells(self, *args, **kwargs):
                """
                Enables/disables the display of all cells.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/all_cells").execute(*args, **kwargs)
            def z_range(self, *args, **kwargs):
                """
                Limits the display of grid objects to the specified z-range.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/z_range").execute(*args, **kwargs)
            def labels(self, *args, **kwargs):
                """
                Enables/disables the display of labels.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/labels").execute(*args, **kwargs)
            def list(self, *args, **kwargs):
                """
                Lists all the grid display settings.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/list").execute(*args, **kwargs)
            def neighborhood(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/neighborhood").execute(*args, **kwargs)
            def unused(self, *args, **kwargs):
                """
                Enables/disables the display of unused nodes.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/unused").execute(*args, **kwargs)
            def all_faces(self, *args, **kwargs):
                """
                Enables/disables the display of all faces.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/all_faces").execute(*args, **kwargs)
            def refine(self, *args, **kwargs):
                """
                Enables/disables the display of those faces that have been marked for refinement.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/refine").execute(*args, **kwargs)
            def face_quality(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/face_quality").execute(*args, **kwargs)
            def left_handed(self, *args, **kwargs):
                """
                Enables/disables the display of left-handed faces.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/left_handed").execute(*args, **kwargs)
            def multi(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/multi").execute(*args, **kwargs)
            def normal_scale(self, *args, **kwargs):
                """
                Sets the scale factor for face normals.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/normal_scale").execute(*args, **kwargs)
            def default(self, *args, **kwargs):
                """
                Resets the grid display parameters to their default values.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/default").execute(*args, **kwargs)
            def marked(self, *args, **kwargs):
                """
                Enables/disables the display of marked nodes.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/marked").execute(*args, **kwargs)
            def free(self, *args, **kwargs):
                """
                Enables/disables the drawing of faces/nodes that have no neighboring face on at least one edge.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/free").execute(*args, **kwargs)
            def label_font(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/label_font").execute(*args, **kwargs)
            def x_range(self, *args, **kwargs):
                """
                Limits the display of grid objects to the specified x-range.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/x_range").execute(*args, **kwargs)
            def node_size(self, *args, **kwargs):
                """
                Sets the node symbol scaling factor.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/node_size").execute(*args, **kwargs)
            def unmeshed(self, *args, **kwargs):
                """
                Enables/disables the display of nodes and faces that have not been meshed.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/unmeshed").execute(*args, **kwargs)
            def all_nodes(self, *args, **kwargs):
                """
                Enables/disables the display of all nodes.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/all_nodes").execute(*args, **kwargs)
            def y_range(self, *args, **kwargs):
                """
                Limits the display of grid objects to the specified y-range.
                """
                return PyMenu(self._service, self._version, self._mode, "/display/set_grid/y_range").execute(*args, **kwargs)
    ...
    class report(TUIMenu):
        ...
        def verbosity_level(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/report/verbosity_level").execute(*args, **kwargs)
        def cell_quality_limits(self, *args, **kwargs):
            """
            Reports the cell quality limits.
            """
            return PyMenu(self._service, self._version, self._mode, "/report/cell_quality_limits").execute(*args, **kwargs)
        def quality_method(self, *args, **kwargs):
            """
            Specifies the method to be used for reporting face and cell quality.
            """
            return PyMenu(self._service, self._version, self._mode, "/report/quality_method").execute(*args, **kwargs)
        def cell_zone_at_location(self, *args, **kwargs):
            """
            Returns the cell zone at or closest to the specified location.
            """
            return PyMenu(self._service, self._version, self._mode, "/report/cell_zone_at_location").execute(*args, **kwargs)
        def edge_size_limits(self, *args, **kwargs):
            """
            Reports the edge size limits.
            """
            return PyMenu(self._service, self._version, self._mode, "/report/edge_size_limits").execute(*args, **kwargs)
        def update_bounding_box(self, *args, **kwargs):
            """
            Updates the bounding box.
            """
            return PyMenu(self._service, self._version, self._mode, "/report/update_bounding_box").execute(*args, **kwargs)
        def meshing_time(self, *args, **kwargs):
            """
            Report meshing time.
            """
            return PyMenu(self._service, self._version, self._mode, "/report/meshing_time").execute(*args, **kwargs)
        def memory_usage(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/report/memory_usage").execute(*args, **kwargs)
        def spy_level(self, *args, **kwargs):
            """
            Spy on meshing process.
            """
            return PyMenu(self._service, self._version, self._mode, "/report/spy_level").execute(*args, **kwargs)
        def cell_distribution(self, *args, **kwargs):
            """
            Reports the distribution of cell quality or size based on the bounding limits and number of partitions specified.
            """
            return PyMenu(self._service, self._version, self._mode, "/report/cell_distribution").execute(*args, **kwargs)
        def cell_zone_volume(self, *args, **kwargs):
            """
            Reports the volume of the specified cell zone.
            """
            return PyMenu(self._service, self._version, self._mode, "/report/cell_zone_volume").execute(*args, **kwargs)
        def cell_size_limits(self, *args, **kwargs):
            """
            Reports the cell size limits.
            """
            return PyMenu(self._service, self._version, self._mode, "/report/cell_size_limits").execute(*args, **kwargs)
        def face_distribution(self, *args, **kwargs):
            """
            Reports the distribution of face quality or size based on the bounding limits and number of partitions specified.
            """
            return PyMenu(self._service, self._version, self._mode, "/report/face_distribution").execute(*args, **kwargs)
        def boundary_cell_quality(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/report/boundary_cell_quality").execute(*args, **kwargs)
        def enhanced_orthogonal_quality(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/report/enhanced_orthogonal_quality").execute(*args, **kwargs)
        def list_cell_quality(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/report/list_cell_quality").execute(*args, **kwargs)
        def face_zone_area(self, *args, **kwargs):
            """
            Reports the area of the specified face zone.
            """
            return PyMenu(self._service, self._version, self._mode, "/report/face_zone_area").execute(*args, **kwargs)
        def face_node_degree_distribution(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/report/face_node_degree_distribution").execute(*args, **kwargs)
        def face_quality_limits(self, *args, **kwargs):
            """
            Reports the face quality limits.
            """
            return PyMenu(self._service, self._version, self._mode, "/report/face_quality_limits").execute(*args, **kwargs)
        def unrefined_cells(self, *args, **kwargs):
            """
            Reports the number of cells that have not been refined.
            """
            return PyMenu(self._service, self._version, self._mode, "/report/unrefined_cells").execute(*args, **kwargs)
        def face_zone_at_location(self, *args, **kwargs):
            """
            Reports the face zone at the given location.
            """
            return PyMenu(self._service, self._version, self._mode, "/report/face_zone_at_location").execute(*args, **kwargs)
        def mesh_size(self, *args, **kwargs):
            """
            Reports the number of nodes, faces, and cells in the mesh.
            """
            return PyMenu(self._service, self._version, self._mode, "/report/mesh_size").execute(*args, **kwargs)
        def number_meshed(self, *args, **kwargs):
            """
            Reports the number of elements that have been meshed.
            """
            return PyMenu(self._service, self._version, self._mode, "/report/number_meshed").execute(*args, **kwargs)
        def face_size_limits(self, *args, **kwargs):
            """
            Reports the face size limits.
            """
            return PyMenu(self._service, self._version, self._mode, "/report/face_size_limits").execute(*args, **kwargs)
        def mesh_statistics(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/report/mesh_statistics").execute(*args, **kwargs)
        def neighborhood_quality(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/report/neighborhood_quality").execute(*args, **kwargs)
        def print_info(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/report/print_info").execute(*args, **kwargs)
    ...
    class size_functions(TUIMenu):
        ...
        def set_prox_gap_tolerance(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/size_functions/set_prox_gap_tolerance").execute(*args, **kwargs)
        def triangulate_quad_faces(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/size_functions/triangulate_quad_faces").execute(*args, **kwargs)
        def enable_periodicity_filter(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/size_functions/enable_periodicity_filter").execute(*args, **kwargs)
        def delete(self, *args, **kwargs):
            """
            Deletes the specified size function or the current size field.
            """
            return PyMenu(self._service, self._version, self._mode, "/size_functions/delete").execute(*args, **kwargs)
        def create(self, *args, **kwargs):
            """
            Defines the size function based on the specified parameters.
            """
            return PyMenu(self._service, self._version, self._mode, "/size_functions/create").execute(*args, **kwargs)
        def reset_global_controls(self, *args, **kwargs):
            """
            Resets the global controls to their default values.
            """
            return PyMenu(self._service, self._version, self._mode, "/size_functions/reset_global_controls").execute(*args, **kwargs)
        def create_defaults(self, *args, **kwargs):
            """
            Creates default size functions based on face and edge curvature and proximity.
            """
            return PyMenu(self._service, self._version, self._mode, "/size_functions/create_defaults").execute(*args, **kwargs)
        def compute(self, *args, **kwargs):
            """
            Computes the size function based on the defined parameters.
            """
            return PyMenu(self._service, self._version, self._mode, "/size_functions/compute").execute(*args, **kwargs)
        def delete_all(self, *args, **kwargs):
            """
            Deletes all the defined size functions.
            """
            return PyMenu(self._service, self._version, self._mode, "/size_functions/delete_all").execute(*args, **kwargs)
        def set_scaling_filter(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/size_functions/set_scaling_filter").execute(*args, **kwargs)
        def disable_periodicity_filter(self, *args, **kwargs):
            """
            Removes periodicity from the size field.
            """
            return PyMenu(self._service, self._version, self._mode, "/size_functions/disable_periodicity_filter").execute(*args, **kwargs)
        def use_cad_imported_curvature(self, *args, **kwargs):
            """
            Allows you to disable curvature data from the nodes of the CAD facets.
            """
            return PyMenu(self._service, self._version, self._mode, "/size_functions/use_cad_imported_curvature").execute(*args, **kwargs)
        def list(self, *args, **kwargs):
            """
            Lists all the defined size functions and the corresponding parameter values defined.
            """
            return PyMenu(self._service, self._version, self._mode, "/size_functions/list").execute(*args, **kwargs)
        def set_global_controls(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/size_functions/set_global_controls").execute(*args, **kwargs)
        def list_periodicity_filter(self, *args, **kwargs):
            """
            List periodic in size field.
            """
            return PyMenu(self._service, self._version, self._mode, "/size_functions/list_periodicity_filter").execute(*args, **kwargs)
        ...
        class controls(TUIMenu):
            ...
            def curvature_method(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/size_functions/controls/curvature_method").execute(*args, **kwargs)
            def meshed_sf_behavior(self, *args, **kwargs):
                """
                Set meshed size function processing to hard.
                """
                return PyMenu(self._service, self._version, self._mode, "/size_functions/controls/meshed_sf_behavior").execute(*args, **kwargs)
        ...
        class contours(TUIMenu):
            ...
            def draw(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/size_functions/contours/draw").execute(*args, **kwargs)
            ...
            class set(TUIMenu):
                ...
                def refine_facets(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/size_functions/contours/set/refine_facets").execute(*args, **kwargs)
    ...
    class boundary(TUIMenu):
        ...
        def delete_duplicate_faces(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/delete_duplicate_faces").execute(*args, **kwargs)
        def wrapper(self, *args, **kwargs):
            """
            Enters the surface wrapper menu.  This menu is no longer supported, and will be removed in a future release.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/wrapper").execute(*args, **kwargs)
        def create_revolved_surface(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/create_revolved_surface").execute(*args, **kwargs)
        def delete_island_faces(self, *args, **kwargs):
            """
            Enables you to delete faces in a non-contiguous region of a face zone.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/delete_island_faces").execute(*args, **kwargs)
        def create_swept_surface(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/create_swept_surface").execute(*args, **kwargs)
        def make_periodic(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/make_periodic").execute(*args, **kwargs)
        def auto_slit_faces(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/auto_slit_faces").execute(*args, **kwargs)
        def face_skewness(self, *args, **kwargs):
            """
            Lists the worst face skewness.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/face_skewness").execute(*args, **kwargs)
        def mark_faces_in_region(self, *args, **kwargs):
            """
            Marks the faces that are contained in a specified local refinement region.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/mark_faces_in_region").execute(*args, **kwargs)
        def mark_face_proximity(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/mark_face_proximity").execute(*args, **kwargs)
        def delete_unconnected_faces(self, *args, **kwargs):
            """
            Enables you to delete the unconnected face-zones.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/delete_unconnected_faces").execute(*args, **kwargs)
        def clear_marked_nodes(self, *args, **kwargs):
            """
            Clears nodes that were marked using the mark-duplicate-nodes command.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/clear_marked_nodes").execute(*args, **kwargs)
        def count_unused_nodes(self, *args, **kwargs):
            """
            Lists the number of boundary nodes that are not used by any cell.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/count_unused_nodes").execute(*args, **kwargs)
        def create_plane_surface(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/create_plane_surface").execute(*args, **kwargs)
        def create_cylinder(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/create_cylinder").execute(*args, **kwargs)
        def project_face_zone(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/project_face_zone").execute(*args, **kwargs)
        def coarsen_boundary_faces(self, *args, **kwargs):
            """
            Coarsen boundary face zones.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/coarsen_boundary_faces").execute(*args, **kwargs)
        def check_duplicate_geom(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/check_duplicate_geom").execute(*args, **kwargs)
        def mark_bad_quality_faces(self, *args, **kwargs):
            """
            Mark Bad Quality Faces.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/mark_bad_quality_faces").execute(*args, **kwargs)
        def check_boundary_mesh(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/check_boundary_mesh").execute(*args, **kwargs)
        def jiggle_boundary_nodes(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/jiggle_boundary_nodes").execute(*args, **kwargs)
        def unmark_selected_faces(self, *args, **kwargs):
            """
            Unmarks the marked selected faces.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/unmark_selected_faces").execute(*args, **kwargs)
        def mark_duplicate_nodes(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/mark_duplicate_nodes").execute(*args, **kwargs)
        def count_unused_bound_node(self, *args, **kwargs):
            """
            Counts the unused boundary nodes in the domain.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/count_unused_bound_node").execute(*args, **kwargs)
        def create_bounding_box(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/create_bounding_box").execute(*args, **kwargs)
        def improve_surface_mesh(self, *args, **kwargs):
            """
            Improve surface mesh by swapping face edges
            where Delaunay violations occur.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/improve_surface_mesh").execute(*args, **kwargs)
        def reset_element_type(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/reset_element_type").execute(*args, **kwargs)
        def expand_marked_faces_by_rings(self, *args, **kwargs):
            """
            Mark rings of faces around marked faces.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/expand_marked_faces_by_rings").execute(*args, **kwargs)
        def count_free_nodes(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/count_free_nodes").execute(*args, **kwargs)
        def face_distribution(self, *args, **kwargs):
            """
            Reports the distribution of face quality in the text window.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/face_distribution").execute(*args, **kwargs)
        def delete_all_dup_faces(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/delete_all_dup_faces").execute(*args, **kwargs)
        def delete_unused_nodes(self, *args, **kwargs):
            """
            Deletes the boundary nodes that are not used by any boundary faces.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/delete_unused_nodes").execute(*args, **kwargs)
        def recover_periodic_surfaces(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/recover_periodic_surfaces").execute(*args, **kwargs)
        def count_marked_faces(self, *args, **kwargs):
            """
            Reports the number of marked faces.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/count_marked_faces").execute(*args, **kwargs)
        def clear_marked_faces(self, *args, **kwargs):
            """
            Clears marked faces.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/clear_marked_faces").execute(*args, **kwargs)
        def fix_mconnected_edges(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/fix_mconnected_edges").execute(*args, **kwargs)
        def merge_nodes(self, *args, **kwargs):
            """
            Merges duplicate nodes.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/merge_nodes").execute(*args, **kwargs)
        def orient_faces_by_point(self, *args, **kwargs):
            """
            Orients the normals based on the specified material point.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/orient_faces_by_point").execute(*args, **kwargs)
        def slit_boundary_face(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/slit_boundary_face").execute(*args, **kwargs)
        def set_periodicity(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/set_periodicity").execute(*args, **kwargs)
        def compute_bounding_box(self, *args, **kwargs):
            """
            Computes the bounding box for the zones specified.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/compute_bounding_box").execute(*args, **kwargs)
        def edge_limits(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/edge_limits").execute(*args, **kwargs)
        def print_info(self, *args, **kwargs):
            """
            Prints information about the grid in the text window.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/print_info").execute(*args, **kwargs)
        def delete_free_edge_faces(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/delete_free_edge_faces").execute(*args, **kwargs)
        def scale_nodes(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/scale_nodes").execute(*args, **kwargs)
        def mark_face_intersection(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/mark_face_intersection").execute(*args, **kwargs)
        def smooth_marked_faces(self, *args, **kwargs):
            """
            Smooths the marked faces.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/smooth_marked_faces").execute(*args, **kwargs)
        def unmark_faces_in_zones(self, *args, **kwargs):
            """
            Unmark faces in zones.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/unmark_faces_in_zones").execute(*args, **kwargs)
        def resolve_face_intersection(self, *args, **kwargs):
            """
            Resolves self intersection on manifold surface meshes.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/resolve_face_intersection").execute(*args, **kwargs)
        def merge_small_face_zones(self, *args, **kwargs):
            """
            Merges the face zones having area less than the minimum area.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/merge_small_face_zones").execute(*args, **kwargs)
        def count_unused_faces(self, *args, **kwargs):
            """
            Lists the number of boundary faces that are not used by any cell.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/count_unused_faces").execute(*args, **kwargs)
        def delete_unused_faces(self, *args, **kwargs):
            """
            Deletes all the boundary faces that are not used by any cell.
            """
            return PyMenu(self._service, self._version, self._mode, "/boundary/delete_unused_faces").execute(*args, **kwargs)
        ...
        class improve(TUIMenu):
            ...
            def improve(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/improve/improve").execute(*args, **kwargs)
            def swap(self, *args, **kwargs):
                """
                Enables you to improve the boundary surface using edge swapping.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/improve/swap").execute(*args, **kwargs)
            def degree_swap(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/improve/degree_swap").execute(*args, **kwargs)
            def collapse_bad_faces(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/improve/collapse_bad_faces").execute(*args, **kwargs)
            def smooth(self, *args, **kwargs):
                """
                Enables you to improve the boundary surface using smoothing.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/improve/smooth").execute(*args, **kwargs)
        ...
        class remesh(TUIMenu):
            ...
            def coarsen_and_refine(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/coarsen_and_refine").execute(*args, **kwargs)
            def remesh_overlapping_zones(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/remesh_overlapping_zones").execute(*args, **kwargs)
            def stitch_all_face_zones(self, *args, **kwargs):
                ...
                no.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/stitch_all_face_zones").execute(*args, **kwargs)
            def remesh_marked_faces(self, *args, **kwargs):
                """
                Locally remesh marked faces.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/remesh_marked_faces").execute(*args, **kwargs)
            def insert_edge_zone(self, *args, **kwargs):
                """
                Inserts an edge zone into a triangulated boundary face zone.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/insert_edge_zone").execute(*args, **kwargs)
            def remesh_constant_size(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/remesh_constant_size").execute(*args, **kwargs)
            def remesh_face_zone(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/remesh_face_zone").execute(*args, **kwargs)
            def join_face_zones(self, *args, **kwargs):
                ...
                no.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/join_face_zones").execute(*args, **kwargs)
            def mark_stitch_faces(self, *args, **kwargs):
                """
                Highlights the triangles in the neighborhood of the stitch edge loop.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/mark_stitch_faces").execute(*args, **kwargs)
            def triangulate(self, *args, **kwargs):
                """
                Triangulates quad zones.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/triangulate").execute(*args, **kwargs)
            def create_join_loop(self, *args, **kwargs):
                """
                Creates edge loop on boundary of the region of overlap of two surfaces.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/create_join_loop").execute(*args, **kwargs)
            def faceted_stitch_zones(self, *args, **kwargs):
                """
                Performs the faceted stitching of zones.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/faceted_stitch_zones").execute(*args, **kwargs)
            def create_edge_loops(self, *args, **kwargs):
                """
                Creates edge loops for a specified face zone, based on feature angle.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/create_edge_loops").execute(*args, **kwargs)
            def mark_join_faces(self, *args, **kwargs):
                """
                Highlights the triangles in the neighborhood of the join edge loop.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/mark_join_faces").execute(*args, **kwargs)
            def stitch_face_zones(self, *args, **kwargs):
                ...
                no.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/stitch_face_zones").execute(*args, **kwargs)
            def intersect_face_zones(self, *args, **kwargs):
                ...
                no.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/intersect_face_zones").execute(*args, **kwargs)
            def create_intersect_loop(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/create_intersect_loop").execute(*args, **kwargs)
            def mark_intersecting_faces(self, *args, **kwargs):
                """
                Highlights the triangles in the neighborhood of the line of intersection.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/mark_intersecting_faces").execute(*args, **kwargs)
            def clear_marked_faces(self, *args, **kwargs):
                """
                Clears the highlighting of the triangles that are marked.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/clear_marked_faces").execute(*args, **kwargs)
            def intersect_all_face_zones(self, *args, **kwargs):
                ...
                no.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/intersect_all_face_zones").execute(*args, **kwargs)
            def create_stitch_loop(self, *args, **kwargs):
                """
                Creates edge loops for connecting two surfaces along their free edges.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/create_stitch_loop").execute(*args, **kwargs)
            def remesh_face_zones_conformally(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/remesh_face_zones_conformally").execute(*args, **kwargs)
            def delete_overlapped_edges(self, *args, **kwargs):
                """
                Deletes edges that overlap selected edge loops.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/delete_overlapped_edges").execute(*args, **kwargs)
            def create_all_intrst_loops(self, *args, **kwargs):
                """
                Creates edge loop of intersection for all boundary zones in current domain.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/create_all_intrst_loops").execute(*args, **kwargs)
            def stitch_with_preserve_boundary(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/stitch_with_preserve_boundary").execute(*args, **kwargs)
            def join_all_face_zones(self, *args, **kwargs):
                ...
                no.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/join_all_face_zones").execute(*args, **kwargs)
            ...
            class size_functions(TUIMenu):
                ...
                def list_periodicity_filter(self, *args, **kwargs):
                    ...
                    List periodic in size field.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/size_functions/list_periodicity_filter").execute(*args, **kwargs)
                def delete_all(self, *args, **kwargs):
                    """
                    Deletes all the defined size functions.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/size_functions/delete_all").execute(*args, **kwargs)
                def create(self, *args, **kwargs):
                    """
                    Defines the size function based on the specified parameters.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/size_functions/create").execute(*args, **kwargs)
                def create_defaults(self, *args, **kwargs):
                    """
                    Creates default size functions based on face and edge curvature and proximity.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/size_functions/create_defaults").execute(*args, **kwargs)
                def set_scaling_filter(self, *args, **kwargs):
                    """
                    Specifies the scale factor, and minimum and maximum size values to filter the size output from the size field.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/size_functions/set_scaling_filter").execute(*args, **kwargs)
                def set_prox_gap_tolerance(self, *args, **kwargs):
                    """
                    Sets the tolerance relative to minimum size to take gaps into account. Gaps whose thickness is less than the global minimum size multiplied by this factor will not be regarded as a proximity gap.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/size_functions/set_prox_gap_tolerance").execute(*args, **kwargs)
                def disable_periodicity_filter(self, *args, **kwargs):
                    """
                    Removes periodicity from the size field.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/size_functions/disable_periodicity_filter").execute(*args, **kwargs)
                def triangulate_quad_faces(self, *args, **kwargs):
                    """
                    Identifies the zones comprising non-triangular elements and uses a triangulated copy of these zones for computing the size functions.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/size_functions/triangulate_quad_faces").execute(*args, **kwargs)
                def delete(self, *args, **kwargs):
                    """
                    Deletes the specified size function or the current size field.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/size_functions/delete").execute(*args, **kwargs)
                def compute(self, *args, **kwargs):
                    """
                    Computes the size field based on the defined parameters.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/size_functions/compute").execute(*args, **kwargs)
                def set_global_controls(self, *args, **kwargs):
                    """
                    Sets the values for the global minimum and maximum size, and the growth rate.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/size_functions/set_global_controls").execute(*args, **kwargs)
                def reset_global_controls(self, *args, **kwargs):
                    """
                    Resets the global controls to their default values.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/size_functions/reset_global_controls").execute(*args, **kwargs)
                def enable_periodicity_filter(self, *args, **kwargs):
                    """
                    Enable size field periodicity.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/size_functions/enable_periodicity_filter").execute(*args, **kwargs)
                def list(self, *args, **kwargs):
                    """
                    Lists all the defined size functions and the parameter values defined.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/size_functions/list").execute(*args, **kwargs)
                def use_cad_imported_curvature(self, *args, **kwargs):
                    """
                    Enables/disables curvature data from the nodes of the CAD facets.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/size_functions/use_cad_imported_curvature").execute(*args, **kwargs)
                ...
                class contours(TUIMenu):
                    ...
                    def draw(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/size_functions/contours/draw").execute(*args, **kwargs)
                    ...
                    class set(TUIMenu):
                        ...
                        def refine_facets(self, *args, **kwargs):
                            ...
                            """
                            return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/size_functions/contours/set/refine_facets").execute(*args, **kwargs)
                ...
                class controls(TUIMenu):
                    ...
                    def curvature_method(self, *args, **kwargs):
                        ...
                        Option to get facet curvature.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/size_functions/controls/curvature_method").execute(*args, **kwargs)
                    def meshed_sf_behavior(self, *args, **kwargs):
                        """
                        Set meshed size function processing to hard.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/size_functions/controls/meshed_sf_behavior").execute(*args, **kwargs)
            ...
            class controls(TUIMenu):
                ...
                def quadratic_recon(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/controls/quadratic_recon").execute(*args, **kwargs)
                def remesh_method(self, *args, **kwargs):
                    """
                    Specifies the method to be used for the node distribution on the edge loop.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/controls/remesh_method").execute(*args, **kwargs)
                def spacing(self, *args, **kwargs):
                    """
                    Sets the node spacing for the edge loop.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/controls/spacing").execute(*args, **kwargs)
                def tolerance(self, *args, **kwargs):
                    """
                    Sets the tolerance for determining if two edges intersect.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/controls/tolerance").execute(*args, **kwargs)
                def direction(self, *args, **kwargs):
                    """
                    Specifies the direction of the edge loop projection.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/controls/direction").execute(*args, **kwargs)
                def project_method(self, *args, **kwargs):
                    """
                    Specifies the method for projecting edge loops.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/controls/project_method").execute(*args, **kwargs)
                def delete_overlapped(self, *args, **kwargs):
                    """
                    Toggles the deletion of region of overlap of the two surfaces.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/controls/delete_overlapped").execute(*args, **kwargs)
                def proximity_local_search(self, *args, **kwargs):
                    """
                    Includes the selected face for proximity calculation.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/controls/proximity_local_search").execute(*args, **kwargs)
                ...
                class intersect(TUIMenu):
                    ...
                    def separate(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/controls/intersect/separate").execute(*args, **kwargs)
                    def within_tolerance(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/controls/intersect/within_tolerance").execute(*args, **kwargs)
                    def feature_angle(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/controls/intersect/feature_angle").execute(*args, **kwargs)
                    def tolerance(self, *args, **kwargs):
                        """
                        Specifies the tolerance value for the intersect operations.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/controls/intersect/tolerance").execute(*args, **kwargs)
                    def absolute_tolerance(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/controls/intersect/absolute_tolerance").execute(*args, **kwargs)
                    def join_project_angle(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/controls/intersect/join_project_angle").execute(*args, **kwargs)
                    def retri_improve(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/controls/intersect/retri_improve").execute(*args, **kwargs)
                    def delete_overlap(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/controls/intersect/delete_overlap").execute(*args, **kwargs)
                    def remesh_post_intersection(self, *args, **kwargs):
                        """
                        Used to enable or disable automatic post-remesh operation after any connect operation (join, intersect, or stitch).
                        """
                        return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/controls/intersect/remesh_post_intersection").execute(*args, **kwargs)
                    def stitch_preserve(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/controls/intersect/stitch_preserve").execute(*args, **kwargs)
                    def join_match_angle(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/controls/intersect/join_match_angle").execute(*args, **kwargs)
                    def refine_region(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/controls/intersect/refine_region").execute(*args, **kwargs)
                    def ignore_parallel_faces(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/boundary/remesh/controls/intersect/ignore_parallel_faces").execute(*args, **kwargs)
        ...
        class shell_boundary_layer(TUIMenu):
            ...
            def create(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/shell_boundary_layer/create").execute(*args, **kwargs)
            ...
            class controls(TUIMenu):
                ...
                class zone_specific_growth(TUIMenu):
                    ...
                    def apply_growth(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/boundary/shell_boundary_layer/controls/zone_specific_growth/apply_growth").execute(*args, **kwargs)
                    def clear_growth(self, *args, **kwargs):
                        """
                        Clear shell boundary layer specific growth on individual edge zones.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/boundary/shell_boundary_layer/controls/zone_specific_growth/clear_growth").execute(*args, **kwargs)
        ...
        class refine(TUIMenu):
            ...
            def refine(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/refine/refine").execute(*args, **kwargs)
            def count(self, *args, **kwargs):
                """
                Counts the number of faces marked on each boundary zone.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/refine/count").execute(*args, **kwargs)
            def limits(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/refine/limits").execute(*args, **kwargs)
            def auto_refine(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/refine/auto_refine").execute(*args, **kwargs)
            def clear(self, *args, **kwargs):
                """
                Clears all refinement marks from all boundary faces.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/refine/clear").execute(*args, **kwargs)
            def mark(self, *args, **kwargs):
                """
                Marks the faces for refinement.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/refine/mark").execute(*args, **kwargs)
            ...
            class local_regions(TUIMenu):
                ...
                def define(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/refine/local_regions/define").execute(*args, **kwargs)
                def init(self, *args, **kwargs):
                    """
                    Creates a region encompassing the entire geometry.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/refine/local_regions/init").execute(*args, **kwargs)
                def delete(self, *args, **kwargs):
                    """
                    Deletes the specified region.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/refine/local_regions/delete").execute(*args, **kwargs)
                def list_all_regions(self, *args, **kwargs):
                    """
                    Lists all the refinement regions in the console.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/refine/local_regions/list_all_regions").execute(*args, **kwargs)
        ...
        class separate(TUIMenu):
            ...
            def sep_face_zone_by_mark(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/separate/sep_face_zone_by_mark").execute(*args, **kwargs)
            def mark_faces_in_region(self, *args, **kwargs):
                """
                Marks the faces that are contained in a specified local refinement region.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/separate/mark_faces_in_region").execute(*args, **kwargs)
            def sep_face_zone_by_shape(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/separate/sep_face_zone_by_shape").execute(*args, **kwargs)
            def sep_face_zone_by_seed(self, *args, **kwargs):
                """
                Separates a boundary face zone by defining a seed face on the surface.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/separate/sep_face_zone_by_seed").execute(*args, **kwargs)
            def sep_face_zone_by_seed_angle(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/separate/sep_face_zone_by_seed_angle").execute(*args, **kwargs)
            def sep_face_zone_by_region(self, *args, **kwargs):
                """
                Separates a boundary face zone based on contiguous regions.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/separate/sep_face_zone_by_region").execute(*args, **kwargs)
            def sep_face_zone_by_cnbor(self, *args, **kwargs):
                """
                Separates a boundary/interior face zone based on its cell neighbors.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/separate/sep_face_zone_by_cnbor").execute(*args, **kwargs)
            def sep_face_zone_by_angle(self, *args, **kwargs):
                """
                Separates a boundary face zone based on significant angle.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/separate/sep_face_zone_by_angle").execute(*args, **kwargs)
            ...
            class local_regions(TUIMenu):
                ...
                def define(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/separate/local_regions/define").execute(*args, **kwargs)
                def list_all_regions(self, *args, **kwargs):
                    """
                    Lists all the local regions defined.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/separate/local_regions/list_all_regions").execute(*args, **kwargs)
                def init(self, *args, **kwargs):
                    """
                    Creates a region encompassing the entire geometry.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/separate/local_regions/init").execute(*args, **kwargs)
                def delete(self, *args, **kwargs):
                    """
                    Deletes the specified local region.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/separate/local_regions/delete").execute(*args, **kwargs)
        ...
        class manage(TUIMenu):
            ...
            def create(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/manage/create").execute(*args, **kwargs)
            def scale(self, *args, **kwargs):
                """
                Scales all nodes of the specified face zone(s).
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/manage/scale").execute(*args, **kwargs)
            def type(self, *args, **kwargs):
                """
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/manage/type").execute(*args, **kwargs)
            def copy(self, *args, **kwargs):
                """
                Copies all nodes and faces of the specified face zone(s).
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/manage/copy").execute(*args, **kwargs)
            def auto_delete_nodes(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/manage/auto_delete_nodes").execute(*args, **kwargs)
            def scale_model(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/manage/scale_model").execute(*args, **kwargs)
            def remove_suffix(self, *args, **kwargs):
                """
                Removes the suffix (characters including and after the leftmost ":") in the face zone names.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/manage/remove_suffix").execute(*args, **kwargs)
            def translate_model(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/manage/translate_model").execute(*args, **kwargs)
            def delete(self, *args, **kwargs):
                """
                Deletes the face zone.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/manage/delete").execute(*args, **kwargs)
            def name(self, *args, **kwargs):
                """
                Gives a face zone a new name.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/manage/name").execute(*args, **kwargs)
            def flip(self, *args, **kwargs):
                """
                Reverses the normal direction of the specified boundary zone(s).
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/manage/flip").execute(*args, **kwargs)
            def list(self, *args, **kwargs):
                """
                Prints information about all boundary zones.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/manage/list").execute(*args, **kwargs)
            def merge(self, *args, **kwargs):
                """
                Merges face zones.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/manage/merge").execute(*args, **kwargs)
            def translate(self, *args, **kwargs):
                """
                Translates all nodes of the specified face zone(s).
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/manage/translate").execute(*args, **kwargs)
            def change_prefix(self, *args, **kwargs):
                """
                Enables you to change the prefix for the specified face zones.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/manage/change_prefix").execute(*args, **kwargs)
            def rotate_model(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/manage/rotate_model").execute(*args, **kwargs)
            def rotate(self, *args, **kwargs):
                """
                Rotates all nodes of the specified face zone(s).
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/manage/rotate").execute(*args, **kwargs)
            def orient(self, *args, **kwargs):
                """
                Consistently orients the faces in the specified zones.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/manage/orient").execute(*args, **kwargs)
            def id(self, *args, **kwargs):
                """
                Specifies a new boundary zone ID. If there is a conflict, the change will be ignored.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/manage/id").execute(*args, **kwargs)
            def origin(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/manage/origin").execute(*args, **kwargs)
            def change_suffix(self, *args, **kwargs):
                """
                Change the suffix for specified face zones.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/manage/change_suffix").execute(*args, **kwargs)
            ...
            class user_defined_groups(TUIMenu):
                ...
                def list(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/manage/user_defined_groups/list").execute(*args, **kwargs)
                def update(self, *args, **kwargs):
                    """
                    Enables you to modify an existing group.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/manage/user_defined_groups/update").execute(*args, **kwargs)
                def delete(self, *args, **kwargs):
                    """
                    Deletes the specified user-defined group.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/manage/user_defined_groups/delete").execute(*args, **kwargs)
                def activate(self, *args, **kwargs):
                    """
                    Activates the specified user-defined groups.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/manage/user_defined_groups/activate").execute(*args, **kwargs)
                def create(self, *args, **kwargs):
                    """
                    Creates the user-defined group comprising the specified zones.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/boundary/manage/user_defined_groups/create").execute(*args, **kwargs)
        ...
        class boundary_conditions(TUIMenu):
            ...
            def clear(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/boundary_conditions/clear").execute(*args, **kwargs)
            def copy(self, *args, **kwargs):
                """
                Enables you to copy the boundary conditions from the face zone selected to the face zones specified.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/boundary_conditions/copy").execute(*args, **kwargs)
            def clear_all(self, *args, **kwargs):
                """
                Clears the boundary conditions assigned to all the face zones.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/boundary_conditions/clear_all").execute(*args, **kwargs)
        ...
        class feature(TUIMenu):
            ...
            def create_edge_zones(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/feature/create_edge_zones").execute(*args, **kwargs)
            def orient_edge_direction(self, *args, **kwargs):
                """
                Orients the edges on the loop to point in the same direction.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/feature/orient_edge_direction").execute(*args, **kwargs)
            def intersect_edge_zones(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/feature/intersect_edge_zones").execute(*args, **kwargs)
            def group(self, *args, **kwargs):
                """
                Associates the specified edge zone(s) with the specified face zone.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/feature/group").execute(*args, **kwargs)
            def remesh_edge_zones(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/feature/remesh_edge_zones").execute(*args, **kwargs)
            def delete_degenerated_edges(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/feature/delete_degenerated_edges").execute(*args, **kwargs)
            def separate_edge_zones_by_seed(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/feature/separate_edge_zones_by_seed").execute(*args, **kwargs)
            def delete_edge_zones(self, *args, **kwargs):
                """
                Deletes the specified edge zone(s).
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/feature/delete_edge_zones").execute(*args, **kwargs)
            def merge_edge_zones(self, *args, **kwargs):
                """
                Merges multiple edge loops of the same type into a single loop.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/feature/merge_edge_zones").execute(*args, **kwargs)
            def separate_delete_small_edges(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/feature/separate_delete_small_edges").execute(*args, **kwargs)
            def copy_edge_zones(self, *args, **kwargs):
                """
                Copies the specified edge zone(s) to new edge zone(s).
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/feature/copy_edge_zones").execute(*args, **kwargs)
            def separate_edge_zones(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/feature/separate_edge_zones").execute(*args, **kwargs)
            def ungroup(self, *args, **kwargs):
                """
                Ungroups previously grouped edge zones.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/feature/ungroup").execute(*args, **kwargs)
            def toggle_edge_type(self, *args, **kwargs):
                """
                Toggles the edge type between boundary and interior.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/feature/toggle_edge_type").execute(*args, **kwargs)
            def project_edge_zones(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/feature/project_edge_zones").execute(*args, **kwargs)
            def reverse_edge_direction(self, *args, **kwargs):
                """
                Reverses the direction of the edge loop.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/feature/reverse_edge_direction").execute(*args, **kwargs)
            def edge_size_limits(self, *args, **kwargs):
                """
                Reports the minimum, maximum, and average edge length for the specified edge zone(s) in the console.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/feature/edge_size_limits").execute(*args, **kwargs)
            def list_edge_zones(self, *args, **kwargs):
                """
                Lists the name, ID, type, and count for the specified edge zone(s).
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/feature/list_edge_zones").execute(*args, **kwargs)
        ...
        class modify(TUIMenu):
            ...
            def hole_feature_angle(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/hole_feature_angle").execute(*args, **kwargs)
            def swap(self, *args, **kwargs):
                """
                Swaps boundary edges (of triangular faces) if the selection list contains edges.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/swap").execute(*args, **kwargs)
            def local_remesh(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/local_remesh").execute(*args, **kwargs)
            def merge(self, *args, **kwargs):
                """
                Merges pairs of nodes. The first node selected is retained, and the second is the duplicate that is merged.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/merge").execute(*args, **kwargs)
            def select_zone(self, *args, **kwargs):
                """
                Adds a zone to the selection list by entering the zone name or ID.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/select_zone").execute(*args, **kwargs)
            def delete(self, *args, **kwargs):
                """
                Deletes all selected faces and nodes.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/delete").execute(*args, **kwargs)
            def split_face(self, *args, **kwargs):
                """
                Splits two selected faces into four faces.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/split_face").execute(*args, **kwargs)
            def create(self, *args, **kwargs):
                """
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/create").execute(*args, **kwargs)
            def rezone(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/rezone").execute(*args, **kwargs)
            def move(self, *args, **kwargs):
                """
                Moves the selected node to the selected position if the selection list contains a node and a position.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/move").execute(*args, **kwargs)
            def mark_skew_face(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/mark_skew_face").execute(*args, **kwargs)
            def create_mid_node(self, *args, **kwargs):
                """
                Creates a node at the midpoint between two selected nodes.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/create_mid_node").execute(*args, **kwargs)
            def select_probe(self, *args, **kwargs):
                """
                Selects the probe function. The possible functions are:.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/select_probe").execute(*args, **kwargs)
            def next_skew(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/next_skew").execute(*args, **kwargs)
            def skew(self, *args, **kwargs):
                """
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/skew").execute(*args, **kwargs)
            def deselect_last(self, *args, **kwargs):
                """
                Removes the last selection from the selection list.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/deselect_last").execute(*args, **kwargs)
            def smooth(self, *args, **kwargs):
                """
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/smooth").execute(*args, **kwargs)
            def select_filter(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/select_filter").execute(*args, **kwargs)
            def collapse(self, *args, **kwargs):
                """
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/collapse").execute(*args, **kwargs)
            def select_entity(self, *args, **kwargs):
                """
                Adds a cell, face, or node to the selection list by entering the name of the entity.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/select_entity").execute(*args, **kwargs)
            def clear_selections(self, *args, **kwargs):
                """
                Clears all selections.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/clear_selections").execute(*args, **kwargs)
            def patch_options(self, *args, **kwargs):
                """
                Settings for Patching zone(s) by filling holes.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/patch_options").execute(*args, **kwargs)
            def show_filter(self, *args, **kwargs):
                """
                Shows the current filter.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/show_filter").execute(*args, **kwargs)
            def clear_skew_faces(self, *args, **kwargs):
                """
                Clears faces that were marked using the mark-skew-face command.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/clear_skew_faces").execute(*args, **kwargs)
            def select_position(self, *args, **kwargs):
                """
                Adds a position to the selection list by entering the coordinates of the position.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/select_position").execute(*args, **kwargs)
            def analyze_bnd_connectvty(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/analyze_bnd_connectvty").execute(*args, **kwargs)
            def auto_patch_holes(self, *args, **kwargs):
                """
                Patch zone(s) by filling holes.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/auto_patch_holes").execute(*args, **kwargs)
            def show_probe(self, *args, **kwargs):
                """
                Shows the current probe function.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/show_probe").execute(*args, **kwargs)
            def delta_move(self, *args, **kwargs):
                """
                Moves the selected node by specified magnitude.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/delta_move").execute(*args, **kwargs)
            def undo(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/undo").execute(*args, **kwargs)
            def select_visible_entities(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/select_visible_entities").execute(*args, **kwargs)
            def list_selections(self, *args, **kwargs):
                """
                Lists all of the selected objects.
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/list_selections").execute(*args, **kwargs)
            def skew_report_zone(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/boundary/modify/skew_report_zone").execute(*args, **kwargs)
    ...
    class mesh(TUIMenu):
        ...
        def cutcell(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/mesh/cutcell").execute(*args, **kwargs)
        def auto_mesh(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/mesh/auto_mesh").execute(*args, **kwargs)
        def zone_names_clean_up(self, *args, **kwargs):
            """
            S.
            """
            return PyMenu(self._service, self._version, self._mode, "/mesh/zone_names_clean_up").execute(*args, **kwargs)
        def laplace_smooth_nodes(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/mesh/laplace_smooth_nodes").execute(*args, **kwargs)
        def repair_face_handedness(self, *args, **kwargs):
            """
            Reverses face node orientation.
            """
            return PyMenu(self._service, self._version, self._mode, "/mesh/repair_face_handedness").execute(*args, **kwargs)
        def check_mesh(self, *args, **kwargs):
            """
            Checks the mesh for topological errors.
            """
            return PyMenu(self._service, self._version, self._mode, "/mesh/check_mesh").execute(*args, **kwargs)
        def prepare_for_solve(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/mesh/prepare_for_solve").execute(*args, **kwargs)
        def create_frustrum(self, *args, **kwargs):
            """
            Create a cylindrical hex mesh.
            """
            return PyMenu(self._service, self._version, self._mode, "/mesh/create_frustrum").execute(*args, **kwargs)
        def auto_mesh_multiple_objects(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/mesh/auto_mesh_multiple_objects").execute(*args, **kwargs)
        def clear_mesh(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/mesh/clear_mesh").execute(*args, **kwargs)
        def deactivate_lean_datastructures(self, *args, **kwargs):
            """
            Deactivates Lean data structures.
            """
            return PyMenu(self._service, self._version, self._mode, "/mesh/deactivate_lean_datastructures").execute(*args, **kwargs)
        def check_quality(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/mesh/check_quality").execute(*args, **kwargs)
        def create_heat_exchanger(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/mesh/create_heat_exchanger").execute(*args, **kwargs)
        def reset_mesh(self, *args, **kwargs):
            """
            Clears the entire mesh.
            """
            return PyMenu(self._service, self._version, self._mode, "/mesh/reset_mesh").execute(*args, **kwargs)
        def activate_lean_datastructures(self, *args, **kwargs):
            """
            Activates Lean data structures to reduce memory.
            """
            return PyMenu(self._service, self._version, self._mode, "/mesh/activate_lean_datastructures").execute(*args, **kwargs)
        def clear_undo_stack(self, *args, **kwargs):
            """
            Clears undo stack.
            """
            return PyMenu(self._service, self._version, self._mode, "/mesh/clear_undo_stack").execute(*args, **kwargs)
        def check_quality_level(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/mesh/check_quality_level").execute(*args, **kwargs)
        def auto_prefix_cell_zones(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/mesh/auto_prefix_cell_zones").execute(*args, **kwargs)
        def list_mesh_parameter(self, *args, **kwargs):
            """
            Shows all mesh parameters.
            """
            return PyMenu(self._service, self._version, self._mode, "/mesh/list_mesh_parameter").execute(*args, **kwargs)
        def selective_mesh_check(self, *args, **kwargs):
            """
            Performs a customized mesh check on specific zones rather than all zones.
            """
            return PyMenu(self._service, self._version, self._mode, "/mesh/selective_mesh_check").execute(*args, **kwargs)
        def reset_mesh_parameter(self, *args, **kwargs):
            """
            Resets all parameters to their default value.
            """
            return PyMenu(self._service, self._version, self._mode, "/mesh/reset_mesh_parameter").execute(*args, **kwargs)
        ...
        class cavity(TUIMenu):
            ...
            def add_zones(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/cavity/add_zones").execute(*args, **kwargs)
            def create_hexcore_cavity_by_scale(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/cavity/create_hexcore_cavity_by_scale").execute(*args, **kwargs)
            def merge_cavity(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/cavity/merge_cavity").execute(*args, **kwargs)
            def create_hexcore_cavity_by_region(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/cavity/create_hexcore_cavity_by_region").execute(*args, **kwargs)
            def remesh_hexcore_cavity(self, *args, **kwargs):
                """
                Remesh a cavity in hexcore mesh.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/cavity/remesh_hexcore_cavity").execute(*args, **kwargs)
            def region(self, *args, **kwargs):
                """
                Enables you to create a cavity to modify the existing volume mesh in the specified region.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/cavity/region").execute(*args, **kwargs)
            def replace_zones(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/cavity/replace_zones").execute(*args, **kwargs)
            def remove_zones(self, *args, **kwargs):
                """
                Enables you to create a cavity for removing zones from the existing volume mesh.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/cavity/remove_zones").execute(*args, **kwargs)
        ...
        class manage(TUIMenu):
            ...
            def id(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/id").execute(*args, **kwargs)
            def list(self, *args, **kwargs):
                """
                Prints information on all cell zones.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/list").execute(*args, **kwargs)
            def rotate_model(self, *args, **kwargs):
                """
                Rotates all nodes of the model by a specified angle.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/rotate_model").execute(*args, **kwargs)
            def name(self, *args, **kwargs):
                """
                Enables you to rename a cell zone.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/name").execute(*args, **kwargs)
            def active_list(self, *args, **kwargs):
                """
                Lists all active zones.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/active_list").execute(*args, **kwargs)
            def origin(self, *args, **kwargs):
                """
                Specifies a new origin for the mesh, to be used for cell zone rotation. The default origin is (0,0,0).
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/origin").execute(*args, **kwargs)
            def change_suffix(self, *args, **kwargs):
                """
                Change the suffix for specified face zones.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/change_suffix").execute(*args, **kwargs)
            def translate_model(self, *args, **kwargs):
                """
                Translates all nodes of the model by a specified vector.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/translate_model").execute(*args, **kwargs)
            def scale_model(self, *args, **kwargs):
                """
                Scales all nodes of the model by a specified factor.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/scale_model").execute(*args, **kwargs)
            def set_active(self, *args, **kwargs):
                """
                Sets the specified cell zones to be active.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/set_active").execute(*args, **kwargs)
            def type(self, *args, **kwargs):
                """
                Changes the type and name of a cell zone.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/type").execute(*args, **kwargs)
            def adjacent_face_zones(self, *args, **kwargs):
                """
                Lists all face zones that refer to the specified cell zone.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/adjacent_face_zones").execute(*args, **kwargs)
            def merge(self, *args, **kwargs):
                """
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/merge").execute(*args, **kwargs)
            def scale(self, *args, **kwargs):
                """
                Scales all nodes of specified cell zones by a specified factor.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/scale").execute(*args, **kwargs)
            def get_material_point(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/get_material_point").execute(*args, **kwargs)
            def revolve_face_zone(self, *args, **kwargs):
                """
                Generates cells by revolving a face thread.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/revolve_face_zone").execute(*args, **kwargs)
            def delete(self, *args, **kwargs):
                """
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/delete").execute(*args, **kwargs)
            def change_prefix(self, *args, **kwargs):
                """
                Enables you to change the prefix for the cell zone.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/change_prefix").execute(*args, **kwargs)
            def rotate(self, *args, **kwargs):
                """
                Rotates all nodes of specified cell zones by a specified angle.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/rotate").execute(*args, **kwargs)
            def merge_dead_zones(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/merge_dead_zones").execute(*args, **kwargs)
            def auto_set_active(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/auto_set_active").execute(*args, **kwargs)
            def copy(self, *args, **kwargs):
                """
                Copies all nodes and faces of specified cell zones.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/copy").execute(*args, **kwargs)
            def translate(self, *args, **kwargs):
                """
                Translates all nodes of specified cell zones by a specified vector.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/manage/translate").execute(*args, **kwargs)
        ...
        class tet(TUIMenu):
            ...
            def init_refine(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/tet/init_refine").execute(*args, **kwargs)
            def preserve_cell_zone(self, *args, **kwargs):
                """
                Allows you to specify the cell zones to be preserved during the meshing process.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/tet/preserve_cell_zone").execute(*args, **kwargs)
            def trace_path_between_cells(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/tet/trace_path_between_cells").execute(*args, **kwargs)
            def init(self, *args, **kwargs):
                """
                Generates the initial Delaunay mesh by meshing the boundary nodes.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/tet/init").execute(*args, **kwargs)
            def un_preserve_cell_zone(self, *args, **kwargs):
                """
                Un-preserve cell zone.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/tet/un_preserve_cell_zone").execute(*args, **kwargs)
            def refine(self, *args, **kwargs):
                """
                Refines the initialized mesh.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/tet/refine").execute(*args, **kwargs)
            def delete_virtual_cells(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/tet/delete_virtual_cells").execute(*args, **kwargs)
            def mesh_object(self, *args, **kwargs):
                """
                Tet mesh object of type mesh.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/tet/mesh_object").execute(*args, **kwargs)
            ...
            class improve(TUIMenu):
                ...
                def sliver_boundary_swap(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/improve/sliver_boundary_swap").execute(*args, **kwargs)
                def smooth_nodes(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/improve/smooth_nodes").execute(*args, **kwargs)
                def smooth_boundary_sliver(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/improve/smooth_boundary_sliver").execute(*args, **kwargs)
                def refine_slivers(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/improve/refine_slivers").execute(*args, **kwargs)
                def refine_boundary_slivers(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/improve/refine_boundary_slivers").execute(*args, **kwargs)
                def skew_smooth_nodes(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/improve/skew_smooth_nodes").execute(*args, **kwargs)
                def smooth_interior_sliver(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/improve/smooth_interior_sliver").execute(*args, **kwargs)
                def improve_cells(self, *args, **kwargs):
                    """
                    Improves skewed tetrahedral cells.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/improve/improve_cells").execute(*args, **kwargs)
                def swap_faces(self, *args, **kwargs):
                    """
                    Performs interior face swapping to improve cell skewness.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/improve/swap_faces").execute(*args, **kwargs)
                def collapse_slivers(self, *args, **kwargs):
                    """
                    Attempts to collapse the nodes of a skewed sliver cell on any one of its neighbors.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/improve/collapse_slivers").execute(*args, **kwargs)
            ...
            class controls(TUIMenu):
                ...
                def refine_method(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/refine_method").execute(*args, **kwargs)
                def non_fluid_type(self, *args, **kwargs):
                    """
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/non_fluid_type").execute(*args, **kwargs)
                def use_max_cell_size(self, *args, **kwargs):
                    """
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/use_max_cell_size").execute(*args, **kwargs)
                def cell_sizing(self, *args, **kwargs):
                    """
                    Specifies the cell sizing function for refinement. You can select geometric, linear, none, or size-field as appropriate.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/cell_sizing").execute(*args, **kwargs)
                def delete_unused_nodes(self, *args, **kwargs):
                    """
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/delete_unused_nodes").execute(*args, **kwargs)
                def set_region_based_sizing(self, *args, **kwargs):
                    """
                    Allows you to specify local sizing settings (max cell length) for specified region(s).
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/set_region_based_sizing").execute(*args, **kwargs)
                def max_cell_length(self, *args, **kwargs):
                    """
                    Specifies the maximum allowable cell length.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/max_cell_length").execute(*args, **kwargs)
                def delete_dead_zones(self, *args, **kwargs):
                    """
                    Specifies the maximum allowable cell volume.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/delete_dead_zones").execute(*args, **kwargs)
                def merge_free_nodes(self, *args, **kwargs):
                    """
                    Automatically merge duplicate nodes?.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/merge_free_nodes").execute(*args, **kwargs)
                def clear_zone_growth_rate(self, *args, **kwargs):
                    """
                    Clear zone specific geometric growth rates.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/clear_zone_growth_rate").execute(*args, **kwargs)
                def compute_max_cell_volume(self, *args, **kwargs):
                    """
                    Computes the maximum cell volume for the current mesh.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/compute_max_cell_volume").execute(*args, **kwargs)
                def print_region_based_sizing(self, *args, **kwargs):
                    """
                    Displays local sizing settings (max cell length) for specified region(s).
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/print_region_based_sizing").execute(*args, **kwargs)
                def max_cell_volume(self, *args, **kwargs):
                    """
                    Specifies the maximum allowable cell volume.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/max_cell_volume").execute(*args, **kwargs)
                def set_zone_growth_rate(self, *args, **kwargs):
                    """
                    Set zone specific geometric growth rates.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/set_zone_growth_rate").execute(*args, **kwargs)
                def skewness_method(self, *args, **kwargs):
                    """
                    Enters the skewness refinement controls menu.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/skewness_method").execute(*args, **kwargs)
                def improve_surface_mesh(self, *args, **kwargs):
                    """
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/improve_surface_mesh").execute(*args, **kwargs)
                ...
                class adv_front_method(TUIMenu):
                    ...
                    def second_improve_params(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/adv_front_method/second_improve_params").execute(*args, **kwargs)
                    def first_improve_params(self, *args, **kwargs):
                        """
                        Defines the refining front improvement parameters for the advancing front method.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/adv_front_method/first_improve_params").execute(*args, **kwargs)
                    def refine_parameters(self, *args, **kwargs):
                        """
                        Defines the cell zone improvement parameters for the advancing front method.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/adv_front_method/refine_parameters").execute(*args, **kwargs)
                    ...
                    class skew_improve(TUIMenu):
                        ...
                        def target_low_skew(self, *args, **kwargs):
                            ...
                            """
                            return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/adv_front_method/skew_improve/target_low_skew").execute(*args, **kwargs)
                        def iterations(self, *args, **kwargs):
                            """
                            Specifies the number of improvement iterations in each attempt for the  advancing front method.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/adv_front_method/skew_improve/iterations").execute(*args, **kwargs)
                        def target(self, *args, **kwargs):
                            """
                            ...
                            """
                            return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/adv_front_method/skew_improve/target").execute(*args, **kwargs)
                        def sliver_skew(self, *args, **kwargs):
                            """
                            ...
                            """
                            return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/adv_front_method/skew_improve/sliver_skew").execute(*args, **kwargs)
                        def attempts(self, *args, **kwargs):
                            """
                            Specifies the number of overall improvement attempts for the advancing front  method.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/adv_front_method/skew_improve/attempts").execute(*args, **kwargs)
                        def target_skew(self, *args, **kwargs):
                            """
                            Specifies the targeted skewness during improvement for the advancing front  method.
                            """
                            return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/adv_front_method/skew_improve/target_skew").execute(*args, **kwargs)
                        def boundary_sliver_skew(self, *args, **kwargs):
                            """
                            ...
                            """
                            return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/adv_front_method/skew_improve/boundary_sliver_skew").execute(*args, **kwargs)
                ...
                class tet_improve(TUIMenu):
                    ...
                    def iterations(self, *args, **kwargs):
                        ...
                        Improve iterations.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/tet_improve/iterations").execute(*args, **kwargs)
                    def attempts(self, *args, **kwargs):
                        """
                        Improve attempts.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/tet_improve/attempts").execute(*args, **kwargs)
                    def angle(self, *args, **kwargs):
                        """
                        Max dihedral angle defining a valid boundary cell.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/tet_improve/angle").execute(*args, **kwargs)
                    def skew(self, *args, **kwargs):
                        """
                        Remove skew.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/tet_improve/skew").execute(*args, **kwargs)
                ...
                class improve_mesh(TUIMenu):
                    ...
                    def swap(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/improve_mesh/swap").execute(*args, **kwargs)
                    def laplace_smooth(self, *args, **kwargs):
                        """
                        Enables you to specify the Laplace smoothing parameters.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/improve_mesh/laplace_smooth").execute(*args, **kwargs)
                    def improve(self, *args, **kwargs):
                        """
                        Automatically improves the mesh.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/improve_mesh/improve").execute(*args, **kwargs)
                    def skewness_smooth(self, *args, **kwargs):
                        """
                        Enables you to specify the skewness smooth parameters.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/improve_mesh/skewness_smooth").execute(*args, **kwargs)
                ...
                class remove_slivers(TUIMenu):
                    ...
                    def angle(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/remove_slivers/angle").execute(*args, **kwargs)
                    def low_skew(self, *args, **kwargs):
                        """
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/remove_slivers/low_skew").execute(*args, **kwargs)
                    def iterations(self, *args, **kwargs):
                        """
                        Specifies the number of iterations to be performed for the specific sliver removal operation.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/remove_slivers/iterations").execute(*args, **kwargs)
                    def method(self, *args, **kwargs):
                        """
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/remove_slivers/method").execute(*args, **kwargs)
                    def skew(self, *args, **kwargs):
                        """
                        Specifies the skewness threshold for sliver removal.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/remove_slivers/skew").execute(*args, **kwargs)
                    def remove(self, *args, **kwargs):
                        """
                        Enables/disables the automatic removal of slivers.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/remove_slivers/remove").execute(*args, **kwargs)
                    def attempts(self, *args, **kwargs):
                        """
                        Specifies the number of attempts overall to remove slivers.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/remove_slivers/attempts").execute(*args, **kwargs)
                ...
                class advanced(TUIMenu):
                    ...
                    def progress_reports(self, *args, **kwargs):
                        ...
                        Set time between progress reports in seconds.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/advanced/progress_reports").execute(*args, **kwargs)
                    def keep_virtual_entities(self, *args, **kwargs):
                        """
                        Toggle deletion of virtual entities after intialization.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/advanced/keep_virtual_entities").execute(*args, **kwargs)
                    def report_unmeshed_faces(self, *args, **kwargs):
                        """
                        Report unmeshed faces.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/advanced/report_unmeshed_faces").execute(*args, **kwargs)
                    def max_cells(self, *args, **kwargs):
                        """
                        Set maximum number of cells in mesh.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/advanced/max_cells").execute(*args, **kwargs)
                    def node_tolerance(self, *args, **kwargs):
                        """
                        Set node-tolerance.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/advanced/node_tolerance").execute(*args, **kwargs)
                    def defaults(self, *args, **kwargs):
                        """
                        Calculate defaults.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/advanced/defaults").execute(*args, **kwargs)
                    def sliver_size(self, *args, **kwargs):
                        """
                        Set sliver-size.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/advanced/sliver_size").execute(*args, **kwargs)
                    def max_nodes(self, *args, **kwargs):
                        """
                        Set maximum number of nodes in mesh.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/advanced/max_nodes").execute(*args, **kwargs)
                    def report_max_unmeshed(self, *args, **kwargs):
                        """
                        Max number of unmeshed entities reported.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/advanced/report_max_unmeshed").execute(*args, **kwargs)
                    def freeze_boundary_cells(self, *args, **kwargs):
                        """
                        Freeze boundary cells .
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/advanced/freeze_boundary_cells").execute(*args, **kwargs)
                    def report_unmeshed_nodes(self, *args, **kwargs):
                        """
                        Report unmeshed nodes.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/tet/controls/advanced/report_unmeshed_nodes").execute(*args, **kwargs)
            ...
            class local_regions(TUIMenu):
                ...
                def deactivate(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/local_regions/deactivate").execute(*args, **kwargs)
                def init(self, *args, **kwargs):
                    """
                    Defines the default refinement region encompassing the entire geometry.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/local_regions/init").execute(*args, **kwargs)
                def delete(self, *args, **kwargs):
                    """
                    Deletes the specified refinement region.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/local_regions/delete").execute(*args, **kwargs)
                def ideal_area(self, *args, **kwargs):
                    """
                    Ideal triangle area for given edge length.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/local_regions/ideal_area").execute(*args, **kwargs)
                def refine(self, *args, **kwargs):
                    """
                    Refines the active cells inside the selected region based on the specified refinement parameters.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/local_regions/refine").execute(*args, **kwargs)
                def activate(self, *args, **kwargs):
                    """
                    Activates the specified regions for refinement.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/local_regions/activate").execute(*args, **kwargs)
                def ideal_vol(self, *args, **kwargs):
                    """
                    Reports the volume of an ideal tetrahedron for the edge length specified.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/local_regions/ideal_vol").execute(*args, **kwargs)
                def define(self, *args, **kwargs):
                    """
                    Defines the refinement region according to the specified parameters.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/local_regions/define").execute(*args, **kwargs)
                def list_all_regions(self, *args, **kwargs):
                    """
                    Lists all refinement region parameters and the activated regions in the console.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/tet/local_regions/list_all_regions").execute(*args, **kwargs)
        ...
        class domains(TUIMenu):
            ...
            def activate(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/domains/activate").execute(*args, **kwargs)
            def create(self, *args, **kwargs):
                """
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/domains/create").execute(*args, **kwargs)
            def print(self, *args, **kwargs):
                """
                Prints the information for the specified domain.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/domains/print").execute(*args, **kwargs)
            def draw(self, *args, **kwargs):
                """
                Displays the boundary face zones of the specified domain.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/domains/draw").execute(*args, **kwargs)
            def delete(self, *args, **kwargs):
                """
                Deletes the specified domain.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/domains/delete").execute(*args, **kwargs)
            def create_by_point(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/domains/create_by_point").execute(*args, **kwargs)
            def create_by_cell_zone(self, *args, **kwargs):
                """
                Creates a new domain based on the specified cell zone.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/domains/create_by_cell_zone").execute(*args, **kwargs)
        ...
        class separate(TUIMenu):
            ...
            def separate_prisms_from_hex(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/separate/separate_prisms_from_hex").execute(*args, **kwargs)
            def separate_cell_by_shape(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/separate/separate_cell_by_shape").execute(*args, **kwargs)
            def separate_cell_by_size(self, *args, **kwargs):
                """
                Separates cells based on the specified minimum and maximum cell sizes.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/separate/separate_cell_by_size").execute(*args, **kwargs)
            def separate_cell_by_face(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/separate/separate_cell_by_face").execute(*args, **kwargs)
            def separate_wedge_prisms(self, *args, **kwargs):
                """
                Separate wedge-prism cells from bulk.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/separate/separate_wedge_prisms").execute(*args, **kwargs)
            def separate_cell_by_mark(self, *args, **kwargs):
                """
                Separates cells within a specified local region into another cell zone.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/separate/separate_cell_by_mark").execute(*args, **kwargs)
            def separate_cell_by_skew(self, *args, **kwargs):
                """
                Separates cells based on the specified cell skewness.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/separate/separate_cell_by_skew").execute(*args, **kwargs)
            def separate_cell_by_region(self, *args, **kwargs):
                """
                Separates contiguous regions within a cell zone into separate cell zones.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/separate/separate_cell_by_region").execute(*args, **kwargs)
            def separate_prisms_from_poly(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/separate/separate_prisms_from_poly").execute(*args, **kwargs)
            ...
            class local_regions(TUIMenu):
                ...
                def delete(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/separate/local_regions/delete").execute(*args, **kwargs)
                def define(self, *args, **kwargs):
                    """
                    Enables you to define the parameters for the refinement region.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/separate/local_regions/define").execute(*args, **kwargs)
                def list_all_regions(self, *args, **kwargs):
                    """
                    Lists all the refinement regions.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/separate/local_regions/list_all_regions").execute(*args, **kwargs)
                def init(self, *args, **kwargs):
                    """
                    Deletes all current regions and adds the default refinement region.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/separate/local_regions/init").execute(*args, **kwargs)
        ...
        class pyramid(TUIMenu):
            ...
            def create(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/pyramid/create").execute(*args, **kwargs)
            ...
            class controls(TUIMenu):
                ...
                def neighbor_angle(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/pyramid/controls/neighbor_angle").execute(*args, **kwargs)
                def offset_factor(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/pyramid/controls/offset_factor").execute(*args, **kwargs)
                def vertex_method(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/pyramid/controls/vertex_method").execute(*args, **kwargs)
                def offset_scaling(self, *args, **kwargs):
                    """
                    Specifies the scaling, to be used to determine the height of the pyramid.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/pyramid/controls/offset_scaling").execute(*args, **kwargs)
        ...
        class hexcore(TUIMenu):
            ...
            def merge_tets_to_pyramids(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/merge_tets_to_pyramids").execute(*args, **kwargs)
            def create(self, *args, **kwargs):
                """
                Enables you to create the hexcore mesh according to the specified parameters.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/create").execute(*args, **kwargs)
            ...
            class controls(TUIMenu):
                ...
                def maximum_cell_length(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/maximum_cell_length").execute(*args, **kwargs)
                def smooth_relaxation(self, *args, **kwargs):
                    """
                    Smoothing under relaxation on hexcore interface.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/smooth_relaxation").execute(*args, **kwargs)
                def buffer_layers(self, *args, **kwargs):
                    """
                    Sets the number of addition cells to mark for subdivision.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/buffer_layers").execute(*args, **kwargs)
                def delete_dead_zones(self, *args, **kwargs):
                    """
                    Toggles the automatic deleting of the dead zones.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/delete_dead_zones").execute(*args, **kwargs)
                def peel_layers(self, *args, **kwargs):
                    """
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/peel_layers").execute(*args, **kwargs)
                def set_region_based_sizing(self, *args, **kwargs):
                    """
                    Allows you to specify local sizing settings (max cell length and growth rate) for specified region(s).
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/set_region_based_sizing").execute(*args, **kwargs)
                def island_thresholds(self, *args, **kwargs):
                    """
                    Maximum number of cells and volume fraction in islands, deleted while separating the cells by region.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/island_thresholds").execute(*args, **kwargs)
                def only_hexcore(self, *args, **kwargs):
                    """
                    Create hexcore and activate tet domain.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/only_hexcore").execute(*args, **kwargs)
                def smooth_interface(self, *args, **kwargs):
                    """
                    Enable smoothing of hexcore interface.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/smooth_interface").execute(*args, **kwargs)
                def maximum_initial_cells(self, *args, **kwargs):
                    """
                    Specifies the maximum number of cells in the initial Cartesian mesh.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/maximum_initial_cells").execute(*args, **kwargs)
                def octree_hexcore(self, *args, **kwargs):
                    """
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/octree_hexcore").execute(*args, **kwargs)
                def merge_tets_to_pyramids(self, *args, **kwargs):
                    """
                    Merge tets into pyramids.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/merge_tets_to_pyramids").execute(*args, **kwargs)
                def define_hexcore_extents(self, *args, **kwargs):
                    """
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/define_hexcore_extents").execute(*args, **kwargs)
                def smooth_iterations(self, *args, **kwargs):
                    """
                    Number of smoothing iterations on hexcore interface.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/smooth_iterations").execute(*args, **kwargs)
                def maximum_subdivisions(self, *args, **kwargs):
                    """
                    Maximum number of subdivision sweeps.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/maximum_subdivisions").execute(*args, **kwargs)
                def skip_tet_refinement(self, *args, **kwargs):
                    """
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/skip_tet_refinement").execute(*args, **kwargs)
                def compute_max_cell_length(self, *args, **kwargs):
                    """
                    Computes the maximum cell length for the hexcore mesh.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/compute_max_cell_length").execute(*args, **kwargs)
                def non_fluid_type(self, *args, **kwargs):
                    """
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/non_fluid_type").execute(*args, **kwargs)
                def keep_hex_tet_separate(self, *args, **kwargs):
                    """
                    Separate Hex and Tet cells.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/keep_hex_tet_separate").execute(*args, **kwargs)
                def print_region_based_sizing(self, *args, **kwargs):
                    """
                    Displays local sizing settings (max cell length and growth rate) for specified region(s).
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/print_region_based_sizing").execute(*args, **kwargs)
                def avoid_1_by_8_cell_jump_in_hexcore(self, *args, **kwargs):
                    """
                    Avoid-1:8-cell-jump-in-hexcore.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/avoid_1_by_8_cell_jump_in_hexcore").execute(*args, **kwargs)
                ...
                class outer_domain_params(TUIMenu):
                    ...
                    def auto_align_boundaries(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/outer_domain_params/auto_align_boundaries").execute(*args, **kwargs)
                    def auto_align_tolerance(self, *args, **kwargs):
                        """
                        Specifies the tolerance for aligning boundary zones when auto-align? is enabled.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/outer_domain_params/auto_align_tolerance").execute(*args, **kwargs)
                    def delete_old_face_zones(self, *args, **kwargs):
                        """
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/outer_domain_params/delete_old_face_zones").execute(*args, **kwargs)
                    def list(self, *args, **kwargs):
                        """
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/outer_domain_params/list").execute(*args, **kwargs)
                    def coordinates(self, *args, **kwargs):
                        """
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/outer_domain_params/coordinates").execute(*args, **kwargs)
                    def specify_coordinates(self, *args, **kwargs):
                        """
                        Enables you to specify the extents of the hexcore outer box using the coordinates command.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/outer_domain_params/specify_coordinates").execute(*args, **kwargs)
                    def specify_boundaries(self, *args, **kwargs):
                        """
                        Enables you to specify selected boundaries to which the hexcore mesh is to be generated using the boundaries command.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/outer_domain_params/specify_boundaries").execute(*args, **kwargs)
                    def auto_align(self, *args, **kwargs):
                        """
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/outer_domain_params/auto_align").execute(*args, **kwargs)
                    def boundaries(self, *args, **kwargs):
                        """
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/controls/outer_domain_params/boundaries").execute(*args, **kwargs)
            ...
            class local_regions(TUIMenu):
                ...
                def ideal_hex_vol(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/local_regions/ideal_hex_vol").execute(*args, **kwargs)
                def activate(self, *args, **kwargs):
                    """
                    Enables you to activate the specified local regions for refinement.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/local_regions/activate").execute(*args, **kwargs)
                def define(self, *args, **kwargs):
                    """
                    Defines the local region according to the specified parameters.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/local_regions/define").execute(*args, **kwargs)
                def delete(self, *args, **kwargs):
                    """
                    Deletes the specified refinement region.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/local_regions/delete").execute(*args, **kwargs)
                def init(self, *args, **kwargs):
                    """
                    Creates a default region encompassing the entire geometry.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/local_regions/init").execute(*args, **kwargs)
                def list_all_regions(self, *args, **kwargs):
                    """
                    Lists the defined and active regions in the console.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/local_regions/list_all_regions").execute(*args, **kwargs)
                def deactivate(self, *args, **kwargs):
                    """
                    Enables you to deactivate the specified local regions for refinement.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/local_regions/deactivate").execute(*args, **kwargs)
                def ideal_quad_area(self, *args, **kwargs):
                    """
                    Ideal quad area for given edge length.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/hexcore/local_regions/ideal_quad_area").execute(*args, **kwargs)
        ...
        class cartesian(TUIMenu):
            ...
            def mesh(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/cartesian/mesh").execute(*args, **kwargs)
        ...
        class poly_hexcore(TUIMenu):
            ...
            class controls(TUIMenu):
                ...
                def mark_core_region_cell_type_as_hex(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/poly_hexcore/controls/mark_core_region_cell_type_as_hex").execute(*args, **kwargs)
                def only_polyhedra_for_selected_regions(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/poly_hexcore/controls/only_polyhedra_for_selected_regions").execute(*args, **kwargs)
                def avoid_1_by_8_cell_jump_in_hexcore(self, *args, **kwargs):
                    """
                    Avoid-1:8-cell-jump-in-hexcore.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/poly_hexcore/controls/avoid_1_by_8_cell_jump_in_hexcore").execute(*args, **kwargs)
        ...
        class rapid_octree(TUIMenu):
            ...
            def boundary_mesh_optimization(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/boundary_mesh_optimization").execute(*args, **kwargs)
            def dry_run(self, *args, **kwargs):
                """
                If yes: Just print diagnostic information, do not create a mesh.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/dry_run").execute(*args, **kwargs)
            def reset_bounding_box(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/reset_bounding_box").execute(*args, **kwargs)
            def delete_poor_quality_cells(self, *args, **kwargs):
                """
                Delete all cells with orthogonal-quality less than 0.01.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/delete_poor_quality_cells").execute(*args, **kwargs)
            def flow_volume(self, *args, **kwargs):
                """
                Specifies the volume to be filled by the mesh.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/flow_volume").execute(*args, **kwargs)
            def improve_geometry_resolution(self, *args, **kwargs):
                """
                Enables improved geometry resolution.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/improve_geometry_resolution").execute(*args, **kwargs)
            def estimate_cell_count(self, *args, **kwargs):
                """
                Give a quick estimate about the expected number of cells.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/estimate_cell_count").execute(*args, **kwargs)
            def is_manifold_geo(self, *args, **kwargs):
                """
                Set to yes if the geomety is manifold (speed up mesh generation).
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/is_manifold_geo").execute(*args, **kwargs)
            def create_stair_step_mesh(self, *args, **kwargs):
                """
                Create rapid octree mesh with a cartesian boundary approximation.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/create_stair_step_mesh").execute(*args, **kwargs)
            def create(self, *args, **kwargs):
                """
                Creates a mesh using the Rapid Octree mesher.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/create").execute(*args, **kwargs)
            def verbosity(self, *args, **kwargs):
                """
                Sets the verbosity of the messages printed by the Rapid Octree mesher.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/verbosity").execute(*args, **kwargs)
            def boundary_treatment(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/boundary_treatment").execute(*args, **kwargs)
            def distribute_geometry(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/distribute_geometry").execute(*args, **kwargs)
            def undo_last_meshing_operation(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/undo_last_meshing_operation").execute(*args, **kwargs)
            def bounding_box(self, *args, **kwargs):
                """
                Defines/modifies the bounding box around the geometry.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/bounding_box").execute(*args, **kwargs)
            def geometry(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/geometry").execute(*args, **kwargs)
            ...
            class boundary_layer_mesh_configuration(TUIMenu):
                ...
                def add(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/boundary_layer_mesh_configuration/add").execute(*args, **kwargs)
                def edit(self, *args, **kwargs):
                    """
                    Specify the number of prismatic layers for surface zones.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/boundary_layer_mesh_configuration/edit").execute(*args, **kwargs)
                def delete_all(self, *args, **kwargs):
                    """
                    Specify the number of prismatic layers for surface zones.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/boundary_layer_mesh_configuration/delete_all").execute(*args, **kwargs)
                def delete(self, *args, **kwargs):
                    """
                    Specify the number of prismatic layers for surface zones.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/boundary_layer_mesh_configuration/delete").execute(*args, **kwargs)
                def list(self, *args, **kwargs):
                    """
                    Specify the number of prismatic layers for surface zones.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/boundary_layer_mesh_configuration/list").execute(*args, **kwargs)
            ...
            class advanced_meshing_options(TUIMenu):
                ...
                def mesh_optimization_scheme(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/advanced_meshing_options/mesh_optimization_scheme").execute(*args, **kwargs)
                def distance_erosion_factor(self, *args, **kwargs):
                    """
                    Set distance erosion factor as a factor of prism edge length.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/advanced_meshing_options/distance_erosion_factor").execute(*args, **kwargs)
                def target_cell_orthoskew(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/advanced_meshing_options/target_cell_orthoskew").execute(*args, **kwargs)
                def projection_priority_zones(self, *args, **kwargs):
                    """
                    Prioritize zone association of faces crossing multiple boundary zones.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/advanced_meshing_options/projection_priority_zones").execute(*args, **kwargs)
                def pseudo_normal_mode(self, *args, **kwargs):
                    """
                    Sets the mode for cumputing projection front sudo normals.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/advanced_meshing_options/pseudo_normal_mode").execute(*args, **kwargs)
                def aspect_ratio_skewness_limit(self, *args, **kwargs):
                    """
                    Ignore cells with higher skew in aspect ratio improvement.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/advanced_meshing_options/aspect_ratio_skewness_limit").execute(*args, **kwargs)
                def rename_bounding_box_zones(self, *args, **kwargs):
                    """
                    Set flag to change naming scheme of bounding box surface zones.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/advanced_meshing_options/rename_bounding_box_zones").execute(*args, **kwargs)
                def activate_projection_layer_improvement_algorithm(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/advanced_meshing_options/activate_projection_layer_improvement_algorithm").execute(*args, **kwargs)
                def max_num_inflection_point_iter(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/advanced_meshing_options/max_num_inflection_point_iter").execute(*args, **kwargs)
                def target_bnd_face_warp(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/advanced_meshing_options/target_bnd_face_warp").execute(*args, **kwargs)
                def target_int_face_warp(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/advanced_meshing_options/target_int_face_warp").execute(*args, **kwargs)
                def smooth_mesh_coarsening(self, *args, **kwargs):
                    """
                    Activte smoother mesh coarseing algorightm. Will increase runtime!.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/advanced_meshing_options/smooth_mesh_coarsening").execute(*args, **kwargs)
            ...
            class refinement_regions(TUIMenu):
                ...
                def list(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/refinement_regions/list").execute(*args, **kwargs)
                def edit(self, *args, **kwargs):
                    """
                    Edit a refinement region definition.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/refinement_regions/edit").execute(*args, **kwargs)
                def add(self, *args, **kwargs):
                    """
                    Adds a refinement region to the domain.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/refinement_regions/add").execute(*args, **kwargs)
                def list_properties(self, *args, **kwargs):
                    """
                    List the properties of a refinement region definition.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/refinement_regions/list_properties").execute(*args, **kwargs)
                def delete(self, *args, **kwargs):
                    """
                    Deletes a refinement region.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/refinement_regions/delete").execute(*args, **kwargs)
            ...
            class mesh_sizing(TUIMenu):
                ...
                def buffer_layers(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/mesh_sizing/buffer_layers").execute(*args, **kwargs)
                def boundary_layers(self, *args, **kwargs):
                    """
                    Set the minimum number of constant-size cells adjacent to the geometry.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/mesh_sizing/boundary_layers").execute(*args, **kwargs)
                def clear_all_surface_sizings(self, *args, **kwargs):
                    """
                    Delete all size function definitions.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/mesh_sizing/clear_all_surface_sizings").execute(*args, **kwargs)
                def delete_surface_sizing(self, *args, **kwargs):
                    """
                    Delete a size function definition.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/mesh_sizing/delete_surface_sizing").execute(*args, **kwargs)
                def list_surface_sizings(self, *args, **kwargs):
                    """
                    List all size function definitions.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/mesh_sizing/list_surface_sizings").execute(*args, **kwargs)
                def max_cell_size(self, *args, **kwargs):
                    """
                    Sets the maximum cell size in the octree mesh.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/mesh_sizing/max_cell_size").execute(*args, **kwargs)
                def mesh_coarsening_exponent(self, *args, **kwargs):
                    """
                    Set the exponent for mesh coarsening.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/mesh_sizing/mesh_coarsening_exponent").execute(*args, **kwargs)
                def boundary_cell_size(self, *args, **kwargs):
                    """
                    Sets the default cell size for the geometry.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/mesh_sizing/boundary_cell_size").execute(*args, **kwargs)
                def add_surface_sizing(self, *args, **kwargs):
                    """
                    Add a size function definition.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/mesh_sizing/add_surface_sizing").execute(*args, **kwargs)
                def change_surface_sizing(self, *args, **kwargs):
                    """
                    Change a size function definition.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/mesh_sizing/change_surface_sizing").execute(*args, **kwargs)
                def surface_coarsening_layers(self, *args, **kwargs):
                    """
                    Set the minimum number of constant-size cells adjacent to the geometry.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/mesh_sizing/surface_coarsening_layers").execute(*args, **kwargs)
                def feature_angle_refinement(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/rapid_octree/mesh_sizing/feature_angle_refinement").execute(*args, **kwargs)
        ...
        class auto_mesh_controls(TUIMenu):
            ...
            def backup_object(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/auto_mesh_controls/backup_object").execute(*args, **kwargs)
        ...
        class non_conformals(TUIMenu):
            ...
            def create(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/non_conformals/create").execute(*args, **kwargs)
            def separate(self, *args, **kwargs):
                """
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/non_conformals/separate").execute(*args, **kwargs)
            ...
            class controls(TUIMenu):
                ...
                def enable(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/non_conformals/controls/enable").execute(*args, **kwargs)
                def retri_method(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/non_conformals/controls/retri_method").execute(*args, **kwargs)
        ...
        class modify(TUIMenu):
            ...
            def select_entity(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/modify/select_entity").execute(*args, **kwargs)
            def list_selections(self, *args, **kwargs):
                """
                Lists all items in the selection list.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/modify/list_selections").execute(*args, **kwargs)
            def mesh_node(self, *args, **kwargs):
                """
                Attempts to introduce a new node into the existing mesh.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/modify/mesh_node").execute(*args, **kwargs)
            def auto_node_move(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/modify/auto_node_move").execute(*args, **kwargs)
            def delete_isolated_cells(self, *args, **kwargs):
                """
                Delete isolated cells.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/modify/delete_isolated_cells").execute(*args, **kwargs)
            def mesh_nodes_on_zone(self, *args, **kwargs):
                """
                Inserts nodes associated with node or face zone into the volume mesh.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/modify/mesh_nodes_on_zone").execute(*args, **kwargs)
            def repair_negative_volume_cells(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/modify/repair_negative_volume_cells").execute(*args, **kwargs)
            def auto_improve_warp(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/modify/auto_improve_warp").execute(*args, **kwargs)
            def smooth_node(self, *args, **kwargs):
                """
                Applies Laplace smoothing to the nodes in the selection list.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/modify/smooth_node").execute(*args, **kwargs)
            def deselect_last(self, *args, **kwargs):
                """
                Deselects the last item you selected using the select-entity command.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/modify/deselect_last").execute(*args, **kwargs)
            def clear_selections(self, *args, **kwargs):
                """
                Clears all items from the selection list.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/modify/clear_selections").execute(*args, **kwargs)
            def extract_unused_nodes(self, *args, **kwargs):
                """
                Places all unused nodes in a separate interior node zone.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/modify/extract_unused_nodes").execute(*args, **kwargs)
            def neighborhood_skew(self, *args, **kwargs):
                """
                Reports the maximum skewness of cells using the specified node.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/modify/neighborhood_skew").execute(*args, **kwargs)
            def refine_cell(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/modify/refine_cell").execute(*args, **kwargs)
            def list_skewed_cells(self, *args, **kwargs):
                """
                Lists cells with skewness in a specified range.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/modify/list_skewed_cells").execute(*args, **kwargs)
        ...
        class poly(TUIMenu):
            ...
            def remesh(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/poly/remesh").execute(*args, **kwargs)
            def quality_method(self, *args, **kwargs):
                """
                Asks you to choose from internal-default,  orthoskew or squish quality measure for mesh improvement.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/poly/quality_method").execute(*args, **kwargs)
            def collapse(self, *args, **kwargs):
                """
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/poly/collapse").execute(*args, **kwargs)
            def improve(self, *args, **kwargs):
                """
                Allows you to improve the polyhedral mesh quality based on the  quality-method.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/poly/improve").execute(*args, **kwargs)
            ...
            class controls(TUIMenu):
                ...
                def non_fluid_type(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/poly/controls/non_fluid_type").execute(*args, **kwargs)
                def feature_angle(self, *args, **kwargs):
                    """
                    Sets the minimum threshold that should be preserved as a feature.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/poly/controls/feature_angle").execute(*args, **kwargs)
                def sliver_cell_area_fraction(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/poly/controls/sliver_cell_area_fraction").execute(*args, **kwargs)
                def face_size_ratio(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/poly/controls/face_size_ratio").execute(*args, **kwargs)
                def improve(self, *args, **kwargs):
                    """
                    Enables poly mesh improvement by smoothing based on the smooth-controls.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/poly/controls/improve").execute(*args, **kwargs)
                def edge_size_ratio(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/poly/controls/edge_size_ratio").execute(*args, **kwargs)
                def merge_skew(self, *args, **kwargs):
                    """
                    Sets the minimum skewness threshold for cell merge.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/poly/controls/merge_skew").execute(*args, **kwargs)
                def cell_sizing(self, *args, **kwargs):
                    """
                    Sets cell volume distribution function as geometric, linear, or size-field.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/poly/controls/cell_sizing").execute(*args, **kwargs)
                def remesh_skew(self, *args, **kwargs):
                    """
                    Sets the target skewness when remeshing.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/poly/controls/remesh_skew").execute(*args, **kwargs)
                ...
                class prism(TUIMenu):
                    ...
                    def apply_growth(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/poly/controls/prism/apply_growth").execute(*args, **kwargs)
                    def list_growth(self, *args, **kwargs):
                        """
                        List growth settings.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/poly/controls/prism/list_growth").execute(*args, **kwargs)
                    def clear_growth(self, *args, **kwargs):
                        """
                        Clear growth settings.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/poly/controls/prism/clear_growth").execute(*args, **kwargs)
                ...
                class smooth_controls(TUIMenu):
                    ...
                    def smooth_on_layer(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/poly/controls/smooth_controls/smooth_on_layer").execute(*args, **kwargs)
                    def smooth_skew(self, *args, **kwargs):
                        """
                        Sets the minimum skewness threshold for poly mesh smoothing.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/poly/controls/smooth_controls/smooth_skew").execute(*args, **kwargs)
                    def smooth_attempts(self, *args, **kwargs):
                        """
                        Sets the maximum number of movements for a single node during poly mesh smoothing.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/poly/controls/smooth_controls/smooth_attempts").execute(*args, **kwargs)
                    def smooth_boundary(self, *args, **kwargs):
                        """
                        Enables boundary smoothing as part of poly cell smoothing. Default is no.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/poly/controls/smooth_controls/smooth_boundary").execute(*args, **kwargs)
                    def smooth_iterations(self, *args, **kwargs):
                        """
                        Sets the number of improvement passes over the full poly mesh.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/poly/controls/smooth_controls/smooth_iterations").execute(*args, **kwargs)
                    def laplace_smooth_iterations(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/poly/controls/smooth_controls/laplace_smooth_iterations").execute(*args, **kwargs)
                    def edge_smooth_iterations(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/poly/controls/smooth_controls/edge_smooth_iterations").execute(*args, **kwargs)
                    def centroid_smooth_iterations(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/poly/controls/smooth_controls/centroid_smooth_iterations").execute(*args, **kwargs)
            ...
            class local_regions(TUIMenu):
                ...
                def ideal_vol(self, *args, **kwargs):
                    ...
                    Reports the volume of an ideal tetrahedron for the edge length specified.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/poly/local_regions/ideal_vol").execute(*args, **kwargs)
                def refine(self, *args, **kwargs):
                    """
                    Refines the active cells inside the selected region based on the specified refinement parameters.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/poly/local_regions/refine").execute(*args, **kwargs)
                def ideal_area(self, *args, **kwargs):
                    """
                    Ideal triangle area for given edge length.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/poly/local_regions/ideal_area").execute(*args, **kwargs)
                def delete(self, *args, **kwargs):
                    """
                    Deletes the specified refinement region.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/poly/local_regions/delete").execute(*args, **kwargs)
                def deactivate(self, *args, **kwargs):
                    """
                    Deactivates the specified regions for refinement.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/poly/local_regions/deactivate").execute(*args, **kwargs)
                def define(self, *args, **kwargs):
                    """
                    Defines the refinement region according to the specified parameters.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/poly/local_regions/define").execute(*args, **kwargs)
                def list_all_regions(self, *args, **kwargs):
                    """
                    Lists all refinement region parameters and the activated regions in the console.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/poly/local_regions/list_all_regions").execute(*args, **kwargs)
                def activate(self, *args, **kwargs):
                    """
                    Activates the specified regions for refinement.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/poly/local_regions/activate").execute(*args, **kwargs)
                def init(self, *args, **kwargs):
                    """
                    Defines the default refinement region encompassing the entire geometry.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/poly/local_regions/init").execute(*args, **kwargs)
        ...
        class scoped_prisms(TUIMenu):
            ...
            def set_no_imprint_zones(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/scoped_prisms/set_no_imprint_zones").execute(*args, **kwargs)
            def delete(self, *args, **kwargs):
                """
                Deletes the specified scoped prism control.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/scoped_prisms/delete").execute(*args, **kwargs)
            def poly_keep_nlayer_prism_characteristics(self, *args, **kwargs):
                """
                Number of layers to maintain poly-prism characteristics.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/scoped_prisms/poly_keep_nlayer_prism_characteristics").execute(*args, **kwargs)
            def create(self, *args, **kwargs):
                """
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/scoped_prisms/create").execute(*args, **kwargs)
            def write(self, *args, **kwargs):
                """
                Writes the scoped prism controls to a prism control file (\*.pzmcontrol). Specify the scoped prism file name.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/scoped_prisms/write").execute(*args, **kwargs)
            def read(self, *args, **kwargs):
                """
                Reads in the specified scoped prism control file (\*.pzmcontrol).
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/scoped_prisms/read").execute(*args, **kwargs)
            def modify(self, *args, **kwargs):
                """
                Modifies the specified control based on the parameters specified.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/scoped_prisms/modify").execute(*args, **kwargs)
            def set_overset_prism_controls(self, *args, **kwargs):
                """
                Set boundary layer controls for overset mesh generation.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/scoped_prisms/set_overset_prism_controls").execute(*args, **kwargs)
            def list(self, *args, **kwargs):
                """
                Lists all the defined scoped prism controls.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/scoped_prisms/list").execute(*args, **kwargs)
            def growth_options(self, *args, **kwargs):
                """
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/scoped_prisms/growth_options").execute(*args, **kwargs)
            def set_advanced_controls(self, *args, **kwargs):
                """
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/scoped_prisms/set_advanced_controls").execute(*args, **kwargs)
        ...
        class cell_zone_conditions(TUIMenu):
            ...
            def copy(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/cell_zone_conditions/copy").execute(*args, **kwargs)
            def clear_all(self, *args, **kwargs):
                """
                Clears the cell conditions assigned to all the zones.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/cell_zone_conditions/clear_all").execute(*args, **kwargs)
            def clear(self, *args, **kwargs):
                """
                Clears the cell zone conditions assigned to the specified zones.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/cell_zone_conditions/clear").execute(*args, **kwargs)
        ...
        class thin_volume_mesh(TUIMenu):
            ...
            def create(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/thin_volume_mesh/create").execute(*args, **kwargs)
        ...
        class prism(TUIMenu):
            ...
            def quality_method(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/prism/quality_method").execute(*args, **kwargs)
            def mark_ignore_faces(self, *args, **kwargs):
                """
                Enables you to mark the faces to be ignored during prism meshing.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/prism/mark_ignore_faces").execute(*args, **kwargs)
            def mark_proximity_faces(self, *args, **kwargs):
                """
                Mark prism base faces with certain gap.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/prism/mark_proximity_faces").execute(*args, **kwargs)
            def list_parameters(self, *args, **kwargs):
                """
                Shows all prism mesh parameters.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/prism/list_parameters").execute(*args, **kwargs)
            def mark_nonmanifold_nodes(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/prism/mark_nonmanifold_nodes").execute(*args, **kwargs)
            def reset_parameters(self, *args, **kwargs):
                """
                Resets all prism parameters.
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/prism/reset_parameters").execute(*args, **kwargs)
            def create(self, *args, **kwargs):
                """
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/mesh/prism/create").execute(*args, **kwargs)
            ...
            class improve(TUIMenu):
                ...
                def smooth_prism_cells(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/prism/improve/smooth_prism_cells").execute(*args, **kwargs)
                def smooth_sliver_skew(self, *args, **kwargs):
                    """
                    Specifies the skewness above which prism cells will be smoothed.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/prism/improve/smooth_sliver_skew").execute(*args, **kwargs)
                def smooth_brute_force(self, *args, **kwargs):
                    """
                    Forcibly smooths cells if cell skewness is still high after regular smoothing.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/prism/improve/smooth_brute_force").execute(*args, **kwargs)
                def smooth_cell_rings(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/prism/improve/smooth_cell_rings").execute(*args, **kwargs)
                def improve_prism_cells(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/prism/improve/improve_prism_cells").execute(*args, **kwargs)
                def smooth_improve_prism_cells(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/prism/improve/smooth_improve_prism_cells").execute(*args, **kwargs)
            ...
            class controls(TUIMenu):
                ...
                def set_post_mesh_controls(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/set_post_mesh_controls").execute(*args, **kwargs)
                def remove_invalid_layer(self, *args, **kwargs):
                    """
                    Removes the last prism layer if it fails in the quality check.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/remove_invalid_layer").execute(*args, **kwargs)
                def set_overset_prism_controls(self, *args, **kwargs):
                    """
                    Set boundary layer controls for overset mesh generation.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/set_overset_prism_controls").execute(*args, **kwargs)
                def check_quality(self, *args, **kwargs):
                    """
                    Enables/disables the checking of volume, skewness, and handedness of each new cell and face.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/check_quality").execute(*args, **kwargs)
                def auto_separate_cells(self, *args, **kwargs):
                    """
                    Automatically separate prism cells extruded from multiple face threads?.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/auto_separate_cells").execute(*args, **kwargs)
                def split(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/split").execute(*args, **kwargs)
                def merge_ignored_threads(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/merge_ignored_threads").execute(*args, **kwargs)
                def grow_individually(self, *args, **kwargs):
                    """
                    Grow from multiple zones one-at-a-time?.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/grow_individually").execute(*args, **kwargs)
                ...
                class proximity(TUIMenu):
                    ...
                    def max_shrink_factor(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/proximity/max_shrink_factor").execute(*args, **kwargs)
                    def keep_first_layer_offsets(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/proximity/keep_first_layer_offsets").execute(*args, **kwargs)
                    def smoothing_rate(self, *args, **kwargs):
                        """
                        Rate at which shrinkage is propagated in lateral direction.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/proximity/smoothing_rate").execute(*args, **kwargs)
                    def allow_shrinkage(self, *args, **kwargs):
                        """
                        Enables shrinkage while growing prism layers.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/proximity/allow_shrinkage").execute(*args, **kwargs)
                    def gap_factor(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/proximity/gap_factor").execute(*args, **kwargs)
                    def max_aspect_ratio(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/proximity/max_aspect_ratio").execute(*args, **kwargs)
                    def allow_ignore(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/proximity/allow_ignore").execute(*args, **kwargs)
                ...
                class post_ignore(TUIMenu):
                    ...
                    def post_remove_cells(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/post_ignore/post_remove_cells").execute(*args, **kwargs)
                ...
                class offset(TUIMenu):
                    ...
                    def smooth_iter(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/offset/smooth_iter").execute(*args, **kwargs)
                    def smooth(self, *args, **kwargs):
                        """
                        Perform smoothing of offset distances?.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/offset/smooth").execute(*args, **kwargs)
                    def smooth_converged(self, *args, **kwargs):
                        """
                        Convergence criterion for offset smoothing.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/offset/smooth_converged").execute(*args, **kwargs)
                    def min_aspect_ratio(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/offset/min_aspect_ratio").execute(*args, **kwargs)
                    def first_aspect_ratio_min(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/offset/first_aspect_ratio_min").execute(*args, **kwargs)
                ...
                class normal(TUIMenu):
                    ...
                    def compute_normal(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/normal/compute_normal").execute(*args, **kwargs)
                    def smooth_iter(self, *args, **kwargs):
                        """
                        Maximum number of smoothing iterations for normal vectors.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/normal/smooth_iter").execute(*args, **kwargs)
                    def smooth(self, *args, **kwargs):
                        """
                        Perform smoothing of normal advancement direction vectors?.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/normal/smooth").execute(*args, **kwargs)
                    def direction_method(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/normal/direction_method").execute(*args, **kwargs)
                    def orient_mesh_object_face_normals(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/normal/orient_mesh_object_face_normals").execute(*args, **kwargs)
                    def converge_locally(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/normal/converge_locally").execute(*args, **kwargs)
                    def orthogonal_layers(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/normal/orthogonal_layers").execute(*args, **kwargs)
                    def smooth_converged(self, *args, **kwargs):
                        """
                        Convergence criterion (in DEGREES) for angle changes
                        during normal smoothing.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/normal/smooth_converged").execute(*args, **kwargs)
                    def ignore_invalid_normals(self, *args, **kwargs):
                        """
                        Enables you to ignore nodes that have poor normals.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/normal/ignore_invalid_normals").execute(*args, **kwargs)
                    def normal_method(self, *args, **kwargs):
                        """
                        Method in which normal marching direction vectors are determined.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/normal/normal_method").execute(*args, **kwargs)
                    def direction_vector(self, *args, **kwargs):
                        """
                        Specifies the direction vector for prism extrusion when the uniform method is selected for direction-method.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/normal/direction_vector").execute(*args, **kwargs)
                    def max_angle_change(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/normal/max_angle_change").execute(*args, **kwargs)
                    def bisect_angle(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/normal/bisect_angle").execute(*args, **kwargs)
                ...
                class morph(TUIMenu):
                    ...
                    def morphing_convergence_limit(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/morph/morphing_convergence_limit").execute(*args, **kwargs)
                    def improve_threshold(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/morph/improve_threshold").execute(*args, **kwargs)
                    def morphing_frequency(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/morph/morphing_frequency").execute(*args, **kwargs)
                ...
                class improve(TUIMenu):
                    ...
                    def identify_feature_line(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/identify_feature_line").execute(*args, **kwargs)
                    def max_allowable_cell_skew(self, *args, **kwargs):
                        """
                        Specifies the cell quality criteria for smoothing and quality checking.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/max_allowable_cell_skew").execute(*args, **kwargs)
                    def shrink_left_handed_cap(self, *args, **kwargs):
                        """
                        Shrink if required to get rid of left handed faces.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/shrink_left_handed_cap").execute(*args, **kwargs)
                    def edge_swap_cap_angle(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/edge_swap_cap_angle").execute(*args, **kwargs)
                    def node_smooth_angle(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/node_smooth_angle").execute(*args, **kwargs)
                    def edge_smooth_angle(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/edge_smooth_angle").execute(*args, **kwargs)
                    def node_smooth_local(self, *args, **kwargs):
                        """
                        Allow node-smoothing to converge locally (for large geometries).
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/node_smooth_local").execute(*args, **kwargs)
                    def corner_height_weight(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/corner_height_weight").execute(*args, **kwargs)
                    def post_adjust_height(self, *args, **kwargs):
                        """
                        Perform prism height adjustment based on growth rate?.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/post_adjust_height").execute(*args, **kwargs)
                    def edge_swap(self, *args, **kwargs):
                        """
                        Perform edge swapping to improve skewness?.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/edge_swap").execute(*args, **kwargs)
                    def edge_swap_base_angle(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/edge_swap_base_angle").execute(*args, **kwargs)
                    def node_smooth_converged(self, *args, **kwargs):
                        """
                        Convergence criterion for node smoothing.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/node_smooth_converged").execute(*args, **kwargs)
                    def check_size(self, *args, **kwargs):
                        """
                        Check for negative cell volume?.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/check_size").execute(*args, **kwargs)
                    def smooth_improve_prism_cells(self, *args, **kwargs):
                        """
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/smooth_improve_prism_cells").execute(*args, **kwargs)
                    def node_smooth(self, *args, **kwargs):
                        """
                        Perform node-driven smoothing to improve skewness?.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/node_smooth").execute(*args, **kwargs)
                    def left_hand_check(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/left_hand_check").execute(*args, **kwargs)
                    def max_allowable_cap_skew(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/max_allowable_cap_skew").execute(*args, **kwargs)
                    def face_smooth_converged(self, *args, **kwargs):
                        """
                        Convergence criteria for cap face smoothing.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/face_smooth_converged").execute(*args, **kwargs)
                    def edge_smooth(self, *args, **kwargs):
                        """
                        Perform local smoothing of nodes on longest edges of skewed faces?.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/edge_smooth").execute(*args, **kwargs)
                    def layer_by_layer_smoothing(self, *args, **kwargs):
                        """
                        Perform normals and heights smoothing to improve cell quality/shape?.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/layer_by_layer_smoothing").execute(*args, **kwargs)
                    def improve_warp(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/improve_warp").execute(*args, **kwargs)
                    def check_allowable_skew(self, *args, **kwargs):
                        """
                        Enables you to check the skewness of the prism cap for every layer.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/check_allowable_skew").execute(*args, **kwargs)
                    def node_smooth_iter(self, *args, **kwargs):
                        """
                        Maximum number of smoothing iterations for nodes on advancing layers.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/node_smooth_iter").execute(*args, **kwargs)
                    def face_smooth_skew(self, *args, **kwargs):
                        """
                        Min. skewness to smooth cap faces.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/face_smooth_skew").execute(*args, **kwargs)
                    def face_smooth(self, *args, **kwargs):
                        """
                        Perform face-driven smoothing to improve skewness?.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/face_smooth").execute(*args, **kwargs)
                    def swap_smooth_skew(self, *args, **kwargs):
                        """
                        Only faces with skewness >= this value are swapped and/or smoothed.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/swap_smooth_skew").execute(*args, **kwargs)
                    def node_smooth_rings(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/node_smooth_rings").execute(*args, **kwargs)
                    def face_smooth_rings(self, *args, **kwargs):
                        """
                        No. of rings to propagate skewness during smoothing of cap faces.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/improve/face_smooth_rings").execute(*args, **kwargs)
                ...
                class zone_specific_growth(TUIMenu):
                    ...
                    def clear_growth(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/zone_specific_growth/clear_growth").execute(*args, **kwargs)
                    def apply_growth(self, *args, **kwargs):
                        """
                        Applies the zone-specific growth parameters specified.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/zone_specific_growth/apply_growth").execute(*args, **kwargs)
                    def list_growth(self, *args, **kwargs):
                        """
                        Lists the zone-specific growth parameters specified for individual zones in the console.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/zone_specific_growth/list_growth").execute(*args, **kwargs)
                ...
                class adjacent_zone(TUIMenu):
                    ...
                    def retriangulate_adjacent(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/adjacent_zone/retriangulate_adjacent").execute(*args, **kwargs)
                    def side_topology_align_angle(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/adjacent_zone/side_topology_align_angle").execute(*args, **kwargs)
                    def retri_feature_angle(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/adjacent_zone/retri_feature_angle").execute(*args, **kwargs)
                    def side_feature_align_angle(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/adjacent_zone/side_feature_align_angle").execute(*args, **kwargs)
                    def side_feature_angle(self, *args, **kwargs):
                        """
                        Specifies the angle used for computing the feature normals.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/adjacent_zone/side_feature_angle").execute(*args, **kwargs)
                    def project_converged(self, *args, **kwargs):
                        """
                        Convergence criterion for projection to adjacent zones.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/adjacent_zone/project_converged").execute(*args, **kwargs)
                    def project_adjacent_angle(self, *args, **kwargs):
                        ...
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/adjacent_zone/project_adjacent_angle").execute(*args, **kwargs)
                    def project_iter(self, *args, **kwargs):
                        """
                        Maximum number of iterations for projection to adjacent zones.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/adjacent_zone/project_iter").execute(*args, **kwargs)
                    def project(self, *args, **kwargs):
                        """
                        Project outer nodes to adjacent planar zones?.
                        """
                        return PyMenu(self._service, self._version, self._mode, "/mesh/prism/controls/adjacent_zone/project").execute(*args, **kwargs)
            ...
            class split(TUIMenu):
                ...
                def split(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/prism/split/split").execute(*args, **kwargs)
            ...
            class post_ignore(TUIMenu):
                ...
                def mark_cavity_prism_cap(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/prism/post_ignore/mark_cavity_prism_cap").execute(*args, **kwargs)
                def post_remove_cells(self, *args, **kwargs):
                    """
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/prism/post_ignore/post_remove_cells").execute(*args, **kwargs)
                def create_cavity(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/prism/post_ignore/create_cavity").execute(*args, **kwargs)
                def mark_prism_cap(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/mesh/prism/post_ignore/mark_prism_cap").execute(*args, **kwargs)
    ...
    class file(TUIMenu):
        ...
        def read_multiple_mesh(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/file/read_multiple_mesh").execute(*args, **kwargs)
        ...
        def read_domains(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/file/read_domains").execute(*args, **kwargs)
        ...
        def write_domains(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/file/write_domains").execute(*args, **kwargs)
        ...
        def filter_list(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/file/filter_list").execute(*args, **kwargs)
        def file_format(self, *args, **kwargs):
            """
            Enables/disables the writing of binary files.
            """
            return PyMenu(self._service, self._version, self._mode, "/file/file_format").execute(*args, **kwargs)
        def read_meshes_by_tmerge(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/file/read_meshes_by_tmerge").execute(*args, **kwargs)
        def write_options(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/file/write_options").execute(*args, **kwargs)
        def read_boundary_mesh(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/file/read_boundary_mesh").execute(*args, **kwargs)
        ...
        def read_options(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/file/read_options").execute(*args, **kwargs)
        ...
        def read_mesh_vars(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/file/read_mesh_vars").execute(*args, **kwargs)
        def hdf_files(self, *args, **kwargs):
            """
            Indicate whether to write Ansys common fluids format (CFF) files or legacy case files.
            """
            return PyMenu(self._service, self._version, self._mode, "/file/hdf_files").execute(*args, **kwargs)
        def append_mesh(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/file/append_mesh").execute(*args, **kwargs)
        ...
        def read_mesh(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/file/read_mesh").execute(*args, **kwargs)
        def write_mesh_vars(self, *args, **kwargs):
            """
            Writes mesh varaibles to a file.
            """
            return PyMenu(self._service, self._version, self._mode, "/file/write_mesh_vars").execute(*args, **kwargs)
        def write_size_field(self, *args, **kwargs):
            """
            Enables you to write a size field file.
            """
            return PyMenu(self._service, self._version, self._mode, "/file/write_size_field").execute(*args, **kwargs)
        def write_boundaries(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/file/write_boundaries").execute(*args, **kwargs)
        def read_multi_bound_mesh(self, *args, **kwargs):
            """
            Enables you to read multiple boundary mesh files into the meshing mode.
            """
            return PyMenu(self._service, self._version, self._mode, "/file/read_multi_bound_mesh").execute(*args, **kwargs)
        def filter_options(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/file/filter_options").execute(*args, **kwargs)
        def read_size_field(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/file/read_size_field").execute(*args, **kwargs)
        ...
        def append_meshes_by_tmerge(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/file/append_meshes_by_tmerge").execute(*args, **kwargs)
        ...
        def write_mesh(self, *args, **kwargs):
            ...
            """
            return PyMenu(self._service, self._version, self._mode, "/file/write_mesh").execute(*args, **kwargs)
        ...
        class export(TUIMenu):
            ...
            def patran(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/file/export/patran").execute(*args, **kwargs)
            ...
            def hypermesh(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/file/export/hypermesh").execute(*args, **kwargs)
            def stl(self, *args, **kwargs):
                """
                Write a STL boundary mesh file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/export/stl").execute(*args, **kwargs)
            def ansys(self, *args, **kwargs):
                """
                Write a Ansys mesh file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/export/ansys").execute(*args, **kwargs)
        ...
        class import_(TUIMenu):
            ...
            def hypermesh_surf_mesh(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/hypermesh_surf_mesh").execute(*args, **kwargs)
            def ideas_surf_mesh(self, *args, **kwargs):
                """
                Read a surface mesh from an IDEAS universal file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/ideas_surf_mesh").execute(*args, **kwargs)
            def fidap_vol_mesh(self, *args, **kwargs):
                """
                Read a volume mesh from a FIDAP neutral file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/fidap_vol_mesh").execute(*args, **kwargs)
            def nastran_vol_mesh(self, *args, **kwargs):
                """
                Read a volume mesh from a NASTRAN file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/nastran_vol_mesh").execute(*args, **kwargs)
            def hypermesh_vol_mesh(self, *args, **kwargs):
                """
                Read a volume mesh from a HYPERMESH ascii file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/hypermesh_vol_mesh").execute(*args, **kwargs)
            def fidap_surf_mesh(self, *args, **kwargs):
                """
                Read a surface mesh from a FIDAP neutral file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/fidap_surf_mesh").execute(*args, **kwargs)
            def nastran_surf_mesh(self, *args, **kwargs):
                """
                Read a surface mesh from a NASTRAN file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/nastran_surf_mesh").execute(*args, **kwargs)
            def patran_vol_mesh(self, *args, **kwargs):
                """
                Read a volume mesh from a PATRAN neutral file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/patran_vol_mesh").execute(*args, **kwargs)
            def cad_geometry(self, *args, **kwargs):
                ...
                STL  \*.stl.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_geometry").execute(*args, **kwargs)
            def gambit_surf_mesh(self, *args, **kwargs):
                """
                Read a surface mesh from a GAMBIT neutral file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/gambit_surf_mesh").execute(*args, **kwargs)
            def patran_surf_mesh(self, *args, **kwargs):
                """
                Read a surface mesh from a PATRAN neutral file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/patran_surf_mesh").execute(*args, **kwargs)
            def fluent_3d_mesh(self, *args, **kwargs):
                """
                Read a 3D mesh.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/fluent_3d_mesh").execute(*args, **kwargs)
            def ansys_vol_mesh(self, *args, **kwargs):
                """
                Read a volume mesh from an Ansys prep7 or cdb file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/ansys_vol_mesh").execute(*args, **kwargs)
            def reimport_last_with_cfd_surface_mesh(self, *args, **kwargs):
                """
                Reimport CAD using the size field.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/reimport_last_with_cfd_surface_mesh").execute(*args, **kwargs)
            def stl(self, *args, **kwargs):
                """
                Read a surface mesh from a stereolithography (STL) file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/stl").execute(*args, **kwargs)
            def cgns_surf_mesh(self, *args, **kwargs):
                """
                Read a surface mesh from a CGNS format file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/cgns_surf_mesh").execute(*args, **kwargs)
            def cad(self, *args, **kwargs):
                ...
                STL  \*.stl.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/cad").execute(*args, **kwargs)
            def gambit_vol_mesh(self, *args, **kwargs):
                """
                Read a volume mesh from a GAMBIT neutral file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/gambit_vol_mesh").execute(*args, **kwargs)
            def fluent_2d_mesh(self, *args, **kwargs):
                """
                Read a 2D mesh.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/fluent_2d_mesh").execute(*args, **kwargs)
            def ideas_vol_mesh(self, *args, **kwargs):
                """
                Read a volume mesh from an IDEAS universal file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/ideas_vol_mesh").execute(*args, **kwargs)
            def fl_uns2_mesh(self, *args, **kwargs):
                """
                Read a mesh from a Fluent UNS V2 case file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/fl_uns2_mesh").execute(*args, **kwargs)
            def ansys_surf_mesh(self, *args, **kwargs):
                """
                Read a surface mesh from an Ansys prep7 or cdb file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/ansys_surf_mesh").execute(*args, **kwargs)
            def cgns_vol_mesh(self, *args, **kwargs):
                """
                Read a volume mesh from an CGNS format file.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/import_/cgns_vol_mesh").execute(*args, **kwargs)
            ...
            class cad_options(TUIMenu):
                ...
                def modify_all_duplicate_names(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/modify_all_duplicate_names").execute(*args, **kwargs)
                def name_separator_character(self, *args, **kwargs):
                    """
                    Character to be used as a separator in all names.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/name_separator_character").execute(*args, **kwargs)
                def one_object_per(self, *args, **kwargs):
                    """
                    Set one object per body, part or file.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/one_object_per").execute(*args, **kwargs)
                def enclosure_symm_processing(self, *args, **kwargs):
                    """
                    Processing of enclosure and symmetry named selections during import.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/enclosure_symm_processing").execute(*args, **kwargs)
                def strip_path_prefix_from_names(self, *args, **kwargs):
                    """
                    Strip path prefixes from naming.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/strip_path_prefix_from_names").execute(*args, **kwargs)
                def import_curvature_data_from_CAD(self, *args, **kwargs):
                    """
                    Import Curvature Data from CAD.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/import_curvature_data_from_CAD").execute(*args, **kwargs)
                def merge_objects_per_body_named_selection(self, *args, **kwargs):
                    """
                    Merge Objects per body named selection.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/merge_objects_per_body_named_selection").execute(*args, **kwargs)
                def read_all_cad_in_subdirectories(self, *args, **kwargs):
                    """
                    Recursive search for CAD files in sub-directories.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/read_all_cad_in_subdirectories").execute(*args, **kwargs)
                def import_body_names(self, *args, **kwargs):
                    """
                    Import Body names from the CAD files.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/import_body_names").execute(*args, **kwargs)
                def object_type(self, *args, **kwargs):
                    """
                    Object type for CAD files.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/object_type").execute(*args, **kwargs)
                def use_component_names(self, *args, **kwargs):
                    """
                    Use component names for CAD files.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/use_component_names").execute(*args, **kwargs)
                def save_PMDB(self, *args, **kwargs):
                    """
                    Saves PMDB file in the directory containing the CAD files imported.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/save_PMDB").execute(*args, **kwargs)
                def continue_on_error(self, *args, **kwargs):
                    """
                    Continue on error during cad import.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/continue_on_error").execute(*args, **kwargs)
                def one_face_zone_per(self, *args, **kwargs):
                    """
                    Set one object per body, face or object.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/one_face_zone_per").execute(*args, **kwargs)
                def extract_features(self, *args, **kwargs):
                    """
                    Set the feature angle.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/extract_features").execute(*args, **kwargs)
                def merge_nodes(self, *args, **kwargs):
                    """
                    Merge Nodes for CAD import.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/merge_nodes").execute(*args, **kwargs)
                def use_part_names(self, *args, **kwargs):
                    """
                    Use part names for CAD files.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/use_part_names").execute(*args, **kwargs)
                def named_selection_tessellation_failure(self, *args, **kwargs):
                    """
                    Set named selection for CFD surface mesh failures.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/named_selection_tessellation_failure").execute(*args, **kwargs)
                def single_connected_edge_label(self, *args, **kwargs):
                    """
                    Single connected edge label for CAD files.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/single_connected_edge_label").execute(*args, **kwargs)
                def import_label_for_body_named_selection(self, *args, **kwargs):
                    """
                    Import face zone labels for body named selections.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/import_label_for_body_named_selection").execute(*args, **kwargs)
                def use_body_names(self, *args, **kwargs):
                    """
                    Use body names for CAD files.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/use_body_names").execute(*args, **kwargs)
                def separate_features_by_type(self, *args, **kwargs):
                    """
                    Separate features by type.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/separate_features_by_type").execute(*args, **kwargs)
                def strip_file_name_extension_from_naming(self, *args, **kwargs):
                    """
                    Strip file name extension from naming.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/strip_file_name_extension_from_naming").execute(*args, **kwargs)
                def named_selections(self, *args, **kwargs):
                    """
                    Allows to import Named Selections from the CAD file.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/named_selections").execute(*args, **kwargs)
                def double_connected_face_label(self, *args, **kwargs):
                    """
                    Double connected face label for CAD files.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/double_connected_face_label").execute(*args, **kwargs)
                def use_part_or_body_names_as_suffix_to_named_selections(self, *args, **kwargs):
                    ...
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/use_part_or_body_names_as_suffix_to_named_selections").execute(*args, **kwargs)
                def create_label_per_body_during_cad_faceting(self, *args, **kwargs):
                    """
                    Create label Per Body during cad faceting.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/create_label_per_body_during_cad_faceting").execute(*args, **kwargs)
                def replacement_character(self, *args, **kwargs):
                    """
                    Name replacement character.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/replacement_character").execute(*args, **kwargs)
                def tessellation(self, *args, **kwargs):
                    """
                    Set tessellation controls for cad import.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/tessellation").execute(*args, **kwargs)
                def use_collection_names(self, *args, **kwargs):
                    """
                    Use collection names for CAD files.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/use_collection_names").execute(*args, **kwargs)
                def import_part_names(self, *args, **kwargs):
                    """
                    Import Part names from the CAD files.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/import_part_names").execute(*args, **kwargs)
                def reconstruct_topology(self, *args, **kwargs):
                    """
                    Reconstruct topology for STL files.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/reconstruct_topology").execute(*args, **kwargs)
                def create_cad_assemblies(self, *args, **kwargs):
                    """
                    Import CAD Assemblies.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/create_cad_assemblies").execute(*args, **kwargs)
                def derive_zone_name_from_object_scope(self, *args, **kwargs):
                    """
                    Derive zone names from object scope.
                    """
                    return PyMenu(self._service, self._version, self._mode, "/file/import_/cad_options/derive_zone_name_from_object_scope").execute(*args, **kwargs)
        ...
        class checkpoint(TUIMenu):
            ...
            def restore_checkpoint(self, *args, **kwargs):
                ...
                """
                return PyMenu(self._service, self._version, self._mode, "/file/checkpoint/restore_checkpoint").execute(*args, **kwargs)
            def list_checkpoint_names(self, *args, **kwargs):
                """
                Get all checkpoint names.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/checkpoint/list_checkpoint_names").execute(*args, **kwargs)
            def delete_checkpoint(self, *args, **kwargs):
                """
                Delete checkpoint.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/checkpoint/delete_checkpoint").execute(*args, **kwargs)
            def write_checkpoint(self, *args, **kwargs):
                """
                Write checkpoint.
                """
                return PyMenu(self._service, self._version, self._mode, "/file/checkpoint/write_checkpoint").execute(*args, **kwargs)
