...
class CncMachineOperationSearchResultDtoPagedResult(_serialization.Model):
...
class CncPartListDto(_serialization.Model):
    """CncPartListDto.
...
class CncToolSubTypeDto(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        *,
        ...
        geometry_helper_text: Optional[str] = None,
        size_helper_text: Optional[str] = None,
        diameter_helper_text: Optional[str] = None,
        grade_helper_text: Optional[str] = None,
        radius_helper_text: Optional[str] = None,
        width_helper_text: Optional[str] = None,
        pitch_helper_text: Optional[str] = None,
        length_helper_text: Optional[str] = None,
        kapr_helper_text: Optional[str] = None,
        teeth_helper_text: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword id: Required.
...
class CreateAsset(_serialization.Model):
    ...
    def __init__(self, *, parent_id: Optional[int] = None, **kwargs: Any) -> None:
        """
        :keyword parent_id:
        :paramtype parent_id: int
        """
...
class CreateMeasurementFormSchemaFeedbackRequest(_serialization.Model):
...
class CurrentWorkActivityDto(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar id: Required.
    :vartype id: str
    :ivar workorder_id: Required.
    :vartype workorder_id: str
    ...
    :ivar operation_started_quantity:
    :vartype operation_started_quantity: float
    :ivar part_number:
    :vartype part_number: str
    :ivar part_name:
    :vartype part_name: str
    ...
    :ivar material_pick_status: Required. Known values are: "NotRequired", "NotStarted", "Partial",
    ...
    _validation = {
        "id": {"required": True, "min_length": 1},
        "workorder_id": {"required": True, "min_length": 1},
    ...
    _attribute_map = {
        "id": {"key": "id", "type": "str"},
        "workorder_id": {"key": "workorderId", "type": "str"},
        "company_id": {"key": "companyId", "type": "str"},
        "operation": {"key": "operation", "type": "int"},
        ...
        "operation_started_quantity": {"key": "operationStartedQuantity", "type": "float"},
        "part_number": {"key": "partNumber", "type": "str"},
        "part_name": {"key": "partName", "type": "str"},
    ...
    def __init__(
        ...
        *,
        ...
        operation_started_quantity: Optional[float] = None,
        part_number: Optional[str] = None,
        part_name: Optional[str] = None,
        ...
        **kwargs: Any
        ...
        :keyword id: Required.
        :paramtype id: str
        :keyword workorder_id: Required.
        :paramtype workorder_id: str
        ...
        :keyword operation_started_quantity:
        :paramtype operation_started_quantity: float
        :keyword part_number:
        :paramtype part_number: str
        :keyword part_name:
        :paramtype part_name: str
        ...
        self.operation_started_quantity = operation_started_quantity
        self.part_number = part_number
        self.part_name = part_name
...
class DrawingFileDto(_serialization.Model):
    ...
    def __init__(
        self, *, id: int, name: str, title: Optional[str] = None, **kwargs: Any  # pylint: disable=redefined-builtin
    ) -> None:
        """
        :keyword id: Required.
        :paramtype id: int
...
class MachineInactivityCriteriaDto(_serialization.Model):
    ...
    :ivar machine_external_id:
    :vartype machine_external_id: str
    :ivar inactivity_period_in_minutes:
    ...
    def __init__(
        self,
        *,
        machine_external_id: Optional[str] = None,
        inactivity_period_in_minutes: Optional[int] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword machine_external_id:
        :paramtype machine_external_id: str
        :keyword inactivity_period_in_minutes:
...
class MachineInactivityCriteriaDtoAlertSubscriptionDto(_serialization.Model):
    ...
    :ivar notification_channel: "Teams"
    ...
    def __init__(
        ...
        *,
        ...
        description: Optional[str] = None,
        subscriber: Optional["_models.SubscriberDto"] = None,
        notification_channel: Optional[Union[str, "_models.NotificationChannelDto"]] = None,
        criteria: Optional["_models.MachineInactivityCriteriaDto"] = None,
        ...
        **kwargs: Any
        ...
        :keyword notification_channel: "Teams"
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword material_status: Known values are: "NotRequired", "NotAvailable",
         "PartiallyAvailable", "Available", and "Unknown".
...
class MeasurementFormInstanceOverviewDtoPagedResult(_serialization.Model):
...
class MeasurementFormSchemaNotNeededDtoPagedResult(_serialization.Model):
...
class MeasuringToolSettingsDto(_serialization.Model):
    ...
    :ivar disable_user_defined_identifiers_for_calibrated_tools:
    ...
    def __init__(
        self,
        *,
        disable_user_defined_identifiers_for_calibrated_tools: Optional[bool] = None,
        disable_user_defined_identifiers_for_uncalibrated_tools: Optional[bool] = None,
        **kwargs: Any
    ) -> None:
        """
...
class MrbCompanySettingsDto(_serialization.Model):
    ...
    :ivar stamp_with_heat: Required.
    :vartype stamp_with_heat: bool
    :ivar hide_lot_info: Required.
    :vartype hide_lot_info: bool
    :ivar hide_heat_info: Required.
    :vartype hide_heat_info: bool
    :ivar lot_label:
    :vartype lot_label: str
    :ivar heat_label:
    :vartype heat_label: str
    :ivar co_c_statement:
    ...
    _validation = {
        ...
        "stamp_with_heat": {"required": True},
        "hide_lot_info": {"required": True},
        "hide_heat_info": {"required": True},
        "address_lines": {"required": True},
    }

    _attribute_map = {
        "stamp_with_lot": {"key": "stampWithLot", "type": "bool"},
        "stamp_with_heat": {"key": "stampWithHeat", "type": "bool"},
        "hide_lot_info": {"key": "hideLotInfo", "type": "bool"},
        "hide_heat_info": {"key": "hideHeatInfo", "type": "bool"},
        "lot_label": {"key": "lotLabel", "type": "str"},
        "heat_label": {"key": "heatLabel", "type": "str"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword stamp_with_heat: Required.
        :paramtype stamp_with_heat: bool
        :keyword hide_lot_info: Required.
        :paramtype hide_lot_info: bool
        :keyword hide_heat_info: Required.
        :paramtype hide_heat_info: bool
        :keyword lot_label:
        :paramtype lot_label: str
        :keyword heat_label:
        :paramtype heat_label: str
        ...
        self.stamp_with_heat = stamp_with_heat
        self.hide_lot_info = hide_lot_info
        self.hide_heat_info = hide_heat_info
        self.lot_label = lot_label
        self.heat_label = heat_label
...
class PickListSuggestionDto(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar suggested:
    :vartype suggested: ~ignos.api.client.models.InventoryDto
    :ivar available: Required.
    ...
    _attribute_map = {
        ...
        "suggested": {"key": "suggested", "type": "InventoryDto"},
    ...
    def __init__(
        ...
        *,
        ...
        suggested: Optional["_models.InventoryDto"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword position:
        ...
        :keyword suggested:
        :paramtype suggested: ~ignos.api.client.models.InventoryDto
        :keyword available: Required.
...
class ProductionEmployeeDto(_serialization.Model):
    ...
    :ivar name: Required.
    :vartype name: str
    :ivar employment_legal_entity_id:
    :vartype employment_legal_entity_id: str
    :ivar dimension_display_value:
    :vartype dimension_display_value: str
    """
    ...
    _attribute_map = {
        "id": {"key": "id", "type": "str"},
        "name": {"key": "name", "type": "str"},
        "employment_legal_entity_id": {"key": "employmentLegalEntityId", "type": "str"},
        "dimension_display_value": {"key": "dimensionDisplayValue", "type": "str"},
    }
    ...
    def __init__(
        ...
        *,
        id: str,  # pylint: disable=redefined-builtin
        name: str,
        employment_legal_entity_id: Optional[str] = None,
        dimension_display_value: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword id: Required.
        ...
        :keyword name: Required.
        :paramtype name: str
        :keyword employment_legal_entity_id:
        :paramtype employment_legal_entity_id: str
        :keyword dimension_display_value:
        :paramtype dimension_display_value: str
        """
        super().__init__(**kwargs)
        self.id = id
        self.name = name
...
class SaveMeasurementFormInstanceSchemaCommentRequest(_serialization.Model):
...
class SetCurrentProductionCompany(_serialization.Model):
    """SetCurrentProductionCompany.
...
class SetMeasurementFormSchemaFeedbackUserRequest(_serialization.Model):
...
class StartOperationDto(_serialization.Model):
    ...
    def __init__(
        self, *, work_order: str, operation_number: int, started_quantity: Optional[int] = None, **kwargs: Any
    ) -> None:
        """
        :keyword work_order: Required.
        :paramtype work_order: str
...
class SubscribeToMachineInactivityAlerts(_serialization.Model):
    ...
    def __init__(self, *, criteria: Optional["_models.MachineInactivityCriteriaDto"] = None, **kwargs: Any) -> None:
        """
        :keyword criteria:
        :paramtype criteria: ~ignos.api.client.models.MachineInactivityCriteriaDto
        """
...
class SurroundingOperationDto(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar status: Required. Known values are: "NotReady", "Ready", "Ongoing", "Completed", and
     "Stopped".
    :vartype status: str or ~ignos.api.client.models.OperationStatusDto
    :ivar resource_group_id: Required.
    ...
    _validation = {
        ...
        "planned_start": {"required": True},
        "status": {"required": True},
        "resource_group_id": {"required": True, "min_length": 1},
        "resource_id": {"required": True, "min_length": 1},
        "resource_name": {"required": True, "min_length": 1},
        "produced_quantity": {"required": True},
        "scrapped_quantity": {"required": True},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword status: Required. Known values are: "NotReady", "Ready", "Ongoing", "Completed", and
         "Stopped".
        :paramtype status: str or ~ignos.api.client.models.OperationStatusDto
        :keyword resource_group_id: Required.
...
class TraceItemConsumptionDto(_serialization.Model):
    ...
    _validation = {
        "trace_number": {"required": True, "min_length": 1},
...
class UpdateCncMachineCommunicationSettingsRequest(_serialization.Model):
...
class UpdateCncMachineOperationRequest(_serialization.Model):
...
class UpdateMachineInactivitySubscription(_serialization.Model):
    ...
    def __init__(self, *, subscription_id: str, enabled: Optional[bool] = None, **kwargs: Any) -> None:
        """
...
class UpsertMrbCompanySettings(_serialization.Model):
...
class UpsertSupplierToMeasurementFormInstanceRequest(_serialization.Model):
