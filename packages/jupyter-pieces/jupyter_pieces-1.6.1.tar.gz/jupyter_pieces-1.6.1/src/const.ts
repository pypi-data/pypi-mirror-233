...
export default class Constants {
  ...
  public static readonly PIECES_SNIPPET_LIST_VIEW_TYPE = 'pieces-snippet-list';
  ...
  public static readonly TOGGLE_AUTODISCOVER =
    'Auto-Discover snippets from your vault';
  public static readonly TOGGLE_AUTODISCOVER_DESC =
    'Automatically discover snippets from your vault when opening Pieces.';
  ...
  public static readonly NO_SELECTION_SAVE =
    'Make sure to select some snippets before you try to save';
  ...
  public static readonly RECLASSIFY_FAILURE =
    'Error Reclassifying snippet, please try again... or contact support@pieces.app';
  public static readonly UPDATE_SUCCESS = 'Snippet successfully updated';
  public static readonly UPDATE_FAILURE =
    'Error updating snippet, please try again... or contact support@pieces.app';
  public static readonly UPDATE_CODE_SUCCESS =
    'Snippet code successfully updated';
  public static readonly UPDATE_CODE_FAILURE =
    'Error updating snippet code, please try again... or contact support@pieces.app';
