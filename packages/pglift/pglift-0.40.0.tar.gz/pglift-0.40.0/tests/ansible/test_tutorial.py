...
def site_settings(
    ...
    if pgbackrest_execpath is not None:
        settings["pgbackrest"] = {
            ...
            "repository": {"mode": "path", "path": str(tmp_path / "pgbackups")},
        }
    ...
    if temboard_execpath:
        temboard_signing_key = tmp_path / "temboard-agent-signing-public.pem"
        cert = cert_factory(common_name="temboard-agent")
        settings["temboard"] = {
