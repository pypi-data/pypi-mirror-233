...
.. note:: The ``repository`` key is required.
...
The base pgBackRest configuration is installed site-wise from a template which
...
In this mode, you can then either use `TLS with client certificates` or
