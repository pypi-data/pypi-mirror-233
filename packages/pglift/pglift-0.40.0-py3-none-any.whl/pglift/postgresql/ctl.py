...
def replication_lag(instance: "PostgreSQLInstance") -> Optional[Decimal]:
...
def wal_sender_state(instance: "PostgreSQLInstance") -> Optional[WALSenderState]:
...
def libpq_environ(
    instance: "BaseInstance", role: str, *, base: Optional[dict[str, str]] = None
) -> dict[str, str]:
