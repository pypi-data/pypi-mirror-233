...
from takamol_einvoicer_test_kit2.einvoices.constants import SELLER_INFO
...
class Item(models.Model):
    ...
    invoice_content_type = models.ForeignKey(ContentType, on_delete=models.CASCADE, related_name='items')
