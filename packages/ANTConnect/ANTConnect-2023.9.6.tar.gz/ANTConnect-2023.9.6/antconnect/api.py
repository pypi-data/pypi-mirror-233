...
class API:
    ...
    def _make_api_request(self, path: str, method: str, parameters: dict = None,
    ...
    def tables_query(self, project_id: str, queryBody, limit=1000, offset=0):
        """ Get all columns in a table """
        path = 'project/{}/tables/query?limit={}&offset='.format(project_id, limit, offset)
