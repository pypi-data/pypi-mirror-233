...
class MigrationClient(object):
    ...
    def cancel_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/cancel_work_request.py.html>`__ to see an example of how to use cancel_work_request API.
        """
    ...
    def change_migration_compartment(self, migration_id, change_migration_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/change_migration_compartment.py.html>`__ to see an example of how to use change_migration_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_migration_plan_compartment(self, migration_plan_id, change_migration_plan_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/change_migration_plan_compartment.py.html>`__ to see an example of how to use change_migration_plan_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        if extra_kwargs:
            raise ValueError(
                "change_migration_plan_compartment got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def change_replication_schedule_compartment(self, replication_schedule_id, change_replication_schedule_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/change_replication_schedule_compartment.py.html>`__ to see an example of how to use change_replication_schedule_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        if extra_kwargs:
            raise ValueError(
                "change_replication_schedule_compartment got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def create_migration(self, create_migration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/create_migration.py.html>`__ to see an example of how to use create_migration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_migration_asset(self, create_migration_asset_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/create_migration_asset.py.html>`__ to see an example of how to use create_migration_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        ...
        if extra_kwargs:
            raise ValueError(
                "create_migration_asset got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def create_migration_plan(self, create_migration_plan_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/create_migration_plan.py.html>`__ to see an example of how to use create_migration_plan API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        ...
        if extra_kwargs:
            raise ValueError(
                "create_migration_plan got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def create_replication_schedule(self, create_replication_schedule_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/create_replication_schedule.py.html>`__ to see an example of how to use create_replication_schedule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        ...
        if extra_kwargs:
            raise ValueError(
                "create_replication_schedule got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def create_target_asset(self, create_target_asset_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/create_target_asset.py.html>`__ to see an example of how to use create_target_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        ...
        if extra_kwargs:
            raise ValueError(
                "create_target_asset got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def delete_migration(self, migration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/delete_migration.py.html>`__ to see an example of how to use delete_migration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationId']
    ...
    def delete_migration_asset(self, migration_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/delete_migration_asset.py.html>`__ to see an example of how to use delete_migration_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        if extra_kwargs:
            raise ValueError(
                "delete_migration_asset got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def delete_migration_plan(self, migration_plan_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/delete_migration_plan.py.html>`__ to see an example of how to use delete_migration_plan API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationPlanId']
        ...
        if extra_kwargs:
            raise ValueError(
                "delete_migration_plan got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def delete_replication_schedule(self, replication_schedule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/delete_replication_schedule.py.html>`__ to see an example of how to use delete_replication_schedule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['replicationScheduleId']
        ...
        if extra_kwargs:
            raise ValueError(
                "delete_replication_schedule got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def delete_target_asset(self, target_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/delete_target_asset.py.html>`__ to see an example of how to use delete_target_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        if extra_kwargs:
            raise ValueError(
                "delete_target_asset got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def execute_migration_plan(self, migration_plan_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/execute_migration_plan.py.html>`__ to see an example of how to use execute_migration_plan API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationPlanId']
        ...
        if extra_kwargs:
            raise ValueError(
                "execute_migration_plan got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def export_migration_plan(self, migration_plan_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/export_migration_plan.py.html>`__ to see an example of how to use export_migration_plan API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationPlanId']
        ...
        if extra_kwargs:
            raise ValueError(
                "export_migration_plan got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def get_migration(self, migration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/get_migration.py.html>`__ to see an example of how to use get_migration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationId']
        resource_path = "/migrations/{migrationId}"
    ...
    def get_migration_asset(self, migration_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/get_migration_asset.py.html>`__ to see an example of how to use get_migration_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationAssetId']
        resource_path = "/migrationAssets/{migrationAssetId}"
        ...
        if extra_kwargs:
            raise ValueError(
                "get_migration_asset got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def get_migration_plan(self, migration_plan_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/get_migration_plan.py.html>`__ to see an example of how to use get_migration_plan API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationPlanId']
        resource_path = "/migrationPlans/{migrationPlanId}"
        ...
        if extra_kwargs:
            raise ValueError(
                "get_migration_plan got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def get_replication_progress(self, migration_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/get_replication_progress.py.html>`__ to see an example of how to use get_replication_progress API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationAssetId']
        ...
        if extra_kwargs:
            raise ValueError(
                "get_replication_progress got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def get_replication_schedule(self, replication_schedule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/get_replication_schedule.py.html>`__ to see an example of how to use get_replication_schedule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['replicationScheduleId']
        resource_path = "/replicationSchedules/{replicationScheduleId}"
        ...
        if extra_kwargs:
            raise ValueError(
                "get_replication_schedule got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def get_target_asset(self, target_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/get_target_asset.py.html>`__ to see an example of how to use get_target_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['targetAssetId']
        resource_path = "/targetAssets/{targetAssetId}"
        ...
        if extra_kwargs:
            raise ValueError(
                "get_target_asset got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
        resource_path = "/workRequests/{workRequestId}"
    ...
    def import_migration_plan(self, migration_plan_id, import_migration_plan_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/import_migration_plan.py.html>`__ to see an example of how to use import_migration_plan API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationPlanId']
        ...
        if extra_kwargs:
            raise ValueError(
                "import_migration_plan got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def list_available_shapes(self, migration_plan_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/list_available_shapes.py.html>`__ to see an example of how to use list_available_shapes API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationPlanId']
        ...
        if extra_kwargs:
            raise ValueError(
                "list_available_shapes got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def list_migration_assets(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/list_migration_assets.py.html>`__ to see an example of how to use list_migration_assets API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/migrationAssets"
        ...
        if extra_kwargs:
            raise ValueError(
                "list_migration_assets got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def list_migration_plans(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/list_migration_plans.py.html>`__ to see an example of how to use list_migration_plans API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/migrationPlans"
        ...
        if extra_kwargs:
            raise ValueError(
                "list_migration_plans got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def list_migrations(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/list_migrations.py.html>`__ to see an example of how to use list_migrations API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/migrations"
    ...
    def list_replication_schedules(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/list_replication_schedules.py.html>`__ to see an example of how to use list_replication_schedules API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/replicationSchedules"
        ...
        if extra_kwargs:
            raise ValueError(
                "list_replication_schedules got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def list_target_assets(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/list_target_assets.py.html>`__ to see an example of how to use list_target_assets API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/targetAssets"
        ...
        if extra_kwargs:
            raise ValueError(
                "list_target_assets got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_requests(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def refresh_migration(self, migration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/refresh_migration.py.html>`__ to see an example of how to use refresh_migration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationId']
        ...
        if extra_kwargs:
            raise ValueError(
                "refresh_migration got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def refresh_migration_asset(self, migration_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/refresh_migration_asset.py.html>`__ to see an example of how to use refresh_migration_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationAssetId']
        ...
        if extra_kwargs:
            raise ValueError(
                "refresh_migration_asset got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def refresh_migration_plan(self, migration_plan_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/refresh_migration_plan.py.html>`__ to see an example of how to use refresh_migration_plan API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationPlanId']
        ...
        if extra_kwargs:
            raise ValueError(
                "refresh_migration_plan got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def start_asset_replication(self, migration_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/start_asset_replication.py.html>`__ to see an example of how to use start_asset_replication API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationAssetId']
        ...
        if extra_kwargs:
            raise ValueError(
                "start_asset_replication got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def start_migration_replication(self, migration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/start_migration_replication.py.html>`__ to see an example of how to use start_migration_replication API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationId']
        ...
        if extra_kwargs:
            raise ValueError(
                "start_migration_replication got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def update_migration(self, migration_id, update_migration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/update_migration.py.html>`__ to see an example of how to use update_migration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationId']
        resource_path = "/migrations/{migrationId}"
    ...
    def update_migration_asset(self, migration_asset_id, update_migration_asset_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/update_migration_asset.py.html>`__ to see an example of how to use update_migration_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationAssetId']
        resource_path = "/migrationAssets/{migrationAssetId}"
        ...
        if extra_kwargs:
            raise ValueError(
                "update_migration_asset got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def update_migration_plan(self, migration_plan_id, update_migration_plan_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/update_migration_plan.py.html>`__ to see an example of how to use update_migration_plan API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationPlanId']
        resource_path = "/migrationPlans/{migrationPlanId}"
        ...
        if extra_kwargs:
            raise ValueError(
                "update_migration_plan got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def update_replication_schedule(self, replication_schedule_id, update_replication_schedule_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/update_replication_schedule.py.html>`__ to see an example of how to use update_replication_schedule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['replicationScheduleId']
        resource_path = "/replicationSchedules/{replicationScheduleId}"
        ...
        if extra_kwargs:
            raise ValueError(
                "update_replication_schedule got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def update_target_asset(self, target_asset_id, update_target_asset_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.112.3/cloudmigrations/update_target_asset.py.html>`__ to see an example of how to use update_target_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['targetAssetId']
        resource_path = "/targetAssets/{targetAssetId}"
        ...
        if extra_kwargs:
            raise ValueError(
                "update_target_asset got unknown kwargs: {!r}".format(extra_kwargs))
