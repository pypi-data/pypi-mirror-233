...
class Numeric(object):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_destroy__ = native_driver_python.delete_Numeric

# Register Numeric in native_driver_python:
native_driver_python.Numeric_swigregister(Numeric)
class NumericGroup(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_destroy__ = native_driver_python.delete_NumericGroup

# Register NumericGroup in native_driver_python:
native_driver_python.NumericGroup_swigregister(NumericGroup)
class NumericGroupIterator(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_destroy__ = native_driver_python.delete_NumericGroupIterator

# Register NumericGroupIterator in native_driver_python:
native_driver_python.NumericGroupIterator_swigregister(NumericGroupIterator)
...
def numeric_get_double(numeric):
    return native_driver_python.numeric_get_double(numeric)

def numeric_get_long(numeric):
    return native_driver_python.numeric_get_long(numeric)

def numeric_is_double(numeric):
    return native_driver_python.numeric_is_double(numeric)

def numeric_is_long(numeric):
    return native_driver_python.numeric_is_long(numeric)

def numeric_is_nan(numeric):
    return native_driver_python.numeric_is_nan(numeric)

def numeric_to_string(numeric):
    return native_driver_python.numeric_to_string(numeric)

def numeric_group_to_string(numeric_group):
    return native_driver_python.numeric_group_to_string(numeric_group)

def numeric_group_equals(lhs, rhs):
    return native_driver_python.numeric_group_equals(lhs, rhs)

def numeric_group_get_owner(numeric_group):
    return native_driver_python.numeric_group_get_owner(numeric_group)

def numeric_group_get_numeric(numeric_group):
    return native_driver_python.numeric_group_get_numeric(numeric_group)
...
def connection_open_plaintext(address):
    return native_driver_python.connection_open_plaintext(address)

def connection_open_encrypted(addresses, credential):
    return native_driver_python.connection_open_encrypted(addresses, credential)
...
def replica_info_get_address(replica_info):
    return native_driver_python.replica_info_get_address(replica_info)
...
def query_match(transaction, query, options):
    return native_driver_python.query_match(transaction, query, options)
...
def query_match_aggregate(transaction, query, options):
    return native_driver_python.query_match_aggregate(transaction, query, options)

def concept_map_group_iterator_next(it):
    return native_driver_python.concept_map_group_iterator_next(it)

def query_match_group(transaction, query, options):
    return native_driver_python.query_match_group(transaction, query, options)

def numeric_group_iterator_next(it):
    return native_driver_python.numeric_group_iterator_next(it)

def query_match_group_aggregate(transaction, query, options):
    return native_driver_python.query_match_group_aggregate(transaction, query, options)
...
def session_new(database, session_type, options):
    return native_driver_python.session_new(database, session_type, options)
