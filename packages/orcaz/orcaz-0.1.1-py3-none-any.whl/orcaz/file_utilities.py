...
#
# Description:
# This module contains the functions for performing file operations for the orca.
#
# Usage:
# The functions in this module can be imported and used in other modules within the orca to perform file operations.
#
# ----------------------------------------------------------------------------------------------------------------------
import os
import glob
...
def organise_files_by_modality(tracer_dirs: list, modalities: list, orca_dir) -> None:
    """
    Organises the files by modality.
    :param tracer_dirs: The list of tracer directories
    :param modalities: The list of modalities.
    :param orca_dir: The path to the orca directory.
    """
    for modality in modalities:
        files_to_copy = select_files_by_modality(tracer_dirs, modality)
        copy_files_to_destination(files_to_copy, os.path.join(orca_dir, modality))
