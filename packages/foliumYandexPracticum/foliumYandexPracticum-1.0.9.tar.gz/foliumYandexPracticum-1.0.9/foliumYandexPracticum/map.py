...
from foliumYandexPracticum.utilities import validate_location, camelize, parse_options, image_to_url
...
class Marker(MacroElement):
    ...
    def __init__(self, location=None, 
                 popup=None, 
                 tooltip=None, 
                 icon=CustomIcon(icon_image= 'https://code.s3.yandex.net/data_faculty/folium/marker.svg',
                                 icon_size=(50,50)),
