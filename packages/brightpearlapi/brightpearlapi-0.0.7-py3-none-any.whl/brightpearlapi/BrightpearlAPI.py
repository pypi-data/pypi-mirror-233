from src.brightpearlapi.services.OrdersClient import OrdersClient
from src.brightpearlapi.services.ContactClient import ContactClient
from src.brightpearlapi.services.WarehouseClient import WarehouseClient
from src.brightpearlapi.services.ProductClient import ProductClient
...
class BrightpearlAPI:
    def __init__(self, client_id=None, client_secret=None, oauth=False, account_id=None, datacenter=None,
        ...
        self.Warehouse = WarehouseClient(datacenter=self.datacenter, account_id=self.account_id,
                                         app_ref=self.app_ref, access_token=self.access_token)
        self.Contacts = ContactClient(datacenter=self.datacenter, account_id=self.account_id,
                                      app_ref=self.app_ref, access_token=self.access_token)
        self.Products = ProductClient(datacenter=self.datacenter, account_id=self.account_id,
                                      app_ref=self.app_ref, access_token=self.access_token)
