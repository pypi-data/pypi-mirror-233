"""
upload format
python -m twine upload dist/* -u __token__ -p pypi-***
...
def __calc_lim(parsed_equation : dict, x_goes_towards : str, side, precision : int = 50) -> str:
    ...
    lim_out = __remove_trailing_0(round(lim, precision))
    lim_out_mprecise = __remove_trailing_0(round(lim_mprecise, precision + 5))
...
def calculate(equation : str, x_val : str = None) -> str:
    ...
    x_val : str = None, optional
        ...
        Ex: "54"
    """
    parsed_equation, lim_x_vals = parser(equation)
...
print(__calculate(out, lim_x_vals=lim))