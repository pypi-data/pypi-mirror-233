...
from flow_agent_package.tools.contracts import AgentSkillConfiguration, MLIndexSkillConfiguration, FlowSkillConfiguration, ArbitrationMethod
...
from flow_agent_package.tools.flow_skill import FlowSkill
from flow_agent_package.tools.index_skill import MLIndexSkill


class ArbitrationAgent:

  def __init__(self, arbitration_method, agent_connection, deployment_name, skills, memory_manager):
...
def agent(
  ...
  # resource_group_name="baker-static"
  # workspace_name= "baker-eastus2"
