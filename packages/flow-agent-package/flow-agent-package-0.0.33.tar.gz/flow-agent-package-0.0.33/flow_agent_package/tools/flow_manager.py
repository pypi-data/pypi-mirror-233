...
class SubFlowManager:
    ...
    def __exit__(self, *args):
        ...
        primary_flow_log_path = self.active_log_context.file_path
        ...
        with open(primary_flow_log_path, "a") as main_log:
            main_log.write(sub_log_data)
...
class FlowManager:
    ...
    def execute_yaml_flow(self, inputs):
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            # return self.local_client.get_details(base_run)[f"outputs.{self.output}"][0]
