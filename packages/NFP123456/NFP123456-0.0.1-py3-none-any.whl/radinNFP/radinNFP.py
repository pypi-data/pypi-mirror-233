...
# s = NFP(polygon1,polygon2)      

# plt.clf()  # Clear the previous plot
# ax = plt.gca()  # Get the current axis

# polygon1_patch = patches.Polygon(polygon1, closed=True, edgecolor='blue', facecolor='none')
# polygon2_patch = patches.Polygon(polygon2, closed=True, edgecolor='green', facecolor='none') 
# s_patch = patches.Polygon(s, closed=True, edgecolor='red', facecolor='none')
# # Plot the polygons and NFP for this iteration
# ax.add_patch(polygon1_patch)
# ax.add_patch(polygon2_patch)
# ax.add_patch(s_patch)
