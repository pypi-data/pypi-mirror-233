...
from .pipeline import (Task, QueueTask, IntegrationTask, LogicModuleTask, AnalyticsTask, EventWorkOrderTask,
                       DiscoverableIntegrationTask, BlobTask)
...
class Automation:
    ...
    def deploy_as_blob_data_feed(task: BlobTask,
        ...
        # TODO - API needs to be updated to support sourceType = "Blob" before this new deployment method will function
        #  & so package shouldn't be deployed to PyPI until API/TaskEngine updates are complete
        payload = {
            "dataFeedId": str(data_feed_id),
            "driverId": str(task.id),
            "name": data_feed_name,
