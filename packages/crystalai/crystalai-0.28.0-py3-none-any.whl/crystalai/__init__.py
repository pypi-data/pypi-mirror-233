# Crystal Computing AI Python bindings.
#
# Originally forked from the MIT-licensed OpenAI Python bindings
# In turn forked from the MIT-licensed Stripe Python bindings.
...
from crystalai.api_resources import (
    Audio,
    ChatCompletion,
    Completion,
    Customer,
...
from crystalai.error import APIError, InvalidRequestError, OpenAIError
from crystalai.version import VERSION

if TYPE_CHECKING:
    import requests
    from aiohttp import ClientSession

api_key = os.environ.get("CRYSTALAI_API_KEY")
...
api_key_path: Optional[str] = os.environ.get("CRYSTALAI_API_KEY_PATH")

organization = os.environ.get("CRYSTALAI_ORGANIZATION")
api_base = os.environ.get("CRYSTALAI_API_BASE", "https://api.crystalcomputing.com/v1")
api_type = os.environ.get("CRYSTALAI_API_TYPE", "open_ai")
api_version = os.environ.get(
    "CRYSTALAI_API_VERSION",
