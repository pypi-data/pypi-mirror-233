...
from crystalai.datalib.pandas_helper import assert_has_pandas
from crystalai.datalib.pandas_helper import pandas as pd
...
def common_prompt_suffix_validator(df):
    ...
    if common_suffix != "":
        ...
        immediate_msg = "\n- Your data does not contain a common separator at the end of your prompts. Having a separator string appended to the end of the prompt makes it clearer to the fine-tuned model where the completion should begin. See https://platform.crystalcomputing.com/docs/guides/fine-tuning/preparing-your-dataset for more detail and examples. If you intend to do open-ended generation, then you should leave the prompts empty"
...
def common_completion_suffix_validator(df):
    ...
    if common_suffix != "":
        ...
        immediate_msg = "\n- Your data does not contain a common ending at the end of your completions. Having a common ending string appended to the end of the completion makes it clearer to the fine-tuned model where the completion should end. See https://platform.crystalcomputing.com/docs/guides/fine-tuning/preparing-your-dataset for more detail and examples."
...
def completions_space_start_validator(df):
    ...
    if df.completion.str[:1].nunique() != 1 or df.completion.values[0][0] != " ":
        immediate_msg = "\n- The completion should start with a whitespace character (` `). This tends to produce better results due to the tokenization we use. See https://platform.crystalcomputing.com/docs/guides/fine-tuning/preparing-your-dataset for more details"
...
def lower_case_validator(df, column):
    ...
    if count_upper * 2 > count_lower:
        return Remediation(
            name="lower_case",
            immediate_msg=f"\n- More than a third of your `{column}` column/key is uppercase. Uppercase {column}s tends to perform worse than a mixture of case encountered in normal language. We recommend to lower case the data if that makes sense in your domain. See https://platform.crystalcomputing.com/docs/guides/fine-tuning/preparing-your-dataset for more details",
