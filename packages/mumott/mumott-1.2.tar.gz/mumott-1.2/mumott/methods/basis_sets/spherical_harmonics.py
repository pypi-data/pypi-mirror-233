...
class SphericalHarmonics(BasisSet):
    ...
    def __init__(self,
        ...
        self._projection_matrix = np.zeros((self._probed_coordinates.vector.shape[0],
                                           self._probed_coordinates.vector.shape[1],
                                           len(self._ell_indices)), dtype=np.float64)
    ...
    def _calculate_projection_matrix(self) -> None:
        ...
        _, probed_polar_angles, probed_azim_angles = self._probed_coordinates.to_spherical
        ...
        # reduce over K
        complex_factors = complex_factors.mean(axis=-1)
        ...
        self._projection_matrix = norm_factor[np.newaxis, np.newaxis, ...] * (
    ...
    def probed_coordinates(self) -> ProbedCoordinates:
        ...
        attribute, the :class:`mumott.methods.SphericalHarmonics` instance is
