...
def _relax_offsets(offsets: NDArray[float]) -> NDArray[float]:
...
def _shift_toward_center(center_of_mass_2d: NDArray[float],
                         center_of_mass_3d: NDArray[float],
                         j_vector: NDArray[float],
                         k_vector: NDArray[float],
                         j_offset: float,
                         k_offset: float) -> NDArray[float]:
...
def run_cross_correlation_alignment(data_container: DataContainer,
