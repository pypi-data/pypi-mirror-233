...
LONG_DESCRIPTION = 'A package that allows Automation/Scripting for CST Studio Suite. It provides wrappers around CST Studio Suite python library and some utilities.'
