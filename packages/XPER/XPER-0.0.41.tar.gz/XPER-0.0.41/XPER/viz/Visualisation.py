...
class visualizationClass(ModelPerformance):
    ...
    #def bar_plot(XPER_values,labels,percentage=True):
        ...
        colorscale = [[0, 'rgb(1, 137, 250)'], [1, 'rgb(255, 1, 82)']]
        ...
        for i,values in enumerate(pos_values): # Iteration sur les XPER positives
            ...
            if i == 0:
                ...
                polygon_sep = plt.Polygon([
                               ...
                               (base_x - cut_x - width_separators, cut_y)
                            ], closed=True, fill=True,facecolor="#8fc8f7", linewidth=0) #  "#FFC3D5"
                ...
                polygon = plt.Polygon([
                               ...
                               (base_x - cut_x, cut_y)
                            ], closed=True, fill=True,facecolor="#0189fa", linewidth=0) #  "#FF0D57"
        ...
        for i,values in enumerate(neg_values): # Iteration sur les XPER negatives
            ...
            if i == 0:
                ...
                polygon_sep = plt.Polygon([
                            ...
                            (base_x + width_separators,base_height),
                            (ancien_cut_x+ width_separators, cut_y)], 
                            closed=True, fill=True,facecolor="#f990b2", linewidth=0) # "#FFC3D5" "#D1E6FA"
                ...
                polygon = plt.Polygon([
                            ...
                            (base_x ,base_height),
                            (ancien_cut_x, cut_y)],
                                closed=True, fill=True,facecolor="#ff0152", linewidth=0) #  "#1E88E5"
