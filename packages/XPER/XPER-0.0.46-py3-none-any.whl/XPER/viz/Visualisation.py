...
class visualizationClass(ModelPerformance):
    ...
    #def bar_plot(XPER_values,labels,percentage=True):
        ...
        # Define colors based on the value of bars
        colors = ['rgb(1, 137, 250)' if value < 0 else 'rgb(255, 1, 82)' for value in final_selection_values]
        ...
        y=final_selection_labels,
        orientation='h',
        marker=dict(color=colors)  # Using the manual colors defined based on the values
        ))
