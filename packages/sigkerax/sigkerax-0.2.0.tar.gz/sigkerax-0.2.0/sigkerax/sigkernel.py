...
class SigKernel:
  def __init__(self, static_kernel_kind: str = 'linear', scale: float = 1.0, #scales: jnp.ndarray = jnp.array([1e0]),
               s0: float = 0.0, t0: float = 0.0, S: float = 1.0, T: float = 1.0, refinement_factor: float = 1.0,
