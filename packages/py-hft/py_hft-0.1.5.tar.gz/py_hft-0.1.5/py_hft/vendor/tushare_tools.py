...
token = '67d1d0141d5b94d219a101d33dd248d65de6b4eb28c84d2888212528'
def GetApi():
...
def pro_bar(ts_code='', pro_api=pro_api(), start_date=None, end_date=None, freq='D', asset='E', 
           exchange='',
           adj = None,
           ma = [],
           factors = None,
