...
Refer to the Terraform Registory for docs: [`data_snowflake_accounts`](https://registry.terraform.io/providers/snowflake-labs/snowflake/0.72.0/docs/data-sources/accounts).
'''
import abc
import builtins
import datetime
...
class DataSnowflakeAccounts(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.72.0/docs/data-sources/accounts snowflake_accounts}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.72.0/docs/data-sources/accounts snowflake_accounts} Data Source.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.72.0/docs/data-sources/accounts#id DataSnowflakeAccounts#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param pattern: Specifies an account name pattern. If a pattern is specified, only accounts matching the pattern are returned. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.72.0/docs/data-sources/accounts#pattern DataSnowflakeAccounts#pattern}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def pattern(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__35455adbbda72f98f916829f296803cc1ece1312a1a6859ba371d2c3dce60287)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataSnowflakeAccountsConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.72.0/docs/data-sources/accounts#id DataSnowflakeAccounts#id}.
    ...
    def pattern(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.72.0/docs/data-sources/accounts#pattern DataSnowflakeAccounts#pattern}
        '''
...
def _typecheckingstub__35455adbbda72f98f916829f296803cc1ece1312a1a6859ba371d2c3dce60287(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
