...
resource "gitlab_project_variable" "scep_ecs_cluster_name" {
  project           = data.gitlab_project.service.id
...
resource "gitlab_project_variable" "scep_ecs_service_name" {
  project           = data.gitlab_project.service.id
...
resource "gitlab_project_variable" "scep_container_name" {
  project           = data.gitlab_project.service.id
  key               = "CONTAINER_NAME"
