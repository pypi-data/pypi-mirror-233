...
T = TypeVar("T", bound="AppCanvasUpdateBase")


@attr.s(auto_attribs=True, repr=False)
class AppCanvasUpdateBase:
    """  """
    ...
    def __repr__(self):
        ...
        return "AppCanvasUpdateBase({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        app_canvas_update_base.additional_properties = d
        return app_canvas_update_base
