...
T = TypeVar("T", bound="SectionUiBlockUpdate")
...
class SectionUiBlockUpdate:
    ...
    def __repr__(self):
        ...
        return "SectionUiBlockUpdate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        section_ui_block_update = cls(
            children=children,
            id=id,
            type=type,
        )

        section_ui_block_update.additional_properties = d
        return section_ui_block_update
