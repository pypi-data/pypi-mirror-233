...
T = TypeVar("T", bound="AppCanvasLeafNodeUiBlockList")


@attr.s(auto_attribs=True, repr=False)
class AppCanvasLeafNodeUiBlockList:
    """  """
    ...
    def __repr__(self):
        ...
        return "AppCanvasLeafNodeUiBlockList({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        app_canvas_leaf_node_ui_block_list = cls(
            children=children,
        )

        app_canvas_leaf_node_ui_block_list.additional_properties = d
        return app_canvas_leaf_node_ui_block_list
