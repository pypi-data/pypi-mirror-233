...
- contextName (string; optional):
    ...
    property takes precedence over the component ID.  Use this
    property if the context's name contains the characters '.' or '{'
    as they are not allowed in component IDs.
