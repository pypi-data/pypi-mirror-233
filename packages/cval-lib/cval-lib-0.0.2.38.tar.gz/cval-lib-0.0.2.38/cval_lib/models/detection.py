...
from cval_lib.models._base import Model
...
class DetectionSamplingOnPremise(Model):
    """
    ...
    def send(self, user_api_key: str, sync: bool = True):
        return self._send(user_api_key, f'/api/on-premise/sampling/detection', sync)


class DetectionTest(Model):
    """
