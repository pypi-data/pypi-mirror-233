...
from songfinder import elements, exports
from songfinder import classPaths
from songfinder import settings
...
@app.route("/")
def hello_world(html=None, exportSettings=None):
    ...
    export = exports.ExportHtml(element, exportSettings=self._exportSettings)
