...
class LINE:
   ...
   def line_shakhes(candel_num , symbol_EURUSD , decimal_sambol):
        ...
        price_close_3 = price_close_3 * x
        line_point = line_point * x

        price_close_3 = int (price_close_3)
        ...
        if amount_shakhes > (sprade * LINE().Max_spread):
