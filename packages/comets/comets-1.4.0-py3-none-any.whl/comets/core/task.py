...
class Task(ABC):
    ...
    def timeit(self, input_parameter_set={}, print_to_console=True):
        """Time the execution of the Task using a similar method as python `timeit`.

        Args:
            input_parameter_set (ParameterSet): the input ParameterSet. Defaults to {}.
            print_to_console:
...
class FunctionalTask(Task):
    ...
    def __init__(self, function, cold_input_parameter_set={}):
        """
    ...
    def evaluate(self, input_parameter_set={}, *args, **kwargs):
        """
