...
class Optimization(Experiment):
    ...
    def __init__(
        ...
        self.constraint_handler = (
            _ConstraintHandler(constraints) if constraints is not None else None
        )
        ...
        if self.constraint_handler is not None:
            ...
            self.optimization_history['all_transformed_constraint_violations'] = []
    ...
    def _update_history(
        ...
        if self.constraint_handler is not None:
            ...
            self.optimization_history['all_transformed_constraint_violations'].append(
                list(transformed_violations)
            )
    ...
    def _execute(self):
        ...
        if self.constraint_handler is not None:
            ...
            transformed_constraint_violations = (
                self.constraint_handler.transform_constraint_violation(
                    constraint_violations
                )
            )
            penalties = self.constraint_handler.compute_penalty(
                transformed_constraint_violations, list_of_loss
            )
            if self.maximize:
