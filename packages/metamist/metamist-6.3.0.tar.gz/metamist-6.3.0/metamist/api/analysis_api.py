...
class AnalysisApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_sequencing_group_file_sizes_async = async_wrap(self.get_sequencing_group_file_sizes)
        self.get_sequencing_group_file_sizes_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'HTTPBearer'
                ...
                'operation_id': 'get_sequencing_group_file_sizes',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_sequencing_group_file_sizes(
        self,
        **kwargs
    ):
        """Get Sequencing Group File Sizes  # noqa: E501

        Get the per sample file size by type over the given projects and date range  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_sequencing_group_file_sizes(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_sequencing_group_file_sizes_endpoint.call_with_http_info(**kwargs)
