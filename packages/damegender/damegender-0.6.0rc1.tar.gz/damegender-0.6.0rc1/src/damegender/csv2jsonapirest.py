...
# Adding for each name adding the countries where the names is being used
parser.add_argument('--names_in_countries', default=False, action="store_true")
# Adding for each name adding the surname with the same string that the name
parser.add_argument('--names_and_surnames', default=False, action="store_true")
parser.add_argument('--gender',
                    required=True,
                    choices=["male", "female", "all"])
# parser.add_argument('--include_surnames', default=False, action="store_true")
