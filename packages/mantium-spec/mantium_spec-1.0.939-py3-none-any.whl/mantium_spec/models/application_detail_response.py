...
class ApplicationDetailResponse(object):
    ...
    def __init__(self, id=None, created_at=None, name=None, description=None, top_k=None, status=None, last_synced=None, storage_size=0, data_sources=[], check_permissions=None, similarity_threshold=None, destination_id=None, embedding_count=0, template=None, local_vars_configuration=None):  # noqa: E501
