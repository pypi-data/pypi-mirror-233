...
class CustomTemplateOptions(object):
    ...
    def __init__(self, type='custom', is_activating=False, credentials=None, dataset_id=None, content_column=None, embedding_column=None, local_vars_configuration=None):  # noqa: E501
