...
def genConfigFile():
    ...
    configFileGlobal[f"{defaultSection}"] = {'defaultLogFile': 'logFile.txt', 'defaultDataFile': 'dataFile.txt', 'defaultLogMessageType': 'INFO', 'defaultTimerLogMessageType': 'TIMER', 'defaultTimerMessage': 'default timer', 'DebugToggle': 'True', 'LogSettings': 'True', 'ClearLogFile': 'True', 'ClearDataFile': 'True'}
