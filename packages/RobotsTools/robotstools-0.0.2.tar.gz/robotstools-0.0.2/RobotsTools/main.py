...
def genConfigFile():
    ...
    configFileGlobal[defaultSection] = {'defaultLogFile': 'logFile.txt', 'defaultLogFile': 'dataFile.txt', 'defaultLogMessageType': 'INFO', 'defaultTimerLogMessageType': 'TIMER', 'defaultTimerMessage': 'default timer', 'DebugToggle': 'True', 'LogSettings': 'True', 'ClearLogFile': 'True', 'ClearDataFile': 'True'}
