...
class FactSheetStore(FileStore):
    ...
    def get_path_metric(self, run_id):
        ...
        parent_path, metric_files = self._get_resource_files(run_dir,"metrics")
    ...
    def log_batch(self, run_id, metrics, params, tags):
        ...
        if self.autolog:
            ...
            check_hyp_tag_exist=check_if_key_exist(currentData.params,SPARK_HYP_TAG)
            ...
            if (check_valid_framework):
                ...
                if not check_spark_tag:
                    if (check_tensorflow_tag or check_bst_tag):
                        ...
                        check_early_stop_dl= check_if_earlystop_defined(currentData.params)
                
                        check_early_stop_rounds_val_bst=check_get_val(currentData.params,EARLY_STOP_ROUND_TAG)
                        check_if_early_stop_happened_bst=check_if_key_exist(currentData.metrics,EARLY_STOP_ROUND_METRIC_TAG)
