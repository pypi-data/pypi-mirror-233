...
import math
import os
from ibm_cloud_sdk_core.authenticators import NoAuthAuthenticator, CloudPakForDataAuthenticator, IAMAuthenticator, BearerTokenAuthenticator
...
def check_if_auth_used(authenticator):
    is_auth_used = False
    if type(authenticator) in [CloudPakForDataAuthenticator, CP4DAuthenticator, IAMAuthenticator, BearerTokenAuthenticator]:
            is_auth_used = True
    return is_auth_used
