...
class FeatureSet(Artifact):
    ...
    @property
    def uri(self) -> str:
        return f"azureml://subscriptions/{self.__arm_id.subscription_id}/resourceGroups/{self.__arm_id.resource_group_name}/providers/Microsoft.MachineLearningServices/workspaces/{self.__arm_id.workspace_name}/{self.__arm_id.asset_type}/{self.__arm_id.asset_name}/versions/{self.__arm_id.asset_version}"
    ...
    def _from_rest_object(
        ...
        featureset.__feature_store_guid = featurestore._workspace_id
