...
class PointAtTimeOnTheFlyRetrievalJob(OnlineRetrievalJob):
    ...
    def _process_feature_set(
        ...
        # note that this is just define the rough window. the source_delay and temp join look back will be considered accurately in the join itself
        ...
        df = feature_set._to_pandas_dataframe(
            feature_window_start_date_time=feature_window_start, feature_window_end_date_time=feature_window_end
        )
