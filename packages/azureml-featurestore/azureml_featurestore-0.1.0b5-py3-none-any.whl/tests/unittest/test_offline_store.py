...
class OfflineStoreTest(unittest.TestCase):
    ...
    def test_offline_store_validation(self, mock_copy_rename_and_zip):
        ...
        fs_config._feature_store_settings = FeatureStoreSettings(offline_store_connection_name = "offlineStoreConnectionName1")
        ...
        fs_config._feature_store_settings = FeatureStoreSettings(offline_store_connection_name = "offlineStoreConnectionName")
        fset = FeatureSet._from_rest_object(rest_obj, mock_ml_client)
