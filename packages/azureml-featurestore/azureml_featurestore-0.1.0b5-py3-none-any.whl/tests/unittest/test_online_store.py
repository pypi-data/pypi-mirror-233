...
class OnlineStoreTest(unittest.TestCase):
    ...
    def test_online_store_validation(self, mock_copy_rename_and_zip):
        ...
        fs_config._feature_store_settings = FeatureStoreSettings(offline_store_connection_name = "onlineStoreConnectionName1")
        ...
        fs_config._feature_store_settings = FeatureStoreSettings(online_store_connection_name = "onlineStoreConnectionName")
        fset = FeatureSet._from_rest_object(rest_obj, mock_ml_client)
        ...
        fs_config._feature_store_settings = FeatureStoreSettings(online_store_connection_name = "onlineStoreConnectionName1")
        fset = FeatureSet._from_rest_object(rest_obj, mock_ml_client)
