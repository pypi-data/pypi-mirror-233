...
from tests.helpers import assert_attributes_equal, mock_post, mock_get, mock_patch, generate_rec_ranked_list, \
    generate_unique_str_list
...
def test_build_ranked_list():
    ...
    gt_attr = model.get_attribute("pred")
    assert gt_attr.value_type == ValueType.RankedList and gt_attr.categorical is False
