...
from uglypty.uglyplugin_ttpbuilder.Library.util import show_ttp_help, name_selection, generate_template, highlight_text, \
...
class TTPGuiUI(QWidget):
    def __init__(self, parent=None):
        super().__init__()
        self.parent = parent
        self.initialize_theme(parent.theme)
