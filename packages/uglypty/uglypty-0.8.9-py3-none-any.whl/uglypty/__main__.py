...
from uglypty.uglyplugin_ttpbuilder.ttpgui import TTPGuiUI
...
class UglyPty(QtWidgets.QWidget):
    def setupUi(self, Ui_UglyPTY, global_theme="dark"):
        ...
        self.actionTTPBuilder = QtGui.QAction(parent=Ui_UglyPTY)
        self.actionTTPBuilder.setObjectName("actionTTPBuilder")
        self.menuTools.addAction(self.actionTTPBuilder)
        self.actionTTPBuilder.triggered.connect(lambda: self.open_ttpbuilder())
    ...
    def retranslateUi(self, Ui_UglyPTY):
        ...
        self.actionTTPBuilder.setText(_translate("Ui_UglyPTY", "TTP Visual Builder"))
    ...
    def open_ttpbuilder(self):
        self.ttpgui = TTPGuiUI(self)
        self.ttpgui.show()
