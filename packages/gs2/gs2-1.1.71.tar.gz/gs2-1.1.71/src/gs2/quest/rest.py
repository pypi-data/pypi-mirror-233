...
class Gs2QuestRestClient(rest.AbstractGs2RestClient):
    ...
    def _get_quest_group_model_master(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='quest',
            region=self.session.region,
        ) + "/{namespaceName}/master/group/{questGroupName}".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            questGroupName=request.quest_group_name if request.quest_group_name is not None and request.quest_group_name != '' else 'null',
        )
    ...
    def _describe_quest_model_masters(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='quest',
            region=self.session.region,
        ) + "/{namespaceName}/master/group/{questGroupName}/quest".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            questGroupName=request.quest_group_name if request.quest_group_name is not None and request.quest_group_name != '' else 'null',
        )
    ...
    def _get_quest_model_master(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='quest',
            region=self.session.region,
        ) + "/{namespaceName}/master/group/{questGroupName}/quest/{questName}".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            questGroupName=request.quest_group_name if request.quest_group_name is not None and request.quest_group_name != '' else 'null',
            questName=request.quest_name if request.quest_name is not None and request.quest_name != '' else 'null',
        )
    ...
    def _start(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='quest',
            region=self.session.region,
        ) + "/{namespaceName}/user/me/progress/group/{questGroupName}/quest/{questName}/start".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            questGroupName=request.quest_group_name if request.quest_group_name is not None and request.quest_group_name != '' else 'null',
            questName=request.quest_name if request.quest_name is not None and request.quest_name != '' else 'null',
        )
    ...
    def _start_by_user_id(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='quest',
            region=self.session.region,
        ) + "/{namespaceName}/user/{userId}/progress/group/{questGroupName}/quest/{questName}/start".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            questGroupName=request.quest_group_name if request.quest_group_name is not None and request.quest_group_name != '' else 'null',
            questName=request.quest_name if request.quest_name is not None and request.quest_name != '' else 'null',
            userId=request.user_id if request.user_id is not None and request.user_id != '' else 'null',
    ...
    def _describe_completed_quest_lists(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='quest',
            region=self.session.region,
        ) + "/{namespaceName}/user/me/completed".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
        )
    ...
    def _describe_completed_quest_lists_by_user_id(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='quest',
            region=self.session.region,
        ) + "/{namespaceName}/user/{userId}/completed".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            userId=request.user_id if request.user_id is not None and request.user_id != '' else 'null',
        )
    ...
    def _get_completed_quest_list(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='quest',
            region=self.session.region,
        ) + "/{namespaceName}/user/me/completed/group/{questGroupName}".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            questGroupName=request.quest_group_name if request.quest_group_name is not None and request.quest_group_name != '' else 'null',
        )
    ...
    def _get_completed_quest_list_by_user_id(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='quest',
            region=self.session.region,
        ) + "/{namespaceName}/user/{userId}/completed/group/{questGroupName}".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            questGroupName=request.quest_group_name if request.quest_group_name is not None and request.quest_group_name != '' else 'null',
            userId=request.user_id if request.user_id is not None and request.user_id != '' else 'null',
        )
    ...
    def _get_quest_group_model(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='quest',
            region=self.session.region,
        ) + "/{namespaceName}/group/{questGroupName}".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            questGroupName=request.quest_group_name if request.quest_group_name is not None and request.quest_group_name != '' else 'null',
        )
    ...
    def _describe_quest_models(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='quest',
            region=self.session.region,
        ) + "/{namespaceName}/group/{questGroupName}/quest".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            questGroupName=request.quest_group_name if request.quest_group_name is not None and request.quest_group_name != '' else 'null',
        )
    ...
    def _get_quest_model(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='quest',
            region=self.session.region,
        ) + "/{namespaceName}/group/{questGroupName}/quest/{questName}".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            questGroupName=request.quest_group_name if request.quest_group_name is not None and request.quest_group_name != '' else 'null',
            questName=request.quest_name if request.quest_name is not None and request.quest_name != '' else 'null',
        )
