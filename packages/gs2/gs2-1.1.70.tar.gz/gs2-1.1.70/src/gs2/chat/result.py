...
class DescribeRoomsResult(core.Gs2Result):
    ...
    def with_next_page_token(self, next_page_token: str) -> DescribeRoomsResult:
        self.next_page_token = next_page_token
        return self
...
class CreateRoomResult(core.Gs2Result):
    item: Room = None

    def with_item(self, item: Room) -> CreateRoomResult:
        self.item = item
        return self
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[CreateRoomResult]:
        if data is None:
            return None
        return CreateRoomResult()\
            .with_item(Room.from_dict(data.get('item')))
...
class CreateRoomFromBackendResult(core.Gs2Result):
    item: Room = None

    def with_item(self, item: Room) -> CreateRoomFromBackendResult:
        self.item = item
        return self
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[CreateRoomFromBackendResult]:
        if data is None:
            return None
...
class GetRoomResult(core.Gs2Result):
    item: Room = None

    def with_item(self, item: Room) -> GetRoomResult:
        self.item = item
        return self
...
class UpdateRoomResult(core.Gs2Result):
    item: Room = None

    def with_item(self, item: Room) -> UpdateRoomResult:
        self.item = item
        return self
...
class UpdateRoomFromBackendResult(core.Gs2Result):
    item: Room = None

    def with_item(self, item: Room) -> UpdateRoomFromBackendResult:
        self.item = item
        return self
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[UpdateRoomFromBackendResult]:
        if data is None:
            return None
...
class DeleteRoomResult(core.Gs2Result):
    item: Room = None

    def with_item(self, item: Room) -> DeleteRoomResult:
        self.item = item
        return self
...
class DeleteRoomFromBackendResult(core.Gs2Result):
    item: Room = None

    def with_item(self, item: Room) -> DeleteRoomFromBackendResult:
        self.item = item
        return self
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[DeleteRoomFromBackendResult]:
        if data is None:
            return None
...
class PostResult(core.Gs2Result):
    item: Message = None

    def with_item(self, item: Message) -> PostResult:
        self.item = item
        return self
...
class PostByUserIdResult(core.Gs2Result):
    item: Message = None

    def with_item(self, item: Message) -> PostByUserIdResult:
        self.item = item
        return self
...
class DescribeSubscribesResult(core.Gs2Result):
    items: List[Subscribe] = None
    next_page_token: str = None

    def with_items(self, items: List[Subscribe]) -> DescribeSubscribesResult:
        self.items = items
        return self
...
class DescribeSubscribesByUserIdResult(core.Gs2Result):
    ...
    def with_items(self, items: List[Subscribe]) -> DescribeSubscribesByUserIdResult:
        self.items = items
        return self
...
class DescribeSubscribesByRoomNameResult(core.Gs2Result):
    items: List[Subscribe] = None
    next_page_token: str = None

    def with_items(self, items: List[Subscribe]) -> DescribeSubscribesByRoomNameResult:
        self.items = items
        return self

    def with_next_page_token(self, next_page_token: str) -> DescribeSubscribesByRoomNameResult:
        self.next_page_token = next_page_token
        return self
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[DescribeSubscribesByRoomNameResult]:
        if data is None:
            return None
...
class SubscribeResult(core.Gs2Result):
    ...
    def with_item(self, item: Subscribe) -> SubscribeResult:
        self.item = item
        return self
    ...
    def from_dict(
        ...
        return SubscribeResult()\
            .with_item(Subscribe.from_dict(data.get('item')))
...
class SubscribeByUserIdResult(core.Gs2Result):
    ...
    def with_item(self, item: Subscribe) -> SubscribeByUserIdResult:
        self.item = item
        return self
...
class GetSubscribeResult(core.Gs2Result):
    ...
    def with_item(self, item: Subscribe) -> GetSubscribeResult:
        self.item = item
        return self
...
class GetSubscribeByUserIdResult(core.Gs2Result):
    ...
    def with_item(self, item: Subscribe) -> GetSubscribeByUserIdResult:
        self.item = item
        return self
...
class UpdateNotificationTypeResult(core.Gs2Result):
    item: Subscribe = None

    def with_item(self, item: Subscribe) -> UpdateNotificationTypeResult:
        self.item = item
        return self
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[UpdateNotificationTypeResult]:
        if data is None:
            return None
...
class UpdateNotificationTypeByUserIdResult(core.Gs2Result):
    item: Subscribe = None

    def with_item(self, item: Subscribe) -> UpdateNotificationTypeByUserIdResult:
        self.item = item
        return self
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[UpdateNotificationTypeByUserIdResult]:
        if data is None:
            return None
...
class UnsubscribeResult(core.Gs2Result):
    ...
    def with_item(self, item: Subscribe) -> UnsubscribeResult:
        self.item = item
        return self
...
class UnsubscribeByUserIdResult(core.Gs2Result):
    ...
    def with_item(self, item: Subscribe) -> UnsubscribeByUserIdResult:
        self.item = item
        return self
