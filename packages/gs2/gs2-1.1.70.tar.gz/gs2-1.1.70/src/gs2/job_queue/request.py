...
class DescribeJobsByUserIdRequest(core.Gs2Request):
    ...
    def with_namespace_name(self, namespace_name: str) -> DescribeJobsByUserIdRequest:
        self.namespace_name = namespace_name
        return self

    def with_user_id(self, user_id: str) -> DescribeJobsByUserIdRequest:
        self.user_id = user_id
        return self

    def with_page_token(self, page_token: str) -> DescribeJobsByUserIdRequest:
        self.page_token = page_token
        return self

    def with_limit(self, limit: int) -> DescribeJobsByUserIdRequest:
        self.limit = limit
        return self
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[DescribeJobsByUserIdRequest]:
        if data is None:
            return None
...
class GetJobByUserIdRequest(core.Gs2Request):
    ...
    def with_namespace_name(self, namespace_name: str) -> GetJobByUserIdRequest:
        self.namespace_name = namespace_name
        return self

    def with_user_id(self, user_id: str) -> GetJobByUserIdRequest:
        self.user_id = user_id
        return self

    def with_job_name(self, job_name: str) -> GetJobByUserIdRequest:
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[GetJobByUserIdRequest]:
        if data is None:
            return None
...
class PushByUserIdRequest(core.Gs2Request):
    ...
    def with_user_id(self, user_id: str) -> PushByUserIdRequest:
        self.user_id = user_id
        return self
...
class RunRequest(core.Gs2Request):
...
class RunByUserIdRequest(core.Gs2Request):
...
class DeleteJobByUserIdRequest(core.Gs2Request):
    ...
    def with_user_id(self, user_id: str) -> DeleteJobByUserIdRequest:
        self.user_id = user_id
        return self
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[DeleteJobByUserIdRequest]:
        if data is None:
            return None
...
class PushByStampSheetRequest(core.Gs2Request):

    context_stack: str = None
    stamp_sheet: str = None
    key_id: str = None

    def with_stamp_sheet(self, stamp_sheet: str) -> PushByStampSheetRequest:
        self.stamp_sheet = stamp_sheet
        return self

    def with_key_id(self, key_id: str) -> PushByStampSheetRequest:
        self.key_id = key_id
        return self
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[PushByStampSheetRequest]:
        if data is None:
            return None
...
class DeleteByStampTaskRequest(core.Gs2Request):

    context_stack: str = None
    stamp_task: str = None
    key_id: str = None

    def with_stamp_task(self, stamp_task: str) -> DeleteByStampTaskRequest:
        self.stamp_task = stamp_task
        return self

    def with_key_id(self, key_id: str) -> DeleteByStampTaskRequest:
        self.key_id = key_id
        return self
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[DeleteByStampTaskRequest]:
        if data is None:
            return None
...
class DescribeDeadLetterJobsByUserIdRequest(core.Gs2Request):
    ...
    def with_namespace_name(self, namespace_name: str) -> DescribeDeadLetterJobsByUserIdRequest:
        self.namespace_name = namespace_name
        return self

    def with_user_id(self, user_id: str) -> DescribeDeadLetterJobsByUserIdRequest:
        self.user_id = user_id
        return self

    def with_page_token(self, page_token: str) -> DescribeDeadLetterJobsByUserIdRequest:
        self.page_token = page_token
        return self

    def with_limit(self, limit: int) -> DescribeDeadLetterJobsByUserIdRequest:
        self.limit = limit
        return self
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[DescribeDeadLetterJobsByUserIdRequest]:
        if data is None:
            return None
...
class GetDeadLetterJobByUserIdRequest(core.Gs2Request):
    ...
    def with_namespace_name(self, namespace_name: str) -> GetDeadLetterJobByUserIdRequest:
        self.namespace_name = namespace_name
        return self

    def with_user_id(self, user_id: str) -> GetDeadLetterJobByUserIdRequest:
        self.user_id = user_id
        return self

    def with_dead_letter_job_name(self, dead_letter_job_name: str) -> GetDeadLetterJobByUserIdRequest:
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[GetDeadLetterJobByUserIdRequest]:
        if data is None:
            return None
        return GetDeadLetterJobByUserIdRequest()\
            .with_namespace_name(data.get('namespaceName'))\
            .with_user_id(data.get('userId'))\
            .with_dead_letter_job_name(data.get('deadLetterJobName'))

    def to_dict(self) -> Dict[str, Any]:
        return {
            "namespaceName": self.namespace_name,
            "userId": self.user_id,
            "deadLetterJobName": self.dead_letter_job_name,
        }


class DeleteDeadLetterJobByUserIdRequest(core.Gs2Request):
    ...
    def with_user_id(self, user_id: str) -> DeleteDeadLetterJobByUserIdRequest:
        self.user_id = user_id
        return self
    ...
    def from_dict(
        data: Dict[str, Any],
    ) -> Optional[DeleteDeadLetterJobByUserIdRequest]:
        if data is None:
            return None
