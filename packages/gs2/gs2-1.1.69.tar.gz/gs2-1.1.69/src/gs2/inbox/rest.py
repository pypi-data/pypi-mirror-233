...
class Gs2InboxRestClient(rest.AbstractGs2RestClient):
    ...
    def _describe_messages(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='inbox',
            region=self.session.region,
        ) + "/{namespaceName}/user/me/message".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
        )
    ...
    def _send_message_by_user_id(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='inbox',
            region=self.session.region,
        ) + "/{namespaceName}/user/{userId}/message".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
    ...
    def _get_message(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='inbox',
            region=self.session.region,
        ) + "/{namespaceName}/user/me/{messageName}".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
    ...
    def _get_message_by_user_id(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='inbox',
            region=self.session.region,
        ) + "/{namespaceName}/user/{userId}/{messageName}".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            userId=request.user_id if request.user_id is not None and request.user_id != '' else 'null',
            messageName=request.message_name if request.message_name is not None and request.message_name != '' else 'null',
        )
    ...
    def _receive_global_message(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='inbox',
            region=self.session.region,
        ) + "/{namespaceName}/user/me/message/globalMessage/receive".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
        )
    ...
    def _receive_global_message_by_user_id(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='inbox',
            region=self.session.region,
        ) + "/{namespaceName}/user/{userId}/message/globalMessage/receive".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            userId=request.user_id if request.user_id is not None and request.user_id != '' else 'null',
        )
    ...
    def _read_message(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='inbox',
            region=self.session.region,
        ) + "/{namespaceName}/user/me/{messageName}/read".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            messageName=request.message_name if request.message_name is not None and request.message_name != '' else 'null',
        )
    ...
    def _read_message_by_user_id(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='inbox',
            region=self.session.region,
        ) + "/{namespaceName}/user/{userId}/{messageName}/read".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            userId=request.user_id if request.user_id is not None and request.user_id != '' else 'null',
            messageName=request.message_name if request.message_name is not None and request.message_name != '' else 'null',
        )
    ...
    def _describe_global_message_masters(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='inbox',
            region=self.session.region,
        ) + "/{namespaceName}/master/globalMessage".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
        )
    ...
    def _get_global_message_master(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='inbox',
            region=self.session.region,
        ) + "/{namespaceName}/master/globalMessage/{globalMessageName}".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            globalMessageName=request.global_message_name if request.global_message_name is not None and request.global_message_name != '' else 'null',
        )
    ...
    def _describe_global_messages(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='inbox',
            region=self.session.region,
        ) + "/{namespaceName}/globalMessage".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
        )
    ...
    def _get_global_message(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='inbox',
            region=self.session.region,
        ) + "/{namespaceName}/globalMessage/{globalMessageName}".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            globalMessageName=request.global_message_name if request.global_message_name is not None and request.global_message_name != '' else 'null',
        )
    ...
    def _get_received_by_user_id(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='inbox',
            region=self.session.region,
        ) + "/{namespaceName}/user/{userId}/received".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            userId=request.user_id if request.user_id is not None and request.user_id != '' else 'null',
        )
