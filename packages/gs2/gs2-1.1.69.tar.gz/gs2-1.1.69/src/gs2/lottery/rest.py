...
class Gs2LotteryRestClient(rest.AbstractGs2RestClient):
    ...
    def _describe_lottery_model_masters(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='lottery',
            region=self.session.region,
        ) + "/{namespaceName}/master/lottery".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
        )
    ...
    def _get_lottery_model_master(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='lottery',
            region=self.session.region,
        ) + "/{namespaceName}/master/lottery/{lotteryName}".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
    ...
    def _describe_prize_table_masters(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='lottery',
            region=self.session.region,
        ) + "/{namespaceName}/master/table".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
        )
    ...
    def _get_prize_table_master(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='lottery',
            region=self.session.region,
        ) + "/{namespaceName}/master/table/{prizeTableName}".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
    ...
    def _get_lottery_model(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='lottery',
            region=self.session.region,
        ) + "/{namespaceName}/lottery/{lotteryName}".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            lotteryName=request.lottery_name if request.lottery_name is not None and request.lottery_name != '' else 'null',
        )
    ...
    def _get_prize_table(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='lottery',
            region=self.session.region,
        ) + "/{namespaceName}/table/{prizeTableName}".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            prizeTableName=request.prize_table_name if request.prize_table_name is not None and request.prize_table_name != '' else 'null',
        )
    ...
    def _draw_by_user_id(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='lottery',
            region=self.session.region,
        ) + "/{namespaceName}/user/{userId}/lottery/{lotteryName}/draw".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            lotteryName=request.lottery_name if request.lottery_name is not None and request.lottery_name != '' else 'null',
    ...
    def _prediction_by_user_id(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='lottery',
            region=self.session.region,
        ) + "/{namespaceName}/user/{userId}/lottery/{lotteryName}/prediction".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            lotteryName=request.lottery_name if request.lottery_name is not None and request.lottery_name != '' else 'null',
            userId=request.user_id if request.user_id is not None and request.user_id != '' else 'null',
        )
    ...
    def _draw_with_random_seed_by_user_id(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='lottery',
            region=self.session.region,
        ) + "/{namespaceName}/user/{userId}/lottery/{lotteryName}/draw/withSeed".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            lotteryName=request.lottery_name if request.lottery_name is not None and request.lottery_name != '' else 'null',
            userId=request.user_id if request.user_id is not None and request.user_id != '' else 'null',
        )
    ...
    def _describe_probabilities(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='lottery',
            region=self.session.region,
        ) + "/{namespaceName}/user/me/lottery/{lotteryName}/probability".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            lotteryName=request.lottery_name if request.lottery_name is not None and request.lottery_name != '' else 'null',
        )
    ...
    def _describe_probabilities_by_user_id(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='lottery',
            region=self.session.region,
        ) + "/{namespaceName}/user/{userId}/lottery/{lotteryName}/probability".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            lotteryName=request.lottery_name if request.lottery_name is not None and request.lottery_name != '' else 'null',
            userId=request.user_id if request.user_id is not None and request.user_id != '' else 'null',
        )
    ...
    def _describe_boxes(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='lottery',
            region=self.session.region,
        ) + "/{namespaceName}/user/me/box".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
        )
    ...
    def _describe_boxes_by_user_id(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='lottery',
            region=self.session.region,
        ) + "/{namespaceName}/user/{userId}/box".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            userId=request.user_id if request.user_id is not None and request.user_id != '' else 'null',
        )
    ...
    def _get_box(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='lottery',
            region=self.session.region,
        ) + "/{namespaceName}/user/me/box/{prizeTableName}".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            prizeTableName=request.prize_table_name if request.prize_table_name is not None and request.prize_table_name != '' else 'null',
        )
    ...
    def _get_box_by_user_id(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='lottery',
            region=self.session.region,
        ) + "/{namespaceName}/user/{userId}/box/{prizeTableName}".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            prizeTableName=request.prize_table_name if request.prize_table_name is not None and request.prize_table_name != '' else 'null',
            userId=request.user_id if request.user_id is not None and request.user_id != '' else 'null',
        )
