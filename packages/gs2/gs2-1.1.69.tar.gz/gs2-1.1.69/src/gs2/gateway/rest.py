...
class Gs2GatewayRestClient(rest.AbstractGs2RestClient):
    ...
    def _describe_web_socket_sessions(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='gateway',
            region=self.session.region,
        ) + "/{namespaceName}/session/user/me".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
        )
    ...
    def _describe_web_socket_sessions_by_user_id(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='gateway',
            region=self.session.region,
        ) + "/{namespaceName}/session/user/{userId}".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
    ...
    def _set_user_id(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='gateway',
            region=self.session.region,
        ) + "/{namespaceName}/session/user/me/user".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
        )
    ...
    def _set_user_id_by_user_id(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='gateway',
            region=self.session.region,
        ) + "/{namespaceName}/session/user/{userId}/user".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            userId=request.user_id if request.user_id is not None and request.user_id != '' else 'null',
        )
    ...
    def _send_notification(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='gateway',
            region=self.session.region,
        ) + "/{namespaceName}/session/user/{userId}/notification".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            userId=request.user_id if request.user_id is not None and request.user_id != '' else 'null',
        )
    ...
    def _set_firebase_token(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='gateway',
            region=self.session.region,
        ) + "/{namespaceName}/user/me/firebase/token".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
        )
    ...
    def _set_firebase_token_by_user_id(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='gateway',
            region=self.session.region,
        ) + "/{namespaceName}/user/{userId}/firebase/token".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            userId=request.user_id if request.user_id is not None and request.user_id != '' else 'null',
        )
    ...
    def _send_mobile_notification_by_user_id(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='gateway',
            region=self.session.region,
        ) + "/{namespaceName}/user/{userId}/firebase/token/notification".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            userId=request.user_id if request.user_id is not None and request.user_id != '' else 'null',
        )
