...
from pyroherd.connection import Connection
from pyroherd.crypto import aes, rsa, prime
from pyroherd.errors import SecurityCheckMismatch
from pyroherd.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "pyroherd.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
