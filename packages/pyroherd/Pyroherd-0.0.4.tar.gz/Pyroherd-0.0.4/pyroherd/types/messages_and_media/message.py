...
from pyroherd.errors import MessageIdsEmpty, PeerIdInvalid
from pyroherd.parser import utils as parser_utils, Parser
...
class Message(Object, Update):
    ...
    Parameters:
        ...
        from_user (:obj:`~pyroherd.types.User`, *optional*):
            Sender, empty for messages sent to channels.

        sender_chat (:obj:`~pyroherd.types.Chat`, *optional*):
        ...
        chat (:obj:`~pyroherd.types.Chat`, *optional*):
            Conversation the message belongs to.

        forward_from (:obj:`~pyroherd.types.User`, *optional*):
        ...
        forward_from_chat (:obj:`~pyroherd.types.Chat`, *optional*):
        ...
        reply_to_message (:obj:`~pyroherd.types.Message`, *optional*):
        ...
        service (:obj:`~pyroherd.enums.MessageServiceType`, *optional*):
        ...
        media (:obj:`~pyroherd.enums.MessageMediaType`, *optional*):
        ...
        entities (List of :obj:`~pyroherd.types.MessageEntity`, *optional*):
            For text messages, special entities like usernames, URLs, bot commands, etc. that appear in the text.

        caption_entities (List of :obj:`~pyroherd.types.MessageEntity`, *optional*):
            For messages with a caption, special entities like usernames, URLs, bot commands, etc. that appear
            in the caption.

        audio (:obj:`~pyroherd.types.Audio`, *optional*):
            Message is an audio file, information about the file.

        document (:obj:`~pyroherd.types.Document`, *optional*):
            Message is a general file, information about the file.

        photo (:obj:`~pyroherd.types.Photo`, *optional*):
            Message is a photo, information about the photo.

        sticker (:obj:`~pyroherd.types.Sticker`, *optional*):
            Message is a sticker, information about the sticker.

        animation (:obj:`~pyroherd.types.Animation`, *optional*):
            Message is an animation, information about the animation.

        game (:obj:`~pyroherd.types.Game`, *optional*):
            Message is a game, information about the game.

        video (:obj:`~pyroherd.types.Video`, *optional*):
            Message is a video, information about the video.

        voice (:obj:`~pyroherd.types.Voice`, *optional*):
            Message is a voice message, information about the file.

        video_note (:obj:`~pyroherd.types.VideoNote`, *optional*):
        ...
        contact (:obj:`~pyroherd.types.Contact`, *optional*):
            Message is a shared contact, information about the contact.

        location (:obj:`~pyroherd.types.Location`, *optional*):
            Message is a shared location, information about the location.

        venue (:obj:`~pyroherd.types.Venue`, *optional*):
            Message is a venue, information about the venue.

        web_page (:obj:`~pyroherd.types.WebPage`, *optional*):
            Message was sent with a webpage preview.

        poll (:obj:`~pyroherd.types.Poll`, *optional*):
            Message is a native poll, information about the poll.

        dice (:obj:`~pyroherd.types.Dice`, *optional*):
            A dice containing a value that is randomly generated by Telegram.

        new_chat_members (List of :obj:`~pyroherd.types.User`, *optional*):
            New members that were added to the group or supergroup and information about them
            (the bot itself may be one of these members).

        left_chat_member (:obj:`~pyroherd.types.User`, *optional*):
            A member was removed from the group, information about them (this member may be the bot itself).

        new_chat_title (``str``, *optional*):
            A chat title was changed to this value.

        new_chat_photo (:obj:`~pyroherd.types.Photo`, *optional*):
        ...
        pinned_message (:obj:`~pyroherd.types.Message`, *optional*):
            Specified message was pinned.
            Note that the Message object in this field will not contain further reply_to_message fields even if it
            is itself a reply.

        game_high_score (:obj:`~pyroherd.types.GameHighScore`, *optional*):
	...
	forwards (``int``, *optional*):
        ...
        via_bot (:obj:`~pyroherd.types.User`):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the text of this message. Only applicable when using :obj:`Filters.regex <pyroherd.Filters.regex>`.

        command (List of ``str``, *optional*):
            A list containing the command and its arguments, if any.
            E.g.: "/start 1 2 3" would produce ["start", "1", "2", "3"].
            Only applicable when using :obj:`~pyroherd.filters.command`.

        video_chat_scheduled (:obj:`~pyroherd.types.VideoChatScheduled`, *optional*):
            Service message: voice chat scheduled.

        video_chat_started (:obj:`~pyroherd.types.VideoChatStarted`, *optional*):
            Service message: the voice chat started.

        video_chat_ended (:obj:`~pyroherd.types.VideoChatEnded`, *optional*):
            Service message: the voice chat has ended.

        video_chat_members_invited (:obj:`~pyroherd.types.VoiceChatParticipantsInvited`, *optional*):
            Service message: new members were invited to the voice chat.

        web_app_data (:obj:`~pyroherd.types.WebAppData`, *optional*):
        ...
        reactions (List of :obj:`~pyroherd.types.Reaction`):
    ...
    async def get_media_group(self) -> List["types.Message"]:
        """Bound method *get_media_group* of :obj:`~pyroherd.types.Message`.
        ...
        Returns:
            List of :obj:`~pyroherd.types.Message`: On success, a list of messages of the media group is returned.
    ...
    async def reply_text(
        ...
        """Bound method *reply_text* of :obj:`~pyroherd.types.Message`.
        ...
        Parameters:
            ...
            entities (List of :obj:`~pyroherd.types.MessageEntity`):
    ...
    async def reply_animation(
        ...
        """Bound method *reply_animation* :obj:`~pyroherd.types.Message`.
        ...
        Returns:
            On success, the sent :obj:`~pyroherd.types.Message` is returned.
            In case the upload is deliberately stopped with :meth:`~pyroherd.Client.stop_transmission`, None is returned
            instead.
    ...
    async def reply_audio(
        ...
        """Bound method *reply_audio* of :obj:`~pyroherd.types.Message`.
    ...
    async def reply_cached_media(
        ...
        """Bound method *reply_cached_media* of :obj:`~pyroherd.types.Message`.
    ...
    async def reply_chat_action(self, action: "enums.ChatAction") -> bool:
        """Bound method *reply_chat_action* of :obj:`~pyroherd.types.Message`.

        Use as a shortcut for:

        .. code-block:: python

            from pyroherd import enums
        ...
        Parameters:
            action (:obj:`~pyroherd.enums.ChatAction`):
    ...
    async def reply_contact(
        ...
        """Bound method *reply_contact* of :obj:`~pyroherd.types.Message`.
    ...
    async def reply_document(
        ...
        """Bound method *reply_document* of :obj:`~pyroherd.types.Message`.
    ...
    async def reply_game(
        ...
        """Bound method *reply_game* of :obj:`~pyroherd.types.Message`.
    ...
    async def reply_inline_bot_result(
        ...
        """Bound method *reply_inline_bot_result* of :obj:`~pyroherd.types.Message`.
    ...
    async def reply_location(
        ...
        """Bound method *reply_location* of :obj:`~pyroherd.types.Message`.
    ...
    async def reply_media_group(
        ...
        """Bound method *reply_media_group* of :obj:`~pyroherd.types.Message`.
        ...
        Parameters:
            media (``list``):
                A list containing either :obj:`~pyroherd.types.InputMediaPhoto` or
                :obj:`~pyroherd.types.InputMediaVideo` objects
        ...
        Returns:
            On success, a :obj:`~pyroherd.types.Messages` object is returned containing all the
    ...
    async def reply_photo(
        ...
        """Bound method *reply_photo* of :obj:`~pyroherd.types.Message`.
    ...
    async def reply_poll(
        ...
        """Bound method *reply_poll* of :obj:`~pyroherd.types.Message`.
        ...
        Parameters:
            ...
            type (:obj`~pyroherd.enums.PollType`, *optional*):
                Poll type, :obj:`~pyroherd.enums.PollType.QUIZ` or :obj:`~pyroherd.enums.PollType.REGULAR`.
                Defaults to :obj:`~pyroherd.enums.PollType.REGULAR`.
            ...
            explanation_parse_mode (:obj:`~pyroherd.enums.ParseMode`, *optional*):
                By default, texts are parsed using both Markdown and HTML styles.
                You can combine both syntaxes together.

            explanation_entities (List of :obj:`~pyroherd.types.MessageEntity`):
    ...
    async def reply_sticker(
        ...
        """Bound method *reply_sticker* of :obj:`~pyroherd.types.Message`.
    ...
    async def reply_venue(
        ...
        """Bound method *reply_venue* of :obj:`~pyroherd.types.Message`.
    ...
    async def reply_video(
        ...
        """Bound method *reply_video* of :obj:`~pyroherd.types.Message`.
    ...
    async def reply_video_note(
        ...
        """Bound method *reply_video_note* of :obj:`~pyroherd.types.Message`.
    ...
    async def reply_voice(
        ...
        """Bound method *reply_voice* of :obj:`~pyroherd.types.Message`.
    ...
    async def edit_text(
        ...
        """Bound method *edit_text* of :obj:`~pyroherd.types.Message`.
        ...
        Returns:
            On success, the edited :obj:`~pyroherd.types.Message` is returned.
    ...
    async def edit_caption(
        ...
        """Bound method *edit_caption* of :obj:`~pyroherd.types.Message`.
    ...
    async def edit_media(
        ...
        """Bound method *edit_media* of :obj:`~pyroherd.types.Message`.
        ...
        Parameters:
            media (:obj:`~pyroherd.types.InputMedia`):
    ...
    async def edit_reply_markup(self, reply_markup: "types.InlineKeyboardMarkup" = None) -> "Message":
        """Bound method *edit_reply_markup* of :obj:`~pyroherd.types.Message`.
        ...
        Parameters:
            reply_markup (:obj:`~pyroherd.types.InlineKeyboardMarkup`):
                An InlineKeyboardMarkup object.

        Returns:
            On success, if edited message is sent by the bot, the edited
            :obj:`~pyroherd.types.Message` is returned, otherwise True is returned.
    ...
    async def forward(
        ...
        """Bound method *forward* of :obj:`~pyroherd.types.Message`.
    ...
    async def copy(
        ...
        """Bound method *copy* of :obj:`~pyroherd.types.Message`.
        ...
        Returns:
            :obj:`~pyroherd.types.Message`: On success, the copied message is returned.
    ...
    async def delete(self, revoke: bool = True):
        """Bound method *delete* of :obj:`~pyroherd.types.Message`.
    ...
    async def click(self, x: Union[int, str] = 0, y: int = None, quote: bool = None, timeout: int = 10):
        """Bound method *click* of :obj:`~pyroherd.types.Message`.
        ...
        Returns:
            -   The result of :meth:`~pyroherd.Client.request_callback_answer` in case of inline callback button clicks.
    ...
    async def react(self, emoji: str = "", big: bool = False) -> bool:
        """Bound method *react* of :obj:`~pyroherd.types.Message`.
    ...
    async def retract_vote(
        ...
        """Bound method *retract_vote* of :obj:`~pyroherd.types.Message`.
        ...
        Returns:
            :obj:`~pyroherd.types.Poll`: On success, the poll with the retracted vote is returned.
    ...
    async def download(
        ...
        """Bound method *download* of :obj:`~pyroherd.types.Message`.
    ...
    async def vote(
        ...
        """Bound method *vote* of :obj:`~pyroherd.types.Message`.
        ...
        Returns:
            :obj:`~pyroherd.types.Poll`: On success, the poll with the chosen option is returned.
    ...
    async def pin(self, disable_notification: bool = False, both_sides: bool = False) -> "types.Message":
        """Bound method *pin* of :obj:`~pyroherd.types.Message`.
        ...
        Returns:
            :obj:`~pyroherd.types.Message`: On success, the service message is returned.
    ...
    async def unpin(self) -> bool:
        """Bound method *unpin* of :obj:`~pyroherd.types.Message`.
