...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~pyroherd.Client.search_global_count`.
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~pyroherd.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "pyroherd". Get the first 50 results
                async for message in app.search_global("pyroherd", limit=50):
                    print(message.text)
