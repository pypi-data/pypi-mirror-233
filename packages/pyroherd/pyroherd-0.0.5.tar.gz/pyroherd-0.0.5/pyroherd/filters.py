...
from pyroherd.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "pyroherd.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~pyroherd.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~pyroherd.handlers.MessageHandler` the *update* argument will be a :obj:`~pyroherd.types.Message`; in a :obj:`~pyroherd.handlers.CallbackQueryHandler` the *update* will be a :obj:`~pyroherd.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~pyroherd.filters.command` or :meth:`~pyroherd.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~pyroherd.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~pyroherd.types.Document` objects."""
...
"""Filter messages that contain :obj:`~pyroherd.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~pyroherd.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~pyroherd.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~pyroherd.types.Game` objects."""
...
"""Filter messages that contain :obj:`~pyroherd.types.Video` objects."""
...
"""Filter messages that contain :obj:`~pyroherd.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~pyroherd.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~pyroherd.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~pyroherd.types.Location` objects."""
...
"""Filter messages that contain :obj:`~pyroherd.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~pyroherd.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~pyroherd.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~pyroherd.types.Message`.
    ...
    async def func(flt, client: pyroherd.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~pyroherd.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~pyroherd.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~pyroherd.types.InlineQuery`: The filter will match ``query``.
