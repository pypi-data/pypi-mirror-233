...
class InlineQuery(Object, Update):
    ...
    Parameters:
        ...
        chat_type (:obj:`~pyroherd.enums.ChatType`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the query of this inline query. Only applicable when using :obj:`Filters.regex <pyroherd.Filters.regex>`.
    """
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`~pyroherd.types.InlineQuery`.
        ...
        Parameters:
            results (List of :obj:`~pyroherd.types.InlineQueryResult`):
