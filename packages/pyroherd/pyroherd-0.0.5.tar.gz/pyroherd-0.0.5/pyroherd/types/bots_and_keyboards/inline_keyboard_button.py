...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~pyroherd.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~pyroherd.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~pyroherd.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~pyroherd.types.CallbackGame`, *optional*):
