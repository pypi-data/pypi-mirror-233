...
class SearchResultsPositions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroherd.raw.base.messages.SearchResultsPositions`.
    ...
    Parameters:
        ...
        positions (List of :obj:`SearchResultsPosition <pyroherd.raw.base.SearchResultsPosition>`):
            N/A
