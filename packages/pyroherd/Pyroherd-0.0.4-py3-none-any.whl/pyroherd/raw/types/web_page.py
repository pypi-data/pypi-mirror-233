...
class WebPage(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroherd.raw.base.WebPage`.
    ...
    Parameters:
        ...
        document (:obj:`Document <pyroherd.raw.base.Document>`, *optional*):
            N/A

        cached_page (:obj:`Page <pyroherd.raw.base.Page>`, *optional*):
            N/A

        attributes (List of :obj:`WebPageAttribute <pyroherd.raw.base.WebPageAttribute>`, *optional*):
            N/A
