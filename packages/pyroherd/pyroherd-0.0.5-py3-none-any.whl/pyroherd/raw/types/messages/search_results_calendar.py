...
class SearchResultsCalendar(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroherd.raw.base.messages.SearchResultsCalendar`.
    ...
    Parameters:
        ...
        periods (List of :obj:`SearchResultsCalendarPeriod <pyroherd.raw.base.SearchResultsCalendarPeriod>`):
            N/A
