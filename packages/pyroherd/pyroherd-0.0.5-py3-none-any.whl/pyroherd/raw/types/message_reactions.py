...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroherd.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <pyroherd.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <pyroherd.raw.base.MessagePeerReaction>`, *optional*):
            N/A
