...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroherd.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <pyroherd.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <pyroherd.raw.base.PopularContact>`):
            N/A
