...
class BotInlineResult(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroherd.raw.base.BotInlineResult`.
    ...
    Parameters:
        ...
        send_message (:obj:`BotInlineMessage <pyroherd.raw.base.BotInlineMessage>`):
            N/A
        ...
        thumb (:obj:`WebDocument <pyroherd.raw.base.WebDocument>`, *optional*):
            N/A

        content (:obj:`WebDocument <pyroherd.raw.base.WebDocument>`, *optional*):
            N/A
