...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroherd.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <pyroherd.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <pyroherd.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <pyroherd.raw.base.SecureValueError>`):
            N/A
