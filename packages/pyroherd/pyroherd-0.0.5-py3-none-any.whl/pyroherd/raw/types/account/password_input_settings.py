...
class PasswordInputSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroherd.raw.base.account.PasswordInputSettings`.
    ...
    Parameters:
        new_algo (:obj:`PasswordKdfAlgo <pyroherd.raw.base.PasswordKdfAlgo>`, *optional*):
            N/A
        ...
        new_secure_settings (:obj:`SecureSecretSettings <pyroherd.raw.base.SecureSecretSettings>`, *optional*):
            N/A
