...
class InputMediaInvoice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroherd.raw.base.InputMedia`.
    ...
    Parameters:
        ...
        provider_data (:obj:`DataJSON <pyroherd.raw.base.DataJSON>`):
            N/A

        photo (:obj:`InputWebDocument <pyroherd.raw.base.InputWebDocument>`, *optional*):
            N/A

        start_param (``str``, *optional*):
            N/A

        extended_media (:obj:`InputMedia <pyroherd.raw.base.InputMedia>`, *optional*):
            N/A
