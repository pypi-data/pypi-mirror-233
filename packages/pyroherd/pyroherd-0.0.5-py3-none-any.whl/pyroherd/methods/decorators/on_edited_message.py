...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~pyroherd.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroherd.Client):
                self.add_handler(pyroherd.handlers.EditedMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroherd.handlers.EditedMessageHandler(func, self),
