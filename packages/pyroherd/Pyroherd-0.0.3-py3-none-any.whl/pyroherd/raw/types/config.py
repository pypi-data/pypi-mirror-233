...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroherd.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <pyroherd.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <pyroherd.raw.base.Reaction>`, *optional*):
            N/A
