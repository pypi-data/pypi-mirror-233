...
class PollResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroherd.raw.base.PollResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`PollAnswerVoters <pyroherd.raw.base.PollAnswerVoters>`, *optional*):
            N/A
        ...
        solution_entities (List of :obj:`MessageEntity <pyroherd.raw.base.MessageEntity>`, *optional*):
            N/A
