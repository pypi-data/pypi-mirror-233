...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroherd.raw.base.Document`.
    ...
    Parameters:
        ...
        thumbs (List of :obj:`PhotoSize <pyroherd.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <pyroherd.raw.base.VideoSize>`, *optional*):
            N/A
