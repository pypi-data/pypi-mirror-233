...
class InputChatUploadedPhoto(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroherd.raw.base.InputChatPhoto`.
    ...
    Parameters:
        file (:obj:`InputFile <pyroherd.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <pyroherd.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <pyroherd.raw.base.VideoSize>`, *optional*):
            N/A
