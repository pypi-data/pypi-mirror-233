...
class AttachMenuBotIcon(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroherd.raw.base.AttachMenuBotIcon`.
    ...
    Parameters:
        ...
        icon (:obj:`Document <pyroherd.raw.base.Document>`):
            N/A

        colors (List of :obj:`AttachMenuBotIconColor <pyroherd.raw.base.AttachMenuBotIconColor>`, *optional*):
            N/A
