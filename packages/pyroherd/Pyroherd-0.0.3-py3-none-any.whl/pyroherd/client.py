...
import pyroherd
from pyroherd import __version__, __license__
from pyroherd import enums
from pyroherd import raw
from pyroherd import utils
from pyroherd.crypto import aes
from pyroherd.errors import CDNFileHashMismatch
from pyroherd.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from pyroherd.handlers.handler import Handler
from pyroherd.methods import Methods
from pyroherd.session import Auth, Session
from pyroherd.storage import FileStorage, MemoryStorage
from pyroherd.types import User, TermsOfService
from pyroherd.utils import ainput
...
class Client(Methods):
    """Pyroherd Client, the main means for interacting with Telegram.
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~pyroherd.Client.export_session_string` before stopping the client to get a session string you can
        ...
        workdir (``str``, *optional*):
            ...
            The working directory is the location in the filesystem where Pyroherd will store the session files.
    ...
    APP_VERSION = f"Pyroherd {__version__}"
    ...
    async def authorize(self) -> User:
        ...
        print(f"Welcome to Pyroherd (version {__version__})")
        print(f"Pyroherd is free software and comes with ABSOLUTELY NO WARRANTY. Licensed\n"
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~pyroherd.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.pyroherd.org/start/auth")
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except pyroherd.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
            finally:
