...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~pyroherd.types.InputMediaPhoto`, :obj:`~pyroherd.types.InputMediaVideo`, :obj:`~pyroherd.types.InputMediaAudio` and :obj:`~pyroherd.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~pyroherd.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from pyroherd.types import InputMediaPhoto, InputMediaVideo
