...
import pyroherd
from pyroherd import StopTransmission, enums
from pyroherd import raw
from pyroherd import types
from pyroherd import utils
from pyroherd.errors import FilePartMissing
from pyroherd.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~pyroherd.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~pyroherd.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~pyroherd.Client.stop_transmission`, None is returned.
