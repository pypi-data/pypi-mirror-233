...
class Invoke:
    async def invoke(
        ...
        Available functions are listed in the :obj:`functions <pyroherd.api.functions>` package and may accept compound
        data types from :obj:`types <pyroherd.api.types>` as well as bare types such as ``int``, ``str``, etc...
