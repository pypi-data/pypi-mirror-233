...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~pyroherd.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroherd.Client):
                self.add_handler(pyroherd.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroherd.handlers.ChatMemberUpdatedHandler(func, self),
