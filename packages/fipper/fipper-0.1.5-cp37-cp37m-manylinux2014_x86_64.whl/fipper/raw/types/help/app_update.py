...
class AppUpdate(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~fipper.raw.base.help.AppUpdate`.
    ...
    Parameters:
        ...
        entities (List of :obj:`MessageEntity <fipper.raw.base.MessageEntity>`):
            N/A
        ...
        sticker (:obj:`Document <fipper.raw.base.Document>`, *optional*):
            N/A
