...
class GroupCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~fipper.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call (:obj:`GroupCall <fipper.raw.base.GroupCall>`):
            N/A

        participants (List of :obj:`GroupCallParticipant <fipper.raw.base.GroupCallParticipant>`):
            N/A
