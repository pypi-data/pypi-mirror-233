...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~fipper.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <fipper.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <fipper.raw.base.VideoSize>`, *optional*):
            N/A
