...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~fipper.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <fipper.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <fipper.raw.base.PhoneConnection>`):
            N/A
