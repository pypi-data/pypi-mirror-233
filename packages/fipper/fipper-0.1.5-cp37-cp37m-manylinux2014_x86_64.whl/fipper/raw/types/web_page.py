...
class WebPage(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~fipper.raw.base.WebPage`.
    ...
    Parameters:
        ...
        photo (:obj:`Photo <fipper.raw.base.Photo>`, *optional*):
            N/A
        ...
        cached_page (:obj:`Page <fipper.raw.base.Page>`, *optional*):
            N/A

        attributes (List of :obj:`WebPageAttribute <fipper.raw.base.WebPageAttribute>`, *optional*):
            N/A
