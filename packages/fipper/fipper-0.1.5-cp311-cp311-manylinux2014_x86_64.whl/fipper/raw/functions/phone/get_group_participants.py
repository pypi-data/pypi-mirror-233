...
class GetGroupParticipants(TLObject):  # type: ignore
    ...
    Parameters:
        call (:obj:`InputGroupCall <fipper.raw.base.InputGroupCall>`):
            N/A

        ids (List of :obj:`InputPeer <fipper.raw.base.InputPeer>`):
            N/A
    ...
    Returns:
        :obj:`phone.GroupParticipants <fipper.raw.base.phone.GroupParticipants>`
    """
