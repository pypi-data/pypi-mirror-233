...
class RequestSimpleWebView(TLObject):  # type: ignore
    ...
    Parameters:
        bot (:obj:`InputUser <fipper.raw.base.InputUser>`):
            N/A
        ...
        theme_params (:obj:`DataJSON <fipper.raw.base.DataJSON>`, *optional*):
            N/A

    Returns:
        :obj:`SimpleWebViewResult <fipper.raw.base.SimpleWebViewResult>`
    """

    __slots__: List[str] = ["bot", "url", "platform", "theme_params"]

    ID = 0x299bec8e
    QUALNAME = "functions.messages.RequestSimpleWebView"

    def __init__(self, *, bot: "raw.base.InputUser", url: str, platform: str, theme_params: "raw.base.DataJSON" = None) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "RequestSimpleWebView":
        ...
        return RequestSimpleWebView(bot=bot, url=url, platform=platform, theme_params=theme_params)
