...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~fipper.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <fipper.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <fipper.raw.base.PopularContact>`):
            N/A
