...
class MessageMediaDocument(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        document (:obj:`Document <fipper.raw.base.Document>`, *optional*):
            N/A
    ...
    __slots__: List[str] = ["nopremium", "document", "ttl_seconds"]

    ID = 0x9cb070d7
    QUALNAME = "types.MessageMediaDocument"

    def __init__(self, *, nopremium: Optional[bool] = None, document: "raw.base.Document" = None, ttl_seconds: Optional[int] = None) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "MessageMediaDocument":
        ...
        return MessageMediaDocument(nopremium=nopremium, document=document, ttl_seconds=ttl_seconds)
