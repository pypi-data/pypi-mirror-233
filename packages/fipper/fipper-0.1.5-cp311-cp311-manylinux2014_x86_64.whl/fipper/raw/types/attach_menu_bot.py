...
class AttachMenuBot(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~fipper.raw.base.AttachMenuBot`.
    ...
    Parameters:
        ...
        peer_types (List of :obj:`AttachMenuPeerType <fipper.raw.base.AttachMenuPeerType>`):
            N/A

        icons (List of :obj:`AttachMenuBotIcon <fipper.raw.base.AttachMenuBotIcon>`):
            N/A
