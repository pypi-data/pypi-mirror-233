...
class SearchResultsCalendar(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~fipper.raw.base.messages.SearchResultsCalendar`.
    ...
    Parameters:
        ...
        periods (List of :obj:`SearchResultsCalendarPeriod <fipper.raw.base.SearchResultsCalendarPeriod>`):
            N/A

        messages (List of :obj:`Message <fipper.raw.base.Message>`):
            N/A
