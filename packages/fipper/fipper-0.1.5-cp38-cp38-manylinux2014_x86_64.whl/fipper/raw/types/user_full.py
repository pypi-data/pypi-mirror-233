...
class UserFull(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~fipper.raw.base.UserFull`.
    ...
    Parameters:
        ...
        settings (:obj:`PeerSettings <fipper.raw.base.PeerSettings>`):
            N/A
        ...
        profile_photo (:obj:`Photo <fipper.raw.base.Photo>`, *optional*):
            N/A

        bot_info (:obj:`BotInfo <fipper.raw.base.BotInfo>`, *optional*):
            N/A
    ...
    def read(b: BytesIO, *args: Any) -> "UserFull":
        ...
        return UserFull(id=id, settings=settings, notify_settings=notify_settings, common_chats_count=common_chats_count, blocked=blocked, phone_calls_available=phone_calls_available, phone_calls_private=phone_calls_private, can_pin_message=can_pin_message, has_scheduled=has_scheduled, video_calls_available=video_calls_available, voice_messages_forbidden=voice_messages_forbidden, about=about, profile_photo=profile_photo, bot_info=bot_info, pinned_msg_id=pinned_msg_id, folder_id=folder_id, ttl_period=ttl_period, theme_emoticon=theme_emoticon, private_forward_name=private_forward_name, bot_group_admin_rights=bot_group_admin_rights, bot_broadcast_admin_rights=bot_broadcast_admin_rights, premium_gifts=premium_gifts)
