...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~fipper.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <fipper.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <fipper.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <fipper.raw.base.PremiumSubscriptionOption>`):
            N/A
