...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        invoice (:obj:`InputInvoice <fipper.raw.base.InputInvoice>`):
            N/A

        info (:obj:`PaymentRequestedInfo <fipper.raw.base.PaymentRequestedInfo>`):
            N/A
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <fipper.raw.base.payments.ValidatedRequestedInfo>`
    """
