...
class UpdateTheme(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        theme (:obj:`InputTheme <fipper.raw.base.InputTheme>`):
            N/A
        ...
        document (:obj:`InputDocument <fipper.raw.base.InputDocument>`, *optional*):
            N/A

        settings (List of :obj:`InputThemeSettings <fipper.raw.base.InputThemeSettings>`, *optional*):
            N/A

    Returns:
        :obj:`Theme <fipper.raw.base.Theme>`
    """
