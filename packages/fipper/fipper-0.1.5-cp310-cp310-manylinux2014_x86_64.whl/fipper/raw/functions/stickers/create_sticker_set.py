...
class CreateStickerSet(TLObject):  # type: ignore
    ...
    Parameters:
        user_id (:obj:`InputUser <fipper.raw.base.InputUser>`):
            N/A
        ...
        stickers (List of :obj:`InputStickerSetItem <fipper.raw.base.InputStickerSetItem>`):
            N/A
        ...
        thumb (:obj:`InputDocument <fipper.raw.base.InputDocument>`, *optional*):
            N/A
