...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~fipper.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <fipper.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <fipper.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <fipper.raw.base.SecureValueError>`):
            N/A
