...
class ExportedChatInviteReplaced(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~fipper.raw.base.messages.ExportedChatInvite`.
    ...
    Parameters:
        invite (:obj:`ExportedChatInvite <fipper.raw.base.ExportedChatInvite>`):
            N/A

        new_invite (:obj:`ExportedChatInvite <fipper.raw.base.ExportedChatInvite>`):
            N/A
