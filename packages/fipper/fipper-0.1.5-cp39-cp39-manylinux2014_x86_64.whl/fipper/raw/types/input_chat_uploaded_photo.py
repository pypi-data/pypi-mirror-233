...
class InputChatUploadedPhoto(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~fipper.raw.base.InputChatPhoto`.
    ...
    Parameters:
        file (:obj:`InputFile <fipper.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <fipper.raw.base.InputFile>`, *optional*):
            N/A
