...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~fipper.raw.base.Document`.
    ...
    Parameters:
        ...
        attributes (List of :obj:`DocumentAttribute <fipper.raw.base.DocumentAttribute>`):
            N/A

        thumbs (List of :obj:`PhotoSize <fipper.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <fipper.raw.base.VideoSize>`, *optional*):
            N/A
