...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~fipper.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <fipper.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <fipper.raw.base.Reaction>`, *optional*):
            N/A
