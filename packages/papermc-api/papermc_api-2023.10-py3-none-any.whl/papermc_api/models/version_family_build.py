...
class VersionFamilyBuild(BaseModel):
    """
    VersionFamilyBuild
    """
    ...
    __properties: ClassVar[List[str]] = ["version", "build", "time", "channel", "promoted", "changes", "downloads"]
    ...
    def channel_validate_enum(cls, value):
        ...
        if value not in ('default', 'experimental'):
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "changes": [Change.from_dict(_item) for _item in obj.get("changes")] if obj.get("changes") is not None else None,
            "downloads": dict(
