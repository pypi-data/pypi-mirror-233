...
class BuildsResponse(BaseModel):
    ...
    builds: Optional[List[VersionBuild]] = None
    __properties: ClassVar[List[str]] = ["project_id", "project_name", "version", "builds"]
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "builds": [VersionBuild.from_dict(_item) for _item in obj.get("builds")] if obj.get("builds") is not None else None
        })
        return _obj
