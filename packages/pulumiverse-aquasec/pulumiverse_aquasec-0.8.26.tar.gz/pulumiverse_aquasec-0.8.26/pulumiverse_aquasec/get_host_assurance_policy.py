...
__all__ = [
    'GetHostAssurancePolicyResult',
    'AwaitableGetHostAssurancePolicyResult',
    'get_host_assurance_policy',
    'get_host_assurance_policy_output',
]

@pulumi.output_type
class GetHostAssurancePolicyResult:
    """
    ...
    def auto_scan_times(self) -> Sequence['outputs.GetHostAssurancePolicyAutoScanTimeResult']:
    ...
    def custom_checks(self) -> Sequence['outputs.GetHostAssurancePolicyCustomCheckResult']:
        """
    ...
    def forbidden_labels(self) -> Sequence['outputs.GetHostAssurancePolicyForbiddenLabelResult']:
    ...
    def packages_black_lists(self) -> Sequence['outputs.GetHostAssurancePolicyPackagesBlackListResult']:
        """
    ...
    def packages_white_lists(self) -> Sequence['outputs.GetHostAssurancePolicyPackagesWhiteListResult']:
        """
    ...
    def required_labels(self) -> Sequence['outputs.GetHostAssurancePolicyRequiredLabelResult']:
    ...
    @property
    @pulumi.getter
    def scopes(self) -> Sequence['outputs.GetHostAssurancePolicyScopeResult']:
        return pulumi.get(self, "scopes")

    @property
    @pulumi.getter(name="trustedBaseImages")
    def trusted_base_images(self) -> Sequence['outputs.GetHostAssurancePolicyTrustedBaseImageResult']:
        """
...
class AwaitableGetHostAssurancePolicyResult(GetHostAssurancePolicyResult):
