...
class GetKubernetesAssurancePolicyResult:
    ...
    def __init__(__self__, allowed_images=None, application_scopes=None, audit_on_failure=None, author=None, auto_scan_configured=None, auto_scan_enabled=None, auto_scan_times=None, blacklist_permissions=None, blacklist_permissions_enabled=None, blacklisted_licenses=None, blacklisted_licenses_enabled=None, block_failed=None, control_exclude_no_fix=None, custom_checks=None, custom_checks_enabled=None, custom_severity_enabled=None, cves_black_list_enabled=None, cves_black_lists=None, cves_white_list_enabled=None, cves_white_lists=None, cvss_severity=None, cvss_severity_enabled=None, cvss_severity_exclude_no_fix=None, description=None, disallow_malware=None, docker_cis_enabled=None, domain=None, domain_name=None, dta_enabled=None, dta_severity=None, enabled=None, enforce=None, enforce_after_days=None, enforce_excessive_permissions=None, exceptional_monitored_malware_paths=None, fail_cicd=None, forbidden_labels=None, forbidden_labels_enabled=None, force_microenforcer=None, function_integrity_enabled=None, id=None, ignore_recently_published_vln=None, ignore_recently_published_vln_period=None, ignore_risk_resources_enabled=None, ignored_risk_resources=None, images=None, kube_cis_enabled=None, kubernetes_controls_names=None, labels=None, malware_action=None, maximum_score=None, maximum_score_enabled=None, maximum_score_exclude_no_fix=None, monitored_malware_paths=None, name=None, only_none_root_users=None, packages_black_list_enabled=None, packages_black_lists=None, packages_white_list_enabled=None, packages_white_lists=None, partial_results_image_fail=None, read_only=None, registries=None, registry=None, required_labels=None, required_labels_enabled=None, scan_nfs_mounts=None, scan_sensitive_data=None, scap_enabled=None, scap_files=None, scopes=None, trusted_base_images=None, trusted_base_images_enabled=None, whitelisted_licenses=None, whitelisted_licenses_enabled=None):
        ...
        if kubernetes_controls_names and not isinstance(kubernetes_controls_names, list):
            raise TypeError("Expected argument 'kubernetes_controls_names' to be a list")
    ...
    def auto_scan_times(self) -> Sequence['outputs.GetKubernetesAssurancePolicyAutoScanTimeResult']:
    ...
    def custom_checks(self) -> Sequence['outputs.GetKubernetesAssurancePolicyCustomCheckResult']:
        """
    ...
    def forbidden_labels(self) -> Sequence['outputs.GetKubernetesAssurancePolicyForbiddenLabelResult']:
    ...
    def kubernetes_controls_names(self) -> Sequence[str]:
        """
    ...
    def packages_white_lists(self) -> Sequence['outputs.GetKubernetesAssurancePolicyPackagesWhiteListResult']:
        """
    ...
    def required_labels(self) -> Sequence['outputs.GetKubernetesAssurancePolicyRequiredLabelResult']:
    ...
    @property
    @pulumi.getter
    def scopes(self) -> Sequence['outputs.GetKubernetesAssurancePolicyScopeResult']:
        return pulumi.get(self, "scopes")

    @property
    @pulumi.getter(name="trustedBaseImages")
    def trusted_base_images(self) -> Sequence['outputs.GetKubernetesAssurancePolicyTrustedBaseImageResult']:
        """
...
class AwaitableGetKubernetesAssurancePolicyResult(GetKubernetesAssurancePolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetKubernetesAssurancePolicyResult(
            ...
            kubernetes_controls_names=self.kubernetes_controls_names,
            labels=self.labels,
...
def get_kubernetes_assurance_policy(name: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetKubernetesAssurancePolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('aquasec:index/getKubernetesAssurancePolicy:getKubernetesAssurancePolicy', __args__, opts=opts, typ=GetKubernetesAssurancePolicyResult).value

    return AwaitableGetKubernetesAssurancePolicyResult(
        allowed_images=pulumi.get(__ret__, 'allowed_images'),
        application_scopes=pulumi.get(__ret__, 'application_scopes'),
        audit_on_failure=pulumi.get(__ret__, 'audit_on_failure'),
        author=pulumi.get(__ret__, 'author'),
        auto_scan_configured=pulumi.get(__ret__, 'auto_scan_configured'),
        auto_scan_enabled=pulumi.get(__ret__, 'auto_scan_enabled'),
        auto_scan_times=pulumi.get(__ret__, 'auto_scan_times'),
        blacklist_permissions=pulumi.get(__ret__, 'blacklist_permissions'),
        blacklist_permissions_enabled=pulumi.get(__ret__, 'blacklist_permissions_enabled'),
        blacklisted_licenses=pulumi.get(__ret__, 'blacklisted_licenses'),
        blacklisted_licenses_enabled=pulumi.get(__ret__, 'blacklisted_licenses_enabled'),
        block_failed=pulumi.get(__ret__, 'block_failed'),
        control_exclude_no_fix=pulumi.get(__ret__, 'control_exclude_no_fix'),
        custom_checks=pulumi.get(__ret__, 'custom_checks'),
        custom_checks_enabled=pulumi.get(__ret__, 'custom_checks_enabled'),
        custom_severity_enabled=pulumi.get(__ret__, 'custom_severity_enabled'),
        cves_black_list_enabled=pulumi.get(__ret__, 'cves_black_list_enabled'),
        cves_black_lists=pulumi.get(__ret__, 'cves_black_lists'),
        cves_white_list_enabled=pulumi.get(__ret__, 'cves_white_list_enabled'),
        cves_white_lists=pulumi.get(__ret__, 'cves_white_lists'),
        cvss_severity=pulumi.get(__ret__, 'cvss_severity'),
        cvss_severity_enabled=pulumi.get(__ret__, 'cvss_severity_enabled'),
        cvss_severity_exclude_no_fix=pulumi.get(__ret__, 'cvss_severity_exclude_no_fix'),
        description=pulumi.get(__ret__, 'description'),
        disallow_malware=pulumi.get(__ret__, 'disallow_malware'),
        docker_cis_enabled=pulumi.get(__ret__, 'docker_cis_enabled'),
        domain=pulumi.get(__ret__, 'domain'),
        domain_name=pulumi.get(__ret__, 'domain_name'),
        dta_enabled=pulumi.get(__ret__, 'dta_enabled'),
        dta_severity=pulumi.get(__ret__, 'dta_severity'),
        enabled=pulumi.get(__ret__, 'enabled'),
        enforce=pulumi.get(__ret__, 'enforce'),
        enforce_after_days=pulumi.get(__ret__, 'enforce_after_days'),
        enforce_excessive_permissions=pulumi.get(__ret__, 'enforce_excessive_permissions'),
        exceptional_monitored_malware_paths=pulumi.get(__ret__, 'exceptional_monitored_malware_paths'),
        fail_cicd=pulumi.get(__ret__, 'fail_cicd'),
        forbidden_labels=pulumi.get(__ret__, 'forbidden_labels'),
        forbidden_labels_enabled=pulumi.get(__ret__, 'forbidden_labels_enabled'),
        force_microenforcer=pulumi.get(__ret__, 'force_microenforcer'),
        function_integrity_enabled=pulumi.get(__ret__, 'function_integrity_enabled'),
        id=pulumi.get(__ret__, 'id'),
        ignore_recently_published_vln=pulumi.get(__ret__, 'ignore_recently_published_vln'),
        ignore_recently_published_vln_period=pulumi.get(__ret__, 'ignore_recently_published_vln_period'),
        ignore_risk_resources_enabled=pulumi.get(__ret__, 'ignore_risk_resources_enabled'),
        ignored_risk_resources=pulumi.get(__ret__, 'ignored_risk_resources'),
        images=pulumi.get(__ret__, 'images'),
        kube_cis_enabled=pulumi.get(__ret__, 'kube_cis_enabled'),
        kubernetes_controls_names=pulumi.get(__ret__, 'kubernetes_controls_names'),
        labels=pulumi.get(__ret__, 'labels'),
        malware_action=pulumi.get(__ret__, 'malware_action'),
        maximum_score=pulumi.get(__ret__, 'maximum_score'),
        maximum_score_enabled=pulumi.get(__ret__, 'maximum_score_enabled'),
        maximum_score_exclude_no_fix=pulumi.get(__ret__, 'maximum_score_exclude_no_fix'),
        monitored_malware_paths=pulumi.get(__ret__, 'monitored_malware_paths'),
        name=pulumi.get(__ret__, 'name'),
        only_none_root_users=pulumi.get(__ret__, 'only_none_root_users'),
        packages_black_list_enabled=pulumi.get(__ret__, 'packages_black_list_enabled'),
        packages_black_lists=pulumi.get(__ret__, 'packages_black_lists'),
        packages_white_list_enabled=pulumi.get(__ret__, 'packages_white_list_enabled'),
        packages_white_lists=pulumi.get(__ret__, 'packages_white_lists'),
        partial_results_image_fail=pulumi.get(__ret__, 'partial_results_image_fail'),
        read_only=pulumi.get(__ret__, 'read_only'),
        registries=pulumi.get(__ret__, 'registries'),
        registry=pulumi.get(__ret__, 'registry'),
        required_labels=pulumi.get(__ret__, 'required_labels'),
        required_labels_enabled=pulumi.get(__ret__, 'required_labels_enabled'),
        scan_nfs_mounts=pulumi.get(__ret__, 'scan_nfs_mounts'),
        scan_sensitive_data=pulumi.get(__ret__, 'scan_sensitive_data'),
        scap_enabled=pulumi.get(__ret__, 'scap_enabled'),
        scap_files=pulumi.get(__ret__, 'scap_files'),
        scopes=pulumi.get(__ret__, 'scopes'),
        trusted_base_images=pulumi.get(__ret__, 'trusted_base_images'),
        trusted_base_images_enabled=pulumi.get(__ret__, 'trusted_base_images_enabled'),
        whitelisted_licenses=pulumi.get(__ret__, 'whitelisted_licenses'),
        whitelisted_licenses_enabled=pulumi.get(__ret__, 'whitelisted_licenses_enabled'))


@_utilities.lift_output_func(get_kubernetes_assurance_policy)
def get_kubernetes_assurance_policy_output(name: Optional[pulumi.Input[str]] = None,
                                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetKubernetesAssurancePolicyResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
