...
__all__ = [
    'GetFunctionAssurancePolicyResult',
    'AwaitableGetFunctionAssurancePolicyResult',
    'get_function_assurance_policy',
    'get_function_assurance_policy_output',
]

@pulumi.output_type
class GetFunctionAssurancePolicyResult:
    """
    ...
    def auto_scan_times(self) -> Sequence['outputs.GetFunctionAssurancePolicyAutoScanTimeResult']:
    ...
    def custom_checks(self) -> Sequence['outputs.GetFunctionAssurancePolicyCustomCheckResult']:
        """
    ...
    def forbidden_labels(self) -> Sequence['outputs.GetFunctionAssurancePolicyForbiddenLabelResult']:
    ...
    def packages_white_lists(self) -> Sequence['outputs.GetFunctionAssurancePolicyPackagesWhiteListResult']:
        """
    ...
    def required_labels(self) -> Sequence['outputs.GetFunctionAssurancePolicyRequiredLabelResult']:
    ...
    @property
    @pulumi.getter
    def scopes(self) -> Sequence['outputs.GetFunctionAssurancePolicyScopeResult']:
        return pulumi.get(self, "scopes")

    @property
    @pulumi.getter(name="trustedBaseImages")
    def trusted_base_images(self) -> Sequence['outputs.GetFunctionAssurancePolicyTrustedBaseImageResult']:
        """
...
class AwaitableGetFunctionAssurancePolicyResult(GetFunctionAssurancePolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFunctionAssurancePolicyResult(
...
def get_function_assurance_policy(name: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFunctionAssurancePolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('aquasec:index/getFunctionAssurancePolicy:getFunctionAssurancePolicy', __args__, opts=opts, typ=GetFunctionAssurancePolicyResult).value

    return AwaitableGetFunctionAssurancePolicyResult(
...
@_utilities.lift_output_func(get_function_assurance_policy)
def get_function_assurance_policy_output(name: Optional[pulumi.Input[str]] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetFunctionAssurancePolicyResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
