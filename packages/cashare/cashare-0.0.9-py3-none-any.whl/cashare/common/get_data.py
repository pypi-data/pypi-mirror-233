...
@retry(stop=stop_after_attempt(3),wait=wait_fixed(25),retry=retry_if_exception_type(Exception))
def _retry_get(url,timeout):
    ...
    """
    try:
        with  httpx.Client(timeout=30) as client:  # ，读取时间30s#解决timeout问题
            response = client.get(url, timeout=100)
...
if __name__ == '__main__':
    ...
    df = generate_data(sk_code="000001.sz", token='z9882e4b76023e40ff0ea54667f4c44de2i8', start_date='1990-04-02',
