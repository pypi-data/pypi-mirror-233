...
#技术指标
def mc_data(sk_code,type,token,ma,end_date=str(datetime.date.today().strftime('%Y-%m-%d')),start_date='19000101',):
...
if __name__ == '__main__':
    ...
    df=mc_data(ma='5_ema',sk_code="aapl",token='j2c4291a77c3ea30ebb85fa883a6235dc4g8',type='1min',start_date='2023-09-21',end_date='2023-09-24')
    print(df)
    pass
