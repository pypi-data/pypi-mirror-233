...
from .__util_adapters import select_versioned_value, CommunicationFormat
...
class Context:
    ...
    def search_eql(self, payload, returns="raw"):
        search_res = es_datalake_search_eql(payload)
...
def run(
    ...
    datalake = Datalake(storage_endpoint, ids_util)
    ...
    try:
        ...
        result = getattr(importlib.import_module(func_module), func_name)(
            input, context
        )
        ...
        taskResult = {"status": "completed", "result": result or {}}
