...
*SynchronizationApi* | [**post_sync_original**](docs/SynchronizationApi.md#post_sync_original) | **POST** /sync/setup/origin | Setup the origin dataset for synchronization
*SynchronizationApi* | [**post_sync_replica**](docs/SynchronizationApi.md#post_sync_replica) | **POST** /sync/setup/replica | Setup the replica dataset for synchronization
