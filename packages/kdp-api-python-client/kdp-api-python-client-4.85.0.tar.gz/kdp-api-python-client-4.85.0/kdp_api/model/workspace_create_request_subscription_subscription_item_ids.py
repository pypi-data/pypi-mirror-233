...
class WorkspaceCreateRequestSubscriptionSubscriptionItemIds(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """WorkspaceCreateRequestSubscriptionSubscriptionItemIds - a model defined in OpenAPI
