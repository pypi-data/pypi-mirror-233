...
def lazy_import():
    ...
    globals()['AccessControlLabel'] = AccessControlLabel


class UploadResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'access_control_label': (AccessControlLabel,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, dataset_id, files, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            access_control_label (AccessControlLabel): [optional]  # noqa: E501
            custom_metadata ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Custom Metadata. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, dataset_id, files, *args, **kwargs):  # noqa: E501
        """UploadResponse - a model defined in OpenAPI
