...
class Workspace(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, unique_id, name, *args, **kwargs):  # noqa: E501
        """Workspace - a model defined in OpenAPI

        Args:
            id (str): workspace ID
            unique_id (str): workspace unique ID for uniqueness check only
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, unique_id, name, *args, **kwargs):  # noqa: E501
        """Workspace - a model defined in OpenAPI
