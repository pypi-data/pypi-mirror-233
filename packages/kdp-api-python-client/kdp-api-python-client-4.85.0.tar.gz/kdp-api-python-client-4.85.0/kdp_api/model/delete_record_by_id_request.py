...
class DeleteRecordByIdRequest(ModelNormal):
    ...
    attribute_map = {
        'record_ids': 'recordIds',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, record_ids, *args, **kwargs):  # noqa: E501
        """DeleteRecordByIdRequest - a model defined in OpenAPI

        Args:
            record_ids ([str]): Ids of the records to be deleted. To delete all the records in the dataset set this to empty array and set deleteAll parameter to true
        ...
        Keyword Args:
            ...
            delete_all (bool): If this boolean is set to true, delete all records in the dataset that are visible to the user. [optional] if omitted the server will use the default value of False  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, record_ids, *args, **kwargs):  # noqa: E501
        """DeleteRecordByIdRequest - a model defined in OpenAPI
