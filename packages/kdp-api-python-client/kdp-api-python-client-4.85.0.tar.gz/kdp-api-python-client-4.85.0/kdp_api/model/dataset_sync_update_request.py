"""
    ...
    The version of the OpenAPI document: 4.85.0
...
class DatasetSyncUpdateRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, dataset_id, status, type, key, created_by_user_id, is_origin_workspace, host, workspace_id, workspace_unique_id, *args, **kwargs):  # noqa: E501
        """DatasetSyncUpdateRequest - a model defined in OpenAPI

        Args:
            id (str): dataset sync ID
            dataset_id (str): dataset ID
            status (str): Status of the dataset sync.<br>Pending, active, or canceled.
            type (str): Type of the Dataset Sync<br><br>read - the paired replica dataset can only read records from the origin dataset <br><br>write - the paired replica dataset can only write records to the origin dataset <br><br>manage - the paired replica dataset can read records from the origin dataset, <br>write records to the origin dataset, and delete records from the origin dataset
            key (str): Security key used for the dataset sync
            created_by_user_id (str): ID of User that created the dataset sync
            is_origin_workspace (bool): Indicates if dataset for sync originates in this workspace
            host (str): Our Host name
            workspace_id (str): Our workspace ID
            workspace_unique_id (str): Our workspace uniqueId
        ...
        self.is_origin_workspace = is_origin_workspace
        self.host = host
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, dataset_id, status, type, key, created_by_user_id, is_origin_workspace, host, workspace_id, workspace_unique_id, *args, **kwargs):  # noqa: E501
        """DatasetSyncUpdateRequest - a model defined in OpenAPI
