...
class Authentication(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, strategy, email, password, *args, **kwargs):  # noqa: E501
        """Authentication - a model defined in OpenAPI

        Args:
            strategy (str): The method of authentication
    ...
    @convert_js_args_to_python_args
    def __init__(self, strategy, email, password, *args, **kwargs):  # noqa: E501
        """Authentication - a model defined in OpenAPI
