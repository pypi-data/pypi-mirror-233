...
class SyncSetupReplica(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'sync_workspace_id': (str,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, dataset_id, status, type, workspace_id, workspace_unique_id, sync_workspace_id, sync_workspace_unique_id, host, sync_host, *args, **kwargs):  # noqa: E501
        """SyncSetupReplica - a model defined in OpenAPI

        Args:
            id (str): synchronization ID
            dataset_id (str): ID dataset to be synchronized
            status (str): synchronization status
            type (str): synchronization type
            workspace_id (str): Workspace ID
            workspace_unique_id (str): Workspace uniqueId
            sync_workspace_id (str): Sync Workspace ID
            sync_workspace_unique_id (str): Sync Workspace uniqueId
            host (str): Host
            sync_host (str): Sync Host
        ...
        self.sync_workspace_unique_id = sync_workspace_unique_id
        self.host = host
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, dataset_id, status, type, workspace_id, workspace_unique_id, sync_workspace_id, sync_workspace_unique_id, host, sync_host, *args, **kwargs):  # noqa: E501
        """SyncSetupReplica - a model defined in OpenAPI
