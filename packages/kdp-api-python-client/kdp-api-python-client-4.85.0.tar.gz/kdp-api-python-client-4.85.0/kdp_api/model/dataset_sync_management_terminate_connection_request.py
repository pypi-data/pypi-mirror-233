...
class DatasetSyncManagementTerminateConnectionRequest(ModelNormal):
    ...
    attribute_map = {
        ...
        'dataset_sync_id': 'datasetSyncId',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, action, dataset_sync_id, *args, **kwargs):  # noqa: E501
        """DatasetSyncManagementTerminateConnectionRequest - a model defined in OpenAPI

        Args:
            action (str): The dataset sync management action
            dataset_sync_id (str): The ID of the dataset-sync with the connection
        ...
        self.action = action
        self.dataset_sync_id = dataset_sync_id
    ...
    @convert_js_args_to_python_args
    def __init__(self, action, dataset_sync_id, *args, **kwargs):  # noqa: E501
        """DatasetSyncManagementTerminateConnectionRequest - a model defined in OpenAPI
