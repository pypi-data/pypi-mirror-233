...
class AuditLogConfiguration(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'keep_forever': (bool,),  # noqa: E501
            'age_in_days': (int,),  # noqa: E501
    ...
    attribute_map = {
        'keep_forever': 'keepForever',  # noqa: E501
        'age_in_days': 'ageInDays',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, keep_forever, *args, **kwargs):  # noqa: E501
        """AuditLogConfiguration - a model defined in OpenAPI

        Args:
            keep_forever (bool): flag to never delete the logs
        ...
        Keyword Args:
            ...
            age_in_days (int): The age of the logs- Logs older than that would be deleted, if the keepForever flag is false. [optional]  # noqa: E501
            workspace_id (str): The id of the workspace to which this configuration belongs. [optional]  # noqa: E501
            dataset_id (str): The id of the dataset in which the audit logs for this workspace is stored. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, keep_forever, *args, **kwargs):  # noqa: E501
        """AuditLogConfiguration - a model defined in OpenAPI
