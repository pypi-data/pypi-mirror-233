...
class AuthenticationSSO(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, strategy, access_token, *args, **kwargs):  # noqa: E501
        """AuthenticationSSO - a model defined in OpenAPI

        Args:
            strategy (str): The method of authentication for single sign-on customers
            access_token (str): The access_token retrieved by signing into the SSO account
    ...
    @convert_js_args_to_python_args
    def __init__(self, strategy, access_token, *args, **kwargs):  # noqa: E501
        """AuthenticationSSO - a model defined in OpenAPI
