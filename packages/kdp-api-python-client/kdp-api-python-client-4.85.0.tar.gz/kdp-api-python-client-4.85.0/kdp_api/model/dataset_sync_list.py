...
class DatasetSyncList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """DatasetSyncList - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([DatasetSync]): list of dataset syncs.  # noqa: E501

        Keyword Args:
            value ([DatasetSync]): list of dataset syncs.  # noqa: E501
