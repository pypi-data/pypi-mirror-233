...
class AuditLogEvent(ModelNormal):
    ...
    attribute_map = {
        'id': 'id',  # noqa: E501
        'type': 'type',  # noqa: E501
        'timestamp_ms': 'timestampMs',  # noqa: E501
        'dataset_id': 'datasetId',  # noqa: E501
        'user_id': 'userId',  # noqa: E501
        'description': 'description',  # noqa: E501
        'source_ip': 'sourceIP',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, type, timestamp_ms, dataset_id, *args, **kwargs):  # noqa: E501
        """AuditLogEvent - a model defined in OpenAPI

        Args:
            id (str): event ID
            type (str):
            timestamp_ms (int): event timestamp - UTC - Required. Number of milliseconds since the Unix epoch (January 1, 1970, 00:00:00 UTC).
        ...
        Keyword Args:
            ...
            user_id (str): user ID if available. [optional]  # noqa: E501
            description (str): details of the audit log event. [optional]  # noqa: E501
            source_ip (str): IP address of the user machine - optional. [optional]  # noqa: E501
            actor (str): The user who requested the action or `KDP Service` if initiated by KDP.. [optional]  # noqa: E501
            details ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): details of the audit log event. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, type, timestamp_ms, dataset_id, *args, **kwargs):  # noqa: E501
        """AuditLogEvent - a model defined in OpenAPI
