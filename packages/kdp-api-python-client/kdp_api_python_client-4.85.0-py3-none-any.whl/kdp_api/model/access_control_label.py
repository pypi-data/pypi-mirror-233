...
class AccessControlLabel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, security_labeled, security_label_info, *args, **kwargs):  # noqa: E501
        """AccessControlLabel - a model defined in OpenAPI

        Args:
            security_labeled (bool): Security Labeled
            security_label_info (SecurityLabelInfoParams):
        ...
        self.security_labeled = security_labeled
        self.security_label_info = security_label_info
    ...
    @convert_js_args_to_python_args
    def __init__(self, security_labeled, security_label_info, *args, **kwargs):  # noqa: E501
        """AccessControlLabel - a model defined in OpenAPI
