...
class AuditLogConfigurationList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """AuditLogConfigurationList - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([AuditLogConfiguration]): list of audit log configurations.  # noqa: E501

        Keyword Args:
            value ([AuditLogConfiguration]): list of audit log configurations.  # noqa: E501
