...
class DeleteRecordByQueryRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, query, *args, **kwargs):  # noqa: E501
        """DeleteRecordByQueryRequest - a model defined in OpenAPI

        Args:
            query (str): Records identified by running this query will be deleted
