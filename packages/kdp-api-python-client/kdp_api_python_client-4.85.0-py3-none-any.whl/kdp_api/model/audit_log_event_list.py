...
class AuditLogEventList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """AuditLogEventList - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([AuditLogEvent]): list of audit log events.  # noqa: E501

        Keyword Args:
            value ([AuditLogEvent]): list of audit log events.  # noqa: E501
