...
class SyncKafkaConsumerGroupId(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, sync_workspace_unique_id, sync_dataset_id, dataset_id, *args, **kwargs):  # noqa: E501
        """SyncKafkaConsumerGroupId - a model defined in OpenAPI

        Args:
            sync_workspace_unique_id (str): sync workspace unique ID
            sync_dataset_id (str): sync dataset ID
        ...
        self.sync_dataset_id = sync_dataset_id
    ...
    @convert_js_args_to_python_args
    def __init__(self, sync_workspace_unique_id, sync_dataset_id, dataset_id, *args, **kwargs):  # noqa: E501
        """SyncKafkaConsumerGroupId - a model defined in OpenAPI
