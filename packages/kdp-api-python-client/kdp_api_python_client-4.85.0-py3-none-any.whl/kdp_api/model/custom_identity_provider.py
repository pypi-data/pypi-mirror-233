...
class CustomIdentityProvider(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'config': (KeycloakProviderConfiguration,),  # noqa: E501
            'id': (str,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, workspace_id, config, *args, **kwargs):  # noqa: E501
        """CustomIdentityProvider - a model defined in OpenAPI

        Args:
            workspace_id (str):
            config (KeycloakProviderConfiguration):

        Keyword Args:
            provider_type (str): defaults to "keycloak", must be one of ["keycloak", ]  # noqa: E501
            ...
            id (str): custom identity provider ID. [optional]  # noqa: E501
        """

        provider_type = kwargs.get('provider_type', "keycloak")
    ...
    @convert_js_args_to_python_args
    def __init__(self, workspace_id, config, *args, **kwargs):  # noqa: E501
        """CustomIdentityProvider - a model defined in OpenAPI
