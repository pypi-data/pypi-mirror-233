...
class CustomIdentityProviderList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """CustomIdentityProviderList - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([CustomIdentityProvider]): list of custom identity providers.  # noqa: E501

        Keyword Args:
            value ([CustomIdentityProvider]): list of custom identity providers.  # noqa: E501
