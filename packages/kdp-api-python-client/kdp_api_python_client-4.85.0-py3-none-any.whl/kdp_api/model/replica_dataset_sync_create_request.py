...
class ReplicaDatasetSyncCreateRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, sync_host, sync_id, *args, **kwargs):  # noqa: E501
        """ReplicaDatasetSyncCreateRequest - a model defined in OpenAPI

        Args:
            key (str): Security key used for the dataset sync  Is the **key** field from **Create Sync Key (Create Origin Dataset Sync)** response body.  *Plain Text key is only available from the **Create Sync Key (Create Origin Dataset Sync)** POST response, key is encrypted on GET requests.* 
            sync_host (str): The Host Name of the paired Sync Workspace
            sync_id (str): The ID of the dataset-sync in paired Sync Workspace  *For a paired replica, this is the Origin Dataset Sync ID*  *For the origin sync, this is the Paired Replica Dataset Sync ID* 
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, sync_host, sync_id, *args, **kwargs):  # noqa: E501
        """ReplicaDatasetSyncCreateRequest - a model defined in OpenAPI
