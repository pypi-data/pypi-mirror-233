...
class DeleteDocumentByQueryRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, query, *args, **kwargs):  # noqa: E501
        """DeleteDocumentByQueryRequest - a model defined in OpenAPI

        Args:
            query (str): Documents identified by running this query will be deleted
