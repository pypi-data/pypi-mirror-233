...
def load_most_recent_dnb(specific_year_month=False):
    ...
    if specific_year_month==False:
        ...
        try:
            dnb = pd.read_csv(dnb_folder[0][0] + 'Eurofiber_NL.csv', dtype=dtype_dict, low_memory=False, sep=';', encoding='ISO-8859-1')
            return dnb  
        except:
            dnb = pd.read_csv(dnb_folder[0][0] + 'Eurofiber_NL.csv', dtype=dtype_dict, low_memory=False)
            return dnb              
    else:
        try:
            ...
            specific_year_month = specific_year_month[:4] + ' ' + specific_year_month[-2:]
            dnb = pd.read_csv(r'C:\Users\thaibinh.luu\Eurofiber Nederland BV\Project GLOBE - General\02 Data Lake\01 Companies\Smart Profile/{}/Eurofiber_NL.csv'.format(specific_year_month), dtype=dtype_dict, low_memory=False, sep=';', encoding='ISO-8859-1')
            return dnb
...
def load_most_recent_dnb_enriched(specific_year_month=False):
    ...
    if specific_year_month==False:    
        ...
        try:
            specific_year_month = specific_year_month[:4] + ' ' + specific_year_month[-2:]
            dnb = pd.read_csv(r'C:\Users\thaibinh.luu\Eurofiber Nederland BV\Project GLOBE - General\02 Data Lake\01 Companies\SP Enriched/{}/Eurofiber_NL.csv'.format(specific_year_month), dtype=dtype_dict, low_memory=False)
            return dnb        
        except:
            specific_year_month = specific_year_month[:4] + ' ' + specific_year_month[-2:]
            dnb = pd.read_csv(r'C:\Users\thaibinh.luu\Eurofiber Nederland BV\Project GLOBE - General\02 Data Lake\01 Companies\SP Enriched/{}/Eurofiber_NL.csv'.format(specific_year_month), dtype=dtype_dict, low_memory=False, sep=';')
            return dnb 
