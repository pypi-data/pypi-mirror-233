'''
Performs unit tests on the Pioneer REST Cliet and API.
...
class TestApi(unittest.TestCase):
    ...
    def databases_utilized_by_unittest(self, all: bool = False) -> List[Dict[str, Any]]:
        '''which databases are used by unittests
    ...
    def test_account_info(self) -> None:
        ...
        self.assertIn(resp['subscriptionName'], ('Standard', 'Professional', 'empcustom'))
    ...
    def test_andromeda_utility(self) -> None:
        ...
        util_preivew: bool = True if utils['utilities'][item]['stable'] is False else False

        # TODO OE-8726 test a specific utility
        resp: Dict[str, Any] = self.API._andromeda_utility(util_name, util_preivew)
        self.assertIsInstance(resp, dict)
        self.assertIsInstance(resp['result'], str)
        self.assertEqual(resp['result'], 'success')
    ...
    def test_andromeda_utility_run(self) -> None:
        ...
        # TODO OE-8726 commardArgs is CLI mechanism for input parameters to py module
        resp: Dict[str, Any] = self.API.wksp_job_start(
            wksp=self.WKSP,
            command=cmd,
            utility_name=util_name,
            utility_preview_version=util_preivew,
    ...
    def test_cache_store_add(self) -> None:
        ...
        # clean up and remove unittests cache entries!
    ...
    def test_database_clone(self) -> None:
        ...
        bytes_diff_perc: float = bytes_diff / db_src['bytesUsed']
        self.assertLess(bytes_diff_perc, 1.0)
    ...
    def test_database_create_delete(self) -> None:
        ...
        db: Dict[str, Any] = self.API.database(dbname)
    ...
    def test_database_create_delete_all(self) -> None:
        ...
        for tname, tid in self.API.DATABASE_TEMPLATES_NAMEID.items():
            ...
            if tid == 'template1' or tid.startswith('anura_2_'):
    ...
    def test_database_create_delete_wrong_id(self) -> None:
        ...
        resp = self.API.database_create(name='cant', template=tname)
        self.assertEqual(resp['crash'], True)
        self.assertEqual(resp['exception'].response.status_code, 400)
        ...
        resp: Dict[str, Any] = self.API.database_create(
            dbname, desc=f'unittest {dbname} {tname}', template=tids[0], backups=False
        )
        self.assertIsInstance(resp['result'], str)
        self.assertEqual(resp['result'], 'success')
        self.assertIsInstance(resp['storageId'], str)
    ...
    def test_database_create_failure_template_bad(self) -> None:
        ...
        resp = self.API.database_create(name='cant', template='does_not_exist')
        self.assertEqual(resp['crash'], True)
        self.assertEqual(resp['exception'].response.status_code, 400)
    ...
    def test_database_create_failure_template_swap(self) -> None:
        ...
        resp = self.API.database_create(name='cant', template='Out of China')
        self.assertEqual(resp['crash'], True)
        self.assertEqual(resp['exception'].response.status_code, 400)
    ...
    def test_database_templates(self) -> None:
        ...
        templates: Dict[float, Templates] = {
            ...
            7.6: {
                'id': 7.6,
                'name': 'Anura New Model v2.6.31.3.1 (cost to serve)',
                'templateType': 'baseline',
                'pgTemplateName': 'anura_2_6_31_3_1_clean',
                'schema': 'anura',
                'baselineSchemaVersion': '2.6.31.3.1',
                'baseId': 7,
            ...
            33.1: {
                'id': 33.1,
                'name': 'Anura New Model v2.7.1',
                'templateType': 'baseline',
                'pgTemplateName': 'anura_2_7_1_clean',
                'schema': 'anura',
                'baselineSchemaVersion': '2.7.1',
                'baseId': 33,
            ...
            9.7: {
                'id': 9.7,
                'name': 'Global Supply Chain Strategy (with cost to serve)',
                'templateType': 'templateSet',
                'pgTemplateName': '25250120-50ce-11ee-829d-000000017a27',
                'schema': 'anura',
                'baselineSchemaVersion': '2.6.31.3',
                'baseId': 9,
                'templateVersion': '2.6.31.3.1',
            ...
            9.8: {
                'id': 9.8,
                'name': 'Global Supply Chain Strategy (2.7)',
                'templateType': 'templateSet',
                'pgTemplateName': 'f4c046ec-504f-11ee-a606-657d93e1818a',
                'schema': 'anura',
                'baselineSchemaVersion': '2.7.1',
                'baseId': 9,
                'templateVersion': '2.7.1',
            ...
            12.4: {
                'id': 12.4,
                'name': 'Tactical Capacity Optimization (with cost to serve)',
                'templateType': 'templateSet',
                'pgTemplateName': '25250fec-50ce-11ee-8964-000000017670',
                'schema': 'anura',
                'baselineSchemaVersion': '2.6.31.3',
                'baseId': 12,
                'templateVersion': '2.6.31.3.1',
            ...
            12.5: {
                'id': 12.5,
                'name': 'Tactical Capacity Optimization (2.7)',
                'templateType': 'templateSet',
                'pgTemplateName': 'b26e706e-5056-11ee-a606-657d93e1818a',
                'schema': 'anura',
                'baselineSchemaVersion': '2.7.1',
                'baseId': 12,
                'templateVersion': '2.7.1',
            ...
            15.3: {
                'id': 15.3,
                'name': 'Detailed Facility Selection (with cost to serve)',
                'templateType': 'templateSet',
                'pgTemplateName': '252516f5-50ce-11ee-95c0-0000000150a1',
                'schema': 'anura',
                'baselineSchemaVersion': '2.6.31.3',
                'baseId': 15,
                'templateVersion': '2.6.31.3.1',
            ...
            15.4: {
                'id': 15.4,
                'name': 'Detailed Facility Selection (2.7)',
                'templateType': 'templateSet',
                'pgTemplateName': '07426f5a-5057-11ee-a606-657d93e1818a',
                'schema': 'anura',
                'baselineSchemaVersion': '2.7.1',
                'baseId': 15,
                'templateVersion': '2.7.1',
            ...
            18.4: {
                'id': 18.4,
                'name': 'United States Greenfield Facility Selection (with cost to serve)',
                'templateType': 'templateSet',
                'pgTemplateName': '25251c18-50ce-11ee-8d45-00000000313d',
                'schema': 'anura',
                'baselineSchemaVersion': '2.6.31.3',
                'baseId': 18,
                'templateVersion': '2.6.31.3.1',
            ...
            18.5: {
                'id': 18.5,
                'name': 'United States Greenfield Facility Selection (2.7)',
                'templateType': 'templateSet',
                'pgTemplateName': '246ef03c-5050-11ee-a606-657d93e1818a',
                'schema': 'anura',
                'baselineSchemaVersion': '2.7.1',
                'baseId': 18,
                'templateVersion': '2.7.1',
            ...
            21.3: {
                'id': 21.3,
                'name': 'China Exit Strategy in Asia (with cost to serve)',
                'templateType': 'templateSet',
                'pgTemplateName': '252520d1-50ce-11ee-b69d-000000009ab7',
                'schema': 'anura',
                'baselineSchemaVersion': '2.6.31.3',
                'baseId': 21,
                'templateVersion': '2.6.31.3.1',
            ...
            21.4: {
                'id': 21.4,
                'name': 'China Exit Strategy in Asia (2.7)',
                'templateType': 'templateSet',
                'pgTemplateName': '488bb1bc-5050-11ee-a606-657d93e1818a',
                'schema': 'anura',
                'baselineSchemaVersion': '2.7.1',
                'baseId': 21,
                'templateVersion': '2.7.1',
            ...
            24.4: {
                'id': 24.4,
                'name': 'China Exit Risk Strategy (with cost to serve)',
                'templateType': 'templateSet',
                'pgTemplateName': '2525250f-50ce-11ee-893c-0000000035ff',
                'schema': 'anura',
                'baselineSchemaVersion': '2.6.31.3',
                'baseId': 24,
                'templateVersion': '2.6.31.3.1',
            ...
            24.5: {
                'id': 24.5,
                'name': 'China Exit Risk Strategy (2.7)',
                'templateType': 'templateSet',
                'pgTemplateName': '6a69f47e-5050-11ee-a606-657d93e1818a',
                'schema': 'anura',
                'baselineSchemaVersion': '2.7.1',
                'baseId': 24,
                'templateVersion': '2.7.1',
            ...
            27.3: {
                'id': 27.3,
                'name': 'Multi-Year Capacity Planning (with cost to serve)',
                'templateType': 'templateSet',
                'pgTemplateName': '25252975-50ce-11ee-85f1-000000001efe',
                'schema': 'anura',
                'baselineSchemaVersion': '2.6.31.3',
                'baseId': 27,
                'templateVersion': '2.6.31.3.1',
            ...
            27.4: {
                'id': 27.4,
                'name': 'Multi-Year Capacity Planning (2.7)',
                'templateType': 'templateSet',
                'pgTemplateName': 'af65ebdc-5050-11ee-a606-657d93e1818a',
                'schema': 'anura',
                'baselineSchemaVersion': '2.7.1',
                'baseId': 27,
                'templateVersion': '2.7.1',
            ...
            28.3: {
                'id': 28.3,
                'name': 'Fleet Size Optimization - EMEA Geo (with cost to serve)',
                'templateType': 'templateSet',
                'pgTemplateName': '25252d73-50ce-11ee-bdaa-00000001398f',
                'schema': 'anura',
                'baselineSchemaVersion': '2.6.31.3',
                'baseId': 28,
                'templateVersion': '2.6.31.3.1',
            ...
            28.4: {
                'id': 28.4,
                'name': 'Fleet Size Optimization - EMEA Geo (2.7)',
                'templateType': 'templateSet',
                'pgTemplateName': 'e36ed1fa-5050-11ee-a606-657d93e1818a',
                'schema': 'anura',
                'baselineSchemaVersion': '2.7.1',
                'baseId': 28,
                'templateVersion': '2.7.1',
            ...
            29.1: {
                ...
                'templateType': 'templateSet',
                'pgTemplateName': '31d503bc-d00b-11ed-b72f-9fd8ea75300c',
                'schema': 'anura',
                'baselineSchemaVersion': '2.6.31.3',
                'baseId': 29,
                'templateVersion': '2.6.31.3',
                ...
                'media': [{'type': 'yt', 'url': 'https://youtu.be/dmzaZP1-lm8'}],
            },
            29.2: {
                'id': 29.2,
                'name': 'Global Risk Analysis (with cost to serve)',
                'templateType': 'templateSet',
                'pgTemplateName': '252531cd-50ce-11ee-ae12-00000001467e',
                'schema': 'anura',
                'baselineSchemaVersion': '2.6.31.3',
                'baseId': 29,
                ...
                'isDefault': True,
                'tags': ['Risk & Resiliency', 'Network Optimization', 'MIP', 'Risk', 'Cosmic Frog'],
                'media': [{'type': 'yt', 'url': 'https://www.youtube.com/watch?v=dmzaZP1-lm8'}],
            },
            29.3: {
                'id': 29.3,
                'name': 'Global Risk Analysis (2.7)',
                'templateType': 'templateSet',
                'pgTemplateName': '4950fa98-5051-11ee-a606-657d93e1818a',
                'schema': 'anura',
                'baselineSchemaVersion': '2.7.1',
                'baseId': 29,
                'templateVersion': '2.7.1',
                ...
                'isDefault': True,
                'tags': ['Risk & Resiliency', 'Network Optimization', 'MIP', 'Risk', 'Cosmic Frog'],
                'media': [{'type': 'yt', 'url': 'https://www.youtube.com/watch?v=new-url'}],
            },
            30.2: {
                'id': 30.2,
            ...
            30.3: {
                'id': 30.3,
                'name': 'Fleet Size Optimization - US Geo (with cost to serve)',
                'templateType': 'templateSet',
                'pgTemplateName': '2525361b-50ce-11ee-948c-0000000148d5',
                'schema': 'anura',
                'baselineSchemaVersion': '2.6.31.3',
                'baseId': 30,
                'templateVersion': '2.6.31.3.1',
            ...
            30.4: {
                'id': 30.4,
                'name': 'Fleet Size Optimization - US Geo (2.7)',
                'templateType': 'templateSet',
                'pgTemplateName': 'ccd635f8-5057-11ee-a606-657d93e1818a',
                'schema': 'anura',
                'baselineSchemaVersion': '2.7.1',
                'baseId': 30,
                'templateVersion': '2.7.1',
            ...
            31.2: {
                'id': 31.2,
                'name': 'Global Sustainability Analysis (with cost to serve)',
                'templateType': 'templateSet',
                'pgTemplateName': '25253a1e-50ce-11ee-bfc2-000000009236',
                'schema': 'anura',
                'baselineSchemaVersion': '2.6.31.3',
                'baseId': 31,
                'templateVersion': '2.6.31.3.1',
            ...
            31.3: {
                'id': 31.3,
                'name': 'Global Sustainability Analysis (2.7)',
                'templateType': 'templateSet',
                'pgTemplateName': '7242506e-5051-11ee-a606-657d93e1818ad',
                'schema': 'anura',
                'baselineSchemaVersion': '2.7.1',
                'baseId': 31,
                'templateVersion': '2.7.1',
                ...
                'media': [{'type': 'yt', 'url': 'https://youtu.be/new-url'}],
            },
            32.1: {
                'id': 32.1,
                'name': 'Global Sourcing - Cost To Serve',
                'templateType': 'templateSet',
                'pgTemplateName': '225b7500-0f7c-11ee-85d5-fdae5abf8381',
                'schema': 'anura',
                'baselineSchemaVersion': '2.6.31.3',
                'baseId': 32,
                'templateVersion': '2.6.31.3',
            ...
            32.2: {
                'id': 32.2,
                'name': 'Global Sourcing - Cost To Serve (with cost to serve)',
                'templateType': 'templateSet',
                'pgTemplateName': '25253e2e-50ce-11ee-a469-0000000076c1',
                'schema': 'anura',
                'baselineSchemaVersion': '2.6.31.3',
                'baseId': 32,
                'templateVersion': '2.6.31.3.1',
            ...
            32.3: {
                'id': 32.3,
                'name': 'Global Sourcing - Cost To Serve (2.7)',
                'templateType': 'templateSet',
                'pgTemplateName': '01d0da30-5051-11ee-a606-657d93e1818a',
                'schema': 'anura',
                'baselineSchemaVersion': '2.7.1',
                'baseId': 32,
                'templateVersion': '2.7.1',
    ...
    def test_wksp_job_start_preview(self) -> None:
        ...
        self.assertEqual(job['result'], 'success')
            ...
            self.WKSP, job_key=job_beta['jobKey'], stop_when='done'
        )
        ...
        pkg_beta: Dict[str, Dict[str, str]] = {d['name']: d for d in jsn}
        self.assertRegex(pkg_beta['neo']['version'], r'2\.6\.\d+')

        done: bool = self.API.util_job_monitor(self.WKSP, job_key=job['jobKey'], stop_when='done')
        self.assertTrue(done)
        std_out: str = self.API.wksp_job_file_result(self.WKSP, job['jobKey'])
        self.assertIsInstance(std_out, str)
        jsn = self.deserialize_pip_output(std_out)
        pkg: Dict[str, Dict[str, str]] = {d['name']: d for d in jsn}
        self.assertRegex(pkg['neo']['version'], r'2\.6\.\d+')

        diff: Dict[str, str] = {}
        for d in pkg:
            if pkg_beta.get(d) is None:
                diff[d] = 'not found in preview image'
            elif pkg[d]['version'] != pkg_beta[d]['version']:
                diff[d] = f"{pkg[d]['version']} != {pkg_beta[d]['version']}"
        if diff:
