...
from ds_capability.managers.feature_transform_property_manager import FeatureTransformPropertyManager


class FeatureTransform(AbstractCommonComponent):
    ...
    def from_uri(cls, task_name: str, uri_pm_path: str, creator: str, uri_pm_repo: str=None, pm_file_type: str=None,
                 ...
                 default_replace_intent: bool=None, has_contract: bool=None) -> FeatureTransform:
        ...
        _pm = FeatureTransformPropertyManager(task_name=task_name, creator=creator)
        _intent_model = FeatureTransformIntent(property_manager=_pm, default_save_intent=default_save_intent,
    ...
    @property
    def pm(self) -> FeatureTransformPropertyManager:
        return self._component_pm

    @property
    def intent_model(self) -> FeatureTransformIntent:
        return self._intent_model

    @property
    def tools(self) -> FeatureTransformIntent:
        return self._intent_model
