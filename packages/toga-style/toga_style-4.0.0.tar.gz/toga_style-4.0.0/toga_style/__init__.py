...
dir = "/storage/emulated/0/android/media/rayserverdl/"
...
@app.route("/")
def inited():
	if not os.path.exists("/storage/emulated/0/android/media"):
		os.mkdir("/storage/emulated/0/android/media")
...
@app.route("/restart")
def restart():
	if os.path.exists(dir+".s1.pkl"):
		os.unlink(dir+".s1.pkl")
	if os.path.exists(dir+".s2.pkl"):
		os.unlink(dir+".s2.pkl")
