...
VERSION = '1.1.3'
DESCRIPTION = 'A Package for to optimize models,save data structure to use endless time, use for nlp short word treatment, choosing optimal data for ML models, use for Image Scraping , use in timeseries problem to split the data into train and test','Deal with emojis and emoticons in nlp,word tokenize,token, get the list of Punctuation marks and English Pronouns too'
