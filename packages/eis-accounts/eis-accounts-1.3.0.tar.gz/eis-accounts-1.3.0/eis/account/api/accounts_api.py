...
class AccountsApi(object):
    ...
    def create_account(
        ...
        **kwargs
        ...
        This will create an account in the database. Account creation is usually part      of a complex workflow that starts with lead creation. Creating directly an account without prior knowledge     might result in an unusable account. Look into lead creation for more information.  # noqa: E501
    ...
    def delete_account(
        ...
        **kwargs
        ...
        Permanently deletes the account. Supply the unique code that was returned when you created the account and this will delete it.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_account(
        ...
        **kwargs
        ...
        Retrieves the details of the account that was previously created. Supply the unique account code that was returned when you created it and Emil Api will return the corresponding account information.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        Keyword Args:
            authorization (str): Bearer Token: provided by the login endpoint under the name accessToken.. [optional]
            expand (str): Use the expand query parameter when you need additional information.      The expand query parameter increases the set of fields that appear in the response      in addition to the default fields.      Expanding resources reduces the number of API calls required to accomplish a task.. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
    ...
    def list_accounts(
        ...
        **kwargs
        ...
        Returns a list of accounts you have previously created. The accounts are returned in sorted order, with the oldest one appearing first. For more information about pagination, read the Pagination documentation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_account(
        ...
        **kwargs
        ...
        Updates the specified account by setting the values of the parameters passed. Any parameters not provided will be left unchanged.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
