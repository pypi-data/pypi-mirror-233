...
if TYPE_CHECKING:
    from dotserve.haystack.callbacks import HaystackAgentCallbackHandler
    from dotserve.langchain.callbacks import (
        LangchainCallbackHandler,
        AsyncLangchainCallbackHandler,
    )
    from dotserve.llama_index.callbacks import LlamaIndexCallbackHandler

import dotserve.input_widget as input_widget
from dotserve.action import Action
from dotserve.cache import cache
from dotserve.chat_settings import ChatSettings
from dotserve.client.base import AppUser, PersistedAppUser
from dotserve.config import config
from dotserve.element import (
    Audio,
    Avatar,
    File,
    Image,
...
from dotserve.message import AskFileMessage, AskUserMessage, ErrorMessage, Message
from dotserve.oauth_providers import get_configured_oauth_providers
from dotserve.sync import make_async, run_sync
from dotserve.telemetry import trace
from dotserve.types import FileSpec
from dotserve.user_session import user_session
from dotserve.utils import make_module_getattr, wrap_user_function
...
__getattr__ = make_module_getattr(
    {
        "LangchainCallbackHandler": "dotserve.langchain.callbacks",
        "AsyncLangchainCallbackHandler": "dotserve.langchain.callbacks",
        "LlamaIndexCallbackHandler": "dotserve.llama_index.callbacks",
        "HaystackAgentCallbackHandler": "dotserve.haystack.callbacks",
    }
)
