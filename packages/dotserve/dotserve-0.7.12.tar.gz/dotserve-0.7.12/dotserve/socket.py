...
from dotserve.auth import get_current_user, require_login
from dotserve.client.base import MessageDict
from dotserve.config import config
from dotserve.context import init_ws_context
from dotserve.logger import logger
from dotserve.message import ErrorMessage, Message
from dotserve.server import socket
from dotserve.session import WebsocketSession
from dotserve.telemetry import trace_event
from dotserve.user_session import user_sessions
...
async def connect(sid, environ, auth):
    ...
    session_id = environ.get("HTTP_X_DOTSERVE_SESSION_ID")
