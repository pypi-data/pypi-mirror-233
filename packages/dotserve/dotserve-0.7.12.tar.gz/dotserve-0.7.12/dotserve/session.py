...
if TYPE_CHECKING:
    ...
    from dotserve.types import AskResponse
    ...
    async def get_conversation_id(self) -> Optional[str]:
        ...
        if not self.conversation_id:
            async with self.lock:
                ...
                self.conversation_id = await dotserve_client.create_conversation(
...
class HTTPSession(BaseSession):
    """Internal HTTP session object. Used to consume Dotserve through API (no websocket)."""
