...
class DotserveGraphQLClient:
    def __init__(self, api_key: str, dotserve_server: str):
        self.headers = {"content-type": "application/json"}
        if api_key:
            self.headers["x-api-key"] = api_key
        else:
            raise ValueError("Cannot instantiate Cloud Client without DOTSERVE_API_KEY")

        graphql_endpoint = f"{dotserve_server}/api/graphql"
