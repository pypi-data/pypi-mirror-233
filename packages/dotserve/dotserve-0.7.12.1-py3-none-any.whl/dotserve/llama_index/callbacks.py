...
from dotserve.context import context_var
from dotserve.element import Text
from dotserve.message import Message
from dotserve.prompt import Prompt, PromptMessage
...
class LlamaIndexCallbackHandler(BaseCallbackHandler):
    ...
    def _restore_context(self) -> None:
        """Restore Dotserve context in the current thread

        Dotserve context is local to the main thread, and LlamaIndex
        runs the callbacks in its own threads, so they don't have a
        Dotserve context by default.
