...
from dotserve.session import BaseSession, WebsocketSession
from dotserve.types import AskSpec, FileSpec
from socketio.exceptions import TimeoutError


class BaseDotserveEmitter:
    """
    Dotserve Emitter Stub class. This class is used for testing purposes.
    It stubs the DotserveEmitter class and does nothing on function calls.
    """
...
class DotserveEmitter(BaseDotserveEmitter):
    """
    Dotserve Emitter class. The Emitter is not directly exposed to the developer.
    ...
    async def process_user_message(self, message_dict: MessageDict):
        ...
        if dotserve_client:
            ...
            persisted_id = await dotserve_client.create_message(message_dict)
            if persisted_id:
