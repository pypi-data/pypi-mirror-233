...
def readCellMask():
    ...
    if maskFilePath:
        ...
        CTkMessagebox(title="Error", message="No file selected. Please select a Mask .tif file.", icon="cancel")
...
def Binning_Image_Way(choice):
    ...
    if binningLabel == 'None':
        ...
        try:
            ...
            CTkMessagebox(title="Error", message="No Mask file selected. Please select a Mask .tif file if you want to bin in cell.", icon="cancel")
            print("File not found. Please select a Mask .tif file.")
            return False
...
def Select_Excel_File():
    ...
    if saveExcelPath:
        ...
        CTkMessagebox(title="Error",message="No excel file selected. Please select an excel file to save lifetime values.",icon="cancel")
...
h5_path = pkg_resources.resource_filename('FLIM_fit', 'FLIM_GAN_9_27.h5')
FLIM_GAN_Model = tf.keras.models.load_model(h5_path,compile=False)
