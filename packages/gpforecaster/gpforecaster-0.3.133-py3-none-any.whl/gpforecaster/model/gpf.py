            ...
            for epoch in range(epochs):
                ...
                if verbose:
                    print(
                        ...
                        f"\t Upper : {np.round(val_loss_all[1], 3) if val_loss_all[0] is not None else 'N/A'}\n"
                        f"\t Bottom : {np.round(val_loss_all[2], 3) if val_loss_all[0] is not None else 'N/A'}\n"
                        f"Test Loss:"
                        f"\t Weighted: {np.round(test_loss_all[0], 3) if test_loss_all[0] is not None else 'N/A'}\n"
                        f"\t Upper : {np.round(test_loss_all[1], 3) if test_loss_all[0] is not None else 'N/A'}\n"
                        f"\t Bottom : {np.round(test_loss_all[2], 3) if test_loss_all[0] is not None else 'N/A'}\n"
                    )
