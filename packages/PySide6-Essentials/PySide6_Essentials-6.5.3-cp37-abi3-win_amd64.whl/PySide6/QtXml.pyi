...
class QDomDocument(PySide6.QtXml.QDomNode):
    ...
    class ParseOption(enum.Flag):
        ...
        Default                  : QDomDocument.ParseOption = ... # 0x0
    ...
    @overload
    def setContent(self, text: Union[PySide6.QtCore.QByteArray, bytes]) -> Tuple[bool, str, int, int]: ...
    @overload
    def setContent(self, text: Union[PySide6.QtCore.QByteArray, bytes], namespaceProcessing: bool) -> Tuple[bool, str, int, int]: ...
