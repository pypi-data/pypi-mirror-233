...
.. code-block:: none
      ...
      sina_jaccard --file1 "path/to/your/file1.txt"  --files "path/to/your/file2.txt" --delimiter ","  --selection "jaccardAll" --ignoreAllDiacriticsButNotShadda --ignoreShaddaDiacritic  
