...
#    
#    # Adding argument for the text input or file input
#    parser.add_argument('--text', type=str, help='Text to be analyzed for Named Entity Recognition')
#    parser.add_argument('--file', type=str, help='File containing the text to be analyzed for Named Entity Recognition')
#
...
#    input_text = args.text if args.text else read_file(args.file)
#
...
def main():
    ...
    if args.text is not None:
        ...
        # Print the results in JSON format
        print(json.dumps(results, ensure_ascii=False, indent=4))
    if args.text is None and args.dir is None:
        print("Error: Either --text or --file argument must be provided.")
        return
...
#arabi_ner --text "Your text here." --output_csv output.csv
#arabi_ner --dir /path/to/your/directory --output_csv output.csv
