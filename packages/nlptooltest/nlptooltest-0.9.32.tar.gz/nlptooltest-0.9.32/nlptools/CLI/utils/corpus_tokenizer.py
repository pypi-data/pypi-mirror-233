...
import argparse
from nlptools.utils import corpus_tokenizer
...
def main():
    ...
    print("dir_path: ",args.dir_path, " output_csv : ",args.output_csv)
    # Call the corpus_tokenizer function with the parsed arguments
    corpus_tokenizer(args.dir_path, args.output_csv, row_id = 1, global_sentence_id = 1)
