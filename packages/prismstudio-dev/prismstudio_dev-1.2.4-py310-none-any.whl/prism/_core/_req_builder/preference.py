...
def get_default_attributes():
    ...
    return [k for k, v in const.SMValues.items() if v in ga]
...
def set_package_priority(datacategory: str, datacomponent: str, package_priority: list):
    ...
    --------
        ...
        >>> prism.preference.set_package_priority(datacategory=datacategory, datacomponent=datacomponent, package_priority=package_priority)
        {
        'status': 'Success',
