...
def gltf(
    ...
    ''' Export scene as glTF 2.0 file :File: `addons/io_scene_gltf2/__init__.py\:752 <https://projects.blender.org/blender/blender-addons/addons/io_scene_gltf2/__init__.py#L752>`__
    ...
    :param export_try_sparse_sk: Use Sparse Accessor if better, Try using Sparce Accessor if it save space
    ...
    :param export_gpu_instances: GPU Instances, Export using EXT_mesh_gpu_instancing.Limited to children of a same Empty. multiple Materials might be omitted
