...
def collection_show_all(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Show all bone collections :File: `startup/bl_operators/anim.py\:556 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/anim.py#L556>`__
...
def collection_solo_visibility(
        ...
        *,
        name: typing.Union[str, typing.Any] = ""):
    ''' Hide all other bone collections and show the active one :File: `startup/bl_operators/anim.py\:539 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/anim.py#L539>`__
...
def sync_bone_color_to_selected(
        override_context: typing.Optional[
            typing.Union[typing.Dict, 'bpy.types.Context']] = None,
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None,
    ...
    :type execution_context: typing.Optional[typing.Union[str, int]]
    :type undo: typing.Optional[bool]
    :param bone_type: Type * ``EDIT`` Edit Bone -- Copy Edit Bone colors from the active bone to all selected bones. * ``POSE`` Pose Bone -- Copy Pose Bone colors from the active bone to all selected bones.
