...
class MlFoundry:
    ...
    def get_model(self, fqn: str) -> ModelVersion:
        ...
        warning_message = (
            ...
            "Please use `get_model_version_by_fqn` instead"
        )
        warnings.warn(
    ...
    def get_artifact(self, fqn: str) -> ArtifactVersion:
        ...
        """
        warning_message = (
            "`get_artifact` is deprecated and will be removed in a future release. "
            "Please use `get_artifact_version_by_fqn` instead"
        )
        warnings.warn(
            message=warning_message, category=DeprecationWarning, stacklevel=2
        )
