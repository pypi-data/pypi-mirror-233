...
class MediaPostMixin(object):
    ...
    def get_media_comments_chunk(
        ...
        return types.CommentsChunk(**response.json(), media_identifier=code_or_id_or_url)
    ...
    def get_comment_thread_chunk(
        ...
        return types.CommentsThreadChunk(**response.json(), commend_id=comment_id)
    ...
    def get_medias_by_hashtag_chunk(
        ...
        return types.MediaPostsHashtagChunk(**response.json(), hashtag=hashtag)
    ...
    def get_tagged_medias_chunk(
        ...
        return types.TaggedMediaPostsChunk(**response.json(), user_identifier=username_or_id_or_url)
