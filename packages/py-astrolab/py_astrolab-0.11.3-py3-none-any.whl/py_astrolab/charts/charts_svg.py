    ...
    def __drawAspect(self, r, ar, aspect_dict, aspect_id: str, color: str, isAxis=False, cut_by=8.4):
        ...
        if not isAxis:
            ...
            if (0 <= angle < 45) or (315 <= angle < 360):
                ...
                mid_x -= label_offset
            line += f'<text class="aspectDeg" id="{aspect_id}Deg" x="{mid_x}" y="{mid_y}" fill="#ffffff" text-anchor="middle" dominant-baseline="middle" style="opacity: 0">{str(round(orb))}°</text>'
        return line
