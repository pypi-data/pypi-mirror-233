...
class MakeSvgInstance:
    ...
    def __drawAspect(self, r, ar, aspect_dict, aspect_id: str, color: str, isAxis=False, cut_by=8.4):
        ...
        if isAxis:
            ...
            offset_length = 10  # Distanza dal centro dell'asse
        ...
        if self.chart_type == "Transit" or self.chart_type == "Composite":
            ...
            for e in range(len(t_keys)):
                ...
                output = output + f'<line id="{self.planets_settings[i]["name"].title()}GTransitLine" x1="'+str(x1)+'" y1="'+str(y1)+'" x2="'+str(x2)+'" y2="'+str(
                    y2)+'" style="stroke: blue'+'; stroke-width: 1px; stroke-opacity: 1;"/>'
                ...
                output = output + f'<line id="{self.planets_settings[i]["name"].title()}GTransitLineInner" x1="'+str(x1_inner)+'" y1="'+str(y1_inner)+'" x2="'+str(x2_inner)+'" y2="'+str(y2_inner)+'" style="stroke: blue'+'; stroke-width: 1px; stroke-opacity: 1;"/>'
    ...
    def makeTemplate(self):
        ...
        if self.chart_type == "Transit" or self.chart_type == "Composite":
            ...
            td['transitRingAxes'] = self.__makeAxis(r, r-self.c1+54.5, self.t_user.axis_list, 9.7, 'blue', transit_axis, composite_axis)
