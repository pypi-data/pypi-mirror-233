...
class ListRestViewMixin(ModelResponseMixin):
    ...
    def get_list_fields(self):
        ...
        :rtype: :class:`list[pfx.pfxcore.views.ViewField]`
        """
        if self.__class__ not in self._class_list_fields:
            self._class_list_fields[self.__class__] = self._process_fields(
                self.list_fields or self.fields)
        return self._class_list_fields[self.__class__]
