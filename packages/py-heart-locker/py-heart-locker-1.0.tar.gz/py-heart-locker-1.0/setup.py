...
setup(
    ...
    description='Python process locker to avoid repeatedly executing the same script at the same time',  # Optional
    ...
    url='https://github.com/EXP-Codes/py-heart-locker',  # Optional
