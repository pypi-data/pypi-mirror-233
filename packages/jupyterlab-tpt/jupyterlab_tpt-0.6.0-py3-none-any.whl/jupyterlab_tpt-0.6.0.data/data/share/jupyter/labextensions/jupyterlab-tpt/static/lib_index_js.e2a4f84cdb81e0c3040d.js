...
/* harmony import */ var jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! jupyterlab-celltagsclasses */ "./node_modules/jupyterlab-celltagsclasses/lib/metadata.js");
...
/* harmony import */ var jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! jupyterlab-celltagsclasses */ "./node_modules/jupyterlab-celltagsclasses/lib/apply_on_cells.js");
/*
...
const _set_hide = (cell, hidden, input_output) => {
    if (hidden) {
        (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_4__.md_set)(cell, `hide_${input_output}`, true);
        (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_4__.md_insert)(cell, 'tags', `hide-${input_output}`);
    }
    else {
        (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_4__.md_unset)(cell, `hide_${input_output}`);
        (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_4__.md_remove)(cell, 'tags', `hide-${input_output}`);
    }
};
const _toggle_hide = (cell, input_output) => {
    if ((0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_4__.md_get)(cell, `tags.hide-${input_output}`)) {
...
const clean_cell_metadata = (cell) => {
    ...
    if (editable === true) {
        (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_4__.md_unset)(cell, 'editable');
    }
    const tags = cell.model.getMetadata('tags');
    if ((tags === null || tags === void 0 ? void 0 : tags.length) === 0) {
        (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_4__.md_unset)(cell, 'tags');
    }
    const slide_type = (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_4__.md_get)(cell, 'slideshow.slide_type');
    if (slide_type === '') {
        (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_4__.md_unset)(cell, 'slideshow.slide_type');
    }
    const slideshow = (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_4__.md_get)(cell, 'slideshow');
    if ((slideshow !== undefined) && (JSON.stringify(slideshow) == '{}')) {
        (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_4__.md_unset)(cell, 'slideshow');
    }
    const user_expressions = (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_4__.md_get)(cell, 'user_expressions');
    if ((user_expressions === null || user_expressions === void 0 ? void 0 : user_expressions.length) === 0) {
        (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_4__.md_unset)(cell, 'user_expressions');
    }
};
const toggle_tag = (cell, tag) => {
    if ((0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_4__.md_get)(cell, 'tags', tag)) {
        (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_4__.md_remove)(cell, 'tags', tag);
    }
    else {
        (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_4__.md_insert)(cell, 'tags', tag);
    }
};
...
const plugin = {
    ...
    activate: (app, palette, notebookTracker, settingRegistry) => {
        ...
        function loadSetting(setting) {
            ...
            limit = setting.get('limit').composite;
            flag = setting.get('flag').composite;
            console.log(`Settings Example extension: Limit is set to '${limit}' and flag to '${flag}'`);
        }
        ...
        app.commands.addCommand(command, {
            ...
            execute: () => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.apply_on_cells)(notebookTracker, jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.Scope.Multiple, (cell) => set_hide_input(cell, true))
        });
        palette.addItem({ command, category: 'Convenience' });
        command = 'convenience:show-input';
        app.commands.addCommand(command, {
            label: 'show input for all selected cells',
            execute: () => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.apply_on_cells)(notebookTracker, jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.Scope.Multiple, (cell) => set_hide_input(cell, false))
        });
        palette.addItem({ command, category: 'Convenience' });
        ...
        app.commands.addCommand(command, {
            ...
            execute: () => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.apply_on_cells)(notebookTracker, jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.Scope.Multiple, (cell) => toggle_hide_input(cell))
        });
        palette.addItem({ command, category: 'Convenience' });
        ...
        app.commands.addCommand(command, {
            ...
            execute: () => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.apply_on_cells)(notebookTracker, jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.Scope.Multiple, (cell) => set_hide_output(cell, true))
        });
        palette.addItem({ command, category: 'Convenience' });
        command = 'convenience:show-output';
        app.commands.addCommand(command, {
            label: 'show output for all selected cells',
            execute: () => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.apply_on_cells)(notebookTracker, jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.Scope.Multiple, (cell) => set_hide_output(cell, false))
        });
        palette.addItem({ command, category: 'Convenience' });
        ...
        app.commands.addCommand(command, {
            ...
            execute: () => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.apply_on_cells)(notebookTracker, jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.Scope.Multiple, (cell) => toggle_hide_output(cell))
        });
        palette.addItem({ command, category: 'Convenience' });
        ...
        app.commands.addCommand(command, {
            ...
            execute: () => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.apply_on_cells)(notebookTracker, jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.Scope.All, (cell) => set_hide_input_needle(cell, true))
        });
        palette.addItem({ command, category: 'Convenience' });
        ...
        app.commands.addCommand(command, {
            ...
            execute: () => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.apply_on_cells)(notebookTracker, jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.Scope.All, (cell) => set_hide_input_needle(cell, false))
        });
        palette.addItem({ command, category: 'Convenience' });
        ...
        app.commands.addCommand(command, {
            ...
            execute: () => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.apply_on_cells)(notebookTracker, jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.Scope.Multiple, clean_cell_metadata)
        });
        palette.addItem({ command, category: 'Convenience' });
        app.commands.addKeyBinding({ command, keys: ['Alt Cmd 7'], selector: '.jp-Notebook' });
        ...
        app.commands.addCommand(command, {
            ...
            execute: () => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.apply_on_cells)(notebookTracker, jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.Scope.All, clean_cell_metadata)
        });
        palette.addItem({ command, category: 'Convenience' });
        ...
        app.commands.addCommand(command, {
            ...
            execute: () => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.apply_on_cells)(notebookTracker, jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.Scope.All, unrender_markdown)
        });
        palette.addItem({ command, category: 'Convenience' });
        ...
        app.commands.addCommand(command, {
            ...
            execute: () => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.apply_on_cells)(notebookTracker, jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.Scope.Multiple, (cell) => toggle_tag(cell, 'raises-exception')),
        });
        palette.addItem({ command, category: 'Convenience' });
        ...
        app.commands.addCommand(command, {
            ...
            execute: () => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.apply_on_cells)(notebookTracker, jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.Scope.Multiple, (cell) => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_4__.md_insert)(cell, 'tags', 'raises-exception')),
        });
        palette.addItem({ command, category: 'Convenience' });
...
//# sourceMappingURL=lib_index_js.e2a4f84cdb81e0c3040d.js.map