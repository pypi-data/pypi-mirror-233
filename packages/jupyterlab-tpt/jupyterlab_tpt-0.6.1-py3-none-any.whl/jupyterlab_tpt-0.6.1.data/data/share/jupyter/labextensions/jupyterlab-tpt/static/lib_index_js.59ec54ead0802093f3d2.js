...
const _set_hide = (cell, hidden, input_output) => {
    if (hidden) {
        (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.md_set)(cell, `hide_${input_output}`, true);
        (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.md_insert)(cell, 'tags', `hide-${input_output}`);
    }
    else {
        (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.md_unset)(cell, `hide_${input_output}`);
        (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.md_remove)(cell, 'tags', `hide-${input_output}`);
    }
};
const _toggle_hide = (cell, input_output) => {
    if ((0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_5__.md_get)(cell, `tags.hide-${input_output}`)) {
...
const plugin = {
    ...
    activate: (app, palette, notebookTracker, settingRegistry) => {
        ...
        app.commands.addCommand(command, {
            ...
            execute: () => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_6__.apply_on_cells)(notebookTracker, jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_6__.Scope.Multiple, (cell) => set_hide_input(cell, true))
        });
        palette.addItem({ command, category: 'convenience' });
        command = 'convenience:show-input';
        app.commands.addCommand(command, {
            label: 'show input for all selected cells',
            execute: () => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_6__.apply_on_cells)(notebookTracker, jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_6__.Scope.Multiple, (cell) => set_hide_input(cell, false))
        });
        palette.addItem({ command, category: 'convenience' });
        ...
        app.commands.addCommand(command, {
            ...
            execute: () => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_6__.apply_on_cells)(notebookTracker, jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_6__.Scope.Multiple, (cell) => toggle_hide_input(cell))
        });
        palette.addItem({ command, category: 'convenience' });
        ...
        app.commands.addCommand(command, {
            ...
            execute: () => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_6__.apply_on_cells)(notebookTracker, jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_6__.Scope.Multiple, (cell) => set_hide_output(cell, true))
        });
        palette.addItem({ command, category: 'convenience' });
        command = 'convenience:show-output';
        app.commands.addCommand(command, {
            label: 'show output for all selected cells',
            execute: () => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_6__.apply_on_cells)(notebookTracker, jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_6__.Scope.Multiple, (cell) => set_hide_output(cell, false))
        });
        palette.addItem({ command, category: 'convenience' });
        ...
        app.commands.addCommand(command, {
            ...
            execute: () => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_6__.apply_on_cells)(notebookTracker, jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_6__.Scope.Multiple, (cell) => toggle_hide_output(cell))
        });
        palette.addItem({ command, category: 'convenience' });
        ...
        app.commands.addCommand(command, {
            ...
            execute: () => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_6__.apply_on_cells)(notebookTracker, jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_6__.Scope.All, (cell) => set_hide_input_needle(cell, true))
        });
        palette.addItem({ command, category: 'convenience' });
        ...
        app.commands.addCommand(command, {
            ...
            execute: () => (0,jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_6__.apply_on_cells)(notebookTracker, jupyterlab_celltagsclasses__WEBPACK_IMPORTED_MODULE_6__.Scope.All, (cell) => set_hide_input_needle(cell, false))
        });
        palette.addItem({ command, category: 'convenience' });
        ...
        function loadSetting(setting) {
            ...
            outline_selected_cells = setting.get('outline_selected_cells').composite;
            console.log(`tpt extension, outline_selected is read as ${outline_selected_cells}`);
            if (outline_selected_cells) {
                const inject_css = (css_text) => {
                    const style = document.createElement('style');
                    style.setAttribute('type', 'text/css');
                    style.appendChild(document.createTextNode(css_text));
                    document.body.appendChild(style);
                };
                inject_css(_style_selected_cells_raw_css__WEBPACK_IMPORTED_MODULE_4__);
            }
        }
