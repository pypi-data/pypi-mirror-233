...
class TestReferenceModel(TestCase):
    def setUp(self):
        ...
        self.subject_visit = SubjectVisit.objects.get(visit_code="1000")
    ...
    def test_reference_getter_without_using_model_obj(self):
        ...
        opts = dict(
            ...
            report_datetime=crf_one.related_visit.report_datetime,
            visit_schedule_name=crf_one.related_visit.visit_schedule_name,
    ...
    def test_model_manager_requisition(self):
        ...
        obj = Reference.objects.get_requisition_for_visit(
            f"reference_app.subjectrequisition.{CD4}", self.subject_visit
        )
    ...
    def test_requisition_creates_two(self):
        ...
        obj = Reference.objects.get_requisition_for_visit(
            f"reference_app.subjectrequisition.{VL}", self.subject_visit
        )
    ...
    def test_requisition_creates2(self):
        ...
        SubjectRequisition.objects.create(
            subject_visit=self.subject_visit, panel=self.panel_fbc
        )

        for panel in [self.panel_cd4, self.panel_vl, self.panel_fbc]:
