...
A program értékei itt mennek. Yay."

ARGUMENT_APPLICATION_HELP = "\
Válassza ki a futtatni kívánt alkalmazást."

ARGUMENT_APPLICATION_TITLE = "Alkalmazás"

ARGUMENT_CUSTOMIZATION_DESCRIPTION = "\
Celestine megpróbálja kitalálni a legjobb beállításokat. \
Ehelyett kérheti ezeknek az értékeknek a használatát."

ARGUMENT_CUSTOMIZATION_TITLE = "Testreszabás"

ARGUMENT_HELP_HELP = "Megjeleníti ezt a súgóképernyőt."

ARGUMENT_INFORMATION_DESCRIPTION = "\
Ezek felvétele befejezi a programot az információk megjelenítéséhez."

ARGUMENT_INFORMATION_TITLE = "Információ"
...
ARGUMENT_MODIFICATION_DESCRIPTION = "Jelzők konfigurálása"

ARGUMENT_MODIFICATION_TITLE = "Módosítás"
...
Válassza ki, hogy a Python melyik verzióját használja."

ARGUMENT_VERSION_HELP = "Megjeleníti az aktuális verziót."

CLEAN_MAIN_CLEAN = "Formázza az összes python kódfájlt."

CLEAN_MAIN_LICENCE = "Tisztítsa meg a licencfájlokat."

CLEAN_MAIN_TITLE = "\
Szkriptek, amelyek felkészítik a projektet a közzétételre."

CLEAN_MAIN_VERSION = "Verziószám frissítése."
...
DEMO_ONE_NEXT = "Ugrás a második oldalra."

DEMO_ONE_PAST = "Ugrás a fő oldalra."

DEMO_ONE_SAY = "Az étel jó ízű."

DEMO_ONE_TITLE = "Első oldal."

DEMO_TWO_ACTION = "Ints a tehénnek."

DEMO_TWO_NEXT = "Ugrás a fő oldalra."

DEMO_TWO_PAST = "Ugrás az első oldalra."

DEMO_TWO_SAY = "Viszlát ember."
...
SESSION_PARSER_CHOICE = "érvénytelen választás"

SESSION_PARSER_CHOOSE = "Válasszon a következők közül"

SESSION_PARSER_ERROR = "hiba"

SESSION_PARSER_UNRECOGNIZED = "Ismeretlen argumentumok"

SESSION_PARSER_USAGE = "használat"

TRANSLATOR_FILE_ERROR_OVERFLOW = "Túlcsordultunk."

TRANSLATOR_MAIN_BUTTON = "Fájlok fordítása"

TRANSLATOR_REPORT_BUTTON = "Jelentés az aktákról."

TRANSLATOR_SESSION_KEY = "\
A Translator szolgáltatáskulcsa a Azure Portal."
...
VIEWER_MAIN_BUTTON = "Képek betöltése a könyvtárba."
